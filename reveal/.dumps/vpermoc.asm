...
000ah mov rcx,7FF7C7522798h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7522798h:imm64]         encoding(10 bytes) = 48 b9 98 27 52 c7 f7 7f 00 00
0014h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F398D70h:jmp64]                encoding(5 bytes) = e8 57 8d 39 5f
0019h mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
001ch mov rcx,7FF7C7517788h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7517788h:imm64]         encoding(10 bytes) = 48 b9 88 77 51 c7 f7 7f 00 00
0026h mov edx,2                     ; MOV(Mov_r32_imm32) [EDX,2h:imm32]                    encoding(5 bytes) = ba 02 00 00 00
002bh call 7FF826FA6E40h            ; CALL(Call_rel32_64) [5F3F0BC0h:jmp64]                encoding(5 bytes) = e8 90 0b 3f 5f
0030h mov rdi,rax                   ; MOV(Mov_r64_rm64) [RDI,RAX]                          encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C764DEA0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c764dea0h:imm64]         encoding(10 bytes) = 48 b9 a0 de 64 c7 f7 7f 00 00
003dh call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F398D70h:jmp64]                encoding(5 bytes) = e8 2e 8d 39 5f
...
004dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F3EFC90h:jmp64]                encoding(5 bytes) = e8 3e fc 3e 5f
...
005dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F3EFC90h:jmp64]                encoding(5 bytes) = e8 2e fc 3e 5f
...
0076h mov rdx,27890010A90h          ; MOV(Mov_r64_imm64) [RDX,27890010a90h:imm64]          encoding(10 bytes) = 48 ba 90 0a 01 90 78 02 00 00
...
008fh call 7FF825DACEB0h            ; CALL(Call_rel32_64) [5E1F6C30h:jmp64]                encoding(5 bytes) = e8 9c 6b 1f 5e
...
00a6h call 7FF7C7BB5BB0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF930h:jmp64]        encoding(5 bytes) = e8 85 f8 ff ff
00abh mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C7D7C7B0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7d7c7b0h:imm64]         encoding(10 bytes) = 48 b9 b0 c7 d7 c7 f7 7f 00 00
00b8h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F398D70h:jmp64]                encoding(5 bytes) = e8 b3 8c 39 5f
...
00d0h mov rcx,7FF7C7D7C7B0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7d7c7b0h:imm64]         encoding(10 bytes) = 48 b9 b0 c7 d7 c7 f7 7f 00 00
00dah call 7FF826EEEF00h            ; CALL(Call_rel32_64) [5F338C80h:jmp64]                encoding(5 bytes) = e8 a1 8b 33 5f
...
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> vand_dynamic(Vector256<uint> a, Vector256<uint> b)
; location: [7FF7C7BB6390h, 7FF7C7BB63BFh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h call 7FF7C7BB6280h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64]        encoding(5 bytes) = e8 db fe ff ff
...
; location: [7FF7C7BB67E0h, 7FF7C7BB6811h]
...
; location: [7FF7C7BB6830h, 7FF7C7BB6853h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
0009h mov rax,278F17CC15Dh          ; MOV(Mov_r64_imm64) [RAX,278f17cc15dh:imm64]          encoding(10 bytes) = 48 b8 5d c1 7c f1 78 02 00 00
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0x5D,0xC1,0x7C,0xF1,0x78,0x02,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<int> vpermvar8x32_256x32i(Vector256<int> src, Vector256<uint> spec)
; location: [7FF7C7BB6870h, 7FF7C7BB688Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
...
; location: [7FF7C7BB68A0h, 7FF7C7BB68BDh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BB68D0h, 7FF7C7BB6920h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,278F17CC5CDh          ; MOV(Mov_r64_imm64) [RAX,278f17cc5cdh:imm64]          encoding(10 bytes) = 48 b8 cd c5 7c f1 78 02 00 00
...
002bh mov rax,278F17CC13Dh          ; MOV(Mov_r64_imm64) [RAX,278f17cc13dh:imm64]          encoding(10 bytes) = 48 b8 3d c1 7c f1 78 02 00 00
...
; location: [7FF7C7BB6970h, 7FF7C7BB698Ah]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h vmovupd xmm1,[r8]             ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM1,mem(Packed128_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 79 10 08
...
; location: [7FF7C7BB69A0h, 7FF7C7BB69BDh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BB69D0h, 7FF7C7BB69EDh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BB6A00h, 7FF7C7BB6A61h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
