...
000ah mov rcx,7FF7C7502798h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7502798h:imm64]         encoding(10 bytes) = 48 b9 98 27 50 c7 f7 7f 00 00
0014h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F3BF710h:jmp64]                encoding(5 bytes) = e8 f7 f6 3b 5f
0019h mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
001ch mov rcx,7FF7C74F7788h         ; MOV(Mov_r64_imm64) [RCX,7ff7c74f7788h:imm64]         encoding(10 bytes) = 48 b9 88 77 4f c7 f7 7f 00 00
0026h mov edx,2                     ; MOV(Mov_r32_imm32) [EDX,2h:imm32]                    encoding(5 bytes) = ba 02 00 00 00
002bh call 7FF826FA6E40h            ; CALL(Call_rel32_64) [5F417560h:jmp64]                encoding(5 bytes) = e8 30 75 41 5f
0030h mov rdi,rax                   ; MOV(Mov_r64_rm64) [RDI,RAX]                          encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C762D2C0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c762d2c0h:imm64]         encoding(10 bytes) = 48 b9 c0 d2 62 c7 f7 7f 00 00
003dh call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F3BF710h:jmp64]                encoding(5 bytes) = e8 ce f6 3b 5f
...
004dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F416630h:jmp64]                encoding(5 bytes) = e8 de 65 41 5f
...
005dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F416630h:jmp64]                encoding(5 bytes) = e8 ce 65 41 5f
...
0076h mov rdx,1E93EA60700h          ; MOV(Mov_r64_imm64) [RDX,1e93ea60700h:imm64]          encoding(10 bytes) = 48 ba 00 07 a6 3e e9 01 00 00
...
008fh call 7FF825DACEB0h            ; CALL(Call_rel32_64) [5E21D5D0h:jmp64]                encoding(5 bytes) = e8 3c d5 21 5e
...
00a6h call 7FF7C7B8F0B8h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF7D8h:jmp64]        encoding(5 bytes) = e8 2d f7 ff ff
00abh mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C7D35B70h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7d35b70h:imm64]         encoding(10 bytes) = 48 b9 70 5b d3 c7 f7 7f 00 00
00b8h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F3BF710h:jmp64]                encoding(5 bytes) = e8 53 f6 3b 5f
...
00d0h mov rcx,7FF7C7D35B70h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7d35b70h:imm64]         encoding(10 bytes) = 48 b9 70 5b d3 c7 f7 7f 00 00
00dah call 7FF826EEEF00h            ; CALL(Call_rel32_64) [5F35F620h:jmp64]                encoding(5 bytes) = e8 41 f5 35 5f
...
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> vand_dynamic(Vector256<uint> a, Vector256<uint> b)
; location: [7FF7C7B8F9F0h, 7FF7C7B8FA1Fh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h call 7FF7C7B8F8E0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64]        encoding(5 bytes) = e8 db fe ff ff
...
; location: [7FF7C7B8FE40h, 7FF7C7B8FE71h]
...
; location: [7FF7C7B90290h, 7FF7C7B902B3h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
0009h mov rax,1E9476B5225h          ; MOV(Mov_r64_imm64) [RAX,1e9476b5225h:imm64]          encoding(10 bytes) = 48 b8 25 52 6b 47 e9 01 00 00
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0x25,0x52,0x6B,0x47,0xE9,0x01,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<int> vpermvar8x32_256x32i(Vector256<int> src, Vector256<uint> spec)
; location: [7FF7C7B902D0h, 7FF7C7B902EDh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
...
; location: [7FF7C7B90300h, 7FF7C7B9031Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7B90330h, 7FF7C7B90380h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,1E9476B56D5h          ; MOV(Mov_r64_imm64) [RAX,1e9476b56d5h:imm64]          encoding(10 bytes) = 48 b8 d5 56 6b 47 e9 01 00 00
...
002bh mov rax,1E9476B5205h          ; MOV(Mov_r64_imm64) [RAX,1e9476b5205h:imm64]          encoding(10 bytes) = 48 b8 05 52 6b 47 e9 01 00 00
...
; location: [7FF7C7B903D0h, 7FF7C7B903EAh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h vmovupd xmm1,[r8]             ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM1,mem(Packed128_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 79 10 08
...
; location: [7FF7C7B90400h, 7FF7C7B9041Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7B90430h, 7FF7C7B9044Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7B90460h, 7FF7C7B904C1h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
