; 2020-01-11 03:38:50:466
; function: Func<Vector256<uint>,Vector256<uint>,Vector256<uint>> vand_delgate()
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
...
0014h call 7FF82720EFF0h                      ; CALL(Call_rel32_64) [5F3BB7B0h:jmp64]      encoding(5 bytes) = e8 97 b7 3b 5f
...
002bh call 7FF827266E40h                      ; CALL(Call_rel32_64) [5F413600h:jmp64]      encoding(5 bytes) = e8 d0 35 41 5f
0030h mov rdi,rax                             ; MOV(Mov_r64_rm64) [RDI,RAX]                encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C7DCAC68h                   ; MOV(Mov_r64_imm64) [RCX,7ff7c7dcac68h:imm64] encoding(10 bytes) = 48 b9 68 ac dc c7 f7 7f 00 00
003dh call 7FF82720EFF0h                      ; CALL(Call_rel32_64) [5F3BB7B0h:jmp64]      encoding(5 bytes) = e8 6e b7 3b 5f
...
004dh call 7FF827265F10h                      ; CALL(Call_rel32_64) [5F4126D0h:jmp64]      encoding(5 bytes) = e8 7e 26 41 5f
...
005dh call 7FF827265F10h                      ; CALL(Call_rel32_64) [5F4126D0h:jmp64]      encoding(5 bytes) = e8 6e 26 41 5f
...
0076h mov rdx,1C861BC09C8h                    ; MOV(Mov_r64_imm64) [RDX,1c861bc09c8h:imm64] encoding(10 bytes) = 48 ba c8 09 bc 61 c8 01 00 00
...
008fh call 7FF825DACEB0h                      ; CALL(Call_rel32_64) [5DF59670h:jmp64]      encoding(5 bytes) = e8 dc 95 f5 5d
...
00a6h call 7FF7C7E53128h                      ; CALL(Call_rel32_64) [FFFFFFFFFFFFF8E8h:jmp64] encoding(5 bytes) = e8 3d f8 ff ff
00abh mov rsi,rax                             ; MOV(Mov_r64_rm64) [RSI,RAX]                encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C8046138h                   ; MOV(Mov_r64_imm64) [RCX,7ff7c8046138h:imm64] encoding(10 bytes) = 48 b9 38 61 04 c8 f7 7f 00 00
00b8h call 7FF82720EFF0h                      ; CALL(Call_rel32_64) [5F3BB7B0h:jmp64]      encoding(5 bytes) = e8 f3 b6 3b 5f
...
00d0h mov rcx,7FF7C8046138h                   ; MOV(Mov_r64_imm64) [RCX,7ff7c8046138h:imm64] encoding(10 bytes) = 48 b9 38 61 04 c8 f7 7f 00 00
00dah call 7FF8271AEF00h                      ; CALL(Call_rel32_64) [5F35B6C0h:jmp64]      encoding(5 bytes) = e8 e1 b5 35 5f
...
0010h call 7FF7C7E53840h                      ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64] encoding(5 bytes) = e8 db fe ff ff
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0xC9,0xCF,0x8A,0x6A,0xC8,0x01,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
0000h vzeroupper                              ; VZEROUPPER(VEX_Vzeroupper)                 encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                              ; NOP(Nopw)                                  encoding(2 bytes) = 66 90
...
0009h mov rax,1C86A8ACFC9h                    ; MOV(Mov_r64_imm64) [RAX,1c86a8acfc9h:imm64] encoding(10 bytes) = 48 b8 c9 cf 8a 6a c8 01 00 00
...
002bh mov rax,1C86A8ACFA9h                    ; MOV(Mov_r64_imm64) [RAX,1c86a8acfa9h:imm64] encoding(10 bytes) = 48 b8 a9 cf 8a 6a c8 01 00 00
