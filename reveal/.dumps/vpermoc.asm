; 2020-01-05 15:03:46:079
; function: Func<Vector256<uint>,Vector256<uint>,Vector256<uint>> vand_delgate()
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
...
000ah mov rcx,7FF7B5A42798h                   ; MOV(Mov_r64_imm64) [RCX,7ff7b5a42798h:imm64] encoding(10 bytes) = 48 b9 98 27 a4 b5 f7 7f 00 00
0014h call 7FF81547EFF0h                      ; CALL(Call_rel32_64) [5F1A6130h:jmp64]      encoding(5 bytes) = e8 17 61 1a 5f
0019h mov rsi,rax                             ; MOV(Mov_r64_rm64) [RSI,RAX]                encoding(3 bytes) = 48 8b f0
001ch mov rcx,7FF7B5A37788h                   ; MOV(Mov_r64_imm64) [RCX,7ff7b5a37788h:imm64] encoding(10 bytes) = 48 b9 88 77 a3 b5 f7 7f 00 00
0026h mov edx,2                               ; MOV(Mov_r32_imm32) [EDX,2h:imm32]          encoding(5 bytes) = ba 02 00 00 00
002bh call 7FF8154D6E40h                      ; CALL(Call_rel32_64) [5F1FDF80h:jmp64]      encoding(5 bytes) = e8 50 df 1f 5f
0030h mov rdi,rax                             ; MOV(Mov_r64_rm64) [RDI,RAX]                encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7B60DF570h                   ; MOV(Mov_r64_imm64) [RCX,7ff7b60df570h:imm64] encoding(10 bytes) = 48 b9 70 f5 0d b6 f7 7f 00 00
003dh call 7FF81547EFF0h                      ; CALL(Call_rel32_64) [5F1A6130h:jmp64]      encoding(5 bytes) = e8 ee 60 1a 5f
...
004dh call 7FF8154D5F10h                      ; CALL(Call_rel32_64) [5F1FD050h:jmp64]      encoding(5 bytes) = e8 fe cf 1f 5f
...
005dh call 7FF8154D5F10h                      ; CALL(Call_rel32_64) [5F1FD050h:jmp64]      encoding(5 bytes) = e8 ee cf 1f 5f
...
0076h mov rdx,25896B75990h                    ; MOV(Mov_r64_imm64) [RDX,25896b75990h:imm64] encoding(10 bytes) = 48 ba 90 59 b7 96 58 02 00 00
...
008fh call 7FF81359CEB0h                      ; CALL(Call_rel32_64) [5D2C3FF0h:jmp64]      encoding(5 bytes) = e8 5c 3f 2c 5d
...
00a6h call 7FF7B62D8B08h                      ; CALL(Call_rel32_64) [FFFFFFFFFFFFFC48h:jmp64] encoding(5 bytes) = e8 9d fb ff ff
00abh mov rsi,rax                             ; MOV(Mov_r64_rm64) [RSI,RAX]                encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7B6399C80h                   ; MOV(Mov_r64_imm64) [RCX,7ff7b6399c80h:imm64] encoding(10 bytes) = 48 b9 80 9c 39 b6 f7 7f 00 00
00b8h call 7FF81547EFF0h                      ; CALL(Call_rel32_64) [5F1A6130h:jmp64]      encoding(5 bytes) = e8 73 60 1a 5f
...
00d0h mov rcx,7FF7B6399C80h                   ; MOV(Mov_r64_imm64) [RCX,7ff7b6399c80h:imm64] encoding(10 bytes) = 48 b9 80 9c 39 b6 f7 7f 00 00
00dah call 7FF81541EF00h                      ; CALL(Call_rel32_64) [5F146040h:jmp64]      encoding(5 bytes) = e8 61 5f 14 5f
...
0010h call 7FF7B62D8EC0h                      ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64] encoding(5 bytes) = e8 db fe ff ff
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0xD9,0xED,0x11,0x9F,0x58,0x02,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
0000h vzeroupper                              ; VZEROUPPER(VEX_Vzeroupper)                 encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                              ; NOP(Nopw)                                  encoding(2 bytes) = 66 90
...
0009h mov rax,2589F11EDD9h                    ; MOV(Mov_r64_imm64) [RAX,2589f11edd9h:imm64] encoding(10 bytes) = 48 b8 d9 ed 11 9f 58 02 00 00
...
0005h vmovupd ymm0,[rdx]                      ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]                       ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,2589F11F249h                    ; MOV(Mov_r64_imm64) [RAX,2589f11f249h:imm64] encoding(10 bytes) = 48 b8 49 f2 11 9f 58 02 00 00
...
002bh mov rax,2589F11EDB9h                    ; MOV(Mov_r64_imm64) [RAX,2589f11edb9h:imm64] encoding(10 bytes) = 48 b8 b9 ed 11 9f 58 02 00 00
