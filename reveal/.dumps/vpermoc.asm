; 2020-01-18 18:18:34:530
; Func<Vector256<uint>,Vector256<uint>,Vector256<uint>> vand_delgate()
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
; 2020-01-18 18:18:34:530
...
000ah mov rcx,7FF7C7EF2798h                   ; MOV(Mov_r64_imm64) [RCX,7ff7c7ef2798h:imm64] encoding(10 bytes) = 48 b9 98 27 ef c7 f7 7f 00 00
0014h call 7FF82793EFF0h                      ; CALL(Call_rel32_64) [5F3777A0h:jmp64]      encoding(5 bytes) = e8 87 77 37 5f
0019h mov rsi,rax                             ; MOV(Mov_r64_rm64) [RSI,RAX]                encoding(3 bytes) = 48 8b f0
001ch mov rcx,7FF7C7EE7788h                   ; MOV(Mov_r64_imm64) [RCX,7ff7c7ee7788h:imm64] encoding(10 bytes) = 48 b9 88 77 ee c7 f7 7f 00 00
0026h mov edx,2                               ; MOV(Mov_r32_imm32) [EDX,2h:imm32]          encoding(5 bytes) = ba 02 00 00 00
002bh call 7FF827996E40h                      ; CALL(Call_rel32_64) [5F3CF5F0h:jmp64]      encoding(5 bytes) = e8 c0 f5 3c 5f
0030h mov rdi,rax                             ; MOV(Mov_r64_rm64) [RDI,RAX]                encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C8587560h                   ; MOV(Mov_r64_imm64) [RCX,7ff7c8587560h:imm64] encoding(10 bytes) = 48 b9 60 75 58 c8 f7 7f 00 00
003dh call 7FF82793EFF0h                      ; CALL(Call_rel32_64) [5F3777A0h:jmp64]      encoding(5 bytes) = e8 5e 77 37 5f
...
004dh call 7FF827995F10h                      ; CALL(Call_rel32_64) [5F3CE6C0h:jmp64]      encoding(5 bytes) = e8 6e e6 3c 5f
...
005dh call 7FF827995F10h                      ; CALL(Call_rel32_64) [5F3CE6C0h:jmp64]      encoding(5 bytes) = e8 5e e6 3c 5f
...
0076h mov rdx,25910018950h                    ; MOV(Mov_r64_imm64) [RDX,25910018950h:imm64] encoding(10 bytes) = 48 ba 50 89 01 10 59 02 00 00
...
008fh call 7FF825DACEB0h                      ; CALL(Call_rel32_64) [5D7E5660h:jmp64]      encoding(5 bytes) = e8 cc 55 7e 5d
...
00a6h call 7FF7C85C6998h                      ; CALL(Call_rel32_64) [FFFFFFFFFFFFF148h:jmp64] encoding(5 bytes) = e8 9d f0 ff ff
00abh mov rsi,rax                             ; MOV(Mov_r64_rm64) [RSI,RAX]                encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C87647C0h                   ; MOV(Mov_r64_imm64) [RCX,7ff7c87647c0h:imm64] encoding(10 bytes) = 48 b9 c0 47 76 c8 f7 7f 00 00
00b8h call 7FF82793EFF0h                      ; CALL(Call_rel32_64) [5F3777A0h:jmp64]      encoding(5 bytes) = e8 e3 76 37 5f
...
00d0h mov rcx,7FF7C87647C0h                   ; MOV(Mov_r64_imm64) [RCX,7ff7c87647c0h:imm64] encoding(10 bytes) = 48 b9 c0 47 76 c8 f7 7f 00 00
00dah call 7FF8278DEF00h                      ; CALL(Call_rel32_64) [5F3176B0h:jmp64]      encoding(5 bytes) = e8 d1 75 31 5f
...
0010h call 7FF7C85C7850h                      ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64] encoding(5 bytes) = e8 db fe ff ff
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0x85,0x52,0x73,0x69,0x59,0x02,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
; 2020-01-18 18:18:34:531
0000h vzeroupper                              ; VZEROUPPER(VEX_Vzeroupper)                 encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                              ; NOP(Nopw)                                  encoding(2 bytes) = 66 90
...
0009h mov rax,25969735285h                    ; MOV(Mov_r64_imm64) [RAX,25969735285h:imm64] encoding(10 bytes) = 48 b8 85 52 73 69 59 02 00 00
...
002bh mov rax,25969E981C9h                    ; MOV(Mov_r64_imm64) [RAX,25969e981c9h:imm64] encoding(10 bytes) = 48 b8 c9 81 e9 69 59 02 00 00
