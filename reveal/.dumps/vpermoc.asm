; 2020-01-12 17:49:15:714
; function: Func<Vector256<uint>,Vector256<uint>,Vector256<uint>> vand_delgate()
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
...
0014h call 7FF82720EFF0h                      ; CALL(Call_rel32_64) [5F3BA480h:jmp64]      encoding(5 bytes) = e8 67 a4 3b 5f
...
002bh call 7FF827266E40h                      ; CALL(Call_rel32_64) [5F4122D0h:jmp64]      encoding(5 bytes) = e8 a0 22 41 5f
0030h mov rdi,rax                             ; MOV(Mov_r64_rm64) [RDI,RAX]                encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C7DF2680h                   ; MOV(Mov_r64_imm64) [RCX,7ff7c7df2680h:imm64] encoding(10 bytes) = 48 b9 80 26 df c7 f7 7f 00 00
003dh call 7FF82720EFF0h                      ; CALL(Call_rel32_64) [5F3BA480h:jmp64]      encoding(5 bytes) = e8 3e a4 3b 5f
...
004dh call 7FF827265F10h                      ; CALL(Call_rel32_64) [5F4113A0h:jmp64]      encoding(5 bytes) = e8 4e 13 41 5f
...
005dh call 7FF827265F10h                      ; CALL(Call_rel32_64) [5F4113A0h:jmp64]      encoding(5 bytes) = e8 3e 13 41 5f
...
0076h mov rdx,241ACF40A50h                    ; MOV(Mov_r64_imm64) [RDX,241acf40a50h:imm64] encoding(10 bytes) = 48 ba 50 0a f4 ac 41 02 00 00
...
008fh call 7FF825DACEB0h                      ; CALL(Call_rel32_64) [5DF58340h:jmp64]      encoding(5 bytes) = e8 ac 82 f5 5d
...
00a6h call 7FF7C7E53E60h                      ; CALL(Call_rel32_64) [FFFFFFFFFFFFF2F0h:jmp64] encoding(5 bytes) = e8 45 f2 ff ff
00abh mov rsi,rax                             ; MOV(Mov_r64_rm64) [RSI,RAX]                encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C8047750h                   ; MOV(Mov_r64_imm64) [RCX,7ff7c8047750h:imm64] encoding(10 bytes) = 48 b9 50 77 04 c8 f7 7f 00 00
00b8h call 7FF82720EFF0h                      ; CALL(Call_rel32_64) [5F3BA480h:jmp64]      encoding(5 bytes) = e8 c3 a3 3b 5f
...
00d0h mov rcx,7FF7C8047750h                   ; MOV(Mov_r64_imm64) [RCX,7ff7c8047750h:imm64] encoding(10 bytes) = 48 b9 50 77 04 c8 f7 7f 00 00
00dah call 7FF8271AEF00h                      ; CALL(Call_rel32_64) [5F35A390h:jmp64]      encoding(5 bytes) = e8 b1 a2 35 5f
...
0010h call 7FF7C7E54B70h                      ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64] encoding(5 bytes) = e8 db fe ff ff
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0xA5,0xCF,0x6A,0xB5,0x41,0x02,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
0000h vzeroupper                              ; VZEROUPPER(VEX_Vzeroupper)                 encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                              ; NOP(Nopw)                                  encoding(2 bytes) = 66 90
...
0009h mov rax,241B56ACFA5h                    ; MOV(Mov_r64_imm64) [RAX,241b56acfa5h:imm64] encoding(10 bytes) = 48 b8 a5 cf 6a b5 41 02 00 00
...
002bh mov rax,241B56ACF85h                    ; MOV(Mov_r64_imm64) [RAX,241b56acf85h:imm64] encoding(10 bytes) = 48 b8 85 cf 6a b5 41 02 00 00
