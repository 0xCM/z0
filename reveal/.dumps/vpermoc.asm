...
000ah mov rcx,7FF7C7532798h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7532798h:imm64]         encoding(10 bytes) = 48 b9 98 27 53 c7 f7 7f 00 00
0014h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F38EFF0h:jmp64]                encoding(5 bytes) = e8 d7 ef 38 5f
0019h mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
001ch mov rcx,7FF7C7527788h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7527788h:imm64]         encoding(10 bytes) = 48 b9 88 77 52 c7 f7 7f 00 00
0026h mov edx,2                     ; MOV(Mov_r32_imm32) [EDX,2h:imm32]                    encoding(5 bytes) = ba 02 00 00 00
002bh call 7FF826FA6E40h            ; CALL(Call_rel32_64) [5F3E6E40h:jmp64]                encoding(5 bytes) = e8 10 6e 3e 5f
0030h mov rdi,rax                   ; MOV(Mov_r64_rm64) [RDI,RAX]                          encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C765D4C0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c765d4c0h:imm64]         encoding(10 bytes) = 48 b9 c0 d4 65 c7 f7 7f 00 00
003dh call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F38EFF0h:jmp64]                encoding(5 bytes) = e8 ae ef 38 5f
...
004dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F3E5F10h:jmp64]                encoding(5 bytes) = e8 be 5e 3e 5f
...
005dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F3E5F10h:jmp64]                encoding(5 bytes) = e8 ae 5e 3e 5f
...
0076h mov rdx,26D644306F8h          ; MOV(Mov_r64_imm64) [RDX,26d644306f8h:imm64]          encoding(10 bytes) = 48 ba f8 06 43 64 6d 02 00 00
...
008fh call 7FF825DACEB0h            ; CALL(Call_rel32_64) [5E1ECEB0h:jmp64]                encoding(5 bytes) = e8 1c ce 1e 5e
...
00a6h call 7FF7C7BBF9A8h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF9A8h:jmp64]        encoding(5 bytes) = e8 fd f8 ff ff
00abh mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C7D60C88h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7d60c88h:imm64]         encoding(10 bytes) = 48 b9 88 0c d6 c7 f7 7f 00 00
00b8h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F38EFF0h:jmp64]                encoding(5 bytes) = e8 33 ef 38 5f
...
00d0h mov rcx,7FF7C7D60C88h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7d60c88h:imm64]         encoding(10 bytes) = 48 b9 88 0c d6 c7 f7 7f 00 00
00dah call 7FF826EEEF00h            ; CALL(Call_rel32_64) [5F32EF00h:jmp64]                encoding(5 bytes) = e8 21 ee 32 5f
...
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> vand_dynamic(Vector256<uint> a, Vector256<uint> b)
; location: [7FF7C7BC0110h, 7FF7C7BC013Fh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h call 7FF7C7BC0000h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64]        encoding(5 bytes) = e8 db fe ff ff
...
; location: [7FF7C7BC0560h, 7FF7C7BC0591h]
...
; location: [7FF7C7BC05B0h, 7FF7C7BC05D3h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
0009h mov rax,26D6D048071h          ; MOV(Mov_r64_imm64) [RAX,26d6d048071h:imm64]          encoding(10 bytes) = 48 b8 71 80 04 6d 6d 02 00 00
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0x71,0x80,0x04,0x6D,0x6D,0x02,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<int> vpermvar8x32_256x32i(Vector256<int> src, Vector256<uint> spec)
; location: [7FF7C7BC05F0h, 7FF7C7BC060Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
...
; location: [7FF7C7BC0620h, 7FF7C7BC063Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BC0650h, 7FF7C7BC06A0h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,26D6D048521h          ; MOV(Mov_r64_imm64) [RAX,26d6d048521h:imm64]          encoding(10 bytes) = 48 b8 21 85 04 6d 6d 02 00 00
...
002bh mov rax,26D6D048051h          ; MOV(Mov_r64_imm64) [RAX,26d6d048051h:imm64]          encoding(10 bytes) = 48 b8 51 80 04 6d 6d 02 00 00
...
; location: [7FF7C7BC06F0h, 7FF7C7BC070Ah]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h vmovupd xmm1,[r8]             ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM1,mem(Packed128_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 79 10 08
...
; location: [7FF7C7BC0720h, 7FF7C7BC073Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BC0750h, 7FF7C7BC076Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BC0780h, 7FF7C7BC07E1h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
