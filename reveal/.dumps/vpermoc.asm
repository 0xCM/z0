...
0014h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F3B0040h:jmp64]                encoding(5 bytes) = e8 27 00 3b 5f
...
002bh call 7FF826FA6E40h            ; CALL(Call_rel32_64) [5F407E90h:jmp64]                encoding(5 bytes) = e8 60 7e 40 5f
0030h mov rdi,rax                   ; MOV(Mov_r64_rm64) [RDI,RAX]                          encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C763D028h         ; MOV(Mov_r64_imm64) [RCX,7ff7c763d028h:imm64]         encoding(10 bytes) = 48 b9 28 d0 63 c7 f7 7f 00 00
003dh call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F3B0040h:jmp64]                encoding(5 bytes) = e8 fe ff 3a 5f
...
004dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F406F60h:jmp64]                encoding(5 bytes) = e8 0e 6f 40 5f
...
005dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F406F60h:jmp64]                encoding(5 bytes) = e8 fe 6e 40 5f
...
0076h mov rdx,188C08806E8h          ; MOV(Mov_r64_imm64) [RDX,188c08806e8h:imm64]          encoding(10 bytes) = 48 ba e8 06 88 c0 88 01 00 00
...
008fh call 7FF825DACEB0h            ; CALL(Call_rel32_64) [5E20DF00h:jmp64]                encoding(5 bytes) = e8 6c de 20 5e
...
00a6h call 7FF7C7B9E7D0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF820h:jmp64]        encoding(5 bytes) = e8 75 f7 ff ff
00abh mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C7D40950h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7d40950h:imm64]         encoding(10 bytes) = 48 b9 50 09 d4 c7 f7 7f 00 00
00b8h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F3B0040h:jmp64]                encoding(5 bytes) = e8 83 ff 3a 5f
...
00d0h mov rcx,7FF7C7D40950h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7d40950h:imm64]         encoding(10 bytes) = 48 b9 50 09 d4 c7 f7 7f 00 00
00dah call 7FF826EEEF00h            ; CALL(Call_rel32_64) [5F34FF50h:jmp64]                encoding(5 bytes) = e8 71 fe 34 5f
...
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> vand_dynamic(Vector256<uint> a, Vector256<uint> b)
; location: [7FF7C7B9F0C0h, 7FF7C7B9F0EFh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h call 7FF7C7B9EFB0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64]        encoding(5 bytes) = e8 db fe ff ff
...
; location: [7FF7C7B9F920h, 7FF7C7B9F951h]
...
; location: [7FF7C7B9F970h, 7FF7C7B9F993h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
0009h mov rax,188C9565CF1h          ; MOV(Mov_r64_imm64) [RAX,188c9565cf1h:imm64]          encoding(10 bytes) = 48 b8 f1 5c 56 c9 88 01 00 00
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0xF1,0x5C,0x56,0xC9,0x88,0x01,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<int> vpermvar8x32_256x32i(Vector256<int> src, Vector256<uint> spec)
; location: [7FF7C7B9F9B0h, 7FF7C7B9F9CDh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
...
; location: [7FF7C7B9F9E0h, 7FF7C7B9F9FDh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7B9FA10h, 7FF7C7B9FA60h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,188C95661A1h          ; MOV(Mov_r64_imm64) [RAX,188c95661a1h:imm64]          encoding(10 bytes) = 48 b8 a1 61 56 c9 88 01 00 00
...
002bh mov rax,188C9565CD1h          ; MOV(Mov_r64_imm64) [RAX,188c9565cd1h:imm64]          encoding(10 bytes) = 48 b8 d1 5c 56 c9 88 01 00 00
...
; location: [7FF7C7B9FAB0h, 7FF7C7B9FACAh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h vmovupd xmm1,[r8]             ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM1,mem(Packed128_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 79 10 08
...
; location: [7FF7C7B9FAE0h, 7FF7C7B9FAFDh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7B9FB10h, 7FF7C7B9FB2Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7B9FB40h, 7FF7C7B9FBA1h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
