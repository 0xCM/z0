...
0014h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F39F740h:jmp64]                encoding(5 bytes) = e8 27 f7 39 5f
...
002bh call 7FF826FA6E40h            ; CALL(Call_rel32_64) [5F3F7590h:jmp64]                encoding(5 bytes) = e8 60 75 3f 5f
0030h mov rdi,rax                   ; MOV(Mov_r64_rm64) [RDI,RAX]                          encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C764D390h         ; MOV(Mov_r64_imm64) [RCX,7ff7c764d390h:imm64]         encoding(10 bytes) = 48 b9 90 d3 64 c7 f7 7f 00 00
003dh call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F39F740h:jmp64]                encoding(5 bytes) = e8 fe f6 39 5f
...
004dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F3F6660h:jmp64]                encoding(5 bytes) = e8 0e 66 3f 5f
...
005dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F3F6660h:jmp64]                encoding(5 bytes) = e8 fe 65 3f 5f
...
0076h mov rdx,274128A0700h          ; MOV(Mov_r64_imm64) [RDX,274128a0700h:imm64]          encoding(10 bytes) = 48 ba 00 07 8a 12 74 02 00 00
...
008fh call 7FF825DACEB0h            ; CALL(Call_rel32_64) [5E1FD600h:jmp64]                encoding(5 bytes) = e8 6c d5 1f 5e
...
00a6h call 7FF7C7BAF0C0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF810h:jmp64]        encoding(5 bytes) = e8 65 f7 ff ff
00abh mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C7D55D40h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7d55d40h:imm64]         encoding(10 bytes) = 48 b9 40 5d d5 c7 f7 7f 00 00
00b8h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F39F740h:jmp64]                encoding(5 bytes) = e8 83 f6 39 5f
...
00d0h mov rcx,7FF7C7D55D40h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7d55d40h:imm64]         encoding(10 bytes) = 48 b9 40 5d d5 c7 f7 7f 00 00
00dah call 7FF826EEEF00h            ; CALL(Call_rel32_64) [5F33F650h:jmp64]                encoding(5 bytes) = e8 71 f5 33 5f
...
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> vand_dynamic(Vector256<uint> a, Vector256<uint> b)
; location: [7FF7C7BAF9C0h, 7FF7C7BAF9EFh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h call 7FF7C7BAF8B0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64]        encoding(5 bytes) = e8 db fe ff ff
...
; location: [7FF7C7BB0220h, 7FF7C7BB0251h]
...
; location: [7FF7C7BB0270h, 7FF7C7BB0293h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
0009h mov rax,2741B3E5AADh          ; MOV(Mov_r64_imm64) [RAX,2741b3e5aadh:imm64]          encoding(10 bytes) = 48 b8 ad 5a 3e 1b 74 02 00 00
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0xAD,0x5A,0x3E,0x1B,0x74,0x02,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<int> vpermvar8x32_256x32i(Vector256<int> src, Vector256<uint> spec)
; location: [7FF7C7BB02B0h, 7FF7C7BB02CDh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
...
; location: [7FF7C7BB02E0h, 7FF7C7BB02FDh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BB0310h, 7FF7C7BB0360h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,2741B3E5F5Dh          ; MOV(Mov_r64_imm64) [RAX,2741b3e5f5dh:imm64]          encoding(10 bytes) = 48 b8 5d 5f 3e 1b 74 02 00 00
...
002bh mov rax,2741B3E5A8Dh          ; MOV(Mov_r64_imm64) [RAX,2741b3e5a8dh:imm64]          encoding(10 bytes) = 48 b8 8d 5a 3e 1b 74 02 00 00
...
; location: [7FF7C7BB03B0h, 7FF7C7BB03CAh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h vmovupd xmm1,[r8]             ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM1,mem(Packed128_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 79 10 08
...
; location: [7FF7C7BB03E0h, 7FF7C7BB03FDh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BB0410h, 7FF7C7BB042Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BB0440h, 7FF7C7BB04A1h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
