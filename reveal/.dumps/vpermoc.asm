...
0014h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F3876C0h:jmp64]                encoding(5 bytes) = e8 a7 76 38 5f
...
002bh call 7FF826FA6E40h            ; CALL(Call_rel32_64) [5F3DF510h:jmp64]                encoding(5 bytes) = e8 e0 f4 3d 5f
0030h mov rdi,rax                   ; MOV(Mov_r64_rm64) [RDI,RAX]                          encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C7AE4290h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7ae4290h:imm64]         encoding(10 bytes) = 48 b9 90 42 ae c7 f7 7f 00 00
003dh call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F3876C0h:jmp64]                encoding(5 bytes) = e8 7e 76 38 5f
...
004dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F3DE5E0h:jmp64]                encoding(5 bytes) = e8 8e e5 3d 5f
...
005dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F3DE5E0h:jmp64]                encoding(5 bytes) = e8 7e e5 3d 5f
...
0076h mov rdx,1F1C7518EC0h          ; MOV(Mov_r64_imm64) [RDX,1f1c7518ec0h:imm64]          encoding(10 bytes) = 48 ba c0 8e 51 c7 f1 01 00 00
...
008fh call 7FF825DACEB0h            ; CALL(Call_rel32_64) [5E1E5580h:jmp64]                encoding(5 bytes) = e8 ec 54 1e 5e
...
00a6h call 7FF7C7BC6BB8h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF288h:jmp64]        encoding(5 bytes) = e8 dd f1 ff ff
00abh mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C7D8DC98h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7d8dc98h:imm64]         encoding(10 bytes) = 48 b9 98 dc d8 c7 f7 7f 00 00
00b8h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F3876C0h:jmp64]                encoding(5 bytes) = e8 03 76 38 5f
...
00d0h mov rcx,7FF7C7D8DC98h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7d8dc98h:imm64]         encoding(10 bytes) = 48 b9 98 dc d8 c7 f7 7f 00 00
00dah call 7FF826EEEF00h            ; CALL(Call_rel32_64) [5F3275D0h:jmp64]                encoding(5 bytes) = e8 f1 74 32 5f
...
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> vand_dynamic(Vector256<uint> a, Vector256<uint> b)
; location: [7FF7C7BC7A40h, 7FF7C7BC7A6Fh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h call 7FF7C7BC7930h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64]        encoding(5 bytes) = e8 db fe ff ff
...
; location: [7FF7C7BC7E90h, 7FF7C7BC7EC1h]
...
; location: [7FF7C7BC7EE0h, 7FF7C7BC7F03h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
0009h mov rax,1F1D004EDD9h          ; MOV(Mov_r64_imm64) [RAX,1f1d004edd9h:imm64]          encoding(10 bytes) = 48 b8 d9 ed 04 d0 f1 01 00 00
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0xD9,0xED,0x04,0xD0,0xF1,0x01,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<int> vpermvar8x32_256x32i(Vector256<int> src, Vector256<uint> spec)
; location: [7FF7C7BC7F20h, 7FF7C7BC7F3Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
...
; location: [7FF7C7BC7F50h, 7FF7C7BC7F6Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BC7F80h, 7FF7C7BC7FD0h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,1F1D004F249h          ; MOV(Mov_r64_imm64) [RAX,1f1d004f249h:imm64]          encoding(10 bytes) = 48 b8 49 f2 04 d0 f1 01 00 00
...
002bh mov rax,1F1D004EDB9h          ; MOV(Mov_r64_imm64) [RAX,1f1d004edb9h:imm64]          encoding(10 bytes) = 48 b8 b9 ed 04 d0 f1 01 00 00
...
; location: [7FF7C7BC8020h, 7FF7C7BC803Ah]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h vmovupd xmm1,[r8]             ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM1,mem(Packed128_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 79 10 08
...
; location: [7FF7C7BC8050h, 7FF7C7BC806Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BC8080h, 7FF7C7BC809Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BC80B0h, 7FF7C7BC8111h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
