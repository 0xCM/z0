...
000ah mov rcx,7FF7C77E2798h         ; MOV(Mov_r64_imm64) [RCX,7ff7c77e2798h:imm64]         encoding(10 bytes) = 48 b9 98 27 7e c7 f7 7f 00 00
0014h call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F1FF840h:jmp64]                encoding(5 bytes) = e8 27 f8 1f 5f
0019h mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
001ch mov rcx,7FF7C77D7788h         ; MOV(Mov_r64_imm64) [RCX,7ff7c77d7788h:imm64]         encoding(10 bytes) = 48 b9 88 77 7d c7 f7 7f 00 00
0026h mov edx,2                     ; MOV(Mov_r32_imm32) [EDX,2h:imm32]                    encoding(5 bytes) = ba 02 00 00 00
002bh call 7FF827266E40h            ; CALL(Call_rel32_64) [5F257690h:jmp64]                encoding(5 bytes) = e8 60 76 25 5f
0030h mov rdi,rax                   ; MOV(Mov_r64_rm64) [RDI,RAX]                          encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C790D118h         ; MOV(Mov_r64_imm64) [RCX,7ff7c790d118h:imm64]         encoding(10 bytes) = 48 b9 18 d1 90 c7 f7 7f 00 00
003dh call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F1FF840h:jmp64]                encoding(5 bytes) = e8 fe f7 1f 5f
...
004dh call 7FF827265F10h            ; CALL(Call_rel32_64) [5F256760h:jmp64]                encoding(5 bytes) = e8 0e 67 25 5f
...
005dh call 7FF827265F10h            ; CALL(Call_rel32_64) [5F256760h:jmp64]                encoding(5 bytes) = e8 fe 66 25 5f
...
0076h mov rdx,1FA67C906B8h          ; MOV(Mov_r64_imm64) [RDX,1fa67c906b8h:imm64]          encoding(10 bytes) = 48 ba b8 06 c9 67 fa 01 00 00
...
008fh call 7FF825DACEB0h            ; CALL(Call_rel32_64) [5DD9D700h:jmp64]                encoding(5 bytes) = e8 6c d6 d9 5d
...
00a6h call 7FF7C800F168h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF9B8h:jmp64]        encoding(5 bytes) = e8 0d f9 ff ff
00abh mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C81C3D70h         ; MOV(Mov_r64_imm64) [RCX,7ff7c81c3d70h:imm64]         encoding(10 bytes) = 48 b9 70 3d 1c c8 f7 7f 00 00
00b8h call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F1FF840h:jmp64]                encoding(5 bytes) = e8 83 f7 1f 5f
...
00d0h mov rcx,7FF7C81C3D70h         ; MOV(Mov_r64_imm64) [RCX,7ff7c81c3d70h:imm64]         encoding(10 bytes) = 48 b9 70 3d 1c c8 f7 7f 00 00
00dah call 7FF8271AEF00h            ; CALL(Call_rel32_64) [5F19F750h:jmp64]                encoding(5 bytes) = e8 71 f6 19 5f
...
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> vand_dynamic(Vector256<uint> a, Vector256<uint> b)
; location: [7FF7C800F8C0h, 7FF7C800F8EFh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h call 7FF7C800F7B0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64]        encoding(5 bytes) = e8 db fe ff ff
...
; location: [7FF7C800FD10h, 7FF7C800FD41h]
...
; location: [7FF7C800FD60h, 7FF7C800FD83h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
0009h mov rax,1FA708E5085h          ; MOV(Mov_r64_imm64) [RAX,1fa708e5085h:imm64]          encoding(10 bytes) = 48 b8 85 50 8e 70 fa 01 00 00
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0x85,0x50,0x8E,0x70,0xFA,0x01,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<int> vpermvar8x32_256x32i(Vector256<int> src, Vector256<uint> spec)
; location: [7FF7C800FDA0h, 7FF7C800FDBDh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
...
; location: [7FF7C800FDD0h, 7FF7C800FDEDh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C800FE00h, 7FF7C800FE50h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,1FA708E5535h          ; MOV(Mov_r64_imm64) [RAX,1fa708e5535h:imm64]          encoding(10 bytes) = 48 b8 35 55 8e 70 fa 01 00 00
...
002bh mov rax,1FA708E5065h          ; MOV(Mov_r64_imm64) [RAX,1fa708e5065h:imm64]          encoding(10 bytes) = 48 b8 65 50 8e 70 fa 01 00 00
...
; location: [7FF7C800FEA0h, 7FF7C800FEBAh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h vmovupd xmm1,[r8]             ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM1,mem(Packed128_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 79 10 08
...
; location: [7FF7C800FED0h, 7FF7C800FEEDh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C800FF00h, 7FF7C800FF1Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C800FF30h, 7FF7C800FF91h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
