...
000ah mov rcx,7FF7C7542798h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7542798h:imm64]         encoding(10 bytes) = 48 b9 98 27 54 c7 f7 7f 00 00
0014h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F3896C0h:jmp64]                encoding(5 bytes) = e8 a7 96 38 5f
0019h mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
001ch mov rcx,7FF7C7537788h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7537788h:imm64]         encoding(10 bytes) = 48 b9 88 77 53 c7 f7 7f 00 00
0026h mov edx,2                     ; MOV(Mov_r32_imm32) [EDX,2h:imm32]                    encoding(5 bytes) = ba 02 00 00 00
002bh call 7FF826FA6E40h            ; CALL(Call_rel32_64) [5F3E1510h:jmp64]                encoding(5 bytes) = e8 e0 14 3e 5f
0030h mov rdi,rax                   ; MOV(Mov_r64_rm64) [RDI,RAX]                          encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C766DF28h         ; MOV(Mov_r64_imm64) [RCX,7ff7c766df28h:imm64]         encoding(10 bytes) = 48 b9 28 df 66 c7 f7 7f 00 00
003dh call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F3896C0h:jmp64]                encoding(5 bytes) = e8 7e 96 38 5f
...
004dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F3E05E0h:jmp64]                encoding(5 bytes) = e8 8e 05 3e 5f
...
005dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F3E05E0h:jmp64]                encoding(5 bytes) = e8 7e 05 3e 5f
...
0076h mov rdx,2B7B4280A70h          ; MOV(Mov_r64_imm64) [RDX,2b7b4280a70h:imm64]          encoding(10 bytes) = 48 ba 70 0a 28 b4 b7 02 00 00
...
008fh call 7FF825DACEB0h            ; CALL(Call_rel32_64) [5E1E7580h:jmp64]                encoding(5 bytes) = e8 ec 74 1e 5e
...
00a6h call 7FF7C7BC51F8h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF8C8h:jmp64]        encoding(5 bytes) = e8 1d f8 ff ff
00abh mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C7D9C198h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7d9c198h:imm64]         encoding(10 bytes) = 48 b9 98 c1 d9 c7 f7 7f 00 00
00b8h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F3896C0h:jmp64]                encoding(5 bytes) = e8 03 96 38 5f
...
00d0h mov rcx,7FF7C7D9C198h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7d9c198h:imm64]         encoding(10 bytes) = 48 b9 98 c1 d9 c7 f7 7f 00 00
00dah call 7FF826EEEF00h            ; CALL(Call_rel32_64) [5F3295D0h:jmp64]                encoding(5 bytes) = e8 f1 94 32 5f
...
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> vand_dynamic(Vector256<uint> a, Vector256<uint> b)
; location: [7FF7C7BC5A40h, 7FF7C7BC5A6Fh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h call 7FF7C7BC5930h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64]        encoding(5 bytes) = e8 db fe ff ff
...
; location: [7FF7C7BC5E90h, 7FF7C7BC5EC1h]
...
; location: [7FF7C7BC5EE0h, 7FF7C7BC5F03h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
0009h mov rax,2B7BCE9F009h          ; MOV(Mov_r64_imm64) [RAX,2b7bce9f009h:imm64]          encoding(10 bytes) = 48 b8 09 f0 e9 bc b7 02 00 00
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0x09,0xF0,0xE9,0xBC,0xB7,0x02,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<int> vpermvar8x32_256x32i(Vector256<int> src, Vector256<uint> spec)
; location: [7FF7C7BC5F20h, 7FF7C7BC5F3Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
...
; location: [7FF7C7BC5F50h, 7FF7C7BC5F6Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BC5F80h, 7FF7C7BC5FD0h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,2B7BCE9F479h          ; MOV(Mov_r64_imm64) [RAX,2b7bce9f479h:imm64]          encoding(10 bytes) = 48 b8 79 f4 e9 bc b7 02 00 00
...
002bh mov rax,2B7BCE9EFE9h          ; MOV(Mov_r64_imm64) [RAX,2b7bce9efe9h:imm64]          encoding(10 bytes) = 48 b8 e9 ef e9 bc b7 02 00 00
...
; location: [7FF7C7BC6020h, 7FF7C7BC603Ah]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h vmovupd xmm1,[r8]             ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM1,mem(Packed128_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 79 10 08
...
; location: [7FF7C7BC6050h, 7FF7C7BC606Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BC6080h, 7FF7C7BC609Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BC60B0h, 7FF7C7BC6111h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
