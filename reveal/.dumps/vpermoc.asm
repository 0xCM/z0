...
0014h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F380A90h:jmp64]                encoding(5 bytes) = e8 77 0a 38 5f
...
002bh call 7FF826FA6E40h            ; CALL(Call_rel32_64) [5F3D88E0h:jmp64]                encoding(5 bytes) = e8 b0 88 3d 5f
0030h mov rdi,rax                   ; MOV(Mov_r64_rm64) [RDI,RAX]                          encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C766D088h         ; MOV(Mov_r64_imm64) [RCX,7ff7c766d088h:imm64]         encoding(10 bytes) = 48 b9 88 d0 66 c7 f7 7f 00 00
003dh call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F380A90h:jmp64]                encoding(5 bytes) = e8 4e 0a 38 5f
...
004dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F3D79B0h:jmp64]                encoding(5 bytes) = e8 5e 79 3d 5f
...
005dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F3D79B0h:jmp64]                encoding(5 bytes) = e8 4e 79 3d 5f
...
0076h mov rdx,1C3A51E0648h          ; MOV(Mov_r64_imm64) [RDX,1c3a51e0648h:imm64]          encoding(10 bytes) = 48 ba 48 06 1e a5 c3 01 00 00
...
008fh call 7FF825DACEB0h            ; CALL(Call_rel32_64) [5E1DE950h:jmp64]                encoding(5 bytes) = e8 bc e8 1d 5e
...
00a6h call 7FF7C7BCDEF0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF990h:jmp64]        encoding(5 bytes) = e8 e5 f8 ff ff
00abh mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C7D67FB0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7d67fb0h:imm64]         encoding(10 bytes) = 48 b9 b0 7f d6 c7 f7 7f 00 00
00b8h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F380A90h:jmp64]                encoding(5 bytes) = e8 d3 09 38 5f
...
00d0h mov rcx,7FF7C7D67FB0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7d67fb0h:imm64]         encoding(10 bytes) = 48 b9 b0 7f d6 c7 f7 7f 00 00
00dah call 7FF826EEEF00h            ; CALL(Call_rel32_64) [5F3209A0h:jmp64]                encoding(5 bytes) = e8 c1 08 32 5f
...
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> vand_dynamic(Vector256<uint> a, Vector256<uint> b)
; location: [7FF7C7BCE670h, 7FF7C7BCE69Fh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h call 7FF7C7BCE560h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64]        encoding(5 bytes) = e8 db fe ff ff
...
; location: [7FF7C7BCEAC0h, 7FF7C7BCEAF1h]
...
; location: [7FF7C7BCEB10h, 7FF7C7BCEB33h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
0009h mov rax,1C3ADD14C51h          ; MOV(Mov_r64_imm64) [RAX,1c3add14c51h:imm64]          encoding(10 bytes) = 48 b8 51 4c d1 ad c3 01 00 00
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0x51,0x4C,0xD1,0xAD,0xC3,0x01,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<int> vpermvar8x32_256x32i(Vector256<int> src, Vector256<uint> spec)
; location: [7FF7C7BCEB50h, 7FF7C7BCEB6Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
...
; location: [7FF7C7BCEB80h, 7FF7C7BCEB9Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BCEBB0h, 7FF7C7BCEC00h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,1C3ADD15101h          ; MOV(Mov_r64_imm64) [RAX,1c3add15101h:imm64]          encoding(10 bytes) = 48 b8 01 51 d1 ad c3 01 00 00
...
002bh mov rax,1C3ADD14C31h          ; MOV(Mov_r64_imm64) [RAX,1c3add14c31h:imm64]          encoding(10 bytes) = 48 b8 31 4c d1 ad c3 01 00 00
...
; location: [7FF7C7BCEC50h, 7FF7C7BCEC6Ah]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h vmovupd xmm1,[r8]             ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM1,mem(Packed128_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 79 10 08
...
; location: [7FF7C7BCEC80h, 7FF7C7BCEC9Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BCECB0h, 7FF7C7BCECCDh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BCECE0h, 7FF7C7BCED41h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
