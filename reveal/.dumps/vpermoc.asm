; 2020-01-08 22:54:01:603
; function: Func<Vector256<uint>,Vector256<uint>,Vector256<uint>> vand_delgate()
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
...
000ah mov rcx,7FF7B6192798h                   ; MOV(Mov_r64_imm64) [RCX,7ff7b6192798h:imm64] encoding(10 bytes) = 48 b9 98 27 19 b6 f7 7f 00 00
0014h call 7FF815BBEFF0h                      ; CALL(Call_rel32_64) [5F3C8CE0h:jmp64]      encoding(5 bytes) = e8 c7 8c 3c 5f
0019h mov rsi,rax                             ; MOV(Mov_r64_rm64) [RSI,RAX]                encoding(3 bytes) = 48 8b f0
001ch mov rcx,7FF7B6187788h                   ; MOV(Mov_r64_imm64) [RCX,7ff7b6187788h:imm64] encoding(10 bytes) = 48 b9 88 77 18 b6 f7 7f 00 00
0026h mov edx,2                               ; MOV(Mov_r32_imm32) [EDX,2h:imm32]          encoding(5 bytes) = ba 02 00 00 00
002bh call 7FF815C16E40h                      ; CALL(Call_rel32_64) [5F420B30h:jmp64]      encoding(5 bytes) = e8 00 0b 42 5f
0030h mov rdi,rax                             ; MOV(Mov_r64_rm64) [RDI,RAX]                encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7B676BFE0h                   ; MOV(Mov_r64_imm64) [RCX,7ff7b676bfe0h:imm64] encoding(10 bytes) = 48 b9 e0 bf 76 b6 f7 7f 00 00
003dh call 7FF815BBEFF0h                      ; CALL(Call_rel32_64) [5F3C8CE0h:jmp64]      encoding(5 bytes) = e8 9e 8c 3c 5f
...
004dh call 7FF815C15F10h                      ; CALL(Call_rel32_64) [5F41FC00h:jmp64]      encoding(5 bytes) = e8 ae fb 41 5f
...
005dh call 7FF815C15F10h                      ; CALL(Call_rel32_64) [5F41FC00h:jmp64]      encoding(5 bytes) = e8 9e fb 41 5f
...
0076h mov rdx,20E9B1509C8h                    ; MOV(Mov_r64_imm64) [RDX,20e9b1509c8h:imm64] encoding(10 bytes) = 48 ba c8 09 15 9b 0e 02 00 00
...
008fh call 7FF81477CEB0h                      ; CALL(Call_rel32_64) [5DF86BA0h:jmp64]      encoding(5 bytes) = e8 0c 6b f8 5d
...
00a6h call 7FF7B67F5C48h                      ; CALL(Call_rel32_64) [FFFFFFFFFFFFF938h:jmp64] encoding(5 bytes) = e8 8d f8 ff ff
00abh mov rsi,rax                             ; MOV(Mov_r64_rm64) [RSI,RAX]                encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7B69E5EA0h                   ; MOV(Mov_r64_imm64) [RCX,7ff7b69e5ea0h:imm64] encoding(10 bytes) = 48 b9 a0 5e 9e b6 f7 7f 00 00
00b8h call 7FF815BBEFF0h                      ; CALL(Call_rel32_64) [5F3C8CE0h:jmp64]      encoding(5 bytes) = e8 23 8c 3c 5f
...
00d0h mov rcx,7FF7B69E5EA0h                   ; MOV(Mov_r64_imm64) [RCX,7ff7b69e5ea0h:imm64] encoding(10 bytes) = 48 b9 a0 5e 9e b6 f7 7f 00 00
00dah call 7FF815B5EF00h                      ; CALL(Call_rel32_64) [5F368BF0h:jmp64]      encoding(5 bytes) = e8 11 8b 36 5f
...
0010h call 7FF7B67F6310h                      ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64] encoding(5 bytes) = e8 db fe ff ff
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0x3D,0xD8,0xD6,0xA3,0x0E,0x02,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
0000h vzeroupper                              ; VZEROUPPER(VEX_Vzeroupper)                 encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                              ; NOP(Nopw)                                  encoding(2 bytes) = 66 90
...
0009h mov rax,20EA3D6D83Dh                    ; MOV(Mov_r64_imm64) [RAX,20ea3d6d83dh:imm64] encoding(10 bytes) = 48 b8 3d d8 d6 a3 0e 02 00 00
...
002bh mov rax,20EA3D6D81Dh                    ; MOV(Mov_r64_imm64) [RAX,20ea3d6d81dh:imm64] encoding(10 bytes) = 48 b8 1d d8 d6 a3 0e 02 00 00
