; 2020-01-05 20:14:03:081
; function: Func<Vector256<uint>,Vector256<uint>,Vector256<uint>> vand_delgate()
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
...
000ah mov rcx,7FF7B4E12798h                   ; MOV(Mov_r64_imm64) [RCX,7ff7b4e12798h:imm64] encoding(10 bytes) = 48 b9 98 27 e1 b4 f7 7f 00 00
0014h call 7FF81481EFF0h                      ; CALL(Call_rel32_64) [5F176120h:jmp64]      encoding(5 bytes) = e8 07 61 17 5f
0019h mov rsi,rax                             ; MOV(Mov_r64_rm64) [RSI,RAX]                encoding(3 bytes) = 48 8b f0
001ch mov rcx,7FF7B4E07788h                   ; MOV(Mov_r64_imm64) [RCX,7ff7b4e07788h:imm64] encoding(10 bytes) = 48 b9 88 77 e0 b4 f7 7f 00 00
0026h mov edx,2                               ; MOV(Mov_r32_imm32) [EDX,2h:imm32]          encoding(5 bytes) = ba 02 00 00 00
002bh call 7FF814876E40h                      ; CALL(Call_rel32_64) [5F1CDF70h:jmp64]      encoding(5 bytes) = e8 40 df 1c 5f
0030h mov rdi,rax                             ; MOV(Mov_r64_rm64) [RDI,RAX]                encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7B54AFBE0h                   ; MOV(Mov_r64_imm64) [RCX,7ff7b54afbe0h:imm64] encoding(10 bytes) = 48 b9 e0 fb 4a b5 f7 7f 00 00
003dh call 7FF81481EFF0h                      ; CALL(Call_rel32_64) [5F176120h:jmp64]      encoding(5 bytes) = e8 de 60 17 5f
...
004dh call 7FF814875F10h                      ; CALL(Call_rel32_64) [5F1CD040h:jmp64]      encoding(5 bytes) = e8 ee cf 1c 5f
...
005dh call 7FF814875F10h                      ; CALL(Call_rel32_64) [5F1CD040h:jmp64]      encoding(5 bytes) = e8 de cf 1c 5f
...
0076h mov rdx,13C100159A8h                    ; MOV(Mov_r64_imm64) [RDX,13c100159a8h:imm64] encoding(10 bytes) = 48 ba a8 59 01 10 3c 01 00 00
...
008fh call 7FF81420CEB0h                      ; CALL(Call_rel32_64) [5EB63FE0h:jmp64]      encoding(5 bytes) = e8 4c 3f b6 5e
...
00a6h call 7FF7B56A8898h                      ; CALL(Call_rel32_64) [FFFFFFFFFFFFF9C8h:jmp64] encoding(5 bytes) = e8 1d f9 ff ff
00abh mov rsi,rax                             ; MOV(Mov_r64_rm64) [RSI,RAX]                encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7B5769C80h                   ; MOV(Mov_r64_imm64) [RCX,7ff7b5769c80h:imm64] encoding(10 bytes) = 48 b9 80 9c 76 b5 f7 7f 00 00
00b8h call 7FF81481EFF0h                      ; CALL(Call_rel32_64) [5F176120h:jmp64]      encoding(5 bytes) = e8 63 60 17 5f
...
00d0h mov rcx,7FF7B5769C80h                   ; MOV(Mov_r64_imm64) [RCX,7ff7b5769c80h:imm64] encoding(10 bytes) = 48 b9 80 9c 76 b5 f7 7f 00 00
00dah call 7FF8147BEF00h                      ; CALL(Call_rel32_64) [5F116030h:jmp64]      encoding(5 bytes) = e8 51 5f 11 5f
...
0010h call 7FF7B56A8ED0h                      ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64] encoding(5 bytes) = e8 db fe ff ff
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0xD9,0xED,0xDD,0x7E,0x3C,0x01,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
0000h vzeroupper                              ; VZEROUPPER(VEX_Vzeroupper)                 encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                              ; NOP(Nopw)                                  encoding(2 bytes) = 66 90
...
0009h mov rax,13C7EDDEDD9h                    ; MOV(Mov_r64_imm64) [RAX,13c7eddedd9h:imm64] encoding(10 bytes) = 48 b8 d9 ed dd 7e 3c 01 00 00
...
0005h vmovupd ymm0,[rdx]                      ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]                       ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,13C7EDDF249h                    ; MOV(Mov_r64_imm64) [RAX,13c7eddf249h:imm64] encoding(10 bytes) = 48 b8 49 f2 dd 7e 3c 01 00 00
...
002bh mov rax,13C7EDDEDB9h                    ; MOV(Mov_r64_imm64) [RAX,13c7eddedb9h:imm64] encoding(10 bytes) = 48 b8 b9 ed dd 7e 3c 01 00 00
