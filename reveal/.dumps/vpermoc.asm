...
0014h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F39F850h:jmp64]                encoding(5 bytes) = e8 37 f8 39 5f
...
002bh call 7FF826FA6E40h            ; CALL(Call_rel32_64) [5F3F76A0h:jmp64]                encoding(5 bytes) = e8 70 76 3f 5f
0030h mov rdi,rax                   ; MOV(Mov_r64_rm64) [RDI,RAX]                          encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C764D218h         ; MOV(Mov_r64_imm64) [RCX,7ff7c764d218h:imm64]         encoding(10 bytes) = 48 b9 18 d2 64 c7 f7 7f 00 00
003dh call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F39F850h:jmp64]                encoding(5 bytes) = e8 0e f8 39 5f
...
004dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F3F6770h:jmp64]                encoding(5 bytes) = e8 1e 67 3f 5f
...
005dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F3F6770h:jmp64]                encoding(5 bytes) = e8 0e 67 3f 5f
...
0076h mov rdx,20FBED406B8h          ; MOV(Mov_r64_imm64) [RDX,20fbed406b8h:imm64]          encoding(10 bytes) = 48 ba b8 06 d4 be 0f 02 00 00
...
008fh call 7FF825DACEB0h            ; CALL(Call_rel32_64) [5E1FD710h:jmp64]                encoding(5 bytes) = e8 7c d6 1f 5e
...
00a6h call 7FF7C7BAF158h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF9B8h:jmp64]        encoding(5 bytes) = e8 0d f9 ff ff
00abh mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C7D543D0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7d543d0h:imm64]         encoding(10 bytes) = 48 b9 d0 43 d5 c7 f7 7f 00 00
00b8h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F39F850h:jmp64]                encoding(5 bytes) = e8 93 f7 39 5f
...
00d0h mov rcx,7FF7C7D543D0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7d543d0h:imm64]         encoding(10 bytes) = 48 b9 d0 43 d5 c7 f7 7f 00 00
00dah call 7FF826EEEF00h            ; CALL(Call_rel32_64) [5F33F760h:jmp64]                encoding(5 bytes) = e8 81 f6 33 5f
...
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> vand_dynamic(Vector256<uint> a, Vector256<uint> b)
; location: [7FF7C7BAF8B0h, 7FF7C7BAF8DFh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h call 7FF7C7BAF7A0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64]        encoding(5 bytes) = e8 db fe ff ff
...
; location: [7FF7C7BAFD00h, 7FF7C7BAFD31h]
...
; location: [7FF7C7BAFD50h, 7FF7C7BAFD73h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
0009h mov rax,20FC7955985h          ; MOV(Mov_r64_imm64) [RAX,20fc7955985h:imm64]          encoding(10 bytes) = 48 b8 85 59 95 c7 0f 02 00 00
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0x85,0x59,0x95,0xC7,0x0F,0x02,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<int> vpermvar8x32_256x32i(Vector256<int> src, Vector256<uint> spec)
; location: [7FF7C7BAFD90h, 7FF7C7BAFDADh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
...
; location: [7FF7C7BAFDC0h, 7FF7C7BAFDDDh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BAFDF0h, 7FF7C7BAFE40h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,20FC7955E35h          ; MOV(Mov_r64_imm64) [RAX,20fc7955e35h:imm64]          encoding(10 bytes) = 48 b8 35 5e 95 c7 0f 02 00 00
...
002bh mov rax,20FC7955965h          ; MOV(Mov_r64_imm64) [RAX,20fc7955965h:imm64]          encoding(10 bytes) = 48 b8 65 59 95 c7 0f 02 00 00
...
; location: [7FF7C7BAFE90h, 7FF7C7BAFEAAh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h vmovupd xmm1,[r8]             ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM1,mem(Packed128_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 79 10 08
...
; location: [7FF7C7BAFEC0h, 7FF7C7BAFEDDh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BAFEF0h, 7FF7C7BAFF0Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BAFF20h, 7FF7C7BAFF81h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
