...
0014h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F3AF7B0h:jmp64]                encoding(5 bytes) = e8 97 f7 3a 5f
...
002bh call 7FF826FA6E40h            ; CALL(Call_rel32_64) [5F407600h:jmp64]                encoding(5 bytes) = e8 d0 75 40 5f
0030h mov rdi,rax                   ; MOV(Mov_r64_rm64) [RDI,RAX]                          encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C763D2C0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c763d2c0h:imm64]         encoding(10 bytes) = 48 b9 c0 d2 63 c7 f7 7f 00 00
003dh call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F3AF7B0h:jmp64]                encoding(5 bytes) = e8 6e f7 3a 5f
...
004dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F4066D0h:jmp64]                encoding(5 bytes) = e8 7e 66 40 5f
...
005dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F4066D0h:jmp64]                encoding(5 bytes) = e8 6e 66 40 5f
...
0076h mov rdx,20864BC0700h          ; MOV(Mov_r64_imm64) [RDX,20864bc0700h:imm64]          encoding(10 bytes) = 48 ba 00 07 bc 64 08 02 00 00
...
008fh call 7FF825DACEB0h            ; CALL(Call_rel32_64) [5E20D670h:jmp64]                encoding(5 bytes) = e8 dc d5 20 5e
...
00a6h call 7FF7C7B9F1C0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF980h:jmp64]        encoding(5 bytes) = e8 d5 f8 ff ff
00abh mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C7D443D0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7d443d0h:imm64]         encoding(10 bytes) = 48 b9 d0 43 d4 c7 f7 7f 00 00
00b8h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F3AF7B0h:jmp64]                encoding(5 bytes) = e8 f3 f6 3a 5f
...
00d0h mov rcx,7FF7C7D443D0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7d443d0h:imm64]         encoding(10 bytes) = 48 b9 d0 43 d4 c7 f7 7f 00 00
00dah call 7FF826EEEF00h            ; CALL(Call_rel32_64) [5F34F6C0h:jmp64]                encoding(5 bytes) = e8 e1 f5 34 5f
...
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> vand_dynamic(Vector256<uint> a, Vector256<uint> b)
; location: [7FF7C7B9F950h, 7FF7C7B9F97Fh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h call 7FF7C7B9F840h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64]        encoding(5 bytes) = e8 db fe ff ff
...
; location: [7FF7C7B9FDA0h, 7FF7C7B9FDD1h]
...
; location: [7FF7C7B9FDF0h, 7FF7C7B9FE13h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
0009h mov rax,2086D8F59A9h          ; MOV(Mov_r64_imm64) [RAX,2086d8f59a9h:imm64]          encoding(10 bytes) = 48 b8 a9 59 8f 6d 08 02 00 00
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0xA9,0x59,0x8F,0x6D,0x08,0x02,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<int> vpermvar8x32_256x32i(Vector256<int> src, Vector256<uint> spec)
; location: [7FF7C7B9FE30h, 7FF7C7B9FE4Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
...
; location: [7FF7C7B9FE60h, 7FF7C7B9FE7Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7B9FE90h, 7FF7C7B9FEE0h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,2086D8F5E59h          ; MOV(Mov_r64_imm64) [RAX,2086d8f5e59h:imm64]          encoding(10 bytes) = 48 b8 59 5e 8f 6d 08 02 00 00
...
002bh mov rax,2086D8F5989h          ; MOV(Mov_r64_imm64) [RAX,2086d8f5989h:imm64]          encoding(10 bytes) = 48 b8 89 59 8f 6d 08 02 00 00
...
; location: [7FF7C7B9FF30h, 7FF7C7B9FF4Ah]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h vmovupd xmm1,[r8]             ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM1,mem(Packed128_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 79 10 08
...
; location: [7FF7C7B9FF60h, 7FF7C7B9FF7Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7B9FF90h, 7FF7C7B9FFADh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7B9FFC0h, 7FF7C7BA0021h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
