...
0014h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F379AF0h:jmp64]                encoding(5 bytes) = e8 d7 9a 37 5f
...
002bh call 7FF826FA6E40h            ; CALL(Call_rel32_64) [5F3D1940h:jmp64]                encoding(5 bytes) = e8 10 19 3d 5f
0030h mov rdi,rax                   ; MOV(Mov_r64_rm64) [RDI,RAX]                          encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C766DEA0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c766dea0h:imm64]         encoding(10 bytes) = 48 b9 a0 de 66 c7 f7 7f 00 00
003dh call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F379AF0h:jmp64]                encoding(5 bytes) = e8 ae 9a 37 5f
...
004dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F3D0A10h:jmp64]                encoding(5 bytes) = e8 be 09 3d 5f
...
005dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F3D0A10h:jmp64]                encoding(5 bytes) = e8 ae 09 3d 5f
...
0076h mov rdx,236BDAD09C8h          ; MOV(Mov_r64_imm64) [RDX,236bdad09c8h:imm64]          encoding(10 bytes) = 48 ba c8 09 ad bd 36 02 00 00
...
008fh call 7FF825DACEB0h            ; CALL(Call_rel32_64) [5E1D79B0h:jmp64]                encoding(5 bytes) = e8 1c 79 1d 5e
...
00a6h call 7FF7C7BD4FA8h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFAA8h:jmp64]        encoding(5 bytes) = e8 fd f9 ff ff
00abh mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C7DA76B0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7da76b0h:imm64]         encoding(10 bytes) = 48 b9 b0 76 da c7 f7 7f 00 00
00b8h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F379AF0h:jmp64]                encoding(5 bytes) = e8 33 9a 37 5f
...
00d0h mov rcx,7FF7C7DA76B0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7da76b0h:imm64]         encoding(10 bytes) = 48 b9 b0 76 da c7 f7 7f 00 00
00dah call 7FF826EEEF00h            ; CALL(Call_rel32_64) [5F319A00h:jmp64]                encoding(5 bytes) = e8 21 99 31 5f
...
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> vand_dynamic(Vector256<uint> a, Vector256<uint> b)
; location: [7FF7C7BD5610h, 7FF7C7BD563Fh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h call 7FF7C7BD5500h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64]        encoding(5 bytes) = e8 db fe ff ff
...
; location: [7FF7C7BD5A60h, 7FF7C7BD5A91h]
...
; location: [7FF7C7BD5AB0h, 7FF7C7BD5AD3h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
0009h mov rax,236C660B8C5h          ; MOV(Mov_r64_imm64) [RAX,236c660b8c5h:imm64]          encoding(10 bytes) = 48 b8 c5 b8 60 c6 36 02 00 00
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0xC5,0xB8,0x60,0xC6,0x36,0x02,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<int> vpermvar8x32_256x32i(Vector256<int> src, Vector256<uint> spec)
; location: [7FF7C7BD5AF0h, 7FF7C7BD5B0Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
...
; location: [7FF7C7BD5B20h, 7FF7C7BD5B3Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BD5B50h, 7FF7C7BD5BA0h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,236C660BD35h          ; MOV(Mov_r64_imm64) [RAX,236c660bd35h:imm64]          encoding(10 bytes) = 48 b8 35 bd 60 c6 36 02 00 00
...
002bh mov rax,236C660B8A5h          ; MOV(Mov_r64_imm64) [RAX,236c660b8a5h:imm64]          encoding(10 bytes) = 48 b8 a5 b8 60 c6 36 02 00 00
...
; location: [7FF7C7BD5BF0h, 7FF7C7BD5C0Ah]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h vmovupd xmm1,[r8]             ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM1,mem(Packed128_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 79 10 08
...
; location: [7FF7C7BD5C20h, 7FF7C7BD5C3Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BD5C50h, 7FF7C7BD5C6Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7BD5C80h, 7FF7C7BD5CE1h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
