; 2020-01-16 19:14:10:602
; function: Func<Vector256<uint>,Vector256<uint>,Vector256<uint>> vand_delgate()
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
...
000ah mov rcx,7FF7C7F12798h                   ; MOV(Mov_r64_imm64) [RCX,7ff7c7f12798h:imm64] encoding(10 bytes) = 48 b9 98 27 f1 c7 f7 7f 00 00
0014h call 7FF82793EFF0h                      ; CALL(Call_rel32_64) [5F368970h:jmp64]      encoding(5 bytes) = e8 57 89 36 5f
0019h mov rsi,rax                             ; MOV(Mov_r64_rm64) [RSI,RAX]                encoding(3 bytes) = 48 8b f0
001ch mov rcx,7FF7C7F07788h                   ; MOV(Mov_r64_imm64) [RCX,7ff7c7f07788h:imm64] encoding(10 bytes) = 48 b9 88 77 f0 c7 f7 7f 00 00
0026h mov edx,2                               ; MOV(Mov_r32_imm32) [EDX,2h:imm32]          encoding(5 bytes) = ba 02 00 00 00
002bh call 7FF827996E40h                      ; CALL(Call_rel32_64) [5F3C07C0h:jmp64]      encoding(5 bytes) = e8 90 07 3c 5f
0030h mov rdi,rax                             ; MOV(Mov_r64_rm64) [RDI,RAX]                encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C85A6520h                   ; MOV(Mov_r64_imm64) [RCX,7ff7c85a6520h:imm64] encoding(10 bytes) = 48 b9 20 65 5a c8 f7 7f 00 00
003dh call 7FF82793EFF0h                      ; CALL(Call_rel32_64) [5F368970h:jmp64]      encoding(5 bytes) = e8 2e 89 36 5f
...
004dh call 7FF827995F10h                      ; CALL(Call_rel32_64) [5F3BF890h:jmp64]      encoding(5 bytes) = e8 3e f8 3b 5f
...
005dh call 7FF827995F10h                      ; CALL(Call_rel32_64) [5F3BF890h:jmp64]      encoding(5 bytes) = e8 2e f8 3b 5f
...
0076h mov rdx,12AD67A8968h                    ; MOV(Mov_r64_imm64) [RDX,12ad67a8968h:imm64] encoding(10 bytes) = 48 ba 68 89 7a d6 2a 01 00 00
...
008fh call 7FF825DACEB0h                      ; CALL(Call_rel32_64) [5D7D6830h:jmp64]      encoding(5 bytes) = e8 9c 67 7d 5d
...
00a6h call 7FF7C85D54A0h                      ; CALL(Call_rel32_64) [FFFFFFFFFFFFEE20h:jmp64] encoding(5 bytes) = e8 75 ed ff ff
00abh mov rsi,rax                             ; MOV(Mov_r64_rm64) [RSI,RAX]                encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C876E8C8h                   ; MOV(Mov_r64_imm64) [RCX,7ff7c876e8c8h:imm64] encoding(10 bytes) = 48 b9 c8 e8 76 c8 f7 7f 00 00
00b8h call 7FF82793EFF0h                      ; CALL(Call_rel32_64) [5F368970h:jmp64]      encoding(5 bytes) = e8 b3 88 36 5f
...
00d0h mov rcx,7FF7C876E8C8h                   ; MOV(Mov_r64_imm64) [RCX,7ff7c876e8c8h:imm64] encoding(10 bytes) = 48 b9 c8 e8 76 c8 f7 7f 00 00
00dah call 7FF8278DEF00h                      ; CALL(Call_rel32_64) [5F308880h:jmp64]      encoding(5 bytes) = e8 a1 87 30 5f
...
0010h call 7FF7C85D6680h                      ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64] encoding(5 bytes) = e8 db fe ff ff
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0x2D,0x91,0x77,0xC6,0x2A,0x01,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
0000h vzeroupper                              ; VZEROUPPER(VEX_Vzeroupper)                 encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                              ; NOP(Nopw)                                  encoding(2 bytes) = 66 90
...
0009h mov rax,12AC677912Dh                    ; MOV(Mov_r64_imm64) [RAX,12ac677912dh:imm64] encoding(10 bytes) = 48 b8 2d 91 77 c6 2a 01 00 00
...
002bh mov rax,12AC677910Dh                    ; MOV(Mov_r64_imm64) [RAX,12ac677910dh:imm64] encoding(10 bytes) = 48 b8 0d 91 77 c6 2a 01 00 00
