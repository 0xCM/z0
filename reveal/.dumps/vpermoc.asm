; 2020-01-08 01:52:29:621
; function: Func<Vector256<uint>,Vector256<uint>,Vector256<uint>> vand_delgate()
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
...
000ah mov rcx,7FF7B5A62798h                   ; MOV(Mov_r64_imm64) [RCX,7ff7b5a62798h:imm64] encoding(10 bytes) = 48 b9 98 27 a6 b5 f7 7f 00 00
0014h call 7FF81549EFF0h                      ; CALL(Call_rel32_64) [5F3D9980h:jmp64]      encoding(5 bytes) = e8 67 99 3d 5f
0019h mov rsi,rax                             ; MOV(Mov_r64_rm64) [RSI,RAX]                encoding(3 bytes) = 48 8b f0
001ch mov rcx,7FF7B5A57788h                   ; MOV(Mov_r64_imm64) [RCX,7ff7b5a57788h:imm64] encoding(10 bytes) = 48 b9 88 77 a5 b5 f7 7f 00 00
0026h mov edx,2                               ; MOV(Mov_r32_imm32) [EDX,2h:imm32]          encoding(5 bytes) = ba 02 00 00 00
002bh call 7FF8154F6E40h                      ; CALL(Call_rel32_64) [5F4317D0h:jmp64]      encoding(5 bytes) = e8 a0 17 43 5f
0030h mov rdi,rax                             ; MOV(Mov_r64_rm64) [RDI,RAX]                encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7B603E778h                   ; MOV(Mov_r64_imm64) [RCX,7ff7b603e778h:imm64] encoding(10 bytes) = 48 b9 78 e7 03 b6 f7 7f 00 00
003dh call 7FF81549EFF0h                      ; CALL(Call_rel32_64) [5F3D9980h:jmp64]      encoding(5 bytes) = e8 3e 99 3d 5f
...
004dh call 7FF8154F5F10h                      ; CALL(Call_rel32_64) [5F4308A0h:jmp64]      encoding(5 bytes) = e8 4e 08 43 5f
...
005dh call 7FF8154F5F10h                      ; CALL(Call_rel32_64) [5F4308A0h:jmp64]      encoding(5 bytes) = e8 3e 08 43 5f
...
0076h mov rdx,28CF52E09C0h                    ; MOV(Mov_r64_imm64) [RDX,28cf52e09c0h:imm64] encoding(10 bytes) = 48 ba c0 09 2e f5 8c 02 00 00
...
008fh call 7FF81477CEB0h                      ; CALL(Call_rel32_64) [5E6B7840h:jmp64]      encoding(5 bytes) = e8 ac 77 6b 5e
...
00a6h call 7FF7B60C52B8h                      ; CALL(Call_rel32_64) [FFFFFFFFFFFFFC48h:jmp64] encoding(5 bytes) = e8 9d fb ff ff
00abh mov rsi,rax                             ; MOV(Mov_r64_rm64) [RSI,RAX]                encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7B62B3500h                   ; MOV(Mov_r64_imm64) [RCX,7ff7b62b3500h:imm64] encoding(10 bytes) = 48 b9 00 35 2b b6 f7 7f 00 00
00b8h call 7FF81549EFF0h                      ; CALL(Call_rel32_64) [5F3D9980h:jmp64]      encoding(5 bytes) = e8 c3 98 3d 5f
...
00d0h mov rcx,7FF7B62B3500h                   ; MOV(Mov_r64_imm64) [RCX,7ff7b62b3500h:imm64] encoding(10 bytes) = 48 b9 00 35 2b b6 f7 7f 00 00
00dah call 7FF81543EF00h                      ; CALL(Call_rel32_64) [5F379890h:jmp64]      encoding(5 bytes) = e8 b1 97 37 5f
...
0010h call 7FF7B60C5670h                      ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64] encoding(5 bytes) = e8 db fe ff ff
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0x8D,0xDE,0xF0,0xFD,0x8C,0x02,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
0000h vzeroupper                              ; VZEROUPPER(VEX_Vzeroupper)                 encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                              ; NOP(Nopw)                                  encoding(2 bytes) = 66 90
...
0009h mov rax,28CFDF0DE8Dh                    ; MOV(Mov_r64_imm64) [RAX,28cfdf0de8dh:imm64] encoding(10 bytes) = 48 b8 8d de f0 fd 8c 02 00 00
...
002bh mov rax,28CFDF0DE6Dh                    ; MOV(Mov_r64_imm64) [RAX,28cfdf0de6dh:imm64] encoding(10 bytes) = 48 b8 6d de f0 fd 8c 02 00 00
