; 2019-11-25 04:09:26:258
; function: BitVector16 bm_16x4_col_literal(in BitMatrix16x4 A)
; location: [7FFDDB028B20h, 7FFDDB028B3Ah]
...
; static ReadOnlySpan<byte> bm_16x4_col_literalBytes => new byte[27]{0x0F,0x1F,0x44,0x00,0x00,0x48,0x8B,0x01,0x48,0xBA,0x44,0x44,0x44,0x44,0x44,0x44,0x44,0x44,0xC4,0xE2,0xFA,0xF5,0xC2,0x0F,0xB7,0xC0,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: BitVector8 bm_8x8_col_literal(in BitMatrix8 A)
; location: [7FFDDB028B50h, 7FFDDB028B8Ch]
...
; location: [7FFDDB028BB0h, 7FFDDB028BCFh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,[rcx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 01
...
; static ReadOnlySpan<byte> bm_16x4_col_indexBytes => new byte[32]{0x0F,0x1F,0x44,0x00,0x00,0x48,0x8B,0x01,0x49,0xB8,0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x8B,0xCA,0x49,0xD3,0xE0,0xC4,0xC2,0xFA,0xF5,0xC0,0x0F,0xB7,0xC0,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void transpose_8x8_1(in BitMatrix8 A, ref BitMatrix8 Z)
; location: [7FFDDB028BE0h, 7FFDDB028C30h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0007h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0009h mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
0041h vpsllq xmm0,xmm0,1            ; VPSLLQ(VEX_Vpsllq_xmm_xmm_imm8) [XMM0,XMM0,1h:imm8]  encoding(VEX, 5 bytes) = c5 f9 73 f0 01
0046h dec eax                       ; DEC(Dec_rm32) [EAX]                                  encoding(2 bytes) = ff c8
0048h test eax,eax                  ; TEST(Test_rm32_r32) [EAX,EAX]                        encoding(2 bytes) = 85 c0
004ah jge short 002dh               ; JGE(Jge_rel8_64) [2Dh:jmp64]                         encoding(2 bytes) = 7d e1
004ch add rsp,18h                   ; ADD(Add_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 c4 18
0050h ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> transpose_8x8_1Bytes => new byte[81]{0x48,0x83,0xEC,0x18,0xC5,0xF8,0x77,0x33,0xC0,0x48,0x89,0x44,0x24,0x08,0xC5,0xFA,0x6F,0x01,0xC5,0xFA,0x7F,0x44,0x24,0x08,0x48,0x8D,0x44,0x24,0x08,0x48,0x8B,0x00,0x48,0x8B,0x00,0xC4,0xE1,0xF9,0x6E,0xC0,0xB8,0x07,0x00,0x00,0x00,0x48,0x8B,0x0A,0x4C,0x63,0xC0,0x49,0x03,0xC8,0xC5,0x79,0xD7,0xC0,0x45,0x0F,0xB6,0xC0,0x44,0x88,0x01,0xC5,0xF9,0x73,0xF0,0x01,0xFF,0xC8,0x85,0xC0,0x7D,0xE1,0x48,0x83,0xC4,0x18,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void transpose_8x8_2(in BitMatrix8 A, ref BitMatrix8 Z)
; location: [7FFDDB028C50h, 7FFDDB028CAAh]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0007h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0009h mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
; location: [7FFDDB028CD0h, 7FFDDB028D41h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0007h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
...
; location: [7FFDDB028D60h, 7FFDDB028DECh]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0007h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0009h mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
; location: [7FFDDB028E10h, 7FFDDB028EA9h]
...
001ah mov [rsp+20h],dx              ; MOV(Mov_rm16_r16) [mem(16u,RSP:br,:sr),DX]           encoding(5 bytes) = 66 89 54 24 20
001fh mov edx,[rsp+20h]             ; MOV(Mov_r32_rm32) [EDX,mem(32u,RSP:br,:sr)]          encoding(4 bytes) = 8b 54 24 20
0023h movzx edx,dx                  ; MOVZX(Movzx_r32_rm16) [EDX,DX]                       encoding(3 bytes) = 0f b7 d2
0026h mov rcx,2222222222222222h     ; MOV(Mov_r64_imm64) [RCX,2222222222222222h:imm64]     encoding(10 bytes) = 48 b9 22 22 22 22 22 22 22 22
0030h pext rcx,rax,rcx              ; PEXT(VEX_Pext_r64_r64_rm64) [RCX,RAX,RCX]            encoding(VEX, 5 bytes) = c4 e2 fa f5 c9
0035h movzx ecx,cx                  ; MOVZX(Movzx_r32_rm16) [ECX,CX]                       encoding(3 bytes) = 0f b7 c9
0038h mov [rsp+18h],cx              ; MOV(Mov_rm16_r16) [mem(16u,RSP:br,:sr),CX]           encoding(5 bytes) = 66 89 4c 24 18
003dh mov ecx,[rsp+18h]             ; MOV(Mov_r32_rm32) [ECX,mem(32u,RSP:br,:sr)]          encoding(4 bytes) = 8b 4c 24 18
0041h movzx ecx,cx                  ; MOVZX(Movzx_r32_rm16) [ECX,CX]                       encoding(3 bytes) = 0f b7 c9
0044h shl rcx,10h                   ; SHL(Shl_rm64_imm8) [RCX,10h:imm8]                    encoding(4 bytes) = 48 c1 e1 10
0048h or rdx,rcx                    ; OR(Or_r64_rm64) [RDX,RCX]                            encoding(3 bytes) = 48 0b d1
004bh mov rcx,4444444444444444h     ; MOV(Mov_r64_imm64) [RCX,4444444444444444h:imm64]     encoding(10 bytes) = 48 b9 44 44 44 44 44 44 44 44
0055h pext rcx,rax,rcx              ; PEXT(VEX_Pext_r64_r64_rm64) [RCX,RAX,RCX]            encoding(VEX, 5 bytes) = c4 e2 fa f5 c9
005ah movzx ecx,cx                  ; MOVZX(Movzx_r32_rm16) [ECX,CX]                       encoding(3 bytes) = 0f b7 c9
005dh mov [rsp+10h],cx              ; MOV(Mov_rm16_r16) [mem(16u,RSP:br,:sr),CX]           encoding(5 bytes) = 66 89 4c 24 10
0062h mov ecx,[rsp+10h]             ; MOV(Mov_r32_rm32) [ECX,mem(32u,RSP:br,:sr)]          encoding(4 bytes) = 8b 4c 24 10
0066h movzx ecx,cx                  ; MOVZX(Movzx_r32_rm16) [ECX,CX]                       encoding(3 bytes) = 0f b7 c9
0069h shl rcx,20h                   ; SHL(Shl_rm64_imm8) [RCX,20h:imm8]                    encoding(4 bytes) = 48 c1 e1 20
006dh or rdx,rcx                    ; OR(Or_r64_rm64) [RDX,RCX]                            encoding(3 bytes) = 48 0b d1
0070h mov rcx,8888888888888888h     ; MOV(Mov_r64_imm64) [RCX,8888888888888888h:imm64]     encoding(10 bytes) = 48 b9 88 88 88 88 88 88 88 88
007ah pext rax,rax,rcx              ; PEXT(VEX_Pext_r64_r64_rm64) [RAX,RAX,RCX]            encoding(VEX, 5 bytes) = c4 e2 fa f5 c1
007fh movzx eax,ax                  ; MOVZX(Movzx_r32_rm16) [EAX,AX]                       encoding(3 bytes) = 0f b7 c0
0082h mov [rsp+8],ax                ; MOV(Mov_rm16_r16) [mem(16u,RSP:br,:sr),AX]           encoding(5 bytes) = 66 89 44 24 08
0087h mov eax,[rsp+8]               ; MOV(Mov_r32_rm32) [EAX,mem(32u,RSP:br,:sr)]          encoding(4 bytes) = 8b 44 24 08
008bh movzx eax,ax                  ; MOVZX(Movzx_r32_rm16) [EAX,AX]                       encoding(3 bytes) = 0f b7 c0
008eh shl rax,30h                   ; SHL(Shl_rm64_imm8) [RAX,30h:imm8]                    encoding(4 bytes) = 48 c1 e0 30
0092h or rax,rdx                    ; OR(Or_r64_rm64) [RAX,RDX]                            encoding(3 bytes) = 48 0b c2
0095h add rsp,28h                   ; ADD(Add_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 c4 28
0099h ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> transpose_16x4Bytes => new byte[154]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: BitMatrix4 pbm_and_4x4(in BitMatrix4 A, in BitMatrix4 B)
; location: [7FFDDB028FD0h, 7FFDDB028FE0h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; static ReadOnlySpan<byte> pbm_and_4x4Bytes => new byte[17]{0x0F,0x1F,0x44,0x00,0x00,0x0F,0xB7,0x01,0x0F,0xB7,0x12,0x23,0xC2,0x0F,0xB7,0xC0,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void pbm_and_8x8(in BitMatrix8 A, in BitMatrix8 B, ref BitMatrix8 Z)
; location: [7FFDDB029110h, 7FFDDB02912Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,[rcx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 01
...
; location: [7FFDDB029550h, 7FFDDB02956Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,[rcx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 01
0008h mov rdx,[rdx]                 ; MOV(Mov_r64_rm64) [RDX,mem(64u,RDX:br,:sr)]          encoding(3 bytes) = 48 8b 12
000bh mov rcx,[r8]                  ; MOV(Mov_r64_rm64) [RCX,mem(64u,R8:br,:sr)]           encoding(3 bytes) = 49 8b 08
...
; location: [7FFDDB029580h, 7FFDDB0295D0h]
...
; location: [7FFDDB029600h, 7FFDDB029650h]
0000h sub rsp,58h                   ; SUB(Sub_rm64_imm8) [RSP,58h:imm64]                   encoding(4 bytes) = 48 83 ec 58
0004h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0007h mov rax,[rcx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 01
000ah mov rdx,[rdx]                 ; MOV(Mov_r64_rm64) [RDX,mem(64u,RDX:br,:sr)]          encoding(3 bytes) = 48 8b 12
...
; location: [7FFDDB029BD0h, 7FFDDB029C49h]
...
; location: [7FFDDB029C70h, 7FFDDB029CE9h]
0000h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0001h sub rsp,50h                   ; SUB(Sub_rm64_imm8) [RSP,50h:imm64]                   encoding(4 bytes) = 48 83 ec 50
0005h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0008h mov rax,[rcx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 01
...
; location: [7FFDDB029D10h, 7FFDDB029D89h]
0000h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0001h sub rsp,50h                   ; SUB(Sub_rm64_imm8) [RSP,50h:imm64]                   encoding(4 bytes) = 48 83 ec 50
0005h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0008h mov rax,[rcx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 01
...
; location: [7FFDDB029DB0h, 7FFDDB029E29h]
0000h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0001h sub rsp,50h                   ; SUB(Sub_rm64_imm8) [RSP,50h:imm64]                   encoding(4 bytes) = 48 83 ec 50
0005h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0008h mov rax,[rcx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 01
