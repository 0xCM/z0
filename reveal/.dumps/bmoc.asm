; 2019-10-27 16:51:32:941
; function: BitMatrix<byte> alloc_8x8u()
; location: [7FFDDBAC8E70h, 7FFDDBAC8E7Fh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,7FFDDBAC7F18h         ; MOV(Mov_r64_imm64) [RAX,7ffddbac7f18h:imm64]         encoding(10 bytes) = 48 b8 18 7f ac db fd 7f 00 00
000fh jmp rax                       ; JMP(Jmp_rm64) [RAX]                                  encoding(3 bytes) = 48 ff e0
; static ReadOnlySpan<byte> alloc_8x8uBytes => new byte[18]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0x18,0x7F,0xAC,0xDB,0xFD,0x7F,0x00,0x00,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: BitMatrix<ushort> alloc_16x16u()
; location: [7FFDDBAC8EA0h, 7FFDDBAC8EAFh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,7FFDDBAC8678h         ; MOV(Mov_r64_imm64) [RAX,7ffddbac8678h:imm64]         encoding(10 bytes) = 48 b8 78 86 ac db fd 7f 00 00
000fh jmp rax                       ; JMP(Jmp_rm64) [RAX]                                  encoding(3 bytes) = 48 ff e0
; static ReadOnlySpan<byte> alloc_16x16uBytes => new byte[18]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0x78,0x86,0xAC,0xDB,0xFD,0x7F,0x00,0x00,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: BitMatrix<uint> alloc_32x32u()
; location: [7FFDDBAC8ED0h, 7FFDDBAC8EDFh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,7FFDDBAC8718h         ; MOV(Mov_r64_imm64) [RAX,7ffddbac8718h:imm64]         encoding(10 bytes) = 48 b8 18 87 ac db fd 7f 00 00
000fh jmp rax                       ; JMP(Jmp_rm64) [RAX]                                  encoding(3 bytes) = 48 ff e0
; static ReadOnlySpan<byte> alloc_32x32uBytes => new byte[18]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0x18,0x87,0xAC,0xDB,0xFD,0x7F,0x00,0x00,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: BitMatrix<ulong> alloc_g64x64u()
; location: [7FFDDBAC8F00h, 7FFDDBAC8F0Fh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,7FFDDBAC87B8h         ; MOV(Mov_r64_imm64) [RAX,7ffddbac87b8h:imm64]         encoding(10 bytes) = 48 b8 b8 87 ac db fd 7f 00 00
000fh jmp rax                       ; JMP(Jmp_rm64) [RAX]                                  encoding(3 bytes) = 48 ff e0
; static ReadOnlySpan<byte> alloc_g64x64uBytes => new byte[18]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0xB8,0x87,0xAC,0xDB,0xFD,0x7F,0x00,0x00,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: BitMatrix64 bm_from_natspan_64x64x64u(in Span<N64,ulong> src)
; location: [7FFDDBAC9960h, 7FFDDBAC9A31h]
...
0030h call 7FFE3AEEF3E0h            ; CALL(Call_rel32_64) [5F425A80h:jmp64]                encoding(5 bytes) = e8 4b 5a 42 5f
0035h mov rdx,20732DD2F10h          ; MOV(Mov_r64_imm64) [RDX,20732dd2f10h:imm64]          encoding(10 bytes) = 48 ba 10 2f dd 32 07 02 00 00
...
004eh mov rcx,7FFDDB683260h         ; MOV(Mov_r64_imm64) [RCX,7ffddb683260h:imm64]         encoding(10 bytes) = 48 b9 60 32 68 db fd 7f 00 00
0058h call 7FFE3AF245E0h            ; CALL(Call_rel32_64) [5F45AC80h:jmp64]                encoding(5 bytes) = e8 23 ac 45 5f
...
0070h call 7FFE3A868F00h            ; CALL(Call_rel32_64) [5ED9F5A0h:jmp64]                encoding(5 bytes) = e8 2b f5 d9 5e
...
0094h mov r9,20732DED3C8h           ; MOV(Mov_r64_imm64) [R9,20732ded3c8h:imm64]           encoding(10 bytes) = 49 b9 c8 d3 de 32 07 02 00 00
...
00c3h call 7FFDDB400F78h            ; CALL(Call_rel32_64) [FFFFFFFFFF937618h:jmp64]        encoding(5 bytes) = e8 50 75 93 ff
...
; static ReadOnlySpan<byte> bm_from_natspan_64x64x64uBytes => new byte[210]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix<byte> gbm_and_8x8(in BitMatrix<byte> A, in BitMatrix<byte> B, ref BitMatrix<byte> C)
; location: [7FFDDBAC9D00h, 7FFDDBAC9D55h]
...
; location: [7FFDDBACA180h, 7FFDDBACA205h]
...
; location: [7FFDDBACA230h, 7FFDDBACA2FDh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
...
0041h call 7FFDDBAC8678h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFE448h:jmp64]        encoding(5 bytes) = e8 02 e4 ff ff
...
00b6h call 7FFE3AF23690h            ; CALL(Call_rel32_64) [5F459460h:jmp64]                encoding(5 bytes) = e8 a5 93 45 5f
...
; static ReadOnlySpan<byte> gbm_and_16x16_allocBytes => new byte[206]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix16 pbm_and_16x16(in BitMatrix16 A, in BitMatrix16 B, ref BitMatrix16 C)
; location: [7FFDDBACA330h, 7FFDDBACA3AAh]
...
002fh call 7FFDDBAC8BC0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFE3E0h:jmp64]        encoding(5 bytes) = e8 ac e3 ff ff
...
00a2h call 7FFE3B04EF00h            ; CALL(Call_rel32_64) [5F584720h:jmp64]                encoding(5 bytes) = e8 79 46 58 5f
00a7h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> pbm_and_16x16_allocBytes => new byte[168]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix<uint> gbm_and_32x32(in BitMatrix<uint> A, in BitMatrix<uint> B, ref BitMatrix<uint> C)
; location: [7FFDDBACA8B0h, 7FFDDBACAA49h]
...
; location: [7FFDDBACAAA0h, 7FFDDBACB08Eh]
