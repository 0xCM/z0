; 2019-11-21 12:21:39:636
; function: BitMatrix4 and_4x4(in BitMatrix4 A, in BitMatrix4 B)
; location: [7FFDD9F25D40h, 7FFDD9F25D50h]
...
; location: [7FFDD9F25E80h, 7FFDD9F25EFCh]
...
0044h call 7FFDD9F23568h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFD6E8h:jmp64]        encoding(5 bytes) = e8 9f d6 ff ff
...
006bh call 7FFE39363690h            ; CALL(Call_rel32_64) [5F43D810h:jmp64]                encoding(5 bytes) = e8 a0 d7 43 5f
...
; static ReadOnlySpan<byte> and_8x8Bytes => new byte[125]{0x57,0x56,0x53,0x48,0x83,0xEC,0x40,0xC5,0xF8,0x77,0x33,0xC0,0x48,0x89,0x44,0x24,0x28,0x48,0x8B,0xD9,0x48,0x8B,0xF2,0x49,0x8B,0xF8,0x48,0x8D,0x4C,0x24,0x28,0xC5,0xF8,0x57,0xC0,0xC5,0xFA,0x7F,0x01,0xC6,0x44,0x24,0x20,0x00,0x48,0x0F,0xBE,0x4C,0x24,0x20,0x88,0x4C,0x24,0x38,0x48,0x8D,0x4C,0x24,0x28,0x48,0x0F,0xBE,0x54,0x24,0x38,0x45,0x33,0xC0,0xE8,0x9F,0xD6,0xFF,0xFF,0x48,0x8B,0x06,0x48,0x8B,0x17,0x48,0x8D,0x4C,0x24,0x28,0x48,0x8B,0x09,0x48,0x8B,0x00,0x48,0x8B,0x12,0x48,0x23,0xC2,0x48,0x89,0x01,0x48,0x8B,0xFB,0x48,0x8D,0x74,0x24,0x28,0xE8,0xA0,0xD7,0x43,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x48,0x83,0xC4,0x40,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: BitMatrix<byte> and_8x8g(in BitMatrix<byte> A, in BitMatrix<byte> B)
; location: [7FFDD9F26320h, 7FFDD9F26384h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
002ch call 7FFDD9F254F0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF1D0h:jmp64]        encoding(5 bytes) = e8 9f f1 ff ff
...
0053h call 7FFE39363690h            ; CALL(Call_rel32_64) [5F43D370h:jmp64]                encoding(5 bytes) = e8 18 d3 43 5f
...
; static ReadOnlySpan<byte> and_8x8gBytes => new byte[101]{0x57,0x56,0x53,0x48,0x83,0xEC,0x30,0xC5,0xF8,0x77,0x33,0xC0,0x48,0x89,0x44,0x24,0x20,0x48,0x8B,0xD9,0x48,0x8B,0xF2,0x49,0x8B,0xF8,0x48,0x8D,0x4C,0x24,0x20,0xC5,0xF8,0x57,0xC0,0xC5,0xFA,0x7F,0x01,0x48,0x8D,0x4C,0x24,0x20,0xE8,0x9F,0xF1,0xFF,0xFF,0x48,0x8B,0x06,0x48,0x8B,0x17,0x48,0x8D,0x4C,0x24,0x20,0x48,0x8B,0x09,0x48,0x8B,0x00,0x48,0x8B,0x12,0x48,0x23,0xC2,0x48,0x89,0x01,0x48,0x8B,0xFB,0x48,0x8D,0x74,0x24,0x20,0xE8,0x18,0xD3,0x43,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x48,0x83,0xC4,0x30,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix8 and_8x8_ref(in BitMatrix8 A, in BitMatrix8 B, ref BitMatrix8 Z)
; location: [7FFDD9F263A0h, 7FFDD9F263BDh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFDD9F263D0h, 7FFDD9F263EDh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,[rcx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 01
0008h mov rdx,[rdx]                 ; MOV(Mov_r64_rm64) [RDX,mem(64u,RDX:br,:sr)]          encoding(3 bytes) = 48 8b 12
000bh mov rcx,[r8]                  ; MOV(Mov_r64_rm64) [RCX,mem(64u,R8:br,:sr)]           encoding(3 bytes) = 49 8b 08
...
; location: [7FFDD9F26580h, 7FFDD9F26635h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0047h call 7FFDD9F23578h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFCFF8h:jmp64]        encoding(5 bytes) = e8 ac cf ff ff
...
009eh call 7FFE39363690h            ; CALL(Call_rel32_64) [5F43D110h:jmp64]                encoding(5 bytes) = e8 6d d0 43 5f
...
; static ReadOnlySpan<byte> and_16x16Bytes => new byte[182]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix<ushort> and_16x16g_ref(in BitMatrix<ushort> A, in BitMatrix<ushort> B, ref BitMatrix<ushort> C)
; location: [7FFDD9F26A70h, 7FFDD9F26AC3h]
...
; location: [7FFDD9F26AF0h, 7FFDD9F26BCCh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
0003h sub rsp,80h                   ; SUB(Sub_rm64_imm32) [RSP,80h:imm64]                  encoding(7 bytes) = 48 81 ec 80 00 00 00
...
003eh movsx rdx,byte ptr [rsp+78h]  ; MOVSX(Movsx_r64_rm8) [RDX,mem(8i,RSP:br,:sr)]        encoding(6 bytes) = 48 0f be 54 24 78
0044h xor r8d,r8d                   ; XOR(Xor_r32_rm32) [R8D,R8D]                          encoding(3 bytes) = 45 33 c0
0047h call 7FFDD9F23588h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFCA98h:jmp64]        encoding(5 bytes) = e8 4c ca ff ff
004ch mov rax,[rsi]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RSI:br,:sr)]          encoding(3 bytes) = 48 8b 06
004fh mov rdx,[rdi]                 ; MOV(Mov_r64_rm64) [RDX,mem(64u,RDI:br,:sr)]          encoding(3 bytes) = 48 8b 17
0052h lea rcx,[rsp+68h]             ; LEA(Lea_r64_m) [RCX,mem(Unknown,RSP:br,:sr)]         encoding(5 bytes) = 48 8d 4c 24 68
0057h mov rcx,[rcx]                 ; MOV(Mov_r64_rm64) [RCX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 09
...
00c5h call 7FFE39363690h            ; CALL(Call_rel32_64) [5F43CBA0h:jmp64]                encoding(5 bytes) = e8 d6 ca 43 5f
...
; static ReadOnlySpan<byte> and_32x32Bytes => new byte[221]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: BitMatrix<uint> and_32x32g(in BitMatrix<uint> A, in BitMatrix<uint> B)
; location: [7FFDD9F26C00h, 7FFDD9F26CC4h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
0003h sub rsp,80h                   ; SUB(Sub_rm64_imm32) [RSP,80h:imm64]                  encoding(7 bytes) = 48 81 ec 80 00 00 00
...
002fh call 7FFDD9F22A08h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFBE08h:jmp64]        encoding(5 bytes) = e8 d4 bd ff ff
...
00adh call 7FFE39363690h            ; CALL(Call_rel32_64) [5F43CA90h:jmp64]                encoding(5 bytes) = e8 de c9 43 5f
...
; location: [7FFDD9F26DA0h, 7FFDD9F26E1Dh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,48h                   ; SUB(Sub_rm64_imm8) [RSP,48h:imm64]                   encoding(4 bytes) = 48 83 ec 48
0006h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
...
; location: [7FFDD9F26E50h, 7FFDD9F26ECDh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,48h                   ; SUB(Sub_rm64_imm8) [RSP,48h:imm64]                   encoding(4 bytes) = 48 83 ec 48
0006h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
...
; location: [7FFDD9F27200h, 7FFDD9F27253h]
