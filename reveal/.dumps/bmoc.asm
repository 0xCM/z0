...
0032h call 7FFDDB41DA90h            ; CALL(Call_rel32_64) [FFFFFFFFFF9313D0h:jmp64]        encoding(5 bytes) = e8 99 13 93 ff
...
00a7h call 7FFE3AF245E0h            ; CALL(Call_rel32_64) [5F437F20h:jmp64]                encoding(5 bytes) = e8 74 7e 43 5f
...
00e3h call 7FFE3A868F00h            ; CALL(Call_rel32_64) [5ED7C840h:jmp64]                encoding(5 bytes) = e8 58 c7 d7 5e
...
00f2h call 7FFE3B04ED50h            ; CALL(Call_rel32_64) [5F562690h:jmp64]                encoding(5 bytes) = e8 99 25 56 5f
00f7h call 7FFDDB4305D0h            ; CALL(Call_rel32_64) [FFFFFFFFFF943F10h:jmp64]        encoding(5 bytes) = e8 14 3e 94 ff
00fch int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> bm_transpose_8x8Bytes => new byte[253]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: BitMatrix<byte> alloc_8x8u()
; location: [7FFDDBAEC7E0h, 7FFDDBAEC7EFh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,7FFDDBAEC5B0h         ; MOV(Mov_r64_imm64) [RAX,7ffddbaec5b0h:imm64]         encoding(10 bytes) = 48 b8 b0 c5 ae db fd 7f 00 00
000fh jmp rax                       ; JMP(Jmp_rm64) [RAX]                                  encoding(3 bytes) = 48 ff e0
; static ReadOnlySpan<byte> alloc_8x8uBytes => new byte[18]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0xB0,0xC5,0xAE,0xDB,0xFD,0x7F,0x00,0x00,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: BitMatrix<ushort> alloc_16x16u()
; location: [7FFDDBAEC810h, 7FFDDBAEC81Fh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,7FFDDBAEC658h         ; MOV(Mov_r64_imm64) [RAX,7ffddbaec658h:imm64]         encoding(10 bytes) = 48 b8 58 c6 ae db fd 7f 00 00
000fh jmp rax                       ; JMP(Jmp_rm64) [RAX]                                  encoding(3 bytes) = 48 ff e0
; static ReadOnlySpan<byte> alloc_16x16uBytes => new byte[18]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0x58,0xC6,0xAE,0xDB,0xFD,0x7F,0x00,0x00,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: BitMatrix<uint> alloc_32x32u()
; location: [7FFDDBAECC40h, 7FFDDBAECC4Fh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,7FFDDBAEC668h         ; MOV(Mov_r64_imm64) [RAX,7ffddbaec668h:imm64]         encoding(10 bytes) = 48 b8 68 c6 ae db fd 7f 00 00
000fh jmp rax                       ; JMP(Jmp_rm64) [RAX]                                  encoding(3 bytes) = 48 ff e0
; static ReadOnlySpan<byte> alloc_32x32uBytes => new byte[18]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0x68,0xC6,0xAE,0xDB,0xFD,0x7F,0x00,0x00,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: BitMatrix<ulong> alloc_g64x64u()
; location: [7FFDDBAECC70h, 7FFDDBAECC7Fh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,7FFDDBAEC678h         ; MOV(Mov_r64_imm64) [RAX,7ffddbaec678h:imm64]         encoding(10 bytes) = 48 b8 78 c6 ae db fd 7f 00 00
000fh jmp rax                       ; JMP(Jmp_rm64) [RAX]                                  encoding(3 bytes) = 48 ff e0
; static ReadOnlySpan<byte> alloc_g64x64uBytes => new byte[18]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0x78,0xC6,0xAE,0xDB,0xFD,0x7F,0x00,0x00,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: BitMatrix64 bm_from_natspan_64x64x64u(in Span<N64,ulong> src)
; location: [7FFDDBAED0A0h, 7FFDDBAED171h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
...
0030h call 7FFE3AEEF3E0h            ; CALL(Call_rel32_64) [5F402340h:jmp64]                encoding(5 bytes) = e8 0b 23 40 5f
0035h mov rdx,1CFF0652F10h          ; MOV(Mov_r64_imm64) [RDX,1cff0652f10h:imm64]          encoding(10 bytes) = 48 ba 10 2f 65 f0 cf 01 00 00
...
0058h call 7FFE3AF245E0h            ; CALL(Call_rel32_64) [5F437540h:jmp64]                encoding(5 bytes) = e8 e3 74 43 5f
...
0070h call 7FFE3A868F00h            ; CALL(Call_rel32_64) [5ED7BE60h:jmp64]                encoding(5 bytes) = e8 eb bd d7 5e
...
0094h mov r9,1CFF066D4F8h           ; MOV(Mov_r64_imm64) [R9,1cff066d4f8h:imm64]           encoding(10 bytes) = 49 b9 f8 d4 66 f0 cf 01 00 00
...
00c3h call 7FFDDB420F78h            ; CALL(Call_rel32_64) [FFFFFFFFFF933ED8h:jmp64]        encoding(5 bytes) = e8 10 3e 93 ff
...
; static ReadOnlySpan<byte> bm_from_natspan_64x64x64uBytes => new byte[210]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix<byte> gbm_and_8x8(in BitMatrix<byte> A, in BitMatrix<byte> B, ref BitMatrix<byte> C)
; location: [7FFDDBAED5A0h, 7FFDDBAED5F5h]
...
; location: [7FFDDBAEDA20h, 7FFDDBAEDAA5h]
...
; location: [7FFDDBAEDAD0h, 7FFDDBAEDB9Dh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
...
0041h call 7FFDDBAEC658h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFEB88h:jmp64]        encoding(5 bytes) = e8 42 eb ff ff
...
00b6h call 7FFE3AF23690h            ; CALL(Call_rel32_64) [5F435BC0h:jmp64]                encoding(5 bytes) = e8 05 5b 43 5f
...
; static ReadOnlySpan<byte> gbm_and_16x16_allocBytes => new byte[206]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix16 pbm_and_16x16(in BitMatrix16 A, in BitMatrix16 B, ref BitMatrix16 C)
; location: [7FFDDBAEDDC0h, 7FFDDBAEDE3Ah]
...
002fh call 7FFDDBAEC008h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFE1A8h:jmp64]        encoding(5 bytes) = e8 74 e1 ff ff
...
00a2h call 7FFE3B04EF00h            ; CALL(Call_rel32_64) [5F5610A0h:jmp64]                encoding(5 bytes) = e8 f9 0f 56 5f
00a7h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> pbm_and_16x16_allocBytes => new byte[168]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix<uint> gbm_and_32x32(in BitMatrix<uint> A, in BitMatrix<uint> B, ref BitMatrix<uint> C)
; location: [7FFDDBAEE340h, 7FFDDBAEE4D9h]
...
; location: [7FFDDBAEE530h, 7FFDDBAEEB1Eh]
