...
0030h call 7FFE3AEEF3E0h            ; CALL(Call_rel32_64) [5F425570h:jmp64]                encoding(5 bytes) = e8 3b 55 42 5f
0035h mov rdx,21A39AD2F40h          ; MOV(Mov_r64_imm64) [RDX,21a39ad2f40h:imm64]          encoding(10 bytes) = 48 ba 40 2f ad 39 1a 02 00 00
...
004eh mov rcx,7FFDDB67D1F0h         ; MOV(Mov_r64_imm64) [RCX,7ffddb67d1f0h:imm64]         encoding(10 bytes) = 48 b9 f0 d1 67 db fd 7f 00 00
0058h call 7FFE3AF245E0h            ; CALL(Call_rel32_64) [5F45A770h:jmp64]                encoding(5 bytes) = e8 13 a7 45 5f
...
0070h call 7FFE3A868F00h            ; CALL(Call_rel32_64) [5ED9F090h:jmp64]                encoding(5 bytes) = e8 1b f0 d9 5e
...
; static ReadOnlySpan<byte> bm_from_natspan_64x64x64uBytes => new byte[127]{0x57,0x56,0x48,0x83,0xEC,0x38,0xC5,0xF8,0x77,0x33,0xC0,0x48,0x89,0x44,0x24,0x28,0xC5,0xFA,0x6F,0x01,0xC5,0xFA,0x7F,0x44,0x24,0x28,0x83,0x7C,0x24,0x30,0x00,0x75,0x23,0x48,0xB9,0x20,0x00,0x3C,0xDB,0xFD,0x7F,0x00,0x00,0xBA,0x57,0x00,0x00,0x00,0xE8,0x3B,0x55,0x42,0x5F,0x48,0xBA,0x40,0x2F,0xAD,0x39,0x1A,0x02,0x00,0x00,0x48,0x8B,0x02,0xEB,0x34,0x8B,0x54,0x24,0x30,0x48,0x63,0xF2,0x48,0x8B,0xD6,0x48,0xB9,0xF0,0xD1,0x67,0xDB,0xFD,0x7F,0x00,0x00,0xE8,0x13,0xA7,0x45,0x5F,0x48,0x8B,0xF8,0x48,0x8D,0x4F,0x10,0x48,0x8B,0x54,0x24,0x28,0x4C,0x8B,0xC6,0x49,0xC1,0xE0,0x03,0xE8,0x1B,0xF0,0xD9,0x5E,0x48,0x8B,0xC7,0x48,0x83,0xC4,0x38,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix<byte> gbm_and_8x8(in BitMatrix<byte> A, in BitMatrix<byte> B, ref BitMatrix<byte> C)
; location: [7FFDDBACB3B0h, 7FFDDBACB405h]
...
; location: [7FFDDBACB420h, 7FFDDBACB4A5h]
...
; location: [7FFDDBACB8E0h, 7FFDDBACB9ADh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
...
0041h call 7FFDDBACB4E0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFC00h:jmp64]        encoding(5 bytes) = e8 ba fb ff ff
...
00b6h call 7FFE3AF23690h            ; CALL(Call_rel32_64) [5F457DB0h:jmp64]                encoding(5 bytes) = e8 f5 7c 45 5f
...
; static ReadOnlySpan<byte> gbm_and_16x16_allocBytes => new byte[206]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix16 pbm_and_16x16(in BitMatrix16 A, in BitMatrix16 B, ref BitMatrix16 C)
; location: [7FFDDBACB9E0h, 7FFDDBACBA5Ah]
...
002fh call 7FFDDBACA7C0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFE930h:jmp64]        encoding(5 bytes) = e8 fc e8 ff ff
...
00a2h call 7FFE3B04EF00h            ; CALL(Call_rel32_64) [5F583070h:jmp64]                encoding(5 bytes) = e8 c9 2f 58 5f
00a7h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> pbm_and_16x16_allocBytes => new byte[168]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix<uint> gbm_and_32x32(in BitMatrix<uint> A, in BitMatrix<uint> B, ref BitMatrix<uint> C)
; location: [7FFDDBACBF60h, 7FFDDBACC0F9h]
...
; location: [7FFDDBACC550h, 7FFDDBACCB3Eh]
