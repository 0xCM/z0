...
0021h mov rcx,7FFDDB3B0020h         ; MOV(Mov_r64_imm64) [RCX,7ffddb3b0020h:imm64]         encoding(10 bytes) = 48 b9 20 00 3b db fd 7f 00 00
002bh mov edx,57h                   ; MOV(Mov_r32_imm32) [EDX,57h:imm32]                   encoding(5 bytes) = ba 57 00 00 00
0030h call 7FFE3AEEF3E0h            ; CALL(Call_rel32_64) [5F433C30h:jmp64]                encoding(5 bytes) = e8 fb 3b 43 5f
0035h mov rdx,1CFDAC02F40h          ; MOV(Mov_r64_imm64) [RDX,1cfdac02f40h:imm64]          encoding(10 bytes) = 48 ba 40 2f c0 da cf 01 00 00
...
004eh mov rcx,7FFDDB66F240h         ; MOV(Mov_r64_imm64) [RCX,7ffddb66f240h:imm64]         encoding(10 bytes) = 48 b9 40 f2 66 db fd 7f 00 00
0058h call 7FFE3AF245E0h            ; CALL(Call_rel32_64) [5F468E30h:jmp64]                encoding(5 bytes) = e8 d3 8d 46 5f
...
0070h call 7FFE3A868F00h            ; CALL(Call_rel32_64) [5EDAD750h:jmp64]                encoding(5 bytes) = e8 db d6 da 5e
...
; static ReadOnlySpan<byte> bm_from_natspan_64x64x64uBytes => new byte[127]{0x57,0x56,0x48,0x83,0xEC,0x38,0xC5,0xF8,0x77,0x33,0xC0,0x48,0x89,0x44,0x24,0x28,0xC5,0xFA,0x6F,0x01,0xC5,0xFA,0x7F,0x44,0x24,0x28,0x83,0x7C,0x24,0x30,0x00,0x75,0x23,0x48,0xB9,0x20,0x00,0x3B,0xDB,0xFD,0x7F,0x00,0x00,0xBA,0x57,0x00,0x00,0x00,0xE8,0xFB,0x3B,0x43,0x5F,0x48,0xBA,0x40,0x2F,0xC0,0xDA,0xCF,0x01,0x00,0x00,0x48,0x8B,0x02,0xEB,0x34,0x8B,0x54,0x24,0x30,0x48,0x63,0xF2,0x48,0x8B,0xD6,0x48,0xB9,0x40,0xF2,0x66,0xDB,0xFD,0x7F,0x00,0x00,0xE8,0xD3,0x8D,0x46,0x5F,0x48,0x8B,0xF8,0x48,0x8D,0x4F,0x10,0x48,0x8B,0x54,0x24,0x28,0x4C,0x8B,0xC6,0x49,0xC1,0xE0,0x03,0xE8,0xDB,0xD6,0xDA,0x5E,0x48,0x8B,0xC7,0x48,0x83,0xC4,0x38,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix<byte> gbm_and_8x8(in BitMatrix<byte> A, in BitMatrix<byte> B, ref BitMatrix<byte> C)
; location: [7FFDDBABC8F0h, 7FFDDBABC945h]
...
; location: [7FFDDBABCD70h, 7FFDDBABCDF5h]
...
; location: [7FFDDBABD230h, 7FFDDBABD2FDh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
...
0041h call 7FFDDBABCC68h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFA38h:jmp64]        encoding(5 bytes) = e8 f2 f9 ff ff
...
00b6h call 7FFE3AF23690h            ; CALL(Call_rel32_64) [5F466460h:jmp64]                encoding(5 bytes) = e8 a5 63 46 5f
...
; static ReadOnlySpan<byte> gbm_and_16x16_allocBytes => new byte[206]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix16 pbm_and_16x16(in BitMatrix16 A, in BitMatrix16 B, ref BitMatrix16 C)
; location: [7FFDDBABD330h, 7FFDDBABD3AAh]
...
002fh call 7FFDDBABC100h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFED30h:jmp64]        encoding(5 bytes) = e8 fc ec ff ff
...
00a2h call 7FFE3B04EF00h            ; CALL(Call_rel32_64) [5F591B30h:jmp64]                encoding(5 bytes) = e8 89 1a 59 5f
00a7h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> pbm_and_16x16_allocBytes => new byte[168]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix<uint> gbm_and_32x32(in BitMatrix<uint> A, in BitMatrix<uint> B, ref BitMatrix<uint> C)
; location: [7FFDDBABD8B0h, 7FFDDBABDA49h]
...
; location: [7FFDDBABDAA0h, 7FFDDBABE08Eh]
