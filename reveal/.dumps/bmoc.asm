...
0030h call 7FFE3AEEF3E0h            ; CALL(Call_rel32_64) [5F4325F0h:jmp64]                encoding(5 bytes) = e8 bb 25 43 5f
0035h mov rdx,2C510002F40h          ; MOV(Mov_r64_imm64) [RDX,2c510002f40h:imm64]          encoding(10 bytes) = 48 ba 40 2f 00 10 c5 02 00 00
...
004eh mov rcx,7FFDDB673260h         ; MOV(Mov_r64_imm64) [RCX,7ffddb673260h:imm64]         encoding(10 bytes) = 48 b9 60 32 67 db fd 7f 00 00
0058h call 7FFE3AF245E0h            ; CALL(Call_rel32_64) [5F4677F0h:jmp64]                encoding(5 bytes) = e8 93 77 46 5f
...
0070h call 7FFE3A868F00h            ; CALL(Call_rel32_64) [5EDAC110h:jmp64]                encoding(5 bytes) = e8 9b c0 da 5e
...
0094h mov r9,2C5100198F0h           ; MOV(Mov_r64_imm64) [R9,2c5100198f0h:imm64]           encoding(10 bytes) = 49 b9 f0 98 01 10 c5 02 00 00
...
00c3h call 7FFDDB3F0F80h            ; CALL(Call_rel32_64) [FFFFFFFFFF934190h:jmp64]        encoding(5 bytes) = e8 c8 40 93 ff
...
; static ReadOnlySpan<byte> bm_from_natspan_64x64x64uBytes => new byte[210]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix<byte> gbm_and_8x8(in BitMatrix<byte> A, in BitMatrix<byte> B, ref BitMatrix<byte> C)
; location: [7FFDDBABE0C0h, 7FFDDBABE115h]
...
; location: [7FFDDBABE540h, 7FFDDBABE5C5h]
...
; location: [7FFDDBABEA00h, 7FFDDBABEACDh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
...
0041h call 7FFDDBABE398h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF998h:jmp64]        encoding(5 bytes) = e8 52 f9 ff ff
...
00b6h call 7FFE3AF23690h            ; CALL(Call_rel32_64) [5F464C90h:jmp64]                encoding(5 bytes) = e8 d5 4b 46 5f
...
; static ReadOnlySpan<byte> gbm_and_16x16_allocBytes => new byte[206]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix16 pbm_and_16x16(in BitMatrix16 A, in BitMatrix16 B, ref BitMatrix16 C)
; location: [7FFDDBABEB00h, 7FFDDBABEB7Ah]
...
002fh call 7FFDDBABD548h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFE9A8h:jmp64]        encoding(5 bytes) = e8 74 e9 ff ff
...
00a2h call 7FFE3B04EF00h            ; CALL(Call_rel32_64) [5F590360h:jmp64]                encoding(5 bytes) = e8 b9 02 59 5f
00a7h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> pbm_and_16x16_allocBytes => new byte[168]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix<uint> gbm_and_32x32(in BitMatrix<uint> A, in BitMatrix<uint> B, ref BitMatrix<uint> C)
; location: [7FFDDBABF080h, 7FFDDBABF219h]
...
; location: [7FFDDBABF270h, 7FFDDBABF85Eh]
