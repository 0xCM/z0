; 2019-11-20 15:08:32:530
; function: BitMatrix4 and_4x4(in BitMatrix4 A, in BitMatrix4 B)
; location: [7FFDD9F35230h, 7FFDD9F35240h]
...
; location: [7FFDD9F35370h, 7FFDD9F353ECh]
...
0044h call 7FFDD9F32C00h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFD890h:jmp64]        encoding(5 bytes) = e8 47 d8 ff ff
...
006bh call 7FFE39363690h            ; CALL(Call_rel32_64) [5F42E320h:jmp64]                encoding(5 bytes) = e8 b0 e2 42 5f
...
; static ReadOnlySpan<byte> and_8x8Bytes => new byte[125]{0x57,0x56,0x53,0x48,0x83,0xEC,0x40,0xC5,0xF8,0x77,0x33,0xC0,0x48,0x89,0x44,0x24,0x28,0x48,0x8B,0xD9,0x48,0x8B,0xF2,0x49,0x8B,0xF8,0x48,0x8D,0x4C,0x24,0x28,0xC5,0xF8,0x57,0xC0,0xC5,0xFA,0x7F,0x01,0xC6,0x44,0x24,0x20,0x00,0x48,0x0F,0xBE,0x4C,0x24,0x20,0x88,0x4C,0x24,0x38,0x48,0x8D,0x4C,0x24,0x28,0x48,0x0F,0xBE,0x54,0x24,0x38,0x45,0x33,0xC0,0xE8,0x47,0xD8,0xFF,0xFF,0x48,0x8B,0x06,0x48,0x8B,0x17,0x48,0x8D,0x4C,0x24,0x28,0x48,0x8B,0x09,0x48,0x8B,0x00,0x48,0x8B,0x12,0x48,0x23,0xC2,0x48,0x89,0x01,0x48,0x8B,0xFB,0x48,0x8D,0x74,0x24,0x28,0xE8,0xB0,0xE2,0x42,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x48,0x83,0xC4,0x40,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: BitMatrix<byte> and_8x8g(in BitMatrix<byte> A, in BitMatrix<byte> B)
; location: [7FFDD9F35810h, 7FFDD9F35874h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
002ch call 7FFDD9F34A30h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF220h:jmp64]        encoding(5 bytes) = e8 ef f1 ff ff
...
0053h call 7FFE39363690h            ; CALL(Call_rel32_64) [5F42DE80h:jmp64]                encoding(5 bytes) = e8 28 de 42 5f
...
; static ReadOnlySpan<byte> and_8x8gBytes => new byte[101]{0x57,0x56,0x53,0x48,0x83,0xEC,0x30,0xC5,0xF8,0x77,0x33,0xC0,0x48,0x89,0x44,0x24,0x20,0x48,0x8B,0xD9,0x48,0x8B,0xF2,0x49,0x8B,0xF8,0x48,0x8D,0x4C,0x24,0x20,0xC5,0xF8,0x57,0xC0,0xC5,0xFA,0x7F,0x01,0x48,0x8D,0x4C,0x24,0x20,0xE8,0xEF,0xF1,0xFF,0xFF,0x48,0x8B,0x06,0x48,0x8B,0x17,0x48,0x8D,0x4C,0x24,0x20,0x48,0x8B,0x09,0x48,0x8B,0x00,0x48,0x8B,0x12,0x48,0x23,0xC2,0x48,0x89,0x01,0x48,0x8B,0xFB,0x48,0x8D,0x74,0x24,0x20,0xE8,0x28,0xDE,0x42,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x48,0x83,0xC4,0x30,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix8 and_8x8_ref(in BitMatrix8 A, in BitMatrix8 B, ref BitMatrix8 Z)
; location: [7FFDD9F35890h, 7FFDD9F358ADh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFDD9F358C0h, 7FFDD9F358DDh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,[rcx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 01
0008h mov rdx,[rdx]                 ; MOV(Mov_r64_rm64) [RDX,mem(64u,RDX:br,:sr)]          encoding(3 bytes) = 48 8b 12
000bh mov rcx,[r8]                  ; MOV(Mov_r64_rm64) [RCX,mem(64u,R8:br,:sr)]           encoding(3 bytes) = 49 8b 08
...
; location: [7FFDD9F35E80h, 7FFDD9F35F35h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0047h call 7FFDD9F32C10h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFCD90h:jmp64]        encoding(5 bytes) = e8 44 cd ff ff
...
009eh call 7FFE39363690h            ; CALL(Call_rel32_64) [5F42D810h:jmp64]                encoding(5 bytes) = e8 6d d7 42 5f
...
; location: [7FFDD9F35FE0h, 7FFDD9F360BCh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
0003h sub rsp,80h                   ; SUB(Sub_rm64_imm32) [RSP,80h:imm64]                  encoding(7 bytes) = 48 81 ec 80 00 00 00
...
003eh movsx rdx,byte ptr [rsp+78h]  ; MOVSX(Movsx_r64_rm8) [RDX,mem(8i,RSP:br,:sr)]        encoding(6 bytes) = 48 0f be 54 24 78
0044h xor r8d,r8d                   ; XOR(Xor_r32_rm32) [R8D,R8D]                          encoding(3 bytes) = 45 33 c0
0047h call 7FFDD9F32C20h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFCC40h:jmp64]        encoding(5 bytes) = e8 f4 cb ff ff
004ch mov rax,[rsi]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RSI:br,:sr)]          encoding(3 bytes) = 48 8b 06
004fh mov rdx,[rdi]                 ; MOV(Mov_r64_rm64) [RDX,mem(64u,RDI:br,:sr)]          encoding(3 bytes) = 48 8b 17
0052h lea rcx,[rsp+68h]             ; LEA(Lea_r64_m) [RCX,mem(Unknown,RSP:br,:sr)]         encoding(5 bytes) = 48 8d 4c 24 68
0057h mov rcx,[rcx]                 ; MOV(Mov_r64_rm64) [RCX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 09
...
00c5h call 7FFE39363690h            ; CALL(Call_rel32_64) [5F42D6B0h:jmp64]                encoding(5 bytes) = e8 e6 d5 42 5f
...
002fh call 7FFDD9F32098h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFBFA8h:jmp64]        encoding(5 bytes) = e8 74 bf ff ff
...
00adh call 7FFE39363690h            ; CALL(Call_rel32_64) [5F42D5A0h:jmp64]                encoding(5 bytes) = e8 ee d4 42 5f
...
; static ReadOnlySpan<byte> and_32x32gBytes => new byte[197]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix32 and_32x32_ref(in BitMatrix32 A, in BitMatrix32 B, ref BitMatrix32 Z)
; location: [7FFDD9F361E0h, 7FFDD9F3625Dh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
...
; location: [7FFDD9F36290h, 7FFDD9F3630Dh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,48h                   ; SUB(Sub_rm64_imm8) [RSP,48h:imm64]                   encoding(4 bytes) = 48 83 ec 48
0006h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
...
; location: [7FFDD9F36340h, 7FFDD9F363BDh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,48h                   ; SUB(Sub_rm64_imm8) [RSP,48h:imm64]                   encoding(4 bytes) = 48 83 ec 48
0006h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
...
; location: [7FFDD9F366F0h, 7FFDD9F36743h]
