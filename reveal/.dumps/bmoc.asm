; 2019-11-21 00:45:03:329
; function: BitMatrix4 and_4x4(in BitMatrix4 A, in BitMatrix4 B)
; location: [7FFDD9F45240h, 7FFDD9F45250h]
...
; location: [7FFDD9F45380h, 7FFDD9F453FCh]
...
0044h call 7FFDD9F42A70h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFD6F0h:jmp64]        encoding(5 bytes) = e8 a7 d6 ff ff
...
006bh call 7FFE39363690h            ; CALL(Call_rel32_64) [5F41E310h:jmp64]                encoding(5 bytes) = e8 a0 e2 41 5f
...
; static ReadOnlySpan<byte> and_8x8Bytes => new byte[125]{0x57,0x56,0x53,0x48,0x83,0xEC,0x40,0xC5,0xF8,0x77,0x33,0xC0,0x48,0x89,0x44,0x24,0x28,0x48,0x8B,0xD9,0x48,0x8B,0xF2,0x49,0x8B,0xF8,0x48,0x8D,0x4C,0x24,0x28,0xC5,0xF8,0x57,0xC0,0xC5,0xFA,0x7F,0x01,0xC6,0x44,0x24,0x20,0x00,0x48,0x0F,0xBE,0x4C,0x24,0x20,0x88,0x4C,0x24,0x38,0x48,0x8D,0x4C,0x24,0x28,0x48,0x0F,0xBE,0x54,0x24,0x38,0x45,0x33,0xC0,0xE8,0xA7,0xD6,0xFF,0xFF,0x48,0x8B,0x06,0x48,0x8B,0x17,0x48,0x8D,0x4C,0x24,0x28,0x48,0x8B,0x09,0x48,0x8B,0x00,0x48,0x8B,0x12,0x48,0x23,0xC2,0x48,0x89,0x01,0x48,0x8B,0xFB,0x48,0x8D,0x74,0x24,0x28,0xE8,0xA0,0xE2,0x41,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x48,0x83,0xC4,0x40,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: BitMatrix<byte> and_8x8g(in BitMatrix<byte> A, in BitMatrix<byte> B)
; location: [7FFDD9F45820h, 7FFDD9F45884h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
002ch call 7FFDD9F45418h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFBF8h:jmp64]        encoding(5 bytes) = e8 c7 fb ff ff
...
0053h call 7FFE39363690h            ; CALL(Call_rel32_64) [5F41DE70h:jmp64]                encoding(5 bytes) = e8 18 de 41 5f
...
; static ReadOnlySpan<byte> and_8x8gBytes => new byte[101]{0x57,0x56,0x53,0x48,0x83,0xEC,0x30,0xC5,0xF8,0x77,0x33,0xC0,0x48,0x89,0x44,0x24,0x20,0x48,0x8B,0xD9,0x48,0x8B,0xF2,0x49,0x8B,0xF8,0x48,0x8D,0x4C,0x24,0x20,0xC5,0xF8,0x57,0xC0,0xC5,0xFA,0x7F,0x01,0x48,0x8D,0x4C,0x24,0x20,0xE8,0xC7,0xFB,0xFF,0xFF,0x48,0x8B,0x06,0x48,0x8B,0x17,0x48,0x8D,0x4C,0x24,0x20,0x48,0x8B,0x09,0x48,0x8B,0x00,0x48,0x8B,0x12,0x48,0x23,0xC2,0x48,0x89,0x01,0x48,0x8B,0xFB,0x48,0x8D,0x74,0x24,0x20,0xE8,0x18,0xDE,0x41,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x48,0x83,0xC4,0x30,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix8 and_8x8_ref(in BitMatrix8 A, in BitMatrix8 B, ref BitMatrix8 Z)
; location: [7FFDD9F458A0h, 7FFDD9F458BDh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFDD9F458D0h, 7FFDD9F458EDh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,[rcx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 01
0008h mov rdx,[rdx]                 ; MOV(Mov_r64_rm64) [RDX,mem(64u,RDX:br,:sr)]          encoding(3 bytes) = 48 8b 12
000bh mov rcx,[r8]                  ; MOV(Mov_r64_rm64) [RCX,mem(64u,R8:br,:sr)]           encoding(3 bytes) = 49 8b 08
...
; location: [7FFDD9F45A80h, 7FFDD9F45B35h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0047h call 7FFDD9F42A80h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFD000h:jmp64]        encoding(5 bytes) = e8 b4 cf ff ff
...
009eh call 7FFE39363690h            ; CALL(Call_rel32_64) [5F41DC10h:jmp64]                encoding(5 bytes) = e8 6d db 41 5f
...
; static ReadOnlySpan<byte> and_16x16Bytes => new byte[182]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix<ushort> and_16x16g_ref(in BitMatrix<ushort> A, in BitMatrix<ushort> B, ref BitMatrix<ushort> C)
; location: [7FFDD9F45F70h, 7FFDD9F45FC3h]
...
; location: [7FFDD9F45FF0h, 7FFDD9F460CCh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
0003h sub rsp,80h                   ; SUB(Sub_rm64_imm32) [RSP,80h:imm64]                  encoding(7 bytes) = 48 81 ec 80 00 00 00
...
003eh movsx rdx,byte ptr [rsp+78h]  ; MOVSX(Movsx_r64_rm8) [RDX,mem(8i,RSP:br,:sr)]        encoding(6 bytes) = 48 0f be 54 24 78
0044h xor r8d,r8d                   ; XOR(Xor_r32_rm32) [R8D,R8D]                          encoding(3 bytes) = 45 33 c0
0047h call 7FFDD9F42A90h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFCAA0h:jmp64]        encoding(5 bytes) = e8 54 ca ff ff
004ch mov rax,[rsi]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RSI:br,:sr)]          encoding(3 bytes) = 48 8b 06
004fh mov rdx,[rdi]                 ; MOV(Mov_r64_rm64) [RDX,mem(64u,RDI:br,:sr)]          encoding(3 bytes) = 48 8b 17
0052h lea rcx,[rsp+68h]             ; LEA(Lea_r64_m) [RCX,mem(Unknown,RSP:br,:sr)]         encoding(5 bytes) = 48 8d 4c 24 68
0057h mov rcx,[rcx]                 ; MOV(Mov_r64_rm64) [RCX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 09
...
00c5h call 7FFE39363690h            ; CALL(Call_rel32_64) [5F41D6A0h:jmp64]                encoding(5 bytes) = e8 d6 d5 41 5f
...
; static ReadOnlySpan<byte> and_32x32Bytes => new byte[221]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: BitMatrix<uint> and_32x32g(in BitMatrix<uint> A, in BitMatrix<uint> B)
; location: [7FFDD9F46100h, 7FFDD9F461C4h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
0003h sub rsp,80h                   ; SUB(Sub_rm64_imm32) [RSP,80h:imm64]                  encoding(7 bytes) = 48 81 ec 80 00 00 00
...
002fh call 7FFDD9F41F08h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFBE08h:jmp64]        encoding(5 bytes) = e8 d4 bd ff ff
...
00adh call 7FFE39363690h            ; CALL(Call_rel32_64) [5F41D590h:jmp64]                encoding(5 bytes) = e8 de d4 41 5f
...
; static ReadOnlySpan<byte> and_32x32gBytes => new byte[197]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix32 and_32x32_ref(in BitMatrix32 A, in BitMatrix32 B, ref BitMatrix32 Z)
; location: [7FFDD9F461F0h, 7FFDD9F4626Dh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
...
; location: [7FFDD9F462A0h, 7FFDD9F4631Dh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,48h                   ; SUB(Sub_rm64_imm8) [RSP,48h:imm64]                   encoding(4 bytes) = 48 83 ec 48
0006h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
...
; location: [7FFDD9F46350h, 7FFDD9F463CDh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,48h                   ; SUB(Sub_rm64_imm8) [RSP,48h:imm64]                   encoding(4 bytes) = 48 83 ec 48
0006h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
...
; location: [7FFDD9F46700h, 7FFDD9F46753h]
