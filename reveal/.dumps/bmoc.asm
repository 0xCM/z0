...
0030h call 7FFE3AC2F3E0h            ; CALL(Call_rel32_64) [5F4351C0h:jmp64]                encoding(5 bytes) = e8 8b 51 43 5f
0035h mov rdx,1E1F7822F40h          ; MOV(Mov_r64_imm64) [RDX,1e1f7822f40h:imm64]          encoding(10 bytes) = 48 ba 40 2f 82 f7 e1 01 00 00
...
004eh mov rcx,7FFDDB3B3260h         ; MOV(Mov_r64_imm64) [RCX,7ffddb3b3260h:imm64]         encoding(10 bytes) = 48 b9 60 32 3b db fd 7f 00 00
0058h call 7FFE3AC645E0h            ; CALL(Call_rel32_64) [5F46A3C0h:jmp64]                encoding(5 bytes) = e8 63 a3 46 5f
...
0070h call 7FFE39218F00h            ; CALL(Call_rel32_64) [5DA1ECE0h:jmp64]                encoding(5 bytes) = e8 6b ec a1 5d
...
0094h mov r9,1E1F7831950h           ; MOV(Mov_r64_imm64) [R9,1e1f7831950h:imm64]           encoding(10 bytes) = 49 b9 50 19 83 f7 e1 01 00 00
...
00c3h call 7FFDDB131420h            ; CALL(Call_rel32_64) [FFFFFFFFFF937200h:jmp64]        encoding(5 bytes) = e8 38 71 93 ff
...
; static ReadOnlySpan<byte> bm_from_natspan_64x64x64uBytes => new byte[210]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix<byte> gbm_and_8x8(in BitMatrix<byte> A, in BitMatrix<byte> B, ref BitMatrix<byte> C)
; location: [7FFDDB7FB500h, 7FFDDB7FB555h]
...
; location: [7FFDDB7FB980h, 7FFDDB7FBA05h]
...
; location: [7FFDDB7FBE40h, 7FFDDB7FBF0Dh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
...
0041h call 7FFDDB7FB7C8h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF988h:jmp64]        encoding(5 bytes) = e8 42 f9 ff ff
...
00b6h call 7FFE3AC63690h            ; CALL(Call_rel32_64) [5F467850h:jmp64]                encoding(5 bytes) = e8 95 77 46 5f
...
; static ReadOnlySpan<byte> gbm_and_16x16_allocBytes => new byte[206]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix16 pbm_and_16x16(in BitMatrix16 A, in BitMatrix16 B, ref BitMatrix16 C)
; location: [7FFDDB7FBF40h, 7FFDDB7FBFBAh]
...
002fh call 7FFDDB7FA9B8h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFE9D8h:jmp64]        encoding(5 bytes) = e8 a4 e9 ff ff
...
00a2h call 7FFE3AD8EF00h            ; CALL(Call_rel32_64) [5F592F20h:jmp64]                encoding(5 bytes) = e8 79 2e 59 5f
00a7h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> pbm_and_16x16_allocBytes => new byte[168]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ref BitMatrix<uint> gbm_and_32x32(in BitMatrix<uint> A, in BitMatrix<uint> B, ref BitMatrix<uint> C)
; location: [7FFDDB7FC4C0h, 7FFDDB7FC659h]
...
; location: [7FFDDB7FC6B0h, 7FFDDB7FCC9Eh]
