; 2019-12-31 22:07:09:641
; function: RowBits<byte> and_8u(RowBits<byte> x, RowBits<byte> y, RowBits<byte> dst)
; location: [7FF7C7BC3A80h, 7FF7C7BC3AD3h]
...
000dh jle short 0040h               ; JLE(Jle_rel8_64) [40h:jmp64]                         encoding(2 bytes) = 7e 31
...
0018h mov rsi,[rdx]                 ; MOV(Mov_r64_rm64) [RSI,mem(64u,RDX:br,:sr)]          encoding(3 bytes) = 48 8b 32
001bh movzx esi,byte ptr [rsi+r11]  ; MOVZX(Movzx_r32_rm8) [ESI,mem(8u,RSI:br,:sr)]        encoding(5 bytes) = 42 0f b6 34 1e
0020h mov rdi,[r8]                  ; MOV(Mov_r64_rm64) [RDI,mem(64u,R8:br,:sr)]           encoding(3 bytes) = 49 8b 38
0023h movzx r11d,byte ptr [rdi+r11] ; MOVZX(Movzx_r32_rm8) [R11D,mem(8u,RDI:br,:sr)]       encoding(5 bytes) = 46 0f b6 1c 1f
0028h movzx esi,sil                 ; MOVZX(Movzx_r32_rm8) [ESI,SIL]                       encoding(4 bytes) = 40 0f b6 f6
002ch movzx esi,sil                 ; MOVZX(Movzx_r32_rm8) [ESI,SIL]                       encoding(4 bytes) = 40 0f b6 f6
0030h and r11d,esi                  ; AND(And_r32_rm32) [R11D,ESI]                         encoding(3 bytes) = 44 23 de
0033h movzx r11d,r11b               ; MOVZX(Movzx_r32_rm8) [R11D,R11L]                     encoding(4 bytes) = 45 0f b6 db
0037h mov [r10],r11b                ; MOV(Mov_rm8_r8) [mem(8u,R10:br,:sr),R11L]            encoding(3 bytes) = 45 88 1a
003ah inc ecx                       ; INC(Inc_rm32) [ECX]                                  encoding(2 bytes) = ff c1
003ch cmp ecx,eax                   ; CMP(Cmp_r32_rm32) [ECX,EAX]                          encoding(2 bytes) = 3b c8
003eh jl short 000fh                ; JL(Jl_rel8_64) [Fh:jmp64]                            encoding(2 bytes) = 7c cf
0040h mov rdi,rbx                   ; MOV(Mov_r64_rm64) [RDI,RBX]                          encoding(3 bytes) = 48 8b fb
0043h mov rsi,r9                    ; MOV(Mov_r64_rm64) [RSI,R9]                           encoding(3 bytes) = 49 8b f1
0046h call 7FF826FA5E90h            ; CALL(Call_rel32_64) [5F3E2410h:jmp64]                encoding(5 bytes) = e8 c5 23 3e 5f
004bh movsq                         ; MOVSQ(Movsq_m64_m64) [mem(64u),mem(64u,:sr)]         encoding(2 bytes) = 48 a5
004dh mov rax,rbx                   ; MOV(Mov_r64_rm64) [RAX,RBX]                          encoding(3 bytes) = 48 8b c3
...
; static ReadOnlySpan<byte> and_8uBytes => new byte[84]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x8B,0x42,0x08,0x33,0xC9,0x85,0xC0,0x7E,0x31,0x4D,0x8B,0x11,0x4C,0x63,0xD9,0x4D,0x03,0xD3,0x48,0x8B,0x32,0x42,0x0F,0xB6,0x34,0x1E,0x49,0x8B,0x38,0x46,0x0F,0xB6,0x1C,0x1F,0x40,0x0F,0xB6,0xF6,0x40,0x0F,0xB6,0xF6,0x44,0x23,0xDE,0x45,0x0F,0xB6,0xDB,0x45,0x88,0x1A,0xFF,0xC1,0x3B,0xC8,0x7C,0xCF,0x48,0x8B,0xFB,0x49,0x8B,0xF1,0xE8,0xC5,0x23,0x3E,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: RowBits<ushort> and_16u(RowBits<ushort> x, RowBits<ushort> y, RowBits<ushort> dst)
; location: [7FF7C7BC3F00h, 7FF7C7BC3F53h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
0003h mov rbx,rcx                   ; MOV(Mov_r64_rm64) [RBX,RCX]                          encoding(3 bytes) = 48 8b d9
...
001ch movzx esi,word ptr [rsi+r11*2]; MOVZX(Movzx_r32_rm16) [ESI,mem(16u,RSI:br,:sr)]      encoding(5 bytes) = 42 0f b7 34 5e
0021h mov rdi,[r8]                  ; MOV(Mov_r64_rm64) [RDI,mem(64u,R8:br,:sr)]           encoding(3 bytes) = 49 8b 38
0024h movzx r11d,word ptr [rdi+r11*2]; MOVZX(Movzx_r32_rm16) [R11D,mem(16u,RDI:br,:sr)]    encoding(5 bytes) = 46 0f b7 1c 5f
0029h movzx esi,si                  ; MOVZX(Movzx_r32_rm16) [ESI,SI]                       encoding(3 bytes) = 0f b7 f6
002ch movzx esi,si                  ; MOVZX(Movzx_r32_rm16) [ESI,SI]                       encoding(3 bytes) = 0f b7 f6
002fh and r11d,esi                  ; AND(And_r32_rm32) [R11D,ESI]                         encoding(3 bytes) = 44 23 de
0032h movzx r11d,r11w               ; MOVZX(Movzx_r32_rm16) [R11D,R11W]                    encoding(4 bytes) = 45 0f b7 db
0036h mov [r10],r11w                ; MOV(Mov_rm16_r16) [mem(16u,R10:br,:sr),R11W]         encoding(4 bytes) = 66 45 89 1a
003ah inc ecx                       ; INC(Inc_rm32) [ECX]                                  encoding(2 bytes) = ff c1
003ch cmp ecx,eax                   ; CMP(Cmp_r32_rm32) [ECX,EAX]                          encoding(2 bytes) = 3b c8
003eh jl short 000fh                ; JL(Jl_rel8_64) [Fh:jmp64]                            encoding(2 bytes) = 7c cf
0040h mov rdi,rbx                   ; MOV(Mov_r64_rm64) [RDI,RBX]                          encoding(3 bytes) = 48 8b fb
0043h mov rsi,r9                    ; MOV(Mov_r64_rm64) [RSI,R9]                           encoding(3 bytes) = 49 8b f1
0046h call 7FF826FA5E90h            ; CALL(Call_rel32_64) [5F3E1F90h:jmp64]                encoding(5 bytes) = e8 45 1f 3e 5f
004bh movsq                         ; MOVSQ(Movsq_m64_m64) [mem(64u),mem(64u,:sr)]         encoding(2 bytes) = 48 a5
004dh mov rax,rbx                   ; MOV(Mov_r64_rm64) [RAX,RBX]                          encoding(3 bytes) = 48 8b c3
0050h pop rbx                       ; POP(Pop_r64) [RBX]                                   encoding(1 byte ) = 5b
0051h pop rsi                       ; POP(Pop_r64) [RSI]                                   encoding(1 byte ) = 5e
0052h pop rdi                       ; POP(Pop_r64) [RDI]                                   encoding(1 byte ) = 5f
0053h ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> and_16uBytes => new byte[84]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x8B,0x42,0x08,0x33,0xC9,0x85,0xC0,0x7E,0x31,0x4D,0x8B,0x11,0x4C,0x63,0xD9,0x4F,0x8D,0x14,0x5A,0x48,0x8B,0x32,0x42,0x0F,0xB7,0x34,0x5E,0x49,0x8B,0x38,0x46,0x0F,0xB7,0x1C,0x5F,0x0F,0xB7,0xF6,0x0F,0xB7,0xF6,0x44,0x23,0xDE,0x45,0x0F,0xB7,0xDB,0x66,0x45,0x89,0x1A,0xFF,0xC1,0x3B,0xC8,0x7C,0xCF,0x48,0x8B,0xFB,0x49,0x8B,0xF1,0xE8,0x45,0x1F,0x3E,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: RowBits<uint> and_32u(RowBits<uint> x, RowBits<uint> y, RowBits<uint> dst)
; location: [7FF7C7BC40B0h, 7FF7C7BC40F6h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
0003h mov rbx,rcx                   ; MOV(Mov_r64_rm64) [RBX,RCX]                          encoding(3 bytes) = 48 8b d9
...
0039h call 7FF826FA5E90h            ; CALL(Call_rel32_64) [5F3E1DE0h:jmp64]                encoding(5 bytes) = e8 a2 1d 3e 5f
...
; static ReadOnlySpan<byte> and_32uBytes => new byte[71]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x8B,0x42,0x08,0x33,0xC9,0x85,0xC0,0x7E,0x24,0x4D,0x8B,0x11,0x4C,0x63,0xD9,0x4F,0x8D,0x14,0x9A,0x48,0x8B,0x32,0x42,0x8B,0x34,0x9E,0x49,0x8B,0x38,0x46,0x8B,0x1C,0x9F,0x44,0x23,0xDE,0x45,0x89,0x1A,0xFF,0xC1,0x3B,0xC8,0x7C,0xDC,0x48,0x8B,0xFB,0x49,0x8B,0xF1,0xE8,0xA2,0x1D,0x3E,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: RowBits<ulong> and_64u(RowBits<ulong> x, RowBits<ulong> y, RowBits<ulong> dst)
; location: [7FF7C7BC4660h, 7FF7C7BC46A6h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
0003h mov rbx,rcx                   ; MOV(Mov_r64_rm64) [RBX,RCX]                          encoding(3 bytes) = 48 8b d9
...
0033h mov rdi,rbx                   ; MOV(Mov_r64_rm64) [RDI,RBX]                          encoding(3 bytes) = 48 8b fb
0036h mov rsi,r9                    ; MOV(Mov_r64_rm64) [RSI,R9]                           encoding(3 bytes) = 49 8b f1
0039h call 7FF826FA5E90h            ; CALL(Call_rel32_64) [5F3E1830h:jmp64]                encoding(5 bytes) = e8 f2 17 3e 5f
003eh movsq                         ; MOVSQ(Movsq_m64_m64) [mem(64u),mem(64u,:sr)]         encoding(2 bytes) = 48 a5
0040h mov rax,rbx                   ; MOV(Mov_r64_rm64) [RAX,RBX]                          encoding(3 bytes) = 48 8b c3
0043h pop rbx                       ; POP(Pop_r64) [RBX]                                   encoding(1 byte ) = 5b
0044h pop rsi                       ; POP(Pop_r64) [RSI]                                   encoding(1 byte ) = 5e
0045h pop rdi                       ; POP(Pop_r64) [RDI]                                   encoding(1 byte ) = 5f
0046h ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> and_64uBytes => new byte[71]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x8B,0x42,0x08,0x33,0xC9,0x85,0xC0,0x7E,0x24,0x4D,0x8B,0x11,0x4C,0x63,0xD9,0x4F,0x8D,0x14,0xDA,0x48,0x8B,0x32,0x4A,0x8B,0x34,0xDE,0x49,0x8B,0x38,0x4E,0x8B,0x1C,0xDF,0x4C,0x23,0xDE,0x4D,0x89,0x1A,0xFF,0xC1,0x3B,0xC8,0x7C,0xDC,0x48,0x8B,0xFB,0x49,0x8B,0xF1,0xE8,0xF2,0x17,0x3E,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: RowBits<ulong> and_64u_op(RowBits<ulong> x, RowBits<ulong> y)
; location: [7FF7C7BC46C0h, 7FF7C7BC473Fh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
002fh call 7FF7C7BC4428h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFD68h:jmp64]        encoding(5 bytes) = e8 34 fd ff ff
...
006eh call 7FF826FA5E90h            ; CALL(Call_rel32_64) [5F3E17D0h:jmp64]                encoding(5 bytes) = e8 5d 17 3e 5f
...
; static ReadOnlySpan<byte> and_64u_opBytes => new byte[128]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: RowBits<byte> xor_8u(RowBits<byte> x, RowBits<byte> y, RowBits<byte> dst)
; location: [7FF7C7BC4CB0h, 7FF7C7BC4D03h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
0003h mov rbx,rcx                   ; MOV(Mov_r64_rm64) [RBX,RCX]                          encoding(3 bytes) = 48 8b d9
...
0028h movzx esi,sil                 ; MOVZX(Movzx_r32_rm8) [ESI,SIL]                       encoding(4 bytes) = 40 0f b6 f6
002ch movzx esi,sil                 ; MOVZX(Movzx_r32_rm8) [ESI,SIL]                       encoding(4 bytes) = 40 0f b6 f6
0030h xor r11d,esi                  ; XOR(Xor_r32_rm32) [R11D,ESI]                         encoding(3 bytes) = 44 33 de
0033h movzx r11d,r11b               ; MOVZX(Movzx_r32_rm8) [R11D,R11L]                     encoding(4 bytes) = 45 0f b6 db
0037h mov [r10],r11b                ; MOV(Mov_rm8_r8) [mem(8u,R10:br,:sr),R11L]            encoding(3 bytes) = 45 88 1a
003ah inc ecx                       ; INC(Inc_rm32) [ECX]                                  encoding(2 bytes) = ff c1
003ch cmp ecx,eax                   ; CMP(Cmp_r32_rm32) [ECX,EAX]                          encoding(2 bytes) = 3b c8
...
0040h mov rdi,rbx                   ; MOV(Mov_r64_rm64) [RDI,RBX]                          encoding(3 bytes) = 48 8b fb
0043h mov rsi,r9                    ; MOV(Mov_r64_rm64) [RSI,R9]                           encoding(3 bytes) = 49 8b f1
0046h call 7FF826FA5E90h            ; CALL(Call_rel32_64) [5F3E11E0h:jmp64]                encoding(5 bytes) = e8 95 11 3e 5f
004bh movsq                         ; MOVSQ(Movsq_m64_m64) [mem(64u),mem(64u,:sr)]         encoding(2 bytes) = 48 a5
004dh mov rax,rbx                   ; MOV(Mov_r64_rm64) [RAX,RBX]                          encoding(3 bytes) = 48 8b c3
0050h pop rbx                       ; POP(Pop_r64) [RBX]                                   encoding(1 byte ) = 5b
0051h pop rsi                       ; POP(Pop_r64) [RSI]                                   encoding(1 byte ) = 5e
0052h pop rdi                       ; POP(Pop_r64) [RDI]                                   encoding(1 byte ) = 5f
0053h ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> xor_8uBytes => new byte[84]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x8B,0x42,0x08,0x33,0xC9,0x85,0xC0,0x7E,0x31,0x4D,0x8B,0x11,0x4C,0x63,0xD9,0x4D,0x03,0xD3,0x48,0x8B,0x32,0x42,0x0F,0xB6,0x34,0x1E,0x49,0x8B,0x38,0x46,0x0F,0xB6,0x1C,0x1F,0x40,0x0F,0xB6,0xF6,0x40,0x0F,0xB6,0xF6,0x44,0x33,0xDE,0x45,0x0F,0xB6,0xDB,0x45,0x88,0x1A,0xFF,0xC1,0x3B,0xC8,0x7C,0xCF,0x48,0x8B,0xFB,0x49,0x8B,0xF1,0xE8,0x95,0x11,0x3E,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: RowBits<ushort> xor_16u(RowBits<ushort> x, RowBits<ushort> y, RowBits<ushort> dst)
; location: [7FF7C7BC4D20h, 7FF7C7BC4D73h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
0003h mov rbx,rcx                   ; MOV(Mov_r64_rm64) [RBX,RCX]                          encoding(3 bytes) = 48 8b d9
...
0029h movzx esi,si                  ; MOVZX(Movzx_r32_rm16) [ESI,SI]                       encoding(3 bytes) = 0f b7 f6
002ch movzx esi,si                  ; MOVZX(Movzx_r32_rm16) [ESI,SI]                       encoding(3 bytes) = 0f b7 f6
002fh xor r11d,esi                  ; XOR(Xor_r32_rm32) [R11D,ESI]                         encoding(3 bytes) = 44 33 de
0032h movzx r11d,r11w               ; MOVZX(Movzx_r32_rm16) [R11D,R11W]                    encoding(4 bytes) = 45 0f b7 db
0036h mov [r10],r11w                ; MOV(Mov_rm16_r16) [mem(16u,R10:br,:sr),R11W]         encoding(4 bytes) = 66 45 89 1a
003ah inc ecx                       ; INC(Inc_rm32) [ECX]                                  encoding(2 bytes) = ff c1
003ch cmp ecx,eax                   ; CMP(Cmp_r32_rm32) [ECX,EAX]                          encoding(2 bytes) = 3b c8
...
0040h mov rdi,rbx                   ; MOV(Mov_r64_rm64) [RDI,RBX]                          encoding(3 bytes) = 48 8b fb
0043h mov rsi,r9                    ; MOV(Mov_r64_rm64) [RSI,R9]                           encoding(3 bytes) = 49 8b f1
0046h call 7FF826FA5E90h            ; CALL(Call_rel32_64) [5F3E1170h:jmp64]                encoding(5 bytes) = e8 25 11 3e 5f
004bh movsq                         ; MOVSQ(Movsq_m64_m64) [mem(64u),mem(64u,:sr)]         encoding(2 bytes) = 48 a5
004dh mov rax,rbx                   ; MOV(Mov_r64_rm64) [RAX,RBX]                          encoding(3 bytes) = 48 8b c3
0050h pop rbx                       ; POP(Pop_r64) [RBX]                                   encoding(1 byte ) = 5b
0051h pop rsi                       ; POP(Pop_r64) [RSI]                                   encoding(1 byte ) = 5e
0052h pop rdi                       ; POP(Pop_r64) [RDI]                                   encoding(1 byte ) = 5f
0053h ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> xor_16uBytes => new byte[84]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x8B,0x42,0x08,0x33,0xC9,0x85,0xC0,0x7E,0x31,0x4D,0x8B,0x11,0x4C,0x63,0xD9,0x4F,0x8D,0x14,0x5A,0x48,0x8B,0x32,0x42,0x0F,0xB7,0x34,0x5E,0x49,0x8B,0x38,0x46,0x0F,0xB7,0x1C,0x5F,0x0F,0xB7,0xF6,0x0F,0xB7,0xF6,0x44,0x33,0xDE,0x45,0x0F,0xB7,0xDB,0x66,0x45,0x89,0x1A,0xFF,0xC1,0x3B,0xC8,0x7C,0xCF,0x48,0x8B,0xFB,0x49,0x8B,0xF1,0xE8,0x25,0x11,0x3E,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: RowBits<uint> xor_32u(RowBits<uint> x, RowBits<uint> y, RowBits<uint> dst)
; location: [7FF7C7BC4D90h, 7FF7C7BC4DD6h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
0003h mov rbx,rcx                   ; MOV(Mov_r64_rm64) [RBX,RCX]                          encoding(3 bytes) = 48 8b d9
...
0033h mov rdi,rbx                   ; MOV(Mov_r64_rm64) [RDI,RBX]                          encoding(3 bytes) = 48 8b fb
0036h mov rsi,r9                    ; MOV(Mov_r64_rm64) [RSI,R9]                           encoding(3 bytes) = 49 8b f1
0039h call 7FF826FA5E90h            ; CALL(Call_rel32_64) [5F3E1100h:jmp64]                encoding(5 bytes) = e8 c2 10 3e 5f
003eh movsq                         ; MOVSQ(Movsq_m64_m64) [mem(64u),mem(64u,:sr)]         encoding(2 bytes) = 48 a5
0040h mov rax,rbx                   ; MOV(Mov_r64_rm64) [RAX,RBX]                          encoding(3 bytes) = 48 8b c3
0043h pop rbx                       ; POP(Pop_r64) [RBX]                                   encoding(1 byte ) = 5b
0044h pop rsi                       ; POP(Pop_r64) [RSI]                                   encoding(1 byte ) = 5e
0045h pop rdi                       ; POP(Pop_r64) [RDI]                                   encoding(1 byte ) = 5f
0046h ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> xor_32uBytes => new byte[71]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x8B,0x42,0x08,0x33,0xC9,0x85,0xC0,0x7E,0x24,0x4D,0x8B,0x11,0x4C,0x63,0xD9,0x4F,0x8D,0x14,0x9A,0x48,0x8B,0x32,0x42,0x8B,0x34,0x9E,0x49,0x8B,0x38,0x46,0x8B,0x1C,0x9F,0x44,0x33,0xDE,0x45,0x89,0x1A,0xFF,0xC1,0x3B,0xC8,0x7C,0xDC,0x48,0x8B,0xFB,0x49,0x8B,0xF1,0xE8,0xC2,0x10,0x3E,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: RowBits<ulong> xor_64u(RowBits<ulong> x, RowBits<ulong> y, RowBits<ulong> dst)
; location: [7FF7C7BC4DF0h, 7FF7C7BC4E36h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
0003h mov rbx,rcx                   ; MOV(Mov_r64_rm64) [RBX,RCX]                          encoding(3 bytes) = 48 8b d9
...
0033h mov rdi,rbx                   ; MOV(Mov_r64_rm64) [RDI,RBX]                          encoding(3 bytes) = 48 8b fb
0036h mov rsi,r9                    ; MOV(Mov_r64_rm64) [RSI,R9]                           encoding(3 bytes) = 49 8b f1
0039h call 7FF826FA5E90h            ; CALL(Call_rel32_64) [5F3E10A0h:jmp64]                encoding(5 bytes) = e8 62 10 3e 5f
003eh movsq                         ; MOVSQ(Movsq_m64_m64) [mem(64u),mem(64u,:sr)]         encoding(2 bytes) = 48 a5
0040h mov rax,rbx                   ; MOV(Mov_r64_rm64) [RAX,RBX]                          encoding(3 bytes) = 48 8b c3
0043h pop rbx                       ; POP(Pop_r64) [RBX]                                   encoding(1 byte ) = 5b
0044h pop rsi                       ; POP(Pop_r64) [RSI]                                   encoding(1 byte ) = 5e
0045h pop rdi                       ; POP(Pop_r64) [RDI]                                   encoding(1 byte ) = 5f
0046h ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> xor_64uBytes => new byte[71]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x8B,0x42,0x08,0x33,0xC9,0x85,0xC0,0x7E,0x24,0x4D,0x8B,0x11,0x4C,0x63,0xD9,0x4F,0x8D,0x14,0xDA,0x48,0x8B,0x32,0x4A,0x8B,0x34,0xDE,0x49,0x8B,0x38,0x4E,0x8B,0x1C,0xDF,0x4C,0x33,0xDE,0x4D,0x89,0x1A,0xFF,0xC1,0x3B,0xC8,0x7C,0xDC,0x48,0x8B,0xFB,0x49,0x8B,0xF1,0xE8,0x62,0x10,0x3E,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: RowBits<byte> xnor_8u(RowBits<byte> x, RowBits<byte> y, RowBits<byte> dst)
; location: [7FF7C7BC4E50h, 7FF7C7BC4EAAh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
0003h mov rbx,rcx                   ; MOV(Mov_r64_rm64) [RBX,RCX]                          encoding(3 bytes) = 48 8b d9
...
0009h xor ecx,ecx                   ; XOR(Xor_r32_rm32) [ECX,ECX]                          encoding(2 bytes) = 33 c9
000bh test eax,eax                  ; TEST(Test_rm32_r32) [EAX,EAX]                        encoding(2 bytes) = 85 c0
000dh jle short 0047h               ; JLE(Jle_rel8_64) [47h:jmp64]                         encoding(2 bytes) = 7e 38
000fh mov r10,[r9]                  ; MOV(Mov_r64_rm64) [R10,mem(64u,R9:br,:sr)]           encoding(3 bytes) = 4d 8b 11
0012h movsxd r11,ecx                ; MOVSXD(Movsxd_r64_rm32) [R11,ECX]                    encoding(3 bytes) = 4c 63 d9
0015h add r10,r11                   ; ADD(Add_r64_rm64) [R10,R11]                          encoding(3 bytes) = 4d 03 d3
0018h mov rsi,[rdx]                 ; MOV(Mov_r64_rm64) [RSI,mem(64u,RDX:br,:sr)]          encoding(3 bytes) = 48 8b 32
...
0030h xor r11d,esi                  ; XOR(Xor_r32_rm32) [R11D,ESI]                         encoding(3 bytes) = 44 33 de
0033h movzx r11d,r11b               ; MOVZX(Movzx_r32_rm8) [R11D,R11L]                     encoding(4 bytes) = 45 0f b6 db
0037h not r11d                      ; NOT(Not_rm32) [R11D]                                 encoding(3 bytes) = 41 f7 d3
003ah movzx r11d,r11b               ; MOVZX(Movzx_r32_rm8) [R11D,R11L]                     encoding(4 bytes) = 45 0f b6 db
003eh mov [r10],r11b                ; MOV(Mov_rm8_r8) [mem(8u,R10:br,:sr),R11L]            encoding(3 bytes) = 45 88 1a
0041h inc ecx                       ; INC(Inc_rm32) [ECX]                                  encoding(2 bytes) = ff c1
0043h cmp ecx,eax                   ; CMP(Cmp_r32_rm32) [ECX,EAX]                          encoding(2 bytes) = 3b c8
0045h jl short 000fh                ; JL(Jl_rel8_64) [Fh:jmp64]                            encoding(2 bytes) = 7c c8
0047h mov rdi,rbx                   ; MOV(Mov_r64_rm64) [RDI,RBX]                          encoding(3 bytes) = 48 8b fb
004ah mov rsi,r9                    ; MOV(Mov_r64_rm64) [RSI,R9]                           encoding(3 bytes) = 49 8b f1
004dh call 7FF826FA5E90h            ; CALL(Call_rel32_64) [5F3E1040h:jmp64]                encoding(5 bytes) = e8 ee 0f 3e 5f
0052h movsq                         ; MOVSQ(Movsq_m64_m64) [mem(64u),mem(64u,:sr)]         encoding(2 bytes) = 48 a5
0054h mov rax,rbx                   ; MOV(Mov_r64_rm64) [RAX,RBX]                          encoding(3 bytes) = 48 8b c3
0057h pop rbx                       ; POP(Pop_r64) [RBX]                                   encoding(1 byte ) = 5b
...
; static ReadOnlySpan<byte> xnor_8uBytes => new byte[91]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x8B,0x42,0x08,0x33,0xC9,0x85,0xC0,0x7E,0x38,0x4D,0x8B,0x11,0x4C,0x63,0xD9,0x4D,0x03,0xD3,0x48,0x8B,0x32,0x42,0x0F,0xB6,0x34,0x1E,0x49,0x8B,0x38,0x46,0x0F,0xB6,0x1C,0x1F,0x40,0x0F,0xB6,0xF6,0x40,0x0F,0xB6,0xF6,0x44,0x33,0xDE,0x45,0x0F,0xB6,0xDB,0x41,0xF7,0xD3,0x45,0x0F,0xB6,0xDB,0x45,0x88,0x1A,0xFF,0xC1,0x3B,0xC8,0x7C,0xC8,0x48,0x8B,0xFB,0x49,0x8B,0xF1,0xE8,0xEE,0x0F,0x3E,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: RowBits<ushort> xnor_16u(RowBits<ushort> x, RowBits<ushort> y, RowBits<ushort> dst)
; location: [7FF7C7BC52D0h, 7FF7C7BC532Ah]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
0003h mov rbx,rcx                   ; MOV(Mov_r64_rm64) [RBX,RCX]                          encoding(3 bytes) = 48 8b d9
...
002fh xor r11d,esi                  ; XOR(Xor_r32_rm32) [R11D,ESI]                         encoding(3 bytes) = 44 33 de
0032h movzx r11d,r11w               ; MOVZX(Movzx_r32_rm16) [R11D,R11W]                    encoding(4 bytes) = 45 0f b7 db
0036h not r11d                      ; NOT(Not_rm32) [R11D]                                 encoding(3 bytes) = 41 f7 d3
0039h movzx r11d,r11w               ; MOVZX(Movzx_r32_rm16) [R11D,R11W]                    encoding(4 bytes) = 45 0f b7 db
003dh mov [r10],r11w                ; MOV(Mov_rm16_r16) [mem(16u,R10:br,:sr),R11W]         encoding(4 bytes) = 66 45 89 1a
0041h inc ecx                       ; INC(Inc_rm32) [ECX]                                  encoding(2 bytes) = ff c1
0043h cmp ecx,eax                   ; CMP(Cmp_r32_rm32) [ECX,EAX]                          encoding(2 bytes) = 3b c8
0045h jl short 000fh                ; JL(Jl_rel8_64) [Fh:jmp64]                            encoding(2 bytes) = 7c c8
0047h mov rdi,rbx                   ; MOV(Mov_r64_rm64) [RDI,RBX]                          encoding(3 bytes) = 48 8b fb
004ah mov rsi,r9                    ; MOV(Mov_r64_rm64) [RSI,R9]                           encoding(3 bytes) = 49 8b f1
004dh call 7FF826FA5E90h            ; CALL(Call_rel32_64) [5F3E0BC0h:jmp64]                encoding(5 bytes) = e8 6e 0b 3e 5f
0052h movsq                         ; MOVSQ(Movsq_m64_m64) [mem(64u),mem(64u,:sr)]         encoding(2 bytes) = 48 a5
0054h mov rax,rbx                   ; MOV(Mov_r64_rm64) [RAX,RBX]                          encoding(3 bytes) = 48 8b c3
0057h pop rbx                       ; POP(Pop_r64) [RBX]                                   encoding(1 byte ) = 5b
0058h pop rsi                       ; POP(Pop_r64) [RSI]                                   encoding(1 byte ) = 5e
0059h pop rdi                       ; POP(Pop_r64) [RDI]                                   encoding(1 byte ) = 5f
005ah ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> xnor_16uBytes => new byte[91]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x8B,0x42,0x08,0x33,0xC9,0x85,0xC0,0x7E,0x38,0x4D,0x8B,0x11,0x4C,0x63,0xD9,0x4F,0x8D,0x14,0x5A,0x48,0x8B,0x32,0x42,0x0F,0xB7,0x34,0x5E,0x49,0x8B,0x38,0x46,0x0F,0xB7,0x1C,0x5F,0x0F,0xB7,0xF6,0x0F,0xB7,0xF6,0x44,0x33,0xDE,0x45,0x0F,0xB7,0xDB,0x41,0xF7,0xD3,0x45,0x0F,0xB7,0xDB,0x66,0x45,0x89,0x1A,0xFF,0xC1,0x3B,0xC8,0x7C,0xC8,0x48,0x8B,0xFB,0x49,0x8B,0xF1,0xE8,0x6E,0x0B,0x3E,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: RowBits<uint> xnor_32u(RowBits<uint> x, RowBits<uint> y, RowBits<uint> dst)
; location: [7FF7C7BC5350h, 7FF7C7BC5399h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
0003h mov rbx,rcx                   ; MOV(Mov_r64_rm64) [RBX,RCX]                          encoding(3 bytes) = 48 8b d9
...
003ch call 7FF826FA5E90h            ; CALL(Call_rel32_64) [5F3E0B40h:jmp64]                encoding(5 bytes) = e8 ff 0a 3e 5f
...
0036h mov rdi,rbx                   ; MOV(Mov_r64_rm64) [RDI,RBX]                          encoding(3 bytes) = 48 8b fb
0039h mov rsi,r9                    ; MOV(Mov_r64_rm64) [RSI,R9]                           encoding(3 bytes) = 49 8b f1
003ch call 7FF826FA5E90h            ; CALL(Call_rel32_64) [5F3E0AD0h:jmp64]                encoding(5 bytes) = e8 8f 0a 3e 5f
0041h movsq                         ; MOVSQ(Movsq_m64_m64) [mem(64u),mem(64u,:sr)]         encoding(2 bytes) = 48 a5
0043h mov rax,rbx                   ; MOV(Mov_r64_rm64) [RAX,RBX]                          encoding(3 bytes) = 48 8b c3
0046h pop rbx                       ; POP(Pop_r64) [RBX]                                   encoding(1 byte ) = 5b
0047h pop rsi                       ; POP(Pop_r64) [RSI]                                   encoding(1 byte ) = 5e
...
0036h call 7FF826FA5E90h            ; CALL(Call_rel32_64) [5F3E0660h:jmp64]                encoding(5 bytes) = e8 25 06 3e 5f
...
; static ReadOnlySpan<byte> not_8uBytes => new byte[68]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x33,0xC0,0x83,0x7A,0x08,0x00,0x7E,0x22,0x49,0x8B,0x08,0x4C,0x63,0xC8,0x49,0x03,0xC9,0x4C,0x8B,0x12,0x47,0x0F,0xB6,0x0C,0x0A,0x41,0xF7,0xD1,0x45,0x0F,0xB6,0xC9,0x44,0x88,0x09,0xFF,0xC0,0x3B,0x42,0x08,0x7C,0xDE,0x48,0x8B,0xFB,0x49,0x8B,0xF0,0xE8,0x25,0x06,0x3E,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: RowBits<ushort> not_16u(RowBits<ushort> x, RowBits<ushort> dst)
; location: [7FF7C7BC5890h, 7FF7C7BC58D5h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
0003h mov rbx,rcx                   ; MOV(Mov_r64_rm64) [RBX,RCX]                          encoding(3 bytes) = 48 8b d9
...
0038h call 7FF826FA5E90h            ; CALL(Call_rel32_64) [5F3E0600h:jmp64]                encoding(5 bytes) = e8 c3 05 3e 5f
...
; static ReadOnlySpan<byte> not_16uBytes => new byte[70]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x33,0xC0,0x83,0x7A,0x08,0x00,0x7E,0x24,0x49,0x8B,0x08,0x4C,0x63,0xC8,0x4A,0x8D,0x0C,0x49,0x4C,0x8B,0x12,0x47,0x0F,0xB7,0x0C,0x4A,0x41,0xF7,0xD1,0x45,0x0F,0xB7,0xC9,0x66,0x44,0x89,0x09,0xFF,0xC0,0x3B,0x42,0x08,0x7C,0xDC,0x48,0x8B,0xFB,0x49,0x8B,0xF0,0xE8,0xC3,0x05,0x3E,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: RowBits<uint> not_32u(RowBits<uint> x, RowBits<uint> dst)
; location: [7FF7C7BC58F0h, 7FF7C7BC592Fh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
0003h mov rbx,rcx                   ; MOV(Mov_r64_rm64) [RBX,RCX]                          encoding(3 bytes) = 48 8b d9
...
0032h call 7FF826FA5E90h            ; CALL(Call_rel32_64) [5F3E05A0h:jmp64]                encoding(5 bytes) = e8 69 05 3e 5f
...
; static ReadOnlySpan<byte> not_32uBytes => new byte[64]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x33,0xC0,0x83,0x7A,0x08,0x00,0x7E,0x1E,0x49,0x8B,0x08,0x4C,0x63,0xC8,0x4A,0x8D,0x0C,0x89,0x4C,0x8B,0x12,0x47,0x8B,0x0C,0x8A,0x41,0xF7,0xD1,0x44,0x89,0x09,0xFF,0xC0,0x3B,0x42,0x08,0x7C,0xE2,0x48,0x8B,0xFB,0x49,0x8B,0xF0,0xE8,0x69,0x05,0x3E,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: RowBits<ulong> not_64u(RowBits<ulong> x, RowBits<ulong> dst)
; location: [7FF7C7BC5950h, 7FF7C7BC5992h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
0003h mov rbx,rcx                   ; MOV(Mov_r64_rm64) [RBX,RCX]                          encoding(3 bytes) = 48 8b d9
...
0035h call 7FF826FA5E90h            ; CALL(Call_rel32_64) [5F3E0540h:jmp64]                encoding(5 bytes) = e8 06 05 3e 5f
...
; static ReadOnlySpan<byte> not_64uBytes => new byte[67]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x33,0xC0,0x83,0x7A,0x08,0x00,0x7E,0x21,0x49,0x8B,0x08,0x4C,0x63,0xC8,0x4A,0x8D,0x0C,0xC9,0x4C,0x8B,0x0A,0x4C,0x63,0xD0,0x4F,0x8B,0x0C,0xD1,0x49,0xF7,0xD1,0x4C,0x89,0x09,0xFF,0xC0,0x3B,0x42,0x08,0x7C,0xDF,0x48,0x8B,0xFB,0x49,0x8B,0xF0,0xE8,0x06,0x05,0x3E,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
