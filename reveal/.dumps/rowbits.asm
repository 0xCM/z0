...
0048h call 7FF827265E90h                      ; CALL(Call_rel32_64) [5F421C00h:jmp64]      encoding(5 bytes) = e8 b3 1b 42 5f
...
0049h call 7FF827265E90h                      ; CALL(Call_rel32_64) [5F421780h:jmp64]      encoding(5 bytes) = e8 32 17 42 5f
...
0039h call 7FF827265E90h                      ; CALL(Call_rel32_64) [5F4215C0h:jmp64]      encoding(5 bytes) = e8 82 15 42 5f
...
; static ReadOnlySpan<byte> and_64uBytes => new byte[71]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x8B,0x42,0x08,0x33,0xC9,0x85,0xC0,0x7E,0x24,0x4D,0x8B,0x11,0x4C,0x63,0xD9,0x4F,0x8D,0x14,0xDA,0x48,0x8B,0x32,0x4A,0x8B,0x34,0xDE,0x49,0x8B,0x38,0x4E,0x8B,0x1C,0xDF,0x4C,0x23,0xDE,0x4D,0x89,0x1A,0xFF,0xC1,0x3B,0xC8,0x7C,0xDC,0x48,0x8B,0xFB,0x49,0x8B,0xF1,0xE8,0x12,0x11,0x42,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
0000h push rdi                                ; PUSH(Push_r64) [RDI]                       encoding(1 byte ) = 57
0001h push rsi                                ; PUSH(Push_r64) [RSI]                       encoding(1 byte ) = 56
0002h push rbx                                ; PUSH(Push_r64) [RBX]                       encoding(1 byte ) = 53
0003h mov rbx,rcx                             ; MOV(Mov_r64_rm64) [RBX,RCX]                encoding(3 bytes) = 48 8b d9
...
0033h mov rdi,rbx                             ; MOV(Mov_r64_rm64) [RDI,RBX]                encoding(3 bytes) = 48 8b fb
0036h mov rsi,r9                              ; MOV(Mov_r64_rm64) [RSI,R9]                 encoding(3 bytes) = 49 8b f1
0039h call 7FF827265E90h                      ; CALL(Call_rel32_64) [5F421150h:jmp64]      encoding(5 bytes) = e8 12 11 42 5f
003eh movsq                                   ; MOVSQ(Movsq_m64_m64) [mem(64u),mem(64u,:sr)] encoding(2 bytes) = 48 a5
0040h mov rax,rbx                             ; MOV(Mov_r64_rm64) [RAX,RBX]                encoding(3 bytes) = 48 8b c3
0043h pop rbx                                 ; POP(Pop_r64) [RBX]                         encoding(1 byte ) = 5b
0044h pop rsi                                 ; POP(Pop_r64) [RSI]                         encoding(1 byte ) = 5e
...
; static ReadOnlySpan<byte> and_64u_opBytes => new byte[128]{};
0000h push rdi                                ; PUSH(Push_r64) [RDI]                       encoding(1 byte ) = 57
0001h push rsi                                ; PUSH(Push_r64) [RSI]                       encoding(1 byte ) = 56
0002h push rbx                                ; PUSH(Push_r64) [RBX]                       encoding(1 byte ) = 53
...
002fh call 7FF7C7E44CA8h                      ; CALL(Call_rel32_64) [FFFFFFFFFFFFFF08h:jmp64] encoding(5 bytes) = e8 d4 fe ff ff
...
006eh call 7FF827265E90h                      ; CALL(Call_rel32_64) [5F4210F0h:jmp64]      encoding(5 bytes) = e8 7d 10 42 5f
...
0042h mov rdi,rbx                             ; MOV(Mov_r64_rm64) [RDI,RBX]                encoding(3 bytes) = 48 8b fb
0045h mov rsi,r9                              ; MOV(Mov_r64_rm64) [RSI,R9]                 encoding(3 bytes) = 49 8b f1
0048h call 7FF827265E90h                      ; CALL(Call_rel32_64) [5F420C40h:jmp64]      encoding(5 bytes) = e8 f3 0b 42 5f
004dh movsq                                   ; MOVSQ(Movsq_m64_m64) [mem(64u),mem(64u,:sr)] encoding(2 bytes) = 48 a5
004fh mov rax,rbx                             ; MOV(Mov_r64_rm64) [RAX,RBX]                encoding(3 bytes) = 48 8b c3
0052h pop rbx                                 ; POP(Pop_r64) [RBX]                         encoding(1 byte ) = 5b
0053h pop rsi                                 ; POP(Pop_r64) [RSI]                         encoding(1 byte ) = 5e
...
0043h mov rdi,rbx                             ; MOV(Mov_r64_rm64) [RDI,RBX]                encoding(3 bytes) = 48 8b fb
0046h mov rsi,r9                              ; MOV(Mov_r64_rm64) [RSI,R9]                 encoding(3 bytes) = 49 8b f1
0049h call 7FF827265E90h                      ; CALL(Call_rel32_64) [5F420BD0h:jmp64]      encoding(5 bytes) = e8 82 0b 42 5f
004eh movsq                                   ; MOVSQ(Movsq_m64_m64) [mem(64u),mem(64u,:sr)] encoding(2 bytes) = 48 a5
0050h mov rax,rbx                             ; MOV(Mov_r64_rm64) [RAX,RBX]                encoding(3 bytes) = 48 8b c3
0053h pop rbx                                 ; POP(Pop_r64) [RBX]                         encoding(1 byte ) = 5b
0054h pop rsi                                 ; POP(Pop_r64) [RSI]                         encoding(1 byte ) = 5e
...
0033h mov rdi,rbx                             ; MOV(Mov_r64_rm64) [RDI,RBX]                encoding(3 bytes) = 48 8b fb
0036h mov rsi,r9                              ; MOV(Mov_r64_rm64) [RSI,R9]                 encoding(3 bytes) = 49 8b f1
0039h call 7FF827265E90h                      ; CALL(Call_rel32_64) [5F420B60h:jmp64]      encoding(5 bytes) = e8 22 0b 42 5f
003eh movsq                                   ; MOVSQ(Movsq_m64_m64) [mem(64u),mem(64u,:sr)] encoding(2 bytes) = 48 a5
0040h mov rax,rbx                             ; MOV(Mov_r64_rm64) [RAX,RBX]                encoding(3 bytes) = 48 8b c3
0043h pop rbx                                 ; POP(Pop_r64) [RBX]                         encoding(1 byte ) = 5b
0044h pop rsi                                 ; POP(Pop_r64) [RSI]                         encoding(1 byte ) = 5e
...
; static ReadOnlySpan<byte> xor_64uBytes => new byte[71]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x8B,0x42,0x08,0x33,0xC9,0x85,0xC0,0x7E,0x24,0x4D,0x8B,0x11,0x4C,0x63,0xD9,0x4F,0x8D,0x14,0xDA,0x48,0x8B,0x32,0x4A,0x8B,0x34,0xDE,0x49,0x8B,0x38,0x4E,0x8B,0x1C,0xDF,0x4C,0x33,0xDE,0x4D,0x89,0x1A,0xFF,0xC1,0x3B,0xC8,0x7C,0xDC,0x48,0x8B,0xFB,0x49,0x8B,0xF1,0xE8,0xC2,0x0A,0x42,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
0000h push rdi                                ; PUSH(Push_r64) [RDI]                       encoding(1 byte ) = 57
0001h push rsi                                ; PUSH(Push_r64) [RSI]                       encoding(1 byte ) = 56
0002h push rbx                                ; PUSH(Push_r64) [RBX]                       encoding(1 byte ) = 53
0003h mov rbx,rcx                             ; MOV(Mov_r64_rm64) [RBX,RCX]                encoding(3 bytes) = 48 8b d9
...
0033h mov rdi,rbx                             ; MOV(Mov_r64_rm64) [RDI,RBX]                encoding(3 bytes) = 48 8b fb
0036h mov rsi,r9                              ; MOV(Mov_r64_rm64) [RSI,R9]                 encoding(3 bytes) = 49 8b f1
0039h call 7FF827265E90h                      ; CALL(Call_rel32_64) [5F420B00h:jmp64]      encoding(5 bytes) = e8 c2 0a 42 5f
003eh movsq                                   ; MOVSQ(Movsq_m64_m64) [mem(64u),mem(64u,:sr)] encoding(2 bytes) = 48 a5
0040h mov rax,rbx                             ; MOV(Mov_r64_rm64) [RAX,RBX]                encoding(3 bytes) = 48 8b c3
0043h pop rbx                                 ; POP(Pop_r64) [RBX]                         encoding(1 byte ) = 5b
0044h pop rsi                                 ; POP(Pop_r64) [RSI]                         encoding(1 byte ) = 5e
...
004bh call 7FF827265E90h                      ; CALL(Call_rel32_64) [5F420690h:jmp64]      encoding(5 bytes) = e8 40 06 42 5f
...
; static ReadOnlySpan<byte> xnor_16uBytes => new byte[90]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x8B,0x42,0x08,0x33,0xC9,0x85,0xC0,0x7E,0x37,0x4D,0x8B,0x11,0x4C,0x63,0xD9,0x4F,0x8D,0x14,0x5A,0x4C,0x8B,0x1A,0x48,0x63,0xF1,0x45,0x0F,0xB7,0x1C,0x73,0x49,0x8B,0x30,0x48,0x63,0xF9,0x0F,0xB7,0x34,0x7E,0x45,0x0F,0xB7,0xDB,0x44,0x33,0xDE,0x41,0xF7,0xD3,0x45,0x0F,0xB7,0xDB,0x66,0x45,0x89,0x1A,0xFF,0xC1,0x3B,0xC8,0x7C,0xC9,0x48,0x8B,0xFB,0x49,0x8B,0xF1,0xE8,0xBF,0x05,0x42,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
0000h push rdi                                ; PUSH(Push_r64) [RDI]                       encoding(1 byte ) = 57
0001h push rsi                                ; PUSH(Push_r64) [RSI]                       encoding(1 byte ) = 56
0002h push rbx                                ; PUSH(Push_r64) [RBX]                       encoding(1 byte ) = 53
0003h mov rbx,rcx                             ; MOV(Mov_r64_rm64) [RBX,RCX]                encoding(3 bytes) = 48 8b d9
...
004ch call 7FF827265E90h                      ; CALL(Call_rel32_64) [5F420610h:jmp64]      encoding(5 bytes) = e8 bf 05 42 5f
...
003ch call 7FF827265E90h                      ; CALL(Call_rel32_64) [5F420590h:jmp64]      encoding(5 bytes) = e8 4f 05 42 5f
...
0036h mov rdi,rbx                             ; MOV(Mov_r64_rm64) [RDI,RBX]                encoding(3 bytes) = 48 8b fb
0039h mov rsi,r9                              ; MOV(Mov_r64_rm64) [RSI,R9]                 encoding(3 bytes) = 49 8b f1
003ch call 7FF827265E90h                      ; CALL(Call_rel32_64) [5F420520h:jmp64]      encoding(5 bytes) = e8 df 04 42 5f
0041h movsq                                   ; MOVSQ(Movsq_m64_m64) [mem(64u),mem(64u,:sr)] encoding(2 bytes) = 48 a5
0043h mov rax,rbx                             ; MOV(Mov_r64_rm64) [RAX,RBX]                encoding(3 bytes) = 48 8b c3
0046h pop rbx                                 ; POP(Pop_r64) [RBX]                         encoding(1 byte ) = 5b
0047h pop rsi                                 ; POP(Pop_r64) [RSI]                         encoding(1 byte ) = 5e
...
0036h call 7FF827265E90h                      ; CALL(Call_rel32_64) [5F4200B0h:jmp64]      encoding(5 bytes) = e8 75 00 42 5f
...
0038h call 7FF827265E90h                      ; CALL(Call_rel32_64) [5F420050h:jmp64]      encoding(5 bytes) = e8 13 00 42 5f
...
; static ReadOnlySpan<byte> not_32uBytes => new byte[64]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x33,0xC0,0x83,0x7A,0x08,0x00,0x7E,0x1E,0x49,0x8B,0x08,0x4C,0x63,0xC8,0x4A,0x8D,0x0C,0x89,0x4C,0x8B,0x12,0x47,0x8B,0x0C,0x8A,0x41,0xF7,0xD1,0x44,0x89,0x09,0xFF,0xC0,0x3B,0x42,0x08,0x7C,0xE2,0x48,0x8B,0xFB,0x49,0x8B,0xF0,0xE8,0xB9,0xFF,0x41,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
0000h push rdi                                ; PUSH(Push_r64) [RDI]                       encoding(1 byte ) = 57
0001h push rsi                                ; PUSH(Push_r64) [RSI]                       encoding(1 byte ) = 56
0002h push rbx                                ; PUSH(Push_r64) [RBX]                       encoding(1 byte ) = 53
0003h mov rbx,rcx                             ; MOV(Mov_r64_rm64) [RBX,RCX]                encoding(3 bytes) = 48 8b d9
...
0032h call 7FF827265E90h                      ; CALL(Call_rel32_64) [5F41FFF0h:jmp64]      encoding(5 bytes) = e8 b9 ff 41 5f
...
; static ReadOnlySpan<byte> not_64uBytes => new byte[67]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x33,0xC0,0x83,0x7A,0x08,0x00,0x7E,0x21,0x49,0x8B,0x08,0x4C,0x63,0xC8,0x4A,0x8D,0x0C,0xC9,0x4C,0x8B,0x0A,0x4C,0x63,0xD0,0x4F,0x8B,0x0C,0xD1,0x49,0xF7,0xD1,0x4C,0x89,0x09,0xFF,0xC0,0x3B,0x42,0x08,0x7C,0xDF,0x48,0x8B,0xFB,0x49,0x8B,0xF0,0xE8,0x56,0xFB,0x41,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
0000h push rdi                                ; PUSH(Push_r64) [RDI]                       encoding(1 byte ) = 57
0001h push rsi                                ; PUSH(Push_r64) [RSI]                       encoding(1 byte ) = 56
0002h push rbx                                ; PUSH(Push_r64) [RBX]                       encoding(1 byte ) = 53
0003h mov rbx,rcx                             ; MOV(Mov_r64_rm64) [RBX,RCX]                encoding(3 bytes) = 48 8b d9
...
0035h call 7FF827265E90h                      ; CALL(Call_rel32_64) [5F41FB90h:jmp64]      encoding(5 bytes) = e8 56 fb 41 5f
