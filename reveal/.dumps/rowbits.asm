...
0048h call 7FF8154D5E90h                      ; CALL(Call_rel32_64) [5F44B370h:jmp64]      encoding(5 bytes) = e8 23 b3 44 5f
...
0046h call 7FF8154D5E90h                      ; CALL(Call_rel32_64) [5F44AEF0h:jmp64]      encoding(5 bytes) = e8 a5 ae 44 5f
...
0039h call 7FF8154D5E90h                      ; CALL(Call_rel32_64) [5F44AA70h:jmp64]      encoding(5 bytes) = e8 32 aa 44 5f
...
; static ReadOnlySpan<byte> and_64uBytes => new byte[71]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x8B,0x42,0x08,0x33,0xC9,0x85,0xC0,0x7E,0x24,0x4D,0x8B,0x11,0x4C,0x63,0xD9,0x4F,0x8D,0x14,0xDA,0x48,0x8B,0x32,0x4A,0x8B,0x34,0xDE,0x49,0x8B,0x38,0x4E,0x8B,0x1C,0xDF,0x4C,0x23,0xDE,0x4D,0x89,0x1A,0xFF,0xC1,0x3B,0xC8,0x7C,0xDC,0x48,0x8B,0xFB,0x49,0x8B,0xF1,0xE8,0xD2,0xA9,0x44,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
0000h push rdi                                ; PUSH(Push_r64) [RDI]                       encoding(1 byte ) = 57
0001h push rsi                                ; PUSH(Push_r64) [RSI]                       encoding(1 byte ) = 56
0002h push rbx                                ; PUSH(Push_r64) [RBX]                       encoding(1 byte ) = 53
0003h mov rbx,rcx                             ; MOV(Mov_r64_rm64) [RBX,RCX]                encoding(3 bytes) = 48 8b d9
...
0033h mov rdi,rbx                             ; MOV(Mov_r64_rm64) [RDI,RBX]                encoding(3 bytes) = 48 8b fb
0036h mov rsi,r9                              ; MOV(Mov_r64_rm64) [RSI,R9]                 encoding(3 bytes) = 49 8b f1
0039h call 7FF8154D5E90h                      ; CALL(Call_rel32_64) [5F44AA10h:jmp64]      encoding(5 bytes) = e8 d2 a9 44 5f
003eh movsq                                   ; MOVSQ(Movsq_m64_m64) [mem(64u),mem(64u,:sr)] encoding(2 bytes) = 48 a5
0040h mov rax,rbx                             ; MOV(Mov_r64_rm64) [RAX,RBX]                encoding(3 bytes) = 48 8b c3
0043h pop rbx                                 ; POP(Pop_r64) [RBX]                         encoding(1 byte ) = 5b
0044h pop rsi                                 ; POP(Pop_r64) [RSI]                         encoding(1 byte ) = 5e
...
002fh call 7FF7B608B3F8h                      ; CALL(Call_rel32_64) [FFFFFFFFFFFFFB08h:jmp64] encoding(5 bytes) = e8 d4 fa ff ff
...
006eh call 7FF8154D5E90h                      ; CALL(Call_rel32_64) [5F44A5A0h:jmp64]      encoding(5 bytes) = e8 2d a5 44 5f
...
0042h mov rdi,rbx                             ; MOV(Mov_r64_rm64) [RDI,RBX]                encoding(3 bytes) = 48 8b fb
0045h mov rsi,r9                              ; MOV(Mov_r64_rm64) [RSI,R9]                 encoding(3 bytes) = 49 8b f1
0048h call 7FF8154D5E90h                      ; CALL(Call_rel32_64) [5F44A500h:jmp64]      encoding(5 bytes) = e8 b3 a4 44 5f
004dh movsq                                   ; MOVSQ(Movsq_m64_m64) [mem(64u),mem(64u,:sr)] encoding(2 bytes) = 48 a5
004fh mov rax,rbx                             ; MOV(Mov_r64_rm64) [RAX,RBX]                encoding(3 bytes) = 48 8b c3
0052h pop rbx                                 ; POP(Pop_r64) [RBX]                         encoding(1 byte ) = 5b
0053h pop rsi                                 ; POP(Pop_r64) [RSI]                         encoding(1 byte ) = 5e
...
0049h call 7FF8154D5E90h                      ; CALL(Call_rel32_64) [5F44A490h:jmp64]      encoding(5 bytes) = e8 42 a4 44 5f
...
0033h mov rdi,rbx                             ; MOV(Mov_r64_rm64) [RDI,RBX]                encoding(3 bytes) = 48 8b fb
0036h mov rsi,r9                              ; MOV(Mov_r64_rm64) [RSI,R9]                 encoding(3 bytes) = 49 8b f1
0039h call 7FF8154D5E90h                      ; CALL(Call_rel32_64) [5F44A420h:jmp64]      encoding(5 bytes) = e8 e2 a3 44 5f
003eh movsq                                   ; MOVSQ(Movsq_m64_m64) [mem(64u),mem(64u,:sr)] encoding(2 bytes) = 48 a5
0040h mov rax,rbx                             ; MOV(Mov_r64_rm64) [RAX,RBX]                encoding(3 bytes) = 48 8b c3
0043h pop rbx                                 ; POP(Pop_r64) [RBX]                         encoding(1 byte ) = 5b
0044h pop rsi                                 ; POP(Pop_r64) [RSI]                         encoding(1 byte ) = 5e
...
; static ReadOnlySpan<byte> xor_64uBytes => new byte[71]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x8B,0x42,0x08,0x33,0xC9,0x85,0xC0,0x7E,0x24,0x4D,0x8B,0x11,0x4C,0x63,0xD9,0x4F,0x8D,0x14,0xDA,0x48,0x8B,0x32,0x4A,0x8B,0x34,0xDE,0x49,0x8B,0x38,0x4E,0x8B,0x1C,0xDF,0x4C,0x33,0xDE,0x4D,0x89,0x1A,0xFF,0xC1,0x3B,0xC8,0x7C,0xDC,0x48,0x8B,0xFB,0x49,0x8B,0xF1,0xE8,0x82,0xA3,0x44,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
0000h push rdi                                ; PUSH(Push_r64) [RDI]                       encoding(1 byte ) = 57
0001h push rsi                                ; PUSH(Push_r64) [RSI]                       encoding(1 byte ) = 56
0002h push rbx                                ; PUSH(Push_r64) [RBX]                       encoding(1 byte ) = 53
0003h mov rbx,rcx                             ; MOV(Mov_r64_rm64) [RBX,RCX]                encoding(3 bytes) = 48 8b d9
...
0033h mov rdi,rbx                             ; MOV(Mov_r64_rm64) [RDI,RBX]                encoding(3 bytes) = 48 8b fb
0036h mov rsi,r9                              ; MOV(Mov_r64_rm64) [RSI,R9]                 encoding(3 bytes) = 49 8b f1
0039h call 7FF8154D5E90h                      ; CALL(Call_rel32_64) [5F44A3C0h:jmp64]      encoding(5 bytes) = e8 82 a3 44 5f
003eh movsq                                   ; MOVSQ(Movsq_m64_m64) [mem(64u),mem(64u,:sr)] encoding(2 bytes) = 48 a5
0040h mov rax,rbx                             ; MOV(Mov_r64_rm64) [RAX,RBX]                encoding(3 bytes) = 48 8b c3
0043h pop rbx                                 ; POP(Pop_r64) [RBX]                         encoding(1 byte ) = 5b
0044h pop rsi                                 ; POP(Pop_r64) [RSI]                         encoding(1 byte ) = 5e
...
004bh call 7FF8154D5E90h                      ; CALL(Call_rel32_64) [5F449F50h:jmp64]      encoding(5 bytes) = e8 00 9f 44 5f
...
; static ReadOnlySpan<byte> xnor_16uBytes => new byte[90]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x8B,0x42,0x08,0x33,0xC9,0x85,0xC0,0x7E,0x37,0x4D,0x8B,0x11,0x4C,0x63,0xD9,0x4F,0x8D,0x14,0x5A,0x4C,0x8B,0x1A,0x48,0x63,0xF1,0x45,0x0F,0xB7,0x1C,0x73,0x49,0x8B,0x30,0x48,0x63,0xF9,0x0F,0xB7,0x34,0x7E,0x45,0x0F,0xB7,0xDB,0x44,0x33,0xDE,0x41,0xF7,0xD3,0x45,0x0F,0xB7,0xDB,0x66,0x45,0x89,0x1A,0xFF,0xC1,0x3B,0xC8,0x7C,0xC9,0x48,0x8B,0xFB,0x49,0x8B,0xF1,0xE8,0x7F,0x9E,0x44,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
0000h push rdi                                ; PUSH(Push_r64) [RDI]                       encoding(1 byte ) = 57
0001h push rsi                                ; PUSH(Push_r64) [RSI]                       encoding(1 byte ) = 56
0002h push rbx                                ; PUSH(Push_r64) [RBX]                       encoding(1 byte ) = 53
0003h mov rbx,rcx                             ; MOV(Mov_r64_rm64) [RBX,RCX]                encoding(3 bytes) = 48 8b d9
...
004ch call 7FF8154D5E90h                      ; CALL(Call_rel32_64) [5F449ED0h:jmp64]      encoding(5 bytes) = e8 7f 9e 44 5f
...
003ch call 7FF8154D5E90h                      ; CALL(Call_rel32_64) [5F449E50h:jmp64]      encoding(5 bytes) = e8 0f 9e 44 5f
...
0036h mov rdi,rbx                             ; MOV(Mov_r64_rm64) [RDI,RBX]                encoding(3 bytes) = 48 8b fb
0039h mov rsi,r9                              ; MOV(Mov_r64_rm64) [RSI,R9]                 encoding(3 bytes) = 49 8b f1
003ch call 7FF8154D5E90h                      ; CALL(Call_rel32_64) [5F449DE0h:jmp64]      encoding(5 bytes) = e8 9f 9d 44 5f
0041h movsq                                   ; MOVSQ(Movsq_m64_m64) [mem(64u),mem(64u,:sr)] encoding(2 bytes) = 48 a5
0043h mov rax,rbx                             ; MOV(Mov_r64_rm64) [RAX,RBX]                encoding(3 bytes) = 48 8b c3
0046h pop rbx                                 ; POP(Pop_r64) [RBX]                         encoding(1 byte ) = 5b
0047h pop rsi                                 ; POP(Pop_r64) [RSI]                         encoding(1 byte ) = 5e
...
0036h call 7FF8154D5E90h                      ; CALL(Call_rel32_64) [5F449970h:jmp64]      encoding(5 bytes) = e8 35 99 44 5f
...
; static ReadOnlySpan<byte> not_16uBytes => new byte[70]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x33,0xC0,0x83,0x7A,0x08,0x00,0x7E,0x24,0x49,0x8B,0x08,0x4C,0x63,0xC8,0x4A,0x8D,0x0C,0x49,0x4C,0x8B,0x12,0x47,0x0F,0xB7,0x0C,0x4A,0x41,0xF7,0xD1,0x45,0x0F,0xB7,0xC9,0x66,0x44,0x89,0x09,0xFF,0xC0,0x3B,0x42,0x08,0x7C,0xDC,0x48,0x8B,0xFB,0x49,0x8B,0xF0,0xE8,0xD3,0x98,0x44,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
0000h push rdi                                ; PUSH(Push_r64) [RDI]                       encoding(1 byte ) = 57
0001h push rsi                                ; PUSH(Push_r64) [RSI]                       encoding(1 byte ) = 56
0002h push rbx                                ; PUSH(Push_r64) [RBX]                       encoding(1 byte ) = 53
0003h mov rbx,rcx                             ; MOV(Mov_r64_rm64) [RBX,RCX]                encoding(3 bytes) = 48 8b d9
...
0038h call 7FF8154D5E90h                      ; CALL(Call_rel32_64) [5F449910h:jmp64]      encoding(5 bytes) = e8 d3 98 44 5f
...
; static ReadOnlySpan<byte> not_32uBytes => new byte[64]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x33,0xC0,0x83,0x7A,0x08,0x00,0x7E,0x1E,0x49,0x8B,0x08,0x4C,0x63,0xC8,0x4A,0x8D,0x0C,0x89,0x4C,0x8B,0x12,0x47,0x8B,0x0C,0x8A,0x41,0xF7,0xD1,0x44,0x89,0x09,0xFF,0xC0,0x3B,0x42,0x08,0x7C,0xE2,0x48,0x8B,0xFB,0x49,0x8B,0xF0,0xE8,0x79,0x98,0x44,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
0000h push rdi                                ; PUSH(Push_r64) [RDI]                       encoding(1 byte ) = 57
0001h push rsi                                ; PUSH(Push_r64) [RSI]                       encoding(1 byte ) = 56
0002h push rbx                                ; PUSH(Push_r64) [RBX]                       encoding(1 byte ) = 53
0003h mov rbx,rcx                             ; MOV(Mov_r64_rm64) [RBX,RCX]                encoding(3 bytes) = 48 8b d9
...
0032h call 7FF8154D5E90h                      ; CALL(Call_rel32_64) [5F4498B0h:jmp64]      encoding(5 bytes) = e8 79 98 44 5f
...
; static ReadOnlySpan<byte> not_64uBytes => new byte[67]{0x57,0x56,0x53,0x48,0x8B,0xD9,0x33,0xC0,0x83,0x7A,0x08,0x00,0x7E,0x21,0x49,0x8B,0x08,0x4C,0x63,0xC8,0x4A,0x8D,0x0C,0xC9,0x4C,0x8B,0x0A,0x4C,0x63,0xD0,0x4F,0x8B,0x0C,0xD1,0x49,0xF7,0xD1,0x4C,0x89,0x09,0xFF,0xC0,0x3B,0x42,0x08,0x7C,0xDF,0x48,0x8B,0xFB,0x49,0x8B,0xF0,0xE8,0x16,0x94,0x44,0x5F,0x48,0xA5,0x48,0x8B,0xC3,0x5B,0x5E,0x5F,0xC3};
0000h push rdi                                ; PUSH(Push_r64) [RDI]                       encoding(1 byte ) = 57
0001h push rsi                                ; PUSH(Push_r64) [RSI]                       encoding(1 byte ) = 56
0002h push rbx                                ; PUSH(Push_r64) [RBX]                       encoding(1 byte ) = 53
0003h mov rbx,rcx                             ; MOV(Mov_r64_rm64) [RBX,RCX]                encoding(3 bytes) = 48 8b d9
...
0035h call 7FF8154D5E90h                      ; CALL(Call_rel32_64) [5F449450h:jmp64]      encoding(5 bytes) = e8 16 94 44 5f
