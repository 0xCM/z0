...
0004h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0007h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
000bh mov rax,10C6A158A79h          ; MOV(Mov_r64_imm64) [RAX,10c6a158a79h:imm64]          encoding(10 bytes) = 48 b8 79 8a 15 6a 0c 01 00 00
...
; static ReadOnlySpan<byte> vreverse_128x8uBytes => new byte[48]{0x48,0x83,0xEC,0x28,0xC5,0xF8,0x77,0xC5,0xF9,0x10,0x02,0x48,0xB8,0x79,0x8A,0x15,0x6A,0x0C,0x01,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0x48,0x83,0xC4,0x28,0xC3,0xE8,0xE1,0x1A,0x61,0x5F,0xCC};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
0011h mov rax,10C6A158A79h          ; MOV(Mov_r64_imm64) [RAX,10c6a158a79h:imm64]          encoding(10 bytes) = 48 b8 79 8a 15 6a 0c 01 00 00
...
; static ReadOnlySpan<byte> vreverse_256x8uBytes => new byte[88]{0x48,0x83,0xEC,0x28,0xC5,0xF8,0x77,0xC5,0xFD,0x10,0x02,0xC4,0xE3,0x7D,0x19,0xC1,0x01,0x48,0xB8,0x79,0x8A,0x15,0x6A,0x0C,0x01,0x00,0x00,0xC5,0xFB,0xF0,0x10,0xC4,0xE2,0x71,0x00,0xCA,0xC4,0xE3,0x7D,0x19,0xC0,0x00,0xC5,0xFB,0xF0,0x10,0xC4,0xE2,0x79,0x00,0xC2,0xC5,0xEC,0x57,0xD2,0xC4,0xE3,0x6D,0x38,0xC9,0x00,0xC4,0xE3,0x75,0x38,0xC0,0x01,0xC5,0xFD,0x11,0x01,0x48,0x8B,0xC1,0xC5,0xF8,0x77,0x48,0x83,0xC4,0x28,0xC3,0xE8,0x69,0x1A,0x61,0x5F,0xCC};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h mov rax,10C6A158C69h          ; MOV(Mov_r64_imm64) [RAX,10c6a158c69h:imm64]          encoding(10 bytes) = 48 b8 69 8c 15 6a 0c 01 00 00
...
0023h ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> vrotlx_n8Bytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0x69,0x8C,0x15,0x6A,0x0C,0x01,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
0000h sub rsp,38h                   ; SUB(Sub_rm64_imm8) [RSP,38h:imm64]                   encoding(4 bytes) = 48 83 ec 38
0004h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0007h mov rax,10C6A1589E9h          ; MOV(Mov_r64_imm64) [RAX,10c6a1589e9h:imm64]          encoding(10 bytes) = 48 b8 e9 89 15 6a 0c 01 00 00
...
; static ReadOnlySpan<byte> pattern_lanemerge_256x8uBytes => new byte[45]{0x48,0x83,0xEC,0x38,0xC5,0xF8,0x77,0x48,0xB8,0xE9,0x89,0x15,0x6A,0x0C,0x01,0x00,0x00,0xC5,0xFF,0xF0,0x00,0xC5,0xFC,0x28,0xC8,0xC5,0xFD,0x11,0x04,0x24,0xC5,0xFD,0x11,0x09,0x48,0x8B,0xC1,0xC5,0xF8,0x77,0x48,0x83,0xC4,0x38,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<ushort> pattern_lanemerge_256x16u()
; location: [7FFDDAFD42A0h, 7FFDDAFD42CCh]
0000h sub rsp,38h                   ; SUB(Sub_rm64_imm8) [RSP,38h:imm64]                   encoding(4 bytes) = 48 83 ec 38
0004h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0007h mov rax,10C6A158BD9h          ; MOV(Mov_r64_imm64) [RAX,10c6a158bd9h:imm64]          encoding(10 bytes) = 48 b8 d9 8b 15 6a 0c 01 00 00
0011h vlddqu ymm0,ymmword ptr [rax] ; VLDDQU(VEX_Vlddqu_ymm_m256) [YMM0,mem(UInt256,RAX:br,:sr)] encoding(VEX, 4 bytes) = c5 ff f0 00
0015h vmovaps ymm1,ymm0             ; VMOVAPS(VEX_Vmovaps_ymm_ymmm256) [YMM1,YMM0]         encoding(VEX, 4 bytes) = c5 fc 28 c8
0019h vmovupd [rsp],ymm0            ; VMOVUPD(VEX_Vmovupd_ymmm256_ymm) [mem(Packed256_Float64,RSP:br,:sr),YMM0] encoding(VEX, 5 bytes) = c5 fd 11 04 24
001eh vmovupd [rcx],ymm1            ; VMOVUPD(VEX_Vmovupd_ymmm256_ymm) [mem(Packed256_Float64,RCX:br,:sr),YMM1] encoding(VEX, 4 bytes) = c5 fd 11 09
...
0028h add rsp,38h                   ; ADD(Add_rm64_imm8) [RSP,38h:imm64]                   encoding(4 bytes) = 48 83 c4 38
002ch ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> pattern_lanemerge_256x16uBytes => new byte[45]{0x48,0x83,0xEC,0x38,0xC5,0xF8,0x77,0x48,0xB8,0xD9,0x8B,0x15,0x6A,0x0C,0x01,0x00,0x00,0xC5,0xFF,0xF0,0x00,0xC5,0xFC,0x28,0xC8,0xC5,0xFD,0x11,0x04,0x24,0xC5,0xFD,0x11,0x09,0x48,0x8B,0xC1,0xC5,0xF8,0x77,0x48,0x83,0xC4,0x38,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h mov rax,10C6A158DF9h          ; MOV(Mov_r64_imm64) [RAX,10c6a158df9h:imm64]          encoding(10 bytes) = 48 b8 f9 8d 15 6a 0c 01 00 00
0013h vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
0017h vpshufb xmm0,xmm0,xmm1        ; VPSHUFB(VEX_Vpshufb_xmm_xmm_xmmm128) [XMM0,XMM0,XMM1] encoding(VEX, 5 bytes) = c4 e2 79 00 c1
001ch vmovupd [rcx],xmm0            ; VMOVUPD(VEX_Vmovupd_xmmm128_xmm) [mem(Packed128_Float64,RCX:br,:sr),XMM0] encoding(VEX, 4 bytes) = c5 f9 11 01
0020h mov rax,rcx                   ; MOV(Mov_r64_rm64) [RAX,RCX]                          encoding(3 bytes) = 48 8b c1
0023h ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0xF9,0x8D,0x15,0x6A,0x0C,0x01,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,10C6A158AD9h          ; MOV(Mov_r64_imm64) [RAX,10c6a158ad9h:imm64]          encoding(10 bytes) = 48 b8 d9 8a 15 6a 0c 01 00 00
...
002bh mov rax,10C6A158CF9h          ; MOV(Mov_r64_imm64) [RAX,10c6a158cf9h:imm64]          encoding(10 bytes) = 48 b8 f9 8c 15 6a 0c 01 00 00
...
; static ReadOnlySpan<byte> vpermvar32x8_256x8uBytes => new byte[81]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xFD,0x10,0x02,0xC4,0xC1,0x7D,0x10,0x08,0x48,0xB8,0xD9,0x8A,0x15,0x6A,0x0C,0x01,0x00,0x00,0xC5,0xFF,0xF0,0x10,0xC5,0xF5,0xFC,0xD2,0xC4,0xE2,0x7D,0x00,0xD2,0xC4,0xE3,0x7D,0x46,0xC0,0x03,0x48,0xB8,0xF9,0x8C,0x15,0x6A,0x0C,0x01,0x00,0x00,0xC5,0xFF,0xF0,0x18,0xC5,0xF5,0xFC,0xCB,0xC4,0xE2,0x7D,0x00,0xC1,0xC5,0xED,0xEB,0xC0,0xC5,0xFD,0x11,0x01,0x48,0x8B,0xC1,0xC5,0xF8,0x77,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector128<byte> rotl_128x16_pattern()
; location: [7FFDDAFD4430h, 7FFDDAFD444Ah]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h mov rax,10C6A158C79h          ; MOV(Mov_r64_imm64) [RAX,10c6a158c79h:imm64]          encoding(10 bytes) = 48 b8 79 8c 15 6a 0c 01 00 00
000fh vlddqu xmm0,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM0,mem(UInt128,RAX:br,:sr)] encoding(VEX, 4 bytes) = c5 fb f0 00
0013h vmovupd [rcx],xmm0            ; VMOVUPD(VEX_Vmovupd_xmmm128_xmm) [mem(Packed128_Float64,RCX:br,:sr),XMM0] encoding(VEX, 4 bytes) = c5 f9 11 01
0017h mov rax,rcx                   ; MOV(Mov_r64_rm64) [RAX,RCX]                          encoding(3 bytes) = 48 8b c1
001ah ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> rotl_128x16_patternBytes => new byte[27]{0xC5,0xF8,0x77,0x66,0x90,0x48,0xB8,0x79,0x8C,0x15,0x6A,0x0C,0x01,0x00,0x00,0xC5,0xFB,0xF0,0x00,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector128<byte> rotl_128x32_pattern()
; location: [7FFDDAFD4460h, 7FFDDAFD447Ah]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h mov rax,10C6A158C99h          ; MOV(Mov_r64_imm64) [RAX,10c6a158c99h:imm64]          encoding(10 bytes) = 48 b8 99 8c 15 6a 0c 01 00 00
000fh vlddqu xmm0,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM0,mem(UInt128,RAX:br,:sr)] encoding(VEX, 4 bytes) = c5 fb f0 00
0013h vmovupd [rcx],xmm0            ; VMOVUPD(VEX_Vmovupd_xmmm128_xmm) [mem(Packed128_Float64,RCX:br,:sr),XMM0] encoding(VEX, 4 bytes) = c5 f9 11 01
0017h mov rax,rcx                   ; MOV(Mov_r64_rm64) [RAX,RCX]                          encoding(3 bytes) = 48 8b c1
001ah ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> rotl_128x32_patternBytes => new byte[27]{0xC5,0xF8,0x77,0x66,0x90,0x48,0xB8,0x99,0x8C,0x15,0x6A,0x0C,0x01,0x00,0x00,0xC5,0xFB,0xF0,0x00,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
0023h mov rax,10C6A158B19h          ; MOV(Mov_r64_imm64) [RAX,10c6a158b19h:imm64]          encoding(10 bytes) = 48 b8 19 8b 15 6a 0c 01 00 00
...
0040h mov rax,10C6A1589E9h          ; MOV(Mov_r64_imm64) [RAX,10c6a1589e9h:imm64]          encoding(10 bytes) = 48 b8 e9 89 15 6a 0c 01 00 00
...
0058h mov rax,10C6A158AD9h          ; MOV(Mov_r64_imm64) [RAX,10c6a158ad9h:imm64]          encoding(10 bytes) = 48 b8 d9 8a 15 6a 0c 01 00 00
...
0075h mov rax,10C6A158CF9h          ; MOV(Mov_r64_imm64) [RAX,10c6a158cf9h:imm64]          encoding(10 bytes) = 48 b8 f9 8c 15 6a 0c 01 00 00
...
00afh mov rax,10C6A158B19h          ; MOV(Mov_r64_imm64) [RAX,10c6a158b19h:imm64]          encoding(10 bytes) = 48 b8 19 8b 15 6a 0c 01 00 00
...
00cch mov rax,10C6A1589E9h          ; MOV(Mov_r64_imm64) [RAX,10c6a1589e9h:imm64]          encoding(10 bytes) = 48 b8 e9 89 15 6a 0c 01 00 00
...
00e3h mov rax,10C6A158AD9h          ; MOV(Mov_r64_imm64) [RAX,10c6a158ad9h:imm64]          encoding(10 bytes) = 48 b8 d9 8a 15 6a 0c 01 00 00
...
0100h mov rax,10C6A158CF9h          ; MOV(Mov_r64_imm64) [RAX,10c6a158cf9h:imm64]          encoding(10 bytes) = 48 b8 f9 8c 15 6a 0c 01 00 00
...
0049h mov rax,10C6A158B19h          ; MOV(Mov_r64_imm64) [RAX,10c6a158b19h:imm64]          encoding(10 bytes) = 48 b8 19 8b 15 6a 0c 01 00 00
...
006bh mov rax,10C6A1589E9h          ; MOV(Mov_r64_imm64) [RAX,10c6a1589e9h:imm64]          encoding(10 bytes) = 48 b8 e9 89 15 6a 0c 01 00 00
...
0087h mov rax,10C6A158AD9h          ; MOV(Mov_r64_imm64) [RAX,10c6a158ad9h:imm64]          encoding(10 bytes) = 48 b8 d9 8a 15 6a 0c 01 00 00
...
00a4h mov rax,10C6A158CF9h          ; MOV(Mov_r64_imm64) [RAX,10c6a158cf9h:imm64]          encoding(10 bytes) = 48 b8 f9 8c 15 6a 0c 01 00 00
...
00bfh mov rax,10C6A158AD9h          ; MOV(Mov_r64_imm64) [RAX,10c6a158ad9h:imm64]          encoding(10 bytes) = 48 b8 d9 8a 15 6a 0c 01 00 00
...
00dch mov rax,10C6A158CF9h          ; MOV(Mov_r64_imm64) [RAX,10c6a158cf9h:imm64]          encoding(10 bytes) = 48 b8 f9 8c 15 6a 0c 01 00 00
...
0145h mov rax,10C6A158B19h          ; MOV(Mov_r64_imm64) [RAX,10c6a158b19h:imm64]          encoding(10 bytes) = 48 b8 19 8b 15 6a 0c 01 00 00
...
0167h mov rax,10C6A1589E9h          ; MOV(Mov_r64_imm64) [RAX,10c6a1589e9h:imm64]          encoding(10 bytes) = 48 b8 e9 89 15 6a 0c 01 00 00
...
0182h mov rax,10C6A158AD9h          ; MOV(Mov_r64_imm64) [RAX,10c6a158ad9h:imm64]          encoding(10 bytes) = 48 b8 d9 8a 15 6a 0c 01 00 00
...
019fh mov rax,10C6A158CF9h          ; MOV(Mov_r64_imm64) [RAX,10c6a158cf9h:imm64]          encoding(10 bytes) = 48 b8 f9 8c 15 6a 0c 01 00 00
...
01bah mov rax,10C6A158AD9h          ; MOV(Mov_r64_imm64) [RAX,10c6a158ad9h:imm64]          encoding(10 bytes) = 48 b8 d9 8a 15 6a 0c 01 00 00
...
01d7h mov rax,10C6A158CF9h          ; MOV(Mov_r64_imm64) [RAX,10c6a158cf9h:imm64]          encoding(10 bytes) = 48 b8 f9 8c 15 6a 0c 01 00 00
...
; static ReadOnlySpan<byte> rotl_g256x8uBytes => new byte[557]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
