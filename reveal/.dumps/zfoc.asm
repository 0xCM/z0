; 2020-01-08 01:52:30:142
; function: byte hexcode_parse(Char c)
; static ReadOnlySpan<byte> hexcode_parseBytes => new byte[21]{0x0F,0x1F,0x44,0x00,0x00,0x0F,0xB7,0xC9,0x48,0xB8,0x18,0x59,0x0D,0xB6,0xF7,0x7F,0x00,0x00,0x48,0xFF,0xE0};
0000h nop dword ptr [rax+rax]                 ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]        encoding(5 bytes) = 0f 1f 44 00 00
0005h movzx ecx,cx                            ; MOVZX(Movzx_r32_rm16) [ECX,CX]             encoding(3 bytes) = 0f b7 c9
0008h mov rax,7FF7B60D5918h                   ; MOV(Mov_r64_imm64) [RAX,7ff7b60d5918h:imm64] encoding(10 bytes) = 48 b8 18 59 0d b6 f7 7f 00 00
