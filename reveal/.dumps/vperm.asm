...
000ah mov rcx,7FF7C7512798h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7512798h:imm64]         encoding(10 bytes) = 48 b9 98 27 51 c7 f7 7f 00 00
0014h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F3B0A40h:jmp64]                encoding(5 bytes) = e8 27 0a 3b 5f
0019h mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
001ch mov rcx,7FF7C7507788h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7507788h:imm64]         encoding(10 bytes) = 48 b9 88 77 50 c7 f7 7f 00 00
0026h mov edx,2                     ; MOV(Mov_r32_imm32) [EDX,2h:imm32]                    encoding(5 bytes) = ba 02 00 00 00
002bh call 7FF826FA6E40h            ; CALL(Call_rel32_64) [5F408890h:jmp64]                encoding(5 bytes) = e8 60 88 40 5f
0030h mov rdi,rax                   ; MOV(Mov_r64_rm64) [RDI,RAX]                          encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C763D088h         ; MOV(Mov_r64_imm64) [RCX,7ff7c763d088h:imm64]         encoding(10 bytes) = 48 b9 88 d0 63 c7 f7 7f 00 00
003dh call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F3B0A40h:jmp64]                encoding(5 bytes) = e8 fe 09 3b 5f
...
004dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F407960h:jmp64]                encoding(5 bytes) = e8 0e 79 40 5f
...
005dh call 7FF826FA5F10h            ; CALL(Call_rel32_64) [5F407960h:jmp64]                encoding(5 bytes) = e8 fe 78 40 5f
...
0076h mov rdx,1D990010648h          ; MOV(Mov_r64_imm64) [RDX,1d990010648h:imm64]          encoding(10 bytes) = 48 ba 48 06 01 90 d9 01 00 00
...
008fh call 7FF825DACEB0h            ; CALL(Call_rel32_64) [5E20E900h:jmp64]                encoding(5 bytes) = e8 6c e8 20 5e
...
00a6h call 7FF7C7B9DF58h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF9A8h:jmp64]        encoding(5 bytes) = e8 fd f8 ff ff
00abh mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C7D37868h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7d37868h:imm64]         encoding(10 bytes) = 48 b9 68 78 d3 c7 f7 7f 00 00
00b8h call 7FF826F4EFF0h            ; CALL(Call_rel32_64) [5F3B0A40h:jmp64]                encoding(5 bytes) = e8 83 09 3b 5f
...
00d0h mov rcx,7FF7C7D37868h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7d37868h:imm64]         encoding(10 bytes) = 48 b9 68 78 d3 c7 f7 7f 00 00
00dah call 7FF826EEEF00h            ; CALL(Call_rel32_64) [5F350950h:jmp64]                encoding(5 bytes) = e8 71 08 35 5f
...
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> vand_dynamic(Vector256<uint> a, Vector256<uint> b)
; location: [7FF7C7B9E6C0h, 7FF7C7B9E6EFh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h call 7FF7C7B9E5B0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64]        encoding(5 bytes) = e8 db fe ff ff
...
; location: [7FF7C7B9EB10h, 7FF7C7B9EB41h]
...
; location: [7FF7C7B9EB60h, 7FF7C7B9EB83h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
0009h mov rax,1D9F2764BB1h          ; MOV(Mov_r64_imm64) [RAX,1d9f2764bb1h:imm64]          encoding(10 bytes) = 48 b8 b1 4b 76 f2 d9 01 00 00
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0xB1,0x4B,0x76,0xF2,0xD9,0x01,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<int> vpermvar8x32_256x32i(Vector256<int> src, Vector256<uint> spec)
; location: [7FF7C7B9EBA0h, 7FF7C7B9EBBDh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
...
; location: [7FF7C7B9EBD0h, 7FF7C7B9EBEDh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7B9EC00h, 7FF7C7B9EC50h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,1D9F2765061h          ; MOV(Mov_r64_imm64) [RAX,1d9f2765061h:imm64]          encoding(10 bytes) = 48 b8 61 50 76 f2 d9 01 00 00
...
002bh mov rax,1D9F2764B91h          ; MOV(Mov_r64_imm64) [RAX,1d9f2764b91h:imm64]          encoding(10 bytes) = 48 b8 91 4b 76 f2 d9 01 00 00
...
; location: [7FF7C7B9ECA0h, 7FF7C7B9ECBAh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h vmovupd xmm1,[r8]             ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM1,mem(Packed128_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 79 10 08
...
; location: [7FF7C7B9ECD0h, 7FF7C7B9ECEDh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7B9ED00h, 7FF7C7B9ED1Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7B9ED30h, 7FF7C7B9ED91h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
