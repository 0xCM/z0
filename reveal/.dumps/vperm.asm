...
0014h call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F3C20F0h:jmp64]                encoding(5 bytes) = e8 d7 20 3c 5f
...
002bh call 7FF827266E40h            ; CALL(Call_rel32_64) [5F419F40h:jmp64]                encoding(5 bytes) = e8 10 9f 41 5f
0030h mov rdi,rax                   ; MOV(Mov_r64_rm64) [RDI,RAX]                          encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C78FCB80h         ; MOV(Mov_r64_imm64) [RCX,7ff7c78fcb80h:imm64]         encoding(10 bytes) = 48 b9 80 cb 8f c7 f7 7f 00 00
003dh call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F3C20F0h:jmp64]                encoding(5 bytes) = e8 ae 20 3c 5f
...
004dh call 7FF827265F10h            ; CALL(Call_rel32_64) [5F419010h:jmp64]                encoding(5 bytes) = e8 be 8f 41 5f
...
005dh call 7FF827265F10h            ; CALL(Call_rel32_64) [5F419010h:jmp64]                encoding(5 bytes) = e8 ae 8f 41 5f
...
0076h mov rdx,280B1030628h          ; MOV(Mov_r64_imm64) [RDX,280b1030628h:imm64]          encoding(10 bytes) = 48 ba 28 06 03 b1 80 02 00 00
...
008fh call 7FF825DACEB0h            ; CALL(Call_rel32_64) [5DF5FFB0h:jmp64]                encoding(5 bytes) = e8 1c ff f5 5d
...
00a6h call 7FF7C7E4C890h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF990h:jmp64]        encoding(5 bytes) = e8 e5 f8 ff ff
00abh mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C7FAD9F8h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7fad9f8h:imm64]         encoding(10 bytes) = 48 b9 f8 d9 fa c7 f7 7f 00 00
00b8h call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F3C20F0h:jmp64]                encoding(5 bytes) = e8 33 20 3c 5f
...
00d0h mov rcx,7FF7C7FAD9F8h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7fad9f8h:imm64]         encoding(10 bytes) = 48 b9 f8 d9 fa c7 f7 7f 00 00
00dah call 7FF8271AEF00h            ; CALL(Call_rel32_64) [5F362000h:jmp64]                encoding(5 bytes) = e8 21 1f 36 5f
...
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> vand_dynamic(Vector256<uint> a, Vector256<uint> b)
; location: [7FF7C7E4D010h, 7FF7C7E4D03Fh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h call 7FF7C7E4CF00h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64]        encoding(5 bytes) = e8 db fe ff ff
...
; location: [7FF7C7E4D460h, 7FF7C7E4D491h]
...
; location: [7FF7C7E4D4B0h, 7FF7C7E4D4D3h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
0009h mov rax,280B9BDEA01h          ; MOV(Mov_r64_imm64) [RAX,280b9bdea01h:imm64]          encoding(10 bytes) = 48 b8 01 ea bd b9 80 02 00 00
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0x01,0xEA,0xBD,0xB9,0x80,0x02,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<int> vpermvar8x32_256x32i(Vector256<int> src, Vector256<uint> spec)
; location: [7FF7C7E4D4F0h, 7FF7C7E4D50Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
...
; location: [7FF7C7E4D520h, 7FF7C7E4D53Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7E4D550h, 7FF7C7E4D5A0h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,280B9BDEEB1h          ; MOV(Mov_r64_imm64) [RAX,280b9bdeeb1h:imm64]          encoding(10 bytes) = 48 b8 b1 ee bd b9 80 02 00 00
...
002bh mov rax,280B9BDE9E1h          ; MOV(Mov_r64_imm64) [RAX,280b9bde9e1h:imm64]          encoding(10 bytes) = 48 b8 e1 e9 bd b9 80 02 00 00
...
; location: [7FF7C7E4D5F0h, 7FF7C7E4D60Ah]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h vmovupd xmm1,[r8]             ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM1,mem(Packed128_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 79 10 08
...
; location: [7FF7C7E4D620h, 7FF7C7E4D63Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7E4D650h, 7FF7C7E4D66Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
