...
0014h call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F35FBB0h:jmp64]                encoding(5 bytes) = e8 97 fb 35 5f
...
002bh call 7FF827266E40h            ; CALL(Call_rel32_64) [5F3B7A00h:jmp64]                encoding(5 bytes) = e8 d0 79 3b 5f
0030h mov rdi,rax                   ; MOV(Mov_r64_rm64) [RDI,RAX]                          encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C790D540h         ; MOV(Mov_r64_imm64) [RCX,7ff7c790d540h:imm64]         encoding(10 bytes) = 48 b9 40 d5 90 c7 f7 7f 00 00
003dh call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F35FBB0h:jmp64]                encoding(5 bytes) = e8 6e fb 35 5f
...
004dh call 7FF827265F10h            ; CALL(Call_rel32_64) [5F3B6AD0h:jmp64]                encoding(5 bytes) = e8 7e 6a 3b 5f
...
005dh call 7FF827265F10h            ; CALL(Call_rel32_64) [5F3B6AD0h:jmp64]                encoding(5 bytes) = e8 6e 6a 3b 5f
...
0076h mov rdx,1E310010778h          ; MOV(Mov_r64_imm64) [RDX,1e310010778h:imm64]          encoding(10 bytes) = 48 ba 78 07 01 10 e3 01 00 00
...
008fh call 7FF825DACEB0h            ; CALL(Call_rel32_64) [5DEFDA70h:jmp64]                encoding(5 bytes) = e8 dc d9 ef 5d
...
00a6h call 7FF7C7EAEE08h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF9C8h:jmp64]        encoding(5 bytes) = e8 1d f9 ff ff
00abh mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C7FC37D8h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7fc37d8h:imm64]         encoding(10 bytes) = 48 b9 d8 37 fc c7 f7 7f 00 00
00b8h call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F35FBB0h:jmp64]                encoding(5 bytes) = e8 f3 fa 35 5f
...
00d0h mov rcx,7FF7C7FC37D8h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7fc37d8h:imm64]         encoding(10 bytes) = 48 b9 d8 37 fc c7 f7 7f 00 00
00dah call 7FF8271AEF00h            ; CALL(Call_rel32_64) [5F2FFAC0h:jmp64]                encoding(5 bytes) = e8 e1 f9 2f 5f
...
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> vand_dynamic(Vector256<uint> a, Vector256<uint> b)
; location: [7FF7C7EAF550h, 7FF7C7EAF57Fh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h call 7FF7C7EAF440h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64]        encoding(5 bytes) = e8 db fe ff ff
...
; location: [7FF7C7EAF9A0h, 7FF7C7EAF9D1h]
...
; location: [7FF7C7EAF9F0h, 7FF7C7EAFA13h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
0009h mov rax,1E37DAB8339h          ; MOV(Mov_r64_imm64) [RAX,1e37dab8339h:imm64]          encoding(10 bytes) = 48 b8 39 83 ab 7d e3 01 00 00
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0x39,0x83,0xAB,0x7D,0xE3,0x01,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<int> vpermvar8x32_256x32i(Vector256<int> src, Vector256<uint> spec)
; location: [7FF7C7EAFA30h, 7FF7C7EAFA4Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
...
; location: [7FF7C7EAFA60h, 7FF7C7EAFA7Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7EAFA90h, 7FF7C7EAFAE0h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,1E37DAB87E9h          ; MOV(Mov_r64_imm64) [RAX,1e37dab87e9h:imm64]          encoding(10 bytes) = 48 b8 e9 87 ab 7d e3 01 00 00
...
002bh mov rax,1E37DAB8319h          ; MOV(Mov_r64_imm64) [RAX,1e37dab8319h:imm64]          encoding(10 bytes) = 48 b8 19 83 ab 7d e3 01 00 00
...
; location: [7FF7C7EAFB30h, 7FF7C7EAFB4Ah]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h vmovupd xmm1,[r8]             ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM1,mem(Packed128_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 79 10 08
...
; location: [7FF7C7EAFB60h, 7FF7C7EAFB7Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7EAFB90h, 7FF7C7EAFBADh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
