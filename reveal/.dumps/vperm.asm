...
000ah mov rcx,7FF7C77F2798h         ; MOV(Mov_r64_imm64) [RCX,7ff7c77f2798h:imm64]         encoding(10 bytes) = 48 b9 98 27 7f c7 f7 7f 00 00
0014h call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F3A2110h:jmp64]                encoding(5 bytes) = e8 f7 20 3a 5f
0019h mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
001ch mov rcx,7FF7C77E7788h         ; MOV(Mov_r64_imm64) [RCX,7ff7c77e7788h:imm64]         encoding(10 bytes) = 48 b9 88 77 7e c7 f7 7f 00 00
0026h mov edx,2                     ; MOV(Mov_r32_imm32) [EDX,2h:imm32]                    encoding(5 bytes) = ba 02 00 00 00
002bh call 7FF827266E40h            ; CALL(Call_rel32_64) [5F3F9F60h:jmp64]                encoding(5 bytes) = e8 30 9f 3f 5f
0030h mov rdi,rax                   ; MOV(Mov_r64_rm64) [RDI,RAX]                          encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C791CB80h         ; MOV(Mov_r64_imm64) [RCX,7ff7c791cb80h:imm64]         encoding(10 bytes) = 48 b9 80 cb 91 c7 f7 7f 00 00
003dh call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F3A2110h:jmp64]                encoding(5 bytes) = e8 ce 20 3a 5f
...
004dh call 7FF827265F10h            ; CALL(Call_rel32_64) [5F3F9030h:jmp64]                encoding(5 bytes) = e8 de 8f 3f 5f
...
005dh call 7FF827265F10h            ; CALL(Call_rel32_64) [5F3F9030h:jmp64]                encoding(5 bytes) = e8 ce 8f 3f 5f
...
0076h mov rdx,1F210010628h          ; MOV(Mov_r64_imm64) [RDX,1f210010628h:imm64]          encoding(10 bytes) = 48 ba 28 06 01 10 f2 01 00 00
...
008fh call 7FF825DACEB0h            ; CALL(Call_rel32_64) [5DF3FFD0h:jmp64]                encoding(5 bytes) = e8 3c ff f3 5d
...
00a6h call 7FF7C7E6C860h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF980h:jmp64]        encoding(5 bytes) = e8 d5 f8 ff ff
00abh mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C7FCD9F8h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7fcd9f8h:imm64]         encoding(10 bytes) = 48 b9 f8 d9 fc c7 f7 7f 00 00
00b8h call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F3A2110h:jmp64]                encoding(5 bytes) = e8 53 20 3a 5f
...
00d0h mov rcx,7FF7C7FCD9F8h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7fcd9f8h:imm64]         encoding(10 bytes) = 48 b9 f8 d9 fc c7 f7 7f 00 00
00dah call 7FF8271AEF00h            ; CALL(Call_rel32_64) [5F342020h:jmp64]                encoding(5 bytes) = e8 41 1f 34 5f
...
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> vand_dynamic(Vector256<uint> a, Vector256<uint> b)
; location: [7FF7C7E6CFF0h, 7FF7C7E6D01Fh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h call 7FF7C7E6CEE0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64]        encoding(5 bytes) = e8 db fe ff ff
...
; location: [7FF7C7E6D440h, 7FF7C7E6D471h]
...
; location: [7FF7C7E6D490h, 7FF7C7E6D4B3h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
0009h mov rax,1F2180EE7E5h          ; MOV(Mov_r64_imm64) [RAX,1f2180ee7e5h:imm64]          encoding(10 bytes) = 48 b8 e5 e7 0e 18 f2 01 00 00
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0xE5,0xE7,0x0E,0x18,0xF2,0x01,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<int> vpermvar8x32_256x32i(Vector256<int> src, Vector256<uint> spec)
; location: [7FF7C7E6D4D0h, 7FF7C7E6D4EDh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
...
; location: [7FF7C7E6D500h, 7FF7C7E6D51Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7E6D530h, 7FF7C7E6D580h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,1F2180EEC95h          ; MOV(Mov_r64_imm64) [RAX,1f2180eec95h:imm64]          encoding(10 bytes) = 48 b8 95 ec 0e 18 f2 01 00 00
...
002bh mov rax,1F2180EE7C5h          ; MOV(Mov_r64_imm64) [RAX,1f2180ee7c5h:imm64]          encoding(10 bytes) = 48 b8 c5 e7 0e 18 f2 01 00 00
...
; location: [7FF7C7E6D5D0h, 7FF7C7E6D5EAh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h vmovupd xmm1,[r8]             ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM1,mem(Packed128_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 79 10 08
...
; location: [7FF7C7E6D600h, 7FF7C7E6D61Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7E6D630h, 7FF7C7E6D64Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
