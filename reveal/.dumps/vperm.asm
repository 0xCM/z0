...
0014h call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F3C1120h:jmp64]                encoding(5 bytes) = e8 07 11 3c 5f
...
002bh call 7FF827266E40h            ; CALL(Call_rel32_64) [5F418F70h:jmp64]                encoding(5 bytes) = e8 40 8f 41 5f
...
003dh call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F3C1120h:jmp64]                encoding(5 bytes) = e8 de 10 3c 5f
...
004dh call 7FF827265F10h            ; CALL(Call_rel32_64) [5F418040h:jmp64]                encoding(5 bytes) = e8 ee 7f 41 5f
...
005dh call 7FF827265F10h            ; CALL(Call_rel32_64) [5F418040h:jmp64]                encoding(5 bytes) = e8 de 7f 41 5f
...
0076h mov rdx,22142650628h          ; MOV(Mov_r64_imm64) [RDX,22142650628h:imm64]          encoding(10 bytes) = 48 ba 28 06 65 42 21 02 00 00
...
008fh call 7FF825DACEB0h            ; CALL(Call_rel32_64) [5DF5EFE0h:jmp64]                encoding(5 bytes) = e8 4c ef f5 5d
...
00a6h call 7FF7C7E4D898h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF9C8h:jmp64]        encoding(5 bytes) = e8 1d f9 ff ff
00abh mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C7FC93C0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7fc93c0h:imm64]         encoding(10 bytes) = 48 b9 c0 93 fc c7 f7 7f 00 00
00b8h call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F3C1120h:jmp64]                encoding(5 bytes) = e8 63 10 3c 5f
...
00d0h mov rcx,7FF7C7FC93C0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7fc93c0h:imm64]         encoding(10 bytes) = 48 b9 c0 93 fc c7 f7 7f 00 00
00dah call 7FF8271AEF00h            ; CALL(Call_rel32_64) [5F361030h:jmp64]                encoding(5 bytes) = e8 51 0f 36 5f
...
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> vand_dynamic(Vector256<uint> a, Vector256<uint> b)
; location: [7FF7C7E4DFE0h, 7FF7C7E4E00Fh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h call 7FF7C7E4DED0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64]        encoding(5 bytes) = e8 db fe ff ff
...
; location: [7FF7C7E4E430h, 7FF7C7E4E461h]
...
; location: [7FF7C7E4E480h, 7FF7C7E4E4A3h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
0009h mov rax,2214B28348Dh          ; MOV(Mov_r64_imm64) [RAX,2214b28348dh:imm64]          encoding(10 bytes) = 48 b8 8d 34 28 4b 21 02 00 00
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0x8D,0x34,0x28,0x4B,0x21,0x02,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<int> vpermvar8x32_256x32i(Vector256<int> src, Vector256<uint> spec)
; location: [7FF7C7E4E4C0h, 7FF7C7E4E4DDh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
...
; location: [7FF7C7E4E4F0h, 7FF7C7E4E50Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7E4E520h, 7FF7C7E4E570h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,2214B28393Dh          ; MOV(Mov_r64_imm64) [RAX,2214b28393dh:imm64]          encoding(10 bytes) = 48 b8 3d 39 28 4b 21 02 00 00
...
002bh mov rax,2214B28346Dh          ; MOV(Mov_r64_imm64) [RAX,2214b28346dh:imm64]          encoding(10 bytes) = 48 b8 6d 34 28 4b 21 02 00 00
...
; location: [7FF7C7E4E5C0h, 7FF7C7E4E5DAh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h vmovupd xmm1,[r8]             ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM1,mem(Packed128_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 79 10 08
...
; location: [7FF7C7E4E5F0h, 7FF7C7E4E60Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7E4E620h, 7FF7C7E4E63Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
