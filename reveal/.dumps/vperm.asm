...
0014h call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F360AF0h:jmp64]                encoding(5 bytes) = e8 d7 0a 36 5f
...
002bh call 7FF827266E40h            ; CALL(Call_rel32_64) [5F3B8940h:jmp64]                encoding(5 bytes) = e8 10 89 3b 5f
0030h mov rdi,rax                   ; MOV(Mov_r64_rm64) [RDI,RAX]                          encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C790D108h         ; MOV(Mov_r64_imm64) [RCX,7ff7c790d108h:imm64]         encoding(10 bytes) = 48 b9 08 d1 90 c7 f7 7f 00 00
003dh call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F360AF0h:jmp64]                encoding(5 bytes) = e8 ae 0a 36 5f
...
004dh call 7FF827265F10h            ; CALL(Call_rel32_64) [5F3B7A10h:jmp64]                encoding(5 bytes) = e8 be 79 3b 5f
...
005dh call 7FF827265F10h            ; CALL(Call_rel32_64) [5F3B7A10h:jmp64]                encoding(5 bytes) = e8 ae 79 3b 5f
...
0076h mov rdx,1CA20C00760h          ; MOV(Mov_r64_imm64) [RDX,1ca20c00760h:imm64]          encoding(10 bytes) = 48 ba 60 07 c0 20 ca 01 00 00
...
008fh call 7FF825DACEB0h            ; CALL(Call_rel32_64) [5DEFE9B0h:jmp64]                encoding(5 bytes) = e8 1c e9 ef 5d
...
00a6h call 7FF7C7EADF00h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFA00h:jmp64]        encoding(5 bytes) = e8 55 f9 ff ff
00abh mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C7FC33B8h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7fc33b8h:imm64]         encoding(10 bytes) = 48 b9 b8 33 fc c7 f7 7f 00 00
00b8h call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F360AF0h:jmp64]                encoding(5 bytes) = e8 33 0a 36 5f
...
00d0h mov rcx,7FF7C7FC33B8h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7fc33b8h:imm64]         encoding(10 bytes) = 48 b9 b8 33 fc c7 f7 7f 00 00
00dah call 7FF8271AEF00h            ; CALL(Call_rel32_64) [5F300A00h:jmp64]                encoding(5 bytes) = e8 21 09 30 5f
...
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> vand_dynamic(Vector256<uint> a, Vector256<uint> b)
; location: [7FF7C7EAE610h, 7FF7C7EAE63Fh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h call 7FF7C7EAE500h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64]        encoding(5 bytes) = e8 db fe ff ff
...
; location: [7FF7C7EAEA60h, 7FF7C7EAEA91h]
...
; location: [7FF7C7EAEAB0h, 7FF7C7EAEAD3h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
0009h mov rax,1CA0F358FD9h          ; MOV(Mov_r64_imm64) [RAX,1ca0f358fd9h:imm64]          encoding(10 bytes) = 48 b8 d9 8f 35 0f ca 01 00 00
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0xD9,0x8F,0x35,0x0F,0xCA,0x01,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<int> vpermvar8x32_256x32i(Vector256<int> src, Vector256<uint> spec)
; location: [7FF7C7EAEAF0h, 7FF7C7EAEB0Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
...
; location: [7FF7C7EAEB20h, 7FF7C7EAEB3Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7EAEB50h, 7FF7C7EAEBA0h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,1CA0F359489h          ; MOV(Mov_r64_imm64) [RAX,1ca0f359489h:imm64]          encoding(10 bytes) = 48 b8 89 94 35 0f ca 01 00 00
...
002bh mov rax,1CA0F358FB9h          ; MOV(Mov_r64_imm64) [RAX,1ca0f358fb9h:imm64]          encoding(10 bytes) = 48 b8 b9 8f 35 0f ca 01 00 00
...
; location: [7FF7C7EAEBF0h, 7FF7C7EAEC0Ah]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h vmovupd xmm1,[r8]             ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM1,mem(Packed128_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 79 10 08
...
; location: [7FF7C7EAEC20h, 7FF7C7EAEC3Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7EAEC50h, 7FF7C7EAEC6Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
