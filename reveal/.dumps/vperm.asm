...
000ah mov rcx,7FF7C77D2798h         ; MOV(Mov_r64_imm64) [RCX,7ff7c77d2798h:imm64]         encoding(10 bytes) = 48 b9 98 27 7d c7 f7 7f 00 00
0014h call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F36F890h:jmp64]                encoding(5 bytes) = e8 77 f8 36 5f
0019h mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
001ch mov rcx,7FF7C77C7788h         ; MOV(Mov_r64_imm64) [RCX,7ff7c77c7788h:imm64]         encoding(10 bytes) = 48 b9 88 77 7c c7 f7 7f 00 00
0026h mov edx,2                     ; MOV(Mov_r32_imm32) [EDX,2h:imm32]                    encoding(5 bytes) = ba 02 00 00 00
002bh call 7FF827266E40h            ; CALL(Call_rel32_64) [5F3C76E0h:jmp64]                encoding(5 bytes) = e8 b0 76 3c 5f
0030h mov rdi,rax                   ; MOV(Mov_r64_rm64) [RDI,RAX]                          encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C78FD660h         ; MOV(Mov_r64_imm64) [RCX,7ff7c78fd660h:imm64]         encoding(10 bytes) = 48 b9 60 d6 8f c7 f7 7f 00 00
003dh call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F36F890h:jmp64]                encoding(5 bytes) = e8 4e f8 36 5f
...
004dh call 7FF827265F10h            ; CALL(Call_rel32_64) [5F3C67B0h:jmp64]                encoding(5 bytes) = e8 5e 67 3c 5f
...
005dh call 7FF827265F10h            ; CALL(Call_rel32_64) [5F3C67B0h:jmp64]                encoding(5 bytes) = e8 4e 67 3c 5f
...
0076h mov rdx,21310010780h          ; MOV(Mov_r64_imm64) [RDX,21310010780h:imm64]          encoding(10 bytes) = 48 ba 80 07 01 10 13 02 00 00
...
008fh call 7FF825DACEB0h            ; CALL(Call_rel32_64) [5DF0D750h:jmp64]                encoding(5 bytes) = e8 bc d6 f0 5d
...
00a6h call 7FF7C7E9F130h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF9D0h:jmp64]        encoding(5 bytes) = e8 25 f9 ff ff
00abh mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C7FB3E98h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7fb3e98h:imm64]         encoding(10 bytes) = 48 b9 98 3e fb c7 f7 7f 00 00
00b8h call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F36F890h:jmp64]                encoding(5 bytes) = e8 d3 f7 36 5f
...
00d0h mov rcx,7FF7C7FB3E98h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7fb3e98h:imm64]         encoding(10 bytes) = 48 b9 98 3e fb c7 f7 7f 00 00
00dah call 7FF8271AEF00h            ; CALL(Call_rel32_64) [5F30F7A0h:jmp64]                encoding(5 bytes) = e8 c1 f6 30 5f
...
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> vand_dynamic(Vector256<uint> a, Vector256<uint> b)
; location: [7FF7C7E9F870h, 7FF7C7E9F89Fh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h call 7FF7C7E9F760h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64]        encoding(5 bytes) = e8 db fe ff ff
...
; location: [7FF7C7E9FCC0h, 7FF7C7E9FCF1h]
...
; location: [7FF7C7E9FD10h, 7FF7C7E9FD33h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
0009h mov rax,213718F8CB5h          ; MOV(Mov_r64_imm64) [RAX,213718f8cb5h:imm64]          encoding(10 bytes) = 48 b8 b5 8c 8f 71 13 02 00 00
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0xB5,0x8C,0x8F,0x71,0x13,0x02,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<int> vpermvar8x32_256x32i(Vector256<int> src, Vector256<uint> spec)
; location: [7FF7C7E9FD50h, 7FF7C7E9FD6Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
...
; location: [7FF7C7E9FD80h, 7FF7C7E9FD9Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7E9FDB0h, 7FF7C7E9FE00h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,213718F9165h          ; MOV(Mov_r64_imm64) [RAX,213718f9165h:imm64]          encoding(10 bytes) = 48 b8 65 91 8f 71 13 02 00 00
...
002bh mov rax,213718F8C95h          ; MOV(Mov_r64_imm64) [RAX,213718f8c95h:imm64]          encoding(10 bytes) = 48 b8 95 8c 8f 71 13 02 00 00
...
; location: [7FF7C7E9FE50h, 7FF7C7E9FE6Ah]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h vmovupd xmm1,[r8]             ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM1,mem(Packed128_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 79 10 08
...
; location: [7FF7C7E9FE80h, 7FF7C7E9FE9Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7E9FEB0h, 7FF7C7E9FECDh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
