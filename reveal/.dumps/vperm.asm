...
000ah mov rcx,7FF7C76B2798h         ; MOV(Mov_r64_imm64) [RCX,7ff7c76b2798h:imm64]         encoding(10 bytes) = 48 b9 98 27 6b c7 f7 7f 00 00
0014h call 7FF8270CEFF0h            ; CALL(Call_rel32_64) [5F3A1EF0h:jmp64]                encoding(5 bytes) = e8 d7 1e 3a 5f
0019h mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
001ch mov rcx,7FF7C76A7788h         ; MOV(Mov_r64_imm64) [RCX,7ff7c76a7788h:imm64]         encoding(10 bytes) = 48 b9 88 77 6a c7 f7 7f 00 00
0026h mov edx,2                     ; MOV(Mov_r32_imm32) [EDX,2h:imm32]                    encoding(5 bytes) = ba 02 00 00 00
002bh call 7FF827126E40h            ; CALL(Call_rel32_64) [5F3F9D40h:jmp64]                encoding(5 bytes) = e8 10 9d 3f 5f
0030h mov rdi,rax                   ; MOV(Mov_r64_rm64) [RDI,RAX]                          encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C77CC1D0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c77cc1d0h:imm64]         encoding(10 bytes) = 48 b9 d0 c1 7c c7 f7 7f 00 00
003dh call 7FF8270CEFF0h            ; CALL(Call_rel32_64) [5F3A1EF0h:jmp64]                encoding(5 bytes) = e8 ae 1e 3a 5f
...
004dh call 7FF827125F10h            ; CALL(Call_rel32_64) [5F3F8E10h:jmp64]                encoding(5 bytes) = e8 be 8d 3f 5f
...
005dh call 7FF827125F10h            ; CALL(Call_rel32_64) [5F3F8E10h:jmp64]                encoding(5 bytes) = e8 ae 8d 3f 5f
...
0076h mov rdx,1CE1B1B05C0h          ; MOV(Mov_r64_imm64) [RDX,1ce1b1b05c0h:imm64]          encoding(10 bytes) = 48 ba c0 05 1b 1b ce 01 00 00
...
008fh call 7FF825DACEB0h            ; CALL(Call_rel32_64) [5E07FDB0h:jmp64]                encoding(5 bytes) = e8 1c fd 07 5e
...
00a6h call 7FF7C7D2CAB8h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF9B8h:jmp64]        encoding(5 bytes) = e8 0d f9 ff ff
00abh mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C7E8C418h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7e8c418h:imm64]         encoding(10 bytes) = 48 b9 18 c4 e8 c7 f7 7f 00 00
00b8h call 7FF8270CEFF0h            ; CALL(Call_rel32_64) [5F3A1EF0h:jmp64]                encoding(5 bytes) = e8 33 1e 3a 5f
...
00d0h mov rcx,7FF7C7E8C418h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7e8c418h:imm64]         encoding(10 bytes) = 48 b9 18 c4 e8 c7 f7 7f 00 00
00dah call 7FF82706EF00h            ; CALL(Call_rel32_64) [5F341E00h:jmp64]                encoding(5 bytes) = e8 21 1d 34 5f
...
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> vand_dynamic(Vector256<uint> a, Vector256<uint> b)
; location: [7FF7C7D2D210h, 7FF7C7D2D23Fh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h call 7FF7C7D2D100h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64]        encoding(5 bytes) = e8 db fe ff ff
...
; location: [7FF7C7D2D660h, 7FF7C7D2D691h]
...
; location: [7FF7C7D2D6B0h, 7FF7C7D2D6D3h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
0009h mov rax,1CE23DBB195h          ; MOV(Mov_r64_imm64) [RAX,1ce23dbb195h:imm64]          encoding(10 bytes) = 48 b8 95 b1 db 23 ce 01 00 00
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0x95,0xB1,0xDB,0x23,0xCE,0x01,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<int> vpermvar8x32_256x32i(Vector256<int> src, Vector256<uint> spec)
; location: [7FF7C7D2D6F0h, 7FF7C7D2D70Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
...
; location: [7FF7C7D2D720h, 7FF7C7D2D73Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7D2D750h, 7FF7C7D2D7A0h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,1CE23DBB645h          ; MOV(Mov_r64_imm64) [RAX,1ce23dbb645h:imm64]          encoding(10 bytes) = 48 b8 45 b6 db 23 ce 01 00 00
...
002bh mov rax,1CE23DBB175h          ; MOV(Mov_r64_imm64) [RAX,1ce23dbb175h:imm64]          encoding(10 bytes) = 48 b8 75 b1 db 23 ce 01 00 00
...
; location: [7FF7C7D2D7F0h, 7FF7C7D2D80Ah]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h vmovupd xmm1,[r8]             ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM1,mem(Packed128_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 79 10 08
...
; location: [7FF7C7D2D820h, 7FF7C7D2D83Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7D2D850h, 7FF7C7D2D86Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
