...
0014h call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F351400h:jmp64]                encoding(5 bytes) = e8 e7 13 35 5f
...
002bh call 7FF827266E40h            ; CALL(Call_rel32_64) [5F3A9250h:jmp64]                encoding(5 bytes) = e8 20 92 3a 5f
0030h mov rdi,rax                   ; MOV(Mov_r64_rm64) [RDI,RAX]                          encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C790D0F8h         ; MOV(Mov_r64_imm64) [RCX,7ff7c790d0f8h:imm64]         encoding(10 bytes) = 48 b9 f8 d0 90 c7 f7 7f 00 00
003dh call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F351400h:jmp64]                encoding(5 bytes) = e8 be 13 35 5f
...
004dh call 7FF827265F10h            ; CALL(Call_rel32_64) [5F3A8320h:jmp64]                encoding(5 bytes) = e8 ce 82 3a 5f
...
005dh call 7FF827265F10h            ; CALL(Call_rel32_64) [5F3A8320h:jmp64]                encoding(5 bytes) = e8 be 82 3a 5f
...
0076h mov rdx,201A7F50770h          ; MOV(Mov_r64_imm64) [RDX,201a7f50770h:imm64]          encoding(10 bytes) = 48 ba 70 07 f5 a7 01 02 00 00
...
008fh call 7FF825DACEB0h            ; CALL(Call_rel32_64) [5DEEF2C0h:jmp64]                encoding(5 bytes) = e8 2c f2 ee 5d
...
00a6h call 7FF7C7EBD450h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF860h:jmp64]        encoding(5 bytes) = e8 b5 f7 ff ff
00abh mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C7FCE3E0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7fce3e0h:imm64]         encoding(10 bytes) = 48 b9 e0 e3 fc c7 f7 7f 00 00
00b8h call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5F351400h:jmp64]                encoding(5 bytes) = e8 43 13 35 5f
...
00d0h mov rcx,7FF7C7FCE3E0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7fce3e0h:imm64]         encoding(10 bytes) = 48 b9 e0 e3 fc c7 f7 7f 00 00
00dah call 7FF8271AEF00h            ; CALL(Call_rel32_64) [5F2F1310h:jmp64]                encoding(5 bytes) = e8 31 12 2f 5f
...
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> vand_dynamic(Vector256<uint> a, Vector256<uint> b)
; location: [7FF7C7EBDD00h, 7FF7C7EBDD2Fh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h call 7FF7C7EBDBF0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64]        encoding(5 bytes) = e8 db fe ff ff
...
; location: [7FF7C7EBE560h, 7FF7C7EBE591h]
...
; location: [7FF7C7EBE5B0h, 7FF7C7EBE5D3h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
0009h mov rax,20197DF72B1h          ; MOV(Mov_r64_imm64) [RAX,20197df72b1h:imm64]          encoding(10 bytes) = 48 b8 b1 72 df 97 01 02 00 00
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0xB1,0x72,0xDF,0x97,0x01,0x02,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<int> vpermvar8x32_256x32i(Vector256<int> src, Vector256<uint> spec)
; location: [7FF7C7EBE5F0h, 7FF7C7EBE60Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
...
; location: [7FF7C7EBE620h, 7FF7C7EBE63Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7EBE650h, 7FF7C7EBE6A0h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,20197DF7761h          ; MOV(Mov_r64_imm64) [RAX,20197df7761h:imm64]          encoding(10 bytes) = 48 b8 61 77 df 97 01 02 00 00
...
002bh mov rax,20197DF7291h          ; MOV(Mov_r64_imm64) [RAX,20197df7291h:imm64]          encoding(10 bytes) = 48 b8 91 72 df 97 01 02 00 00
...
; location: [7FF7C7EBE6F0h, 7FF7C7EBE70Ah]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h vmovupd xmm1,[r8]             ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM1,mem(Packed128_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 79 10 08
...
; location: [7FF7C7EBE720h, 7FF7C7EBE73Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7EBE750h, 7FF7C7EBE76Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
