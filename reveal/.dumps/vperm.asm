...
000ah mov rcx,7FF7C7692798h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7692798h:imm64]         encoding(10 bytes) = 48 b9 98 27 69 c7 f7 7f 00 00
0014h call 7FF8270CEFF0h            ; CALL(Call_rel32_64) [5F360BA0h:jmp64]                encoding(5 bytes) = e8 87 0b 36 5f
0019h mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
001ch mov rcx,7FF7C7687788h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7687788h:imm64]         encoding(10 bytes) = 48 b9 88 77 68 c7 f7 7f 00 00
0026h mov edx,2                     ; MOV(Mov_r32_imm32) [EDX,2h:imm32]                    encoding(5 bytes) = ba 02 00 00 00
002bh call 7FF827126E40h            ; CALL(Call_rel32_64) [5F3B89F0h:jmp64]                encoding(5 bytes) = e8 c0 89 3b 5f
0030h mov rdi,rax                   ; MOV(Mov_r64_rm64) [RDI,RAX]                          encoding(3 bytes) = 48 8b f8
0033h mov rcx,7FF7C77BC898h         ; MOV(Mov_r64_imm64) [RCX,7ff7c77bc898h:imm64]         encoding(10 bytes) = 48 b9 98 c8 7b c7 f7 7f 00 00
003dh call 7FF8270CEFF0h            ; CALL(Call_rel32_64) [5F360BA0h:jmp64]                encoding(5 bytes) = e8 5e 0b 36 5f
...
004dh call 7FF827125F10h            ; CALL(Call_rel32_64) [5F3B7AC0h:jmp64]                encoding(5 bytes) = e8 6e 7a 3b 5f
...
005dh call 7FF827125F10h            ; CALL(Call_rel32_64) [5F3B7AC0h:jmp64]                encoding(5 bytes) = e8 5e 7a 3b 5f
...
0076h mov rdx,26B11410758h          ; MOV(Mov_r64_imm64) [RDX,26b11410758h:imm64]          encoding(10 bytes) = 48 ba 58 07 41 11 6b 02 00 00
...
008fh call 7FF825DACEB0h            ; CALL(Call_rel32_64) [5E03EA60h:jmp64]                encoding(5 bytes) = e8 cc e9 03 5e
...
00a6h call 7FF7C7D6DDD0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF980h:jmp64]        encoding(5 bytes) = e8 d5 f8 ff ff
00abh mov rsi,rax                   ; MOV(Mov_r64_rm64) [RSI,RAX]                          encoding(3 bytes) = 48 8b f0
00aeh mov rcx,7FF7C7E82BB8h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7e82bb8h:imm64]         encoding(10 bytes) = 48 b9 b8 2b e8 c7 f7 7f 00 00
00b8h call 7FF8270CEFF0h            ; CALL(Call_rel32_64) [5F360BA0h:jmp64]                encoding(5 bytes) = e8 e3 0a 36 5f
...
00d0h mov rcx,7FF7C7E82BB8h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7e82bb8h:imm64]         encoding(10 bytes) = 48 b9 b8 2b e8 c7 f7 7f 00 00
00dah call 7FF82706EF00h            ; CALL(Call_rel32_64) [5F300AB0h:jmp64]                encoding(5 bytes) = e8 d1 09 30 5f
...
; static ReadOnlySpan<byte> vand_delgateBytes => new byte[235]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> vand_dynamic(Vector256<uint> a, Vector256<uint> b)
; location: [7FF7C7D6E560h, 7FF7C7D6E58Fh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h call 7FF7C7D6E450h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEF0h:jmp64]        encoding(5 bytes) = e8 db fe ff ff
...
; location: [7FF7C7D6E9B0h, 7FF7C7D6E9E1h]
...
; location: [7FF7C7D6EA00h, 7FF7C7D6EA23h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
0009h mov rax,26B198291B5h          ; MOV(Mov_r64_imm64) [RAX,26b198291b5h:imm64]          encoding(10 bytes) = 48 b8 b5 91 82 19 6b 02 00 00
...
; static ReadOnlySpan<byte> vbswap_128x16uBytes => new byte[36]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xF9,0x10,0x02,0x48,0xB8,0xB5,0x91,0x82,0x19,0x6B,0x02,0x00,0x00,0xC5,0xFB,0xF0,0x08,0xC4,0xE2,0x79,0x00,0xC1,0xC5,0xF9,0x11,0x01,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<int> vpermvar8x32_256x32i(Vector256<int> src, Vector256<uint> spec)
; location: [7FF7C7D6EA40h, 7FF7C7D6EA5Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
...
; location: [7FF7C7D6EA70h, 7FF7C7D6EA8Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7D6EAA0h, 7FF7C7D6EAF0h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
000eh mov rax,26B19829665h          ; MOV(Mov_r64_imm64) [RAX,26b19829665h:imm64]          encoding(10 bytes) = 48 b8 65 96 82 19 6b 02 00 00
...
002bh mov rax,26B19829195h          ; MOV(Mov_r64_imm64) [RAX,26b19829195h:imm64]          encoding(10 bytes) = 48 b8 95 91 82 19 6b 02 00 00
...
; location: [7FF7C7D6EB40h, 7FF7C7D6EB5Ah]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 f9 10 02
0009h vmovupd xmm1,[r8]             ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM1,mem(Packed128_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 79 10 08
...
; location: [7FF7C7D6EB70h, 7FF7C7D6EB8Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
...
; location: [7FF7C7D6EBA0h, 7FF7C7D6EBBDh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rdx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 fd 10 02
0009h vmovupd ymm1,[r8]             ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM1,mem(Packed256_Float64,R8:br,:sr)] encoding(VEX, 5 bytes) = c4 c1 7d 10 08
