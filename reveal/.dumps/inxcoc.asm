; 2019-11-04 04:06:01:110
; function: void avxpack(ref uint src, ref uint dst)
; location: [7FFDDBA2C920h, 7FFDDBA2CF20h]
...
04ech call 7FFDDBA2C530h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFC10h:jmp64]        encoding(5 bytes) = e8 1f f7 ff ff
...
0510h call 7FFDDB43CED8h            ; CALL(Call_rel32_64) [FFFFFFFFFFA105B8h:jmp64]        encoding(5 bytes) = e8 a3 00 a1 ff
...
0542h call 7FFDDB43CE58h            ; CALL(Call_rel32_64) [FFFFFFFFFFA10538h:jmp64]        encoding(5 bytes) = e8 f1 ff a0 ff
...
056ch call 7FFDDBA2B8A0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFEF80h:jmp64]        encoding(5 bytes) = e8 0f ea ff ff
...
0596h call 7FFDDBA2B8A0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFEF80h:jmp64]        encoding(5 bytes) = e8 e5 e9 ff ff
...
05c0h call 7FFDDBA2B8A0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFEF80h:jmp64]        encoding(5 bytes) = e8 bb e9 ff ff
...
05dch call 7FFDDBA2B8D0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFEFB0h:jmp64]        encoding(5 bytes) = e8 cf e9 ff ff
...
; location: [7FFDDBA2D050h, 7FFDDBA2D067h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
; location: [7FFDDBA2D080h, 7FFDDBA2D104h]
...
; location: [7FFDDBA2D130h, 7FFDDBA2D1C0h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
; location: [7FFDDBA2D1F0h, 7FFDDBA2D218h]
...
; location: [7FFDDBA2D230h, 7FFDDBA2D282h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rcx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RCX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fd 10 01
0009h vmovaps ymm1,ymm0             ; VMOVAPS(VEX_Vmovaps_ymm_ymmm256) [YMM1,YMM0]         encoding(VEX, 4 bytes) = c5 fc 28 c8
...
; location: [7FFDDBA2D2A0h, 7FFDDBA2D2E7h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rcx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RCX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fd 10 01
...
; location: [7FFDDB737650h, 7FFDDB737675h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFDDB737690h, 7FFDDB7376F1h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rcx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RCX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 f9 10 01
...
; location: [7FFDDB737720h, 7FFDDB737773h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rcx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RCX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 f9 10 01
