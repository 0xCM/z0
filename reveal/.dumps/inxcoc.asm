; 2019-11-03 08:18:55:224
; function: void avxpack(ref uint src, ref uint dst)
; location: [7FFDDB9ECAF0h, 7FFDDB9ED0F0h]
...
04ech call 7FFDDB9EC6E0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFBF0h:jmp64]        encoding(5 bytes) = e8 ff f6 ff ff
...
0510h call 7FFDDB3FD158h            ; CALL(Call_rel32_64) [FFFFFFFFFFA10668h:jmp64]        encoding(5 bytes) = e8 53 01 a1 ff
...
0542h call 7FFDDB3FD0D8h            ; CALL(Call_rel32_64) [FFFFFFFFFFA105E8h:jmp64]        encoding(5 bytes) = e8 a1 00 a1 ff
...
056ch call 7FFDDB9EBA50h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFEF60h:jmp64]        encoding(5 bytes) = e8 ef e9 ff ff
...
0596h call 7FFDDB9EBA50h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFEF60h:jmp64]        encoding(5 bytes) = e8 c5 e9 ff ff
...
05c0h call 7FFDDB9EBA50h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFEF60h:jmp64]        encoding(5 bytes) = e8 9b e9 ff ff
...
05dch call 7FFDDB9EBA80h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFEF90h:jmp64]        encoding(5 bytes) = e8 af e9 ff ff
...
; location: [7FFDDB9ED1D0h, 7FFDDB9ED209h]
...
; location: [7FFDDB9ED220h, 7FFDDB9ED237h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
; location: [7FFDDB9ED250h, 7FFDDB9ED2D4h]
...
; location: [7FFDDB9ED300h, 7FFDDB9ED390h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
; location: [7FFDDB9ED3C0h, 7FFDDB9ED3E8h]
...
; location: [7FFDDB9ED400h, 7FFDDB9ED452h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rcx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RCX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fd 10 01
0009h vmovaps ymm1,ymm0             ; VMOVAPS(VEX_Vmovaps_ymm_ymmm256) [YMM1,YMM0]         encoding(VEX, 4 bytes) = c5 fc 28 c8
...
; location: [7FFDDB9ED470h, 7FFDDB9ED4B7h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rcx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RCX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fd 10 01
...
; location: [7FFDDB6F7190h, 7FFDDB6F71B5h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFDDB6F71D0h, 7FFDDB6F7231h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rcx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RCX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 f9 10 01
...
; location: [7FFDDB6F7260h, 7FFDDB6F72B3h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rcx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RCX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 f9 10 01
