; 2019-11-04 23:03:41:222
; function: void avxpack(ref uint src, ref uint dst)
; location: [7FFDDB9ECE00h, 7FFDDB9ED400h]
...
04ech call 7FFDDB9ECAC0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFCC0h:jmp64]        encoding(5 bytes) = e8 cf f7 ff ff
...
0510h call 7FFDDB3FD148h            ; CALL(Call_rel32_64) [FFFFFFFFFFA10348h:jmp64]        encoding(5 bytes) = e8 33 fe a0 ff
...
0542h call 7FFDDB3FD0C8h            ; CALL(Call_rel32_64) [FFFFFFFFFFA102C8h:jmp64]        encoding(5 bytes) = e8 81 fd a0 ff
...
056ch call 7FFDDB9EBEC0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF0C0h:jmp64]        encoding(5 bytes) = e8 4f eb ff ff
...
0596h call 7FFDDB9EBEC0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF0C0h:jmp64]        encoding(5 bytes) = e8 25 eb ff ff
...
05c0h call 7FFDDB9EBEC0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF0C0h:jmp64]        encoding(5 bytes) = e8 fb ea ff ff
...
05dch call 7FFDDB9EC9F0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFBF0h:jmp64]        encoding(5 bytes) = e8 0f f6 ff ff
...
; location: [7FFDDB9ED530h, 7FFDDB9ED547h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
; location: [7FFDDB9ED560h, 7FFDDB9ED5E4h]
...
; location: [7FFDDB9ED610h, 7FFDDB9ED6A0h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
; location: [7FFDDB9EDAD0h, 7FFDDB9EDAF8h]
...
; location: [7FFDDB9EDB10h, 7FFDDB9EDB62h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rcx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RCX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fd 10 01
0009h vmovaps ymm1,ymm0             ; VMOVAPS(VEX_Vmovaps_ymm_ymmm256) [YMM1,YMM0]         encoding(VEX, 4 bytes) = c5 fc 28 c8
...
; location: [7FFDDB9EDB80h, 7FFDDB9EDBC7h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd ymm0,[rcx]            ; VMOVUPD(VEX_Vmovupd_ymm_ymmm256) [YMM0,mem(Packed256_Float64,RCX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fd 10 01
...
; location: [7FFDDB6F7130h, 7FFDDB6F7155h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFDDB6F7170h, 7FFDDB6F71D1h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rcx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RCX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 f9 10 01
...
; location: [7FFDDB6F7200h, 7FFDDB6F7253h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h vmovupd xmm0,[rcx]            ; VMOVUPD(VEX_Vmovupd_xmm_xmmm128) [XMM0,mem(Packed128_Float64,RCX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 f9 10 01
