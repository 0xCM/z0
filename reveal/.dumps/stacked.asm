...
; static ReadOnlySpan<byte> ss_store_128Bytes => new byte[24]{0x0F,0x1F,0x44,0x00,0x00,0x48,0x8B,0xC1,0x49,0x8B,0xC8,0x44,0x8B,0xC2,0x48,0x8B,0xD0,0xE8,0x5A,0x66,0x45,0x5F,0x90,0xC3};
0000h nop dword ptr [rax+rax]                 ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]        encoding(5 bytes) = 0f 1f 44 00 00
...
0011h call 7FF8154D6050h                      ; CALL(Call_rel32_64) [5F456670h:jmp64]      encoding(5 bytes) = e8 5a 66 45 5f
0016h nop                                     ; NOP(Nopd)                                  encoding(1 byte ) = 90
0017h ret                                     ; RET(Retnq)                                 encoding(1 byte ) = c3
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Span<byte> ss_span_128x8(ref MemStack128 src)
; static ReadOnlySpan<byte> ss_span_128x8Bytes => new byte[29]{0x48,0x83,0xEC,0x28,0x90,0x48,0x89,0x11,0xC7,0x41,0x08,0x10,0x00,0x00,0x00,0x48,0x8B,0xC1,0x48,0x83,0xC4,0x28,0xC3,0xE8,0xF4,0x01,0x58,0x5F,0xCC};
...
0017h call 7FF8155FFC20h                      ; CALL(Call_rel32_64) [5F580210h:jmp64]      encoding(5 bytes) = e8 f4 01 58 5f
001ch int 3                                   ; INT(Int3)                                  encoding(1 byte ) = cc
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Span<byte> ss_span_256x8(ref MemStack256 src)
; static ReadOnlySpan<byte> ss_span_256x8Bytes => new byte[29]{0x48,0x83,0xEC,0x28,0x90,0x48,0x89,0x11,0xC7,0x41,0x08,0x20,0x00,0x00,0x00,0x48,0x8B,0xC1,0x48,0x83,0xC4,0x28,0xC3,0xE8,0xB4,0x01,0x58,0x5F,0xCC};
0000h sub rsp,28h                             ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]         encoding(4 bytes) = 48 83 ec 28
0004h nop                                     ; NOP(Nopd)                                  encoding(1 byte ) = 90
0005h mov [rcx],rdx                           ; MOV(Mov_rm64_r64) [mem(64u,RCX:br,:sr),RDX] encoding(3 bytes) = 48 89 11
...
0012h add rsp,28h                             ; ADD(Add_rm64_imm8) [RSP,28h:imm64]         encoding(4 bytes) = 48 83 c4 28
0016h ret                                     ; RET(Retnq)                                 encoding(1 byte ) = c3
0017h call 7FF8155FFC20h                      ; CALL(Call_rel32_64) [5F5801D0h:jmp64]      encoding(5 bytes) = e8 b4 01 58 5f
001ch int 3                                   ; INT(Int3)                                  encoding(1 byte ) = cc
----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
0076h call 7FF8154D6050h                      ; CALL(Call_rel32_64) [5F455A90h:jmp64]      encoding(5 bytes) = e8 15 5a 45 5f
...
0088h call 7FF8154D6050h                      ; CALL(Call_rel32_64) [5F455A90h:jmp64]      encoding(5 bytes) = e8 03 5a 45 5f
