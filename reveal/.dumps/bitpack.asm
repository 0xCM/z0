; 2019-12-26 05:40:56:132
; function: byte pack_8(BitSpan src)
; location: [7FF7C77E7B80h, 7FF7C77E7C19h]
...
0059h mov rax,1C3ADD15031h          ; MOV(Mov_r64_imm64) [RAX,1c3add15031h:imm64]          encoding(10 bytes) = 48 b8 31 50 d1 ad c3 01 00 00
...
006ch mov rax,1C3ADD15201h          ; MOV(Mov_r64_imm64) [RAX,1c3add15201h:imm64]          encoding(10 bytes) = 48 b8 01 52 d1 ad c3 01 00 00
