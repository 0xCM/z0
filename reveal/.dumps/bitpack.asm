; 2019-12-28 13:39:43:111
; function: byte pack_8(BitSpan src)
; location: [7FF7C77B7D10h, 7FF7C77B7DA9h]
...
0059h mov rax,2086D8F5D89h          ; MOV(Mov_r64_imm64) [RAX,2086d8f5d89h:imm64]          encoding(10 bytes) = 48 b8 89 5d 8f 6d 08 02 00 00
...
006ch mov rax,2086D8F5F59h          ; MOV(Mov_r64_imm64) [RAX,2086d8f5f59h:imm64]          encoding(10 bytes) = 48 b8 59 5f 8f 6d 08 02 00 00
