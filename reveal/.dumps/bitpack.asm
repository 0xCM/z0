; 2019-12-28 13:10:24:795
; function: byte pack_8(BitSpan src)
; location: [7FF7C77C7D90h, 7FF7C77C7E29h]
...
0059h mov rax,20FC7955D65h          ; MOV(Mov_r64_imm64) [RAX,20fc7955d65h:imm64]          encoding(10 bytes) = 48 b8 65 5d 95 c7 0f 02 00 00
...
006ch mov rax,20FC7955F35h          ; MOV(Mov_r64_imm64) [RAX,20fc7955f35h:imm64]          encoding(10 bytes) = 48 b8 35 5f 95 c7 0f 02 00 00
