; 2019-12-23 01:20:37:720
; function: void part63x3(ulong src, NatSpan<N21,byte> dst)
; location: [7FF7C7D3F520h, 7FF7C7D3F57Ah]
...
; location: [7FF7C7D40C80h, 7FF7C7D40CA0h]
...
; location: [7FF7C7D410C0h, 7FF7C7D4132Ch]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
; location: [7FF7C7D414A0h, 7FF7C7D414B4h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C7D414D0h, 7FF7C7D414FFh]
...
; location: [7FF7C7D41920h, 7FF7C7D41972h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
...
; location: [7FF7C7D41990h, 7FF7C7D419D2h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C7D419F0h, 7FF7C7D41A21h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
