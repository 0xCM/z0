; 2019-11-21 19:28:33:397
; function: void set_bit(ref uint src, byte pos, bit state)
; location: [7FFDD9F4CA60h, 7FFDD9F4CA89h]
...
; location: [7FFDD9F4CAA0h, 7FFDD9F4CAB4h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,rcx                   ; MOV(Mov_r64_rm64) [RAX,RCX]                          encoding(3 bytes) = 48 8b c1
...
; location: [7FFDD9F4CAD0h, 7FFDD9F4CAE6h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,rcx                   ; MOV(Mov_r64_rm64) [RAX,RCX]                          encoding(3 bytes) = 48 8b c1
0008h movzx ecx,dl                  ; MOVZX(Movzx_r32_rm8) [ECX,DL]                        encoding(3 bytes) = 0f b6 ca
000bh mov edx,1                     ; MOV(Mov_r32_imm32) [EDX,1h:imm32]                    encoding(5 bytes) = ba 01 00 00 00
...
; location: [7FFDD9F4D790h, 7FFDD9F4D85Ch]
...
0035h call 7FFDD986F2E8h            ; CALL(Call_rel32_64) [FFFFFFFFFF921B58h:jmp64]        encoding(5 bytes) = e8 1e 1b 92 ff
...
; location: [7FFDD9F4DE30h, 7FFDD9F4DE46h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,[rcx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 01
0008h movzx eax,byte ptr [rax]      ; MOVZX(Movzx_r32_rm8) [EAX,mem(8u,RAX:br,:sr)]        encoding(3 bytes) = 0f b6 00
000bh movzx eax,al                  ; MOVZX(Movzx_r32_rm8) [EAX,AL]                        encoding(3 bytes) = 0f b6 c0
...
; location: [7FFDD9F4DE60h, 7FFDD9F4DE6Eh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,[rcx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 01
...
; location: [7FFDD9F4DE80h, 7FFDD9F4DE9Bh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,[rcx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 01
...
; location: [7FFDD9F4DEB0h, 7FFDD9F4DF05h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,rcx                   ; MOV(Mov_r64_rm64) [RAX,RCX]                          encoding(3 bytes) = 48 8b c1
...
; location: [7FFDD9F4DF20h, 7FFDD9F4DF36h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,[rcx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 01
0008h movzx eax,byte ptr [rax]      ; MOVZX(Movzx_r32_rm8) [EAX,mem(8u,RAX:br,:sr)]        encoding(3 bytes) = 0f b6 00
000bh movzx eax,al                  ; MOVZX(Movzx_r32_rm8) [EAX,AL]                        encoding(3 bytes) = 0f b6 c0
...
; location: [7FFDD9F4DF50h, 7FFDD9F4DFA3h]
...
0012h call 7FFDD9F4DD00h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFDB0h:jmp64]        encoding(5 bytes) = e8 99 fd ff ff
...
; static ReadOnlySpan<byte> segmentsBytes => new byte[84]{0x48,0x83,0xEC,0x38,0x90,0xC6,0x44,0x24,0x30,0x00,0x48,0x8D,0x44,0x24,0x30,0xC6,0x00,0x00,0xE8,0x99,0xFD,0xFF,0xFF,0x0F,0xB7,0xC0,0xC6,0x44,0x24,0x28,0x00,0x48,0x8D,0x54,0x24,0x28,0xC6,0x02,0x00,0x0F,0xB7,0xC0,0x8B,0xD0,0xC1,0xFA,0x03,0x8B,0xC8,0xC1,0xF9,0x1F,0x83,0xE1,0x07,0x03,0xC8,0x83,0xE1,0xF8,0x2B,0xC1,0x75,0x04,0x33,0xC0,0xEB,0x05,0xB8,0x01,0x00,0x00,0x00,0x03,0xC2,0x33,0xD2,0x03,0xC2,0x48,0x83,0xC4,0x38,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int count_segs()
; location: [7FFDD9F4E3C0h, 7FFDD9F4E449h]
...
0019h call 7FFDD9F4DFF0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFC30h:jmp64]        encoding(5 bytes) = e8 12 fc ff ff
...
0029h call 7FFDD986E950h            ; CALL(Call_rel32_64) [FFFFFFFFFF920590h:jmp64]        encoding(5 bytes) = e8 62 05 92 ff
...
; static ReadOnlySpan<byte> count_segsBytes => new byte[138]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: bit readbit_row_col_2(int n, ulong src, int row, int col)
; location: [7FFDD9F4E460h, 7FFDD9F4E498h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFDD9F4E4B0h, 7FFDD9F4E4D7h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFDD9F4E4F0h, 7FFDD9F4E514h]
0000h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
...
0017h call 7FFDD9F4E2A0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFDB0h:jmp64]        encoding(5 bytes) = e8 94 fd ff ff
...
; static ReadOnlySpan<byte> bg_load_32x32x32Bytes => new byte[37]{0x56,0x48,0x83,0xEC,0x20,0x48,0x8B,0xF1,0x48,0x8B,0xCE,0x41,0xB8,0x20,0x00,0x00,0x00,0x41,0xB9,0x20,0x00,0x00,0x00,0xE8,0x94,0xFD,0xFF,0xFF,0x48,0x8B,0xC6,0x48,0x83,0xC4,0x20,0x5E,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: GridSpec bg_specify(ushort rows, ushort cols, ushort segwidth)
; location: [7FFDD9F4E530h, 7FFDD9F4E603h]
