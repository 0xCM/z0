; 2019-12-21 17:46:01:341
; function: Vector256<byte> part63x3(ulong src)
; location: [7FF7C7D80760h, 7FF7C7D807EEh]
...
0019h mov rax,7FFFFFFFFFFFFFFFh     ; MOV(Mov_r64_imm64) [RAX,7fffffffffffffffh:imm64]     encoding(10 bytes) = 48 b8 ff ff ff ff ff ff ff 7f
0023h and rax,rdx                   ; AND(And_r64_rm64) [RAX,RDX]                          encoding(3 bytes) = 48 23 c2
0026h lea rdx,[rsp+8]               ; LEA(Lea_r64_m) [RDX,mem(Unknown,RSP:br,:sr)]         encoding(5 bytes) = 48 8d 54 24 08
002bh vxorps xmm0,xmm0,xmm0         ; VXORPS(VEX_Vxorps_xmm_xmm_xmmm128) [XMM0,XMM0,XMM0]  encoding(VEX, 4 bytes) = c5 f8 57 c0
002fh vmovdqu xmmword ptr [rdx],xmm0; VMOVDQU(VEX_Vmovdqu_xmmm128_xmm) [mem(Packed128_Int32,RDX:br,:sr),XMM0] encoding(VEX, 4 bytes) = c5 fa 7f 02
0033h vmovdqu xmmword ptr [rdx+10h],xmm0; VMOVDQU(VEX_Vmovdqu_xmmm128_xmm) [mem(Packed128_Int32,RDX:br,:sr),XMM0] encoding(VEX, 5 bytes) = c5 fa 7f 42 10
0038h lea rdx,[rsp+8]               ; LEA(Lea_r64_m) [RDX,mem(Unknown,RSP:br,:sr)]         encoding(5 bytes) = 48 8d 54 24 08
003dh mov r8,707070707070707h       ; MOV(Mov_r64_imm64) [R8,707070707070707h:imm64]       encoding(10 bytes) = 49 b8 07 07 07 07 07 07 07 07
0047h pdep r8,rax,r8                ; PDEP(VEX_Pdep_r64_r64_rm64) [R8,RAX,R8]              encoding(VEX, 5 bytes) = c4 42 fb f5 c0
004ch mov [rdx],r8                  ; MOV(Mov_rm64_r64) [mem(64u,RDX:br,:sr),R8]           encoding(3 bytes) = 4c 89 02
004fh lea r8,[rdx+8]                ; LEA(Lea_r64_m) [R8,mem(Unknown,RDX:br,:sr)]          encoding(4 bytes) = 4c 8d 42 08
0053h mov r9,rax                    ; MOV(Mov_r64_rm64) [R9,RAX]                           encoding(3 bytes) = 4c 8b c8
0056h shr r9,18h                    ; SHR(Shr_rm64_imm8) [R9,18h:imm8]                     encoding(4 bytes) = 49 c1 e9 18
005ah mov r10,707070707070707h      ; MOV(Mov_r64_imm64) [R10,707070707070707h:imm64]      encoding(10 bytes) = 49 ba 07 07 07 07 07 07 07 07
0064h pdep r9,r9,r10                ; PDEP(VEX_Pdep_r64_r64_rm64) [R9,R9,R10]              encoding(VEX, 5 bytes) = c4 42 b3 f5 ca
0069h mov [r8],r9                   ; MOV(Mov_rm64_r64) [mem(64u,R8:br,:sr),R9]            encoding(3 bytes) = 4d 89 08
006ch lea r8,[rdx+10h]              ; LEA(Lea_r64_m) [R8,mem(Unknown,RDX:br,:sr)]          encoding(4 bytes) = 4c 8d 42 10
0070h shr rax,30h                   ; SHR(Shr_rm64_imm8) [RAX,30h:imm8]                    encoding(4 bytes) = 48 c1 e8 30
0074h pdep rax,rax,r10              ; PDEP(VEX_Pdep_r64_r64_rm64) [RAX,RAX,R10]            encoding(VEX, 5 bytes) = c4 c2 fb f5 c2
0079h mov [r8],rax                  ; MOV(Mov_rm64_r64) [mem(64u,R8:br,:sr),RAX]           encoding(3 bytes) = 49 89 00
007ch vlddqu ymm0,ymmword ptr [rdx] ; VLDDQU(VEX_Vlddqu_ymm_m256) [YMM0,mem(UInt256,RDX:br,:sr)] encoding(VEX, 4 bytes) = c5 ff f0 02
0080h vmovupd [rcx],ymm0            ; VMOVUPD(VEX_Vmovupd_ymmm256_ymm) [mem(Packed256_Float64,RCX:br,:sr),YMM0] encoding(VEX, 4 bytes) = c5 fd 11 01
...
; static ReadOnlySpan<byte> part63x3Bytes => new byte[143]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void part63x3(ulong src, NatBlock<N21,byte> dst)
; location: [7FF7C7D80C20h, 7FF7C7D80C7Ah]
...
0012h mov rcx,[rdx]                 ; MOV(Mov_r64_rm64) [RCX,mem(64u,RDX:br,:sr)]          encoding(3 bytes) = 48 8b 0a
0015h mov r8,707070707070707h       ; MOV(Mov_r64_imm64) [R8,707070707070707h:imm64]       encoding(10 bytes) = 49 b8 07 07 07 07 07 07 07 07
001fh pdep r8,rax,r8                ; PDEP(VEX_Pdep_r64_r64_rm64) [R8,RAX,R8]              encoding(VEX, 5 bytes) = c4 42 fb f5 c0
0024h mov [rcx],r8                  ; MOV(Mov_rm64_r64) [mem(64u,RCX:br,:sr),R8]           encoding(3 bytes) = 4c 89 01
0027h mov rcx,[rdx]                 ; MOV(Mov_r64_rm64) [RCX,mem(64u,RDX:br,:sr)]          encoding(3 bytes) = 48 8b 0a
002ah add rcx,8                     ; ADD(Add_rm64_imm8) [RCX,8h:imm64]                    encoding(4 bytes) = 48 83 c1 08
002eh mov r8,rax                    ; MOV(Mov_r64_rm64) [R8,RAX]                           encoding(3 bytes) = 4c 8b c0
0031h shr r8,18h                    ; SHR(Shr_rm64_imm8) [R8,18h:imm8]                     encoding(4 bytes) = 49 c1 e8 18
0035h mov r9,707070707070707h       ; MOV(Mov_r64_imm64) [R9,707070707070707h:imm64]       encoding(10 bytes) = 49 b9 07 07 07 07 07 07 07 07
003fh pdep r8,r8,r9                 ; PDEP(VEX_Pdep_r64_r64_rm64) [R8,R8,R9]               encoding(VEX, 5 bytes) = c4 42 bb f5 c1
0044h mov [rcx],r8                  ; MOV(Mov_rm64_r64) [mem(64u,RCX:br,:sr),R8]           encoding(3 bytes) = 4c 89 01
0047h mov rdx,[rdx]                 ; MOV(Mov_r64_rm64) [RDX,mem(64u,RDX:br,:sr)]          encoding(3 bytes) = 48 8b 12
004ah add rdx,10h                   ; ADD(Add_rm64_imm8) [RDX,10h:imm64]                   encoding(4 bytes) = 48 83 c2 10
004eh shr rax,30h                   ; SHR(Shr_rm64_imm8) [RAX,30h:imm8]                    encoding(4 bytes) = 48 c1 e8 30
0052h pdep rax,rax,r9               ; PDEP(VEX_Pdep_r64_r64_rm64) [RAX,RAX,R9]             encoding(VEX, 5 bytes) = c4 c2 fb f5 c1
0057h mov [rdx],rax                 ; MOV(Mov_rm64_r64) [mem(64u,RDX:br,:sr),RAX]          encoding(3 bytes) = 48 89 02
005ah ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> part63x3Bytes => new byte[91]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x7F,0x48,0x23,0xC1,0x48,0x8B,0x0A,0x49,0xB8,0x07,0x07,0x07,0x07,0x07,0x07,0x07,0x07,0xC4,0x42,0xFB,0xF5,0xC0,0x4C,0x89,0x01,0x48,0x8B,0x0A,0x48,0x83,0xC1,0x08,0x4C,0x8B,0xC0,0x49,0xC1,0xE8,0x18,0x49,0xB9,0x07,0x07,0x07,0x07,0x07,0x07,0x07,0x07,0xC4,0x42,0xBB,0xF5,0xC1,0x4C,0x89,0x01,0x48,0x8B,0x12,0x48,0x83,0xC2,0x10,0x48,0xC1,0xE8,0x30,0xC4,0xC2,0xFB,0xF5,0xC1,0x48,0x89,0x02,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void part63x3(ulong src, Span<byte> dst)
; location: [7FF7C7D80C90h, 7FF7C7D80CEEh]
0000h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0004h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
0005h mov rax,[rdx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RDX:br,:sr)]          encoding(3 bytes) = 48 8b 02
0008h mov rdx,7FFFFFFFFFFFFFFFh     ; MOV(Mov_r64_imm64) [RDX,7fffffffffffffffh:imm64]     encoding(10 bytes) = 48 ba ff ff ff ff ff ff ff 7f
0012h and rdx,rcx                   ; AND(And_r64_rm64) [RDX,RCX]                          encoding(3 bytes) = 48 23 d1
0015h mov rcx,707070707070707h      ; MOV(Mov_r64_imm64) [RCX,707070707070707h:imm64]      encoding(10 bytes) = 48 b9 07 07 07 07 07 07 07 07
001fh pdep rcx,rdx,rcx              ; PDEP(VEX_Pdep_r64_r64_rm64) [RCX,RDX,RCX]            encoding(VEX, 5 bytes) = c4 e2 eb f5 c9
0024h mov [rax],rcx                 ; MOV(Mov_rm64_r64) [mem(64u,RAX:br,:sr),RCX]          encoding(3 bytes) = 48 89 08
0027h lea rcx,[rax+8]               ; LEA(Lea_r64_m) [RCX,mem(Unknown,RAX:br,:sr)]         encoding(4 bytes) = 48 8d 48 08
002bh mov r8,rdx                    ; MOV(Mov_r64_rm64) [R8,RDX]                           encoding(3 bytes) = 4c 8b c2
002eh shr r8,18h                    ; SHR(Shr_rm64_imm8) [R8,18h:imm8]                     encoding(4 bytes) = 49 c1 e8 18
0032h mov r9,707070707070707h       ; MOV(Mov_r64_imm64) [R9,707070707070707h:imm64]       encoding(10 bytes) = 49 b9 07 07 07 07 07 07 07 07
003ch pdep r8,r8,r9                 ; PDEP(VEX_Pdep_r64_r64_rm64) [R8,R8,R9]               encoding(VEX, 5 bytes) = c4 42 bb f5 c1
0041h mov [rcx],r8                  ; MOV(Mov_rm64_r64) [mem(64u,RCX:br,:sr),R8]           encoding(3 bytes) = 4c 89 01
0044h add rax,10h                   ; ADD(Add_rm64_imm8) [RAX,10h:imm64]                   encoding(4 bytes) = 48 83 c0 10
0048h shr rdx,30h                   ; SHR(Shr_rm64_imm8) [RDX,30h:imm8]                    encoding(4 bytes) = 48 c1 ea 30
004ch pdep rdx,rdx,r9               ; PDEP(VEX_Pdep_r64_r64_rm64) [RDX,RDX,R9]             encoding(VEX, 5 bytes) = c4 c2 eb f5 d1
0051h mov [rax],rdx                 ; MOV(Mov_rm64_r64) [mem(64u,RAX:br,:sr),RDX]          encoding(3 bytes) = 48 89 10
0054h add rsp,28h                   ; ADD(Add_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 c4 28
0058h ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
0059h call 7FF82724FC20h            ; CALL(Call_rel32_64) [5F4CEF90h:jmp64]                encoding(5 bytes) = e8 32 ef 4c 5f
005eh int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> part63x3Bytes => new byte[95]{0x48,0x83,0xEC,0x28,0x90,0x48,0x8B,0x02,0x48,0xBA,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x7F,0x48,0x23,0xD1,0x48,0xB9,0x07,0x07,0x07,0x07,0x07,0x07,0x07,0x07,0xC4,0xE2,0xEB,0xF5,0xC9,0x48,0x89,0x08,0x48,0x8D,0x48,0x08,0x4C,0x8B,0xC2,0x49,0xC1,0xE8,0x18,0x49,0xB9,0x07,0x07,0x07,0x07,0x07,0x07,0x07,0x07,0xC4,0x42,0xBB,0xF5,0xC1,0x4C,0x89,0x01,0x48,0x83,0xC0,0x10,0x48,0xC1,0xEA,0x30,0xC4,0xC2,0xEB,0xF5,0xD1,0x48,0x89,0x10,0x48,0x83,0xC4,0x28,0xC3,0xE8,0x32,0xEF,0x4C,0x5F,0xCC};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<byte> bitgrid_vector256(BitGrid<byte> src, int block)
; location: [7FF7C7D82400h, 7FF7C7D82420h]
...
; location: [7FF7C7D82840h, 7FF7C7D82AACh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: bit read_bit_from_vector(in BitBlock<N23,byte> src)
; location: [7FF7C7D82C20h, 7FF7C7D82C34h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; static ReadOnlySpan<byte> read_bit_from_vectorBytes => new byte[21]{0x0F,0x1F,0x44,0x00,0x00,0x48,0x8B,0x01,0x0F,0xB6,0x00,0x0F,0xB6,0xC0,0xC1,0xE8,0x03,0x83,0xE0,0x01,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int segments()
; location: [7FF7C7D83050h, 7FF7C7D8307Fh]
...
; location: [7FF7C7D830A0h, 7FF7C7D830F2h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
...
; location: [7FF7C7D83110h, 7FF7C7D83152h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
0039h movzx ecx,cl                  ; MOVZX(Movzx_r32_rm8) [ECX,CL]                        encoding(3 bytes) = 0f b6 c9
003ch shr rax,cl                    ; SHR(Shr_rm64_CL) [RAX,CL]                            encoding(3 bytes) = 48 d3 e8
003fh and eax,1                     ; AND(And_rm32_imm8) [EAX,1h:imm32]                    encoding(3 bytes) = 83 e0 01
0042h ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> readbit_row_col_2Bytes => new byte[67]{0x0F,0x1F,0x44,0x00,0x00,0x48,0x89,0x54,0x24,0x10,0x41,0x0F,0xAF,0xC8,0x41,0x03,0xC9,0x8B,0xC1,0xC1,0xF8,0x1F,0x83,0xE0,0x3F,0x03,0xC1,0xC1,0xF8,0x06,0x48,0x8D,0x54,0x24,0x10,0x48,0x63,0xC0,0x48,0x8B,0x04,0xC2,0x8B,0xD1,0xC1,0xFA,0x1F,0x83,0xE2,0x3F,0x03,0xD1,0x83,0xE2,0xC0,0x2B,0xCA,0x0F,0xB6,0xC9,0x48,0xD3,0xE8,0x83,0xE0,0x01,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: bit readbit_g_position(in ulong src, int pos)
; location: [7FF7C7D83170h, 7FF7C7D831A1h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
0028h movzx ecx,dl                  ; MOVZX(Movzx_r32_rm8) [ECX,DL]                        encoding(3 bytes) = 0f b6 ca
002bh shr rax,cl                    ; SHR(Shr_rm64_CL) [RAX,CL]                            encoding(3 bytes) = 48 d3 e8
002eh and eax,1                     ; AND(And_rm32_imm8) [EAX,1h:imm32]                    encoding(3 bytes) = 83 e0 01
0031h ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> readbit_g_positionBytes => new byte[50]{0x0F,0x1F,0x44,0x00,0x00,0x8B,0xC2,0xC1,0xF8,0x1F,0x83,0xE0,0x3F,0x03,0xC2,0xC1,0xF8,0x06,0x48,0x63,0xC0,0x48,0x8B,0x04,0xC1,0x8B,0xCA,0xC1,0xF9,0x1F,0x83,0xE1,0x3F,0x03,0xCA,0x83,0xE1,0xC0,0x2B,0xD1,0x0F,0xB6,0xCA,0x48,0xD3,0xE8,0x83,0xE0,0x01,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
