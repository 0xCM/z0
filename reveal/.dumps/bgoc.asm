; 2019-11-23 00:41:18:690
; function: void set_bit(ref uint src, byte pos, bit state)
; location: [7FFDDAFFC890h, 7FFDDAFFC8B9h]
...
; location: [7FFDDAFFC8D0h, 7FFDDAFFC8E4h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,rcx                   ; MOV(Mov_r64_rm64) [RAX,RCX]                          encoding(3 bytes) = 48 8b c1
...
; location: [7FFDDAFFC900h, 7FFDDAFFC916h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,rcx                   ; MOV(Mov_r64_rm64) [RAX,RCX]                          encoding(3 bytes) = 48 8b c1
0008h movzx ecx,dl                  ; MOVZX(Movzx_r32_rm8) [ECX,DL]                        encoding(3 bytes) = 0f b6 ca
000bh mov edx,1                     ; MOV(Mov_r32_imm32) [EDX,1h:imm32]                    encoding(5 bytes) = ba 01 00 00 00
...
; location: [7FFDDAFFD1F0h, 7FFDDAFFD2BCh]
...
0035h call 7FFDDA91F258h            ; CALL(Call_rel32_64) [FFFFFFFFFF922068h:jmp64]        encoding(5 bytes) = e8 2e 20 92 ff
...
; location: [7FFDDAFFD890h, 7FFDDAFFD8A6h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,[rcx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 01
0008h movzx eax,byte ptr [rax]      ; MOVZX(Movzx_r32_rm8) [EAX,mem(8u,RAX:br,:sr)]        encoding(3 bytes) = 0f b6 00
000bh movzx eax,al                  ; MOVZX(Movzx_r32_rm8) [EAX,AL]                        encoding(3 bytes) = 0f b6 c0
...
; location: [7FFDDAFFD8C0h, 7FFDDAFFD8CEh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,[rcx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 01
...
; location: [7FFDDAFFDCF0h, 7FFDDAFFDD0Bh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,[rcx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 01
...
; location: [7FFDDAFFDD20h, 7FFDDAFFDD75h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,rcx                   ; MOV(Mov_r64_rm64) [RAX,RCX]                          encoding(3 bytes) = 48 8b c1
...
0012h call 7FFDDAFFDAD8h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFD18h:jmp64]        encoding(5 bytes) = e8 01 fd ff ff
...
; static ReadOnlySpan<byte> segmentsBytes => new byte[84]{0x48,0x83,0xEC,0x38,0x90,0xC6,0x44,0x24,0x30,0x00,0x48,0x8D,0x44,0x24,0x30,0xC6,0x00,0x00,0xE8,0x01,0xFD,0xFF,0xFF,0x0F,0xB7,0xC0,0xC6,0x44,0x24,0x28,0x00,0x48,0x8D,0x54,0x24,0x28,0xC6,0x02,0x00,0x0F,0xB7,0xC0,0x8B,0xD0,0xC1,0xFA,0x03,0x8B,0xC8,0xC1,0xF9,0x1F,0x83,0xE1,0x07,0x03,0xC8,0x83,0xE1,0xF8,0x2B,0xC1,0x75,0x04,0x33,0xC0,0xEB,0x05,0xB8,0x01,0x00,0x00,0x00,0x03,0xC2,0x33,0xD2,0x03,0xC2,0x48,0x83,0xC4,0x38,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
0019h call 7FFDDAFFDC08h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFDD8h:jmp64]        encoding(5 bytes) = e8 ba fd ff ff
...
0029h call 7FFDDA91E8E8h            ; CALL(Call_rel32_64) [FFFFFFFFFF920AB8h:jmp64]        encoding(5 bytes) = e8 8a 0a 92 ff
...
; static ReadOnlySpan<byte> count_segsBytes => new byte[138]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
0017h call 7FFDDAFFDCC0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFF960h:jmp64]        encoding(5 bytes) = e8 44 f9 ff ff
