...
007bh call 7FFDD94B4BE0h            ; CALL(Call_rel32_64) [FFFFFFFFFF9F9550h:jmp64]        encoding(5 bytes) = e8 d0 94 9f ff
...
0074h call 7FFDD94B4BE0h            ; CALL(Call_rel32_64) [FFFFFFFFFF9F94A0h:jmp64]        encoding(5 bytes) = e8 27 94 9f ff
...
007ch call 7FFDD94B4BE0h            ; CALL(Call_rel32_64) [FFFFFFFFFF9F93F0h:jmp64]        encoding(5 bytes) = e8 6f 93 9f ff
...
0075h call 7FFDD94B4BE0h            ; CALL(Call_rel32_64) [FFFFFFFFFF9F9340h:jmp64]        encoding(5 bytes) = e8 c6 92 9f ff
...
004fh call 7FFDD94B4BE0h            ; CALL(Call_rel32_64) [FFFFFFFFFF9F9290h:jmp64]        encoding(5 bytes) = e8 3c 92 9f ff
0054h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> parseBytes => new byte[85]{0x56,0x48,0x83,0xEC,0x30,0x33,0xC0,0x48,0x89,0x44,0x24,0x20,0x48,0x89,0x44,0x24,0x28,0x48,0x8B,0xF2,0x48,0x85,0xC9,0x74,0x31,0x48,0x8D,0x41,0x0C,0x8B,0x51,0x08,0x48,0x8D,0x4C,0x24,0x20,0x48,0x89,0x01,0x89,0x51,0x08,0xE8,0x10,0xFC,0x4F,0x56,0x4C,0x8B,0xC0,0x48,0x8D,0x4C,0x24,0x20,0xBA,0x07,0x00,0x00,0x00,0xE8,0x1E,0x67,0xCC,0xFF,0x89,0x06,0x48,0x83,0xC4,0x30,0x5E,0xC3,0xB9,0x11,0x00,0x00,0x00,0xE8,0x3C,0x92,0x9F,0xFF,0xCC};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
0049h ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
004ah mov ecx,11h                   ; MOV(Mov_r32_imm32) [ECX,11h:imm32]                   encoding(5 bytes) = b9 11 00 00 00
004fh call 7FFDD94B4BE0h            ; CALL(Call_rel32_64) [FFFFFFFFFF9F9220h:jmp64]        encoding(5 bytes) = e8 cc 91 9f ff
0054h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> parseBytes => new byte[85]{0x56,0x48,0x83,0xEC,0x30,0x33,0xC0,0x48,0x89,0x44,0x24,0x20,0x48,0x89,0x44,0x24,0x28,0x48,0x8B,0xF2,0x48,0x85,0xC9,0x74,0x31,0x48,0x8D,0x41,0x0C,0x8B,0x51,0x08,0x48,0x8D,0x4C,0x24,0x20,0x48,0x89,0x01,0x89,0x51,0x08,0xE8,0xA0,0xFB,0x4F,0x56,0x4C,0x8B,0xC0,0x48,0x8D,0x4C,0x24,0x20,0xBA,0x07,0x00,0x00,0x00,0xE8,0xBE,0x66,0xCC,0xFF,0x89,0x06,0x48,0x83,0xC4,0x30,0x5E,0xC3,0xB9,0x11,0x00,0x00,0x00,0xE8,0xCC,0x91,0x9F,0xFF,0xCC};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
0050h call 7FFDD94B4BE0h            ; CALL(Call_rel32_64) [FFFFFFFFFF9F91B0h:jmp64]        encoding(5 bytes) = e8 5b 91 9f ff
0055h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> parseBytes => new byte[86]{0x56,0x48,0x83,0xEC,0x30,0x33,0xC0,0x48,0x89,0x44,0x24,0x20,0x48,0x89,0x44,0x24,0x28,0x48,0x8B,0xF2,0x48,0x85,0xC9,0x74,0x32,0x48,0x8D,0x41,0x0C,0x8B,0x51,0x08,0x48,0x8D,0x4C,0x24,0x20,0x48,0x89,0x01,0x89,0x51,0x08,0xE8,0x30,0xFB,0x4F,0x56,0x4C,0x8B,0xC0,0x48,0x8D,0x4C,0x24,0x20,0xBA,0x07,0x00,0x00,0x00,0xE8,0x46,0x66,0xCC,0xFF,0x48,0x89,0x06,0x48,0x83,0xC4,0x30,0x5E,0xC3,0xB9,0x11,0x00,0x00,0x00,0xE8,0x5B,0x91,0x9F,0xFF,0xCC};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
004ah ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
004bh mov ecx,11h                   ; MOV(Mov_r32_imm32) [ECX,11h:imm32]                   encoding(5 bytes) = b9 11 00 00 00
0050h call 7FFDD94B4BE0h            ; CALL(Call_rel32_64) [FFFFFFFFFF9F9140h:jmp64]        encoding(5 bytes) = e8 eb 90 9f ff
0055h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> parseBytes => new byte[86]{0x56,0x48,0x83,0xEC,0x30,0x33,0xC0,0x48,0x89,0x44,0x24,0x20,0x48,0x89,0x44,0x24,0x28,0x48,0x8B,0xF2,0x48,0x85,0xC9,0x74,0x32,0x48,0x8D,0x41,0x0C,0x8B,0x51,0x08,0x48,0x8D,0x4C,0x24,0x20,0x48,0x89,0x01,0x89,0x51,0x08,0xE8,0xC0,0xFA,0x4F,0x56,0x4C,0x8B,0xC0,0x48,0x8D,0x4C,0x24,0x20,0xBA,0x07,0x00,0x00,0x00,0xE8,0x5E,0xFD,0x5C,0x56,0x48,0x89,0x06,0x48,0x83,0xC4,0x30,0x5E,0xC3,0xB9,0x11,0x00,0x00,0x00,0xE8,0xEB,0x90,0x9F,0xFF,0xCC};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
006bh call 7FFDD94B4BE0h            ; CALL(Call_rel32_64) [FFFFFFFFFF9F90D0h:jmp64]        encoding(5 bytes) = e8 60 90 9f ff
...
006ch call 7FFDD94B4BE0h            ; CALL(Call_rel32_64) [FFFFFFFFFF9F9030h:jmp64]        encoding(5 bytes) = e8 bf 8f 9f ff
