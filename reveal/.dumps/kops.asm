; 2020-01-01 04:39:45:904
; function: bit eq_d16u(ushort a, ushort b)
; location: [7FF7C7BB2A20h, 7FF7C7BB2A33h]
...
; location: [7FF7C7BB2A50h, 7FF7C7BB2A66h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h movzx eax,cx                  ; MOVZX(Movzx_r32_rm16) [EAX,CX]                       encoding(3 bytes) = 0f b7 c1
0008h movzx edx,dx                  ; MOVZX(Movzx_r32_rm16) [EDX,DX]                       encoding(3 bytes) = 0f b7 d2
...
; location: [7FF7C7BB2A80h, 7FF7C7BB2A96h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h movzx eax,cx                  ; MOVZX(Movzx_r32_rm16) [EAX,CX]                       encoding(3 bytes) = 0f b7 c1
0008h movzx edx,dx                  ; MOVZX(Movzx_r32_rm16) [EDX,DX]                       encoding(3 bytes) = 0f b7 d2
000bh movzx eax,ax                  ; MOVZX(Movzx_r32_rm16) [EAX,AX]                       encoding(3 bytes) = 0f b7 c0
...
; location: [7FF7C7BB2AB0h, 7FF7C7BB2ADEh]
...
0024h call 7FF7C7BB24F0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFA40h:jmp64]        encoding(5 bytes) = e8 17 fa ff ff
...
; location: [7FF7C7BB2B00h, 7FF7C7BB2B12h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,29B46B508D8h          ; MOV(Mov_r64_imm64) [RAX,29b46b508d8h:imm64]          encoding(10 bytes) = 48 b8 d8 08 b5 46 9b 02 00 00
000fh mov rax,[rax]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RAX:br,:sr)]          encoding(3 bytes) = 48 8b 00
0012h ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> the_nameBytes => new byte[19]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0xD8,0x08,0xB5,0x46,0x9B,0x02,0x00,0x00,0x48,0x8B,0x00,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
