; 2019-12-23 01:20:36:852
; function: N64 get_n64()
; location: [7FF7C7C4BF40h, 7FF7C7C4BF54h]
...
; location: [7FF7C7C4C900h, 7FF7C7C4C927h]
...
; location: [7FF7C7C4C940h, 7FF7C7C4C94Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C7C4C960h, 7FF7C7C4C96Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
