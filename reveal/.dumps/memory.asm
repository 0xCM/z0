; 2019-12-24 12:34:01:517
; function: N64 get_n64()
; location: [7FF7C7D6BFD0h, 7FF7C7D6BFE4h]
...
; location: [7FF7C7D6C990h, 7FF7C7D6C9B7h]
...
; location: [7FF7C7D6C9D0h, 7FF7C7D6C9DAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C7D6C9F0h, 7FF7C7D6C9FAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
