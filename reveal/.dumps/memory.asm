; 2019-12-14 22:09:14:669
; function: N64 get_n64()
; location: [7FF7F0E67040h, 7FF7F0E67054h]
...
; location: [7FF7F0E67070h, 7FF7F0E67097h]
...
; location: [7FF7F0E670B0h, 7FF7F0E670BAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7F0E670D0h, 7FF7F0E670DAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
