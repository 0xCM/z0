; 2020-01-01 04:39:45:315
; function: N64 get_n64()
; location: [7FF7C7B95240h, 7FF7C7B95254h]
...
; location: [7FF7C7B95270h, 7FF7C7B9527Ah]
...
; location: [7FF7C7B95290h, 7FF7C7B9529Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C7B95830h, 7FF7C7B95857h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C7B95870h, 7FF7C7B9587Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C7B95890h, 7FF7C7B9589Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C7B958B0h, 7FF7C7B958FFh]
0000h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0001h sub rsp,20h                   ; SUB(Sub_rm64_imm8) [RSP,20h:imm64]                   encoding(4 bytes) = 48 83 ec 20
0005h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
0008h mov rcx,7FF7C7709078h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7709078h:imm64]         encoding(10 bytes) = 48 b9 78 90 70 c7 f7 7f 00 00
0012h mov edx,6                     ; MOV(Mov_r32_imm32) [EDX,6h:imm32]                    encoding(5 bytes) = ba 06 00 00 00
0017h call 7FF826FA6DE0h            ; CALL(Call_rel32_64) [5F411530h:jmp64]                encoding(5 bytes) = e8 14 15 41 5f
001ch mov rdx,29B3524E325h          ; MOV(Mov_r64_imm64) [RDX,29b3524e325h:imm64]          encoding(10 bytes) = 48 ba 25 e3 24 35 9b 02 00 00
...
; static ReadOnlySpan<byte> get_CharsBytes => new byte[80]{0x56,0x48,0x83,0xEC,0x20,0x48,0x8B,0xF1,0x48,0xB9,0x78,0x90,0x70,0xC7,0xF7,0x7F,0x00,0x00,0xBA,0x06,0x00,0x00,0x00,0xE8,0x14,0x15,0x41,0x5F,0x48,0xBA,0x25,0xE3,0x24,0x35,0x9B,0x02,0x00,0x00,0x48,0x8D,0x48,0x10,0x4C,0x8B,0x02,0x4C,0x89,0x01,0x44,0x8B,0x42,0x08,0x44,0x89,0x41,0x08,0x48,0x83,0xC0,0x10,0xBA,0x06,0x00,0x00,0x00,0x48,0x89,0x06,0x89,0x56,0x08,0x48,0x8B,0xC6,0x48,0x83,0xC4,0x20,0x5E,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ReadOnlySpan<byte> get_Bytes()
; location: [7FF7C7B95920h, 7FF7C7B9593Ch]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,29B3524E31Dh          ; MOV(Mov_r64_imm64) [RAX,29b3524e31dh:imm64]          encoding(10 bytes) = 48 b8 1d e3 24 35 9b 02 00 00
...
; static ReadOnlySpan<byte> get_BytesBytes => new byte[29]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0x1D,0xE3,0x24,0x35,0x9B,0x02,0x00,0x00,0x48,0x89,0x01,0xC7,0x41,0x08,0x08,0x00,0x00,0x00,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: string get_ContStr()
; location: [7FF7C7B95950h, 7FF7C7B95962h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,29B46B4FB78h          ; MOV(Mov_r64_imm64) [RAX,29b46b4fb78h:imm64]          encoding(10 bytes) = 48 b8 78 fb b4 46 9b 02 00 00
000fh mov rax,[rax]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RAX:br,:sr)]          encoding(3 bytes) = 48 8b 00
0012h ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> get_ContStrBytes => new byte[19]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0x78,0xFB,0xB4,0x46,0x9B,0x02,0x00,0x00,0x48,0x8B,0x00,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ReadOnlySpan<Char> get_CharSpan()
; location: [7FF7C7B95980h, 7FF7C7B959B7h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,29B46B4FB78h          ; MOV(Mov_r64_imm64) [RAX,29b46b4fb78h:imm64]          encoding(10 bytes) = 48 b8 78 fb b4 46 9b 02 00 00
000fh mov rax,[rax]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RAX:br,:sr)]          encoding(3 bytes) = 48 8b 00
...
; static ReadOnlySpan<byte> digit_1Bytes => new byte[46]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0x78,0xFB,0xB4,0x46,0x9B,0x02,0x00,0x00,0x48,0x8B,0x00,0x48,0x85,0xC0,0x75,0x04,0x33,0xD2,0xEB,0x0E,0x8B,0x10,0x48,0x8B,0xD0,0x39,0x12,0x48,0x83,0xC2,0x0C,0x8B,0x40,0x08,0x0F,0xB7,0x42,0x0A,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Char digit_2()
; location: [7FF7C7B95E10h, 7FF7C7B95E36h]
...
0021h call 7FF8270CFDD0h            ; CALL(Call_rel32_64) [5F539FC0h:jmp64]                encoding(5 bytes) = e8 9a 9f 53 5f
0026h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> digit_2Bytes => new byte[39]{0x48,0x83,0xEC,0x28,0x90,0x48,0xB8,0x78,0xFB,0xB4,0x46,0x9B,0x02,0x00,0x00,0x48,0x8B,0x00,0x83,0x78,0x08,0x05,0x76,0x09,0x0F,0xB7,0x40,0x16,0x48,0x83,0xC4,0x28,0xC3,0xE8,0x9A,0x9F,0x53,0x5F,0xCC};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Char digit(int i)
; location: [7FF7C7B95E50h, 7FF7C7B95E66h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h movsxd rax,ecx                ; MOVSXD(Movsxd_r64_rm32) [RAX,ECX]                    encoding(3 bytes) = 48 63 c1
0008h mov rdx,29B3524E31Dh          ; MOV(Mov_r64_imm64) [RDX,29b3524e31dh:imm64]          encoding(10 bytes) = 48 ba 1d e3 24 35 9b 02 00 00
0012h movzx eax,byte ptr [rax+rdx]  ; MOVZX(Movzx_r32_rm8) [EAX,mem(8u,RAX:br,:sr)]        encoding(4 bytes) = 0f b6 04 10
0016h ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> digitBytes => new byte[23]{0x0F,0x1F,0x44,0x00,0x00,0x48,0x63,0xC1,0x48,0xBA,0x1D,0xE3,0x24,0x35,0x9B,0x02,0x00,0x00,0x0F,0xB6,0x04,0x10,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Char bdigit(bit b)
; location: [7FF7C7B95E80h, 7FF7C7B95E8Bh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
