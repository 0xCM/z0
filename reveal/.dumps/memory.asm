; 2019-12-18 17:17:39:898
; function: N64 get_n64()
; location: [7FF7C6A25C80h, 7FF7C6A25C94h]
...
; location: [7FF7C6A26120h, 7FF7C6A26147h]
...
; location: [7FF7C6A26160h, 7FF7C6A2616Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C6A26180h, 7FF7C6A2618Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
