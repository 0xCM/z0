; 2019-12-16 03:16:40:487
; function: N64 get_n64()
; location: [7FF7C6A260B0h, 7FF7C6A260C4h]
...
; location: [7FF7C6A26960h, 7FF7C6A26987h]
...
; location: [7FF7C6A269A0h, 7FF7C6A269AAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C6A269C0h, 7FF7C6A269CAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
