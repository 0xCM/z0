...
; static ReadOnlySpan<byte> digit_1Bytes => new byte[46]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0x68,0xFB,0xBB,0x61,0xC8,0x01,0x00,0x00,0x48,0x8B,0x00,0x48,0x85,0xC0,0x75,0x04,0x33,0xD2,0xEB,0x0E,0x8B,0x10,0x48,0x8B,0xD0,0x39,0x12,0x48,0x83,0xC2,0x0C,0x8B,0x40,0x08,0x0F,0xB7,0x42,0x0A,0xC3};
0000h nop dword ptr [rax+rax]                 ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]        encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,1C861BBFB68h                    ; MOV(Mov_r64_imm64) [RAX,1c861bbfb68h:imm64] encoding(10 bytes) = 48 b8 68 fb bb 61 c8 01 00 00
...
; static ReadOnlySpan<byte> digit_2Bytes => new byte[39]{0x48,0x83,0xEC,0x28,0x90,0x48,0xB8,0x68,0xFB,0xBB,0x61,0xC8,0x01,0x00,0x00,0x48,0x8B,0x00,0x83,0x78,0x08,0x05,0x76,0x09,0x0F,0xB7,0x40,0x16,0x48,0x83,0xC4,0x28,0xC3,0xE8,0x3A,0xA8,0x55,0x5F,0xCC};
...
0021h call 7FF82738FDD0h                      ; CALL(Call_rel32_64) [5F55A860h:jmp64]      encoding(5 bytes) = e8 3a a8 55 5f
0026h int 3                                   ; INT(Int3)                                  encoding(1 byte ) = cc
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Char digit(int i)
; static ReadOnlySpan<byte> digitBytes => new byte[23]{0x0F,0x1F,0x44,0x00,0x00,0x48,0x63,0xC1,0x48,0xBA,0x6D,0xE1,0xB5,0x51,0xC8,0x01,0x00,0x00,0x0F,0xB6,0x04,0x10,0xC3};
0000h nop dword ptr [rax+rax]                 ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]        encoding(5 bytes) = 0f 1f 44 00 00
0005h movsxd rax,ecx                          ; MOVSXD(Movsxd_r64_rm32) [RAX,ECX]          encoding(3 bytes) = 48 63 c1
0008h mov rdx,1C851B5E16Dh                    ; MOV(Mov_r64_imm64) [RDX,1c851b5e16dh:imm64] encoding(10 bytes) = 48 ba 6d e1 b5 51 c8 01 00 00
