; 2019-12-17 03:26:34:124
; function: N64 get_n64()
; location: [7FF7C6A357D0h, 7FF7C6A357E4h]
...
; location: [7FF7C6A35C70h, 7FF7C6A35C97h]
...
; location: [7FF7C6A35CB0h, 7FF7C6A35CBAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C6A35CD0h, 7FF7C6A35CDAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
