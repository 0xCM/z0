; 2019-12-19 21:55:23:302
; function: N64 get_n64()
; location: [7FF7C7EA5930h, 7FF7C7EA5944h]
...
; location: [7FF7C7EA5DD0h, 7FF7C7EA5DF7h]
...
; location: [7FF7C7EA5E10h, 7FF7C7EA5E1Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C7EA5E30h, 7FF7C7EA5E3Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
