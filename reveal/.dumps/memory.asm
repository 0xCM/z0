; 2019-12-13 15:23:28:945
; function: N64 get_n64()
; location: [7FF7C5C61E90h, 7FF7C5C61EA4h]
...
; location: [7FF7C5C61EC0h, 7FF7C5C61EE7h]
...
; location: [7FF7C5C61F00h, 7FF7C5C61F0Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C5C61F20h, 7FF7C5C61F2Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
