; 2019-12-23 21:08:18:582
; function: N64 get_n64()
; location: [7FF7C7D6C660h, 7FF7C7D6C674h]
...
; location: [7FF7C7D6CCB0h, 7FF7C7D6CCD7h]
...
; location: [7FF7C7D6CCF0h, 7FF7C7D6CCFAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C7D6CD10h, 7FF7C7D6CD1Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
