; 2019-12-13 11:54:24:224
; function: N64 get_n64()
; location: [7FFDD8E32740h, 7FFDD8E32754h]
...
; location: [7FFDD8E32770h, 7FFDD8E32797h]
...
; location: [7FFDD8E327B0h, 7FFDD8E327BAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFDD8E327D0h, 7FFDD8E327DAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
