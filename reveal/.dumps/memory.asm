; 2019-12-23 19:01:27:624
; function: N64 get_n64()
; location: [7FF7C7D8C660h, 7FF7C7D8C674h]
...
; location: [7FF7C7D8C8B0h, 7FF7C7D8C8D7h]
...
; location: [7FF7C7D8C8F0h, 7FF7C7D8C8FAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C7D8C910h, 7FF7C7D8C91Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
