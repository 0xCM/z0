; 2019-12-18 14:56:11:562
; function: N64 get_n64()
; location: [7FF7C6A05C80h, 7FF7C6A05C94h]
...
; location: [7FF7C6A06120h, 7FF7C6A06147h]
...
; location: [7FF7C6A06160h, 7FF7C6A0616Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C6A06180h, 7FF7C6A0618Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
