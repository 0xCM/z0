; 2019-12-18 01:55:56:856
; function: N64 get_n64()
; location: [7FF7C6A25620h, 7FF7C6A25634h]
...
; location: [7FF7C6A25C70h, 7FF7C6A25C97h]
...
; location: [7FF7C6A25CB0h, 7FF7C6A25CBAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C6A25CD0h, 7FF7C6A25CDAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
