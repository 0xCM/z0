; 2019-12-25 04:41:09:950
; function: void part64x1_byte(ulong src, Span<byte> dst)
; location: [7FF7C7E4B5A0h, 7FF7C7E4B650h]
...
00abh call 7FF82738FC20h            ; CALL(Call_rel32_64) [5F544680h:jmp64]                encoding(5 bytes) = e8 d0 45 54 5f
00b0h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> part64x1_byteBytes => new byte[177]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void part64x1_bit(ulong src, Span<bit> dst)
; location: [7FF7C7E4B670h, 7FF7C7E4B6C2h]
0000h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
...
004dh call 7FF82738FC20h            ; CALL(Call_rel32_64) [5F5445B0h:jmp64]                encoding(5 bytes) = e8 5e 45 54 5f
0052h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> part64x1_bitBytes => new byte[83]{0x48,0x83,0xEC,0x28,0x48,0x8B,0xC1,0x4C,0x8B,0x02,0x8B,0x4A,0x08,0x48,0xC1,0xE1,0x02,0x48,0xC1,0xE9,0x03,0x48,0x81,0xF9,0xFF,0xFF,0xFF,0x7F,0x77,0x2F,0x33,0xD2,0x48,0x63,0xCA,0x4D,0x8D,0x0C,0xC8,0x8B,0xCA,0x4C,0x8B,0xD0,0x49,0xD3,0xEA,0x48,0xB9,0x01,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0xC4,0xE2,0xAB,0xF5,0xC9,0x49,0x89,0x09,0xFF,0xC2,0x83,0xFA,0x20,0x7C,0xD8,0x48,0x83,0xC4,0x28,0xC3,0xE8,0x5E,0x45,0x54,0x5F,0xCC};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
