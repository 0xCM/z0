; 2020-01-05 02:30:51:496
; function: void part64x1_byte(ulong src, Span<byte> dst)
; location: [7FF7C7BB3760h, 7FF7C7BB3810h]
...
00abh call 7FF8270CFC20h            ; CALL(Call_rel32_64) [5F51C4C0h:jmp64]                encoding(5 bytes) = e8 10 c4 51 5f
00b0h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> part64x1_byteBytes => new byte[177]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void part64x1_bit(ulong src, Span<bit> dst)
; location: [7FF7C7BB3830h, 7FF7C7BB3882h]
0000h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
...
004dh call 7FF8270CFC20h            ; CALL(Call_rel32_64) [5F51C3F0h:jmp64]                encoding(5 bytes) = e8 9e c3 51 5f
0052h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> part64x1_bitBytes => new byte[83]{0x48,0x83,0xEC,0x28,0x48,0x8B,0xC1,0x4C,0x8B,0x02,0x8B,0x4A,0x08,0x48,0xC1,0xE1,0x02,0x48,0xC1,0xE9,0x03,0x48,0x81,0xF9,0xFF,0xFF,0xFF,0x7F,0x77,0x2F,0x33,0xD2,0x48,0x63,0xCA,0x4D,0x8D,0x0C,0xC8,0x8B,0xCA,0x4C,0x8B,0xD0,0x49,0xD3,0xEA,0x48,0xB9,0x01,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0xC4,0xE2,0xAB,0xF5,0xC9,0x49,0x89,0x09,0xFF,0xC2,0x83,0xFA,0x20,0x7C,0xD8,0x48,0x83,0xC4,0x28,0xC3,0xE8,0x9E,0xC3,0x51,0x5F,0xCC};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
