; 2019-12-12 14:55:22:051
; function: uint pop_3x64(ulong x, ulong y, ulong z)
; location: [7FFDD8E55DC0h, 7FFDD8E55E7Ah]
...
; location: [7FFDD8E55E90h, 7FFDD8E55FD3h]
...
; location: [7FFDD8E56020h, 7FFDD8E561A0h]
...
; location: [7FFDD8E565F0h, 7FFDD8E566A0h]
...
00abh call 7FFE383BED50h            ; CALL(Call_rel32_64) [5F568760h:jmp64]                encoding(5 bytes) = e8 b0 86 56 5f
00b0h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> part64x1_byteBytes => new byte[177]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void part64x1_bit(ulong src, Span<bit> dst)
; location: [7FFDD8E566C0h, 7FFDD8E56712h]
0000h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
...
004dh call 7FFE383BED50h            ; CALL(Call_rel32_64) [5F568690h:jmp64]                encoding(5 bytes) = e8 3e 86 56 5f
0052h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> part64x1_bitBytes => new byte[83]{0x48,0x83,0xEC,0x28,0x48,0x8B,0xC1,0x4C,0x8B,0x02,0x8B,0x4A,0x08,0x48,0xC1,0xE1,0x02,0x48,0xC1,0xE9,0x03,0x48,0x81,0xF9,0xFF,0xFF,0xFF,0x7F,0x77,0x2F,0x33,0xD2,0x48,0x63,0xCA,0x4D,0x8D,0x0C,0xC8,0x8B,0xCA,0x4C,0x8B,0xD0,0x49,0xD3,0xEA,0x48,0xB9,0x01,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0xC4,0xE2,0xAB,0xF5,0xC9,0x49,0x89,0x09,0xFF,0xC2,0x83,0xFA,0x20,0x7C,0xD8,0x48,0x83,0xC4,0x28,0xC3,0xE8,0x3E,0x86,0x56,0x5F,0xCC};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
