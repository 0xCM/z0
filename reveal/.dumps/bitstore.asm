; 2020-01-15 19:20:38:132
; function: ReadOnlySpan<byte> bitseq(byte value)
; static ReadOnlySpan<byte> bitseqBytes => new byte[41]{0x0F,0x1F,0x44,0x00,0x00,0x0F,0xB6,0xC2,0xC1,0xE0,0x03,0x48,0x63,0xC0,0x48,0xBA,0xC5,0x50,0x96,0x7B,0xED,0x01,0x00,0x00,0x48,0x03,0xC2,0x48,0x89,0x01,0xC7,0x41,0x08,0x08,0x00,0x00,0x00,0x48,0x8B,0xC1,0xC3};
...
000eh mov rdx,1ED7B9650C5h                    ; MOV(Mov_r64_imm64) [RDX,1ed7b9650c5h:imm64] encoding(10 bytes) = 48 ba c5 50 96 7b ed 01 00 00
...
; static ReadOnlySpan<byte> bitseq_8uBytes => new byte[37]{0x0F,0x1F,0x44,0x00,0x00,0x48,0x8B,0x02,0x0F,0xB6,0xD1,0xC1,0xE2,0x03,0x48,0x63,0xD2,0x48,0xB9,0xC5,0x50,0x96,0x7B,0xED,0x01,0x00,0x00,0x48,0x03,0xD1,0x48,0x8B,0x12,0x48,0x89,0x10,0xC3};
0000h nop dword ptr [rax+rax]                 ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]        encoding(5 bytes) = 0f 1f 44 00 00
...
0011h mov rcx,1ED7B9650C5h                    ; MOV(Mov_r64_imm64) [RCX,1ed7b9650c5h:imm64] encoding(10 bytes) = 48 b9 c5 50 96 7b ed 01 00 00
...
; static ReadOnlySpan<byte> bitseq_16uBytes => new byte[70]{0x0F,0x1F,0x44,0x00,0x00,0x48,0x8B,0x02,0x0F,0xB7,0xD1,0x48,0x8B,0xC8,0x44,0x0F,0xB6,0xC2,0x41,0xC1,0xE0,0x03,0x4D,0x63,0xC0,0x49,0xB9,0xC5,0x50,0x96,0x7B,0xED,0x01,0x00,0x00,0x4D,0x03,0xC1,0x4D,0x8B,0x00,0x4C,0x89,0x01,0x48,0x83,0xC0,0x08,0xC1,0xFA,0x08,0x0F,0xB6,0xD2,0xC1,0xE2,0x03,0x48,0x63,0xD2,0x49,0x03,0xD1,0x48,0x8B,0x12,0x48,0x89,0x10,0xC3};
0000h nop dword ptr [rax+rax]                 ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]        encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,[rdx]                           ; MOV(Mov_r64_rm64) [RAX,mem(64u,RDX:br,:sr)] encoding(3 bytes) = 48 8b 02
...
0019h mov r9,1ED7B9650C5h                     ; MOV(Mov_r64_imm64) [R9,1ed7b9650c5h:imm64] encoding(10 bytes) = 49 b9 c5 50 96 7b ed 01 00 00
...
0029h mov r10,1ED7B9650C5h                    ; MOV(Mov_r64_imm64) [R10,1ed7b9650c5h:imm64] encoding(10 bytes) = 49 ba c5 50 96 7b ed 01 00 00
...
002ah mov r10,1ED7B9650C5h                    ; MOV(Mov_r64_imm64) [R10,1ed7b9650c5h:imm64] encoding(10 bytes) = 49 ba c5 50 96 7b ed 01 00 00
...
; static ReadOnlySpan<byte> bitseqBytes => new byte[58]{0x48,0x83,0xEC,0x28,0x90,0x8B,0xC2,0x45,0x8B,0xC8,0x49,0x03,0xC1,0x48,0x3D,0x00,0x08,0x00,0x00,0x77,0x1F,0x48,0x63,0xC2,0x48,0xBA,0xC5,0x50,0x96,0x7B,0xED,0x01,0x00,0x00,0x48,0x03,0xC2,0x48,0x89,0x01,0x44,0x89,0x41,0x08,0x48,0x8B,0xC1,0x48,0x83,0xC4,0x28,0xC3,0xE8,0xE7,0xEB,0xA3,0xFF,0xCC};
...
0018h mov rdx,1ED7B9650C5h                    ; MOV(Mov_r64_imm64) [RDX,1ed7b9650c5h:imm64] encoding(10 bytes) = 48 ba c5 50 96 7b ed 01 00 00
...
0034h call 7FF7C7E87340h                      ; CALL(Call_rel32_64) [FFFFFFFFFFA3EC20h:jmp64] encoding(5 bytes) = e8 e7 eb a3 ff
0039h int 3                                   ; INT(Int3)                                  encoding(1 byte ) = cc
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ReadOnlySpan<byte> bitseq8u(byte src)
; static ReadOnlySpan<byte> bitseq8uBytes => new byte[89]{0x57,0x56,0x48,0x83,0xEC,0x28,0x48,0x8B,0xF1,0x8B,0xFA,0x48,0xB9,0x10,0xEA,0xE3,0xC7,0xF7,0x7F,0x00,0x00,0xBA,0x08,0x00,0x00,0x00,0xE8,0x51,0xE6,0x54,0x5F,0x48,0x8D,0x50,0x10,0x40,0x0F,0xB6,0xCF,0xC1,0xE1,0x03,0x48,0x63,0xC9,0x49,0xB8,0xC5,0x50,0x96,0x7B,0xED,0x01,0x00,0x00,0x49,0x03,0xC8,0x48,0x8B,0x09,0x48,0x89,0x0A,0x48,0x83,0xC0,0x10,0xBA,0x08,0x00,0x00,0x00,0x48,0x89,0x06,0x89,0x56,0x08,0x48,0x8B,0xC6,0x48,0x83,0xC4,0x28,0x5E,0x5F,0xC3};
...
000bh mov rcx,7FF7C7E3EA10h                   ; MOV(Mov_r64_imm64) [RCX,7ff7c7e3ea10h:imm64] encoding(10 bytes) = 48 b9 10 ea e3 c7 f7 7f 00 00
0015h mov edx,8                               ; MOV(Mov_r32_imm32) [EDX,8h:imm32]          encoding(5 bytes) = ba 08 00 00 00
001ah call 7FF827996DE0h                      ; CALL(Call_rel32_64) [5F54E670h:jmp64]      encoding(5 bytes) = e8 51 e6 54 5f
...
002dh mov r8,1ED7B9650C5h                     ; MOV(Mov_r64_imm64) [R8,1ed7b9650c5h:imm64] encoding(10 bytes) = 49 b8 c5 50 96 7b ed 01 00 00
...
; static ReadOnlySpan<byte> bitchars_8uBytes => new byte[52]{0x48,0x83,0xEC,0x28,0x90,0x0F,0xB6,0xC2,0xC1,0xE0,0x04,0x48,0x63,0xC0,0x48,0xBA,0xDD,0x5A,0x96,0x7B,0xED,0x01,0x00,0x00,0x48,0x03,0xC2,0xBA,0x08,0x00,0x00,0x00,0x48,0x89,0x01,0x89,0x51,0x08,0x48,0x8B,0xC1,0x48,0x83,0xC4,0x28,0xC3,0xE8,0xFD,0x6F,0x67,0x5F,0xCC};
0000h sub rsp,28h                             ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]         encoding(4 bytes) = 48 83 ec 28
0004h nop                                     ; NOP(Nopd)                                  encoding(1 byte ) = 90
0005h movzx eax,dl                            ; MOVZX(Movzx_r32_rm8) [EAX,DL]              encoding(3 bytes) = 0f b6 c2
0008h shl eax,4                               ; SHL(Shl_rm32_imm8) [EAX,4h:imm8]           encoding(3 bytes) = c1 e0 04
000bh movsxd rax,eax                          ; MOVSXD(Movsxd_r64_rm32) [RAX,EAX]          encoding(3 bytes) = 48 63 c0
000eh mov rdx,1ED7B965ADDh                    ; MOV(Mov_r64_imm64) [RDX,1ed7b965addh:imm64] encoding(10 bytes) = 48 ba dd 5a 96 7b ed 01 00 00
0018h add rax,rdx                             ; ADD(Add_r64_rm64) [RAX,RDX]                encoding(3 bytes) = 48 03 c2
...
002eh call 7FF827ABFC20h                      ; CALL(Call_rel32_64) [5F677030h:jmp64]      encoding(5 bytes) = e8 fd 6f 67 5f
0033h int 3                                   ; INT(Int3)                                  encoding(1 byte ) = cc
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void bitchars_8u(byte value, Span<Char> dst)
; static ReadOnlySpan<byte> bitchars_8uBytes => new byte[39]{0xC5,0xF8,0x77,0x66,0x90,0x48,0x8B,0x02,0x0F,0xB6,0xD1,0xC1,0xE2,0x04,0x48,0x63,0xD2,0x48,0xB9,0xDD,0x5A,0x96,0x7B,0xED,0x01,0x00,0x00,0x48,0x03,0xD1,0xC5,0xFA,0x6F,0x02,0xC5,0xFA,0x7F,0x00,0xC3};
...
000eh movsxd rdx,edx                          ; MOVSXD(Movsxd_r64_rm32) [RDX,EDX]          encoding(3 bytes) = 48 63 d2
0011h mov rcx,1ED7B965ADDh                    ; MOV(Mov_r64_imm64) [RCX,1ed7b965addh:imm64] encoding(10 bytes) = 48 b9 dd 5a 96 7b ed 01 00 00
001bh add rdx,rcx                             ; ADD(Add_r64_rm64) [RDX,RCX]                encoding(3 bytes) = 48 03 d1
...
; static ReadOnlySpan<byte> bitchars_16uBytes => new byte[83]{0xC5,0xF8,0x77,0x66,0x90,0x48,0x8B,0x02,0x0F,0xB7,0xD1,0x0F,0xB6,0xCA,0xC1,0xE1,0x04,0x48,0x63,0xC9,0x49,0xB8,0xDD,0x5A,0x96,0x7B,0xED,0x01,0x00,0x00,0x49,0x03,0xC8,0x4C,0x8B,0xC0,0xC5,0xFA,0x6F,0x01,0xC4,0xC1,0x7A,0x7F,0x00,0xC1,0xFA,0x08,0x0F,0xB6,0xD2,0xC1,0xE2,0x04,0x48,0x63,0xD2,0x48,0xB9,0xDD,0x5A,0x96,0x7B,0xED,0x01,0x00,0x00,0x48,0x03,0xD1,0x48,0x83,0xC0,0x10,0xC5,0xFA,0x6F,0x02,0xC5,0xFA,0x7F,0x00,0xC3};
0000h vzeroupper                              ; VZEROUPPER(VEX_Vzeroupper)                 encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                              ; NOP(Nopw)                                  encoding(2 bytes) = 66 90
0005h mov rax,[rdx]                           ; MOV(Mov_r64_rm64) [RAX,mem(64u,RDX:br,:sr)] encoding(3 bytes) = 48 8b 02
0008h movzx edx,cx                            ; MOVZX(Movzx_r32_rm16) [EDX,CX]             encoding(3 bytes) = 0f b7 d1
...
0014h mov r8,1ED7B965ADDh                     ; MOV(Mov_r64_imm64) [R8,1ed7b965addh:imm64] encoding(10 bytes) = 49 b8 dd 5a 96 7b ed 01 00 00
...
0039h mov rcx,1ED7B965ADDh                    ; MOV(Mov_r64_imm64) [RCX,1ed7b965addh:imm64] encoding(10 bytes) = 48 b9 dd 5a 96 7b ed 01 00 00
...
0027h mov r10,1ED7B965ADDh                    ; MOV(Mov_r64_imm64) [R10,1ed7b965addh:imm64] encoding(10 bytes) = 49 ba dd 5a 96 7b ed 01 00 00
...
0028h mov r10,1ED7B965ADDh                    ; MOV(Mov_r64_imm64) [R10,1ed7b965addh:imm64] encoding(10 bytes) = 49 ba dd 5a 96 7b ed 01 00 00
