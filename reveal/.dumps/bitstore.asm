; 2019-12-17 03:26:33:971
; function: Char hexdigit(byte a)
; location: [7FF7C6864480h, 7FF7C686449Ch]
...
000eh mov rdx,19A79F7FF61h          ; MOV(Mov_r64_imm64) [RDX,19a79f7ff61h:imm64]          encoding(10 bytes) = 48 ba 61 ff f7 79 9a 01 00 00
0018h movzx eax,byte ptr [rax+rdx]  ; MOVZX(Movzx_r32_rm8) [EAX,mem(8u,RAX:br,:sr)]        encoding(4 bytes) = 0f b6 04 10
001ch ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> hexdigitBytes => new byte[29]{0x0F,0x1F,0x44,0x00,0x00,0x0F,0xB6,0xC1,0x83,0xE0,0x0F,0x48,0x63,0xC0,0x48,0xBA,0x61,0xFF,0xF7,0x79,0x9A,0x01,0x00,0x00,0x0F,0xB6,0x04,0x10,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void hexdigits(byte a, out Char d0, out Char d1)
; location: [7FF7C68644B0h, 7FF7C68644E4h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h movzx eax,cl                  ; MOVZX(Movzx_r32_rm8) [EAX,CL]                        encoding(3 bytes) = 0f b6 c1
...
0010h mov r9,19A79F7FF61h           ; MOV(Mov_r64_imm64) [R9,19a79f7ff61h:imm64]           encoding(10 bytes) = 49 b9 61 ff f7 79 9a 01 00 00
...
; static ReadOnlySpan<byte> hexdigitsBytes => new byte[53]{0x0F,0x1F,0x44,0x00,0x00,0x0F,0xB6,0xC1,0x8B,0xC8,0x83,0xE1,0x0F,0x48,0x63,0xC9,0x49,0xB9,0x61,0xFF,0xF7,0x79,0x9A,0x01,0x00,0x00,0x42,0x0F,0xB6,0x0C,0x09,0x66,0x89,0x0A,0xC1,0xF8,0x04,0x83,0xE0,0x0F,0x48,0x63,0xC0,0x42,0x0F,0xB6,0x04,0x08,0x66,0x41,0x89,0x00,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
; location: [7FF7C6A304B0h, 7FF7C6A304D3h]
...
001eh call 7FF825F2FC20h            ; CALL(Call_rel32_64) [5F4FF770h:jmp64]                encoding(5 bytes) = e8 4d f7 4f 5f
0023h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> datablock_bytesBytes => new byte[36]{0x48,0x83,0xEC,0x38,0x33,0xC0,0x48,0x89,0x44,0x24,0x28,0xB8,0x10,0x00,0x00,0x00,0x48,0x89,0x4C,0x24,0x28,0x89,0x44,0x24,0x30,0x48,0x83,0xC4,0x38,0xC3,0xE8,0x4D,0xF7,0x4F,0x5F,0xCC};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ReadOnlySpan<byte> bitseq(byte value)
; location: [7FF7C6A30650h, 7FF7C6A30678h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h movzx eax,dl                  ; MOVZX(Movzx_r32_rm8) [EAX,DL]                        encoding(3 bytes) = 0f b6 c2
0008h shl eax,3                     ; SHL(Shl_rm32_imm8) [EAX,3h:imm8]                     encoding(3 bytes) = c1 e0 03
000bh movsxd rax,eax                ; MOVSXD(Movsxd_r64_rm32) [RAX,EAX]                    encoding(3 bytes) = 48 63 c0
000eh mov rdx,19A79F80439h          ; MOV(Mov_r64_imm64) [RDX,19a79f80439h:imm64]          encoding(10 bytes) = 48 ba 39 04 f8 79 9a 01 00 00
...
; static ReadOnlySpan<byte> bitseqBytes => new byte[41]{0x0F,0x1F,0x44,0x00,0x00,0x0F,0xB6,0xC2,0xC1,0xE0,0x03,0x48,0x63,0xC0,0x48,0xBA,0x39,0x04,0xF8,0x79,0x9A,0x01,0x00,0x00,0x48,0x03,0xC2,0x48,0x89,0x01,0xC7,0x41,0x08,0x08,0x00,0x00,0x00,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void bitseq_8u(byte value, Span<byte> dst)
; location: [7FF7C6A30690h, 7FF7C6A306B4h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
0011h mov rcx,19A79F80439h          ; MOV(Mov_r64_imm64) [RCX,19a79f80439h:imm64]          encoding(10 bytes) = 48 b9 39 04 f8 79 9a 01 00 00
...
; static ReadOnlySpan<byte> bitseq_8uBytes => new byte[37]{0x0F,0x1F,0x44,0x00,0x00,0x48,0x8B,0x02,0x0F,0xB6,0xD1,0xC1,0xE2,0x03,0x48,0x63,0xD2,0x48,0xB9,0x39,0x04,0xF8,0x79,0x9A,0x01,0x00,0x00,0x48,0x03,0xD1,0x48,0x8B,0x12,0x48,0x89,0x10,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void bitseq_16u(ushort value, Span<byte> dst)
; location: [7FF7C6A306D0h, 7FF7C6A30715h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,[rdx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RDX:br,:sr)]          encoding(3 bytes) = 48 8b 02
...
0019h mov r9,19A79F80439h           ; MOV(Mov_r64_imm64) [R9,19a79f80439h:imm64]           encoding(10 bytes) = 49 b9 39 04 f8 79 9a 01 00 00
...
; static ReadOnlySpan<byte> bitseq_16uBytes => new byte[70]{0x0F,0x1F,0x44,0x00,0x00,0x48,0x8B,0x02,0x0F,0xB7,0xD1,0x48,0x8B,0xC8,0x44,0x0F,0xB6,0xC2,0x41,0xC1,0xE0,0x03,0x4D,0x63,0xC0,0x49,0xB9,0x39,0x04,0xF8,0x79,0x9A,0x01,0x00,0x00,0x4D,0x03,0xC1,0x4D,0x8B,0x00,0x4C,0x89,0x01,0x48,0x83,0xC0,0x08,0xC1,0xFA,0x08,0x0F,0xB6,0xD2,0xC1,0xE2,0x03,0x48,0x63,0xD2,0x49,0x03,0xD1,0x48,0x8B,0x12,0x48,0x89,0x10,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void bitseq_32u(uint value, Span<byte> dst)
; location: [7FF7C6A30B30h, 7FF7C6A30B75h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,[rdx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RDX:br,:sr)]          encoding(3 bytes) = 48 8b 02
...
0029h mov r10,19A79F80439h          ; MOV(Mov_r64_imm64) [R10,19a79f80439h:imm64]          encoding(10 bytes) = 49 ba 39 04 f8 79 9a 01 00 00
...
002ah mov r10,19A79F80439h          ; MOV(Mov_r64_imm64) [R10,19a79f80439h:imm64]          encoding(10 bytes) = 49 ba 39 04 f8 79 9a 01 00 00
...
0018h mov rdx,19A79F80439h          ; MOV(Mov_r64_imm64) [RDX,19a79f80439h:imm64]          encoding(10 bytes) = 48 ba 39 04 f8 79 9a 01 00 00
...
0034h call 7FF7C630D0A8h            ; CALL(Call_rel32_64) [FFFFFFFFFF8DC4B8h:jmp64]        encoding(5 bytes) = e8 7f c4 8d ff
0039h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> bitseqBytes => new byte[58]{0x48,0x83,0xEC,0x28,0x90,0x8B,0xC2,0x45,0x8B,0xC8,0x49,0x03,0xC1,0x48,0x3D,0x00,0x08,0x00,0x00,0x77,0x1F,0x48,0x63,0xC2,0x48,0xBA,0x39,0x04,0xF8,0x79,0x9A,0x01,0x00,0x00,0x48,0x03,0xC2,0x48,0x89,0x01,0x44,0x89,0x41,0x08,0x48,0x8B,0xC1,0x48,0x83,0xC4,0x28,0xC3,0xE8,0x7F,0xC4,0x8D,0xFF,0xCC};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ReadOnlySpan<byte> bitseq8u(byte src)
; location: [7FF7C6A30C40h, 7FF7C6A30C98h]
...
000bh mov rcx,7FF7C62CEA10h         ; MOV(Mov_r64_imm64) [RCX,7ff7c62cea10h:imm64]         encoding(10 bytes) = 48 b9 10 ea 2c c6 f7 7f 00 00
0015h mov edx,8                     ; MOV(Mov_r32_imm32) [EDX,8h:imm32]                    encoding(5 bytes) = ba 08 00 00 00
001ah call 7FF825E06DE0h            ; CALL(Call_rel32_64) [5F3D61A0h:jmp64]                encoding(5 bytes) = e8 81 61 3d 5f
...
002dh mov r8,19A79F80439h           ; MOV(Mov_r64_imm64) [R8,19a79f80439h:imm64]           encoding(10 bytes) = 49 b8 39 04 f8 79 9a 01 00 00
...
; static ReadOnlySpan<byte> bitseq8uBytes => new byte[89]{0x57,0x56,0x48,0x83,0xEC,0x28,0x48,0x8B,0xF1,0x8B,0xFA,0x48,0xB9,0x10,0xEA,0x2C,0xC6,0xF7,0x7F,0x00,0x00,0xBA,0x08,0x00,0x00,0x00,0xE8,0x81,0x61,0x3D,0x5F,0x48,0x8D,0x50,0x10,0x40,0x0F,0xB6,0xCF,0xC1,0xE1,0x03,0x48,0x63,0xC9,0x49,0xB8,0x39,0x04,0xF8,0x79,0x9A,0x01,0x00,0x00,0x49,0x03,0xC8,0x48,0x8B,0x09,0x48,0x89,0x0A,0x48,0x83,0xC0,0x10,0xBA,0x08,0x00,0x00,0x00,0x48,0x89,0x06,0x89,0x56,0x08,0x48,0x8B,0xC6,0x48,0x83,0xC4,0x28,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ReadOnlySpan<Char> bitchars_8u(byte value)
; location: [7FF7C6A30CC0h, 7FF7C6A30CF3h]
0000h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0004h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
0005h movzx eax,dl                  ; MOVZX(Movzx_r32_rm8) [EAX,DL]                        encoding(3 bytes) = 0f b6 c2
0008h shl eax,4                     ; SHL(Shl_rm32_imm8) [EAX,4h:imm8]                     encoding(3 bytes) = c1 e0 04
000bh movsxd rax,eax                ; MOVSXD(Movsxd_r64_rm32) [RAX,EAX]                    encoding(3 bytes) = 48 63 c0
000eh mov rdx,19A79F80E41h          ; MOV(Mov_r64_imm64) [RDX,19a79f80e41h:imm64]          encoding(10 bytes) = 48 ba 41 0e f8 79 9a 01 00 00
0018h add rax,rdx                   ; ADD(Add_r64_rm64) [RAX,RDX]                          encoding(3 bytes) = 48 03 c2
...
002eh call 7FF825F2FC20h            ; CALL(Call_rel32_64) [5F4FEF60h:jmp64]                encoding(5 bytes) = e8 2d ef 4f 5f
0033h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> bitchars_8uBytes => new byte[52]{0x48,0x83,0xEC,0x28,0x90,0x0F,0xB6,0xC2,0xC1,0xE0,0x04,0x48,0x63,0xC0,0x48,0xBA,0x41,0x0E,0xF8,0x79,0x9A,0x01,0x00,0x00,0x48,0x03,0xC2,0xBA,0x08,0x00,0x00,0x00,0x48,0x89,0x01,0x89,0x51,0x08,0x48,0x8B,0xC1,0x48,0x83,0xC4,0x28,0xC3,0xE8,0x2D,0xEF,0x4F,0x5F,0xCC};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void bitchars_8u(byte value, Span<Char> dst)
; location: [7FF7C6A31110h, 7FF7C6A31136h]
...
000eh movsxd rdx,edx                ; MOVSXD(Movsxd_r64_rm32) [RDX,EDX]                    encoding(3 bytes) = 48 63 d2
0011h mov rcx,19A79F80E41h          ; MOV(Mov_r64_imm64) [RCX,19a79f80e41h:imm64]          encoding(10 bytes) = 48 b9 41 0e f8 79 9a 01 00 00
001bh add rdx,rcx                   ; ADD(Add_r64_rm64) [RDX,RCX]                          encoding(3 bytes) = 48 03 d1
...
; static ReadOnlySpan<byte> bitchars_8uBytes => new byte[39]{0xC5,0xF8,0x77,0x66,0x90,0x48,0x8B,0x02,0x0F,0xB6,0xD1,0xC1,0xE2,0x04,0x48,0x63,0xD2,0x48,0xB9,0x41,0x0E,0xF8,0x79,0x9A,0x01,0x00,0x00,0x48,0x03,0xD1,0xC5,0xFA,0x6F,0x02,0xC5,0xFA,0x7F,0x00,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void bitchars_16u(ushort value, Span<Char> dst)
; location: [7FF7C6A31150h, 7FF7C6A311A2h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h mov rax,[rdx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RDX:br,:sr)]          encoding(3 bytes) = 48 8b 02
0008h movzx edx,cx                  ; MOVZX(Movzx_r32_rm16) [EDX,CX]                       encoding(3 bytes) = 0f b7 d1
...
0014h mov r8,19A79F80E41h           ; MOV(Mov_r64_imm64) [R8,19a79f80e41h:imm64]           encoding(10 bytes) = 49 b8 41 0e f8 79 9a 01 00 00
...
0039h mov rcx,19A79F80E41h          ; MOV(Mov_r64_imm64) [RCX,19a79f80e41h:imm64]          encoding(10 bytes) = 48 b9 41 0e f8 79 9a 01 00 00
...
; static ReadOnlySpan<byte> bitchars_16uBytes => new byte[83]{0xC5,0xF8,0x77,0x66,0x90,0x48,0x8B,0x02,0x0F,0xB7,0xD1,0x0F,0xB6,0xCA,0xC1,0xE1,0x04,0x48,0x63,0xC9,0x49,0xB8,0x41,0x0E,0xF8,0x79,0x9A,0x01,0x00,0x00,0x49,0x03,0xC8,0x4C,0x8B,0xC0,0xC5,0xFA,0x6F,0x01,0xC4,0xC1,0x7A,0x7F,0x00,0xC1,0xFA,0x08,0x0F,0xB6,0xD2,0xC1,0xE2,0x04,0x48,0x63,0xD2,0x48,0xB9,0x41,0x0E,0xF8,0x79,0x9A,0x01,0x00,0x00,0x48,0x03,0xD1,0x48,0x83,0xC0,0x10,0xC5,0xFA,0x6F,0x02,0xC5,0xFA,0x7F,0x00,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void bitchars_32u(uint value, Span<Char> dst)
; location: [7FF7C6A311C0h, 7FF7C6A3120Dh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h mov rax,[rdx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RDX:br,:sr)]          encoding(3 bytes) = 48 8b 02
0008h mov edx,ecx                   ; MOV(Mov_r32_rm32) [EDX,ECX]                          encoding(2 bytes) = 8b d1
...
0027h mov r10,19A79F80E41h          ; MOV(Mov_r64_imm64) [R10,19a79f80e41h:imm64]          encoding(10 bytes) = 49 ba 41 0e f8 79 9a 01 00 00
...
0028h mov r10,19A79F80E41h          ; MOV(Mov_r64_imm64) [R10,19a79f80e41h:imm64]          encoding(10 bytes) = 49 ba 41 0e f8 79 9a 01 00 00
