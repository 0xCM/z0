; 2019-11-05 06:49:43:925
; function: Vector128<uint> pack(ReadOnlySpan<N128,bit> src)
; location: [7FFDDBAE21D0h, 7FFDDBAE2271h]
...
0020h mov byte ptr [rsp+50h],0      ; MOV(Mov_rm8_imm8) [mem(8u,RSP:br,SS:sr),0h:imm8]     encoding(5 bytes) = c6 44 24 50 00
0025h movsx rcx,byte ptr [rsp+50h]  ; MOVSX(Movsx_r64_rm8) [RCX,mem(8i,RSP:br,SS:sr)]      encoding(6 bytes) = 48 0f be 4c 24 50
002bh mov [rsp+70h],cl              ; MOV(Mov_rm8_r8) [mem(8u,RSP:br,SS:sr),CL]            encoding(4 bytes) = 88 4c 24 70
002fh mov byte ptr [rsp+48h],0      ; MOV(Mov_rm8_imm8) [mem(8u,RSP:br,SS:sr),0h:imm8]     encoding(5 bytes) = c6 44 24 48 00
0034h movsx rcx,byte ptr [rsp+48h]  ; MOVSX(Movsx_r64_rm8) [RCX,mem(8i,RSP:br,SS:sr)]      encoding(6 bytes) = 48 0f be 4c 24 48
003ah mov [rsp+68h],cl              ; MOV(Mov_rm8_r8) [mem(8u,RSP:br,SS:sr),CL]            encoding(4 bytes) = 88 4c 24 68
003eh mov rcx,[rdx]                 ; MOV(Mov_r64_rm64) [RCX,mem(64u,RDX:br,DS:sr)]        encoding(3 bytes) = 48 8b 0a
0041h mov edx,[rdx+8]               ; MOV(Mov_r32_rm32) [EDX,mem(32u,RDX:br,DS:sr)]        encoding(3 bytes) = 8b 52 08
0044h lea r8,[rsp+38h]              ; LEA(Lea_r64_m) [R8,mem(Unknown,RSP:br,SS:sr)]        encoding(5 bytes) = 4c 8d 44 24 38
0049h vxorps xmm0,xmm0,xmm0         ; VXORPS(VEX_Vxorps_xmm_xmm_xmmm128) [XMM0,XMM0,XMM0]  encoding(VEX, 4 bytes) = c5 f8 57 c0
004dh vmovdqu xmmword ptr [r8],xmm0 ; VMOVDQU(VEX_Vmovdqu_xmmm128_xmm) [mem(Packed128_Int32,R8:br,DS:sr),XMM0] encoding(VEX, 5 bytes) = c4 c1 7a 7f 00
0052h lea r8,[rsp+38h]              ; LEA(Lea_r64_m) [R8,mem(Unknown,RSP:br,SS:sr)]        encoding(5 bytes) = 4c 8d 44 24 38
0057h mov [r8],rcx                  ; MOV(Mov_rm64_r64) [mem(64u,R8:br,DS:sr),RCX]         encoding(3 bytes) = 49 89 08
005ah mov [r8+8],edx                ; MOV(Mov_rm32_r32) [mem(32u,R8:br,DS:sr),EDX]         encoding(4 bytes) = 41 89 50 08
005eh vmovdqu xmm0,xmmword ptr [rsp+38h]; VMOVDQU(VEX_Vmovdqu_xmm_xmmm128) [XMM0,mem(Packed128_Int32,RSP:br,SS:sr)] encoding(VEX, 6 bytes) = c5 fa 6f 44 24 38
0064h vmovdqu xmmword ptr [rsp+58h],xmm0; VMOVDQU(VEX_Vmovdqu_xmmm128_xmm) [mem(Packed128_Int32,RSP:br,SS:sr),XMM0] encoding(VEX, 6 bytes) = c5 fa 7f 44 24 58
006ah vmovdqu xmm0,xmmword ptr [rsp+58h]; VMOVDQU(VEX_Vmovdqu_xmm_xmmm128) [XMM0,mem(Packed128_Int32,RSP:br,SS:sr)] encoding(VEX, 6 bytes) = c5 fa 6f 44 24 58
0070h vmovdqu xmmword ptr [rsp+28h],xmm0; VMOVDQU(VEX_Vmovdqu_xmmm128_xmm) [mem(Packed128_Int32,RSP:br,SS:sr),XMM0] encoding(VEX, 6 bytes) = c5 fa 7f 44 24 28
0076h lea rcx,[rsp+28h]             ; LEA(Lea_r64_m) [RCX,mem(Unknown,RSP:br,SS:sr)]       encoding(5 bytes) = 48 8d 4c 24 28
007bh mov r9,[rcx]                  ; MOV(Mov_r64_rm64) [R9,mem(64u,RCX:br,DS:sr)]         encoding(3 bytes) = 4c 8b 09
007eh mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0081h movsx rdx,byte ptr [rsp+70h]  ; MOVSX(Movsx_r64_rm8) [RDX,mem(8i,RSP:br,SS:sr)]      encoding(6 bytes) = 48 0f be 54 24 70
0087h movsx r8,byte ptr [rsp+68h]   ; MOVSX(Movsx_r64_rm8) [R8,mem(8i,RSP:br,SS:sr)]       encoding(6 bytes) = 4c 0f be 44 24 68
008dh call 7FFDDB424080h            ; CALL(Call_rel32_64) [FFFFFFFFFF941EB0h:jmp64]        encoding(5 bytes) = e8 1e 1e 94 ff
...
009ch call 7FFE3B04ED50h            ; CALL(Call_rel32_64) [5F56CB80h:jmp64]                encoding(5 bytes) = e8 df ca 56 5f
00a1h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> packBytes => new byte[162]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector128<uint> pack(N1 width, ReadOnlySpan<N128,uint> src)
; location: [7FFDDBAE2290h, 7FFDDBAE22E5h]
...
000ah mov [rsp+20h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,SS:sr),RAX]        encoding(5 bytes) = 48 89 44 24 20
000fh mov [rsp+58h],rdx             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,SS:sr),RDX]        encoding(5 bytes) = 48 89 54 24 58
0014h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
0017h mov byte ptr [rsp+30h],0      ; MOV(Mov_rm8_imm8) [mem(8u,RSP:br,SS:sr),0h:imm8]     encoding(5 bytes) = c6 44 24 30 00
001ch movsx rcx,byte ptr [rsp+30h]  ; MOVSX(Movsx_r64_rm8) [RCX,mem(8i,RSP:br,SS:sr)]      encoding(6 bytes) = 48 0f be 4c 24 30
0022h mov [rsp+38h],cl              ; MOV(Mov_rm8_r8) [mem(8u,RSP:br,SS:sr),CL]            encoding(4 bytes) = 88 4c 24 38
0026h vmovdqu xmm0,xmmword ptr [r8] ; VMOVDQU(VEX_Vmovdqu_xmm_xmmm128) [XMM0,mem(Packed128_Int32,R8:br,DS:sr)] encoding(VEX, 5 bytes) = c4 c1 7a 6f 00
...
0031h lea rcx,[rsp+20h]             ; LEA(Lea_r64_m) [RCX,mem(Unknown,RSP:br,SS:sr)]       encoding(5 bytes) = 48 8d 4c 24 20
0036h mov r9,[rcx]                  ; MOV(Mov_r64_rm64) [R9,mem(64u,RCX:br,DS:sr)]         encoding(3 bytes) = 4c 8b 09
0039h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
003ch movsx rdx,byte ptr [rsp+58h]  ; MOVSX(Movsx_r64_rm8) [RDX,mem(8i,RSP:br,SS:sr)]      encoding(6 bytes) = 48 0f be 54 24 58
0042h movsx r8,byte ptr [rsp+38h]   ; MOVSX(Movsx_r64_rm8) [R8,mem(8i,RSP:br,SS:sr)]       encoding(6 bytes) = 4c 0f be 44 24 38
0048h call 7FFDDB424080h            ; CALL(Call_rel32_64) [FFFFFFFFFF941DF0h:jmp64]        encoding(5 bytes) = e8 a3 1d 94 ff
...
; static ReadOnlySpan<byte> packBytes => new byte[86]{0x56,0x48,0x83,0xEC,0x40,0xC5,0xF8,0x77,0x33,0xC0,0x48,0x89,0x44,0x24,0x20,0x48,0x89,0x54,0x24,0x58,0x48,0x8B,0xF1,0xC6,0x44,0x24,0x30,0x00,0x48,0x0F,0xBE,0x4C,0x24,0x30,0x88,0x4C,0x24,0x38,0xC4,0xC1,0x7A,0x6F,0x00,0xC5,0xFA,0x7F,0x44,0x24,0x20,0x48,0x8D,0x4C,0x24,0x20,0x4C,0x8B,0x09,0x48,0x8B,0xCE,0x48,0x0F,0xBE,0x54,0x24,0x58,0x4C,0x0F,0xBE,0x44,0x24,0x38,0xE8,0xA3,0x1D,0x94,0xFF,0x48,0x8B,0xC6,0x48,0x83,0xC4,0x40,0x5E,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void pack1(ref Vector128<uint> xmm0, ref Vector128<uint> xmm1, in uint src, byte step, int offset)
; location: [7FFDDBAE2300h, 7FFDDBAE2334h]
...
0021h mov eax,[rsp+28h]             ; MOV(Mov_r32_rm32) [EAX,mem(32u,RSP:br,SS:sr)]        encoding(4 bytes) = 8b 44 24 28
0025h movsxd rax,eax                ; MOVSXD(Movsxd_r64_rm32) [RAX,EAX]                    encoding(3 bytes) = 48 63 c0
0028h lea rax,[r8+rax*4]            ; LEA(Lea_r64_m) [RAX,mem(Unknown,R8:br,DS:sr)]        encoding(4 bytes) = 49 8d 04 80
002ch vlddqu xmm0,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM0,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 00
0030h vmovupd [rdx],xmm0            ; VMOVUPD(VEX_Vmovupd_xmmm128_xmm) [mem(Packed128_Float64,RDX:br,DS:sr),XMM0] encoding(VEX, 4 bytes) = c5 f9 11 02
...
; location: [7FFDDBAE2350h, 7FFDDBAE25C6h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h mov rax,r9                    ; MOV(Mov_r64_rm64) [RAX,R9]                           encoding(3 bytes) = 49 8b c1
0008h vlddqu xmm0,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM0,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 00
000ch lea rax,[r9+10h]              ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(4 bytes) = 49 8d 41 10
0010h vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
0014h vpslld xmm1,xmm1,1            ; VPSLLD(VEX_Vpslld_xmm_xmm_imm8) [XMM1,XMM1,1h:imm8]  encoding(VEX, 5 bytes) = c5 f1 72 f1 01
0019h vpor xmm0,xmm0,xmm1           ; VPOR(VEX_Vpor_xmm_xmm_xmmm128) [XMM0,XMM0,XMM1]      encoding(VEX, 4 bytes) = c5 f9 eb c1
001dh lea rax,[r9+20h]              ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(4 bytes) = 49 8d 41 20
0021h vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
002eh lea rax,[r9+30h]              ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(4 bytes) = 49 8d 41 30
0032h vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
003fh lea rax,[r9+40h]              ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(4 bytes) = 49 8d 41 40
0043h vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
0050h lea rax,[r9+50h]              ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(4 bytes) = 49 8d 41 50
0054h vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
0061h lea rax,[r9+60h]              ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(4 bytes) = 49 8d 41 60
0065h vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
0072h lea rax,[r9+70h]              ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(4 bytes) = 49 8d 41 70
0076h vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
0083h lea rax,[r9+80h]              ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 80 00 00 00
008ah vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
0097h lea rax,[r9+90h]              ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 90 00 00 00
009eh vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
00abh lea rax,[r9+0A0h]             ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 a0 00 00 00
00b2h vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
00bfh lea rax,[r9+0B0h]             ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 b0 00 00 00
00c6h vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
00d3h lea rax,[r9+0C0h]             ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 c0 00 00 00
00dah vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
00e7h lea rax,[r9+0D0h]             ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 d0 00 00 00
00eeh vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
00fbh lea rax,[r9+0E0h]             ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 e0 00 00 00
0102h vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
010fh lea rax,[r9+0F0h]             ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 f0 00 00 00
0116h vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
0123h lea rax,[r9+100h]             ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 00 01 00 00
012ah vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
0137h lea rax,[r9+110h]             ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 10 01 00 00
013eh vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
014bh lea rax,[r9+120h]             ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 20 01 00 00
0152h vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
015fh lea rax,[r9+130h]             ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 30 01 00 00
0166h vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
0173h lea rax,[r9+140h]             ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 40 01 00 00
017ah vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
0187h lea rax,[r9+150h]             ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 50 01 00 00
018eh vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
019bh lea rax,[r9+160h]             ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 60 01 00 00
01a2h vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
01afh lea rax,[r9+170h]             ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 70 01 00 00
01b6h vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
01c3h lea rax,[r9+180h]             ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 80 01 00 00
01cah vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
01d7h lea rax,[r9+190h]             ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 90 01 00 00
01deh vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
01ebh lea rax,[r9+1A0h]             ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 a0 01 00 00
01f2h vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
01ffh lea rax,[r9+1B0h]             ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 b0 01 00 00
0206h vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
0213h lea rax,[r9+1C0h]             ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 c0 01 00 00
021ah vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
0227h lea rax,[r9+1D0h]             ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 d0 01 00 00
022eh vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
023bh lea rax,[r9+1E0h]             ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 e0 01 00 00
0242h vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
024fh lea rax,[r9+1F0h]             ; LEA(Lea_r64_m) [RAX,mem(Unknown,R9:br,DS:sr)]        encoding(7 bytes) = 49 8d 81 f0 01 00 00
0256h vlddqu xmm1,xmmword ptr [rax] ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,RAX:br,DS:sr)] encoding(VEX, 4 bytes) = c5 fb f0 08
...
026ah vlddqu xmm1,xmmword ptr [r9]  ; VLDDQU(VEX_Vlddqu_xmm_m128) [XMM1,mem(UInt128,R9:br,DS:sr)] encoding(VEX, 5 bytes) = c4 c1 7b f0 09
026fh vmovupd [rcx],xmm0            ; VMOVUPD(VEX_Vmovupd_xmmm128_xmm) [mem(Packed128_Float64,RCX:br,DS:sr),XMM0] encoding(VEX, 4 bytes) = c5 f9 11 01
