; 2019-11-23 16:56:47:617
; function: Vector128<uint> pack(NatSpan<N128,bit> src)
; location: [7FFDDB00F780h, 7FFDDB00F815h]
...
0081h call 7FFDDA9220F8h            ; CALL(Call_rel32_64) [FFFFFFFFFF912978h:jmp64]        encoding(5 bytes) = e8 f2 28 91 ff
...
0090h call 7FFE3A54ED50h            ; CALL(Call_rel32_64) [5F53F5D0h:jmp64]                encoding(5 bytes) = e8 3b f5 53 5f
0095h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> packBytes => new byte[150]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector128<uint> pack(N1 width, NatSpan<N128,uint> src)
; location: [7FFDDB00F840h, 7FFDDB00F87Bh]
...
002eh call 7FFDDA9220F8h            ; CALL(Call_rel32_64) [FFFFFFFFFF9128B8h:jmp64]        encoding(5 bytes) = e8 85 28 91 ff
...
; static ReadOnlySpan<byte> packBytes => new byte[60]{0x56,0x48,0x83,0xEC,0x30,0x48,0x89,0x54,0x24,0x48,0x48,0x8B,0xF1,0xC6,0x44,0x24,0x20,0x00,0x48,0x0F,0xBE,0x4C,0x24,0x20,0x88,0x4C,0x24,0x28,0x4D,0x8B,0x08,0x48,0x8B,0xCE,0x48,0x0F,0xBE,0x54,0x24,0x48,0x4C,0x0F,0xBE,0x44,0x24,0x28,0xE8,0x85,0x28,0x91,0xFF,0x48,0x8B,0xC6,0x48,0x83,0xC4,0x30,0x5E,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void pack1(ref Vector128<uint> xmm0, ref Vector128<uint> xmm1, in uint src, byte step, int offset)
; location: [7FFDDB00F890h, 7FFDDB00F8C4h]
...
; location: [7FFDDB00F8E0h, 7FFDDB00FB56h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
