; 2019-11-27 21:54:09:973
; function: Vector128<uint> pack(NatSpan<N128,bit> src)
; location: [7FFDDB010A00h, 7FFDDB010A95h]
...
0081h call 7FFDDA902578h            ; CALL(Call_rel32_64) [FFFFFFFFFF8F1B78h:jmp64]        encoding(5 bytes) = e8 f2 1a 8f ff
...
0090h call 7FFE3A54ED50h            ; CALL(Call_rel32_64) [5F53E350h:jmp64]                encoding(5 bytes) = e8 bb e2 53 5f
0095h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> packBytes => new byte[150]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector128<uint> pack(N1 width, NatSpan<N128,uint> src)
; location: [7FFDDB010AC0h, 7FFDDB010AFBh]
...
002eh call 7FFDDA902578h            ; CALL(Call_rel32_64) [FFFFFFFFFF8F1AB8h:jmp64]        encoding(5 bytes) = e8 85 1a 8f ff
...
; static ReadOnlySpan<byte> packBytes => new byte[60]{0x56,0x48,0x83,0xEC,0x30,0x48,0x89,0x54,0x24,0x48,0x48,0x8B,0xF1,0xC6,0x44,0x24,0x20,0x00,0x48,0x0F,0xBE,0x4C,0x24,0x20,0x88,0x4C,0x24,0x28,0x4D,0x8B,0x08,0x48,0x8B,0xCE,0x48,0x0F,0xBE,0x54,0x24,0x48,0x4C,0x0F,0xBE,0x44,0x24,0x28,0xE8,0x85,0x1A,0x8F,0xFF,0x48,0x8B,0xC6,0x48,0x83,0xC4,0x30,0x5E,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void pack1(ref Vector128<uint> xmm0, ref Vector128<uint> xmm1, in uint src, byte step, int offset)
; location: [7FFDDB010B10h, 7FFDDB010B44h]
...
; location: [7FFDDB010B60h, 7FFDDB010DD6h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
