; 2019-12-18 17:17:40:955
; function: byte pack_8(ConstBlock64<byte> src)
; location: [7FF7C6A54900h, 7FF7C6A5491Fh]
...
; location: [7FF7C6A54940h, 7FF7C6A54958h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h mov rax,[rcx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 01
...
; location: [7FF7C6A54970h, 7FF7C6A54988h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h mov rax,[rcx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 01
...
; location: [7FF7C6A551B0h, 7FF7C6A551EAh]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h mov rax,[rcx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 01
...
; location: [7FF7C6A55610h, 7FF7C6A55643h]
...
002eh call 7FF7C62ED298h            ; CALL(Call_rel32_64) [FFFFFFFFFF897C88h:jmp64]        encoding(5 bytes) = e8 55 7c 89 ff
0033h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> unpack_8Bytes => new byte[52]{0x48,0x83,0xEC,0x28,0x90,0x0F,0xB6,0xC1,0x8B,0x4A,0x08,0x48,0x83,0xF9,0x08,0x72,0x1D,0x48,0x8B,0x12,0x0F,0xB6,0xC0,0x48,0xB9,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0xC4,0xE2,0xFB,0xF5,0xC1,0x48,0x89,0x02,0x48,0x83,0xC4,0x28,0xC3,0xE8,0x55,0x7C,0x89,0xFF,0xCC};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void unpack_16(ushort src, Block128<byte> dst)
; location: [7FF7C6A55660h, 7FF7C6A556A8h]
0000h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0004h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
...
0043h call 7FF7C62ED298h            ; CALL(Call_rel32_64) [FFFFFFFFFF897C38h:jmp64]        encoding(5 bytes) = e8 f0 7b 89 ff
0048h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> unpack_16Bytes => new byte[73]{0x48,0x83,0xEC,0x28,0x90,0x0F,0xB7,0xC1,0x8B,0x4A,0x08,0x48,0x83,0xF9,0x10,0x72,0x32,0x48,0x8B,0x12,0x0F,0xB7,0xC0,0x0F,0xB6,0xC8,0x49,0xB8,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0xC4,0xC2,0xF3,0xF5,0xC8,0x48,0x89,0x0A,0x48,0x83,0xC2,0x08,0xC1,0xF8,0x08,0x0F,0xB6,0xC0,0xC4,0xC2,0xFB,0xF5,0xC0,0x48,0x89,0x02,0x48,0x83,0xC4,0x28,0xC3,0xE8,0xF0,0x7B,0x89,0xFF,0xCC};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void unpack_32(uint src, Block256<byte> dst)
; location: [7FF7C6A55AD0h, 7FF7C6A55B4Ah]
0000h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0004h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
...
0075h call 7FF7C62ED298h            ; CALL(Call_rel32_64) [FFFFFFFFFF8977C8h:jmp64]        encoding(5 bytes) = e8 4e 77 89 ff
007ah int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> unpack_32Bytes => new byte[123]{0x48,0x83,0xEC,0x28,0x90,0x8B,0x42,0x08,0x48,0x83,0xF8,0x20,0x72,0x67,0x48,0x8B,0x02,0x0F,0xB6,0xD1,0x49,0xB8,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0xC4,0xC2,0xEB,0xF5,0xD0,0x48,0x89,0x10,0x48,0x8D,0x50,0x08,0x44,0x8B,0xC1,0x41,0xC1,0xE8,0x08,0x45,0x0F,0xB6,0xC0,0x49,0xB9,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0xC4,0x42,0xBB,0xF5,0xC1,0x4C,0x89,0x02,0x48,0x8D,0x50,0x10,0x44,0x8B,0xC1,0x41,0xC1,0xE8,0x10,0x45,0x0F,0xB6,0xC0,0xC4,0x42,0xBB,0xF5,0xC1,0x4C,0x89,0x02,0x48,0x83,0xC0,0x18,0xC1,0xE9,0x18,0x0F,0xB6,0xD1,0xC4,0xC2,0xEB,0xF5,0xD1,0x48,0x89,0x10,0x48,0x83,0xC4,0x28,0xC3,0xE8,0x4E,0x77,0x89,0xFF,0xCC};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void unpack_64(ulong src, Block512<byte> dst)
; location: [7FF7C6A55F70h, 7FF7C6A56046h]
0000h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0004h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
0005h mov eax,[rdx+8]               ; MOV(Mov_r32_rm32) [EAX,mem(32u,RDX:br,:sr)]          encoding(3 bytes) = 8b 42 08
...
00d1h call 7FF7C62ED298h            ; CALL(Call_rel32_64) [FFFFFFFFFF897328h:jmp64]        encoding(5 bytes) = e8 52 72 89 ff
00d6h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> unpack_64Bytes => new byte[215]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ulong broadcast_8x64(byte pattern)
; location: [7FF7C6A56060h, 7FF7C6A56081h]
...
; location: [7FF7C6A560A0h, 7FF7C6A560C2h]
0000h push rax                      ; PUSH(Push_r64) [RAX]                                 encoding(1 byte ) = 50
0001h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0004h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
