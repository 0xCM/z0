; 2019-12-18 14:56:12:630
; function: byte pack_8(ConstBlock64<byte> src)
; location: [7FF7C6A34840h, 7FF7C6A3485Fh]
...
; location: [7FF7C6A34880h, 7FF7C6A34898h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h mov rax,[rcx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 01
...
; location: [7FF7C6A34CC0h, 7FF7C6A34CD8h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h mov rax,[rcx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 01
...
; location: [7FF7C6A35100h, 7FF7C6A3513Ah]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
0005h mov rax,[rcx]                 ; MOV(Mov_r64_rm64) [RAX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 01
...
; location: [7FF7C6A35560h, 7FF7C6A35593h]
...
002eh call 7FF7C62DD298h            ; CALL(Call_rel32_64) [FFFFFFFFFF8A7D38h:jmp64]        encoding(5 bytes) = e8 05 7d 8a ff
0033h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> unpack_8Bytes => new byte[52]{0x48,0x83,0xEC,0x28,0x90,0x0F,0xB6,0xC1,0x8B,0x4A,0x08,0x48,0x83,0xF9,0x08,0x72,0x1D,0x48,0x8B,0x12,0x0F,0xB6,0xC0,0x48,0xB9,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0xC4,0xE2,0xFB,0xF5,0xC1,0x48,0x89,0x02,0x48,0x83,0xC4,0x28,0xC3,0xE8,0x05,0x7D,0x8A,0xFF,0xCC};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void unpack_16(ushort src, Block128<byte> dst)
; location: [7FF7C6A355B0h, 7FF7C6A355F8h]
0000h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0004h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
...
0043h call 7FF7C62DD298h            ; CALL(Call_rel32_64) [FFFFFFFFFF8A7CE8h:jmp64]        encoding(5 bytes) = e8 a0 7c 8a ff
0048h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> unpack_16Bytes => new byte[73]{0x48,0x83,0xEC,0x28,0x90,0x0F,0xB7,0xC1,0x8B,0x4A,0x08,0x48,0x83,0xF9,0x10,0x72,0x32,0x48,0x8B,0x12,0x0F,0xB7,0xC0,0x0F,0xB6,0xC8,0x49,0xB8,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0xC4,0xC2,0xF3,0xF5,0xC8,0x48,0x89,0x0A,0x48,0x83,0xC2,0x08,0xC1,0xF8,0x08,0x0F,0xB6,0xC0,0xC4,0xC2,0xFB,0xF5,0xC0,0x48,0x89,0x02,0x48,0x83,0xC4,0x28,0xC3,0xE8,0xA0,0x7C,0x8A,0xFF,0xCC};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void unpack_32(uint src, Block256<byte> dst)
; location: [7FF7C6A35A20h, 7FF7C6A35A9Ah]
0000h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0004h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
...
0075h call 7FF7C62DD298h            ; CALL(Call_rel32_64) [FFFFFFFFFF8A7878h:jmp64]        encoding(5 bytes) = e8 fe 77 8a ff
007ah int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> unpack_32Bytes => new byte[123]{0x48,0x83,0xEC,0x28,0x90,0x8B,0x42,0x08,0x48,0x83,0xF8,0x20,0x72,0x67,0x48,0x8B,0x02,0x0F,0xB6,0xD1,0x49,0xB8,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0xC4,0xC2,0xEB,0xF5,0xD0,0x48,0x89,0x10,0x48,0x8D,0x50,0x08,0x44,0x8B,0xC1,0x41,0xC1,0xE8,0x08,0x45,0x0F,0xB6,0xC0,0x49,0xB9,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0xC4,0x42,0xBB,0xF5,0xC1,0x4C,0x89,0x02,0x48,0x8D,0x50,0x10,0x44,0x8B,0xC1,0x41,0xC1,0xE8,0x10,0x45,0x0F,0xB6,0xC0,0xC4,0x42,0xBB,0xF5,0xC1,0x4C,0x89,0x02,0x48,0x83,0xC0,0x18,0xC1,0xE9,0x18,0x0F,0xB6,0xD1,0xC4,0xC2,0xEB,0xF5,0xD1,0x48,0x89,0x10,0x48,0x83,0xC4,0x28,0xC3,0xE8,0xFE,0x77,0x8A,0xFF,0xCC};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void unpack_64(ulong src, Block512<byte> dst)
; location: [7FF7C6A35EC0h, 7FF7C6A35F96h]
0000h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0004h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
0005h mov eax,[rdx+8]               ; MOV(Mov_r32_rm32) [EAX,mem(32u,RDX:br,:sr)]          encoding(3 bytes) = 8b 42 08
...
00d1h call 7FF7C62DD298h            ; CALL(Call_rel32_64) [FFFFFFFFFF8A73D8h:jmp64]        encoding(5 bytes) = e8 02 73 8a ff
00d6h int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> unpack_64Bytes => new byte[215]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ulong broadcast_8x64(byte pattern)
; location: [7FF7C6A35FB0h, 7FF7C6A35FD1h]
...
; location: [7FF7C6A35FF0h, 7FF7C6A36012h]
0000h push rax                      ; PUSH(Push_r64) [RAX]                                 encoding(1 byte ) = 50
0001h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0004h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
