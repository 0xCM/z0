...
; static ReadOnlySpan<byte> charspan_5489Bytes => new byte[86]{0x56,0x48,0x83,0xEC,0x20,0x48,0x8B,0xF1,0x48,0xB9,0xD0,0x18,0x9E,0xC7,0xF7,0x7F,0x00,0x00,0xBA,0x04,0x00,0x00,0x00,0xE8,0xE4,0x18,0x43,0x5F,0x48,0x83,0xC0,0x10,0xBA,0x04,0x00,0x00,0x00,0x48,0x8D,0x48,0x06,0x4C,0x8D,0x40,0x04,0x4C,0x8D,0x48,0x02,0x66,0xC7,0x01,0x35,0x00,0x66,0x41,0xC7,0x00,0x34,0x00,0x66,0x41,0xC7,0x01,0x38,0x00,0x66,0xC7,0x00,0x39,0x00,0x48,0x89,0x06,0x89,0x56,0x08,0x48,0x8B,0xC6,0x48,0x83,0xC4,0x20,0x5E,0xC3};
0000h push rsi                                ; PUSH(Push_r64) [RSI]                       encoding(1 byte ) = 56
0001h sub rsp,20h                             ; SUB(Sub_rm64_imm8) [RSP,20h:imm64]         encoding(4 bytes) = 48 83 ec 20
0005h mov rsi,rcx                             ; MOV(Mov_r64_rm64) [RSI,RCX]                encoding(3 bytes) = 48 8b f1
0008h mov rcx,7FF7C79E18D0h                   ; MOV(Mov_r64_imm64) [RCX,7ff7c79e18d0h:imm64] encoding(10 bytes) = 48 b9 d0 18 9e c7 f7 7f 00 00
0012h mov edx,4                               ; MOV(Mov_r32_imm32) [EDX,4h:imm32]          encoding(5 bytes) = ba 04 00 00 00
0017h call 7FF827266DE0h                      ; CALL(Call_rel32_64) [5F431900h:jmp64]      encoding(5 bytes) = e8 e4 18 43 5f
