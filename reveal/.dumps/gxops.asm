...
; static ReadOnlySpan<byte> eq_monikerBytes => new byte[47]{0x48,0x83,0xEC,0x38,0x33,0xC0,0x48,0x89,0x44,0x24,0x30,0x48,0x89,0x44,0x24,0x28,0xC6,0x44,0x24,0x28,0x00,0x48,0x0F,0xBE,0x4C,0x24,0x28,0x88,0x4C,0x24,0x30,0x48,0x8D,0x4C,0x24,0x30,0xE8,0x47,0xFC,0xFF,0xFF,0x90,0x48,0x83,0xC4,0x38,0xC3};
...
0024h call 7FF7C7E63BD0h                      ; CALL(Call_rel32_64) [FFFFFFFFFFFFFC70h:jmp64] encoding(5 bytes) = e8 47 fc ff ff
...
; static ReadOnlySpan<byte> the_nameBytes => new byte[19]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0x88,0xA1,0xBC,0x61,0xC8,0x01,0x00,0x00,0x48,0x8B,0x00,0xC3};
0000h nop dword ptr [rax+rax]                 ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]        encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,1C861BCA188h                    ; MOV(Mov_r64_imm64) [RAX,1c861bca188h:imm64] encoding(10 bytes) = 48 b8 88 a1 bc 61 c8 01 00 00
