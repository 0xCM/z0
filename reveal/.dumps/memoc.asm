; 2019-11-21 00:45:01:917
; function: N64 get_n64()
; location: [7FFDD9E96F60h, 7FFDD9E96F74h]
...
; location: [7FFDD9E96F90h, 7FFDD9E96FB7h]
...
; location: [7FFDD9E96FD0h, 7FFDD9E96FDAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFDD9E96FF0h, 7FFDD9E96FFAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
