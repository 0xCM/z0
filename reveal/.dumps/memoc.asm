; 2019-11-21 19:28:31:088
; function: N64 get_n64()
; location: [7FFDD9E884B0h, 7FFDD9E884C4h]
...
; location: [7FFDD9E88680h, 7FFDD9E886A7h]
...
; location: [7FFDD9E886C0h, 7FFDD9E886CAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFDD9E886E0h, 7FFDD9E886EAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
