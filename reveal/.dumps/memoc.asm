; 2019-11-21 12:21:38:055
; function: N64 get_n64()
; location: [7FFDD9E684B0h, 7FFDD9E684C4h]
...
; location: [7FFDD9E68690h, 7FFDD9E686B7h]
...
; location: [7FFDD9E686D0h, 7FFDD9E686DAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFDD9E686F0h, 7FFDD9E686FAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
