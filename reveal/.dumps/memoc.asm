; 2019-11-28 20:16:38:413
; function: N64 get_n64()
; location: [7FFDDAF58390h, 7FFDDAF583A4h]
...
; location: [7FFDDAF583C0h, 7FFDDAF583E7h]
...
; location: [7FFDDAF58400h, 7FFDDAF5840Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFDDAF58420h, 7FFDDAF5842Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
