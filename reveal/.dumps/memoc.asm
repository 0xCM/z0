; 2019-11-23 16:56:45:292
; function: N64 get_n64()
; location: [7FFDDAF484A0h, 7FFDDAF484B4h]
...
; location: [7FFDDAF486E0h, 7FFDDAF48707h]
...
; location: [7FFDDAF48720h, 7FFDDAF4872Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFDDAF48740h, 7FFDDAF4874Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
