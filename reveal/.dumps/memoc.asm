; 2019-11-27 21:54:08:703
; function: N64 get_n64()
; location: [7FFDDAF38100h, 7FFDDAF38114h]
...
; location: [7FFDDAF38340h, 7FFDDAF38367h]
...
; location: [7FFDDAF38380h, 7FFDDAF3838Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFDDAF383A0h, 7FFDDAF383AAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
