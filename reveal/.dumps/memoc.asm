; 2019-11-30 01:56:08:922
; function: N64 get_n64()
; location: [7FFDDAF28160h, 7FFDDAF28174h]
...
; location: [7FFDDAF287F0h, 7FFDDAF28817h]
...
; location: [7FFDDAF28830h, 7FFDDAF2883Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFDDAF28850h, 7FFDDAF2885Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
