; 2019-12-03 18:10:50:258
; function: N64 get_n64()
; location: [7FFDDAF28020h, 7FFDDAF28034h]
...
; location: [7FFDDAF284C0h, 7FFDDAF284E7h]
...
; location: [7FFDDAF28500h, 7FFDDAF2850Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFDDAF28520h, 7FFDDAF2852Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
