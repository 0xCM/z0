; 2019-12-05 18:50:57:971
; function: N64 get_n64()
; location: [7FFDDAFE1E70h, 7FFDDAFE1E84h]
...
; location: [7FFDDAFE20C0h, 7FFDDAFE20E7h]
...
; location: [7FFDDAFE2100h, 7FFDDAFE210Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFDDAFE2120h, 7FFDDAFE212Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
