; 2019-11-25 21:05:20:546
; function: N64 get_n64()
; location: [7FFDDAF68600h, 7FFDDAF68614h]
...
; location: [7FFDDAF68840h, 7FFDDAF68867h]
...
; location: [7FFDDAF68880h, 7FFDDAF6888Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFDDAF688A0h, 7FFDDAF688AAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
