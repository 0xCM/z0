; 2019-11-25 01:31:45:862
; function: N64 get_n64()
; location: [7FFDDAF48C20h, 7FFDDAF48C34h]
...
; location: [7FFDDAF48E60h, 7FFDDAF48E87h]
...
; location: [7FFDDAF48EA0h, 7FFDDAF48EAAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFDDAF48EC0h, 7FFDDAF48ECAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
