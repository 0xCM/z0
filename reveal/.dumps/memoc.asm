; 2019-11-20 15:08:31:100
; function: N64 get_n64()
; location: [7FFDD9E87100h, 7FFDD9E87114h]
...
; location: [7FFDD9E87130h, 7FFDD9E87157h]
...
; location: [7FFDD9E87170h, 7FFDD9E8717Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFDD9E87190h, 7FFDD9E8719Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
