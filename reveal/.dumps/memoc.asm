; 2019-11-29 12:55:50:820
; function: N64 get_n64()
; location: [7FFDDAF58240h, 7FFDDAF58254h]
...
; location: [7FFDDAF584C0h, 7FFDDAF584E7h]
...
; location: [7FFDDAF58500h, 7FFDDAF5850Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFDDAF58520h, 7FFDDAF5852Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
