namespace Z0
{
    ...
    {
        public static MethodDisassembly[] GenericMethods(Type declarer, params string[] opnames)
        {
            var open = declarer.Methods().Public().OpenGeneric().Where(m => opnames.Contains(m.Name));
