; 2019-12-17 03:26:33:803
; function: Span<byte> GetBytes(in int src)
; location: [7FF7C630D2A0h, 7FF7C630D2B2h]
...
; location: [7FF7C630D6D0h, 7FF7C630D6E2h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov [rdx],r8                  ; MOV(Mov_rm64_r64) [mem(64u,RDX:br,:sr),R8]           encoding(3 bytes) = 4c 89 02
...
; location: [7FF7C630D700h, 7FF7C630D712h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov [rdx],r8                  ; MOV(Mov_rm64_r64) [mem(64u,RDX:br,:sr),R8]           encoding(3 bytes) = 4c 89 02
0008h mov dword ptr [rdx+8],8       ; MOV(Mov_rm32_imm32) [mem(32u,RDX:br,:sr),8h:imm32]   encoding(7 bytes) = c7 42 08 08 00 00 00
000fh mov rax,rdx                   ; MOV(Mov_r64_rm64) [RAX,RDX]                          encoding(3 bytes) = 48 8b c2
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: N3 nat3()
; location: [7FF7C630DB30h, 7FF7C630DB42h]
...
; location: [7FF7C630DB60h, 7FF7C630DB6Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int natval()
; location: [7FF7C630DB80h, 7FF7C630DB97h]
0000h push rax                      ; PUSH(Push_r64) [RAX]                                 encoding(1 byte ) = 50
...
; location: [7FF7C630DFC0h, 7FF7C630DFCAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C630E3F0h, 7FF7C630E3FAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C630E410h, 7FF7C630E41Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int add()
; location: [7FF7C630E430h, 7FF7C630E459h]
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int sub()
; location: [7FF7C630E880h, 7FF7C630E8A9h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int mul()
; location: [7FF7C630E8C0h, 7FF7C630E8E9h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int div()
; location: [7FF7C630E900h, 7FF7C630E929h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int mod()
; location: [7FF7C630E940h, 7FF7C630E966h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ulong pow2()
; location: [7FF7C630ED90h, 7FF7C630ED9Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ulong sll()
; location: [7FF7C630EDB0h, 7FF7C630EDD9h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ulong srl()
; location: [7FF7C630EDF0h, 7FF7C630EE19h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
; location: [7FF7C630EE30h, 7FF7C630EE7Bh]
...
; location: [7FF7C630EEA0h, 7FF7C630EEEBh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0006h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
...
; location: [7FF7C630EF10h, 7FF7C630EF5Bh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0006h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
...
; location: [7FF7C630EF80h, 7FF7C630EFCBh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0006h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
...
; location: [7FF7C630F3F0h, 7FF7C630F45Ch]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
...
000dh mov rcx,7FF7C64BD280h         ; MOV(Mov_r64_imm64) [RCX,7ff7c64bd280h:imm64]         encoding(10 bytes) = 48 b9 80 d2 4b c6 f7 7f 00 00
0017h call 7FF825E06CB0h            ; CALL(Call_rel32_64) [5FAF78C0h:jmp64]                encoding(5 bytes) = e8 a4 78 af 5f
...
0026h call 7FF825E05DF0h            ; CALL(Call_rel32_64) [5FAF6A00h:jmp64]                encoding(5 bytes) = e8 d5 69 af 5f
002bh mov rcx,7FF7C61CD0A0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c61cd0a0h:imm64]         encoding(10 bytes) = 48 b9 a0 d0 1c c6 f7 7f 00 00
0035h mov [rbx+18h],rcx             ; MOV(Mov_rm64_r64) [mem(64u,RBX:br,:sr),RCX]          encoding(4 bytes) = 48 89 4b 18
0039h mov rcx,7FF7C62FA358h         ; MOV(Mov_r64_imm64) [RCX,7ff7c62fa358h:imm64]         encoding(10 bytes) = 48 b9 58 a3 2f c6 f7 7f 00 00
...
004ah call 7FF7C6306108h            ; CALL(Call_rel32_64) [FFFFFFFFFFFF6D18h:jmp64]        encoding(5 bytes) = e8 c9 6c ff ff
...
; static ReadOnlySpan<byte> ShuffleWithDelegateBytes => new byte[109]{0x57,0x56,0x53,0x48,0x83,0xEC,0x20,0x48,0x8B,0xFA,0x49,0x8B,0xF0,0x48,0xB9,0x80,0xD2,0x4B,0xC6,0xF7,0x7F,0x00,0x00,0xE8,0xA4,0x78,0xAF,0x5F,0x48,0x8B,0xD8,0x48,0x8D,0x4B,0x08,0x48,0x8B,0xD3,0xE8,0xD5,0x69,0xAF,0x5F,0x48,0xB9,0xA0,0xD0,0x1C,0xC6,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4B,0x18,0x48,0xB9,0x58,0xA3,0x2F,0xC6,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4B,0x20,0x48,0x8B,0xCB,0xE8,0xC9,0x6C,0xFF,0xFF,0x48,0x8B,0x4B,0x08,0x48,0x8B,0xD7,0x4C,0x8B,0xC6,0x41,0xB9,0x01,0x00,0x00,0x00,0xFF,0x53,0x18,0x48,0x8B,0xC7,0x48,0x83,0xC4,0x20,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> ShuffleWithReflection()
; location: [7FF7C630F880h, 7FF7C630FA6Ah]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
...
001fh mov rax,887C7849D04Fh         ; MOV(Mov_r64_imm64) [RAX,887c7849d04fh:imm64]         encoding(10 bytes) = 48 b8 4f d0 49 78 7c 88 00 00
...
0079h mov rcx,7FF7C6392798h         ; MOV(Mov_r64_imm64) [RCX,7ff7c6392798h:imm64]         encoding(10 bytes) = 48 b9 98 27 39 c6 f7 7f 00 00
0083h call 7FF825DAEFF0h            ; CALL(Call_rel32_64) [5FA9F770h:jmp64]                encoding(5 bytes) = e8 e8 f6 a9 5f
0088h mov rbx,rax                   ; MOV(Mov_r64_rm64) [RBX,RAX]                          encoding(3 bytes) = 48 8b d8
008bh mov rcx,7FF7C6387788h         ; MOV(Mov_r64_imm64) [RCX,7ff7c6387788h:imm64]         encoding(10 bytes) = 48 b9 88 77 38 c6 f7 7f 00 00
0095h mov edx,2                     ; MOV(Mov_r32_imm32) [EDX,2h:imm32]                    encoding(5 bytes) = ba 02 00 00 00
009ah call 7FF825E06E40h            ; CALL(Call_rel32_64) [5FAF75C0h:jmp64]                encoding(5 bytes) = e8 21 75 af 5f
009fh mov rbp,rax                   ; MOV(Mov_r64_rm64) [RBP,RAX]                          encoding(3 bytes) = 48 8b e8
00a2h mov rcx,7FF7C64BCEA0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c64bcea0h:imm64]         encoding(10 bytes) = 48 b9 a0 ce 4b c6 f7 7f 00 00
00ach call 7FF825DAEFF0h            ; CALL(Call_rel32_64) [5FA9F770h:jmp64]                encoding(5 bytes) = e8 bf f6 a9 5f
...
00b9h call 7FF825E05F10h            ; CALL(Call_rel32_64) [5FAF6690h:jmp64]                encoding(5 bytes) = e8 d2 65 af 5f
00beh mov rcx,7FF7C62C7758h         ; MOV(Mov_r64_imm64) [RCX,7ff7c62c7758h:imm64]         encoding(10 bytes) = 48 b9 58 77 2c c6 f7 7f 00 00
00c8h call 7FF825DAEFF0h            ; CALL(Call_rel32_64) [5FA9F770h:jmp64]                encoding(5 bytes) = e8 a3 f6 a9 5f
...
00d8h call 7FF825E05F10h            ; CALL(Call_rel32_64) [5FAF6690h:jmp64]                encoding(5 bytes) = e8 b3 65 af 5f
...
00f1h mov rdx,19A100030D0h          ; MOV(Mov_r64_imm64) [RDX,19a100030d0h:imm64]          encoding(10 bytes) = 48 ba d0 30 00 10 9a 01 00 00
...
010ah call 7FF7C62F0E78h            ; CALL(Call_rel32_64) [FFFFFFFFFFFE15F8h:jmp64]        encoding(5 bytes) = e8 e9 14 fe ff
010fh mov rbx,rax                   ; MOV(Mov_r64_rm64) [RBX,RAX]                          encoding(3 bytes) = 48 8b d8
0112h mov rcx,7FF7C62C52C0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c62c52c0h:imm64]         encoding(10 bytes) = 48 b9 c0 52 2c c6 f7 7f 00 00
011ch mov edx,2                     ; MOV(Mov_r32_imm32) [EDX,2h:imm32]                    encoding(5 bytes) = ba 02 00 00 00
0121h call 7FF825E06E40h            ; CALL(Call_rel32_64) [5FAF75C0h:jmp64]                encoding(5 bytes) = e8 9a 74 af 5f
0126h mov rbp,rax                   ; MOV(Mov_r64_rm64) [RBP,RAX]                          encoding(3 bytes) = 48 8b e8
0129h mov rcx,7FF7C64BCEA0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c64bcea0h:imm64]         encoding(10 bytes) = 48 b9 a0 ce 4b c6 f7 7f 00 00
0133h call 7FF825E06CB0h            ; CALL(Call_rel32_64) [5FAF7430h:jmp64]                encoding(5 bytes) = e8 f8 72 af 5f
...
0149h call 7FF825E05F10h            ; CALL(Call_rel32_64) [5FAF6690h:jmp64]                encoding(5 bytes) = e8 42 65 af 5f
014eh mov rcx,7FF7C62C7758h         ; MOV(Mov_r64_imm64) [RCX,7ff7c62c7758h:imm64]         encoding(10 bytes) = 48 b9 58 77 2c c6 f7 7f 00 00
0158h call 7FF825E06CB0h            ; CALL(Call_rel32_64) [5FAF7430h:jmp64]                encoding(5 bytes) = e8 d3 72 af 5f
...
016ch call 7FF825E05F10h            ; CALL(Call_rel32_64) [5FAF6690h:jmp64]                encoding(5 bytes) = e8 1f 65 af 5f
...
0195h mov rdx,7FF7C64BCEA0h         ; MOV(Mov_r64_imm64) [RDX,7ff7c64bcea0h:imm64]         encoding(10 bytes) = 48 ba a0 ce 4b c6 f7 7f 00 00
...
01a7h mov rcx,7FF7C64BCEA0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c64bcea0h:imm64]         encoding(10 bytes) = 48 b9 a0 ce 4b c6 f7 7f 00 00
01b1h call 7FF825DD3360h            ; CALL(Call_rel32_64) [5FAC3AE0h:jmp64]                encoding(5 bytes) = e8 2a 39 ac 5f
...
01c2h mov rcx,887C7849D04Fh         ; MOV(Mov_r64_imm64) [RCX,887c7849d04fh:imm64]         encoding(10 bytes) = 48 b9 4f d0 49 78 7c 88 00 00
...
01d3h call 7FF825F31650h            ; CALL(Call_rel32_64) [5FC21DD0h:jmp64]                encoding(5 bytes) = e8 f8 1b c2 5f
...
01e5h call 7FF825F2FDD0h            ; CALL(Call_rel32_64) [5FC20550h:jmp64]                encoding(5 bytes) = e8 66 03 c2 5f
01eah int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> ShuffleWithReflectionBytes => new byte[491]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int Switch14(int x)
; location: [7FF7C630FA90h, 7FF7C630FB60h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
000fh lea rdx,[7FF7C630FB68h]       ; LEA(Lea_r64_m) [RDX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 15 c2 00 00 00
0016h mov edx,[rdx+rax*4]           ; MOV(Mov_r32_rm32) [EDX,mem(32u,RDX:br,:sr)]          encoding(3 bytes) = 8b 14 82
0019h lea rcx,[7FF7C630FA95h]       ; LEA(Lea_r64_m) [RCX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 0d e5 ff ff ff
...
0036h lea rdx,[7FF7C630FBA0h]       ; LEA(Lea_r64_m) [RDX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 15 d3 00 00 00
003dh mov edx,[rdx+rax*4]           ; MOV(Mov_r32_rm32) [EDX,mem(32u,RDX:br,:sr)]          encoding(3 bytes) = 8b 14 82
0040h lea rcx,[7FF7C630FA95h]       ; LEA(Lea_r64_m) [RCX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 0d be ff ff ff
...
; location: [7FF7C630FBD0h, 7FF7C630FC4Ch]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C630FC60h, 7FF7C630FC7Ch]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,19A786AD0E1h          ; MOV(Mov_r64_imm64) [RAX,19a786ad0e1h:imm64]          encoding(10 bytes) = 48 b8 e1 d0 6a 78 9a 01 00 00
...
; static ReadOnlySpan<byte> get_U8DataBytes => new byte[29]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0xE1,0xD0,0x6A,0x78,0x9A,0x01,0x00,0x00,0x48,0x89,0x01,0xC7,0x41,0x08,0x40,0x00,0x00,0x00,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ReadOnlySpan<uint> get_U32Data()
; location: [7FF7C630FC90h, 7FF7C630FCFAh]
...
000bh mov rcx,7FF7C64BF5A8h         ; MOV(Mov_r64_imm64) [RCX,7ff7c64bf5a8h:imm64]         encoding(10 bytes) = 48 b9 a8 f5 4b c6 f7 7f 00 00
0015h mov edx,10h                   ; MOV(Mov_r32_imm32) [EDX,10h:imm32]                   encoding(5 bytes) = ba 10 00 00 00
001ah call 7FF825E06DE0h            ; CALL(Call_rel32_64) [5FAF7150h:jmp64]                encoding(5 bytes) = e8 31 71 af 5f
001fh mov rdx,19A786AD121h          ; MOV(Mov_r64_imm64) [RDX,19a786ad121h:imm64]          encoding(10 bytes) = 48 ba 21 d1 6a 78 9a 01 00 00
...
; location: [7FF7C630FD50h, 7FF7C630FD5Bh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C630FD70h, 7FF7C630FDB0h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h cmp edx,1                     ; CMP(Cmp_rm32_imm8) [EDX,1h:imm32]                    encoding(3 bytes) = 83 fa 01
0008h jne short 0010h               ; JNE(Jne_rel8_64) [10h:jmp64]                         encoding(2 bytes) = 75 06
000ah mov eax,1                     ; MOV(Mov_r32_imm32) [EAX,1h:imm32]                    encoding(5 bytes) = b8 01 00 00 00
...
; location: [7FF7C63105E0h, 7FF7C63105EAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C6310600h, 7FF7C631061Ch]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,19A786AD0E1h          ; MOV(Mov_r64_imm64) [RAX,19a786ad0e1h:imm64]          encoding(10 bytes) = 48 b8 e1 d0 6a 78 9a 01 00 00
...
001ch ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> ReadU8DataBytes => new byte[29]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0xE1,0xD0,0x6A,0x78,0x9A,0x01,0x00,0x00,0x48,0x89,0x02,0xC7,0x42,0x08,0x40,0x00,0x00,0x00,0x48,0x8B,0xC2,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ReadOnlySpan<uint> ReadU32Data(int count)
; location: [7FF7C6310630h, 7FF7C6310642h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rcx,rdx                   ; MOV(Mov_r64_rm64) [RCX,RDX]                          encoding(3 bytes) = 48 8b ca
0008h mov rax,7FF7C630FC90h         ; MOV(Mov_r64_imm64) [RAX,7ff7c630fc90h:imm64]         encoding(10 bytes) = 48 b8 90 fc 30 c6 f7 7f 00 00
0012h jmp rax                       ; JMP(Jmp_rm64) [RAX]                                  encoding(3 bytes) = 48 ff e0
; static ReadOnlySpan<byte> ReadU32DataBytes => new byte[21]{0x0F,0x1F,0x44,0x00,0x00,0x48,0x8B,0xCA,0x48,0xB8,0x90,0xFC,0x30,0xC6,0xF7,0x7F,0x00,0x00,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidReturn()
; location: [7FF7C63109D0h, 7FF7C63109ECh]
0000h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0004h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
0005h mov rcx,19A10003060h          ; MOV(Mov_r64_imm64) [RCX,19a10003060h:imm64]          encoding(10 bytes) = 48 b9 60 30 00 10 9a 01 00 00
000fh mov rcx,[rcx]                 ; MOV(Mov_r64_rm64) [RCX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 09
0012h call 7FF7C63109A0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFFD0h:jmp64]        encoding(5 bytes) = e8 b9 ff ff ff
0017h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
0018h add rsp,28h                   ; ADD(Add_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 c4 28
001ch ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> VoidReturnBytes => new byte[29]{0x48,0x83,0xEC,0x28,0x90,0x48,0xB9,0x60,0x30,0x00,0x10,0x9A,0x01,0x00,0x00,0x48,0x8B,0x09,0xE8,0xB9,0xFF,0xFF,0xFF,0x90,0x48,0x83,0xC4,0x28,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int SizeTest()
; location: [7FF7C6310A10h, 7FF7C6310A1Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C6310A30h, 7FF7C6310A3Fh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,7FF7C63109D0h         ; MOV(Mov_r64_imm64) [RAX,7ff7c63109d0h:imm64]         encoding(10 bytes) = 48 b8 d0 09 31 c6 f7 7f 00 00
000fh jmp rax                       ; JMP(Jmp_rm64) [RAX]                                  encoding(3 bytes) = 48 ff e0
; static ReadOnlySpan<byte> VoidCalls1Bytes => new byte[18]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0xD0,0x09,0x31,0xC6,0xF7,0x7F,0x00,0x00,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidCalls2()
; location: [7FF7C6310A60h, 7FF7C6310A82h]
0000h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0001h sub rsp,20h                   ; SUB(Sub_rm64_imm8) [RSP,20h:imm64]                   encoding(4 bytes) = 48 83 ec 20
...
000bh call 7FF7C63109D0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFF70h:jmp64]        encoding(5 bytes) = e8 60 ff ff ff
0010h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0013h mov rax,7FF7C63109D0h         ; MOV(Mov_r64_imm64) [RAX,7ff7c63109d0h:imm64]         encoding(10 bytes) = 48 b8 d0 09 31 c6 f7 7f 00 00
...
; static ReadOnlySpan<byte> VoidCalls2Bytes => new byte[37]{0x56,0x48,0x83,0xEC,0x20,0x48,0x8B,0xF1,0x48,0x8B,0xCE,0xE8,0x60,0xFF,0xFF,0xFF,0x48,0x8B,0xCE,0x48,0xB8,0xD0,0x09,0x31,0xC6,0xF7,0x7F,0x00,0x00,0x48,0x83,0xC4,0x20,0x5E,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidCalls3()
; location: [7FF7C6310AA0h, 7FF7C6310ACAh]
0000h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0001h sub rsp,20h                   ; SUB(Sub_rm64_imm8) [RSP,20h:imm64]                   encoding(4 bytes) = 48 83 ec 20
0005h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
0008h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
000bh call 7FF7C63109D0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFF30h:jmp64]        encoding(5 bytes) = e8 20 ff ff ff
0010h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0013h call 7FF7C63109D0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFF30h:jmp64]        encoding(5 bytes) = e8 18 ff ff ff
0018h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
001bh mov rax,7FF7C63109D0h         ; MOV(Mov_r64_imm64) [RAX,7ff7c63109d0h:imm64]         encoding(10 bytes) = 48 b8 d0 09 31 c6 f7 7f 00 00
...
; static ReadOnlySpan<byte> VoidCalls3Bytes => new byte[45]{0x56,0x48,0x83,0xEC,0x20,0x48,0x8B,0xF1,0x48,0x8B,0xCE,0xE8,0x20,0xFF,0xFF,0xFF,0x48,0x8B,0xCE,0xE8,0x18,0xFF,0xFF,0xFF,0x48,0x8B,0xCE,0x48,0xB8,0xD0,0x09,0x31,0xC6,0xF7,0x7F,0x00,0x00,0x48,0x83,0xC4,0x20,0x5E,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidCalls4()
; location: [7FF7C6310AF0h, 7FF7C6310B22h]
0000h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0001h sub rsp,20h                   ; SUB(Sub_rm64_imm8) [RSP,20h:imm64]                   encoding(4 bytes) = 48 83 ec 20
0005h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
0008h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
000bh call 7FF7C63109D0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEE0h:jmp64]        encoding(5 bytes) = e8 d0 fe ff ff
0010h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0013h call 7FF7C63109D0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEE0h:jmp64]        encoding(5 bytes) = e8 c8 fe ff ff
0018h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
001bh call 7FF7C63109D0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEE0h:jmp64]        encoding(5 bytes) = e8 c0 fe ff ff
0020h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0023h mov rax,7FF7C63109D0h         ; MOV(Mov_r64_imm64) [RAX,7ff7c63109d0h:imm64]         encoding(10 bytes) = 48 b8 d0 09 31 c6 f7 7f 00 00
...
; location: [7FF7C6310B80h, 7FF7C6310B90h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C6310BB0h, 7FF7C6310C18h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbp                      ; PUSH(Push_r64) [RBP]                                 encoding(1 byte ) = 55
0003h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h mov rcx,7FF7C64E38D8h         ; MOV(Mov_r64_imm64) [RCX,7ff7c64e38d8h:imm64]         encoding(10 bytes) = 48 b9 d8 38 4e c6 f7 7f 00 00
001ah call 7FF825E06CB0h            ; CALL(Call_rel32_64) [5FAF6100h:jmp64]                encoding(5 bytes) = e8 e1 60 af 5f
...
0029h call 7FF825E05DF0h            ; CALL(Call_rel32_64) [5FAF5240h:jmp64]                encoding(5 bytes) = e8 12 52 af 5f
002eh mov rcx,7FF7C61CD0E0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c61cd0e0h:imm64]         encoding(10 bytes) = 48 b9 e0 d0 1c c6 f7 7f 00 00
0038h mov [rbp+18h],rcx             ; MOV(Mov_rm64_r64) [mem(64u,RBP:br,:sr),RCX]          encoding(4 bytes) = 48 89 4d 18
003ch mov rcx,7FF7C6310B80h         ; MOV(Mov_r64_imm64) [RCX,7ff7c6310b80h:imm64]         encoding(10 bytes) = 48 b9 80 0b 31 c6 f7 7f 00 00
...
0056h mov rax,7FF7C6310B40h         ; MOV(Mov_r64_imm64) [RAX,7ff7c6310b40h:imm64]         encoding(10 bytes) = 48 b8 40 0b 31 c6 f7 7f 00 00
...
; static ReadOnlySpan<byte> CallInvokeBinOpBytes => new byte[107]{0x57,0x56,0x55,0x53,0x48,0x83,0xEC,0x28,0x48,0x8B,0xF1,0x8B,0xFA,0x41,0x8B,0xD8,0x48,0xB9,0xD8,0x38,0x4E,0xC6,0xF7,0x7F,0x00,0x00,0xE8,0xE1,0x60,0xAF,0x5F,0x48,0x8B,0xE8,0x48,0x8D,0x4D,0x08,0x48,0x8B,0xD5,0xE8,0x12,0x52,0xAF,0x5F,0x48,0xB9,0xE0,0xD0,0x1C,0xC6,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4D,0x18,0x48,0xB9,0x80,0x0B,0x31,0xC6,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4D,0x20,0x48,0x8B,0xCE,0x48,0x8B,0xD5,0x44,0x8B,0xC7,0x44,0x8B,0xCB,0x48,0xB8,0x40,0x0B,0x31,0xC6,0xF7,0x7F,0x00,0x00,0x48,0x83,0xC4,0x28,0x5B,0x5D,0x5E,0x5F,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int And(int a, int b)
; location: [7FF7C6310C40h, 7FF7C6310C49h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,ecx                   ; MOV(Mov_r32_rm32) [EAX,ECX]                          encoding(2 bytes) = 8b c1
...
; location: [7FF7C6310C60h, 7FF7C6310C69h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,ecx                   ; MOV(Mov_r32_rm32) [EAX,ECX]                          encoding(2 bytes) = 8b c1
...
; location: [7FF7C6310C80h, 7FF7C6310C89h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,ecx                   ; MOV(Mov_r32_rm32) [EAX,ECX]                          encoding(2 bytes) = 8b c1
...
; location: [7FF7C6310CA0h, 7FF7C6310CABh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C6310CC0h, 7FF7C6310CEDh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int Jump()
; location: [7FF7C6310D00h, 7FF7C6310D0Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,7                     ; MOV(Mov_r32_imm32) [EAX,7h:imm32]                    encoding(5 bytes) = b8 07 00 00 00
000ah ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
...
; location: [7FF7C6312930h, 7FF7C6312965h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
...
000ah mov rcx,7FF7C6396C18h         ; MOV(Mov_r64_imm64) [RCX,7ff7c6396c18h:imm64]         encoding(10 bytes) = 48 b9 18 6c 39 c6 f7 7f 00 00
0014h xor edx,edx                   ; XOR(Xor_r32_rm32) [EDX,EDX]                          encoding(2 bytes) = 33 d2
0016h call 7FF825DD1BA0h            ; CALL(Call_rel32_64) [5FABF270h:jmp64]                encoding(5 bytes) = e8 55 f2 ab 5f
001bh mov rax,19A10002D38h          ; MOV(Mov_r64_imm64) [RAX,19a10002d38h:imm64]          encoding(10 bytes) = 48 b8 38 2d 00 10 9a 01 00 00
...
; static ReadOnlySpan<byte> MulBytes => new byte[54]{0x57,0x56,0x48,0x83,0xEC,0x28,0x8B,0xF1,0x8B,0xFA,0x48,0xB9,0x18,0x6C,0x39,0xC6,0xF7,0x7F,0x00,0x00,0x33,0xD2,0xE8,0x55,0xF2,0xAB,0x5F,0x48,0xB8,0x38,0x2D,0x00,0x10,0x9A,0x01,0x00,0x00,0x48,0x8B,0x00,0x8B,0x00,0x0F,0xAF,0xF7,0x8B,0xC6,0x48,0x83,0xC4,0x28,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
