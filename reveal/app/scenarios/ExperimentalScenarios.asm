; 2019-12-20 21:49:16:829
; function: Span<byte> GetBytes(in int src)
; location: [7FF7C774D4A0h, 7FF7C774D4B2h]
...
; location: [7FF7C774D4D0h, 7FF7C774D4E2h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov [rdx],r8                  ; MOV(Mov_rm64_r64) [mem(64u,RDX:br,:sr),R8]           encoding(3 bytes) = 4c 89 02
...
; location: [7FF7C774D500h, 7FF7C774D512h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov [rdx],r8                  ; MOV(Mov_rm64_r64) [mem(64u,RDX:br,:sr),R8]           encoding(3 bytes) = 4c 89 02
0008h mov dword ptr [rdx+8],8       ; MOV(Mov_rm32_imm32) [mem(32u,RDX:br,:sr),8h:imm32]   encoding(7 bytes) = c7 42 08 08 00 00 00
000fh mov rax,rdx                   ; MOV(Mov_r64_rm64) [RAX,RDX]                          encoding(3 bytes) = 48 8b c2
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: N3 nat3()
; location: [7FF7C774D930h, 7FF7C774D942h]
...
; location: [7FF7C774D960h, 7FF7C774D96Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int natval()
; location: [7FF7C774DF10h, 7FF7C774DF27h]
0000h push rax                      ; PUSH(Push_r64) [RAX]                                 encoding(1 byte ) = 50
...
; location: [7FF7C774E350h, 7FF7C774E35Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C774E370h, 7FF7C774E37Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C774E7A0h, 7FF7C774E7AAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int add()
; location: [7FF7C774E7C0h, 7FF7C774E7E9h]
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int sub()
; location: [7FF7C774EC10h, 7FF7C774EC39h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int mul()
; location: [7FF7C774EC50h, 7FF7C774EC79h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int div()
; location: [7FF7C774EC90h, 7FF7C774ECB9h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int mod()
; location: [7FF7C774ECD0h, 7FF7C774ECF6h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ulong pow2()
; location: [7FF7C774ED10h, 7FF7C774ED1Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ulong sll()
; location: [7FF7C774ED30h, 7FF7C774ED59h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ulong srl()
; location: [7FF7C774ED70h, 7FF7C774ED99h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
; location: [7FF7C774F1C0h, 7FF7C774F20Bh]
...
; location: [7FF7C774F230h, 7FF7C774F27Bh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0006h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
...
; location: [7FF7C774F2A0h, 7FF7C774F2EBh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0006h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
...
; location: [7FF7C774F310h, 7FF7C774F35Bh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0006h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
...
; location: [7FF7C774F380h, 7FF7C774F3ECh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
...
000dh mov rcx,7FF7C78FDA40h         ; MOV(Mov_r64_imm64) [RCX,7ff7c78fda40h:imm64]         encoding(10 bytes) = 48 b9 40 da 8f c7 f7 7f 00 00
0017h call 7FF827266CB0h            ; CALL(Call_rel32_64) [5FB17930h:jmp64]                encoding(5 bytes) = e8 14 79 b1 5f
...
0026h call 7FF827265DF0h            ; CALL(Call_rel32_64) [5FB16A70h:jmp64]                encoding(5 bytes) = e8 45 6a b1 5f
...
004ah call 7FF7C7746070h            ; CALL(Call_rel32_64) [FFFFFFFFFFFF6CF0h:jmp64]        encoding(5 bytes) = e8 a1 6c ff ff
...
; static ReadOnlySpan<byte> ShuffleWithDelegateBytes => new byte[109]{0x57,0x56,0x53,0x48,0x83,0xEC,0x20,0x48,0x8B,0xFA,0x49,0x8B,0xF0,0x48,0xB9,0x40,0xDA,0x8F,0xC7,0xF7,0x7F,0x00,0x00,0xE8,0x14,0x79,0xB1,0x5F,0x48,0x8B,0xD8,0x48,0x8D,0x4B,0x08,0x48,0x8B,0xD3,0xE8,0x45,0x6A,0xB1,0x5F,0x48,0xB9,0xA0,0xD0,0x60,0xC7,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4B,0x18,0x48,0xB9,0x58,0xA3,0x73,0xC7,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4B,0x20,0x48,0x8B,0xCB,0xE8,0xA1,0x6C,0xFF,0xFF,0x48,0x8B,0x4B,0x08,0x48,0x8B,0xD7,0x4C,0x8B,0xC6,0x41,0xB9,0x01,0x00,0x00,0x00,0xFF,0x53,0x18,0x48,0x8B,0xC7,0x48,0x83,0xC4,0x20,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> ShuffleWithReflection()
; location: [7FF7C774F810h, 7FF7C774F9FAh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
...
001fh mov rax,8087BE20E28h          ; MOV(Mov_r64_imm64) [RAX,8087be20e28h:imm64]          encoding(10 bytes) = 48 b8 28 0e e2 7b 08 08 00 00
...
0083h call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5FABF7E0h:jmp64]                encoding(5 bytes) = e8 58 f7 ab 5f
...
009ah call 7FF827266E40h            ; CALL(Call_rel32_64) [5FB17630h:jmp64]                encoding(5 bytes) = e8 91 75 b1 5f
009fh mov rbp,rax                   ; MOV(Mov_r64_rm64) [RBP,RAX]                          encoding(3 bytes) = 48 8b e8
00a2h mov rcx,7FF7C78FD660h         ; MOV(Mov_r64_imm64) [RCX,7ff7c78fd660h:imm64]         encoding(10 bytes) = 48 b9 60 d6 8f c7 f7 7f 00 00
00ach call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5FABF7E0h:jmp64]                encoding(5 bytes) = e8 2f f7 ab 5f
...
00b9h call 7FF827265F10h            ; CALL(Call_rel32_64) [5FB16700h:jmp64]                encoding(5 bytes) = e8 42 66 b1 5f
00beh mov rcx,7FF7C7707758h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7707758h:imm64]         encoding(10 bytes) = 48 b9 58 77 70 c7 f7 7f 00 00
00c8h call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5FABF7E0h:jmp64]                encoding(5 bytes) = e8 13 f7 ab 5f
...
00d8h call 7FF827265F10h            ; CALL(Call_rel32_64) [5FB16700h:jmp64]                encoding(5 bytes) = e8 23 66 b1 5f
...
00f1h mov rdx,213100030D0h          ; MOV(Mov_r64_imm64) [RDX,213100030d0h:imm64]          encoding(10 bytes) = 48 ba d0 30 00 10 13 02 00 00
...
010ah call 7FF7C7730E78h            ; CALL(Call_rel32_64) [FFFFFFFFFFFE1668h:jmp64]        encoding(5 bytes) = e8 59 15 fe ff
...
0121h call 7FF827266E40h            ; CALL(Call_rel32_64) [5FB17630h:jmp64]                encoding(5 bytes) = e8 0a 75 b1 5f
0126h mov rbp,rax                   ; MOV(Mov_r64_rm64) [RBP,RAX]                          encoding(3 bytes) = 48 8b e8
0129h mov rcx,7FF7C78FD660h         ; MOV(Mov_r64_imm64) [RCX,7ff7c78fd660h:imm64]         encoding(10 bytes) = 48 b9 60 d6 8f c7 f7 7f 00 00
0133h call 7FF827266CB0h            ; CALL(Call_rel32_64) [5FB174A0h:jmp64]                encoding(5 bytes) = e8 68 73 b1 5f
...
0149h call 7FF827265F10h            ; CALL(Call_rel32_64) [5FB16700h:jmp64]                encoding(5 bytes) = e8 b2 65 b1 5f
014eh mov rcx,7FF7C7707758h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7707758h:imm64]         encoding(10 bytes) = 48 b9 58 77 70 c7 f7 7f 00 00
0158h call 7FF827266CB0h            ; CALL(Call_rel32_64) [5FB174A0h:jmp64]                encoding(5 bytes) = e8 43 73 b1 5f
...
016ch call 7FF827265F10h            ; CALL(Call_rel32_64) [5FB16700h:jmp64]                encoding(5 bytes) = e8 8f 65 b1 5f
...
0195h mov rdx,7FF7C78FD660h         ; MOV(Mov_r64_imm64) [RDX,7ff7c78fd660h:imm64]         encoding(10 bytes) = 48 ba 60 d6 8f c7 f7 7f 00 00
...
01a7h mov rcx,7FF7C78FD660h         ; MOV(Mov_r64_imm64) [RCX,7ff7c78fd660h:imm64]         encoding(10 bytes) = 48 b9 60 d6 8f c7 f7 7f 00 00
01b1h call 7FF827233360h            ; CALL(Call_rel32_64) [5FAE3B50h:jmp64]                encoding(5 bytes) = e8 9a 39 ae 5f
...
01c2h mov rcx,8087BE20E28h          ; MOV(Mov_r64_imm64) [RCX,8087be20e28h:imm64]          encoding(10 bytes) = 48 b9 28 0e e2 7b 08 08 00 00
...
01d3h call 7FF827391650h            ; CALL(Call_rel32_64) [5FC41E40h:jmp64]                encoding(5 bytes) = e8 68 1c c4 5f
...
01e5h call 7FF82738FDD0h            ; CALL(Call_rel32_64) [5FC405C0h:jmp64]                encoding(5 bytes) = e8 d6 03 c4 5f
01eah int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> ShuffleWithReflectionBytes => new byte[491]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int Switch14(int x)
; location: [7FF7C774FA20h, 7FF7C774FAF0h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
000fh lea rdx,[7FF7C774FAF8h]       ; LEA(Lea_r64_m) [RDX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 15 c2 00 00 00
0016h mov edx,[rdx+rax*4]           ; MOV(Mov_r32_rm32) [EDX,mem(32u,RDX:br,:sr)]          encoding(3 bytes) = 8b 14 82
0019h lea rcx,[7FF7C774FA25h]       ; LEA(Lea_r64_m) [RCX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 0d e5 ff ff ff
...
0036h lea rdx,[7FF7C774FB30h]       ; LEA(Lea_r64_m) [RDX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 15 d3 00 00 00
003dh mov edx,[rdx+rax*4]           ; MOV(Mov_r32_rm32) [EDX,mem(32u,RDX:br,:sr)]          encoding(3 bytes) = 8b 14 82
0040h lea rcx,[7FF7C774FA25h]       ; LEA(Lea_r64_m) [RCX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 0d be ff ff ff
...
; location: [7FF7C774FB60h, 7FF7C774FBDCh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C774FBF0h, 7FF7C774FC0Ch]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,2136FFECE1Dh          ; MOV(Mov_r64_imm64) [RAX,2136ffece1dh:imm64]          encoding(10 bytes) = 48 b8 1d ce fe 6f 13 02 00 00
...
; static ReadOnlySpan<byte> get_U8DataBytes => new byte[29]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0x1D,0xCE,0xFE,0x6F,0x13,0x02,0x00,0x00,0x48,0x89,0x01,0xC7,0x41,0x08,0x40,0x00,0x00,0x00,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ReadOnlySpan<uint> get_U32Data()
; location: [7FF7C7750030h, 7FF7C775009Ah]
...
000bh mov rcx,7FF7C78FFD68h         ; MOV(Mov_r64_imm64) [RCX,7ff7c78ffd68h:imm64]         encoding(10 bytes) = 48 b9 68 fd 8f c7 f7 7f 00 00
0015h mov edx,10h                   ; MOV(Mov_r32_imm32) [EDX,10h:imm32]                   encoding(5 bytes) = ba 10 00 00 00
001ah call 7FF827266DE0h            ; CALL(Call_rel32_64) [5FB16DB0h:jmp64]                encoding(5 bytes) = e8 91 6d b1 5f
001fh mov rdx,2136FFECE5Dh          ; MOV(Mov_r64_imm64) [RDX,2136ffece5dh:imm64]          encoding(10 bytes) = 48 ba 5d ce fe 6f 13 02 00 00
...
; location: [7FF7C77500F0h, 7FF7C77500FBh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C7750110h, 7FF7C7750150h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h cmp edx,1                     ; CMP(Cmp_rm32_imm8) [EDX,1h:imm32]                    encoding(3 bytes) = 83 fa 01
0008h jne short 0010h               ; JNE(Jne_rel8_64) [10h:jmp64]                         encoding(2 bytes) = 75 06
000ah mov eax,1                     ; MOV(Mov_r32_imm32) [EAX,1h:imm32]                    encoding(5 bytes) = b8 01 00 00 00
...
; location: [7FF7C7750980h, 7FF7C775098Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C77509A0h, 7FF7C77509BCh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,2136FFECE1Dh          ; MOV(Mov_r64_imm64) [RAX,2136ffece1dh:imm64]          encoding(10 bytes) = 48 b8 1d ce fe 6f 13 02 00 00
...
001ch ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> ReadU8DataBytes => new byte[29]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0x1D,0xCE,0xFE,0x6F,0x13,0x02,0x00,0x00,0x48,0x89,0x02,0xC7,0x42,0x08,0x40,0x00,0x00,0x00,0x48,0x8B,0xC2,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ReadOnlySpan<uint> ReadU32Data(int count)
; location: [7FF7C77509D0h, 7FF7C77509E2h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rcx,rdx                   ; MOV(Mov_r64_rm64) [RCX,RDX]                          encoding(3 bytes) = 48 8b ca
0008h mov rax,7FF7C7750030h         ; MOV(Mov_r64_imm64) [RAX,7ff7c7750030h:imm64]         encoding(10 bytes) = 48 b8 30 00 75 c7 f7 7f 00 00
0012h jmp rax                       ; JMP(Jmp_rm64) [RAX]                                  encoding(3 bytes) = 48 ff e0
; static ReadOnlySpan<byte> ReadU32DataBytes => new byte[21]{0x0F,0x1F,0x44,0x00,0x00,0x48,0x8B,0xCA,0x48,0xB8,0x30,0x00,0x75,0xC7,0xF7,0x7F,0x00,0x00,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidReturn()
; location: [7FF7C7750A00h, 7FF7C7750A1Ch]
0000h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0004h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
0005h mov rcx,21310003060h          ; MOV(Mov_r64_imm64) [RCX,21310003060h:imm64]          encoding(10 bytes) = 48 b9 60 30 00 10 13 02 00 00
000fh mov rcx,[rcx]                 ; MOV(Mov_r64_rm64) [RCX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 09
0012h call 7FF7C77508D8h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFED8h:jmp64]        encoding(5 bytes) = e8 c1 fe ff ff
0017h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
0018h add rsp,28h                   ; ADD(Add_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 c4 28
001ch ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> VoidReturnBytes => new byte[29]{0x48,0x83,0xEC,0x28,0x90,0x48,0xB9,0x60,0x30,0x00,0x10,0x13,0x02,0x00,0x00,0x48,0x8B,0x09,0xE8,0xC1,0xFE,0xFF,0xFF,0x90,0x48,0x83,0xC4,0x28,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int SizeTest()
; location: [7FF7C7750A40h, 7FF7C7750A4Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C7750A60h, 7FF7C7750A6Fh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,7FF7C7750A00h         ; MOV(Mov_r64_imm64) [RAX,7ff7c7750a00h:imm64]         encoding(10 bytes) = 48 b8 00 0a 75 c7 f7 7f 00 00
000fh jmp rax                       ; JMP(Jmp_rm64) [RAX]                                  encoding(3 bytes) = 48 ff e0
; static ReadOnlySpan<byte> VoidCalls1Bytes => new byte[18]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0x00,0x0A,0x75,0xC7,0xF7,0x7F,0x00,0x00,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidCalls2()
; location: [7FF7C7750A90h, 7FF7C7750AB2h]
0000h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0001h sub rsp,20h                   ; SUB(Sub_rm64_imm8) [RSP,20h:imm64]                   encoding(4 bytes) = 48 83 ec 20
...
000bh call 7FF7C7750A00h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFF70h:jmp64]        encoding(5 bytes) = e8 60 ff ff ff
0010h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0013h mov rax,7FF7C7750A00h         ; MOV(Mov_r64_imm64) [RAX,7ff7c7750a00h:imm64]         encoding(10 bytes) = 48 b8 00 0a 75 c7 f7 7f 00 00
...
; static ReadOnlySpan<byte> VoidCalls2Bytes => new byte[37]{0x56,0x48,0x83,0xEC,0x20,0x48,0x8B,0xF1,0x48,0x8B,0xCE,0xE8,0x60,0xFF,0xFF,0xFF,0x48,0x8B,0xCE,0x48,0xB8,0x00,0x0A,0x75,0xC7,0xF7,0x7F,0x00,0x00,0x48,0x83,0xC4,0x20,0x5E,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidCalls3()
; location: [7FF7C7750AD0h, 7FF7C7750AFAh]
0000h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0001h sub rsp,20h                   ; SUB(Sub_rm64_imm8) [RSP,20h:imm64]                   encoding(4 bytes) = 48 83 ec 20
0005h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
0008h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
000bh call 7FF7C7750A00h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFF30h:jmp64]        encoding(5 bytes) = e8 20 ff ff ff
0010h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0013h call 7FF7C7750A00h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFF30h:jmp64]        encoding(5 bytes) = e8 18 ff ff ff
0018h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
001bh mov rax,7FF7C7750A00h         ; MOV(Mov_r64_imm64) [RAX,7ff7c7750a00h:imm64]         encoding(10 bytes) = 48 b8 00 0a 75 c7 f7 7f 00 00
...
; static ReadOnlySpan<byte> VoidCalls3Bytes => new byte[45]{0x56,0x48,0x83,0xEC,0x20,0x48,0x8B,0xF1,0x48,0x8B,0xCE,0xE8,0x20,0xFF,0xFF,0xFF,0x48,0x8B,0xCE,0xE8,0x18,0xFF,0xFF,0xFF,0x48,0x8B,0xCE,0x48,0xB8,0x00,0x0A,0x75,0xC7,0xF7,0x7F,0x00,0x00,0x48,0x83,0xC4,0x20,0x5E,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidCalls4()
; location: [7FF7C7750B20h, 7FF7C7750B52h]
0000h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0001h sub rsp,20h                   ; SUB(Sub_rm64_imm8) [RSP,20h:imm64]                   encoding(4 bytes) = 48 83 ec 20
0005h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
0008h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
000bh call 7FF7C7750A00h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEE0h:jmp64]        encoding(5 bytes) = e8 d0 fe ff ff
0010h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0013h call 7FF7C7750A00h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEE0h:jmp64]        encoding(5 bytes) = e8 c8 fe ff ff
0018h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
001bh call 7FF7C7750A00h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEE0h:jmp64]        encoding(5 bytes) = e8 c0 fe ff ff
0020h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0023h mov rax,7FF7C7750A00h         ; MOV(Mov_r64_imm64) [RAX,7ff7c7750a00h:imm64]         encoding(10 bytes) = 48 b8 00 0a 75 c7 f7 7f 00 00
...
; location: [7FF7C7750BB0h, 7FF7C7750BC0h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C7750BE0h, 7FF7C7750C48h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbp                      ; PUSH(Push_r64) [RBP]                                 encoding(1 byte ) = 55
0003h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h mov rcx,7FF7C7924100h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7924100h:imm64]         encoding(10 bytes) = 48 b9 00 41 92 c7 f7 7f 00 00
001ah call 7FF827266CB0h            ; CALL(Call_rel32_64) [5FB160D0h:jmp64]                encoding(5 bytes) = e8 b1 60 b1 5f
...
0029h call 7FF827265DF0h            ; CALL(Call_rel32_64) [5FB15210h:jmp64]                encoding(5 bytes) = e8 e2 51 b1 5f
...
003ch mov rcx,7FF7C7750BB0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7750bb0h:imm64]         encoding(10 bytes) = 48 b9 b0 0b 75 c7 f7 7f 00 00
...
0056h mov rax,7FF7C7750B70h         ; MOV(Mov_r64_imm64) [RAX,7ff7c7750b70h:imm64]         encoding(10 bytes) = 48 b8 70 0b 75 c7 f7 7f 00 00
...
; static ReadOnlySpan<byte> CallInvokeBinOpBytes => new byte[107]{0x57,0x56,0x55,0x53,0x48,0x83,0xEC,0x28,0x48,0x8B,0xF1,0x8B,0xFA,0x41,0x8B,0xD8,0x48,0xB9,0x00,0x41,0x92,0xC7,0xF7,0x7F,0x00,0x00,0xE8,0xB1,0x60,0xB1,0x5F,0x48,0x8B,0xE8,0x48,0x8D,0x4D,0x08,0x48,0x8B,0xD5,0xE8,0xE2,0x51,0xB1,0x5F,0x48,0xB9,0xE0,0xD0,0x60,0xC7,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4D,0x18,0x48,0xB9,0xB0,0x0B,0x75,0xC7,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4D,0x20,0x48,0x8B,0xCE,0x48,0x8B,0xD5,0x44,0x8B,0xC7,0x44,0x8B,0xCB,0x48,0xB8,0x70,0x0B,0x75,0xC7,0xF7,0x7F,0x00,0x00,0x48,0x83,0xC4,0x28,0x5B,0x5D,0x5E,0x5F,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int And(int a, int b)
; location: [7FF7C7750C70h, 7FF7C7750C79h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,ecx                   ; MOV(Mov_r32_rm32) [EAX,ECX]                          encoding(2 bytes) = 8b c1
...
; location: [7FF7C7750C90h, 7FF7C7750C99h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,ecx                   ; MOV(Mov_r32_rm32) [EAX,ECX]                          encoding(2 bytes) = 8b c1
...
; location: [7FF7C7750CB0h, 7FF7C7750CB9h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,ecx                   ; MOV(Mov_r32_rm32) [EAX,ECX]                          encoding(2 bytes) = 8b c1
...
; location: [7FF7C7750CD0h, 7FF7C7750CDBh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C7750CF0h, 7FF7C7750D1Dh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int Jump()
; location: [7FF7C7750D30h, 7FF7C7750D3Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,7                     ; MOV(Mov_r32_imm32) [EAX,7h:imm32]                    encoding(5 bytes) = b8 07 00 00 00
000ah ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
...
; location: [7FF7C7752BC0h, 7FF7C7752BF5h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
...
000ah mov rcx,7FF7C77D6C28h         ; MOV(Mov_r64_imm64) [RCX,7ff7c77d6c28h:imm64]         encoding(10 bytes) = 48 b9 28 6c 7d c7 f7 7f 00 00
0014h xor edx,edx                   ; XOR(Xor_r32_rm32) [EDX,EDX]                          encoding(2 bytes) = 33 d2
0016h call 7FF827231BA0h            ; CALL(Call_rel32_64) [5FADEFE0h:jmp64]                encoding(5 bytes) = e8 c5 ef ad 5f
001bh mov rax,21310002D38h          ; MOV(Mov_r64_imm64) [RAX,21310002d38h:imm64]          encoding(10 bytes) = 48 b8 38 2d 00 10 13 02 00 00
...
; static ReadOnlySpan<byte> MulBytes => new byte[54]{0x57,0x56,0x48,0x83,0xEC,0x28,0x8B,0xF1,0x8B,0xFA,0x48,0xB9,0x28,0x6C,0x7D,0xC7,0xF7,0x7F,0x00,0x00,0x33,0xD2,0xE8,0xC5,0xEF,0xAD,0x5F,0x48,0xB8,0x38,0x2D,0x00,0x10,0x13,0x02,0x00,0x00,0x48,0x8B,0x00,0x8B,0x00,0x0F,0xAF,0xF7,0x8B,0xC6,0x48,0x83,0xC4,0x28,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
