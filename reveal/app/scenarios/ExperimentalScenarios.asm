; 2019-12-16 03:16:40:242
; function: Span<byte> GetBytes(in int src)
; location: [7FF7C62ED430h, 7FF7C62ED442h]
...
; location: [7FF7C62ED460h, 7FF7C62ED472h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov [rdx],r8                  ; MOV(Mov_rm64_r64) [mem(64u,RDX:br,:sr),R8]           encoding(3 bytes) = 4c 89 02
...
; location: [7FF7C62ED490h, 7FF7C62ED4A2h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov [rdx],r8                  ; MOV(Mov_rm64_r64) [mem(64u,RDX:br,:sr),R8]           encoding(3 bytes) = 4c 89 02
0008h mov dword ptr [rdx+8],8       ; MOV(Mov_rm32_imm32) [mem(32u,RDX:br,:sr),8h:imm32]   encoding(7 bytes) = c7 42 08 08 00 00 00
000fh mov rax,rdx                   ; MOV(Mov_r64_rm64) [RAX,RDX]                          encoding(3 bytes) = 48 8b c2
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: N3 nat3()
; location: [7FF7C62ED8C0h, 7FF7C62ED8D2h]
...
; location: [7FF7C62ED8F0h, 7FF7C62ED8FAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int natval()
; location: [7FF7C62EDEA0h, 7FF7C62EDEB7h]
0000h push rax                      ; PUSH(Push_r64) [RAX]                                 encoding(1 byte ) = 50
...
; location: [7FF7C62EE2E0h, 7FF7C62EE2EAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C62EE300h, 7FF7C62EE30Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C62EE320h, 7FF7C62EE32Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int add()
; location: [7FF7C62EE750h, 7FF7C62EE779h]
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int sub()
; location: [7FF7C62EE790h, 7FF7C62EE7B9h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int mul()
; location: [7FF7C62EE7D0h, 7FF7C62EE7F9h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int div()
; location: [7FF7C62EEC20h, 7FF7C62EEC49h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int mod()
; location: [7FF7C62EEC60h, 7FF7C62EEC86h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ulong pow2()
; location: [7FF7C62EECA0h, 7FF7C62EECAAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ulong sll()
; location: [7FF7C62EECC0h, 7FF7C62EECE9h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ulong srl()
; location: [7FF7C62EED00h, 7FF7C62EED29h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
; location: [7FF7C62EED40h, 7FF7C62EED8Bh]
...
; location: [7FF7C62EEDB0h, 7FF7C62EEDFBh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0006h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
...
; location: [7FF7C62EF220h, 7FF7C62EF26Bh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0006h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
...
; location: [7FF7C62EF290h, 7FF7C62EF2DBh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0006h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
...
; location: [7FF7C62EF300h, 7FF7C62EF36Ch]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
...
000dh mov rcx,7FF7C649D280h         ; MOV(Mov_r64_imm64) [RCX,7ff7c649d280h:imm64]         encoding(10 bytes) = 48 b9 80 d2 49 c6 f7 7f 00 00
0017h call 7FF825E06CB0h            ; CALL(Call_rel32_64) [5FB179B0h:jmp64]                encoding(5 bytes) = e8 94 79 b1 5f
...
0026h call 7FF825E05DF0h            ; CALL(Call_rel32_64) [5FB16AF0h:jmp64]                encoding(5 bytes) = e8 c5 6a b1 5f
002bh mov rcx,7FF7C61AD0A0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c61ad0a0h:imm64]         encoding(10 bytes) = 48 b9 a0 d0 1a c6 f7 7f 00 00
0035h mov [rbx+18h],rcx             ; MOV(Mov_rm64_r64) [mem(64u,RBX:br,:sr),RCX]          encoding(4 bytes) = 48 89 4b 18
0039h mov rcx,7FF7C62DA358h         ; MOV(Mov_r64_imm64) [RCX,7ff7c62da358h:imm64]         encoding(10 bytes) = 48 b9 58 a3 2d c6 f7 7f 00 00
...
004ah call 7FF7C62E6118h            ; CALL(Call_rel32_64) [FFFFFFFFFFFF6E18h:jmp64]        encoding(5 bytes) = e8 c9 6d ff ff
...
; static ReadOnlySpan<byte> ShuffleWithDelegateBytes => new byte[109]{0x57,0x56,0x53,0x48,0x83,0xEC,0x20,0x48,0x8B,0xFA,0x49,0x8B,0xF0,0x48,0xB9,0x80,0xD2,0x49,0xC6,0xF7,0x7F,0x00,0x00,0xE8,0x94,0x79,0xB1,0x5F,0x48,0x8B,0xD8,0x48,0x8D,0x4B,0x08,0x48,0x8B,0xD3,0xE8,0xC5,0x6A,0xB1,0x5F,0x48,0xB9,0xA0,0xD0,0x1A,0xC6,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4B,0x18,0x48,0xB9,0x58,0xA3,0x2D,0xC6,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4B,0x20,0x48,0x8B,0xCB,0xE8,0xC9,0x6D,0xFF,0xFF,0x48,0x8B,0x4B,0x08,0x48,0x8B,0xD7,0x4C,0x8B,0xC6,0x41,0xB9,0x01,0x00,0x00,0x00,0xFF,0x53,0x18,0x48,0x8B,0xC7,0x48,0x83,0xC4,0x20,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> ShuffleWithReflection()
; location: [7FF7C62EF790h, 7FF7C62EF97Ah]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
...
001fh mov rax,1177723B74DEh         ; MOV(Mov_r64_imm64) [RAX,1177723b74deh:imm64]         encoding(10 bytes) = 48 b8 de 74 3b 72 77 11 00 00
...
0079h mov rcx,7FF7C6372798h         ; MOV(Mov_r64_imm64) [RCX,7ff7c6372798h:imm64]         encoding(10 bytes) = 48 b9 98 27 37 c6 f7 7f 00 00
0083h call 7FF825DAEFF0h            ; CALL(Call_rel32_64) [5FABF860h:jmp64]                encoding(5 bytes) = e8 d8 f7 ab 5f
0088h mov rbx,rax                   ; MOV(Mov_r64_rm64) [RBX,RAX]                          encoding(3 bytes) = 48 8b d8
008bh mov rcx,7FF7C6367788h         ; MOV(Mov_r64_imm64) [RCX,7ff7c6367788h:imm64]         encoding(10 bytes) = 48 b9 88 77 36 c6 f7 7f 00 00
0095h mov edx,2                     ; MOV(Mov_r32_imm32) [EDX,2h:imm32]                    encoding(5 bytes) = ba 02 00 00 00
009ah call 7FF825E06E40h            ; CALL(Call_rel32_64) [5FB176B0h:jmp64]                encoding(5 bytes) = e8 11 76 b1 5f
009fh mov rbp,rax                   ; MOV(Mov_r64_rm64) [RBP,RAX]                          encoding(3 bytes) = 48 8b e8
00a2h mov rcx,7FF7C649CEA0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c649cea0h:imm64]         encoding(10 bytes) = 48 b9 a0 ce 49 c6 f7 7f 00 00
00ach call 7FF825DAEFF0h            ; CALL(Call_rel32_64) [5FABF860h:jmp64]                encoding(5 bytes) = e8 af f7 ab 5f
...
00b9h call 7FF825E05F10h            ; CALL(Call_rel32_64) [5FB16780h:jmp64]                encoding(5 bytes) = e8 c2 66 b1 5f
00beh mov rcx,7FF7C62A7758h         ; MOV(Mov_r64_imm64) [RCX,7ff7c62a7758h:imm64]         encoding(10 bytes) = 48 b9 58 77 2a c6 f7 7f 00 00
00c8h call 7FF825DAEFF0h            ; CALL(Call_rel32_64) [5FABF860h:jmp64]                encoding(5 bytes) = e8 93 f7 ab 5f
...
00d8h call 7FF825E05F10h            ; CALL(Call_rel32_64) [5FB16780h:jmp64]                encoding(5 bytes) = e8 a3 66 b1 5f
...
00f1h mov rdx,1B1C1AC30D0h          ; MOV(Mov_r64_imm64) [RDX,1b1c1ac30d0h:imm64]          encoding(10 bytes) = 48 ba d0 30 ac c1 b1 01 00 00
...
010ah call 7FF7C62D0E78h            ; CALL(Call_rel32_64) [FFFFFFFFFFFE16E8h:jmp64]        encoding(5 bytes) = e8 d9 15 fe ff
010fh mov rbx,rax                   ; MOV(Mov_r64_rm64) [RBX,RAX]                          encoding(3 bytes) = 48 8b d8
0112h mov rcx,7FF7C62A52C0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c62a52c0h:imm64]         encoding(10 bytes) = 48 b9 c0 52 2a c6 f7 7f 00 00
011ch mov edx,2                     ; MOV(Mov_r32_imm32) [EDX,2h:imm32]                    encoding(5 bytes) = ba 02 00 00 00
0121h call 7FF825E06E40h            ; CALL(Call_rel32_64) [5FB176B0h:jmp64]                encoding(5 bytes) = e8 8a 75 b1 5f
0126h mov rbp,rax                   ; MOV(Mov_r64_rm64) [RBP,RAX]                          encoding(3 bytes) = 48 8b e8
0129h mov rcx,7FF7C649CEA0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c649cea0h:imm64]         encoding(10 bytes) = 48 b9 a0 ce 49 c6 f7 7f 00 00
0133h call 7FF825E06CB0h            ; CALL(Call_rel32_64) [5FB17520h:jmp64]                encoding(5 bytes) = e8 e8 73 b1 5f
...
0149h call 7FF825E05F10h            ; CALL(Call_rel32_64) [5FB16780h:jmp64]                encoding(5 bytes) = e8 32 66 b1 5f
014eh mov rcx,7FF7C62A7758h         ; MOV(Mov_r64_imm64) [RCX,7ff7c62a7758h:imm64]         encoding(10 bytes) = 48 b9 58 77 2a c6 f7 7f 00 00
0158h call 7FF825E06CB0h            ; CALL(Call_rel32_64) [5FB17520h:jmp64]                encoding(5 bytes) = e8 c3 73 b1 5f
...
016ch call 7FF825E05F10h            ; CALL(Call_rel32_64) [5FB16780h:jmp64]                encoding(5 bytes) = e8 0f 66 b1 5f
...
0195h mov rdx,7FF7C649CEA0h         ; MOV(Mov_r64_imm64) [RDX,7ff7c649cea0h:imm64]         encoding(10 bytes) = 48 ba a0 ce 49 c6 f7 7f 00 00
...
01a7h mov rcx,7FF7C649CEA0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c649cea0h:imm64]         encoding(10 bytes) = 48 b9 a0 ce 49 c6 f7 7f 00 00
01b1h call 7FF825DD3360h            ; CALL(Call_rel32_64) [5FAE3BD0h:jmp64]                encoding(5 bytes) = e8 1a 3a ae 5f
...
01c2h mov rcx,1177723B74DEh         ; MOV(Mov_r64_imm64) [RCX,1177723b74deh:imm64]         encoding(10 bytes) = 48 b9 de 74 3b 72 77 11 00 00
...
01d3h call 7FF825F31650h            ; CALL(Call_rel32_64) [5FC41EC0h:jmp64]                encoding(5 bytes) = e8 e8 1c c4 5f
...
01e5h call 7FF825F2FDD0h            ; CALL(Call_rel32_64) [5FC40640h:jmp64]                encoding(5 bytes) = e8 56 04 c4 5f
01eah int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> ShuffleWithReflectionBytes => new byte[491]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vec256<ulong> perm4x64_256x64(Vec256<ulong> src)
; location: [7FF7C62F2A40h, 7FF7C62F2A78h]
...
; location: [7FF7C62F3000h, 7FF7C62F3053h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
; location: [7FF7C62F3070h, 7FF7C62F3140h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
000fh lea rdx,[7FF7C62F3148h]       ; LEA(Lea_r64_m) [RDX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 15 c2 00 00 00
0016h mov edx,[rdx+rax*4]           ; MOV(Mov_r32_rm32) [EDX,mem(32u,RDX:br,:sr)]          encoding(3 bytes) = 8b 14 82
0019h lea rcx,[7FF7C62F3075h]       ; LEA(Lea_r64_m) [RCX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 0d e5 ff ff ff
...
0036h lea rdx,[7FF7C62F3180h]       ; LEA(Lea_r64_m) [RDX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 15 d3 00 00 00
003dh mov edx,[rdx+rax*4]           ; MOV(Mov_r32_rm32) [EDX,mem(32u,RDX:br,:sr)]          encoding(3 bytes) = 8b 14 82
0040h lea rcx,[7FF7C62F3075h]       ; LEA(Lea_r64_m) [RCX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 0d be ff ff ff
...
; location: [7FF7C62F31B0h, 7FF7C62F322Ch]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C62F3240h, 7FF7C62F325Ch]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,1B1B010D1ADh          ; MOV(Mov_r64_imm64) [RAX,1b1b010d1adh:imm64]          encoding(10 bytes) = 48 b8 ad d1 10 b0 b1 01 00 00
...
; static ReadOnlySpan<byte> get_U8DataBytes => new byte[29]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0xAD,0xD1,0x10,0xB0,0xB1,0x01,0x00,0x00,0x48,0x89,0x01,0xC7,0x41,0x08,0x40,0x00,0x00,0x00,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ReadOnlySpan<uint> get_U32Data()
; location: [7FF7C62F3270h, 7FF7C62F32DAh]
...
000bh mov rcx,7FF7C64C7940h         ; MOV(Mov_r64_imm64) [RCX,7ff7c64c7940h:imm64]         encoding(10 bytes) = 48 b9 40 79 4c c6 f7 7f 00 00
0015h mov edx,10h                   ; MOV(Mov_r32_imm32) [EDX,10h:imm32]                   encoding(5 bytes) = ba 10 00 00 00
001ah call 7FF825E06DE0h            ; CALL(Call_rel32_64) [5FB13B70h:jmp64]                encoding(5 bytes) = e8 51 3b b1 5f
001fh mov rdx,1B1B010D1EDh          ; MOV(Mov_r64_imm64) [RDX,1b1b010d1edh:imm64]          encoding(10 bytes) = 48 ba ed d1 10 b0 b1 01 00 00
...
; location: [7FF7C62F3330h, 7FF7C62F333Bh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C62F3350h, 7FF7C62F3390h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h cmp edx,1                     ; CMP(Cmp_rm32_imm8) [EDX,1h:imm32]                    encoding(3 bytes) = 83 fa 01
0008h jne short 0010h               ; JNE(Jne_rel8_64) [10h:jmp64]                         encoding(2 bytes) = 75 06
000ah mov eax,1                     ; MOV(Mov_r32_imm32) [EAX,1h:imm32]                    encoding(5 bytes) = b8 01 00 00 00
...
; location: [7FF7C62F3BC0h, 7FF7C62F3BCAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C62F3BE0h, 7FF7C62F3BFCh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,1B1B010D1ADh          ; MOV(Mov_r64_imm64) [RAX,1b1b010d1adh:imm64]          encoding(10 bytes) = 48 b8 ad d1 10 b0 b1 01 00 00
...
001ch ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> ReadU8DataBytes => new byte[29]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0xAD,0xD1,0x10,0xB0,0xB1,0x01,0x00,0x00,0x48,0x89,0x02,0xC7,0x42,0x08,0x40,0x00,0x00,0x00,0x48,0x8B,0xC2,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ReadOnlySpan<uint> ReadU32Data(int count)
; location: [7FF7C62F3C10h, 7FF7C62F3C22h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rcx,rdx                   ; MOV(Mov_r64_rm64) [RCX,RDX]                          encoding(3 bytes) = 48 8b ca
0008h mov rax,7FF7C62F3270h         ; MOV(Mov_r64_imm64) [RAX,7ff7c62f3270h:imm64]         encoding(10 bytes) = 48 b8 70 32 2f c6 f7 7f 00 00
0012h jmp rax                       ; JMP(Jmp_rm64) [RAX]                                  encoding(3 bytes) = 48 ff e0
; static ReadOnlySpan<byte> ReadU32DataBytes => new byte[21]{0x0F,0x1F,0x44,0x00,0x00,0x48,0x8B,0xCA,0x48,0xB8,0x70,0x32,0x2F,0xC6,0xF7,0x7F,0x00,0x00,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidReturn()
; location: [7FF7C62F3FB0h, 7FF7C62F3FCCh]
0000h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0004h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
0005h mov rcx,1B1C1AC3060h          ; MOV(Mov_r64_imm64) [RCX,1b1c1ac3060h:imm64]          encoding(10 bytes) = 48 b9 60 30 ac c1 b1 01 00 00
000fh mov rcx,[rcx]                 ; MOV(Mov_r64_rm64) [RCX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 09
0012h call 7FF7C62F3F80h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFFD0h:jmp64]        encoding(5 bytes) = e8 b9 ff ff ff
0017h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
0018h add rsp,28h                   ; ADD(Add_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 c4 28
001ch ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> VoidReturnBytes => new byte[29]{0x48,0x83,0xEC,0x28,0x90,0x48,0xB9,0x60,0x30,0xAC,0xC1,0xB1,0x01,0x00,0x00,0x48,0x8B,0x09,0xE8,0xB9,0xFF,0xFF,0xFF,0x90,0x48,0x83,0xC4,0x28,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int SizeTest()
; location: [7FF7C62F3FF0h, 7FF7C62F3FFAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C62F4010h, 7FF7C62F401Fh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,7FF7C62F3FB0h         ; MOV(Mov_r64_imm64) [RAX,7ff7c62f3fb0h:imm64]         encoding(10 bytes) = 48 b8 b0 3f 2f c6 f7 7f 00 00
000fh jmp rax                       ; JMP(Jmp_rm64) [RAX]                                  encoding(3 bytes) = 48 ff e0
; static ReadOnlySpan<byte> VoidCalls1Bytes => new byte[18]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0xB0,0x3F,0x2F,0xC6,0xF7,0x7F,0x00,0x00,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidCalls2()
; location: [7FF7C62F4040h, 7FF7C62F4062h]
0000h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0001h sub rsp,20h                   ; SUB(Sub_rm64_imm8) [RSP,20h:imm64]                   encoding(4 bytes) = 48 83 ec 20
...
000bh call 7FF7C62F3FB0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFF70h:jmp64]        encoding(5 bytes) = e8 60 ff ff ff
0010h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0013h mov rax,7FF7C62F3FB0h         ; MOV(Mov_r64_imm64) [RAX,7ff7c62f3fb0h:imm64]         encoding(10 bytes) = 48 b8 b0 3f 2f c6 f7 7f 00 00
...
; static ReadOnlySpan<byte> VoidCalls2Bytes => new byte[37]{0x56,0x48,0x83,0xEC,0x20,0x48,0x8B,0xF1,0x48,0x8B,0xCE,0xE8,0x60,0xFF,0xFF,0xFF,0x48,0x8B,0xCE,0x48,0xB8,0xB0,0x3F,0x2F,0xC6,0xF7,0x7F,0x00,0x00,0x48,0x83,0xC4,0x20,0x5E,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidCalls3()
; location: [7FF7C62F4080h, 7FF7C62F40AAh]
0000h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0001h sub rsp,20h                   ; SUB(Sub_rm64_imm8) [RSP,20h:imm64]                   encoding(4 bytes) = 48 83 ec 20
0005h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
0008h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
000bh call 7FF7C62F3FB0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFF30h:jmp64]        encoding(5 bytes) = e8 20 ff ff ff
0010h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0013h call 7FF7C62F3FB0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFF30h:jmp64]        encoding(5 bytes) = e8 18 ff ff ff
0018h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
001bh mov rax,7FF7C62F3FB0h         ; MOV(Mov_r64_imm64) [RAX,7ff7c62f3fb0h:imm64]         encoding(10 bytes) = 48 b8 b0 3f 2f c6 f7 7f 00 00
...
; static ReadOnlySpan<byte> VoidCalls3Bytes => new byte[45]{0x56,0x48,0x83,0xEC,0x20,0x48,0x8B,0xF1,0x48,0x8B,0xCE,0xE8,0x20,0xFF,0xFF,0xFF,0x48,0x8B,0xCE,0xE8,0x18,0xFF,0xFF,0xFF,0x48,0x8B,0xCE,0x48,0xB8,0xB0,0x3F,0x2F,0xC6,0xF7,0x7F,0x00,0x00,0x48,0x83,0xC4,0x20,0x5E,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidCalls4()
; location: [7FF7C62F40D0h, 7FF7C62F4102h]
0000h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0001h sub rsp,20h                   ; SUB(Sub_rm64_imm8) [RSP,20h:imm64]                   encoding(4 bytes) = 48 83 ec 20
0005h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
0008h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
000bh call 7FF7C62F3FB0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEE0h:jmp64]        encoding(5 bytes) = e8 d0 fe ff ff
0010h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0013h call 7FF7C62F3FB0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEE0h:jmp64]        encoding(5 bytes) = e8 c8 fe ff ff
0018h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
001bh call 7FF7C62F3FB0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEE0h:jmp64]        encoding(5 bytes) = e8 c0 fe ff ff
0020h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0023h mov rax,7FF7C62F3FB0h         ; MOV(Mov_r64_imm64) [RAX,7ff7c62f3fb0h:imm64]         encoding(10 bytes) = 48 b8 b0 3f 2f c6 f7 7f 00 00
...
; location: [7FF7C62F4160h, 7FF7C62F4170h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C62F4190h, 7FF7C62F41F8h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbp                      ; PUSH(Push_r64) [RBP]                                 encoding(1 byte ) = 55
0003h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h mov rcx,7FF7C64CBC48h         ; MOV(Mov_r64_imm64) [RCX,7ff7c64cbc48h:imm64]         encoding(10 bytes) = 48 b9 48 bc 4c c6 f7 7f 00 00
001ah call 7FF825E06CB0h            ; CALL(Call_rel32_64) [5FB12B20h:jmp64]                encoding(5 bytes) = e8 01 2b b1 5f
...
0029h call 7FF825E05DF0h            ; CALL(Call_rel32_64) [5FB11C60h:jmp64]                encoding(5 bytes) = e8 32 1c b1 5f
002eh mov rcx,7FF7C61AD0E0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c61ad0e0h:imm64]         encoding(10 bytes) = 48 b9 e0 d0 1a c6 f7 7f 00 00
0038h mov [rbp+18h],rcx             ; MOV(Mov_rm64_r64) [mem(64u,RBP:br,:sr),RCX]          encoding(4 bytes) = 48 89 4d 18
003ch mov rcx,7FF7C62F4160h         ; MOV(Mov_r64_imm64) [RCX,7ff7c62f4160h:imm64]         encoding(10 bytes) = 48 b9 60 41 2f c6 f7 7f 00 00
...
0056h mov rax,7FF7C62F4120h         ; MOV(Mov_r64_imm64) [RAX,7ff7c62f4120h:imm64]         encoding(10 bytes) = 48 b8 20 41 2f c6 f7 7f 00 00
...
; static ReadOnlySpan<byte> CallInvokeBinOpBytes => new byte[107]{0x57,0x56,0x55,0x53,0x48,0x83,0xEC,0x28,0x48,0x8B,0xF1,0x8B,0xFA,0x41,0x8B,0xD8,0x48,0xB9,0x48,0xBC,0x4C,0xC6,0xF7,0x7F,0x00,0x00,0xE8,0x01,0x2B,0xB1,0x5F,0x48,0x8B,0xE8,0x48,0x8D,0x4D,0x08,0x48,0x8B,0xD5,0xE8,0x32,0x1C,0xB1,0x5F,0x48,0xB9,0xE0,0xD0,0x1A,0xC6,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4D,0x18,0x48,0xB9,0x60,0x41,0x2F,0xC6,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4D,0x20,0x48,0x8B,0xCE,0x48,0x8B,0xD5,0x44,0x8B,0xC7,0x44,0x8B,0xCB,0x48,0xB8,0x20,0x41,0x2F,0xC6,0xF7,0x7F,0x00,0x00,0x48,0x83,0xC4,0x28,0x5B,0x5D,0x5E,0x5F,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int And(int a, int b)
; location: [7FF7C62F4220h, 7FF7C62F4229h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,ecx                   ; MOV(Mov_r32_rm32) [EAX,ECX]                          encoding(2 bytes) = 8b c1
...
; location: [7FF7C62F4240h, 7FF7C62F4249h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,ecx                   ; MOV(Mov_r32_rm32) [EAX,ECX]                          encoding(2 bytes) = 8b c1
...
; location: [7FF7C62F4260h, 7FF7C62F4269h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,ecx                   ; MOV(Mov_r32_rm32) [EAX,ECX]                          encoding(2 bytes) = 8b c1
...
; location: [7FF7C62F4280h, 7FF7C62F428Bh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C62F42A0h, 7FF7C62F42CDh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int Jump()
; location: [7FF7C62F42E0h, 7FF7C62F42EAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,7                     ; MOV(Mov_r32_imm32) [EAX,7h:imm32]                    encoding(5 bytes) = b8 07 00 00 00
000ah ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
...
; location: [7FF7C62F6320h, 7FF7C62F6355h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
...
000ah mov rcx,7FF7C6376C18h         ; MOV(Mov_r64_imm64) [RCX,7ff7c6376c18h:imm64]         encoding(10 bytes) = 48 b9 18 6c 37 c6 f7 7f 00 00
0014h xor edx,edx                   ; XOR(Xor_r32_rm32) [EDX,EDX]                          encoding(2 bytes) = 33 d2
0016h call 7FF825DD1BA0h            ; CALL(Call_rel32_64) [5FADB880h:jmp64]                encoding(5 bytes) = e8 65 b8 ad 5f
001bh mov rax,1B1C1AC2D38h          ; MOV(Mov_r64_imm64) [RAX,1b1c1ac2d38h:imm64]          encoding(10 bytes) = 48 b8 38 2d ac c1 b1 01 00 00
...
; static ReadOnlySpan<byte> MulBytes => new byte[54]{0x57,0x56,0x48,0x83,0xEC,0x28,0x8B,0xF1,0x8B,0xFA,0x48,0xB9,0x18,0x6C,0x37,0xC6,0xF7,0x7F,0x00,0x00,0x33,0xD2,0xE8,0x65,0xB8,0xAD,0x5F,0x48,0xB8,0x38,0x2D,0xAC,0xC1,0xB1,0x01,0x00,0x00,0x48,0x8B,0x00,0x8B,0x00,0x0F,0xAF,0xF7,0x8B,0xC6,0x48,0x83,0xC4,0x28,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
