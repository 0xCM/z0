; 2019-12-25 04:41:09:562
; function: Span<byte> GetBytes(in int src)
; location: [7FF7C774D270h, 7FF7C774D282h]
...
; location: [7FF7C774D2A0h, 7FF7C774D2B2h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov [rdx],r8                  ; MOV(Mov_rm64_r64) [mem(64u,RDX:br,:sr),R8]           encoding(3 bytes) = 4c 89 02
...
; location: [7FF7C774D2D0h, 7FF7C774D2E2h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov [rdx],r8                  ; MOV(Mov_rm64_r64) [mem(64u,RDX:br,:sr),R8]           encoding(3 bytes) = 4c 89 02
0008h mov dword ptr [rdx+8],8       ; MOV(Mov_rm32_imm32) [mem(32u,RDX:br,:sr),8h:imm32]   encoding(7 bytes) = c7 42 08 08 00 00 00
000fh mov rax,rdx                   ; MOV(Mov_r64_rm64) [RAX,RDX]                          encoding(3 bytes) = 48 8b c2
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: N3 nat3()
; location: [7FF7C774D700h, 7FF7C774D712h]
...
; location: [7FF7C774D730h, 7FF7C774D73Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int natval()
; location: [7FF7C774DCE0h, 7FF7C774DCF7h]
0000h push rax                      ; PUSH(Push_r64) [RAX]                                 encoding(1 byte ) = 50
...
; location: [7FF7C774E120h, 7FF7C774E12Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C774E140h, 7FF7C774E14Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C774E570h, 7FF7C774E57Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int add()
; location: [7FF7C774E590h, 7FF7C774E5B9h]
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int mul()
; location: [7FF7C774EA20h, 7FF7C774EA49h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int div()
; location: [7FF7C774EA60h, 7FF7C774EA89h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int mod()
; location: [7FF7C774EAA0h, 7FF7C774EAC6h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ulong pow2()
; location: [7FF7C774EAE0h, 7FF7C774EAEAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ulong sll()
; location: [7FF7C774EB00h, 7FF7C774EB29h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ulong srl()
; location: [7FF7C774EB40h, 7FF7C774EB69h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
; location: [7FF7C774EF90h, 7FF7C774EFDBh]
...
; location: [7FF7C774F000h, 7FF7C774F04Bh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0006h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
...
; location: [7FF7C774F070h, 7FF7C774F0BBh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0006h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
...
; location: [7FF7C774F0E0h, 7FF7C774F12Bh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0006h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
...
; location: [7FF7C774F150h, 7FF7C774F1BCh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
...
000dh mov rcx,7FF7C78FD468h         ; MOV(Mov_r64_imm64) [RCX,7ff7c78fd468h:imm64]         encoding(10 bytes) = 48 b9 68 d4 8f c7 f7 7f 00 00
0017h call 7FF827266CB0h            ; CALL(Call_rel32_64) [5FB17B60h:jmp64]                encoding(5 bytes) = e8 44 7b b1 5f
...
0026h call 7FF827265DF0h            ; CALL(Call_rel32_64) [5FB16CA0h:jmp64]                encoding(5 bytes) = e8 75 6c b1 5f
...
004ah call 7FF7C7745EF0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFF6DA0h:jmp64]        encoding(5 bytes) = e8 51 6d ff ff
...
; static ReadOnlySpan<byte> ShuffleWithDelegateBytes => new byte[109]{0x57,0x56,0x53,0x48,0x83,0xEC,0x20,0x48,0x8B,0xFA,0x49,0x8B,0xF0,0x48,0xB9,0x68,0xD4,0x8F,0xC7,0xF7,0x7F,0x00,0x00,0xE8,0x44,0x7B,0xB1,0x5F,0x48,0x8B,0xD8,0x48,0x8D,0x4B,0x08,0x48,0x8B,0xD3,0xE8,0x75,0x6C,0xB1,0x5F,0x48,0xB9,0xA0,0xD0,0x60,0xC7,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4B,0x18,0x48,0xB9,0x58,0xA3,0x73,0xC7,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4B,0x20,0x48,0x8B,0xCB,0xE8,0x51,0x6D,0xFF,0xFF,0x48,0x8B,0x4B,0x08,0x48,0x8B,0xD7,0x4C,0x8B,0xC6,0x41,0xB9,0x01,0x00,0x00,0x00,0xFF,0x53,0x18,0x48,0x8B,0xC7,0x48,0x83,0xC4,0x20,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> ShuffleWithReflection()
; location: [7FF7C774F5E0h, 7FF7C774F7CAh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
...
001fh mov rax,6908B7B1F6A0h         ; MOV(Mov_r64_imm64) [RAX,6908b7b1f6a0h:imm64]         encoding(10 bytes) = 48 b8 a0 f6 b1 b7 08 69 00 00
...
0083h call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5FABFA10h:jmp64]                encoding(5 bytes) = e8 88 f9 ab 5f
...
009ah call 7FF827266E40h            ; CALL(Call_rel32_64) [5FB17860h:jmp64]                encoding(5 bytes) = e8 c1 77 b1 5f
009fh mov rbp,rax                   ; MOV(Mov_r64_rm64) [RBP,RAX]                          encoding(3 bytes) = 48 8b e8
00a2h mov rcx,7FF7C78FD088h         ; MOV(Mov_r64_imm64) [RCX,7ff7c78fd088h:imm64]         encoding(10 bytes) = 48 b9 88 d0 8f c7 f7 7f 00 00
00ach call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5FABFA10h:jmp64]                encoding(5 bytes) = e8 5f f9 ab 5f
...
00b9h call 7FF827265F10h            ; CALL(Call_rel32_64) [5FB16930h:jmp64]                encoding(5 bytes) = e8 72 68 b1 5f
00beh mov rcx,7FF7C7707758h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7707758h:imm64]         encoding(10 bytes) = 48 b9 58 77 70 c7 f7 7f 00 00
00c8h call 7FF82720EFF0h            ; CALL(Call_rel32_64) [5FABFA10h:jmp64]                encoding(5 bytes) = e8 43 f9 ab 5f
...
00d8h call 7FF827265F10h            ; CALL(Call_rel32_64) [5FB16930h:jmp64]                encoding(5 bytes) = e8 53 68 b1 5f
...
00f1h mov rdx,29C100030D0h          ; MOV(Mov_r64_imm64) [RDX,29c100030d0h:imm64]          encoding(10 bytes) = 48 ba d0 30 00 10 9c 02 00 00
...
010ah call 7FF7C7730E78h            ; CALL(Call_rel32_64) [FFFFFFFFFFFE1898h:jmp64]        encoding(5 bytes) = e8 89 17 fe ff
...
0121h call 7FF827266E40h            ; CALL(Call_rel32_64) [5FB17860h:jmp64]                encoding(5 bytes) = e8 3a 77 b1 5f
0126h mov rbp,rax                   ; MOV(Mov_r64_rm64) [RBP,RAX]                          encoding(3 bytes) = 48 8b e8
0129h mov rcx,7FF7C78FD088h         ; MOV(Mov_r64_imm64) [RCX,7ff7c78fd088h:imm64]         encoding(10 bytes) = 48 b9 88 d0 8f c7 f7 7f 00 00
0133h call 7FF827266CB0h            ; CALL(Call_rel32_64) [5FB176D0h:jmp64]                encoding(5 bytes) = e8 98 75 b1 5f
...
0149h call 7FF827265F10h            ; CALL(Call_rel32_64) [5FB16930h:jmp64]                encoding(5 bytes) = e8 e2 67 b1 5f
014eh mov rcx,7FF7C7707758h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7707758h:imm64]         encoding(10 bytes) = 48 b9 58 77 70 c7 f7 7f 00 00
0158h call 7FF827266CB0h            ; CALL(Call_rel32_64) [5FB176D0h:jmp64]                encoding(5 bytes) = e8 73 75 b1 5f
...
016ch call 7FF827265F10h            ; CALL(Call_rel32_64) [5FB16930h:jmp64]                encoding(5 bytes) = e8 bf 67 b1 5f
...
0195h mov rdx,7FF7C78FD088h         ; MOV(Mov_r64_imm64) [RDX,7ff7c78fd088h:imm64]         encoding(10 bytes) = 48 ba 88 d0 8f c7 f7 7f 00 00
...
01a7h mov rcx,7FF7C78FD088h         ; MOV(Mov_r64_imm64) [RCX,7ff7c78fd088h:imm64]         encoding(10 bytes) = 48 b9 88 d0 8f c7 f7 7f 00 00
01b1h call 7FF827233360h            ; CALL(Call_rel32_64) [5FAE3D80h:jmp64]                encoding(5 bytes) = e8 ca 3b ae 5f
...
01c2h mov rcx,6908B7B1F6A0h         ; MOV(Mov_r64_imm64) [RCX,6908b7b1f6a0h:imm64]         encoding(10 bytes) = 48 b9 a0 f6 b1 b7 08 69 00 00
...
01d3h call 7FF827391650h            ; CALL(Call_rel32_64) [5FC42070h:jmp64]                encoding(5 bytes) = e8 98 1e c4 5f
...
01e5h call 7FF82738FDD0h            ; CALL(Call_rel32_64) [5FC407F0h:jmp64]                encoding(5 bytes) = e8 06 06 c4 5f
01eah int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> ShuffleWithReflectionBytes => new byte[491]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int Switch14(int x)
; location: [7FF7C774F7F0h, 7FF7C774F8C0h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
000fh lea rdx,[7FF7C774F8C8h]       ; LEA(Lea_r64_m) [RDX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 15 c2 00 00 00
0016h mov edx,[rdx+rax*4]           ; MOV(Mov_r32_rm32) [EDX,mem(32u,RDX:br,:sr)]          encoding(3 bytes) = 8b 14 82
0019h lea rcx,[7FF7C774F7F5h]       ; LEA(Lea_r64_m) [RCX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 0d e5 ff ff ff
...
0036h lea rdx,[7FF7C774F900h]       ; LEA(Lea_r64_m) [RDX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 15 d3 00 00 00
003dh mov edx,[rdx+rax*4]           ; MOV(Mov_r32_rm32) [EDX,mem(32u,RDX:br,:sr)]          encoding(3 bytes) = 8b 14 82
0040h lea rcx,[7FF7C774F7F5h]       ; LEA(Lea_r64_m) [RCX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 0d be ff ff ff
...
; location: [7FF7C774F930h, 7FF7C774F9ACh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C774F9C0h, 7FF7C774F9DCh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,29C69F5C6E1h          ; MOV(Mov_r64_imm64) [RAX,29c69f5c6e1h:imm64]          encoding(10 bytes) = 48 b8 e1 c6 f5 69 9c 02 00 00
...
; static ReadOnlySpan<byte> get_U8DataBytes => new byte[29]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0xE1,0xC6,0xF5,0x69,0x9C,0x02,0x00,0x00,0x48,0x89,0x01,0xC7,0x41,0x08,0x40,0x00,0x00,0x00,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ReadOnlySpan<uint> get_U32Data()
; location: [7FF7C774FE00h, 7FF7C774FE6Ah]
...
000bh mov rcx,7FF7C78FF790h         ; MOV(Mov_r64_imm64) [RCX,7ff7c78ff790h:imm64]         encoding(10 bytes) = 48 b9 90 f7 8f c7 f7 7f 00 00
0015h mov edx,10h                   ; MOV(Mov_r32_imm32) [EDX,10h:imm32]                   encoding(5 bytes) = ba 10 00 00 00
001ah call 7FF827266DE0h            ; CALL(Call_rel32_64) [5FB16FE0h:jmp64]                encoding(5 bytes) = e8 c1 6f b1 5f
001fh mov rdx,29C69F5C721h          ; MOV(Mov_r64_imm64) [RDX,29c69f5c721h:imm64]          encoding(10 bytes) = 48 ba 21 c7 f5 69 9c 02 00 00
...
; location: [7FF7C774FEC0h, 7FF7C774FECBh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C774FEE0h, 7FF7C774FF20h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h cmp edx,1                     ; CMP(Cmp_rm32_imm8) [EDX,1h:imm32]                    encoding(3 bytes) = 83 fa 01
0008h jne short 0010h               ; JNE(Jne_rel8_64) [10h:jmp64]                         encoding(2 bytes) = 75 06
000ah mov eax,1                     ; MOV(Mov_r32_imm32) [EAX,1h:imm32]                    encoding(5 bytes) = b8 01 00 00 00
...
; location: [7FF7C7750750h, 7FF7C775075Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C7750770h, 7FF7C775078Ch]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,29C69F5C6E1h          ; MOV(Mov_r64_imm64) [RAX,29c69f5c6e1h:imm64]          encoding(10 bytes) = 48 b8 e1 c6 f5 69 9c 02 00 00
...
001ch ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> ReadU8DataBytes => new byte[29]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0xE1,0xC6,0xF5,0x69,0x9C,0x02,0x00,0x00,0x48,0x89,0x02,0xC7,0x42,0x08,0x40,0x00,0x00,0x00,0x48,0x8B,0xC2,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ReadOnlySpan<uint> ReadU32Data(int count)
; location: [7FF7C77507A0h, 7FF7C77507B2h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rcx,rdx                   ; MOV(Mov_r64_rm64) [RCX,RDX]                          encoding(3 bytes) = 48 8b ca
0008h mov rax,7FF7C774FE00h         ; MOV(Mov_r64_imm64) [RAX,7ff7c774fe00h:imm64]         encoding(10 bytes) = 48 b8 00 fe 74 c7 f7 7f 00 00
0012h jmp rax                       ; JMP(Jmp_rm64) [RAX]                                  encoding(3 bytes) = 48 ff e0
; static ReadOnlySpan<byte> ReadU32DataBytes => new byte[21]{0x0F,0x1F,0x44,0x00,0x00,0x48,0x8B,0xCA,0x48,0xB8,0x00,0xFE,0x74,0xC7,0xF7,0x7F,0x00,0x00,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidReturn()
; location: [7FF7C77507D0h, 7FF7C77507ECh]
0000h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0004h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
0005h mov rcx,29C10003060h          ; MOV(Mov_r64_imm64) [RCX,29c10003060h:imm64]          encoding(10 bytes) = 48 b9 60 30 00 10 9c 02 00 00
000fh mov rcx,[rcx]                 ; MOV(Mov_r64_rm64) [RCX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 09
0012h call 7FF7C77506A8h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFED8h:jmp64]        encoding(5 bytes) = e8 c1 fe ff ff
0017h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
0018h add rsp,28h                   ; ADD(Add_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 c4 28
001ch ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> VoidReturnBytes => new byte[29]{0x48,0x83,0xEC,0x28,0x90,0x48,0xB9,0x60,0x30,0x00,0x10,0x9C,0x02,0x00,0x00,0x48,0x8B,0x09,0xE8,0xC1,0xFE,0xFF,0xFF,0x90,0x48,0x83,0xC4,0x28,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int SizeTest()
; location: [7FF7C7750810h, 7FF7C775081Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C7750830h, 7FF7C775083Fh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,7FF7C77507D0h         ; MOV(Mov_r64_imm64) [RAX,7ff7c77507d0h:imm64]         encoding(10 bytes) = 48 b8 d0 07 75 c7 f7 7f 00 00
000fh jmp rax                       ; JMP(Jmp_rm64) [RAX]                                  encoding(3 bytes) = 48 ff e0
; static ReadOnlySpan<byte> VoidCalls1Bytes => new byte[18]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0xD0,0x07,0x75,0xC7,0xF7,0x7F,0x00,0x00,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidCalls2()
; location: [7FF7C7750860h, 7FF7C7750882h]
0000h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0001h sub rsp,20h                   ; SUB(Sub_rm64_imm8) [RSP,20h:imm64]                   encoding(4 bytes) = 48 83 ec 20
...
000bh call 7FF7C77507D0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFF70h:jmp64]        encoding(5 bytes) = e8 60 ff ff ff
0010h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0013h mov rax,7FF7C77507D0h         ; MOV(Mov_r64_imm64) [RAX,7ff7c77507d0h:imm64]         encoding(10 bytes) = 48 b8 d0 07 75 c7 f7 7f 00 00
...
; static ReadOnlySpan<byte> VoidCalls2Bytes => new byte[37]{0x56,0x48,0x83,0xEC,0x20,0x48,0x8B,0xF1,0x48,0x8B,0xCE,0xE8,0x60,0xFF,0xFF,0xFF,0x48,0x8B,0xCE,0x48,0xB8,0xD0,0x07,0x75,0xC7,0xF7,0x7F,0x00,0x00,0x48,0x83,0xC4,0x20,0x5E,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidCalls3()
; location: [7FF7C77508A0h, 7FF7C77508CAh]
0000h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0001h sub rsp,20h                   ; SUB(Sub_rm64_imm8) [RSP,20h:imm64]                   encoding(4 bytes) = 48 83 ec 20
0005h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
0008h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
000bh call 7FF7C77507D0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFF30h:jmp64]        encoding(5 bytes) = e8 20 ff ff ff
0010h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0013h call 7FF7C77507D0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFF30h:jmp64]        encoding(5 bytes) = e8 18 ff ff ff
0018h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
001bh mov rax,7FF7C77507D0h         ; MOV(Mov_r64_imm64) [RAX,7ff7c77507d0h:imm64]         encoding(10 bytes) = 48 b8 d0 07 75 c7 f7 7f 00 00
...
; static ReadOnlySpan<byte> VoidCalls3Bytes => new byte[45]{0x56,0x48,0x83,0xEC,0x20,0x48,0x8B,0xF1,0x48,0x8B,0xCE,0xE8,0x20,0xFF,0xFF,0xFF,0x48,0x8B,0xCE,0xE8,0x18,0xFF,0xFF,0xFF,0x48,0x8B,0xCE,0x48,0xB8,0xD0,0x07,0x75,0xC7,0xF7,0x7F,0x00,0x00,0x48,0x83,0xC4,0x20,0x5E,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidCalls4()
; location: [7FF7C77508F0h, 7FF7C7750922h]
0000h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0001h sub rsp,20h                   ; SUB(Sub_rm64_imm8) [RSP,20h:imm64]                   encoding(4 bytes) = 48 83 ec 20
0005h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
0008h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
000bh call 7FF7C77507D0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEE0h:jmp64]        encoding(5 bytes) = e8 d0 fe ff ff
0010h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0013h call 7FF7C77507D0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEE0h:jmp64]        encoding(5 bytes) = e8 c8 fe ff ff
0018h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
001bh call 7FF7C77507D0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEE0h:jmp64]        encoding(5 bytes) = e8 c0 fe ff ff
0020h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0023h mov rax,7FF7C77507D0h         ; MOV(Mov_r64_imm64) [RAX,7ff7c77507d0h:imm64]         encoding(10 bytes) = 48 b8 d0 07 75 c7 f7 7f 00 00
...
; location: [7FF7C7750980h, 7FF7C7750990h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C77509B0h, 7FF7C7750A18h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbp                      ; PUSH(Push_r64) [RBP]                                 encoding(1 byte ) = 55
0003h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h mov rcx,7FF7C7913AB8h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7913ab8h:imm64]         encoding(10 bytes) = 48 b9 b8 3a 91 c7 f7 7f 00 00
001ah call 7FF827266CB0h            ; CALL(Call_rel32_64) [5FB16300h:jmp64]                encoding(5 bytes) = e8 e1 62 b1 5f
...
0029h call 7FF827265DF0h            ; CALL(Call_rel32_64) [5FB15440h:jmp64]                encoding(5 bytes) = e8 12 54 b1 5f
...
003ch mov rcx,7FF7C7750980h         ; MOV(Mov_r64_imm64) [RCX,7ff7c7750980h:imm64]         encoding(10 bytes) = 48 b9 80 09 75 c7 f7 7f 00 00
...
0056h mov rax,7FF7C7750940h         ; MOV(Mov_r64_imm64) [RAX,7ff7c7750940h:imm64]         encoding(10 bytes) = 48 b8 40 09 75 c7 f7 7f 00 00
...
; static ReadOnlySpan<byte> CallInvokeBinOpBytes => new byte[107]{0x57,0x56,0x55,0x53,0x48,0x83,0xEC,0x28,0x48,0x8B,0xF1,0x8B,0xFA,0x41,0x8B,0xD8,0x48,0xB9,0xB8,0x3A,0x91,0xC7,0xF7,0x7F,0x00,0x00,0xE8,0xE1,0x62,0xB1,0x5F,0x48,0x8B,0xE8,0x48,0x8D,0x4D,0x08,0x48,0x8B,0xD5,0xE8,0x12,0x54,0xB1,0x5F,0x48,0xB9,0xE0,0xD0,0x60,0xC7,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4D,0x18,0x48,0xB9,0x80,0x09,0x75,0xC7,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4D,0x20,0x48,0x8B,0xCE,0x48,0x8B,0xD5,0x44,0x8B,0xC7,0x44,0x8B,0xCB,0x48,0xB8,0x40,0x09,0x75,0xC7,0xF7,0x7F,0x00,0x00,0x48,0x83,0xC4,0x28,0x5B,0x5D,0x5E,0x5F,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int And(int a, int b)
; location: [7FF7C7750A40h, 7FF7C7750A49h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,ecx                   ; MOV(Mov_r32_rm32) [EAX,ECX]                          encoding(2 bytes) = 8b c1
...
; location: [7FF7C7750A60h, 7FF7C7750A69h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,ecx                   ; MOV(Mov_r32_rm32) [EAX,ECX]                          encoding(2 bytes) = 8b c1
...
; location: [7FF7C7750A80h, 7FF7C7750A89h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,ecx                   ; MOV(Mov_r32_rm32) [EAX,ECX]                          encoding(2 bytes) = 8b c1
...
; location: [7FF7C7750AA0h, 7FF7C7750AABh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C7750AC0h, 7FF7C7750AEDh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int Jump()
; location: [7FF7C7750B00h, 7FF7C7750B0Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,7                     ; MOV(Mov_r32_imm32) [EAX,7h:imm32]                    encoding(5 bytes) = b8 07 00 00 00
000ah ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
...
; location: [7FF7C7752890h, 7FF7C77528C5h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
...
000ah mov rcx,7FF7C77D6C30h         ; MOV(Mov_r64_imm64) [RCX,7ff7c77d6c30h:imm64]         encoding(10 bytes) = 48 b9 30 6c 7d c7 f7 7f 00 00
0014h xor edx,edx                   ; XOR(Xor_r32_rm32) [EDX,EDX]                          encoding(2 bytes) = 33 d2
0016h call 7FF827231BA0h            ; CALL(Call_rel32_64) [5FADF310h:jmp64]                encoding(5 bytes) = e8 f5 f2 ad 5f
001bh mov rax,29C10002D38h          ; MOV(Mov_r64_imm64) [RAX,29c10002d38h:imm64]          encoding(10 bytes) = 48 b8 38 2d 00 10 9c 02 00 00
...
; static ReadOnlySpan<byte> MulBytes => new byte[54]{0x57,0x56,0x48,0x83,0xEC,0x28,0x8B,0xF1,0x8B,0xFA,0x48,0xB9,0x30,0x6C,0x7D,0xC7,0xF7,0x7F,0x00,0x00,0x33,0xD2,0xE8,0xF5,0xF2,0xAD,0x5F,0x48,0xB8,0x38,0x2D,0x00,0x10,0x9C,0x02,0x00,0x00,0x48,0x8B,0x00,0x8B,0x00,0x0F,0xAF,0xF7,0x8B,0xC6,0x48,0x83,0xC4,0x28,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
