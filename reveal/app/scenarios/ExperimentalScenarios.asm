; 2019-12-18 14:56:11:273
; function: Span<byte> GetBytes(in int src)
; location: [7FF7C62DD490h, 7FF7C62DD4A2h]
...
; location: [7FF7C62DD8C0h, 7FF7C62DD8D2h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov [rdx],r8                  ; MOV(Mov_rm64_r64) [mem(64u,RDX:br,:sr),R8]           encoding(3 bytes) = 4c 89 02
...
; location: [7FF7C62DD8F0h, 7FF7C62DD902h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov [rdx],r8                  ; MOV(Mov_rm64_r64) [mem(64u,RDX:br,:sr),R8]           encoding(3 bytes) = 4c 89 02
0008h mov dword ptr [rdx+8],8       ; MOV(Mov_rm32_imm32) [mem(32u,RDX:br,:sr),8h:imm32]   encoding(7 bytes) = c7 42 08 08 00 00 00
000fh mov rax,rdx                   ; MOV(Mov_r64_rm64) [RAX,RDX]                          encoding(3 bytes) = 48 8b c2
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: N3 nat3()
; location: [7FF7C62DDD20h, 7FF7C62DDD32h]
...
; location: [7FF7C62DDD50h, 7FF7C62DDD5Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int natval()
; location: [7FF7C62DDD70h, 7FF7C62DDD87h]
0000h push rax                      ; PUSH(Push_r64) [RAX]                                 encoding(1 byte ) = 50
...
; location: [7FF7C62DE1B0h, 7FF7C62DE1BAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C62DE5E0h, 7FF7C62DE5EAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C62DE600h, 7FF7C62DE60Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int add()
; location: [7FF7C62DE620h, 7FF7C62DE649h]
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int sub()
; location: [7FF7C62DEA70h, 7FF7C62DEA99h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int mul()
; location: [7FF7C62DEAB0h, 7FF7C62DEAD9h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int div()
; location: [7FF7C62DEAF0h, 7FF7C62DEB19h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int mod()
; location: [7FF7C62DEB30h, 7FF7C62DEB56h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ulong pow2()
; location: [7FF7C62DEF80h, 7FF7C62DEF8Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ulong sll()
; location: [7FF7C62DEFA0h, 7FF7C62DEFC9h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ulong srl()
; location: [7FF7C62DEFE0h, 7FF7C62DF009h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
; location: [7FF7C62DF020h, 7FF7C62DF06Bh]
...
; location: [7FF7C62DF090h, 7FF7C62DF0DBh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0006h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
...
; location: [7FF7C62DF100h, 7FF7C62DF14Bh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0006h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
...
; location: [7FF7C62DF170h, 7FF7C62DF1BBh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0006h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
...
; location: [7FF7C62DF5E0h, 7FF7C62DF64Ch]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
...
000dh mov rcx,7FF7C648D3B8h         ; MOV(Mov_r64_imm64) [RCX,7ff7c648d3b8h:imm64]         encoding(10 bytes) = 48 b9 b8 d3 48 c6 f7 7f 00 00
0017h call 7FF825E06CB0h            ; CALL(Call_rel32_64) [5FB276D0h:jmp64]                encoding(5 bytes) = e8 b4 76 b2 5f
...
0026h call 7FF825E05DF0h            ; CALL(Call_rel32_64) [5FB26810h:jmp64]                encoding(5 bytes) = e8 e5 67 b2 5f
002bh mov rcx,7FF7C619D0A0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c619d0a0h:imm64]         encoding(10 bytes) = 48 b9 a0 d0 19 c6 f7 7f 00 00
0035h mov [rbx+18h],rcx             ; MOV(Mov_rm64_r64) [mem(64u,RBX:br,:sr),RCX]          encoding(4 bytes) = 48 89 4b 18
0039h mov rcx,7FF7C62CA358h         ; MOV(Mov_r64_imm64) [RCX,7ff7c62ca358h:imm64]         encoding(10 bytes) = 48 b9 58 a3 2c c6 f7 7f 00 00
...
004ah call 7FF7C62D6178h            ; CALL(Call_rel32_64) [FFFFFFFFFFFF6B98h:jmp64]        encoding(5 bytes) = e8 49 6b ff ff
...
; static ReadOnlySpan<byte> ShuffleWithDelegateBytes => new byte[109]{0x57,0x56,0x53,0x48,0x83,0xEC,0x20,0x48,0x8B,0xFA,0x49,0x8B,0xF0,0x48,0xB9,0xB8,0xD3,0x48,0xC6,0xF7,0x7F,0x00,0x00,0xE8,0xB4,0x76,0xB2,0x5F,0x48,0x8B,0xD8,0x48,0x8D,0x4B,0x08,0x48,0x8B,0xD3,0xE8,0xE5,0x67,0xB2,0x5F,0x48,0xB9,0xA0,0xD0,0x19,0xC6,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4B,0x18,0x48,0xB9,0x58,0xA3,0x2C,0xC6,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4B,0x20,0x48,0x8B,0xCB,0xE8,0x49,0x6B,0xFF,0xFF,0x48,0x8B,0x4B,0x08,0x48,0x8B,0xD7,0x4C,0x8B,0xC6,0x41,0xB9,0x01,0x00,0x00,0x00,0xFF,0x53,0x18,0x48,0x8B,0xC7,0x48,0x83,0xC4,0x20,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> ShuffleWithReflection()
; location: [7FF7C62DFA70h, 7FF7C62DFC5Ah]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
...
001fh mov rax,69D439432E3Ah         ; MOV(Mov_r64_imm64) [RAX,69d439432e3ah:imm64]         encoding(10 bytes) = 48 b8 3a 2e 43 39 d4 69 00 00
...
0079h mov rcx,7FF7C6362798h         ; MOV(Mov_r64_imm64) [RCX,7ff7c6362798h:imm64]         encoding(10 bytes) = 48 b9 98 27 36 c6 f7 7f 00 00
0083h call 7FF825DAEFF0h            ; CALL(Call_rel32_64) [5FACF580h:jmp64]                encoding(5 bytes) = e8 f8 f4 ac 5f
0088h mov rbx,rax                   ; MOV(Mov_r64_rm64) [RBX,RAX]                          encoding(3 bytes) = 48 8b d8
008bh mov rcx,7FF7C6357788h         ; MOV(Mov_r64_imm64) [RCX,7ff7c6357788h:imm64]         encoding(10 bytes) = 48 b9 88 77 35 c6 f7 7f 00 00
0095h mov edx,2                     ; MOV(Mov_r32_imm32) [EDX,2h:imm32]                    encoding(5 bytes) = ba 02 00 00 00
009ah call 7FF825E06E40h            ; CALL(Call_rel32_64) [5FB273D0h:jmp64]                encoding(5 bytes) = e8 31 73 b2 5f
009fh mov rbp,rax                   ; MOV(Mov_r64_rm64) [RBP,RAX]                          encoding(3 bytes) = 48 8b e8
00a2h mov rcx,7FF7C648CFD8h         ; MOV(Mov_r64_imm64) [RCX,7ff7c648cfd8h:imm64]         encoding(10 bytes) = 48 b9 d8 cf 48 c6 f7 7f 00 00
00ach call 7FF825DAEFF0h            ; CALL(Call_rel32_64) [5FACF580h:jmp64]                encoding(5 bytes) = e8 cf f4 ac 5f
...
00b9h call 7FF825E05F10h            ; CALL(Call_rel32_64) [5FB264A0h:jmp64]                encoding(5 bytes) = e8 e2 63 b2 5f
00beh mov rcx,7FF7C6297758h         ; MOV(Mov_r64_imm64) [RCX,7ff7c6297758h:imm64]         encoding(10 bytes) = 48 b9 58 77 29 c6 f7 7f 00 00
00c8h call 7FF825DAEFF0h            ; CALL(Call_rel32_64) [5FACF580h:jmp64]                encoding(5 bytes) = e8 b3 f4 ac 5f
...
00d8h call 7FF825E05F10h            ; CALL(Call_rel32_64) [5FB264A0h:jmp64]                encoding(5 bytes) = e8 c3 63 b2 5f
...
00f1h mov rdx,1F45BB730D0h          ; MOV(Mov_r64_imm64) [RDX,1f45bb730d0h:imm64]          encoding(10 bytes) = 48 ba d0 30 b7 5b f4 01 00 00
...
010ah call 7FF7C62C0E78h            ; CALL(Call_rel32_64) [FFFFFFFFFFFE1408h:jmp64]        encoding(5 bytes) = e8 f9 12 fe ff
010fh mov rbx,rax                   ; MOV(Mov_r64_rm64) [RBX,RAX]                          encoding(3 bytes) = 48 8b d8
0112h mov rcx,7FF7C62952C0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c62952c0h:imm64]         encoding(10 bytes) = 48 b9 c0 52 29 c6 f7 7f 00 00
011ch mov edx,2                     ; MOV(Mov_r32_imm32) [EDX,2h:imm32]                    encoding(5 bytes) = ba 02 00 00 00
0121h call 7FF825E06E40h            ; CALL(Call_rel32_64) [5FB273D0h:jmp64]                encoding(5 bytes) = e8 aa 72 b2 5f
0126h mov rbp,rax                   ; MOV(Mov_r64_rm64) [RBP,RAX]                          encoding(3 bytes) = 48 8b e8
0129h mov rcx,7FF7C648CFD8h         ; MOV(Mov_r64_imm64) [RCX,7ff7c648cfd8h:imm64]         encoding(10 bytes) = 48 b9 d8 cf 48 c6 f7 7f 00 00
0133h call 7FF825E06CB0h            ; CALL(Call_rel32_64) [5FB27240h:jmp64]                encoding(5 bytes) = e8 08 71 b2 5f
...
0149h call 7FF825E05F10h            ; CALL(Call_rel32_64) [5FB264A0h:jmp64]                encoding(5 bytes) = e8 52 63 b2 5f
014eh mov rcx,7FF7C6297758h         ; MOV(Mov_r64_imm64) [RCX,7ff7c6297758h:imm64]         encoding(10 bytes) = 48 b9 58 77 29 c6 f7 7f 00 00
0158h call 7FF825E06CB0h            ; CALL(Call_rel32_64) [5FB27240h:jmp64]                encoding(5 bytes) = e8 e3 70 b2 5f
...
016ch call 7FF825E05F10h            ; CALL(Call_rel32_64) [5FB264A0h:jmp64]                encoding(5 bytes) = e8 2f 63 b2 5f
...
0195h mov rdx,7FF7C648CFD8h         ; MOV(Mov_r64_imm64) [RDX,7ff7c648cfd8h:imm64]         encoding(10 bytes) = 48 ba d8 cf 48 c6 f7 7f 00 00
...
01a7h mov rcx,7FF7C648CFD8h         ; MOV(Mov_r64_imm64) [RCX,7ff7c648cfd8h:imm64]         encoding(10 bytes) = 48 b9 d8 cf 48 c6 f7 7f 00 00
01b1h call 7FF825DD3360h            ; CALL(Call_rel32_64) [5FAF38F0h:jmp64]                encoding(5 bytes) = e8 3a 37 af 5f
...
01c2h mov rcx,69D439432E3Ah         ; MOV(Mov_r64_imm64) [RCX,69d439432e3ah:imm64]         encoding(10 bytes) = 48 b9 3a 2e 43 39 d4 69 00 00
...
01d3h call 7FF825F31650h            ; CALL(Call_rel32_64) [5FC51BE0h:jmp64]                encoding(5 bytes) = e8 08 1a c5 5f
...
01e5h call 7FF825F2FDD0h            ; CALL(Call_rel32_64) [5FC50360h:jmp64]                encoding(5 bytes) = e8 76 01 c5 5f
01eah int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> ShuffleWithReflectionBytes => new byte[491]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int Switch14(int x)
; location: [7FF7C62DFC80h, 7FF7C62DFD50h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
000fh lea rdx,[7FF7C62DFD58h]       ; LEA(Lea_r64_m) [RDX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 15 c2 00 00 00
0016h mov edx,[rdx+rax*4]           ; MOV(Mov_r32_rm32) [EDX,mem(32u,RDX:br,:sr)]          encoding(3 bytes) = 8b 14 82
0019h lea rcx,[7FF7C62DFC85h]       ; LEA(Lea_r64_m) [RCX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 0d e5 ff ff ff
...
0036h lea rdx,[7FF7C62DFD90h]       ; LEA(Lea_r64_m) [RDX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 15 d3 00 00 00
003dh mov edx,[rdx+rax*4]           ; MOV(Mov_r32_rm32) [EDX,mem(32u,RDX:br,:sr)]          encoding(3 bytes) = 8b 14 82
0040h lea rcx,[7FF7C62DFC85h]       ; LEA(Lea_r64_m) [RCX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 0d be ff ff ff
...
; location: [7FF7C62DFDC0h, 7FF7C62DFE3Ch]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C62DFE50h, 7FF7C62DFE6Ch]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,1F44BA5D215h          ; MOV(Mov_r64_imm64) [RAX,1f44ba5d215h:imm64]          encoding(10 bytes) = 48 b8 15 d2 a5 4b f4 01 00 00
...
; static ReadOnlySpan<byte> get_U8DataBytes => new byte[29]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0x15,0xD2,0xA5,0x4B,0xF4,0x01,0x00,0x00,0x48,0x89,0x01,0xC7,0x41,0x08,0x40,0x00,0x00,0x00,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ReadOnlySpan<uint> get_U32Data()
; location: [7FF7C62DFE80h, 7FF7C62DFEEAh]
...
000bh mov rcx,7FF7C648F6E0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c648f6e0h:imm64]         encoding(10 bytes) = 48 b9 e0 f6 48 c6 f7 7f 00 00
0015h mov edx,10h                   ; MOV(Mov_r32_imm32) [EDX,10h:imm32]                   encoding(5 bytes) = ba 10 00 00 00
001ah call 7FF825E06DE0h            ; CALL(Call_rel32_64) [5FB26F60h:jmp64]                encoding(5 bytes) = e8 41 6f b2 5f
001fh mov rdx,1F44BA5D255h          ; MOV(Mov_r64_imm64) [RDX,1f44ba5d255h:imm64]          encoding(10 bytes) = 48 ba 55 d2 a5 4b f4 01 00 00
...
; location: [7FF7C62DFF40h, 7FF7C62DFF4Bh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C62DFF60h, 7FF7C62DFFA0h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h cmp edx,1                     ; CMP(Cmp_rm32_imm8) [EDX,1h:imm32]                    encoding(3 bytes) = 83 fa 01
0008h jne short 0010h               ; JNE(Jne_rel8_64) [10h:jmp64]                         encoding(2 bytes) = 75 06
000ah mov eax,1                     ; MOV(Mov_r32_imm32) [EAX,1h:imm32]                    encoding(5 bytes) = b8 01 00 00 00
...
; location: [7FF7C62E07D0h, 7FF7C62E07DAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C62E07F0h, 7FF7C62E080Ch]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,1F44BA5D215h          ; MOV(Mov_r64_imm64) [RAX,1f44ba5d215h:imm64]          encoding(10 bytes) = 48 b8 15 d2 a5 4b f4 01 00 00
...
001ch ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> ReadU8DataBytes => new byte[29]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0x15,0xD2,0xA5,0x4B,0xF4,0x01,0x00,0x00,0x48,0x89,0x02,0xC7,0x42,0x08,0x40,0x00,0x00,0x00,0x48,0x8B,0xC2,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ReadOnlySpan<uint> ReadU32Data(int count)
; location: [7FF7C62E0820h, 7FF7C62E0832h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rcx,rdx                   ; MOV(Mov_r64_rm64) [RCX,RDX]                          encoding(3 bytes) = 48 8b ca
0008h mov rax,7FF7C62DFE80h         ; MOV(Mov_r64_imm64) [RAX,7ff7c62dfe80h:imm64]         encoding(10 bytes) = 48 b8 80 fe 2d c6 f7 7f 00 00
0012h jmp rax                       ; JMP(Jmp_rm64) [RAX]                                  encoding(3 bytes) = 48 ff e0
; static ReadOnlySpan<byte> ReadU32DataBytes => new byte[21]{0x0F,0x1F,0x44,0x00,0x00,0x48,0x8B,0xCA,0x48,0xB8,0x80,0xFE,0x2D,0xC6,0xF7,0x7F,0x00,0x00,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidReturn()
; location: [7FF7C62E0BC0h, 7FF7C62E0BDCh]
0000h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0004h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
0005h mov rcx,1F45BB73060h          ; MOV(Mov_r64_imm64) [RCX,1f45bb73060h:imm64]          encoding(10 bytes) = 48 b9 60 30 b7 5b f4 01 00 00
000fh mov rcx,[rcx]                 ; MOV(Mov_r64_rm64) [RCX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 09
0012h call 7FF7C62E0B90h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFFD0h:jmp64]        encoding(5 bytes) = e8 b9 ff ff ff
0017h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
0018h add rsp,28h                   ; ADD(Add_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 c4 28
001ch ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> VoidReturnBytes => new byte[29]{0x48,0x83,0xEC,0x28,0x90,0x48,0xB9,0x60,0x30,0xB7,0x5B,0xF4,0x01,0x00,0x00,0x48,0x8B,0x09,0xE8,0xB9,0xFF,0xFF,0xFF,0x90,0x48,0x83,0xC4,0x28,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int SizeTest()
; location: [7FF7C62E0C00h, 7FF7C62E0C0Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C62E0C20h, 7FF7C62E0C2Fh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,7FF7C62E0BC0h         ; MOV(Mov_r64_imm64) [RAX,7ff7c62e0bc0h:imm64]         encoding(10 bytes) = 48 b8 c0 0b 2e c6 f7 7f 00 00
000fh jmp rax                       ; JMP(Jmp_rm64) [RAX]                                  encoding(3 bytes) = 48 ff e0
; static ReadOnlySpan<byte> VoidCalls1Bytes => new byte[18]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0xC0,0x0B,0x2E,0xC6,0xF7,0x7F,0x00,0x00,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidCalls2()
; location: [7FF7C62E0C50h, 7FF7C62E0C72h]
0000h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0001h sub rsp,20h                   ; SUB(Sub_rm64_imm8) [RSP,20h:imm64]                   encoding(4 bytes) = 48 83 ec 20
...
000bh call 7FF7C62E0BC0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFF70h:jmp64]        encoding(5 bytes) = e8 60 ff ff ff
0010h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0013h mov rax,7FF7C62E0BC0h         ; MOV(Mov_r64_imm64) [RAX,7ff7c62e0bc0h:imm64]         encoding(10 bytes) = 48 b8 c0 0b 2e c6 f7 7f 00 00
...
; static ReadOnlySpan<byte> VoidCalls2Bytes => new byte[37]{0x56,0x48,0x83,0xEC,0x20,0x48,0x8B,0xF1,0x48,0x8B,0xCE,0xE8,0x60,0xFF,0xFF,0xFF,0x48,0x8B,0xCE,0x48,0xB8,0xC0,0x0B,0x2E,0xC6,0xF7,0x7F,0x00,0x00,0x48,0x83,0xC4,0x20,0x5E,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidCalls3()
; location: [7FF7C62E0C90h, 7FF7C62E0CBAh]
0000h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0001h sub rsp,20h                   ; SUB(Sub_rm64_imm8) [RSP,20h:imm64]                   encoding(4 bytes) = 48 83 ec 20
0005h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
0008h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
000bh call 7FF7C62E0BC0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFF30h:jmp64]        encoding(5 bytes) = e8 20 ff ff ff
0010h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0013h call 7FF7C62E0BC0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFF30h:jmp64]        encoding(5 bytes) = e8 18 ff ff ff
0018h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
001bh mov rax,7FF7C62E0BC0h         ; MOV(Mov_r64_imm64) [RAX,7ff7c62e0bc0h:imm64]         encoding(10 bytes) = 48 b8 c0 0b 2e c6 f7 7f 00 00
...
; static ReadOnlySpan<byte> VoidCalls3Bytes => new byte[45]{0x56,0x48,0x83,0xEC,0x20,0x48,0x8B,0xF1,0x48,0x8B,0xCE,0xE8,0x20,0xFF,0xFF,0xFF,0x48,0x8B,0xCE,0xE8,0x18,0xFF,0xFF,0xFF,0x48,0x8B,0xCE,0x48,0xB8,0xC0,0x0B,0x2E,0xC6,0xF7,0x7F,0x00,0x00,0x48,0x83,0xC4,0x20,0x5E,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidCalls4()
; location: [7FF7C62E0CE0h, 7FF7C62E0D12h]
0000h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0001h sub rsp,20h                   ; SUB(Sub_rm64_imm8) [RSP,20h:imm64]                   encoding(4 bytes) = 48 83 ec 20
0005h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
0008h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
000bh call 7FF7C62E0BC0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEE0h:jmp64]        encoding(5 bytes) = e8 d0 fe ff ff
0010h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0013h call 7FF7C62E0BC0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEE0h:jmp64]        encoding(5 bytes) = e8 c8 fe ff ff
0018h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
001bh call 7FF7C62E0BC0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEE0h:jmp64]        encoding(5 bytes) = e8 c0 fe ff ff
0020h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0023h mov rax,7FF7C62E0BC0h         ; MOV(Mov_r64_imm64) [RAX,7ff7c62e0bc0h:imm64]         encoding(10 bytes) = 48 b8 c0 0b 2e c6 f7 7f 00 00
...
; location: [7FF7C62E0D70h, 7FF7C62E0D80h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C62E0DA0h, 7FF7C62E0E08h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbp                      ; PUSH(Push_r64) [RBP]                                 encoding(1 byte ) = 55
0003h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h mov rcx,7FF7C64B3A08h         ; MOV(Mov_r64_imm64) [RCX,7ff7c64b3a08h:imm64]         encoding(10 bytes) = 48 b9 08 3a 4b c6 f7 7f 00 00
001ah call 7FF825E06CB0h            ; CALL(Call_rel32_64) [5FB25F10h:jmp64]                encoding(5 bytes) = e8 f1 5e b2 5f
...
0029h call 7FF825E05DF0h            ; CALL(Call_rel32_64) [5FB25050h:jmp64]                encoding(5 bytes) = e8 22 50 b2 5f
002eh mov rcx,7FF7C619D0E0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c619d0e0h:imm64]         encoding(10 bytes) = 48 b9 e0 d0 19 c6 f7 7f 00 00
0038h mov [rbp+18h],rcx             ; MOV(Mov_rm64_r64) [mem(64u,RBP:br,:sr),RCX]          encoding(4 bytes) = 48 89 4d 18
003ch mov rcx,7FF7C62E0D70h         ; MOV(Mov_r64_imm64) [RCX,7ff7c62e0d70h:imm64]         encoding(10 bytes) = 48 b9 70 0d 2e c6 f7 7f 00 00
...
0056h mov rax,7FF7C62E0D30h         ; MOV(Mov_r64_imm64) [RAX,7ff7c62e0d30h:imm64]         encoding(10 bytes) = 48 b8 30 0d 2e c6 f7 7f 00 00
...
; static ReadOnlySpan<byte> CallInvokeBinOpBytes => new byte[107]{0x57,0x56,0x55,0x53,0x48,0x83,0xEC,0x28,0x48,0x8B,0xF1,0x8B,0xFA,0x41,0x8B,0xD8,0x48,0xB9,0x08,0x3A,0x4B,0xC6,0xF7,0x7F,0x00,0x00,0xE8,0xF1,0x5E,0xB2,0x5F,0x48,0x8B,0xE8,0x48,0x8D,0x4D,0x08,0x48,0x8B,0xD5,0xE8,0x22,0x50,0xB2,0x5F,0x48,0xB9,0xE0,0xD0,0x19,0xC6,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4D,0x18,0x48,0xB9,0x70,0x0D,0x2E,0xC6,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4D,0x20,0x48,0x8B,0xCE,0x48,0x8B,0xD5,0x44,0x8B,0xC7,0x44,0x8B,0xCB,0x48,0xB8,0x30,0x0D,0x2E,0xC6,0xF7,0x7F,0x00,0x00,0x48,0x83,0xC4,0x28,0x5B,0x5D,0x5E,0x5F,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int And(int a, int b)
; location: [7FF7C62E0E30h, 7FF7C62E0E39h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,ecx                   ; MOV(Mov_r32_rm32) [EAX,ECX]                          encoding(2 bytes) = 8b c1
...
; location: [7FF7C62E0E50h, 7FF7C62E0E59h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,ecx                   ; MOV(Mov_r32_rm32) [EAX,ECX]                          encoding(2 bytes) = 8b c1
...
; location: [7FF7C62E0E70h, 7FF7C62E0E79h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,ecx                   ; MOV(Mov_r32_rm32) [EAX,ECX]                          encoding(2 bytes) = 8b c1
...
; location: [7FF7C62E0E90h, 7FF7C62E0E9Bh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C62E0EB0h, 7FF7C62E0EDDh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int Jump()
; location: [7FF7C62E0EF0h, 7FF7C62E0EFAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,7                     ; MOV(Mov_r32_imm32) [EAX,7h:imm32]                    encoding(5 bytes) = b8 07 00 00 00
000ah ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
...
; location: [7FF7C62E2B20h, 7FF7C62E2B55h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
...
000ah mov rcx,7FF7C6366C20h         ; MOV(Mov_r64_imm64) [RCX,7ff7c6366c20h:imm64]         encoding(10 bytes) = 48 b9 20 6c 36 c6 f7 7f 00 00
0014h xor edx,edx                   ; XOR(Xor_r32_rm32) [EDX,EDX]                          encoding(2 bytes) = 33 d2
0016h call 7FF825DD1BA0h            ; CALL(Call_rel32_64) [5FAEF080h:jmp64]                encoding(5 bytes) = e8 65 f0 ae 5f
001bh mov rax,1F45BB72D38h          ; MOV(Mov_r64_imm64) [RAX,1f45bb72d38h:imm64]          encoding(10 bytes) = 48 b8 38 2d b7 5b f4 01 00 00
...
; static ReadOnlySpan<byte> MulBytes => new byte[54]{0x57,0x56,0x48,0x83,0xEC,0x28,0x8B,0xF1,0x8B,0xFA,0x48,0xB9,0x20,0x6C,0x36,0xC6,0xF7,0x7F,0x00,0x00,0x33,0xD2,0xE8,0x65,0xF0,0xAE,0x5F,0x48,0xB8,0x38,0x2D,0xB7,0x5B,0xF4,0x01,0x00,0x00,0x48,0x8B,0x00,0x8B,0x00,0x0F,0xAF,0xF7,0x8B,0xC6,0x48,0x83,0xC4,0x28,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
