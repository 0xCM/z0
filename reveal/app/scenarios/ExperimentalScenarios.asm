; 2019-12-13 15:23:28:459
; function: Span<byte> GetBytes(in int src)
; location: [7FF7C55ACFF0h, 7FF7C55AD002h]
...
; location: [7FF7C55AD420h, 7FF7C55AD432h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov [rdx],r8                  ; MOV(Mov_rm64_r64) [mem(64u,RDX:br,:sr),R8]           encoding(3 bytes) = 4c 89 02
...
; location: [7FF7C55AD450h, 7FF7C55AD462h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov [rdx],r8                  ; MOV(Mov_rm64_r64) [mem(64u,RDX:br,:sr),R8]           encoding(3 bytes) = 4c 89 02
0008h mov dword ptr [rdx+8],8       ; MOV(Mov_rm32_imm32) [mem(32u,RDX:br,:sr),8h:imm32]   encoding(7 bytes) = c7 42 08 08 00 00 00
000fh mov rax,rdx                   ; MOV(Mov_r64_rm64) [RAX,RDX]                          encoding(3 bytes) = 48 8b c2
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: N3 nat3()
; location: [7FF7C55AD880h, 7FF7C55AD892h]
...
; location: [7FF7C55AD8B0h, 7FF7C55AD8BAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int natval()
; location: [7FF7C55AD8D0h, 7FF7C55AD8E7h]
0000h push rax                      ; PUSH(Push_r64) [RAX]                                 encoding(1 byte ) = 50
...
; location: [7FF7C55ADD10h, 7FF7C55ADD1Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C55AE140h, 7FF7C55AE14Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C55AE160h, 7FF7C55AE16Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int add()
; location: [7FF7C55AE590h, 7FF7C55AE5B9h]
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int sub()
; location: [7FF7C55AE5D0h, 7FF7C55AE5F9h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int mul()
; location: [7FF7C55AE610h, 7FF7C55AE639h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int div()
; location: [7FF7C55AE650h, 7FF7C55AE679h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int mod()
; location: [7FF7C55AE690h, 7FF7C55AE6B6h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ulong pow2()
; location: [7FF7C55AEAE0h, 7FF7C55AEAEAh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ulong sll()
; location: [7FF7C55AEB00h, 7FF7C55AEB29h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ulong srl()
; location: [7FF7C55AEB40h, 7FF7C55AEB69h]
0000h sub rsp,18h                   ; SUB(Sub_rm64_imm8) [RSP,18h:imm64]                   encoding(4 bytes) = 48 83 ec 18
0004h xor eax,eax                   ; XOR(Xor_r32_rm32) [EAX,EAX]                          encoding(2 bytes) = 33 c0
0006h mov [rsp+10h],rax             ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 10
000bh mov [rsp+8],rax               ; MOV(Mov_rm64_r64) [mem(64u,RSP:br,:sr),RAX]          encoding(5 bytes) = 48 89 44 24 08
...
; location: [7FF7C55AEB80h, 7FF7C55AEBCBh]
...
; location: [7FF7C55AEBF0h, 7FF7C55AEC3Bh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0006h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
...
; location: [7FF7C55AEC60h, 7FF7C55AECABh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0006h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
...
; location: [7FF7C55AECD0h, 7FF7C55AED1Bh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0006h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
...
; location: [7FF7C55AF140h, 7FF7C55AF1ACh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
...
000dh mov rcx,7FF7C575C9F8h         ; MOV(Mov_r64_imm64) [RCX,7ff7c575c9f8h:imm64]         encoding(10 bytes) = 48 b9 f8 c9 75 c5 f7 7f 00 00
0017h call 7FF825096CB0h            ; CALL(Call_rel32_64) [5FAE7B70h:jmp64]                encoding(5 bytes) = e8 54 7b ae 5f
...
0026h call 7FF825095DF0h            ; CALL(Call_rel32_64) [5FAE6CB0h:jmp64]                encoding(5 bytes) = e8 85 6c ae 5f
002bh mov rcx,7FF7C546D0A0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c546d0a0h:imm64]         encoding(10 bytes) = 48 b9 a0 d0 46 c5 f7 7f 00 00
0035h mov [rbx+18h],rcx             ; MOV(Mov_rm64_r64) [mem(64u,RBX:br,:sr),RCX]          encoding(4 bytes) = 48 89 4b 18
0039h mov rcx,7FF7C559A358h         ; MOV(Mov_r64_imm64) [RCX,7ff7c559a358h:imm64]         encoding(10 bytes) = 48 b9 58 a3 59 c5 f7 7f 00 00
...
004ah call 7FF7C55A5E68h            ; CALL(Call_rel32_64) [FFFFFFFFFFFF6D28h:jmp64]        encoding(5 bytes) = e8 d9 6c ff ff
...
; static ReadOnlySpan<byte> ShuffleWithDelegateBytes => new byte[109]{0x57,0x56,0x53,0x48,0x83,0xEC,0x20,0x48,0x8B,0xFA,0x49,0x8B,0xF0,0x48,0xB9,0xF8,0xC9,0x75,0xC5,0xF7,0x7F,0x00,0x00,0xE8,0x54,0x7B,0xAE,0x5F,0x48,0x8B,0xD8,0x48,0x8D,0x4B,0x08,0x48,0x8B,0xD3,0xE8,0x85,0x6C,0xAE,0x5F,0x48,0xB9,0xA0,0xD0,0x46,0xC5,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4B,0x18,0x48,0xB9,0x58,0xA3,0x59,0xC5,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4B,0x20,0x48,0x8B,0xCB,0xE8,0xD9,0x6C,0xFF,0xFF,0x48,0x8B,0x4B,0x08,0x48,0x8B,0xD7,0x4C,0x8B,0xC6,0x41,0xB9,0x01,0x00,0x00,0x00,0xFF,0x53,0x18,0x48,0x8B,0xC7,0x48,0x83,0xC4,0x20,0x5B,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vector256<uint> ShuffleWithReflection()
; location: [7FF7C55AF5D0h, 7FF7C55AF7BAh]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
...
001fh mov rax,46256FEEEFB5h         ; MOV(Mov_r64_imm64) [RAX,46256feeefb5h:imm64]         encoding(10 bytes) = 48 b8 b5 ef ee 6f 25 46 00 00
...
0079h mov rcx,7FF7C5632798h         ; MOV(Mov_r64_imm64) [RCX,7ff7c5632798h:imm64]         encoding(10 bytes) = 48 b9 98 27 63 c5 f7 7f 00 00
0083h call 7FF82503EFF0h            ; CALL(Call_rel32_64) [5FA8FA20h:jmp64]                encoding(5 bytes) = e8 98 f9 a8 5f
0088h mov rbx,rax                   ; MOV(Mov_r64_rm64) [RBX,RAX]                          encoding(3 bytes) = 48 8b d8
008bh mov rcx,7FF7C5627788h         ; MOV(Mov_r64_imm64) [RCX,7ff7c5627788h:imm64]         encoding(10 bytes) = 48 b9 88 77 62 c5 f7 7f 00 00
0095h mov edx,2                     ; MOV(Mov_r32_imm32) [EDX,2h:imm32]                    encoding(5 bytes) = ba 02 00 00 00
009ah call 7FF825096E40h            ; CALL(Call_rel32_64) [5FAE7870h:jmp64]                encoding(5 bytes) = e8 d1 77 ae 5f
009fh mov rbp,rax                   ; MOV(Mov_r64_rm64) [RBP,RAX]                          encoding(3 bytes) = 48 8b e8
00a2h mov rcx,7FF7C575C618h         ; MOV(Mov_r64_imm64) [RCX,7ff7c575c618h:imm64]         encoding(10 bytes) = 48 b9 18 c6 75 c5 f7 7f 00 00
00ach call 7FF82503EFF0h            ; CALL(Call_rel32_64) [5FA8FA20h:jmp64]                encoding(5 bytes) = e8 6f f9 a8 5f
...
00b9h call 7FF825095F10h            ; CALL(Call_rel32_64) [5FAE6940h:jmp64]                encoding(5 bytes) = e8 82 68 ae 5f
00beh mov rcx,7FF7C5567758h         ; MOV(Mov_r64_imm64) [RCX,7ff7c5567758h:imm64]         encoding(10 bytes) = 48 b9 58 77 56 c5 f7 7f 00 00
00c8h call 7FF82503EFF0h            ; CALL(Call_rel32_64) [5FA8FA20h:jmp64]                encoding(5 bytes) = e8 53 f9 a8 5f
...
00d8h call 7FF825095F10h            ; CALL(Call_rel32_64) [5FAE6940h:jmp64]                encoding(5 bytes) = e8 63 68 ae 5f
...
00f1h mov rdx,2E1100030D0h          ; MOV(Mov_r64_imm64) [RDX,2e1100030d0h:imm64]          encoding(10 bytes) = 48 ba d0 30 00 10 e1 02 00 00
...
010ah call 7FF7C5590E78h            ; CALL(Call_rel32_64) [FFFFFFFFFFFE18A8h:jmp64]        encoding(5 bytes) = e8 99 17 fe ff
010fh mov rbx,rax                   ; MOV(Mov_r64_rm64) [RBX,RAX]                          encoding(3 bytes) = 48 8b d8
0112h mov rcx,7FF7C55652C0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c55652c0h:imm64]         encoding(10 bytes) = 48 b9 c0 52 56 c5 f7 7f 00 00
011ch mov edx,2                     ; MOV(Mov_r32_imm32) [EDX,2h:imm32]                    encoding(5 bytes) = ba 02 00 00 00
0121h call 7FF825096E40h            ; CALL(Call_rel32_64) [5FAE7870h:jmp64]                encoding(5 bytes) = e8 4a 77 ae 5f
0126h mov rbp,rax                   ; MOV(Mov_r64_rm64) [RBP,RAX]                          encoding(3 bytes) = 48 8b e8
0129h mov rcx,7FF7C575C618h         ; MOV(Mov_r64_imm64) [RCX,7ff7c575c618h:imm64]         encoding(10 bytes) = 48 b9 18 c6 75 c5 f7 7f 00 00
0133h call 7FF825096CB0h            ; CALL(Call_rel32_64) [5FAE76E0h:jmp64]                encoding(5 bytes) = e8 a8 75 ae 5f
...
0149h call 7FF825095F10h            ; CALL(Call_rel32_64) [5FAE6940h:jmp64]                encoding(5 bytes) = e8 f2 67 ae 5f
014eh mov rcx,7FF7C5567758h         ; MOV(Mov_r64_imm64) [RCX,7ff7c5567758h:imm64]         encoding(10 bytes) = 48 b9 58 77 56 c5 f7 7f 00 00
0158h call 7FF825096CB0h            ; CALL(Call_rel32_64) [5FAE76E0h:jmp64]                encoding(5 bytes) = e8 83 75 ae 5f
...
016ch call 7FF825095F10h            ; CALL(Call_rel32_64) [5FAE6940h:jmp64]                encoding(5 bytes) = e8 cf 67 ae 5f
...
0195h mov rdx,7FF7C575C618h         ; MOV(Mov_r64_imm64) [RDX,7ff7c575c618h:imm64]         encoding(10 bytes) = 48 ba 18 c6 75 c5 f7 7f 00 00
...
01a7h mov rcx,7FF7C575C618h         ; MOV(Mov_r64_imm64) [RCX,7ff7c575c618h:imm64]         encoding(10 bytes) = 48 b9 18 c6 75 c5 f7 7f 00 00
01b1h call 7FF825063360h            ; CALL(Call_rel32_64) [5FAB3D90h:jmp64]                encoding(5 bytes) = e8 da 3b ab 5f
...
01c2h mov rcx,46256FEEEFB5h         ; MOV(Mov_r64_imm64) [RCX,46256feeefb5h:imm64]         encoding(10 bytes) = 48 b9 b5 ef ee 6f 25 46 00 00
...
01d3h call 7FF8251C1650h            ; CALL(Call_rel32_64) [5FC12080h:jmp64]                encoding(5 bytes) = e8 a8 1e c1 5f
...
01e5h call 7FF8251BFDD0h            ; CALL(Call_rel32_64) [5FC10800h:jmp64]                encoding(5 bytes) = e8 16 06 c1 5f
01eah int 3                         ; INT(Int3)                                            encoding(1 byte ) = cc
; static ReadOnlySpan<byte> ShuffleWithReflectionBytes => new byte[491]{};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: Vec256<ulong> perm4x64_256x64(Vec256<ulong> src)
; location: [7FF7C55B2590h, 7FF7C55B25C8h]
...
; location: [7FF7C55B2B50h, 7FF7C55B2BA3h]
0000h vzeroupper                    ; VZEROUPPER(VEX_Vzeroupper)                           encoding(VEX, 3 bytes) = c5 f8 77
0003h xchg ax,ax                    ; NOP(Nopw)                                            encoding(2 bytes) = 66 90
...
; location: [7FF7C55B2BC0h, 7FF7C55B2C90h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
000fh lea rdx,[7FF7C55B2C98h]       ; LEA(Lea_r64_m) [RDX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 15 c2 00 00 00
0016h mov edx,[rdx+rax*4]           ; MOV(Mov_r32_rm32) [EDX,mem(32u,RDX:br,:sr)]          encoding(3 bytes) = 8b 14 82
0019h lea rcx,[7FF7C55B2BC5h]       ; LEA(Lea_r64_m) [RCX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 0d e5 ff ff ff
...
0036h lea rdx,[7FF7C55B2CD0h]       ; LEA(Lea_r64_m) [RDX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 15 d3 00 00 00
003dh mov edx,[rdx+rax*4]           ; MOV(Mov_r32_rm32) [EDX,mem(32u,RDX:br,:sr)]          encoding(3 bytes) = 8b 14 82
0040h lea rcx,[7FF7C55B2BC5h]       ; LEA(Lea_r64_m) [RCX,mem(Unknown,RIP:br,:sr)]         encoding(7 bytes) = 48 8d 0d be ff ff ff
...
; location: [7FF7C55B2D00h, 7FF7C55B2D7Ch]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C55B2D90h, 7FF7C55B2DACh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,2E16A6EC899h          ; MOV(Mov_r64_imm64) [RAX,2e16a6ec899h:imm64]          encoding(10 bytes) = 48 b8 99 c8 6e 6a e1 02 00 00
...
; static ReadOnlySpan<byte> get_U8DataBytes => new byte[29]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0x99,0xC8,0x6E,0x6A,0xE1,0x02,0x00,0x00,0x48,0x89,0x01,0xC7,0x41,0x08,0x40,0x00,0x00,0x00,0x48,0x8B,0xC1,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ReadOnlySpan<uint> get_U32Data()
; location: [7FF7C55B2DC0h, 7FF7C55B2E2Ah]
...
000bh mov rcx,7FF7C57878F0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c57878f0h:imm64]         encoding(10 bytes) = 48 b9 f0 78 78 c5 f7 7f 00 00
0015h mov edx,10h                   ; MOV(Mov_r32_imm32) [EDX,10h:imm32]                   encoding(5 bytes) = ba 10 00 00 00
001ah call 7FF825096DE0h            ; CALL(Call_rel32_64) [5FAE4020h:jmp64]                encoding(5 bytes) = e8 01 40 ae 5f
001fh mov rdx,2E16A6EC8D9h          ; MOV(Mov_r64_imm64) [RDX,2e16a6ec8d9h:imm64]          encoding(10 bytes) = 48 ba d9 c8 6e 6a e1 02 00 00
...
; location: [7FF7C55B2E80h, 7FF7C55B2E8Bh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C55B2EA0h, 7FF7C55B2EE0h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h cmp edx,1                     ; CMP(Cmp_rm32_imm8) [EDX,1h:imm32]                    encoding(3 bytes) = 83 fa 01
0008h jne short 0010h               ; JNE(Jne_rel8_64) [10h:jmp64]                         encoding(2 bytes) = 75 06
000ah mov eax,1                     ; MOV(Mov_r32_imm32) [EAX,1h:imm32]                    encoding(5 bytes) = b8 01 00 00 00
...
; location: [7FF7C55B3710h, 7FF7C55B371Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C55B3730h, 7FF7C55B374Ch]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,2E16A6EC899h          ; MOV(Mov_r64_imm64) [RAX,2e16a6ec899h:imm64]          encoding(10 bytes) = 48 b8 99 c8 6e 6a e1 02 00 00
...
001ch ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> ReadU8DataBytes => new byte[29]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0x99,0xC8,0x6E,0x6A,0xE1,0x02,0x00,0x00,0x48,0x89,0x02,0xC7,0x42,0x08,0x40,0x00,0x00,0x00,0x48,0x8B,0xC2,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: ReadOnlySpan<uint> ReadU32Data(int count)
; location: [7FF7C55B3760h, 7FF7C55B3772h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rcx,rdx                   ; MOV(Mov_r64_rm64) [RCX,RDX]                          encoding(3 bytes) = 48 8b ca
0008h mov rax,7FF7C55B2DC0h         ; MOV(Mov_r64_imm64) [RAX,7ff7c55b2dc0h:imm64]         encoding(10 bytes) = 48 b8 c0 2d 5b c5 f7 7f 00 00
0012h jmp rax                       ; JMP(Jmp_rm64) [RAX]                                  encoding(3 bytes) = 48 ff e0
; static ReadOnlySpan<byte> ReadU32DataBytes => new byte[21]{0x0F,0x1F,0x44,0x00,0x00,0x48,0x8B,0xCA,0x48,0xB8,0xC0,0x2D,0x5B,0xC5,0xF7,0x7F,0x00,0x00,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidReturn()
; location: [7FF7C55B3B00h, 7FF7C55B3B1Ch]
0000h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0004h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
0005h mov rcx,2E110003060h          ; MOV(Mov_r64_imm64) [RCX,2e110003060h:imm64]          encoding(10 bytes) = 48 b9 60 30 00 10 e1 02 00 00
000fh mov rcx,[rcx]                 ; MOV(Mov_r64_rm64) [RCX,mem(64u,RCX:br,:sr)]          encoding(3 bytes) = 48 8b 09
0012h call 7FF7C55B3AD0h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFFD0h:jmp64]        encoding(5 bytes) = e8 b9 ff ff ff
0017h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
0018h add rsp,28h                   ; ADD(Add_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 c4 28
001ch ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
; static ReadOnlySpan<byte> VoidReturnBytes => new byte[29]{0x48,0x83,0xEC,0x28,0x90,0x48,0xB9,0x60,0x30,0x00,0x10,0xE1,0x02,0x00,0x00,0x48,0x8B,0x09,0xE8,0xB9,0xFF,0xFF,0xFF,0x90,0x48,0x83,0xC4,0x28,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int SizeTest()
; location: [7FF7C55B3B40h, 7FF7C55B3B4Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C55B3B60h, 7FF7C55B3B6Fh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,7FF7C55B3B00h         ; MOV(Mov_r64_imm64) [RAX,7ff7c55b3b00h:imm64]         encoding(10 bytes) = 48 b8 00 3b 5b c5 f7 7f 00 00
000fh jmp rax                       ; JMP(Jmp_rm64) [RAX]                                  encoding(3 bytes) = 48 ff e0
; static ReadOnlySpan<byte> VoidCalls1Bytes => new byte[18]{0x0F,0x1F,0x44,0x00,0x00,0x48,0xB8,0x00,0x3B,0x5B,0xC5,0xF7,0x7F,0x00,0x00,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidCalls2()
; location: [7FF7C55B3B90h, 7FF7C55B3BB2h]
0000h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0001h sub rsp,20h                   ; SUB(Sub_rm64_imm8) [RSP,20h:imm64]                   encoding(4 bytes) = 48 83 ec 20
...
000bh call 7FF7C55B3B00h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFF70h:jmp64]        encoding(5 bytes) = e8 60 ff ff ff
0010h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0013h mov rax,7FF7C55B3B00h         ; MOV(Mov_r64_imm64) [RAX,7ff7c55b3b00h:imm64]         encoding(10 bytes) = 48 b8 00 3b 5b c5 f7 7f 00 00
...
; static ReadOnlySpan<byte> VoidCalls2Bytes => new byte[37]{0x56,0x48,0x83,0xEC,0x20,0x48,0x8B,0xF1,0x48,0x8B,0xCE,0xE8,0x60,0xFF,0xFF,0xFF,0x48,0x8B,0xCE,0x48,0xB8,0x00,0x3B,0x5B,0xC5,0xF7,0x7F,0x00,0x00,0x48,0x83,0xC4,0x20,0x5E,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidCalls3()
; location: [7FF7C55B3BD0h, 7FF7C55B3BFAh]
0000h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0001h sub rsp,20h                   ; SUB(Sub_rm64_imm8) [RSP,20h:imm64]                   encoding(4 bytes) = 48 83 ec 20
0005h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
0008h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
000bh call 7FF7C55B3B00h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFF30h:jmp64]        encoding(5 bytes) = e8 20 ff ff ff
0010h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0013h call 7FF7C55B3B00h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFF30h:jmp64]        encoding(5 bytes) = e8 18 ff ff ff
0018h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
001bh mov rax,7FF7C55B3B00h         ; MOV(Mov_r64_imm64) [RAX,7ff7c55b3b00h:imm64]         encoding(10 bytes) = 48 b8 00 3b 5b c5 f7 7f 00 00
...
; static ReadOnlySpan<byte> VoidCalls3Bytes => new byte[45]{0x56,0x48,0x83,0xEC,0x20,0x48,0x8B,0xF1,0x48,0x8B,0xCE,0xE8,0x20,0xFF,0xFF,0xFF,0x48,0x8B,0xCE,0xE8,0x18,0xFF,0xFF,0xFF,0x48,0x8B,0xCE,0x48,0xB8,0x00,0x3B,0x5B,0xC5,0xF7,0x7F,0x00,0x00,0x48,0x83,0xC4,0x20,0x5E,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: void VoidCalls4()
; location: [7FF7C55B3C20h, 7FF7C55B3C52h]
0000h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0001h sub rsp,20h                   ; SUB(Sub_rm64_imm8) [RSP,20h:imm64]                   encoding(4 bytes) = 48 83 ec 20
0005h mov rsi,rcx                   ; MOV(Mov_r64_rm64) [RSI,RCX]                          encoding(3 bytes) = 48 8b f1
0008h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
000bh call 7FF7C55B3B00h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEE0h:jmp64]        encoding(5 bytes) = e8 d0 fe ff ff
0010h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0013h call 7FF7C55B3B00h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEE0h:jmp64]        encoding(5 bytes) = e8 c8 fe ff ff
0018h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
001bh call 7FF7C55B3B00h            ; CALL(Call_rel32_64) [FFFFFFFFFFFFFEE0h:jmp64]        encoding(5 bytes) = e8 c0 fe ff ff
0020h mov rcx,rsi                   ; MOV(Mov_r64_rm64) [RCX,RSI]                          encoding(3 bytes) = 48 8b ce
0023h mov rax,7FF7C55B3B00h         ; MOV(Mov_r64_imm64) [RAX,7ff7c55b3b00h:imm64]         encoding(10 bytes) = 48 b8 00 3b 5b c5 f7 7f 00 00
...
; location: [7FF7C55B3CB0h, 7FF7C55B3CC0h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C55B3CE0h, 7FF7C55B3D48h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h push rbp                      ; PUSH(Push_r64) [RBP]                                 encoding(1 byte ) = 55
0003h push rbx                      ; PUSH(Push_r64) [RBX]                                 encoding(1 byte ) = 53
...
0010h mov rcx,7FF7C578BBF8h         ; MOV(Mov_r64_imm64) [RCX,7ff7c578bbf8h:imm64]         encoding(10 bytes) = 48 b9 f8 bb 78 c5 f7 7f 00 00
001ah call 7FF825096CB0h            ; CALL(Call_rel32_64) [5FAE2FD0h:jmp64]                encoding(5 bytes) = e8 b1 2f ae 5f
...
0029h call 7FF825095DF0h            ; CALL(Call_rel32_64) [5FAE2110h:jmp64]                encoding(5 bytes) = e8 e2 20 ae 5f
002eh mov rcx,7FF7C546D0E0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c546d0e0h:imm64]         encoding(10 bytes) = 48 b9 e0 d0 46 c5 f7 7f 00 00
0038h mov [rbp+18h],rcx             ; MOV(Mov_rm64_r64) [mem(64u,RBP:br,:sr),RCX]          encoding(4 bytes) = 48 89 4d 18
003ch mov rcx,7FF7C55B3CB0h         ; MOV(Mov_r64_imm64) [RCX,7ff7c55b3cb0h:imm64]         encoding(10 bytes) = 48 b9 b0 3c 5b c5 f7 7f 00 00
...
0056h mov rax,7FF7C55B3C70h         ; MOV(Mov_r64_imm64) [RAX,7ff7c55b3c70h:imm64]         encoding(10 bytes) = 48 b8 70 3c 5b c5 f7 7f 00 00
...
; static ReadOnlySpan<byte> CallInvokeBinOpBytes => new byte[107]{0x57,0x56,0x55,0x53,0x48,0x83,0xEC,0x28,0x48,0x8B,0xF1,0x8B,0xFA,0x41,0x8B,0xD8,0x48,0xB9,0xF8,0xBB,0x78,0xC5,0xF7,0x7F,0x00,0x00,0xE8,0xB1,0x2F,0xAE,0x5F,0x48,0x8B,0xE8,0x48,0x8D,0x4D,0x08,0x48,0x8B,0xD5,0xE8,0xE2,0x20,0xAE,0x5F,0x48,0xB9,0xE0,0xD0,0x46,0xC5,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4D,0x18,0x48,0xB9,0xB0,0x3C,0x5B,0xC5,0xF7,0x7F,0x00,0x00,0x48,0x89,0x4D,0x20,0x48,0x8B,0xCE,0x48,0x8B,0xD5,0x44,0x8B,0xC7,0x44,0x8B,0xCB,0x48,0xB8,0x70,0x3C,0x5B,0xC5,0xF7,0x7F,0x00,0x00,0x48,0x83,0xC4,0x28,0x5B,0x5D,0x5E,0x5F,0x48,0xFF,0xE0};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int And(int a, int b)
; location: [7FF7C55B3D70h, 7FF7C55B3D79h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,ecx                   ; MOV(Mov_r32_rm32) [EAX,ECX]                          encoding(2 bytes) = 8b c1
...
; location: [7FF7C55B3D90h, 7FF7C55B3D99h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,ecx                   ; MOV(Mov_r32_rm32) [EAX,ECX]                          encoding(2 bytes) = 8b c1
...
; location: [7FF7C55B3DB0h, 7FF7C55B3DB9h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,ecx                   ; MOV(Mov_r32_rm32) [EAX,ECX]                          encoding(2 bytes) = 8b c1
...
; location: [7FF7C55B3DD0h, 7FF7C55B3DDBh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FF7C55B3DF0h, 7FF7C55B3E1Dh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int Jump()
; location: [7FF7C55B3E30h, 7FF7C55B3E3Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,:sr)]                  encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,7                     ; MOV(Mov_r32_imm32) [EAX,7h:imm32]                    encoding(5 bytes) = b8 07 00 00 00
000ah ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
...
; location: [7FF7C55B5ED0h, 7FF7C55B5F05h]
0000h push rdi                      ; PUSH(Push_r64) [RDI]                                 encoding(1 byte ) = 57
0001h push rsi                      ; PUSH(Push_r64) [RSI]                                 encoding(1 byte ) = 56
0002h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
...
000ah mov rcx,7FF7C5636BE8h         ; MOV(Mov_r64_imm64) [RCX,7ff7c5636be8h:imm64]         encoding(10 bytes) = 48 b9 e8 6b 63 c5 f7 7f 00 00
0014h xor edx,edx                   ; XOR(Xor_r32_rm32) [EDX,EDX]                          encoding(2 bytes) = 33 d2
0016h call 7FF825061BA0h            ; CALL(Call_rel32_64) [5FAABCD0h:jmp64]                encoding(5 bytes) = e8 b5 bc aa 5f
001bh mov rax,2E110002D38h          ; MOV(Mov_r64_imm64) [RAX,2e110002d38h:imm64]          encoding(10 bytes) = 48 b8 38 2d 00 10 e1 02 00 00
...
; static ReadOnlySpan<byte> MulBytes => new byte[54]{0x57,0x56,0x48,0x83,0xEC,0x28,0x8B,0xF1,0x8B,0xFA,0x48,0xB9,0xE8,0x6B,0x63,0xC5,0xF7,0x7F,0x00,0x00,0x33,0xD2,0xE8,0xB5,0xBC,0xAA,0x5F,0x48,0xB8,0x38,0x2D,0x00,0x10,0xE1,0x02,0x00,0x00,0x48,0x8B,0x00,0x8B,0x00,0x0F,0xAF,0xF7,0x8B,0xC6,0x48,0x83,0xC4,0x28,0x5E,0x5F,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
