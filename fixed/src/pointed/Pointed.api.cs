...
namespace Z0
{
    ...
    {
        [MethodImpl(Inline)]
        public static Pointed<R> surrogate<R>(PointedFunc<R> f)
        ...
        [MethodImpl(Inline)]
        public static PointedFunc<R> pointed<R>(Func<R> f)
            where R : unmanaged, IFixed
                => () => Points.point(f());
        ...
        public static PointedFunc<X0,R> pointed<X0,R>(Func<X0,R> f)
            where R : unmanaged, IFixed
            where X0 : unmanaged, IFixed
                => (in Point<X0> x) => Points.point(f(x.x0));
        ...
        public static PointedFunc<X0,X1,R> pointed<X0,X1,R>(Func<X0,X1,R> f)
            ...
            where X0 : unmanaged, IFixed
            where X1 : unmanaged, IFixed
                => (in Point<X0,X1> x) => Points.point(f(x.x0,x.x1));
        ...
        public static PointedFunc<X0,X1,X2,R> pointed<X0,X1,X2,R>(Func<X0,X1,X2,R> f)
            ...
            where X2 : unmanaged, IFixed
            where R : unmanaged, IFixed
                => (in Point<X0,X1,X2> x) => Points.point(f(x.x0,x.x1,x.x2));

        [MethodImpl(Inline)]
        public static Pointed<R> surrogate<R>(Func<R> f)
            where R : unmanaged, IFixed
                => surrogate(pointed(f));
