...
namespace Z0
{
    ...
    public readonly struct Pointed<X0,X1,X2,R> : IPointedSurrogate<PointedFunc<X0,X1,X2,R>, MixedPoint<X0,X1,X2>, Point<R>>
        ...
        where R : unmanaged, IFixed
    {
        ...
        [MethodImpl(Inline)]
        public Point<R> Evaluate(in MixedPoint<X0,X1,X2> x0) => F(x0);
