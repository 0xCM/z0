...
namespace Z0
{
    ...
    {                
        ...
        [MethodImpl(Inline)]
        public static E eVal<E>(sbyte tVal, E eRep = default) 
            where E : unmanaged, Enum
                => EnumValue.eVal(tVal,eRep);
        ...
        [MethodImpl(Inline)]
        public static E eVal<E>(short tVal, E eRep = default) 
            where E : unmanaged, Enum
                => EnumValue.eVal(tVal,eRep);
        ...
        [MethodImpl(Inline)]
        public static E eVal<E>(ushort tVal, E eRep = default) 
            where E : unmanaged, Enum
                => EnumValue.eVal(tVal,eRep);
        ...
        /// <typeparam name="E">The enum target type of primal u16-kind</typeparam>
        [MethodImpl(Inline)]
        public static E eVal<E>(char tVal, E eRep = default) 
            where E : unmanaged, Enum
                => EnumValue.eVal(tVal,eRep);
        ...
        [MethodImpl(Inline)]
        public static E eVal<E>(int tVal, E eRep = default) 
            where E : unmanaged, Enum
                => EnumValue.eVal(tVal,eRep);
        ...
        [MethodImpl(Inline)]
        public static E eVal<E>(uint tVal, E eRep = default) 
            where E : unmanaged, Enum
                => EnumValue.eVal(tVal,eRep);
        ...
        [MethodImpl(Inline)]
        public static E eVal<E>(long tVal, E eRep = default) 
            where E : unmanaged, Enum
                => EnumValue.eVal(tVal,eRep);
        ...
        [MethodImpl(Inline)]
        public static E eVal<E>(ulong tVal, E eRep = default) 
            where E : unmanaged, Enum
                => EnumValue.eVal(tVal,eRep);
    }
