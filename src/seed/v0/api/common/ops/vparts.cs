...
namespace Z0
{
    ...
    partial struct V0
    {
        ...
        /// <param name="w">The vector width selector</param>
        [MethodImpl(Inline),Op]
        public static Vector128<int> vpartsi(int x0, int x1, int x2, int x3)
            => Vector128.Create(x0,x1, x2, x3);
        ...
        /// <param name="w">The vector width selector</param>
        [MethodImpl(Inline),Op]
        public static Vector128<long> vpartsi(long x0, long x1)
        ...
        /// <param name="w">The vector width selector</param>
        [MethodImpl(Inline),Op]
        public static Vector128<float> vpartsf(float x0, float x1, float x2, float x3)
            => Vector128.Create(x0,x1,x2,x3);
        ...
        /// <param name="w">The vector width selector</param>
        [MethodImpl(Inline),Op]
        public static Vector128<double> vpartsf(double x0, double x1)
            => Vector128.Create(x0,x1);
        ...
        /// <param name="w">The vector width selector</param>
        [MethodImpl(Inline),Op]
        public static Vector256<ushort> vparts(
        ...
        /// <param name="w">The vector width selector</param>
        [MethodImpl(Inline),Op]
        public static Vector256<short> vpartsi(
        ...
        /// <param name="w">The vector width selector</param>
        [MethodImpl(Inline),Op]
        public static Vector256<int> vpartsi(int x0, int x1, int x2, int x3, int x4, int x5, int x6, int x7)
        ...
        /// <param name="w">The vector width selector</param>
        [MethodImpl(Inline),Op]
        public static Vector256<uint> vparts(
        ...
        /// <param name="w">The vector width selector</param>
        [MethodImpl(Inline),Op]
        public static Vector256<long> vpartsi(long x0, long x1, long x2, long x3)
        ...
        /// <param name="w">The vector width selector</param>
        [MethodImpl(Inline),Op]
        public static Vector256<float> vpartsf(float x0, float x1, float x2, float x3, float x4, float x5, float x6, float x7)
            => Vector256.Create(x0,x1,x2,x3,x4,x5,x6,x7);
        ...
        /// <param name="w">The vector width selector</param>
        [MethodImpl(Inline),Op]
        public static Vector256<double> vpartsf(double x0, double x1, double x2, double x3)
            => Vector256.Create(x0,x1,x2,x3);
        ...
        /// <param name="w">The vector width selector</param>
        [MethodImpl(Inline),Op]
        public static Vector512<short> vpartsi(
            short x0, short x1, short x2, short x3, short x4, short x5, short x6, short x7,
        ...
        /// <param name="w">The vector width selector</param>
        [MethodImpl(Inline),Op]
        public static Vector512<int> vpartsi(int x0, int x1, int x2, int x3, int x4, int x5, int x6, int x7,
        ...
        /// <param name="w">The vector width selector</param>
        [MethodImpl(Inline),Op]
        public static Vector512<long> vpartsi(long x0, long  x1, long  x2, long  x3, long x4, long  x5, long  x6, long  x7)
