...
namespace Z0
{
    ...
    {                    
        ...
        {
            [MethodImpl(Inline)]
            get => ref Reference.Address.Ref<sbyte>();
        }
        ...
        {
            [MethodImpl(Inline)]
            get => ref Reference.Address.Ref<byte>();
        }
        ...
        {
            [MethodImpl(Inline)]
            get => ref Reference.Address.Ref<ushort>();
        }
        ...
        {
            [MethodImpl(Inline)]
            get => ref Reference.Address.Ref<int>();
        }
        ...
        {
            [MethodImpl(Inline)]
            get => ref Reference.Address.Ref<uint>();
        }
        ...
        {
            [MethodImpl(Inline)]
            get => ref Reference.Address.Ref<long>();
        }
        ...
        {
            [MethodImpl(Inline)]
            get => ref Reference.Address.Ref<ulong>();
        }
        ...
        {
            [MethodImpl(Inline)]
            get => ref Reference.Address.Ref<float>();
        }
        ...
        {
            [MethodImpl(Inline)]
            get => ref Reference.Address.Ref<double>();
        }
        ...
        {
            [MethodImpl(Inline)]
            get => ref Reference.Address.Ref<decimal>();
        }
        ...
        {
            [MethodImpl(Inline)]
            get => ref Reference.Address.Ref<bool>();
        }
