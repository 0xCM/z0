...
namespace Z0
{
    ...
    partial class Hex
    {
        ...
        {
            ref readonly var codes = ref head(UpperDigits);
        ...
        [MethodImpl(Inline), Op]
        public static ReadOnlySpan<char> digits(byte src)
        {
            ref readonly var codes = ref head(UpperDigits);
        ...
        /// <param name="src">The byte value</param>
        [MethodImpl(Inline), Op]
        public static ReadOnlySpan<char> digits(sbyte src)
            => digits((byte)src);
        ...
        /// <param name="src">The byte value</param>
        [MethodImpl(Inline), Op]
        public static ReadOnlySpan<char> digits(ushort src)
        {
            const int count = 4;
            ref readonly var codes = ref head(UpperDigits);
        ...
        /// <param name="src">The byte value</param>
        [MethodImpl(Inline), Op]
        public static ReadOnlySpan<char> digits(short src)
            => digits((ushort)src);
        ...
        /// <param name="src">The byte value</param>
        [MethodImpl(Inline), Op]
        public static ReadOnlySpan<char> digits(uint src)
        {
            const int count = 8;
            ref readonly var codes = ref head(UpperDigits);
        ...
        /// <param name="src">The byte value</param>
        [MethodImpl(Inline), Op]
        public static ReadOnlySpan<char> digits(int src)
            => digits((uint)src);
        ...
        /// <param name="src">The byte value</param>
        [MethodImpl(Inline), Op]
        public static ReadOnlySpan<char> digits(ulong src)
        {
            const int count = 16;
            ref readonly var codes = ref head(UpperDigits);
        ...
        /// <param name="src">The byte value</param>
        [MethodImpl(Inline), Op]
        public static ReadOnlySpan<char> digits(long src)
            => digits((ulong)src);

        [MethodImpl(Inline), Op]
        public static void digits(byte src, Span<char> dst, int offset)
        {
            ref readonly var codes = ref head(UpperDigits);
        ...
        [MethodImpl(Inline), Op]
        public static void digits(sbyte src, Span<char> dst, int offset)
            => digits((byte)src,dst,offset);
        
        [MethodImpl(Inline), Op]
        public static void digits(ushort src, Span<char> dst, int offset)
        {
            ref readonly var codes = ref head(UpperDigits);
            ref var target = ref head(dst);
            seek(ref target, offset + 0) = (char)skip(in codes, src & 0xF);
        ...
        [MethodImpl(Inline), Op]
        public static void digits(short src, Span<char> dst, int offset)
            => digits((ushort)src,dst,offset);

        [MethodImpl(Inline), Op]
        public static void digits(uint src, Span<char> dst, int offset)
        {
            ref readonly var codes = ref head(UpperDigits);
            ref var target = ref head(dst);
            seek(ref target, offset + 0) = (char)skip(in codes, src & 0xF);
        ...
        [MethodImpl(Inline), Op]
        public static void digits(int src, Span<char> dst, int offset)
            => digits((uint)src,dst,offset);

        [MethodImpl(Inline), Op]
        public static void digits(ulong src, Span<char> dst, int offset)
        {
            ref readonly var codes = ref head(UpperDigits);
            ref var target = ref head(dst);
            seek(ref target, offset + 0) = (char)skip(in codes, src & 0xF);
        ...
        [MethodImpl(Inline), Op]
        public static void digits(long src, Span<char> dst, int offset)        
