...
namespace Z0.Tools
{
    ...
    partial struct Llvm
    {
        public struct LlvmAsCmdInfo : IToolCmdInfo<LlvmAsCmdInfo, LlvmAsCmd>
        {
            ...
            public static CmdOptionSpec SrcPath
                => Cmd.option(string.Empty, "The input file");

            public static CmdOptionSpec DstPath
                => Cmd.option("o", "The input file", CmdArgPrefix.Dash);
