...
namespace Z0
{
    ...
    public static class RandomBitStrings
    {
        ...
        [MethodImpl(Inline)]
        public static BitString BitString(this IPolyStream random, int len)
        ...
        [MethodImpl(Inline)]
        public static BitString BitString(this IPolyStream random, int minlen, int maxlen)
        ...
        /// <param name="maxlen">The maximum length of the bitstring</param>
        [MethodImpl(Inline)]
        public static BitString BitString(this IPolyStream random, Interval<int> length)
        ...
        /// <param name="len">The bitstring length</param>
        [MethodImpl(Inline)]
        public static BitString BitString<N>(this IPolyStream random, N n = default)
