...
namespace Z0
{
    ...
    /// <summary>
    /// Defines a type-level representation of <see cref='DW.W256'/> with a <see cref='TS.Signed'/> classifier
    /// </summary>
    public readonly struct W256i : TVectorWidth<W> 
    {
        ...
        /// The width identity
        /// </summary>
        public const string Identifier = "w256i";
