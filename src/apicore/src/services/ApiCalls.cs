...
namespace Z0
{
    ...
    public readonly partial struct ApiCalls
    {
        ...
        [MethodImpl(Inline)]
        public static ApiCall<A0,R> call<A0,R>(in ApiKey api, uint offset, in A0 a0, in R result)
            where A0 : unmanaged
            where R : unmanaged
                => define(api, skip(a0, offset), skip(result, offset));

        [MethodImpl(Inline)]
        public static ApiCall<A0,A1,R> call<A0,A1,R>(in ApiKey api, uint offset, in A0 a0, in A1 a1, in R result)
            where A0 : unmanaged
            where A1 : unmanaged
            where R : unmanaged
        ...
        [MethodImpl(Inline)]
        public static ApiCall<A0,A1,A2,R> call<A0,A1,A2,R>(in ApiKey api, uint offset, in A0 a0, in A1 a1, A2 a2, in R result)
            where A0 : unmanaged
            where A1 : unmanaged
            where A2 : unmanaged
            where R : unmanaged
        ...
        [MethodImpl(Inline), Op]
        static ApiCall<Cell256,Cell256,Cell256> call(in ApiKey api, in Cell256 a0, in Cell256 a1, in Cell256 result)
            => define(api, a0, a1, result);

        [MethodImpl(Inline), Op]
        static ApiCall<Cell512,Cell512,Cell512> call(in ApiKey api, in Cell512 a0, in Cell512 a1, in Cell512 result)
            => define(api, a0, a1, result);

        [MethodImpl(Inline), Op]
        static ApiCall<Cell8,Cell16,Cell32> call(in ApiKey api, in Cell8 a0, in Cell16 a1, in Cell32 result)
            => define(api, a0, a1, result);

        [MethodImpl(Inline), Op]
        static ApiCall<Cell8,Cell16,Cell32,Cell64> call(in ApiKey api, in Cell8 a0, in Cell16 a1, in Cell32 a2, in Cell64 result)
            => define(api, a0, a1, a2, result);

        [MethodImpl(Inline), Op]
        static ApiCall<Cell8,Cell16,Cell32,Cell64,Cell128> call(in ApiKey api, in Cell8 a0, in Cell16 a1, in Cell32 a2, in Cell64 a3, in Cell128 result)
            => define(api, a0, a1, a2, a3, result);

        [MethodImpl(Inline), Op, Closures(Closure)]
        static ApiCall<T,T,T> call<T>(in ApiKey api, uint offset, in T a0, in T a1, in T value)
            where T : unmanaged
                => define(api, skip(a0,offset), skip(a1, offset), skip(value, offset));

        [MethodImpl(Inline), Op, Closures(Closure)]
        static ApiCall<T,T,T,T> call<T>(in ApiKey api, uint offset, in T a0, in T a1, in T a2, in T result)
            where T : unmanaged
                => define(api, skip(a0,offset), skip(a1, offset), skip(a2,offset), skip(result, offset));

        // [MethodImpl(Inline), Op, Closures(Closure)]
        // static void store<T>(in ApiCall<T,T,T> src, Span<byte> dst)
        //     where T : unmanaged
        //         => serialize(src, dst);

        [MethodImpl(Inline), Op, Closures(Closure)]
        static ApiCallData data<T>(in ApiCall<T,T,T> src)
            where T : unmanaged
                => ApiCallData.serialize(src);

        [MethodImpl(Inline), Op, Closures(Closure)]
        static ApiCallData data<T>(in ApiKey api, uint offset, in T a0, in T a1, in T result)
            where T : unmanaged
                => call<T>(api,offset, a0, a1, result);

        [MethodImpl(Inline), Op, Closures(Closure)]
        static ApiCallData data<T>(in ApiKey api, uint offset, in T a0, in T a1, in T a2, in T result)
            where T : unmanaged
