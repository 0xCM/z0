...
namespace Z0
{
    ...
    partial struct ImageTables
    {
        ...
        public class SectionHeader
        {
            ...
            public SectionAspect Characteristics { get; private set; }

            public SectionHeader (ref IMAGE_SECTION_HEADER section)
            {
                Name = section.Name;
                ...
                Characteristics = (SectionAspect) section.Characteristics;
            }
