...
namespace Z0
{
    ...
    {
        /// <summary>
        /// X86-executable code obtained by disassembling <see cref="eval(Kinds.Add, byte, byte)"/>
        /// </summary>
        ...
        /// <summary>
        /// X86-executable code obtained by disassembling <see cref="eval(Kinds.Sub, byte, byte)"/>
        /// </summary>
        ...
        /// <summary>
        /// X86-executable code obtained by disassembling <see cref="eval(Kinds.Mul, byte, byte)"/>
        /// </summary>
        ...
        /// <summary>
        /// X86-executable code obtained by disassembling <see cref="eval(Kinds.Div, byte, byte)"/>
        /// </summary>
        ...
        /// <summary>
        /// X86-executable code obtained by disassembling <see cref="eval(Kinds.And, byte, byte)"/>
        /// </summary>
