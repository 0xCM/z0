...
namespace Z0
{
    ...
    partial struct z
    {
        ...
        {
            var a = cpu.vinflate(x, n256, z16i);
            var b = cpu.vinflate(y, n256, z16i);
        ...
        {
            var z0 = cpu.vinflate(x, n256, z16i);
            var z1 = cpu.vinflate(y, n256, z16i);
        ...
        {
            (var x0, var x1) = cpu.vinflate(x,n512, z16i);
            (var y0, var y1) = cpu.vinflate(x,n512, z16i);
