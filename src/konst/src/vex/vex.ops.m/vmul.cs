...
namespace Z0
{
    ...
    partial struct z
    {
        ...
        public static Vector256<short> vmul(Vector128<sbyte> x, Vector128<sbyte> y)
            => vmullo(cpu.vinflate16i(x, w256, z16i), cpu.vinflate16i(y, w256, z16i));
        ...
        {
            var z0 = cpu.vinflate16u(x, w256, z16);
            var z1 = cpu.vinflate16u(y, w256, z16);
            return vmullo(z0,z1);
        }
        ...
        {
            var z0 = cpu.vinflate32i(x, w256, z32i);
            var z1 = cpu.vinflate32i(y, w256, z32i);
            return vmullo(z0,z1);
        }
        ...
        {
            var z0 = cpu.vinflate32u(x, w256, z32);
            var z1 = cpu.vinflate32u(y, w256, z32);
            return vmullo(z0,z1);
        }
        ...
        {
            (var x1, var x2) = cpu.vinflate16i(x,w512,z16i);
            (var y1, var y2) = cpu.vinflate16i(x,w512,z16i);
        ...
        {
            (var x1, var x2) = cpu.vinflate16u(x,w512, z16);
            (var y1, var y2) = cpu.vinflate16u(y,w512, z16);
            return (vmullo(x1,y1), vmullo(x2,y2));
        }
        ...
        {
            (var x1, var x2) = cpu.vinflate32i(x, w512, z32i);
            (var y1, var y2) = cpu.vinflate32i(y, w512, z32i);
            return(vmullo(x1,y1), vmullo(x2,y2));
        }
