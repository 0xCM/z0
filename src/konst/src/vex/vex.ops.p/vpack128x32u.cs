...
namespace Z0
{
    ...
    partial struct cpu
    {
        ...
        /// <param name="dst">The target vector</param>
        [MethodImpl(Inline), Op]
        public static Vector128<uint> vpack128x32u(Vector128<ulong> a, Vector128<ulong> b, W128 w = default)
        ...
        /// <param name="dst">The target vector</param>
        [MethodImpl(Inline), Op]
        public static Vector128<uint> vpack128x32u(Vector256<ulong> src, W128 w = default)
            => vparts(w128, (uint)vcell(src, 0),(uint)vcell(src, 1),(uint)vcell(src, 2),(uint)vcell(src, 3));
    }
}