...
namespace Z0
{
    ...
    partial struct z
    {
        ...
        public static Vector256<short> vinflate(Vector128<sbyte> src, W16 w, short t)
            => cpu.vconcat(vmaplo16i(src, n128, t), vmaphi16i(src, n128, t));
