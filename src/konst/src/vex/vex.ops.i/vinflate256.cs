...
namespace Z0
{
    ...
    partial struct z
    {
        ...
        public static Vector1024<int> vinflate(Vector256<sbyte> src, W32 w)
            => cpu.vconvert32i(src, w1024, z32i);
