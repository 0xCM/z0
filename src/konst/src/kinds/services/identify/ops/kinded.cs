...
namespace Z0
{
    ...
    partial class Identify
    {
        ...
        [MethodImpl(Inline)]
        public static string name(ApiKeyKind k)
            => k.Format();
        ...
        /// <param name="k">The operation kind id</param>
        [MethodImpl(Inline)]
        public static string vname(ApiKeyKind k)
            => k.Format(true);
        ...
        public static OpIdentity numeric(ApiKeyKind k,  NumericKind nk, bool generic = false)
        ...
        public static OpIdentity numeric<T>(ApiKeyKind k, T t = default, bool generic = false)
            where T : unmanaged
        ...
        /// <param name="generic">Whether the produced identity has a generic marker</param>
        public static OpIdentity vectorized(ApiKeyKind k, TypeWidth w, NumericKind nk, bool generic)
        ...
        public static OpIdentity vdirect<T>(ApiKeyKind k, TypeWidth w, T t = default)
            where T : unmanaged
        ...
        /// <typeparam name="W">The vector operand width</typeparam>
        /// <typeparam name="T">The vector cell type</typeparam>
        public static OpIdentity vdirect<W,T>(ApiKeyKind k, W w = default, T t = default)
            where T : unmanaged
        ...
        /// <typeparam name="W">The vector operand width</typeparam>
        /// <typeparam name="T">The vector cell type</typeparam>
        public static OpIdentity vgeneric<W,T>(ApiKeyKind k, W w = default, T t = default)
            where T : unmanaged
            where W : unmanaged, ITypeWidth
        ...
        public static OpIdentity sfunc<T>(ApiKeyKind k, T t = default)
        ...
        public static OpIdentity sfunc(ApiKeyKind k, NumericKind nk)
            => NumericOp(name(k), nk);
        ...
        /// <param name="generic">Whether the produced identity has a generic marker</param>
        public static OpIdentity sfunc(ApiKeyKind k, TypeWidth w, NumericKind nk, bool generic = true)
        ...
        /// <param name="t">A cell type representative</param>
        /// <param name="generic">Whether the produced identity has a generic marker</param>
        public static OpIdentity sfunc<T>(ApiKeyKind k, TypeWidth w, T t = default, bool generic = true)
            where T : unmanaged
        ...
        /// <typeparam name="T">The numeric type</typeparam>
        public static OpIdentity sfunc<W,T>(ApiKeyKind k, W w = default, T t = default, bool generic = true)
            where W : unmanaged, ITypeWidth
            where T : unmanaged
        ...
        /// <param name="generic">Whether the produced identity has a generic marker</param>
        public static OpIdentity vsfunc(ApiKeyKind k, TypeWidth w, NumericKind nk, bool generic = true)
            => OpIdentityBuilder.build(vname(k), w, nk, generic);
        ...
        /// <param name="generic">Whether the produced identity has a generic marker</param>
        /// <typeparam name="T">The vector cell type</typeparam>
        public static OpIdentity vsfunc<T>(ApiKeyKind k, TypeWidth w, T t = default, bool generic = true)
            where T : unmanaged
        ...
        /// <typeparam name="T">The vector cell type</typeparam>
        public static OpIdentity vsfunc<W,T>(ApiKeyKind k, W w = default, T t = default, bool generic = true)
            where W : unmanaged, ITypeWidth
            where T : unmanaged
