...
namespace Z0
{
    ...
    public static class PolyBlocks
    {
        ...
        public static SpanBlock8<T> Blocks<T>(this IDomainSource src, W8 w, int count, Interval<T> domain, Func<T,bool> filter)
            where T : unmanaged
        ...
        public static SpanBlock8<T> Blocks<T>(this IDataSource src, W8 w, int count, T t = default)
            where T : unmanaged
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock16<T> Blocks<T>(this IDomainSource src, W16 w, int count, Interval<T> domain, Func<T,bool> filter)
            where T : unmanaged
                => src.Stream(domain,filter).ToSpan(B.cellblocks<T>(w,count)).Blocked(w);
        ...
        /// <param name="t">The cell type representative</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static SpanBlock16<T> Blocks<T>(this IDataSource src, W16 w, int count, T t = default)
            where T : unmanaged
                => src.Stream<T>().ToSpan(B.cellblocks<T>(w,count)).Blocked(w);
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock32<T> Blocks<T>(this IDataSource src, W32 w, int count)
            where T : unmanaged
                => src.Stream<T>().ToSpan(B.cellblocks<T>(w,count)).Blocked(w);
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock32<T> Blocks<T>(this IDomainSource src, W32 w, T min, T max, int count = 1, Func<T,bool> filter = null)
            where T : unmanaged
        ...
        /// <param name="t">The cell type representative</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static SpanBlock32<T> Blocks<T>(this IDomainSource src, W32 w, int count, T t)
            where T : unmanaged
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock64<T> Blocks<T>(this IDataSource src, W64 w, int count)
            where T : unmanaged
                => src.Stream<T>().ToSpan(B.cellblocks<T>(w,count)).Blocked(w);
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock64<T> Blocks<T>(this IDomainSource src, W64 w, Interval<T> domain, int count = 1, Func<T,bool> filter = null)
            where T : unmanaged
                => src.Stream(domain,filter).ToSpan(B.cellblocks<T>(w,count)).Blocked(w);
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock64<T> Blocks<T>(this IDomainSource src, W64 w, T min, T max, int count = 1, Func<T,bool> filter = null)
            where T : unmanaged
                => src.Blocks(w, (min,max), count, filter);
        ...
        /// <param name="t">The cell type representative</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static SpanBlock64<T> Blocks<T>(this IDataSource src, W64 w, int count, T t)
            where T : unmanaged
                => src.Blocks<T>(w,count);
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock128<T> Blocks<T>(this IDataSource src, W128 w, int count = 1)
            where T : unmanaged
                => src.Stream<T>().ToSpan(B.cellblocks<T>(w, count)).Blocked(w);
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock128<T> Blocks<T>(this IDomainSource src, W128 w, Interval<T> domain, int count = 1, Func<T,bool> filter = null)
            where T : unmanaged
                => src.Stream(domain,filter).ToSpan(B.cellblocks<T>(w,count)).Blocked(w);
        ...
        /// <param name="t">The cell type representative</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static SpanBlock128<T> Blocks<T>(this IDataSource src, W128 w, int count, T t)
            where T : unmanaged
                => src.Blocks<T>(w,count);
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock256<T> Blocks<T>(this IDataSource src, W256 w, int count = 1)
            where T : unmanaged
                => src.Stream<T>().ToSpan(B.cellblocks<T>(w,count)).Blocked(w);
        ...
        /// <param name="t">The cell type representative</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static SpanBlock256<T> Blocks<T>(this IDataSource src, W256 w, int count, T t)
            where T : unmanaged
                => src.Blocks<T>(w,count);
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock512<T> Blocks<T>(this IDataSource src, W512 w, int count = 1)
            where T : unmanaged
                => src.Stream<T>().ToSpan(B.cellblocks<T>(w,count)).Blocked(w);
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock512<T> Blocks<T>(this IDomainSource src, W512 w, Interval<T> domain, int count = 1, Func<T,bool> filter = null)
            where T : unmanaged
                => src.Stream(domain,filter).ToSpan(B.cellblocks<T>(w,count)).Blocked(w);
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock512<T> Blocks<T>(this IDomainSource src, W512 w, T min, T max, int count = 1, Func<T,bool> filter = null)
            where T : unmanaged
                => src.Blocks(w, (min,max), count, filter);
        ...
        /// <param name="t">The cell type representative</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static SpanBlock512<T> Blocks<T>(this IDataSource src, W512 w, int count, T t)
            where T : unmanaged
                => src.Blocks<T>(w,count);
    }
}