...
namespace Z0
{
    ...
    public static class PolyRaze
    {
        ...
        /// <typeparam name="T">The generated value type</typeparam>
        [MethodImpl(Inline)]
        public static T[] Array<T>(this IDomainSource src, int length, Interval<T> domain)
            where T : unmanaged
        ...
        /// <typeparam name="T">The generated value type</typeparam>
        [MethodImpl(Inline)]
        public static T[] Array<T>(this IDomainSource src, int length, T min, T max, Func<T,bool> filter)
            where T : unmanaged
        ...
        /// <typeparam name="T">The generated value type</typeparam>
        [MethodImpl(Inline)]
        public static T[] Array<T>(this IDomainSource src, int length, T min, T max)
            where T : unmanaged
