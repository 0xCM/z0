...
namespace Z0
{
    ...
    {
        /// <summary>
        /// Reinterprets an input reference as a mutable <see cref='uint1'/> reference cell
        /// </summary>
        ...
        /// <summary>
        /// Reinterprets an input reference as a mutable <see cref='uint2'/> reference cell
        /// </summary>
        /// <param name="src">The source reference</param>
        /// <param name="dst">The target width selector</param>
        /// <typeparam name="S">The source type</typeparam>
        ...
        /// <summary>
        /// Reinterprets an input reference as as a mutable <see cref='uint3'/> reference cell
        /// </summary>
        /// <param name="src">The source reference</param>
        /// <param name="dst">The target width selector</param>
        /// <typeparam name="S">The source type</typeparam>
        ...
        /// <summary>
        /// Reinterprets an input reference as a mutable <see cref='uint4'/> reference cell
        /// </summary>
        /// <param name="src">The source reference</param>
        /// <param name="dst">The target width selector</param>
        /// <typeparam name="S">The source type</typeparam>
        ...
        /// <summary>
        /// Reinterprets an input reference as a mutable <see cref='uint5'/> reference cell
        /// </summary>
        /// <param name="src">The source reference</param>
        /// <param name="dst">The target width selector</param>
        /// <typeparam name="S">The source type</typeparam>
        ...
        /// <summary>
        /// Reinterprets an input reference as a mutable <see cref='uint6'/> reference cell
        /// </summary>
        /// <param name="src">The source reference</param>
        /// <param name="dst">The target width selector</param>
        /// <typeparam name="S">The source type</typeparam>
        ...
        /// <summary>
        /// Reinterprets an input reference as a mutable <see cref='uint7'/> reference cell
        /// </summary>
        /// <param name="src">The source reference</param>
        /// <param name="dst">The target width selector</param>
        /// <typeparam name="S">The source type</typeparam>
        ...
        /// <summary>
        /// Reinterprets an input reference as a mutable <see cref='octet'/> reference cell
        /// </summary>
        /// <param name="src">The source reference</param>
        /// <param name="dst">The target width selector</param>
        /// <typeparam name="S">The source type</typeparam>
