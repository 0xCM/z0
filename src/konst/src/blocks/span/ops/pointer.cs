...
namespace Z0
{
    ...
    partial struct BufferBlocks
    {
        ...
        /// <typeparam name="T">The reference type</typeparam>
        [MethodImpl(Inline),Op, Closures(Numeric8x16k)]
        public static unsafe T* ptr<T>(in SpanBlock16<T> src, int block)
            where T : unmanaged
        ...
        /// <typeparam name="T">The reference type</typeparam>
        [MethodImpl(Inline),Op, Closures(Numeric8x16k | NumericKind.Width32)]
        public static unsafe T* ptr<T>(in SpanBlock32<T> src, int block)
            where T : unmanaged
                => ptr(ref src.BlockRef(block));
        ...
        /// <typeparam name="T">The reference type</typeparam>
        [MethodImpl(Inline),Op, Closures(AllNumeric)]
        public static unsafe T* ptr<T>(in SpanBlock64<T> src, int block)
            where T : unmanaged
                => ptr(ref src.BlockRef(block));
        ...
        /// <typeparam name="T">The reference type</typeparam>
        [MethodImpl(Inline),Op, Closures(AllNumeric)]
        public static unsafe T* ptr<T>(in SpanBlock128<T> src, int block)
            where T : unmanaged
                => ptr(ref src.BlockRef(block));
        ...
        /// <typeparam name="T">The reference type</typeparam>
        [MethodImpl(Inline),Op, Closures(AllNumeric)]
        public static unsafe T* ptr<T>(in SpanBlock256<T> src, int block)
            where T : unmanaged
                => ptr(ref src.BlockRef(block));
    }
}