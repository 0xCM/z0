...
namespace Z0
{
    ...
    partial struct Blocks
    {
        ...
        public static Block8<byte> create(W8 n, byte src)
            => new Block8<byte>(z.cover(src,1));

        /// <summary>
        /// Creates a 16-bit blocked container from 1 16-bit cell
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block16<ushort> create(W16 n, ushort src)
            => new Block16<ushort>(z.cover(src,1));

        /// <summary>
        /// Creates a 16-bit blocked container from 1 64-bit cell
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block16<ulong> create(W16 n, ulong src)
            => new Block16<ulong>(z.cover(src,1));

        /// <summary>
        /// Creates a 32-bit blocked container from 1 64-bit cell
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block32<ulong> create(W32 n, ulong src)
            => new Block32<ulong>(z.cover(src,1));

        /// <summary>
        /// Creates a 32-bit blocked container from 4 8-bit cells
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block32<byte> create(W32 n, byte x0, byte x1, byte x2, byte x3)
        {
            var dst = 0u;
            seek8(dst,0) = x0;
            seek8(dst,1) = x1;
            seek8(dst,2) = x2;
            seek8(dst,3) = x3;
            return new Block32<byte>(cover(@as<byte>(dst),4));
        }
        ...
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block32<ushort> create(W32 n, ushort x0, ushort x1)
        ...
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block32<uint> create(W32 n, uint x0)
            => new Block32<uint>(x0);
        ...
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block64<byte> create(W64 w, byte x0, byte x1, byte x2, byte x3, byte x4, byte x5, byte x6, byte x7)
        ...
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block64<ushort> create(W64 w, ushort x0, ushort x1, ushort x2, ushort x3)
        ...
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block64<uint> create(W64 w, uint x0, uint x1)
        ...
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block64<ulong> create(W64 w, ulong x0)
        ...
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block128<byte> create(W128 n, 
        ...
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block128<ushort> create(W128 n, 
        ...
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block128<uint> create(W128 n, uint x0, uint x1, uint x2, uint x3)            
        ...
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block128<ulong> create(W128 w, ulong x0, ulong x1)            
        ...
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block256<byte> create(W256 w, 
            byte x0, byte x1, byte x2, byte x3, byte x4, byte x5, byte x6, byte x7, 
            byte x8, byte x9, byte xA, byte xB, byte xC, byte xD, byte xE, byte xF,
        ...
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block256<ushort> create(W256 n, 
            ushort x0, ushort x1, ushort x2, ushort x3, ushort x4, ushort x5, ushort x6, ushort x7, 
        ...
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block256<uint> create(W256 n, 
        ...
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block256<ulong> create(W256 n, ulong x0, ulong x1, ulong x2, ulong x3)
        ...
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block512<ulong> create(W512 w, ulong x0, ulong x1, ulong x2, ulong x3, ulong x4, ulong x5, ulong x6, ulong x7)
        ...
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block512<uint> create(W512 n, 
            uint x0, uint x1, uint x2, uint x3, uint x4, uint x5, uint x6, uint x7, 
