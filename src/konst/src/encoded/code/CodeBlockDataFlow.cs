...
namespace Z0
{
    ...
    public readonly struct CodeBlockDataFlow : IDataFlow<BasedCodeBlock>
    {
        ...
        [MethodImpl(Inline)]
        public CodeBlockDataFlow(MemoryAddress @base, BasedCodeBlock input, BasedCodeBlock output)
        {
        ...
        [MethodImpl(Inline)]
        public CodeBlockDataFlow(MemoryAddress @base, byte[] input, byte[] output)
        {
            Base = @base;
        ...
        [MethodImpl(Inline)]
        public static implicit operator DataFlow<BasedCodeBlock> (CodeBlockDataFlow src)
        ...
        [MethodImpl(Inline)]
        public bool Equals(CodeBlockDataFlow src)
