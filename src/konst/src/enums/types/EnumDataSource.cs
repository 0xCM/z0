...
namespace Z0
{
    ...
    {        
        public static EnumDataSource Empty 
            => new EnumDataSource(FileName.Empty, string.Empty, EnumScalarKind.None, string.Empty);
        ...
        /// </summary>
        public EnumScalarKind BaseType {get;}
        ...
        [MethodImpl(Inline)]
        public EnumDataSource(FileName File, string EnumName, EnumScalarKind BaseType, string Description)
        {
            this.File = File;
