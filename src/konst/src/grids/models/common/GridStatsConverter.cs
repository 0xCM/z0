...
namespace Z0
{
    ...
    public readonly struct GridStatsConverter
    {
        readonly Vector256<uint> Storage;

        [MethodImpl(Inline)]
        public GridStatsConverter(uint SrcCount, uint SrcCellSize, uint DstCellSize, uint SrcSize, uint DstCount, uint DstSize)
