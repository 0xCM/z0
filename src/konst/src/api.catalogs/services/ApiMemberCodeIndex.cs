...
namespace Z0
{
    ...
    public readonly struct ApiMemberCodeIndex
    {
        ...
        public IEnumerable<ApiMemberCode> Search(ApiOperatorKind @class)
            => from code in  Values
                let method = code.Member.Method
