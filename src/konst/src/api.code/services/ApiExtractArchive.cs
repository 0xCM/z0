...
namespace Z0
{
    ...
    public readonly struct ApiExtractArchive : IFileArchive
    {
        ...
        /// </summary>
        public Index<ApiExtractBlock> Read(ApiHostUri host)
        {
            ...
            if(path.IsEmpty)
            {
                ...
                return sys.empty<ApiExtractBlock>();
            }
        ...
        /// </summary>
        public IEnumerable<ApiExtractBlock> ApiCode(PartId owner)
        {
        ...
        /// </summary>
        public IEnumerable<ApiExtractBlock> ApiCode(Func<FS.FileName,bool> predicate)
        {
        ...
        static ApiExtractBlock[] read(FS.FilePath src)
