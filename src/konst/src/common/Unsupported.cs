...
namespace Z0
{
    ...
    public static class Unsupported
    {
        ...
        public static NotSupportedException define<T>()
            => new NotSupportedException($"The type {typeof(T).Name}, it is a mystery");
        ...
        public static NotSupportedException define(Type t)
            => new NotSupportedException($"The type {t}, it is a mystery");

        /// <summary>
        /// Populates a <see cref="NotSupportedException"/> complaining that a  value is not supported
        /// </summary>
        /// <typeparam name="T">The value type</typeparam>
        public static NotSupportedException value<T>(T t)
            => new NotSupportedException($"The value {t}, it is bad");
        ...
        public static NotSupportedException define(NumericKind k)
            => new NotSupportedException($"The type {k.ToString()} is not supported in the current context");
