...
namespace Z0
{
    ...
    public readonly struct ImageLiterals
    {
        ...
        public const byte ELEMENT_TYPE_END = 0x0;

        public const byte ELEMENT_TYPE_VOID = 0x1;

        public const byte ELEMENT_TYPE_BOOLEAN = 0x2;

        public const byte ELEMENT_TYPE_CHAR = 0x3;

        public const byte ELEMENT_TYPE_I1 = 0x4;

        public const byte ELEMENT_TYPE_U1 = 0x5;

        public const byte ELEMENT_TYPE_I2 = 0x6;

        public const byte ELEMENT_TYPE_U2 = 0x7;

        public const byte ELEMENT_TYPE_I4 = 0x8;

        public const byte ELEMENT_TYPE_U4 = 0x9;

        public const byte ELEMENT_TYPE_I8 = 0xa;

        public const byte ELEMENT_TYPE_U8 = 0xb;

        public const byte ELEMENT_TYPE_R4 = 0xc;

        public const byte ELEMENT_TYPE_R8 = 0xd;

        public const byte ELEMENT_TYPE_STRING = 0xe;

        public const byte ELEMENT_TYPE_PTR = 0xf;
