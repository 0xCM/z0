...
namespace Z0
{
    ...
    public readonly struct ApiUriBuilder
    {
        ...
        public static string TestCase(MethodInfo method)
            => $"{Identify.OwningPartText(method.DeclaringType)}{PathSep}{method.DeclaringType.Name}{PathSep}{method.Name}";
        ...
        public static string TestCase(Type host, string fullname)
            => $"{Identify.OwningPartText(host)}{PathSep}{host.Name}{PathSep}{fullname}";
        ...
        public static string TestCase(Type host, OpIdentity id)
            => $"{Identify.OwningPartText(host)}{PathSep}{host.Name}{PathSep}{id}";
    }
}