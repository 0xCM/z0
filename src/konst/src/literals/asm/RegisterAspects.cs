...
{        
    ...
    public readonly struct RegisterAspects
    {
        ...
        public const RegisterAspect RAX = Unsaved | ReturnStore;

        public const RegisterAspect RCX = Unsaved | ArgStore;

        public const RegisterAspect RDX = Unsaved | ArgStore;

        public const RegisterAspect RBX = Saved;

        public const RegisterAspect RSP = Unsaved | StackPointer;

        public const RegisterAspect RBP = Saved;

        public const RegisterAspect RSI = Unsaved | ArgStore;

        public const RegisterAspect RDI = Unsaved | ArgStore;

        public const RegisterAspect R8Q = Unsaved | ArgStore;

        public const RegisterAspect R9Q = Unsaved | ArgStore;

        public const RegisterAspect R10Q = Unsaved;

        public const RegisterAspect R11Q = Unsaved;

        public const RegisterAspect R12Q = Saved;

        public const RegisterAspect R13Q = Saved;

        public const RegisterAspect R14Q = Saved;

        public const RegisterAspect R15Q = Saved;
