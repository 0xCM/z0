...
namespace Z0
{
    ...
    /// <summary>
    /// Defines a type-level representation of <see cref='DW.W64'/> with a <see cref='TS.Signed'/> classifier
    /// </summary>
    public readonly struct W64i : TNumericWidth<W>
    {
        ...
        /// The width identity
        /// </summary>
        public const string Identifier = "w64i";
