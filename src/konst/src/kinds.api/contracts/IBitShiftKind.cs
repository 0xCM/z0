...
namespace Z0
{
    ...
    /// </summary>
    public interface IBitShiftKind : IOpKind, IOpKind<BitShiftApiKey>
    {
    ...
    public interface IBitShiftKind<F> : IBitShiftKind, IOpKind<F,BitShiftApiKey>
    ...
    {
        BitShiftApiKey IBitShiftKind.Kind => default(K).Kind;
