...
namespace Z0
{
    ...
    public readonly struct ProcessEmitters
    {
        public static Index<LocatedImageRow> emit(LocatedImages src, FS.FilePath dst)
        {
            var images = ProcessExtractors.images();
        ...
        [Op]
        static Index<LocatedImageRow> rows(LocatedImages src)
        {
            var count = src.Count;
            var images = src.View;
