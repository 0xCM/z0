...
namespace Z0
{
    ...
    public static partial class MemBlocks
    {
        ...
        [MethodImpl(Inline)]
        static unsafe Vector128<byte> vload(W128 w, in byte src)
            => LoadDquVector128(gptr(src));

        [MethodImpl(Inline)]
        static unsafe Vector256<byte> vload(W256 w, in byte src)
            => LoadDquVector256(gptr(src));

        [MethodImpl(Inline)]
        static unsafe Vector512<byte> vload(W512 w, in byte src)
        ...
        [MethodImpl(Inline)]
        static unsafe void vstore(Vector512<byte> src, ref byte dst)
        {
        ...
        [MethodImpl(Inline)]
        static unsafe Vector128<byte> vbroadcast(W128 w, byte src)
