...
namespace Z0
{
    ...
    /// </summary>
    [Free]
    public interface IBitLogicKind : IApiKey, IApiKind<BinaryBitLogicApiClass>
    {
        BinaryBitLogicApiClass Kind {get;}
    ...
    [Free]
    public interface IBitLogicKind<F> : IBitLogicKind, IApiKind<F,BinaryBitLogicApiClass>
    ...
    public interface IBitLogicKind<F,T> : IBitLogicKind<F>
        where F : unmanaged, IBitLogicKind
    {
        BinaryBitLogicApiClass IBitLogicKind.Kind
            => default(F).Kind;
    }
}