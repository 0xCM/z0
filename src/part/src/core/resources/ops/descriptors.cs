...
namespace Z0
{
    ...
    partial struct Resources
    {
        ...
        {
            var dst = root.list<ComponentAssets>();
            root.iter(src, component => dst.Add(descriptors(component)));
            return dst.ToArray();
        }

        [MethodImpl(Inline), Op]
        public static ComponentAssets descriptors(Assembly src, utf8 match)
        ...
        [Op]
        static unsafe Index<Asset> collect(Assembly src, utf8? match = null)
        {
