...
namespace Z0
{
    ...
    partial class Widths
    {
        ...
        /// <typeparam name="T">The type to test</typeparam>
        [MethodImpl(Inline), Op, Closures(Closure)]
        public static bit test<T>(W16 w)
            => size<T>() == 2;
        ...
        /// <typeparam name="T">The type to test</typeparam>
        [MethodImpl(Inline), Op, Closures(Closure)]
        public static bit test<T>(W32 w)
            => size<T>() == 4;
        ...
        /// <typeparam name="T">The type to test</typeparam>
        [MethodImpl(Inline), Op, Closures(Closure)]
        public static bit test<T>(W64 w)
            => size<T>() == 8;
        ...
        /// <typeparam name="T">The type to test</typeparam>
        [MethodImpl(Inline), Op, Closures(Closure)]
        public static bit test<T>(W128 w)
            => size<T>() == 16;
        ...
        /// <typeparam name="T">The type to test</typeparam>
        [MethodImpl(Inline), Op, Closures(Closure)]
        public static bit test<T>(W256 w)
            => size<T>() == 32;
    }
}