...
namespace System.Reflection.Metadata
{
    ...
    public sealed class Mdv : IDisposable
    {
        ...
        {
            var arguments = MdvArgs.TryParse(args);
            if (arguments == null)
            {
                Console.WriteLine(MdvArgs.Help);
                return 1;
            }
        ...
        readonly MdvArgs _arguments;

        readonly TextWriter _writer;

        string _pendingTitle;

        public Mdv(MdvArgs arguments)
        {
        ...
        void WriteData(string line, params object[] args)
        {
        ...
        static bool IsManagedMetadata(Stream stream)
        {
            long oldPosition = stream.Position;
        ...
        static GenerationData ReadBaseline(string peFilePath, bool embeddedPdb)
        {
            try
            {
        ...
        static GenerationData ReadDelta(string metadataPath, string ilPathOpt)
        {
            byte[] ilDelta;
            try
            {
        ...
        void VisualizeGenerations(List<GenerationData> generations)
        {
        ...
        static void VisualizeDebugDirectory(PEReader peReader, TextWriter writer)
        {
        ...
        static readonly string[] s_PEExtensions = new[] { "*.dll", "*.exe", "*.netmodule", "*.winmd" };

        static IEnumerable<string> GetAllBinaries(string dir)
        {
        ...
        void VisualizeStatistics(MetadataReader mdReader)
        {
        ...
        void VisualizeAssemblyReferences(MetadataReader mdReader)
        {
        ...
        void VisualizeMemberRefs(MetadataReader mdReader)
        {
