...
namespace Z0
{
    ...
    public readonly struct CilOpCodes
    {
        ...
        public static CilOpCodeInfo pack(C id, string name, CilOpCodeType type, CilOperandType optype, byte opcount, ushort code, CilStackBehaviour sb1, CilStackBehaviour sb2)
