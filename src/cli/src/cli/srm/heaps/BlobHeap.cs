    ...
    partial class SRM
    {
        ...
        public struct BlobHeap
        {
            ...
            internal BlobHeap(MemoryBlock block, MetadataKind metadataKind)
            {
                ...
                {
                    var blobs = new byte[(int)VirtualIndex.Count][];

                    blobs[(int)VirtualIndex.ContractPublicKeyToken] = new byte[]
                    {
                        0xB0, 0x3F, 0x5F, 0x7F, 0x11, 0xD5, 0x0A, 0x3A
                    };

                    blobs[(int)VirtualIndex.ContractPublicKey] = new byte[]
                    {
                    ...
                    blobs[(int)VirtualIndex.AttributeUsage_AllowSingle] = new byte[]
                    {
                        // preamble:
                        0x01, 0x00,
                    ...
                    blobs[(int)VirtualIndex.AttributeUsage_AllowMultiple] = new byte[]
                    {
                        // preamble:
                        0x01, 0x00,
                        // target (template parameter):
