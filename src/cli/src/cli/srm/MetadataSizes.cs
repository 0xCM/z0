...
namespace Z0
{
    ...
    partial class SRM
    {
        ...
        {
            const int StreamAlignment = 4;

            // Call the length of the string (including the terminator) m (we require m <= 255);
            public const int MaxMetadataVersionByteCount = 0xff - 1;

            public const int PdbIdSize = 20;

            public readonly int MetadataVersionPaddedLength;
            ...
            public readonly bool IsEncDelta;

            public readonly bool IsCompressed;

            public readonly bool BlobReferenceIsSmall;

            public readonly bool StringReferenceIsSmall;

            public readonly bool GuidReferenceIsSmall;

            public readonly bool CustomAttributeTypeCodedIndexIsSmall;

            public readonly bool DeclSecurityCodedIndexIsSmall;

            public readonly bool EventDefReferenceIsSmall;

            public readonly bool FieldDefReferenceIsSmall;

            public readonly bool GenericParamReferenceIsSmall;

            public readonly bool HasConstantCodedIndexIsSmall;

            public readonly bool HasCustomAttributeCodedIndexIsSmall;

            public readonly bool HasFieldMarshalCodedIndexIsSmall;

            public readonly bool HasSemanticsCodedIndexIsSmall;

            public readonly bool ImplementationCodedIndexIsSmall;

            public readonly bool MemberForwardedCodedIndexIsSmall;

            public readonly bool MemberRefParentCodedIndexIsSmall;

            public readonly bool MethodDefReferenceIsSmall;

            public readonly bool MethodDefOrRefCodedIndexIsSmall;

            public readonly bool ModuleRefReferenceIsSmall;

            public readonly bool ParameterReferenceIsSmall;

            public readonly bool PropertyDefReferenceIsSmall;

            public readonly bool ResolutionScopeCodedIndexIsSmall;

            public readonly bool TypeDefReferenceIsSmall;

            public readonly bool TypeDefOrRefCodedIndexIsSmall;

            public readonly bool TypeOrMethodDefCodedIndexIsSmall;

            public readonly bool DocumentReferenceIsSmall;

            public readonly bool LocalVariableReferenceIsSmall;

            public readonly bool LocalConstantReferenceIsSmall;

            public readonly bool ImportScopeReferenceIsSmall;

            public readonly bool HasCustomDebugInformationCodedIndexIsSmall;
            ...
            public MetadataSizes(ImmutableArray<int> rowCounts, ImmutableArray<int> externalRowCounts, ImmutableArray<int> heapSizes, int metadataVersionByteCount, bool isStandaloneDebugMetadata)
            {
            ...
            public bool IsStandaloneDebugMetadata
                => StandalonePdbStreamSize > 0;

            public bool IsPresent(TableIndex table)
                => (PresentTablesMask & (1UL << (int)table)) != 0;
            ...
            internal static ulong ComputeNonEmptyTableMask(ImmutableArray<int> rowCounts)
            {
                ulong mask = 0;
                for (int i = 0; i < rowCounts.Length; i++)
                {
            ...
            internal int GetTableSize(TableIndex index, int rowSize)
                => RowCounts[(int)index] * rowSize;

            internal bool IsReferenceSmall(int tagBitSize, params TableIndex[] tables)
                => IsCompressed && ReferenceFits(16 - tagBitSize, tables);

            internal bool ReferenceFits(int bitCount, TableIndex[] tables)
            {
