...
namespace Z0
{
    ...
    {           
        ...
        {
            var y = v16i(count);
            var lo = vsllr(vinflate(V0d.vlo(src),w256,z16i),y);
            var hi = vsllr(vinflate(V0d.vhi(src),w256,z16i),y);
        ...
        {
            var y = v16u(count);
            var lo = vsllr(vinflate(V0d.vlo(src),w256,z16),y);
            var hi = vsllr(vinflate(V0d.vhi(src),w256,z16),y);
