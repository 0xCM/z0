...
namespace Z0
{
    ...
    [ApiHost]
    public readonly struct VInflator : IApiHost<VInflator>
    {
        /// <summary>
        /// 16x8u -> 16x16u
        /// </summary>
        ...
        public static Vector256<short> vinflate(Vector128<sbyte> src, W16 w)
            => Vectors.vconcat(dvec.vmaplo(src, n128, z16i), dvec.vmaphi(src, n128, z16i));
