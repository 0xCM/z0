...
namespace Z0
{
    ...
    [ApiHost]
    public readonly struct VZipper : IApiHost<VZipper>
    {
        /// <summary>
        /// (8x16i,8x16i) -> 16x8i
        /// </summary>
        ...
        [MethodImpl(Inline), VZip]
        public static Vector128<byte> vzip(Vector128<short> x, Vector128<short> y, W8 w, N0 z)
            => dvec.vpackus(x,y);
        ...
        public static Vector256<sbyte> vzip(Vector256<short> x, Vector256<short> y, W8 w)            
            => dvec.vperm4x64(dvec.vpackss(x,y), Perm4L.ACBD);
        ...
        [MethodImpl(Inline), VZip]
        public static Vector128<ushort> vzip(Vector128<int> x, Vector128<int> y, W16 w, N0 z)
            => dvec.vpackus(x,y);
        ...
        /// <param name="w">Specifies a zero-extended target</param>
        [MethodImpl(Inline), VZip]
        public static Vector256<byte> vzip(Vector256<short> x, Vector256<short> y, N8 w, N0 z)
            => dvec.vpackus(x,y);
        ...
        /// <param name="w">Specifies a zero-extended target</param>
        [MethodImpl(Inline), VZip]
        public static Vector256<ushort> vzip(Vector256<int> x, Vector256<int> y, N16 w, N0 z)
            => dvec.vpackus(x,y);
        ...
        public static Vector128<byte> vzip(Vector256<uint> x, Vector256<uint> y, W8 w)  
            => dvec.vcompact(dvec.vcompact(x, y, n256,z16), w128, z8);
        ...
        public static Vector256<uint> vzip(Vector256<ulong> x, Vector256<ulong> y, W32 w)
            => Vectors.vconcat(dvec.vcompact(x, n128,z32), dvec.vcompact(y, n128,z32));
        ...
        public static Vector128<byte> vzip(Vector128<uint> x0, Vector128<uint> x1, Vector128<uint> x2, Vector128<uint> x3, W8 w)            
            => dvec.vcompact(dvec.vcompact(x0,x1,n128,z8), dvec.vcompact(x2,x3,n128,z8),w128,z8);
