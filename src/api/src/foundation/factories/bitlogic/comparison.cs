...
namespace Z0
{
    ...
    partial struct BitLogicSpec
    {
        ...
        [MethodImpl(Inline)]
        public static ComparisonExpr compare(ComparisonApiClass kind, ILogicExpr lhs, ILogicExpr rhs, params ILogicVarExpr[] variables)
        ...
        /// <typeparam name="T">The operand type</typeparam>
        [MethodImpl(Inline)]
        public static ComparisonExpr<T> compare<T>(ComparisonApiClass kind, ILogicExpr<T> lhs, ILogicExpr<T> rhs, params IVarExpr<T>[] variables)
            where T : unmanaged
                => Comparisons.define(kind, lhs,rhs, variables);
        ...
        public static ComparisonExpr equals(ILogicExpr lhs, ILogicExpr rhs, params ILogicVarExpr[] variables)
            => Comparisons.define(ComparisonApiClass.Eq, lhs,rhs,variables);
