...
namespace Z0
{
    ...
    class MetaTableEmitter
    {
        ...
        public void Emit(int generation = -1)
        {
        ...
        void WriteRows(string title)
        {
            ...
            var columnWidths = new int[pendingRows.First().Length];
            ...
            var tableWidth = columnWidths.Sum() + columnWidths.Length;
            var horizontalSeparator = new string('=', tableWidth);
