...
namespace Z0.MS
{
    ...
    public sealed class ClrmdRuntime : ClrRuntime
    {
        ...
        public override bool IsThreadSafe 
            => _helpers.Factory.IsThreadSafe && _helpers.DataReader.IsThreadSafe;
        ...
        public override ClrHeap Heap 
            => _heap ??= _helpers.Factory.GetOrCreateHeap();
        ...
        public override ClrType? GetTypeByMethodTable(ulong methodTable) 
            => _helpers.Factory.GetOrCreateType(methodTable, 0);
        ...
        public override IEnumerable<ClrHandle> EnumerateHandles() 
            => _helpers.EnumerateHandleTable(this);

        public override string? GetJitHelperFunctionName(ulong ip) 
            => _helpers.GetJitHelperFunctionName(ip);

        public override ClrMethod? GetMethodByHandle(ulong methodHandle) 
            => _helpers.Factory.CreateMethodFromHandle(methodHandle);
