...
namespace Z0.MS
{
    ...
    public class ClrmdMethod : ClrMethod
    {
        ...
        public override ImmutableArray<ILToNativeMap> ILOffsetMap 
            => _helpers?.GetILMap(NativeCode, _hotCold) ?? default;

        public override HotColdRegions HotColdInfo 
            => _hotCold;

        public override ulong NativeCode 
            => HotColdInfo.HotStart != 0 
            ? HotColdInfo.HotStart 
        ...
        public override bool IsStatic 
            => (_attrs & MethodAttributes.Static) == MethodAttributes.Static;

        public override bool IsFinal 
            => (_attrs & MethodAttributes.Final) == MethodAttributes.Final;

        public override bool IsPInvoke 
            => (_attrs & MethodAttributes.PinvokeImpl) == MethodAttributes.PinvokeImpl;

        public override bool IsVirtual 
            => (_attrs & MethodAttributes.Virtual) == MethodAttributes.Virtual;

        public override bool IsAbstract 
            => (_attrs & MethodAttributes.Abstract) == MethodAttributes.Abstract;

        public override bool IsPublic 
            => (_attrs & MethodAttributes.MemberAccessMask) == MethodAttributes.Public;

        public override bool IsPrivate 
            => (_attrs & MethodAttributes.MemberAccessMask) == MethodAttributes.Private;
