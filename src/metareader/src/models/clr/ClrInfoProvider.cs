...
namespace Z0
{
    ...
    partial struct ClrDataModel
    {
        ...
        public static class ClrInfoProvider
        {
            ...
            /// </summary>
            public static string GetDacRequestFileName(ClrFlavor flavor, MsD.Architecture currentArchitecture, MsD.Architecture targetArchitecture, VersionInfo version, Platform platform)
            {
