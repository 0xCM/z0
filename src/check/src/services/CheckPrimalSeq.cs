...
namespace Z0
{
    ...
    public readonly struct CheckPrimalSeq : ICheckPrimalSeq
    {
        ...
        /// <param name="line">The file line number of invocation</param>
        /// <typeparam name="T">The element type</typeparam>
        public static void eq(ReadOnlySpan<byte> a, ReadOnlySpan<byte> b, [Caller] string caller = null, [File] string file = null, [Line] int? line = null)
        ...
        /// <param name="line">The file line number of invocation</param>
        /// <typeparam name="T">The element type</typeparam>
        public static void eq(ReadOnlySpan<sbyte> a, ReadOnlySpan<sbyte> b, [Caller] string caller = null, [File] string file = null, [Line] int? line = null)
            => require(TestEq(a, b), "a != b", caller, file, line);
        ...
        /// <param name="line">The file line number of invocation</param>
        /// <typeparam name="T">The element type</typeparam>
        public static void eq(ReadOnlySpan<int> a, ReadOnlySpan<int> b, [Caller] string caller = null, [File] string file = null, [Line] int? line = null)
            => require(TestEq(a, b), "a != b", caller, file, line);
        ...
        /// <param name="line">The file line number of invocation</param>
        /// <typeparam name="T">The element type</typeparam>
        public static void eq(ReadOnlySpan<uint> a, ReadOnlySpan<uint> b, [Caller] string caller = null, [File] string file = null, [Line] int? line = null)
            => require(TestEq(a, b), "a != b", caller, file, line);
        ...
        /// <param name="line">The file line number of invocation</param>
        /// <typeparam name="T">The element type</typeparam>
        public static void eq(ReadOnlySpan<ulong> a, ReadOnlySpan<ulong> b, [Caller] string caller = null, [File] string file = null, [Line] int? line = null)
            => require(TestEq(a, b), "a != b", caller, file, line);
    }
}