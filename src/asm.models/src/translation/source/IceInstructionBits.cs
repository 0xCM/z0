...
namespace Z0.Ice
{
    ...
    {
        [Ignore]
        public static IceInstructionBits init()
            => new IceInstructionBits(Enums.literals<InstructionFieldIndex>(), Enums.literals<InstructionFieldSize>());

        public readonly ReadOnlySpan<InstructionFieldIndex> Indices;

        public readonly ReadOnlySpan<InstructionFieldSize> Sizes;

        public IceInstructionBits(InstructionFieldIndex[] fields, InstructionFieldSize[] sizes)
        {
            Indices = fields;
            Sizes = sizes;
        }
