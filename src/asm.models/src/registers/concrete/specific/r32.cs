...
namespace Z0.Asm
{
    ...
    {
        public readonly struct eax : IRegister<eax,W32,uint>
        {
        ...
        public readonly struct ecx : IRegister<ecx,W32,uint>
        {
            public uint Content {get;}
        ...
        public readonly struct edx : IRegister<edx,W32,uint>
        {
            public uint Content {get;}
        ...
        public readonly struct ebx : IRegister<ebx,W32,uint>
        {
            public uint Content {get;}
        ...
        public readonly struct esi : IRegister<esi,W32,uint>
        {
            public uint Content {get;}
        ...
        public readonly struct edi : IRegister<edi,W32,uint>
        {
            public uint Content {get;}
        ...
        public readonly struct esp : IRegister<esp,W32,uint>
        {
            public uint Content {get;}
        ...
        public readonly struct ebp : IRegister<ebp,W32,uint>
        {
            public uint Content {get;}
        ...
        public readonly struct r8d : IRegister<r8d,W32,uint>
        {
            public uint Content {get;}
        ...
        public readonly struct r9d : IRegister<r9d,W32,uint>
        {
            public uint Content {get;}
        ...
        public readonly struct r10d : IRegister<r10d,W32,uint>
        {
            public uint Content {get;}
        ...
        public readonly struct r11d : IRegister<r11d,W32,uint>
        {
            public uint Content {get;}
        ...
        public readonly struct r12d : IRegister<r12d,W32,uint>
        {
            public uint Content {get;}
        ...
        public readonly struct r13d : IRegister<r13d,W32,uint>
        {
            public uint Content {get;}
        ...
        public readonly struct r14d : IRegister<r14d,W32,uint>
        {
            public uint Content {get;}
        ...
        public readonly struct r15d : IRegister<r15d,W32,uint>
        {
            public uint Content {get;}
