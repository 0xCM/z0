...
namespace Z0.Asm
{
    ...
    public readonly struct InstructionTokens
    {
        [MethodImpl(Inline)]
        public static InstructionTokens create(AsmTokenIndex index)
            => new InstructionTokens(index);
        ...
        InstructionTokens(AsmTokenIndex index)
        {
            Models = index.Models;
