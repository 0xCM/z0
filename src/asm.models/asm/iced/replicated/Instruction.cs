...
namespace Z0.Asm
{
    ...
    public struct Instruction : IInstructionInfo
    {
        ...
        public MemDx MemDx => Z0.asm.memDx(MemoryDisplacement, MemoryDisplSize);
        ...
        public Register MemorySegment {get; set;}
        //
        // Summary:
        ...
        public Register MemoryBase {get; set;}
        //
        // Summary:
        ...
        //     Use this property if the operand has kind Iced.Intel.OpKind.Memory
        public Register MemoryIndex {get; set;}
        //
        // Summary:
