    ...
    partial class BitGrid
    {
        ...
        public static BitVector<N,T> row<M,N,T>(BitGrid16<M,N,T> g, int index)
            ...
            where N : unmanaged, ITypeNat
                => generic<T>(Bits.extract(g.Content, ScalarCast.uint8(nat32i<N>()*index),(byte)nat32i<N>()));
        ...
        public static BitVector<N,T> row<M,N,T>(BitGrid64<M,N,T> g, int index)
            ...
            where M : unmanaged, ITypeNat
            where N : unmanaged, ITypeNat
                => generic<T>(gbits.extract(g.Content, (byte)(index*nat32i<N>()), nat8u<N>()));
        ...
        public static BitVector<N,T> row<M,N,T>(SubGrid16<M,N,T> g, int index, N width = default)
            ...
            where N : unmanaged, ITypeNat
            where T : unmanaged
                => generic<T>(Bits.extract(g.Content, ScalarCast.uint8(index* nat32i<N>()), (byte)nat32i<N>()));
