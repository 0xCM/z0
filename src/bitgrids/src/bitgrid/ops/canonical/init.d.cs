...
namespace Z0
{
    ...
    partial class BitGrid
    {
        ...
        {
            var blocksize = n256;
            var blocks = SpanBlocks.alloc<T>(blocksize, BitCalcs.tableblocks(blocksize, m,n,d));
            broadcast(d, blocks);
        ...
        static BitGrid128<M,N,T> init128<M,N,T>(M m = default, N n = default, T d = default)
            ...
            where N : unmanaged, ITypeNat
            where T : unmanaged
                => new BitGrid128<M,N,T>(z.vbroadcast(n128, d));
        ...
        static BitGrid256<M,N,T> init256<M,N,T>(M m = default, N n = default, T d = default)
            ...
            where N : unmanaged, ITypeNat
            where T : unmanaged
                => new BitGrid256<M,N,T>(z.vbroadcast(n256, d));
    }
}