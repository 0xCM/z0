...
namespace Z0
{
    ...
    public readonly struct ShiftOperatorClass : IOperatorClassHost<ShiftOperatorClass,ApiOperatorKind>
    {
    ...
    public readonly struct ShiftOperatorClass<T> : IOperatorClassHost<ShiftOperatorClass<T>,ApiOperatorKind,T>
    {
        [MethodImpl(Inline)]
