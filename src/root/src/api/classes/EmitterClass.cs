...
namespace Z0
{
    ...
    public readonly struct EmitterClass : IOperatorClassHost<EmitterClass,ApiOperatorKind>
    {
    ...
    public readonly struct EmitterClass<T> : IOperatorClassHost<EmitterClass<T>,ApiOperatorKind,T>
    {
        public ApiOperatorKind Kind
            => ApiOperatorKind.Emitter;
