...
namespace Z0.Asm
{
    ...
    sealed class ApiInstructionConverter : AsmWfService<ApiInstructionConverter>, IApiInstructionCoverter
    {
        public Index<ApiInstruction> Convert(ApiCodeBlock code, Index<IceInstruction> src)
        {
