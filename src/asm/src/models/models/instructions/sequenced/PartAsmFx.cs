...
{        
    ...
    /// </summary>         
    public readonly struct PartAsmFx
    {
        /// <summary>
        /// The defining part
        /// </summary>
        ...
        /// </summary>
        public readonly HostAsmFx[] Data;

        [MethodImpl(Inline)]        
        public PartAsmFx(PartId part, HostAsmFx[] src)
        {
            Part = part;
            Data = src;
        }        

        public ReadOnlySpan<HostAsmFx> View
        {
            [MethodImpl(Inline)] 
            get => Data;
        }
        ...
        public IEnumerable<BasedAsmFx> Located
