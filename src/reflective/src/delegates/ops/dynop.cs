...
namespace Z0
{
    ...
    partial class Delegates
    {
        ...
        [MethodImpl(Inline)]
        public static DynamicDelegate<D> dynop<D>(OpIdentity id, MethodInfo src, DynamicMethod dst)
            where D : Delegate
        ...
        [MethodImpl(Inline)]
        public static DynamicDelegate dynop(OpIdentity id, MethodInfo src, DynamicMethod dst, Type @delegate)
        ...
        /// <param name="@delegate">The target delegate type</param>
        [MethodImpl(Inline)]
        public static DynamicDelegate dynop(OpIdentity id, MethodInfo src, DynamicMethod dst, Delegate op)
