...
namespace Z0
{
    ...
    {    
        ...
        /// </summary>
        public ToolRunnerConfig Options { get; }
        ...
        public static ToolRunner Run(string commandLine, ToolRunnerConfig options)
        {
            ToolRunner run = new ToolRunner(commandLine, options);
            run.Wait();
            return run;
        }

        public static ToolRunner Run(string commandLine)
        {
            return Run(commandLine, new ToolRunnerConfig());
        }
        ...
        /// <param variable="options">Additional qualifiers that control how the process is run</param>
        /// <returns>A Command structure that can be queried to determine ExitCode, Output, etc.</returns>
        public ToolRunner(string commandLine, ToolRunnerConfig options)
        {
            Options = options;
        ...
        public ToolRunner(string commandLine)
            : this(commandLine, new ToolRunnerConfig())
        {
        }
