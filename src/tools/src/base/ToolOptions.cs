...
namespace Z0
{
    ...
    public sealed class ToolOptions
    {
        ...
        public ToolOptions Clone()
        {
            return (ToolOptions)MemberwiseClone();
        }
        ...
        /// Updates the Start propery and returns the updated commandOptions.
        /// </summary>
        public ToolOptions AddUseShellExecute()
        {
        ...
        /// </summary>
        public ToolOptions AddNoWindow()
        {
            noWindow = true;
            return this;
        }
        ...
        /// </summary>
        public ToolOptions AddTimeout(int milliseconds)
        {
        ...
        /// </summary>
        public ToolOptions AddInput(string input)
        {
            this.input = input;
            return this;
        }
        ...
        /// </summary>
        public ToolOptions AddCurrentDirectory(string directoryPath)
        {
        ...
        /// </summary>
        public ToolOptions AddOutputFile(string outputFile)
        {
        ...
        /// </summary>
        public ToolOptions AddOutputStream(TextWriter outputStream)
        {
        ...
        /// environment variable eg. "%PATH%;someNewPath".
        /// </summary>
        public ToolOptions AddEnvironmentVariable(string variable, string value)
        {
