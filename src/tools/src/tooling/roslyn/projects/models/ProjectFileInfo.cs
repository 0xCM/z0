...
namespace Z0
{
    ...
    partial struct CodeProjects
    {
        public class ProjectFileInfo
        {
            ...
            public ImmutableArray<string> SourceFiles
                => _data.SourceFiles;

            public ImmutableArray<string> References
                => _data.References;

            public ImmutableArray<string> ProjectReferences
                => _data.ProjectReferences;

            public ImmutableArray<PackageReference> PackageReferences
                => _data.PackageReferences;

            public ImmutableArray<string> Analyzers
                => _data.Analyzers;

            public ImmutableArray<string> AdditionalFiles
                => _data.AdditionalFiles;

            public ImmutableArray<string> AnalyzerConfigFiles
                => _data.AnalyzerConfigFiles;

            public ImmutableDictionary<string, string> ReferenceAliases
                => _data.ReferenceAliases;

            public ImmutableDictionary<string, string> ProjectReferenceAliases
                => _data.ProjectReferenceAliases;

            public bool TreatWarningsAsErrors
                => _data.TreatWarningsAsErrors;

            public bool RunAnalyzers
                => _data.RunAnalyzers;

            public bool RunAnalyzersDuringLiveAnalysis
                => _data.RunAnalyzersDuringLiveAnalysis;

            public string DefaultNamespace
                => _data.DefaultNamespace;

            public ImmutableArray<IMSBuildGlob> FileInclusionGlobPatterns
                => _data.FileInclusionGlobs;
            ...
            private ProjectFileInfo(ProjectIdInfo projectIdInfo,string filePath,ProjectData data,Guid sessionId,DotNetInfo dotNetInfo)
            {
            ...
            public static ProjectFileInfo CreateEmpty(string filePath)
            {
            ...
            public static ProjectFileInfo CreateNoBuild(string filePath, ProjectLoader loader, DotNetInfo dotNetInfo)
            {
                var id = ProjectId.CreateNewId(debugName: filePath);
