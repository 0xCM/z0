...
namespace Z0
{
    ...
    partial struct CodeSolutions
    {
        ...
        public class MetadataReading
        {
            ...
            static string Resolve(string assembly)
            {
            ...
            public static Compilation CsCompilation(MetadataReference src)
            {
                var references = new[]{src};
                return CSharpCompilation.Create("Temp", references: references);
            }
