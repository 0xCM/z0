...
namespace Z0
{
    ...
    /// </summary>
    public readonly struct ToolFlagArg : IToolCmdArg
    {
        /// <summary>
        ...
        [MethodImpl(Inline)]
        public ToolFlagArg(ushort pos, string name, ArgPrefix? prefix = null)
        {
            Position = pos;
            Name = name;
            Value = EmptyString;
        ...
        [MethodImpl(Inline)]
        public ToolFlagArg(string name, ArgPrefix? prefix = null)
        {
            Position = 0;
            Name = name;
            Value = EmptyString;
        ...
        [MethodImpl(Inline)]
        public static implicit operator ToolCmdArg(ToolFlagArg src)
