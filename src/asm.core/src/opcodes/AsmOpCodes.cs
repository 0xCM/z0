...
namespace Z0.Asm
{
    ...
    public readonly struct AsmOpCodes
    {
        ...
        public static AsmOpCode opcode(byte b0, AsmOpCodeSymbols.ImmSize imm)
        ...
        /// <returns></returns>
        [MethodImpl(Inline), Op]
        public static AsmOpCode opcode(byte b0, RegDigit r, AsmOpCodeSymbols.ImmSize imm)
