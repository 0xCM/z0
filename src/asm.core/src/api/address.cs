...
namespace Z0.Asm
{
    ...
    partial struct asm
    {
        ...
        public static AsmAddress address(W8 w, RegIndexCode @base, RegIndexCode index, MemoryScale scale, Disp8 disp = default)
            => address(AsmRegs.reg(NativeSizeCode.W8, RegClassCode.GP, @base), AsmRegs.reg(NativeSizeCode.W8, RegClassCode.GP, index), scale,disp);
        ...
        public static AsmAddress address(W16 w, RegIndexCode @base, RegIndexCode index, MemoryScale scale, Disp16 disp = default)
            => address(AsmRegs.reg(NativeSizeCode.W16, RegClassCode.GP, @base), AsmRegs.reg(NativeSizeCode.W16, RegClassCode.GP, index), scale,disp);
        ...
        public static AsmAddress address(W32 w, RegIndexCode @base, RegIndexCode index, MemoryScale scale, Disp32 disp = default)
            => address(AsmRegs.reg(NativeSizeCode.W32, RegClassCode.GP, @base), AsmRegs.reg(NativeSizeCode.W32, RegClassCode.GP, index), scale,disp);
        ...
        public static AsmAddress address(W64 w, RegIndexCode @base, RegIndexCode index, MemoryScale scale, Disp32 disp = default)
            => address(AsmRegs.reg(NativeSizeCode.W64, RegClassCode.GP, @base), AsmRegs.reg(NativeSizeCode.W64, RegClassCode.GP, index), scale,disp);
    }
}