...
namespace Z0.Asm
{
    ...
    [ApiHost]
    public readonly struct AsmAddressing
    {
        /// <summary>
        ...
        public static AsmAddress address(W8 w, RegIndexCode @base, RegIndexCode index, MemoryScale scale, Disp8 disp = default)
            => address(AsmRegs.reg(RegWidthCode.W8, RegClassCode.GP, @base), AsmRegs.reg(RegWidthCode.W8, RegClassCode.GP, index), scale,disp);
        ...
        public static AsmAddress address(W16 w, RegIndexCode @base, RegIndexCode index, MemoryScale scale, Disp16 disp = default)
            => address(AsmRegs.reg(RegWidthCode.W16, RegClassCode.GP, @base), AsmRegs.reg(RegWidthCode.W16, RegClassCode.GP, index), scale,disp);
        ...
        public static AsmAddress address(W32 w, RegIndexCode @base, RegIndexCode index, MemoryScale scale, Disp32 disp = default)
            => address(AsmRegs.reg(RegWidthCode.W32, RegClassCode.GP, @base), AsmRegs.reg(RegWidthCode.W32, RegClassCode.GP, index), scale,disp);
        ...
        public static AsmAddress address(W64 w, RegIndexCode @base, RegIndexCode index, MemoryScale scale, Disp32 disp = default)
            => address(AsmRegs.reg(RegWidthCode.W64, RegClassCode.GP, @base), AsmRegs.reg(RegWidthCode.W64, RegClassCode.GP, index), scale,disp);
    }
}