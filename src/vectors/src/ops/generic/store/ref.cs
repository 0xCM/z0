    ...
    partial class Vectors
    {
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(byte))
                ...
                Store.save(vcast16u(src), ref uint16(ref dst));
            else if(typeof(T) == typeof(uint))
                Store.save(vcast32u(src), ref uint32(ref dst));
            else
                Store.save(vcast64u(src), ref uint64(ref dst));
        }
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(sbyte))
                Store.save(vcast8i(src), ref int8(ref dst));
            else if(typeof(T) == typeof(short))
                Store.save(vcast16i(src), ref int16(ref dst));
            else if(typeof(T) == typeof(int))
                Store.save(vcast32i(src), ref int32(ref dst));
            else
                Store.save(vcast64i(src), ref int64(ref dst));
        }
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(float))
                Store.save(vcast32f(src), ref float32(ref dst));
            else if(typeof(T) == typeof(double))
                Store.save(vcast64f(src), ref float64(ref dst));
            else 
        ...
        {
            if(typeof(T) == typeof(byte))
                Store.save(vcast8u(src), ref uint8(ref dst));
            else if(typeof(T) == typeof(ushort))
                Store.save(vcast16u(src), ref uint16(ref dst));
            else if(typeof(T) == typeof(uint))
                Store.save(vcast32u(src), ref uint32(ref dst));
        ...
        {
            if(typeof(T) == typeof(byte))
                Store.save(vcast8u(src), ref uint8(ref dst), offset);
            else if(typeof(T) == typeof(ushort))
                Store.save(vcast16u(src), ref uint16(ref dst), offset);
            else if(typeof(T) == typeof(uint))
                Store.save(vcast32u(src), ref uint32(ref dst), offset);
            else
                Store.save(vcast64u(src), ref uint64(ref dst), offset);
        }
        ...
        {
            if(typeof(T) == typeof(sbyte))
                Store.save(vcast8i(src), ref int8(ref dst), offset);
            else if(typeof(T) == typeof(short))
                Store.save(vcast16i(src), ref int16(ref dst), offset);
            else if(typeof(T) == typeof(int))
                Store.save(vcast32i(src), ref int32(ref dst), offset);
            else
                Store.save(vcast64i(src), ref int64(ref dst), offset);
        }
        ...
        {
            if(typeof(T) == typeof(float))
                Store.save(vcast32f(src), ref float32(ref dst), offset);
            else if(typeof(T) == typeof(double))
                Store.save(vcast64f(src), ref float64(ref dst), offset);
            else 
                throw Unsupported.define<T>();                
        }
