    ...
    partial class Vectors
    {
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(byte))
                Store.vstream(v8u(src), ref uint8(ref dst));
            else if(typeof(T) == typeof(ushort))
                Store.vstream(v16u(src), ref uint16(ref dst));
            else if(typeof(T) == typeof(uint))
                Store.vstream(v32u(src), ref uint32(ref dst));
            else if(typeof(T) == typeof(ulong))
                Store.vstream(v64u(src), ref uint64(ref dst));
            else
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(sbyte))
                Store.vstream(v8i(src), ref int8(ref dst));
            else if(typeof(T) == typeof(short))
                Store.vstream(v16i(src), ref int16(ref dst));
            else if(typeof(T) == typeof(int))
                Store.vstream(v32i(src), ref int32(ref dst));
            else if(typeof(T) == typeof(long))
                Store.vstream(v64i(src), ref int64(ref dst));
            else
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(float))
                Store.vstream(v32f(src), ref float32(ref dst));
            else if(typeof(T) == typeof(double))
                Store.vstream(v64f(src), ref float64(ref dst));
            else 
