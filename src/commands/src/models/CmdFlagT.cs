...
namespace Z0
{
    ...
    /// </summary>
    public readonly struct CmdFlag<T> : IToolCmdArg<T>
    {
        /// <summary>
        ...
        [MethodImpl(Inline)]
        public CmdFlag(ushort pos, string name, T value, ArgPrefix? prefix = null)
        {
            Position = pos;
            Name = name;
            Value = value;
        ...
        [MethodImpl(Inline)]
        public CmdFlag(string name, T value, ArgPrefix? prefix = null)
        {
            Position = 0;
            Name = name;
            Value = value;
        ...
        [MethodImpl(Inline)]
        public CmdFlag(T value, ArgPrefix? prefix = null)
        {
            Position = 0;
            Name = value.ToString();
            Value = value;
        ...
        [MethodImpl(Inline)]
        public static implicit operator CmdFlag(CmdFlag<T> src)
            => new CmdFlag(src.Position, src.Name, src.Prefix);

        [MethodImpl(Inline)]
        public static implicit operator ToolCmdArg(CmdFlag<T> src)
