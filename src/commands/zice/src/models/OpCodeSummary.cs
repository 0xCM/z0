...
namespace Z0.Asm.Data
{
	...
	/// Opcode info
	/// </summary>
	public sealed class OpCodeSummary 
	{
		[Flags]
        ...
        internal OpCodeSummary(Code code, uint dword3, uint dword2, uint dword1, StringBuilder sb) 
        {
			...
			case EncodingKind.Legacy:
				opKinds = EmbeddedData.LegacyOpKinds;
			...
			case EncodingKind.VEX:
				opKinds = EmbeddedData.VexOpKinds;
			...
			case EncodingKind.EVEX:
				opKinds = EmbeddedData.EvexOpKinds;
			...
			case EncodingKind.XOP:
				opKinds = EmbeddedData.XopOpKinds;
