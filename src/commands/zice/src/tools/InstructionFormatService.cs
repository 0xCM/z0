...
namespace Z0.Asm.Data
{
	...
	{
		void Include(params OpCodeDataBlock[] src);
		
		string Render();

		string Render(OpCodeDataBlock src);
	}

	public struct InstructionFormatService : IInstructionFormatter
	{
		public static IInstructionFormatter Service
			=> new InstructionFormatService(new StringBuilder());

		public void Include(params OpCodeDataBlock[] src)
		{
			blocks.AddRange(src);
		}
		
		public string Render(OpCodeDataBlock src)
		{
			blocks.Clear();
			blocks.Add(src);
			return Render();
		...
		readonly List<OpCodeDataBlock> blocks;	

		OpCodeDataAdapter opCode;
        ...
        InstructionFormatService(StringBuilder sb)
			: this()
        {
            this.sb = sb;
			this.blocks = new List<OpCodeDataBlock>();
        }

        // InstructionFormatService(OpCodeDataAdapter code, StringBuilder sb)
        // {
        //     this.opCode = code;
        //     this.sb = sb;
		// 	noVecIndex = false;
