...
namespace Z0.Asm.Data
{
	...
	static class CodeEnum {
		...
		static IceEnumValue[] GetValues() =>
			typeof(Code).GetFields().Where(a => a.IsLiteral).Select(a => new IceEnumValue((uint)(Code)a.GetValue(null)!, a.Name, CommentAttribute.GetDocumentation(a))).ToArray();
		...
		static string GetMode(StringBuilder sb, OpEncodingInfo opCode) {
			sb.Clear();
