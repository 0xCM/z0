...
namespace Z0.Alg
{
    ...
    public readonly partial struct Md5Ref
    {
        ...
        */
        ...
        public static void sines(Span<uint> dst)
        {
            for(var i=0; i<64; i++)
                seek(dst,i) = (uint)fmath.floor(232* fmath.abs(fmath.sin(i + 1)));
        }

        [Op]
        public static Span<uint> sines()
        {
        ...
        public static int[] ShiftTable = new int[] { 7, 12, 17, 22, 5, 9, 14, 20, 4, 11, 16, 23, 6, 10, 15, 21 };

        public static uint[] SinesTable = new uint[] {
        ...
        public static ReadOnlySpan<byte> InputData => new byte[67]{0x57,0x56,0x53,0x48,0x83,0xec,0x20,0x48,0x8b,0xf1,0x48,0x8b,0xfa,0x49,0x8b,0xd8,0x48,0x8b,0xce,0x48,0x8b,0xd7,0x4c,0x8b,0xc3,0xe8,0x22,0xaa,0x45,0xff,0x48,0x8b,0xce,0x48,0x8b,0xd7,0x4c,0x8b,0xc3,0xe8,0x1c,0xaa,0x45,0xff,0x48,0x8b,0xce,0x48,0x8b,0xd7,0x4c,0x8b,0xc3,0xe8,0x16,0xaa,0x45,0xff,0x90,0x48,0x83,0xc4,0x20,0x5b,0x5e,0x5f,0xc3};

        public static ReadOnlySpan<byte> OutputHash => new byte[16]{0x63,0x81,0x8d,0xcb,0x85,0x35,0xc9,0xde,0x13,0x9e,0x2d,0x74,0x34,0x64,0xf5,0x8f};
    }
}