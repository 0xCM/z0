...
namespace Z0
{
    ...
    public readonly struct ToolSpec<T,F> : ITool<T,F>
        ...
        where F : unmanaged, Enum
    {
        ...
        [MethodImpl(Inline)]
        public ToolSpec(IWfShell wf, ToolId id, F[] flags,  FS.FolderPath src, FS.FolderPath dst)
        {
            Wf = wf;
            ToolId = id;
            SourceDir = src;
            Source = dst;
            AvailableFlags = new ToolFlags<F>(flags);
