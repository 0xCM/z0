...
namespace Z0
{
        ...
        where S : unmanaged
    {
        ...
        /// </summary>
        readonly Span<WfTableMap<D,S,T,Y>> Processors;
        ...
        [MethodImpl(Inline)]
        public WfTableDispatcher(IWfContext wf, T[] tables, TableMaps<D,S,T,Y> processors, TableSectors<D,S> selectors, Y[] dst)
        {
            Wf = wf;
            Source = tables;
            Target = dst;
