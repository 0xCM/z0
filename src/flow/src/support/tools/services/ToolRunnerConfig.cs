...
namespace Z0
{
    ...
    public sealed class ToolRunnerConfig
    {
        ...
        public ToolRunnerConfig Clone()
        {
            return (ToolRunnerConfig)MemberwiseClone();
        }
        ...
        /// </summary>
        public ToolRunnerConfig AddNoThrow()
        {
            noThrow = true;
            return this;
        }
        ...
        /// </summary>
        public ToolRunnerConfig AddStart()
        {
            Start = true;
            return this;
        }
        ...
        /// Updates the Start propery and returns the updated commandOptions.
        /// </summary>
        public ToolRunnerConfig AddUseShellExecute()
        {
        ...
        /// </summary>
        public ToolRunnerConfig AddNoWindow()
        {
            noWindow = true;
            return this;
        }
        ...
        /// </summary>
        public ToolRunnerConfig AddNoWait()
        {
            noWait = true;
            return this;
        }
        ...
        /// </summary>
        public ToolRunnerConfig AddElevate()
        {
            elevate = true;
            return this;
        }
        ...
        /// </summary>
        public ToolRunnerConfig AddTimeout(int milliseconds)
        {
        ...
        /// </summary>
        public ToolRunnerConfig AddInput(string input)
        {
            this.input = input;
            return this;
        }
        ...
        /// </summary>
        public ToolRunnerConfig AddCurrentDirectory(string directoryPath)
        {
        ...
        /// </summary>
        public ToolRunnerConfig AddOutputFile(string outputFile)
        {
        ...
        /// </summary>
        public ToolRunnerConfig AddOutputStream(TextWriter outputStream)
        {
        ...
        /// environment variable eg. "%PATH%;someNewPath".
        /// </summary>
        public ToolRunnerConfig AddEnvironmentVariable(string variable, string value)
        {
