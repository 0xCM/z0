...
namespace Z0.Tools.LLVM
{
    ...
    partial struct Bitcode
    {
        ...
        public enum BitstreamWrapperHeader : uint
        {
            BWH_MagicField   = 0 * 4,
        ...
        public enum StandardWidths : byte
        {
        ...
        /// blocks.
        public enum BlockInfoCodes : byte
        {
        ...
        public enum FixedAbbrevIDs : byte
        {
        ...
        public enum StandardBlockIDs : byte
        {
        ...
        public enum IdentificationCodes : byte
        {
        ...
        public enum AttributeCodes : byte
        {
            // Deprecated, but still needed to read old bitcode files.
        ...
        public enum OperandBundleTagCode : byte
        {
            OPERAND_BUNDLE_TAG = 1, // TAG: [strchr x N]
        }

        public enum SyncScopeNameCode : byte
        {
            SYNC_SCOPE_NAME = 1,
        }

        // Value symbol table codes.
        public enum ValueSymtabCodes : byte
        {
        ...
        public enum ModulePathSymtabCodes : byte
        {
        ...
        public enum GlobalValueSummarySymtabCodes : byte
        {
        ...
        public enum MetadataCodes : byte
        {
        ...
        public enum ConstantsCodes : byte
        {
        ...
        /// have no fixed relation to the LLVM IR enum values.  Changing these will
        /// break compatibility with old files.
        public enum BinaryOpcodes : byte
        {
            BINOP_ADD = 0,
            BINOP_SUB = 1,
            BINOP_MUL = 2,
        ...
        public enum RMWOperations : byte
        {
            RMW_XCHG = 0,
            RMW_ADD = 1,
            RMW_SUB = 2,
        ...
        public enum OverflowingBinaryOperatorOptionalFlags : byte
        {
        ...
        public enum PossiblyExactOperatorOptionalFlags : byte
        {
             PEO_EXACT = 0
        }

        /// Encoded AtomicOrdering values.
        public enum AtomicOrderingCodes : byte
        {
        ...
        public enum CallMarkersFlags : byte
        {
            CALL_TAIL = 0,
            CALL_CCONV = 1,
            CALL_MUSTTAIL = 14,
        ...
        public enum ComdatSelectionKindCodes : byte
        {
        ...
        public enum StrtabCodes : byte
        {
            STRTAB_BLOB = 1,
        };

        public enum SymtabCodes : byte
        {
            SYMTAB_BLOB = 1,
        };
    }
