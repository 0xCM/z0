...
namespace Z0.X.Events
{
    ...
    public abstract class EventListener : IDisposable
    {
        ...
        readonly EventKeys keywordFilter;

        readonly IEventListenerEventSink eventSink;

        protected EventListener(EventLevel maxVerbosity, EventKeys keywordFilter, IEventListenerEventSink eventSink)
        {
        ...
        protected bool IsEnabled(EventLevel level, EventKeys keyword)
        {
            return this.keywordFilter != EventKeys.None &&
