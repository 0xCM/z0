...
namespace Z0
{
    ...
    public readonly struct ExtractParseFailure
    {
        ...
        /// </summary>
        public readonly ApiMemberExtract Data;
        ...
        [MethodImpl(Inline)]
        public ExtractParseFailure(ApiMemberExtract data, int seq, ExtractTermCode term)
        {
            Data = data;
            Sequence = seq;
            TermCode = term;
        ...
        public static ExtractParseFailure Empty
            => new ExtractParseFailure(ApiMemberExtract.Empty, 0, ExtractTermCode.None);
    }
}