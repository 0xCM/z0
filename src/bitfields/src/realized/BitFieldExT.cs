...
namespace Z0
{
        ...
        where T : unmanaged
    {
        ...
        [MethodImpl(Inline)]
        public T Extract(in FieldSegment segment, in T src)
        ...
        [MethodImpl(Inline)]
        public T Extract(in FieldSegment segment, in T src, bool offset)
        ...
        [MethodImpl(Inline)]
        public ref T Deposit(in FieldSegment segment, in T src, ref T dst)
        {
