...
namespace Z0
{
        ...
        where T : unmanaged
    {
        ...
        public ref readonly FieldSegment Segment(E index)
            => ref skip(Segments, Enums.numeric<E,byte>(index));
        ...
        public T Read(in FieldSegment segment, in S src, bool offset)
            => Ops.Extract(segment, src, offset);
        ...
        public T Read(E index, in S src, bool offset)
            => Ops.Extract(Segment(index), src, offset);
        ...
        {
            Ops.Deposit(segment, src, ref dst);
            return ref dst;
        }            
        ...
        {
            Ops.Deposit(Segment(index), src, ref dst);
            return ref dst;
        }            
