...
namespace Z0
{
    ...
    partial struct Canonical
    {
        ...
        public readonly struct ResourceBuffers
        {
            ...
            const byte Sz = MemorySegment.StorageSize;
            ...
            [Op, MethodImpl(Inline)]
            public static ReadOnlySpan<MemorySegment> segments()
            {
                ...
                return recover<MemorySegment>(index);
            }
        }
    }
}