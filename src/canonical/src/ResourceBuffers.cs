...
namespace Z0
{
    ...
    partial struct Canonical
    {
        ...
        public readonly struct ResourceBuffers
        {
            ...
            const byte Sz = MemSeg.StorageSize;
            ...
            [Op, MethodImpl(Inline)]
            public static ReadOnlySpan<MemSeg> segments()
            {
