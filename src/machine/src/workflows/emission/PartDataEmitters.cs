...
namespace Z0
{
    ...
    public readonly struct PartDataEmitters
    {
        ...
        public static void status(WfKind kind, WfStatusKind status, WfSink dst)
        {            
            var ts = format(z.now());
