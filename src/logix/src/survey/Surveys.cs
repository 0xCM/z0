...
namespace Z0
{
    ...
    public readonly struct Surveys
    {
        ...
        public static QuestionResponse<T> response<T>(in Question<T> question, IPolyrand random)
            where T : unmanaged
        {
        ...
        public static SurveyResponse<T> response<T>(in Survey<T> survey, IPolyrand random)
            where T : unmanaged
        {
