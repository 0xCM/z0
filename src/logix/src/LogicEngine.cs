...
namespace Z0.Logix
{
    ...
    public static class LogicEngine
    {
        ...
        {
            root.require(expr.SetVars(a,b), () => "Unable to set variables");
        ...
        public static bit satisfied<T>(ComparisonExpr<T> expr, T a, T b)
            where T :unmanaged
        {
            root.require(expr.VarCount >= 2, () => $"The source expression has {expr.VarCount} and the operation requires 2");
            expr.SetVars(a,b);
