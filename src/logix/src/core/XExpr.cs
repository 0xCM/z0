...
namespace Z0
{
    ...
    public static class XExpr
    {
        ...
        [MethodImpl(Inline)]
        public static T Set<T>(this IVarExpr<T> v, IDomainSource source)
            where T : unmanaged
        {
            var x = source.Next<T>();
            v.Assign(x);
        ...
        /// <typeparam name="T">The primal type</typeparam>
        [MethodImpl(Inline)]
        public static T Set<T>(this IVarExpr<T> v, IDomainSource source, T min, T max)
            where T : unmanaged
        {
        ...
        [MethodImpl(Inline)]
        public static T SetNext<T>(this IDomainSource random, VariableExpr<T> current)
            where T : unmanaged
        {
            var a = random.Next<T>();
            current.Set(a);
