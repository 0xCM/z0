...
namespace Z0
{
    ...
    public readonly struct Surveys
    {
        ...
        public static QuestionResponse<T> response<T>(in Question<T> question, IDomainSource random)
            where T : unmanaged
        {
        ...
        public static SurveyResponse<T> response<T>(in Survey<T> survey, IDomainSource random)
            where T : unmanaged
        {
