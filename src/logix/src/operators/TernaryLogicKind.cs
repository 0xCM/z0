...
namespace Z0
{
    ...
    /// </summary>
    public enum TernaryLogicKind : byte
    {
        /// <summary>
        /// The empty identity
        /// </summary>
    ...
    {
        [MethodImpl(Inline)]
        public static TernaryLogicKind Next(this TernaryLogicKind src)
            => src != TernaryLogicKind.XFF 
                ? (TernaryLogicKind)((uint)(src) + 1u)
                : TernaryLogicKind.X00; 

        public static string Format(this TernaryLogicKind kind)
            => kind.ToString();

        public static string Format<T>(this TernaryLogicKind kind, T arg1, T arg2, T arg3)
