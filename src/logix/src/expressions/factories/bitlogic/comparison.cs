...
namespace Z0.Logix
{
    ...
    partial class BitLogicSpec
    {
       /// <summary>
        ...
        [MethodImpl(Inline)]
        public static ComparisonExpr compare(BinaryComparisonApiKey kind, ILogicExpr lhs, ILogicExpr rhs, params ILogicVarExpr[] variables)
        ...
        /// <typeparam name="T">The operand type</typeparam>
        [MethodImpl(Inline)]
        public static ComparisonExpr<T> compare<T>(BinaryComparisonApiKey kind, ILogicExpr<T> lhs, ILogicExpr<T> rhs, params IVarExpr<T>[] variables)
            where T : unmanaged
                => ComparisonExpr.define(kind, lhs,rhs, variables);
        ...
        public static ComparisonExpr equals(ILogicExpr lhs, ILogicExpr rhs, params ILogicVarExpr[] variables)
            => ComparisonExpr.define(BinaryComparisonApiKey.Eq, lhs,rhs,variables);
