...
namespace Z0.Logix
{
    ...
    public static partial class BitLogicSpec
    {
        ...
        public static UnaryLogicOpExpr identity(ILogicExpr a)
            => unary(UnaryBitLogic.Identity, a);
        ...
        [MethodImpl(Inline)]
        public static UnaryLogicOpExpr unary(UnaryBitLogic op, ILogicExpr a)
        ...
        /// <typeparam name="T">The operand type</typeparam>
        [MethodImpl(Inline)]
        public static UnaryLogicOpExpr<T> unary<T>(UnaryBitLogic op, ILogicExpr<T> a)
            where T : unmanaged
        ...
        /// <typeparam name="T">The operand type</typeparam>
        [MethodImpl(Inline)]
        static UnaryLogicOpExpr<T> unary<T>(UnaryBitLogic op, bit a)
            where T : unmanaged
        ...
        /// <typeparam name="T">The operand type</typeparam>
        [MethodImpl(Inline)]
        public static UnaryLogicOpExpr unary(UnaryBitLogic kind, bit a)
        ...
        [MethodImpl(Inline)]
        public static TernaryLogicOpExpr ternary(TernaryBitLogic kind, ILogicExpr a, ILogicExpr b, ILogicExpr c)
        ...
        /// <param name="c">The third operand</param>
        [MethodImpl(Inline)]
        public static TernaryLogicOpExpr<T> ternary<T>(TernaryBitLogic kind, ILogicExpr<T> a, ILogicExpr<T> b, ILogicExpr<T> c)
            where T : unmanaged
        ...
        /// <param name="c">The third operand</param>
        [MethodImpl(Inline)]
        public static TernaryLogicOpExpr ternary(TernaryBitLogic kind, bit a, bit b, bit c)
        ...
        /// <param name="c">The third operand</param>
        [MethodImpl(Inline)]
        static TernaryLogicOpExpr<T> ternary<T>(TernaryBitLogic kind, bit a, bit b, bit c)
            where T : unmanaged
