...
namespace Z0
{
    partial class Dynop
    {
        ...
        public static FixedUnaryOp<F> EmitFixedUnaryOp<F>(this BufferToken dst, IdentifiedCode src)
        ...
        /// <typeparam name="F">The fixed operand type</typeparam>
        public static FixedBinaryOp<F> EmitFixedBinaryOp<F>(this BufferToken buffer, IdentifiedCode src)
        ...
        /// <param name="src">The executable source</param>
        /// <typeparam name="F">The fixed operand type</typeparam>
        public static FixedTernaryOp<F> EmitFixedTernaryOp<F>(this BufferToken dst, IdentifiedCode src)
