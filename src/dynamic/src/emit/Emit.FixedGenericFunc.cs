...
namespace Z0
{
    partial class Dynop
    {
        ...
        public static FixedFunc<X0,R> EmitFixedFunc<X0,R>(this BufferToken dst, IdentifiedCode src)
        ...
        /// <param name="dst">The target buffer</param>
        /// <param name="src">The executable source</param>
        public static FixedFunc<X0,X1,R> EmitFixedFunc<X0,X1,R>(this BufferToken dst, IdentifiedCode src)
        ...
        /// <param name="dst">The target buffer</param>
        /// <param name="src">The executable source</param>
        public static FixedFunc<X0,X1,X2,R> EmitFixedFunc<X0,X1,X2,R>(this BufferToken dst, IdentifiedCode src)
