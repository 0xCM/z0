...
namespace Z0
{
    partial class Dynop
    {
        ...
        public static UnaryOp<T> EmitUnaryOp<T>(this IBufferToken buffer, IdentifiedCode src)
            where T : unmanaged
        ...
        /// <param name="src">The code to load</param>
        /// <typeparam name="T">The operand type</typeparam>
        public static BinaryOp<T> EmitBinaryOp<T>(this IBufferToken buffer, IdentifiedCode src)
            where T : unmanaged
        ...
        /// <param name="src">The code to load</param>
        /// <typeparam name="T">The operand type</typeparam>
        public static TernaryOp<T> EmitTernaryOp<T>(this IBufferToken dst, IdentifiedCode src)
            where T : unmanaged
