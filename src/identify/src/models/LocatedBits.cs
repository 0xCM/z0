...
namespace Z0
{
    ...
    /// </summary>
    public readonly struct LocatedBits : IFormattable<LocatedBits>, IByteSpanProvider<LocatedBits>
    {
        /// <summary>
        ...
        public static LocatedBits Parse(OpIdentity id, string data)
            => Define(id, Addressable.Define(HexParsers.Bytes.ParseBytes(data).ToArray()));

        /// <summary>
        /// The canonical zero
        /// </summary>
        public static LocatedBits Empty => Define(OpIdentity.Empty, Addressable.Empty);
        ...
        [MethodImpl(Inline)]
        public static LocatedBits Define(OpIdentity id, Addressable data)
            => new LocatedBits(id, data);
        ...
        [MethodImpl(Inline)]
        public static LocatedBits Define(OpIdentity id, MemoryAddress @base, byte[] data)
            => Define(id, Addressable.Define(@base,data));

        [MethodImpl(Inline)]
        public static implicit operator BinaryCode(in LocatedBits src)
            => BinaryCode.Define(src.Encoded.Bytes);

        [MethodImpl(Inline)]
        public static implicit operator IdentifiedCode(in LocatedBits src)
        ...
        [MethodImpl(Inline)]
        public static implicit operator ReadOnlySpan<byte>(LocatedBits code)
            => code.Bytes;

        [MethodImpl(Inline)]
        LocatedBits(OpIdentity id, Addressable encoded)
        {
            this.Id = id;
