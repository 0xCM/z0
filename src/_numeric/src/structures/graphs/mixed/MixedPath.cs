...
namespace Z0
{
    ...
    // public readonly struct MixedPath<A,B> : IMixedPath<A,B>, ITextual<MixedPath<A,B>>, IEquatable<MixedPath<A,B>>
    // {
    //     public A Src {get;}
    ...
    //     [MethodImpl(Inline)]
    //     public MixedPath(A a, B b)
    //     {
    //         Src = a;
    //         Dst = b;
    //         Identifier = $"{a}{Connector}{b}";
    //     }

    //     public string Format()
    //         => Identifier;

    //     public bool Equals(MixedPath<A,B> src)
    ...
    //         => src is MixedPath<A,B> p && Equals(p);
    ...
    //         Dst = b;
    //         this.c = c;
    //         Identifier = $"{a}{Connector}{b}{Connector}{c}";
    //     }
    ...
    // public readonly struct MixedPath<A,B,C,D> : IMixedPath<A,B,C,D>, ITextual<MixedPath<A,B,C,D>>, IEquatable<MixedPath<A,B,C,D>>
    // {
    //     public A Src {get;}
