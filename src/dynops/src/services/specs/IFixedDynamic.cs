...
namespace Z0
{
    ...
    public interface IFixedDynamic : IService
    {
        ...
        FixedUnaryOp<F> EmitFixedUnary<F>(IBufferToken dst, in OperationCode src);
        ...
        /// <typeparam name="F">The fixed operand type</typeparam>
        FixedBinaryOp<F> EmitFixedBinary<F>(IBufferToken buffer, in OperationCode src);
        ...
        /// <param name="src">The executable source</param>
        /// <typeparam name="F">The fixed operand type</typeparam>
        FixedTernaryOp<F> EmitFixedTernary<F>(IBufferToken dst, in OperationCode src);
        ...
        UnaryOp8 EmitFixedUnary(IBufferToken dst, W8 w, in OperationCode src);
        ...
        /// <param name="w">The width selector</param>
        /// <param name="src">The source code</param>
        UnaryOp16 EmitFixedUnary(IBufferToken dst, W16 w, in OperationCode src);
        ...
        /// <param name="w">The width selector</param>
        /// <param name="src">The source code</param>
        UnaryOp32 EmitFixedUnary(IBufferToken dst, W32 w, in OperationCode src);
        ...
        /// <param name="w">The width selector</param>
        /// <param name="src">The source code</param>
        UnaryOp64 EmitFixedUnary(IBufferToken dst, W64 w, in OperationCode src);
        ...
        /// <param name="w">The width selector</param>
        /// <param name="src">The source code</param>
        UnaryOp128 EmitFixedUnary(IBufferToken dst, W128 w, in OperationCode src);
        ...
        /// <param name="w">The width selector</param>
        /// <param name="src">The source code</param>
        UnaryOp256 EmitFixedUnary(IBufferToken dst, W256 w, in OperationCode src);
        ...
        /// <param name="w">The width selector</param>
        /// <param name="src">The source code</param>
        BinaryOp8 EmitFixedBinary(IBufferToken dst, W8 w, in OperationCode src);
        ...
        /// <param name="w">The width selector</param>
        /// <param name="src">The source code</param>
        BinaryOp16 EmitFixedBinary(IBufferToken dst, W16 w, in OperationCode src);
        ...
        /// <param name="w">The width selector</param>
        /// <param name="src">The source code</param>
        BinaryOp32 EmitFixedBinary(IBufferToken dst, W32 w, in OperationCode src);
        ...
        /// <param name="w">The width selector</param>
        /// <param name="src">The source code</param>
        BinaryOp64 EmitFixedBinary(IBufferToken dst, W64 w, in OperationCode src);
        ...
        /// <param name="w">The width selector</param>
        /// <param name="src">The source code</param>
        BinaryOp128 EmitFixedBinary(IBufferToken dst, W128 w, in OperationCode src);
        ...
        /// <param name="w">The width selector</param>
        /// <param name="src">The source code</param>
        BinaryOp256 EmitFixedBinary(IBufferToken dst, W256 w, in OperationCode src);
    }
}