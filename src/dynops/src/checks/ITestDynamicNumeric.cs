...
namespace Z0
{
    ...
    {
        TestCaseRecord MatchNumeric<T>(in BufferSeq buffers, UnaryOp<T> f, UriHex src)
            where T : unmanaged
        {                                  
        ...
        TestCaseRecord MatchNumeric<T>(in BufferSeq buffers, BinaryOp<T> f, UriHex src)
            where T : unmanaged
        {                                  
        ...
        TestCaseRecord MatchNumeric<T>(in BufferSeq buffers, TernaryOp<T> f, UriHex src)
            where T : unmanaged
        {                                  
