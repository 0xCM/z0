...
namespace Z0
{
    ...
    {
        TestCaseRecord MatchNumeric<T>(in BufferSeq buffers, UnaryOp<T> f, UriBits src)
            where T : unmanaged
        {                                  
        ...
        TestCaseRecord MatchNumeric<T>(in BufferSeq buffers, BinaryOp<T> f, UriBits src)
            where T : unmanaged
        {                                  
        ...
        TestCaseRecord MatchNumeric<T>(in BufferSeq buffers, TernaryOp<T> f, UriBits src)
            where T : unmanaged
        {                                  
