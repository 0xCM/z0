    ...
    public class xed_inst
     {
          ...
          // static xed_iclass_enum_t xed_inst_iclass(in xed_inst_t p) {
          //     return xed_iform_to_iclass(xed_inst_iform_enum(p));
          // }

          // static xed_category_enum_t xed_inst_category(in xed_inst_t p) {
          //     return xed_iform_to_category(xed_inst_iform_enum(p));
          // }

          // static xed_extension_enum_t xed_inst_extension(in xed_inst_t p) {
          //     return xed_iform_to_extension(xed_inst_iform_enum(p));
          // }
          // static xed_isa_set_enum_t xed_inst_isa_set(in xed_inst_t p) {
