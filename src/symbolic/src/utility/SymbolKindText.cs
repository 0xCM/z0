...
namespace Z0
{
    ...
    partial struct CodeSolutions
    {
        ...
        public class SymbolKindText
        {
            ...
            static readonly HashSet<string> hashtable = new HashSet<string>(Kinds);
            ...
            public static string GetTypeKind(ISymbol declaredSymbol)
                => ((INamedTypeSymbol)declaredSymbol).TypeKind.ToString().ToLowerInvariant();
