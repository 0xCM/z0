    ...
    partial struct CodeSolutions
    {
        public static class Paths
        {
            ...
            public static string ProcessedAssemblies
            {
                get
                {
                    string root = SolutionDestinationFolder ?? BaseAppFolder;
            ...
            public static string AssemblyPathsFile => Path.Combine(BaseAppFolder, Constants.AssemblyPaths);
            ...
            public static string MakeRelativeToFolder(string filePath, string relativeToPath)
            {
                ...
                while (!filePath.EnsureTrailingSlash().StartsWith(relativeToPath.EnsureTrailingSlash(), StringComparison.OrdinalIgnoreCase))
                {
                    result.Append(@"..\");
                    relativeToPath = Path.GetDirectoryName(relativeToPath);
                }
