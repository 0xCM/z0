...
namespace Z0
{
    ...
    {
        public readonly struct Rotlx128<T> : ISVShiftOp128Api<T>, ISVImm8UnaryResolver128Api<T>
            where T : unmanaged
        {
        ...
        public readonly struct Rotlx256<T> : ISVShiftOp256Api<T>, ISVImm8UnaryResolver256Api<T>
            where T : unmanaged
        {
            public const string Name = "vrotlx";
