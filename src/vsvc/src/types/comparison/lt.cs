...
namespace Z0
{
    ...
    partial class VSvcHosts
    {
        ...
        public readonly struct Lt128<T> : ISVBinaryOp128D<T>, IBlockedBinaryOp128<T>
            where T : unmanaged
        {
            ...
            public ref readonly Block128<T> Invoke(in Block128<T> a, in Block128<T> b, in Block128<T> c)            
                => ref VBlocks.lt(a,b,c);

        }

        [NumericClosures(NumericKind.All)]
        public readonly struct Lt256<T> : ISVBinaryOp256D<T>, IBlockedBinaryOp256<T>
            where T : unmanaged
        {
            public const string Name = "vlt";
