...
namespace Z0
{
    ...
    public readonly struct StatelessIdentity : IIdentities
    {
        public static IIdentities Services => default(StatelessIdentity);
    }

    public interface IIdentities : IStatelessFactory<StatelessIdentity>
    {
