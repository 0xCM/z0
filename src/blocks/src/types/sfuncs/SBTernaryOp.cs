...
namespace Z0
{
    ...
    public interface ISBTernaryOp8Api<T> : ISBOpApi<W8,T>
        where T : unmanaged
    {
        ref readonly Block8<T> Invoke(in Block8<T> a, in Block8<T> b, in Block8<T> c, in Block8<T> dst);
    }

    [SuppressUnmanagedCodeSecurity]
    public interface ISBTernaryOp16Api<T> : ISBOpApi<W16,T>
        where T : unmanaged
    {
    ...
    [SuppressUnmanagedCodeSecurity]
    public interface ISBTernaryOp32Api<T> : ISBOpApi<W32,T>
        where T : unmanaged
    {
    ...
    [SuppressUnmanagedCodeSecurity]
    public interface ISBTernaryOp64Api<T> : ISBOpApi<W64,T>
        where T : unmanaged
    {
    ...
    [SuppressUnmanagedCodeSecurity]
    public interface ISBTernaryOp128Api<T> : ISBOpApi<W128,T>
        where T : unmanaged
    {
    ...
    [SuppressUnmanagedCodeSecurity]
    public interface ISBTernaryOp256Api<T> : ISBOpApi<W256,T>
        where T : unmanaged
    {
    ...
    [SuppressUnmanagedCodeSecurity]
    public interface ISBTernaryOp512Api<T> : ISBOpApi<W512,T>
        where T : unmanaged
    {
