...
namespace Z0
{
    ...
    partial class Blocks
    {
        ...
        public static Block16<ushort> cells(W16 n, ushort x0)
            => parts(n,x0);
        ...
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block16<ulong> cells(W16 n, ulong x0)
            => parts(n,x0);
        ...
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block64<byte> cells(W64 n, 
        ...
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block64<ushort> cells(W64 n, ushort x0, ushort x1, ushort x2, ushort x3)
            => parts(n,x0,x1,x2,x3);
        ...
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block64<uint> cells(W64 n, uint x0, uint x1)
            => parts(n,x0,x1);
        ...
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block64<ulong> cells(W64 n, ulong x0)
            => parts(n,x0);
        ...
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block128<ulong> cells(W128 n, ulong x0, ulong x1)            
            => parts(n,x0,x1);
        ...
        /// </summary>
        [MethodImpl(Inline), Op]
        public static Block256<byte> cells(W256 n, 
            byte x0, byte x1, byte x2, byte x3, byte x4, byte x5, byte x6, byte x7, 
            byte x8, byte x9, byte xA, byte xB, byte xC, byte xD, byte xE, byte xF,
