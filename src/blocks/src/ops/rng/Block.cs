...
namespace Z0
{
    ...
    public static partial class RandomBlocks
    {         
        /// <summary>
        ...
        public static Block16<T> Block<T>(this IPolyrand random, W16 w)
            where T : unmanaged
                => random.Stream<T>().ToSpan(B.cellblocks<T>(w,1)).Blocked(w); 
        ...
        /// <param name="t">The cell type representative</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static Block32<T> Block<T>(this IPolyrand random, W32 w, T t = default)
            where T : unmanaged
                => random.Blocks<T>(w,1);
        ...
        /// <param name="t">The cell type representative</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static Block64<T> Block<T>(this IPolyrand random, W64 w, T t = default)
            where T : unmanaged
                => random.Blocks<T>(w,1);
        ...
        /// <param name="t">The cell type representative</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static Block128<T> Block<T>(this IPolyrand random, W128 w, T t = default)
            where T : unmanaged
                => random.Blocks<T>(w,1);
        ...
        /// <param name="t">The cell type representative</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static Block256<T> Block<T>(this IPolyrand random, W256 w, T t = default)
            where T : unmanaged
                => random.Blocks<T>(w,1);
        ...
        /// <param name="t">The cell type representative</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static Block512<T> Block<T>(this IPolyrand random, W512 w, T t = default)
            where T : unmanaged
                => random.Blocks<T>(w,1);
        ...
        /// <param name="t">The cell type representative</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static Block16<T> Block<T>(this IPolyrand random, W16 w, T min, T max)
            where T : unmanaged
        ...
        /// <typeparam name="T">The block cell type</typeparam>
        public static Block32<T> Block<T>(this IPolyrand random, W32 w, T min, T max)
            where T : unmanaged
        ...
        /// <param name="max">The inclusive cell value upper bound</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static Block64<T> Block<T>(this IPolyrand random, W64 w, T min, T max)
            where T : unmanaged
                => random.Blocks<T>(w,min,max,1);
        ...
        /// <param name="max">The inclusive cell value upper bound</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static Block128<T> Block<T>(this IPolyrand random, W128 w, T min, T max)
            where T : unmanaged
                => random.Blocks<T>(w,min,max,1);
        ...
        /// <param name="max">The inclusive cell value upper bound</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static Block256<T> Block<T>(this IPolyrand random, W256 w, T min, T max)
            where T : unmanaged
                => random.Blocks<T>(w,min,max,1);
        ...
        /// <param name="max">The inclusive cell value upper bound</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static Block512<T> Block<T>(this IPolyrand random, W512 w, T min, T max)
            where T : unmanaged
                => random.Blocks<T>(w,min,max,1);
        ...
        /// <typeparam name="T">The primal random value type</typeparam>
        public static Block16<T> Block<T>(this IPolyrand random, W16 w, Interval<T> domain, Func<T,bool> filter)
            where T : unmanaged
        ...
        /// <param name="filter">An domain refinement filter</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static Block32<T> Block<T>(this IPolyrand random, W32 w, Interval<T> domain, Func<T,bool> filter)
            where T : unmanaged
                => random.Stream(domain,filter).ToSpan(B.cellblocks<T>(w,1)).Blocked(w); 
        ...
        /// <param name="filter">An domain refinement filter</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static Block64<T> Block<T>(this IPolyrand random, W64 w, Interval<T> domain, Func<T,bool> filter)
            where T : unmanaged
                => random.Stream(domain,filter).ToSpan(B.cellblocks<T>(w,1)).Blocked(w); 
        ...
        /// <param name="filter">An domain refinement filter</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static Block128<T> Block<T>(this IPolyrand random, W128 w, Interval<T> domain, Func<T,bool> filter)
            where T : unmanaged
                => random.Stream(domain,filter).ToSpan(B.cellblocks<T>(w,1)).Blocked(w); 
        ...
        /// <param name="filter">An domain refinement filter</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static Block256<T> Block<T>(this IPolyrand random, W256 w, Interval<T> domain, Func<T,bool> filter)
            where T : unmanaged
                => random.Stream(domain,filter).ToSpan(B.cellblocks<T>(w,1)).Blocked(w); 
        ...
        /// <param name="filter">An domain refinement filter</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static Block512<T> Block<T>(this IPolyrand random, W512 w, Interval<T> domain, Func<T,bool> filter)
            where T : unmanaged
                => random.Stream(domain,filter).ToSpan(B.cellblocks<T>(w,1)).Blocked(w); 
        ...
        /// <param name="domain">A domain to which values are constrained</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static Block16<T> Block<T>(this IPolyrand random, W16 w, Interval<T> domain)
            where T : unmanaged
        ...
        /// <param name="domain">A domain to which values are constrained</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static Block32<T> Block<T>(this IPolyrand random, W32 w, Interval<T> domain)
            where T : unmanaged
                => random.Stream(domain).ToSpan(B.cellblocks<T>(w,1)).Blocked(w); 
        ...
        /// <param name="domain">A domain to which values are constrained</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static Block64<T> Block<T>(this IPolyrand random, W64 w, Interval<T> domain)
            where T : unmanaged
                => random.Stream(domain).ToSpan(B.cellblocks<T>(w,1)).Blocked(w); 
        ...
        /// <param name="domain">A domain to which values are constrained</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static Block128<T> Block<T>(this IPolyrand random, W128 w, Interval<T> domain)
            where T : unmanaged
                => random.Stream(domain).ToSpan(B.cellblocks<T>(w,1)).Blocked(w); 
        ...
        /// <param name="domain">A domain to which values are constrained</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static Block256<T> Block<T>(this IPolyrand random, W256 w, Interval<T> domain)
            where T : unmanaged
                => random.Stream(domain).ToSpan(B.cellblocks<T>(w,1)).Blocked(w); 
        ...
        /// <param name="domain">A domain to which values are constrained</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static Block512<T> Block<T>(this IPolyrand random, W512 w, Interval<T> domain)
            where T : unmanaged
                => random.Stream(domain).ToSpan(B.cellblocks<T>(w,1)).Blocked(w);
    }
}