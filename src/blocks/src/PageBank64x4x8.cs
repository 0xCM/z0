...
namespace Z0
{
    ...
    public class PageBank64x4x8
    {
        ...
        PageBank64x4x8()
        {
            ...
            WinMem.liberate(address(Block0), size<B>());
            WinMem.liberate(address(Block1), size<B>());
            WinMem.liberate(address(Block2), size<B>());
            WinMem.liberate(address(Block3), size<B>());
            WinMem.liberate(address(Block4), size<B>());
            WinMem.liberate(address(Block5), size<B>());
            WinMem.liberate(address(Block6), size<B>());
            WinMem.liberate(address(Block7), size<B>());
