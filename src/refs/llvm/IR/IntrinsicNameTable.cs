namespace llvm
{
    ...
    public readonly partial struct IR
    {
        /// <summary>
        /// From IntrinsicImpl.inc
        /// </summary>
        public static string[] IntrinsicNameTable = new string[]
        {
            "llvm.abs",
            ...
            "llvm.ppc.mma.assemble.pair",
            "llvm.ppc.mma.disassemble.acc",
            "llvm.ppc.mma.disassemble.pair",
            "llvm.ppc.mma.lxvp",
