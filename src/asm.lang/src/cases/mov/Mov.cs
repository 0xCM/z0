...
namespace Z0.Asm
{
    ...
    partial class AsmCases
    {
        ...
        public Mov MovCases()
        {
            ...
            dst[0] = define(monic, counter++, asm.opcode("REX.W B8+ro io"), Sigs.ParseSig("MOV r64, imm64"), asm.statement("mov rax,1f6d13cb5e4h"), "48 b8 e4 b5 3c d1 f6 01 00 00");
            dst[1] = define(monic, counter++, asm.opcode("REX.W B8+ro io"), Sigs.ParseSig("MOV r64, imm64"), asm.statement("mov rax,1f6d12f2f4ch"), "48 b8 4c 2f 2f d1 f6 01 00 00");
            return dst;
        }
