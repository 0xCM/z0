...
namespace Z0.Asm
{
    ...
    partial class AsmCases
    {
        partial struct Statements
        {
            ...
            // /// <typeparam name="T">The target register type</typeparam>
            // /// <typeparam name="S">The source register type</typeparam>
            // public AsmStatement<R64<T>,R8<S>> movzx<T,S>(R64<T> dst, R8<S> src)
            ...
            // /// <param name="src">The source register</param>
            // /// <typeparam name="T">The target register type</typeparam>
            // public AsmStatement<R64<T>,m8> movzx<T>(R64<T> dst, m8 src)
            //     where T : unmanaged, IRegOp64
            //         => asm.statement(Builder.movzx(), dst, src);
            ...
            // /// <typeparam name="T">The target register type</typeparam>
            // [MethodImpl(Inline), Op]
            // public AsmStatement<r64,m8> movzx<T>(r64 dst, m8 src)
            //     => asm.statement(Builder.movzx(), dst, src);
            ...
            // /// <typeparam name="T">The target register type</typeparam>
            // /// <typeparam name="S">The source register type</typeparam>
            // public AsmStatement<R32<T>,R16<S>> movzx<T,S>(R32<T> dst, R16<S> src)
            //     where T : unmanaged, IRegOp32
            ...
            // /// <param name="src">The source register</param>
            // /// <typeparam name="T">The target register type</typeparam>
            // public AsmStatement<R32<T>,m16> movzx<T>(R32<T> dst, m16 src)
            //     where T : unmanaged, IRegOp32
            //         => asm.statement(Builder.movzx(), dst, src);
            ...
            // /// <typeparam name="T">The target register type</typeparam>
            // /// <typeparam name="S">The source register type</typeparam>
            // public AsmStatement<R64<T>,R16<S>> movzx<T,S>(R64<T> dst, R16<S> src)
            //     where T : unmanaged, IRegOp64
            //     where S : unmanaged, IRegOp16
            //         => asm.statement(Builder.movzx(), dst, src);
            ...
            // /// <typeparam name="S">The source register type</typeparam>
            // [MethodImpl(Inline), Op]
            // public AsmStatement<r64,r16> movzx<T,S>(r64 dst, r16 src)
            //     => asm.statement(Builder.movzx(), dst, src);
            ...
            // /// <param name="src">The source register</param>
            // /// <typeparam name="T">The target register type</typeparam>
            // public AsmStatement<R64<T>,m16> movzx<T>(R64<T> dst, m16 src)
            //     where T : unmanaged, IRegOp64
            //         => asm.statement(Builder.movzx(), dst, src);
