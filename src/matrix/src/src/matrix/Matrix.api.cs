...
namespace Z0
{
    ...
    public static class Matrix
    {
        ...
        public static Matrix256<N,T> blockalloc<N,T>(N n = default, T t = default)
            where N : unmanaged, ITypeNat
            where T : unmanaged
                => BufferBlocks.rectangle<T>(n256, value(n), value(n));
        ...
        public static Matrix256<M,N,T> blockalloc<M,N,T>(M m = default, N n = default, T t = default)
            ...
            where N : unmanaged, ITypeNat
            where T : unmanaged
                => BufferBlocks.rectangle<T>(n256, value(m), value(n));
        ...
        public static Matrix256<M,N,T> blockload<M,N,T>(Span<T> src,M m = default, N n = default)
            ...
            where N : unmanaged, ITypeNat
            where T : unmanaged
                => BufferBlocks.safeload(n256,src);
            ...
            where T : unmanaged
        {
            ...
            var dst =  Matrix.blockload<M,N,T>(BufferBlocks.rectangle<T>(n256, value<M>(), value<N>()));
