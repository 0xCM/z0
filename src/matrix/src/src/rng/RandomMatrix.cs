    ...
    public static class RandomMatrix
    {
        ...
        /// <typeparam name="T">The element type</typeparam>
         public static Matrix256<M,N,T> MatrixBlock<M,N,T>(this ISource random)
            ...
            where N : unmanaged, ITypeNat
            where T : unmanaged
                => Z0.Matrix.blockload<M,N,T>(random.SpanBlocks<T>(n256, BlockCalcs.blockcount<M,N,T>(n256)));
        ...
        public static Matrix256<M,N,T> MatrixBlock<M,N,T>(this IDomainSource random, Interval<T> domain, M m = default, N n = default)
            ...
            where N : unmanaged, ITypeNat
            where T : unmanaged
                => Z0.Matrix.blockload<M, N, T>(random.SpanBlocks(n256, domain, BlockCalcs.blockcount<M,N,T>(n256)));
        ...
        /// <typeparam name="T">The element type</typeparam>
         public static Matrix256<N,T> MatrixBlock<N,T>(this IDomainSource random, Interval<T>? domain = null)
            where N : unmanaged, ITypeNat
            where T : unmanaged
                => Z0.Matrix.blockload<N,T>(random.SpanBlocks(n256, domain.ValueOrElse(() => ClosedInterval<T>.Full), BlockCalcs.blockcount<N,N,T>(n256)));
