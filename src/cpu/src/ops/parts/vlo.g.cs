    ...
    partial struct gcpu
    {
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(sbyte))
                return generic<T>(cpu.vlo(v8i(src)));
            else if(typeof(T) == typeof(short))
                return generic<T>(cpu.vlo(v16i(src)));
            else if(typeof(T) == typeof(int))
                return generic<T>(cpu.vlo(v32i(src)));
            else
                return generic<T>(cpu.vlo(v64i(src)));
        }
        ...
        {
            if(typeof(T) == typeof(byte))
                return generic<T>(cpu.vlo(v8u(src)));
            else if(typeof(T) == typeof(ushort))
                return generic<T>(cpu.vlo(v16u(src)));
            else if(typeof(T) == typeof(uint))
                return generic<T>(cpu.vlo(v32u(src)));
            else
                return generic<T>(cpu.vlo(v64u(src)));
        }
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(float))
                return generic<T>(cpu.vlo(v32f(src)));
            else if(typeof(T) == typeof(double))
                return generic<T>(cpu.vlo(v64f(src)));
            else
                throw no<T>();
        }
    }
