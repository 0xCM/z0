...
namespace Z0
{
    ...
    public readonly struct CilOpCodes
    {
        ...
        public static CilOpCodeInfo pack(ILOpCode id, string name, CilOpCodeType type, CilOperandType optype, byte opcount, ushort code, CilStackBehaviour sb1, CilStackBehaviour sb2)
            => new CilOpCodeInfo(id, name, type, optype, opcount, sb1, sb2);
        ...
        [Op]
        public static uint load(ref CilOpCodeInfo dst)
        {
            var i=0u;
