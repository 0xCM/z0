...
namespace Msil
{
    ...
    {
        static readonly PropertyInfo s_indexer;

        static readonly FieldInfo s_scopeFi;

        static readonly Type s_genMethodInfoType;

        static readonly FieldInfo s_genmethFi1, s_genmethFi2;

        static readonly Type s_varArgMethodType;

        static readonly FieldInfo s_varargFi1, s_varargFi2;

        static readonly Type s_genFieldInfoType;

        static readonly FieldInfo s_genfieldFi1, s_genfieldFi2;
        ...
        readonly object m_scope = null;

        internal object this[int token]
            => s_indexer.GetValue(m_scope, new object[] { token });
