...
public static partial class metacore
{
    ...
    public static IndexImmutable<(X1 x1, X2 x2)> multicast<X1, X2>(params (object x1, object x2)[] tuples)
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IndexImmutable<(X1 x1, X2 x2, X3 x3)> multicast<X1, X2, X3>(params (object x1, object x2, object x3)[] tuples)
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IndexImmutable<(X1 x1, X2 x2, X3 x3, X4 x4)> multicast<X1, X2, X3, X4>(params (object x1, object x2, object x3, object x4)[] tuples)
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IndexImmutable<(X1 x1, X2 x2, X3 x3, X4 x4, X5 x5)> multicast<X1, X2, X3, X4, X5>(params (object x1, object x2, object x3, object x4, object x5)[] tuples)
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IndexImmutable<(X1 x1, X2 x2, X3 x3, X4 x4, X5 x5, X6)> multicast<X1, X2, X3, X4, X5, X6>(params (object x1, object x2, object x3, object x4, object x5, object x6)[] tuples)
