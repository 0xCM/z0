...
namespace Meta.Core
{
    ...
    public static class TranslationsX
    {
        ...
        /// <typeparam name="X">The element type</typeparam>
        /// <param name="source">The data source</param>
        public static IndexImmutable<X> AsIndex<X>(this IContainer<X> source)
            => IndexImmutable.make(source.Stream());
        ...
        public static bool IsIndex(this Type t)
            => t.IsConstructedGenericType && t.GetGenericTypeDefinition() == typeof(IndexImmutable<>);
