...
namespace Z0.Asm.Data
{
    ...
    public readonly struct AsmLineParser : ISequentialParser<AsmCommand>
    {
        public static AsmLineParser Service => default(AsmLineParser);
        ...
        public ParseResult<AsmCommand> Parse(string line, ref int seq)
        {
            ...
            var body = parts[0];
            var statement = AsmStatementParser.Service.Parse(body);
            if(statement.Failed)
                return fail;
