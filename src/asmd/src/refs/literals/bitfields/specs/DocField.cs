...
{        
    ...
    {                
        ...
        /// </summary>
        [SegmentWidth("[11111111]")]
        SegWidth = Max8,

        /// <summary>
        /// Defines the Vendor bitfield segment
        /// </summary>
        [FieldSegment("[00000000 00000000 00000000 00000000 00000000 00000000 11111111]")]
        Vendor = SegWidth << P.Vendor,

        /// <summary>
        /// Defines the Volume bitfield segment
        /// </summary>
        [FieldSegment("[00000000 00000000 00000000 00000000 00000000 11111111 00000000]")]
        Volume = SegWidth << P.Volume,

        /// <summary>
        /// Defines the Division bitfield segment
        /// </summary>
        [FieldSegment("[00000000 00000000 00000000 00000000 11111111 00000000 00000000]")]
        ...
        /// </summary>
        [FieldSegment("[00000000 00000000 00000000 11111111 00000000 00000000 00000000]")]
        Section = SegWidth << P.Section,

        /// <summary>
        /// Defines the Topic bitfield segment
        /// </summary>
        [FieldSegment("[00000000 00000000 11111111 00000000 00000000 00000000 00000000]")]
        Topic = SegWidth << P.Topic,

        [SegmentWidth("[11111111 11111111]")]
        ContentWidth = ushort.MaxValue,

        /// <summary>
        /// Defines the Content bitfield segment
        /// </summary>
        [FieldSegment("[11111111 11111111 00000000 00000000 00000000 00000000 00000000]")]
