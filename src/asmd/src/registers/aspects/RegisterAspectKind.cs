...
{        
    ...
    public enum RegisterAspectKind : uint
    {
        ...
        /// </summary>
        /// <remarks>
        /// This means that if a procedure (the caller) modifies register content, the register's orginal value must be restored prior to the procedure's exit/return;
        /// </remarks>
        Volatile = 1,
