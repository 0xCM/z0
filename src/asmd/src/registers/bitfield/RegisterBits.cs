...
{        
    ...
    /// </summary>
    [ApiHost]
    public readonly struct RegisterBits : ITextual
    {
        /// <summary>
        ...
        [MethodImpl(Inline)]
        public static implicit operator RegisterBits(RegisterKind src)
            => new RegisterBits(src);    

        [MethodImpl(Inline)]
        public RegisterBits(RegisterCode c, RegisterClass k, RegisterWidth w)
        {
            Code = c;
            Class = k;
            Width = w;
        ...
        [MethodImpl(Inline)]
        public RegisterBits(RegisterKind src)
        ...
        {            
            ...
            var seg0 = BitFields.format<RegisterCode,byte>(Code);
            var seg1 = BitFields.format<RegisterClass,byte>(Class);
            var seg2 = BitFields.format<RegisterWidth,ushort>(Width);
