...
namespace Z0.Asm.Data
{
    ...
    using V = InstructionTokenDefinitions;

    readonly partial struct InstructionTokenInfo
    {
        const int TokenCount = (int)InstructionToken.TokenCount;
    ...
    {
        [MethodImpl(Inline)]
        public static string Meaning(InstructionToken token)
            => InstructionTokenInfo.Meanings[(int)token];

        [MethodImpl(Inline)]
        public static string Identity(InstructionToken token)
            => InstructionTokenInfo.Identity[(int)token];

        [MethodImpl(Inline)]
        public static string Definition(InstructionToken token)
