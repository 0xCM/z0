...
{        
    ...
    public interface IImmOp8<F> : IImmOp<F,W8,Imm8>, IImmOp<W8,Address8>
        where F : unmanaged, IImmOp8<F>
    {
        
    }

    public interface IImmOp16<F> : IImmOp<F,W16,Imm16>, IImmOp<W16,Address16>
    ...
    public interface IImmOp32<F> : IImmOp<F,W32,Imm32>, IImmOp<W32,Address32>
    ...
    public interface IImmOp64<F> : IImmOp<F,W64,Imm64>, IImmOp<W64,Address64>
