...
namespace Z0.Asm
{
    ...
    {
        public static AsmPipeRunner create(IWfShell wf, params InstructionReceiver[] receivers)
            => new AsmPipeRunner(wf, receivers);
        ...
        public static void Run(IWfShell wf, PartId[] parts)
        {
            var counter = 0;
            ...
            create(wf, Receiver).RunPipe(parts);
        }
