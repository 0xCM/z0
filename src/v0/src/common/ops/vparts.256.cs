...
namespace Z0
{
    ...
    partial struct V0
    {
        ...
        /// <param name="w">The vector width selector</param>
        [MethodImpl(Inline),Op]
        public static Vector256<float> vparts(float x0, float x1, float x2, float x3, float x4, float x5, float x6, float x7)
            => Create(x0,x1,x2,x3,x4,x5,x6,x7);
        ...
        /// <param name="w">The vector width selector</param>
        [MethodImpl(Inline),Op]
        public static Vector256<double> vparts(double x0, double x1, double x2, double x3)
