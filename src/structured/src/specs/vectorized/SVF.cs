...
namespace Z0
{
    ...
    public interface ISVFunc : ISFunc
    {

    }

    [SuppressUnmanagedCodeSecurity]
    public interface ISVFunc128<T> : ISVFunc
        where T : unmanaged
    {
    ...
    [SuppressUnmanagedCodeSecurity]
    public interface ISVFunc256<T> : ISVFunc
        where T : unmanaged
    {
    ...
    [SuppressUnmanagedCodeSecurity]
    public interface ISVF<W1,W2,V1,V2,T1,T2> : ISVFunc, ISFunc<V1,V2>
    ...
    [SuppressUnmanagedCodeSecurity]
    public interface ISVFReduder256Api<T> : ISVF<W256,W128,Vector256<T>,Vector128<T>,T,T>
        where T : unmanaged
    {
