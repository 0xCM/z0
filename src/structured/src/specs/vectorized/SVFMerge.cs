...
namespace Z0
{
    ...
    public interface ISVFMerge<X,Y,Z> : ISVFunc
        where X : unmanaged
        where Y : unmanaged
        where Z : unmanaged
    {
    ...
    [SuppressUnmanagedCodeSecurity]
    public interface ISVFMergeD<S,T> : ISVFMerge<S,S,T>
        where S : unmanaged
        where T : unmanaged
    {
    ...
    [SuppressUnmanagedCodeSecurity]
    public interface ISVMergeOp128<X,Y,Z> : ISVFApi<W128, W128, W128, Vector128<X>, Vector128<Y>, Vector128<Z>, X, Y,Z>
        where X : unmanaged
        where Y : unmanaged
        where Z : unmanaged
    {
    ...
    /// <typeparam name="Z">The target component type</typeparam>
    [SuppressUnmanagedCodeSecurity]
    public interface ISVFMergeOp256<X,Y,Z> : ISVFApi<W256, W256, W256, Vector256<X>, Vector256<Y>, Vector256<Z>, X, Y,Z>
        where X : unmanaged
        where Y : unmanaged
        where Z : unmanaged
    {
    ...
    /// <typeparam name="Z">The target component type</typeparam>
    [SuppressUnmanagedCodeSecurity]
    public interface IVMergeOp2x128x256<X,Y,Z> : ISVFApi<W128, W128, W256, Vector128<X>, Vector128<Y>, Vector256<Z>, X, Y,Z>
        where X : unmanaged
        where Y : unmanaged
        where Z : unmanaged
    {
    ...
    /// <typeparam name="T">The target component type</typeparam>
    [SuppressUnmanagedCodeSecurity]
    public interface ISVMergeOp2x128x256<S,T> : ISVFApi<W128, W128, W256, Vector128<S>, Vector128<S>, Vector256<T>, S, S, T>
        where S : unmanaged
        where T : unmanaged
    {
    ...
    [SuppressUnmanagedCodeSecurity]
    public interface ISVMergeOp2x128x256Api<T> : ISVMergeOp2x128x256<T,T>
        where T : unmanaged
    {
