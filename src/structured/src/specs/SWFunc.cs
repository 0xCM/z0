...
namespace Z0
{
    ...
    public interface ISWFunc<W> : ISFunc
    ...
    /// <typeparam name="W">The width type</typeparam>
    [SuppressUnmanagedCodeSecurity]
    public interface ISWFunc<W,A> : ISWFunc<W>
        where W : unmanaged, ITypeWidth
    {
    ...
    [SuppressUnmanagedCodeSecurity]
    public interface ISWFunc<W,A,B> : ISWFunc<W>
        where W : unmanaged, ITypeWidth
    {
    ...
    [SuppressUnmanagedCodeSecurity]
    public interface ISWFunc<W,A,B,C> : ISWFunc<W>
        where W : unmanaged, ITypeWidth
    {
    ...
    [SuppressUnmanagedCodeSecurity]
    public interface ISWFunc<W,A,B,C,D> : ISWFunc<W>
        where W : unmanaged, ITypeWidth
    {
