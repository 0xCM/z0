...
namespace Z0.Asm
{
    ...
    {
        [CmdOp(".test-rel32")]
        Outcome TestRel32(CmdArgs args)
        {
            ...
            var actual0 = asm.jmp_rel32(ip0, dst);
            ...
            var actual1 = asm.jmp_rel32(ip1, dst);
            ...
            var actual2 = asm.jmp_rel32(ip2, dst);
            ...
            var actual3 = asm.jmp_rel32(ip3, dst);
