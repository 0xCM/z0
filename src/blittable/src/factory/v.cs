...
namespace Z0
{
    ...
    partial struct Blit
    {
        partial struct Factory
        {
            ...
            {
                var v = new v2<T>();
                ref var dst = ref Operate.cell(ref v);
                seek(dst,0) = a0;
                seek(dst,1) = a1;
                return v;
            }
            ...
            {
                var v = new v16<T>();
                ref var dst = ref @as<T,v8<T>>(Operate.cell(ref v));
                seek(dst,0) = a0;
                seek(dst,1) = a1;
                return v;
            }
            ...
            {
                var v = new v32<T>();
                ref var dst = ref @as<T,v16<T>>(Operate.cell(ref v));
                seek(dst,0) = a0;
                seek(dst,1) = a1;
                return v;
            }
            ...
            {
                var v = new v64<T>();
                ref var dst = ref @as<T,v32<T>>(Operate.cell(ref v));
                seek(dst,0) = a0;
                seek(dst,1) = a1;
                return v;
            }
