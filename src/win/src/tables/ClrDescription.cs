...
namespace Z0
{
    ...
    public readonly struct ClrDescription
    {
        ...
        /// </summary>
        public readonly ProcessModuleInfo Module;
        ...
        public ClrDescription(object dt, ClrFlavor flavor, ProcessModuleInfo module, DacLibInfo dacInfo, string dacLocation)
        {
            Module = module;
            ModuleInfo = module;
            DacInfo = dacInfo;
        ...
        public ClrDescription(ProcessDataTarget dt, ClrFlavor flavor, ProcessModuleInfo module, DacLibInfo dacInfo, string dacLocation)
        {
            Module = module;
            ModuleInfo = module;
            DacInfo = dacInfo;
