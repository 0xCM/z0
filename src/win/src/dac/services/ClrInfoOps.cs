...
namespace Z0.MS
{
    ...
    public readonly struct ClrInfoOps
    {
        ...
        public static bool TryGetModuleName(ModuleDescription moduleInfo, [NotNullWhen(true)] out string moduleName)
        {
        ...
        public static bool IsSupportedRuntime(ModuleDescription moduleInfo, out ClrFlavor flavor, out Platform platform)
        {
            flavor = default;
            platform = default;
