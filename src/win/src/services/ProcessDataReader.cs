...
namespace Z0
{
    ...
    public unsafe struct ProcessDataReader : IProcessDataReader
    {
        ...
        readonly IntPtr _snapshotHandle;

        readonly IntPtr _cloneHandle;
        ...
        private static extern int ReadProcessMemory(IntPtr hProcess, IntPtr lpBaseAddress, byte* lpBuffer, IntPtr dwSize, out IntPtr lpNumberOfBytesRead);
