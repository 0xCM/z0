...
namespace Z0.MS
{
    ...
    public struct ACCESS_MASK : IComparable, IComparable<ACCESS_MASK>, IEquatable<ACCESS_MASK>, IFormattable
    {
        ...
        public static implicit operator ACCESS_MASK(int value)
        ...
        /// </summary>
        /// <param name="value">The value of the ACCESS_MASK.</param>
        public static explicit operator int(ACCESS_MASK value)
            => value.AsInt32;
        ...
        /// </summary>
        /// <param name="value">The value of the ACCESS_MASK.</param>
        public static implicit operator ACCESS_MASK(uint value)
            => new ACCESS_MASK(value);
        ...
        /// </summary>
        /// <param name="value">The value for the <see cref="ACCESS_MASK"/>.</param>
        public static implicit operator ACCESS_MASK(GenericRight value)
            => new ACCESS_MASK((uint)value);
        ...
        /// </summary>
        /// <param name="value">The value for the <see cref="ACCESS_MASK"/>.</param>
        public static implicit operator ACCESS_MASK(SpecificRight value)
            => new ACCESS_MASK((uint)value);
        ...
        /// <inheritdoc />
        public bool Equals(ACCESS_MASK other)
            => this.Value == other.Value;

        /// <inheritdoc />
        public override bool Equals(object obj)
            => obj is ACCESS_MASK x && this.Equals(x);

        /// <inheritdoc />
        public int CompareTo(object obj)
            => ((IComparable)this.Value).CompareTo(obj);

        /// <inheritdoc />
        public int CompareTo(ACCESS_MASK other)
