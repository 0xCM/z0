...
namespace Z0.MS
{
    ...
    /// </summary>
    public unsafe readonly struct MSCorEE
    {
        /// <summary>
        ...
        public static extern unsafe int StrongNameGetPublicKey(string szKeyContainer, byte* pbKeyBlob, int cbKeyBlob, out byte* ppbPublicKeyBlob, out int pcbPublicKeyBlob);
        ...
        public static extern unsafe int StrongNameTokenFromPublicKey(byte* pbPublicKeyBlob,int cbPublicKeyBlob,out byte* ppbStrongNameToken, out int pcbStrongNameToken);
        ...
        /// </remarks>
        [DllImport(nameof(MSCorEE), CharSet = CharSet.Unicode)]
        public static extern unsafe HResult GetVersionFromProcess(SafeHandle hProcess,char* pVersion, int cchBuffer, out int dwLength);
        ...
        /// </remarks>
        [DllImport(nameof(MSCorEE), CharSet = CharSet.Unicode)]
        public static extern unsafe HResult GetFileVersion([MarshalAs(UnmanagedType.LPWStr)] string szFileName,char* szBuffer, int cchBuffer, out int dwLength);
    }
}