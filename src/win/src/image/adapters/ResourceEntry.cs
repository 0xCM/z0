...
namespace Z0.Image
{
    ...
    {
        ImmutableArray<ResourceEntry> _children;
        ...
        public ResourceEntry this[string name] 
            => Children.SingleOrDefault(c => c.Name == name);
        ...
        public ResourceEntry(PEImage image, ResourceEntry parent, string name, bool leaf, int offset)
        {
            Image = image;
            Parent = parent;
            Name = name;
