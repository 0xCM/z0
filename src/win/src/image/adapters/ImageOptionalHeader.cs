...
namespace Z0.Image
{
    ...
    public class ImageOptionalHeader
    {
        ...
        public ImageOptionalHeader(ref IMAGE_OPTIONAL_HEADER_AGNOSTIC optional, Lazy<IMAGE_OPTIONAL_HEADER_SPECIFIC> specific, Lazy<IMAGE_DATA_DIRECTORY[]> directories, bool is32bit)
        {
            _optional = optional;
            _specific = specific;
            _32bit = is32bit;
        ...
        public byte MajorLinkerVersion 
            => _optional.MajorLinkerVersion;
        
        public byte MinorLinkerVersion 
            => _optional.MinorLinkerVersion;
        
        public uint SizeOfCode 
            => _optional.SizeOfCode;
        
        public uint SizeOfInitializedData 
            => _optional.SizeOfInitializedData;
        
        public uint SizeOfUninitializedData 
            => _optional.SizeOfUninitializedData;
        
        public uint AddressOfEntryPoint 
            => _optional.AddressOfEntryPoint;
        
        public uint BaseOfCode 
            => _optional.BaseOfCode;
        ...
        public uint BaseOfData 
            => _32bit 
            ? _optional.BaseOfData 
            : throw new InvalidOperationException();

        public ulong ImageBase 
            => _32bit ? _optional.ImageBase : _optional.ImageBase64;

        public uint SectionAlignment 
            => _optional.SectionAlignment;

        public uint FileAlignment 
            => _optional.FileAlignment;

        public ushort MajorOperatingSystemVersion 
            => _optional.MajorOperatingSystemVersion;

        public ushort MinorOperatingSystemVersion 
            => _optional.MinorOperatingSystemVersion;

        public ushort MajorImageVersion 
            => _optional.MajorImageVersion;

        public ushort MinorImageVersion 
            => _optional.MinorImageVersion;

        public ushort MajorSubsystemVersion 
            => _optional.MajorSubsystemVersion;

        public ushort MinorSubsystemVersion 
            => _optional.MinorSubsystemVersion;
