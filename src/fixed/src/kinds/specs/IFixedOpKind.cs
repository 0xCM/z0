...
namespace Z0
{
    ...
    public interface IFixedOpKind : ITextual
    {
        ...
        FixedOpKind Untyped => new FixedOpKind(OperandWidth, OperandType, OperatorType);
        ...
        where D : Delegate
    {
        ...
        FixedWidth IFixedOpKind.OperandWidth => Widths.tfixed<W>();        
    }
        ...
        where D : Delegate
    {
        ...
        Type IFixedOpKind.OperandType => typeof(T);    

        Type IFixedOpKind.OperatorType => typeof(D);          
    }
}