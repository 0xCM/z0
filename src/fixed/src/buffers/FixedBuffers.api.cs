...
namespace Z0
{
    ...
    public static class FixedBuffers
    {
        ...
        /// <typeparam name="F">The buffer segment type</typeparam>
        [MethodImpl(Inline)]
        public static BufferSeq<Fixed128> alloc(W128 width, int count)
        ...
        /// <typeparam name="F">The buffer segment type</typeparam>
        [MethodImpl(Inline)]
        public static BufferSeq<Fixed256> alloc(W256 width, int count)
        ...
        /// <typeparam name="F">The buffer segment type</typeparam>
        [MethodImpl(Inline)]
        public static BufferSeq<Fixed512> alloc(W512 width, int count)
