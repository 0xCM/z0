...
namespace Z0
{
    ...
    public class genum
    {
        ...
        public static T and<E,T>(E a, E b, T t = default)
            ...
            where T : unmanaged
                => gmath.and(numeric<E,T>(a), numeric<E,T>(b));       

        [MethodImpl(Inline)]
        public static T or<E,T>(E a, E b, T t = default)
            where E : unmanaged, Enum
            where T : unmanaged
                => gmath.or(numeric<E,T>(a), numeric<E,T>(b));       

        [MethodImpl(Inline)]
        public static T xor<E,T>(E a, E b, T t = default)
            where E : unmanaged, Enum
            where T : unmanaged
                => gmath.xor(numeric<E,T>(a), numeric<E,T>(b));       

        [MethodImpl(Inline)]
        public static T sll<E,T>(E src, byte count, T t = default)
            where E : unmanaged, Enum
            where T : unmanaged
                => gmath.sll(numeric<E,T>(src),count);       
        ...
        public static T sll<E,S,T>(E src, byte count, S s = default, T t = default)
            ...
            where S : unmanaged
            where T : unmanaged
                => convert<S,T>(gmath.sll(numeric<E,S>(src), count));     
        ...
        public static T sll<E,C,S,T>(E src, C count, S s = default, T t = default)
            ...
            where S : unmanaged
            where T : unmanaged
                => convert<S,T>(gmath.sll(numeric<E,S>(src), numeric<C,byte>(count)));     
        ...
        public static T srl<E,T>(E src, byte count, T t = default)
            where E : unmanaged, Enum
            where T : unmanaged
                => gmath.srl(numeric<E,T>(src),count);       
