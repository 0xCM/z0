...
namespace Z0
{
    ...
    partial class BlockedTypeKinds
    {
        ...
        public readonly struct BlockedTypeKind : ILiteralKind<BK>
        {        
            [MethodImpl(Inline)]
            public static implicit operator BlockedTypeKind(BK kind)
                => new BlockedTypeKind(kind);

            [MethodImpl(Inline)]
            public static implicit operator BK(BlockedTypeKind kind)
                => kind.Class;

            [MethodImpl(Inline)]
            public BlockedTypeKind(BK kind)
            {
                this.Class = kind;
            }
        ...
        public readonly struct BlockedTypeKind<T> : IBlockedKind<BlockedTypeKind<T>>
            where T : unmanaged
        {
            public BK Class {get;}
            ...
            [MethodImpl(Inline)]
            public static implicit operator BlockedTypeKind<T>(BK src)
        ...
        public readonly struct BlockedTypeKind<W,T> :  IBlockedKind<BlockedTypeKind<W,T>, W,T>
            where T : unmanaged
            where W : unmanaged, ITypeWidth
        {
            public BK Class => BlockedTypeKinds.kind<W,T>();
