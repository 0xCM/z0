...
namespace Z0
{
    ...
    partial interface IReflectiveClass
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="src">The method to test</param>
        bool ReturnsVector(MethodInfo src, W128 w)
        ...
        /// </summary>
        /// <param name="src">The method to test</param>
        bool ReturnsVector(MethodInfo src, W256 w)
            => src.ReturnType.IsVector(w);
        ...
        /// </summary>
        /// <param name="src">The method to test</param>
        bool ReturnsVector(MethodInfo src, W512 w)
            => src.ReturnType.IsVector(w);
        ...
        bool ReturnsVector(MethodInfo src, W128 w, Type tCell)
        ...
        /// <param name="w">The width to match</param>
        /// <param name="tCell">The cell type to match</param>
        bool ReturnsVector(MethodInfo src, W256 w, Type tCell)
            => src.ReturnType.IsVector(w, tCell);
        ...
        /// <param name="w">The width to match</param>
        /// <param name="tCell">The cell type to match</param>
        bool ReturnsVector(MethodInfo src, W512 w, Type tCell)
            => src.ReturnType.IsVector(w, tCell);
