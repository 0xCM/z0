...
{        
    ...
    {        
        ...
        public static string TestCase(MethodInfo method)
            => $"{Identities.Owner(method.DeclaringType)}{PathSep}{method.DeclaringType.Name}{PathSep}{method.Name}";
        ...
        public static string TestCase(Type host, string fullname)
            => $"{Identities.Owner(host)}{PathSep}{host.Name}{PathSep}{fullname}";
        ...
        public static string TestCase(Type host, OpIdentity id)
            => $"{Identities.Owner(host)}{PathSep}{host.Name}{PathSep}{id}";
    }
}