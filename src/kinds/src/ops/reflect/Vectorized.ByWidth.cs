...
namespace Z0
{
    ...
    partial class XTend
    {
        ...
        /// <summary>
        /// Selcts vectorized direct or generic methods from a source stream
        /// </summary>
        /// <param name="src">The source strean</param>
        /// <param name="w">The vector width</param>
        /// <param name="generic">Whether generic methods or nongeneric methods should be selected</param>
