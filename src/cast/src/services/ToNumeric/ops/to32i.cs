...
namespace Z0
{
    ...
    partial class ToNumeric
    {
        ...
        public static int to32i(sbyte src)        
            => (int)src;

        [MethodImpl(Inline), Op]
        public static int to32i(byte src)        
            => (int)src;
        
        [MethodImpl(Inline), Op]
        public static int to32i(short src)        
            => (int)src;

        [MethodImpl(Inline), Op]
        public static int to32i(ushort src)        
            => (int)src;

        [MethodImpl(Inline), Op]
        public static int to32i(int src)        
            => (int)src;

        [MethodImpl(Inline), Op]
        public static int to32i(uint src)        
            => (int)src;

        [MethodImpl(Inline), Op]
        public static int to32i(long src)        
            => (int)src;

        [MethodImpl(Inline), Op]
        public static int to32i(ulong src)        
            => (int)src;

        [MethodImpl(Inline), Op]
        public static int to32i(float src)
            => (int)src; 
        ...
        static T to_x<T>(int src)
        {
            if(typeof(T) == typeof(float))
                ...
                return Unsupported.define<int,T>(src);
        }
    }
}