    ...
    partial class gvec
    {
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(byte))
                return generic<T>(z.vperm16x8(v8u(src), spec));
            else if(typeof(T) == typeof(ushort))
                return generic<T>(z.vperm16x8(v16u(src), spec));
            else if(typeof(T) == typeof(uint))
                return generic<T>(z.vperm16x8(v32u(src), spec));
            else if(typeof(T) == typeof(ulong))
                return generic<T>(z.vperm16x8(v64u(src), spec));
            else
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(sbyte))
                return generic<T>(z.vperm16x8(v8i(src), spec));
            else if(typeof(T) == typeof(short))
                return generic<T>(z.vperm16x8(v16i(src), spec));
            else if(typeof(T) == typeof(int))
                return generic<T>(z.vperm16x8(v32i(src), spec));
            else if(typeof(T) == typeof(long))
                return generic<T>(z.vperm16x8(v64i(src), spec));
            else
                throw no<T>();
        }
