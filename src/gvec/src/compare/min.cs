    ...
    partial class gvec
    {
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(byte))
                return generic<T>(z.vmin(v8u(x), v8u(y)));
            else if(typeof(T) == typeof(ushort))
                return generic<T>(z.vmin(v16u(x), v16u(y)));
            else if(typeof(T) == typeof(uint))
                return generic<T>(z.vmin(v32u(x), v32u(y)));
            else if(typeof(T) == typeof(ulong))
                return generic<T>(z.vmin(v64u(x), v64u(y)));
            else
                return vmin_i(x,y);
        }
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(sbyte))
                 return generic<T>(z.vmin(v8i(x), v8i(y)));
            else if(typeof(T) == typeof(short))
                 return generic<T>(z.vmin(v16i(x), v16i(y)));
            else if(typeof(T) == typeof(int))
                 return generic<T>(z.vmin(v32i(x), v32i(y)));
            else if(typeof(T) == typeof(long))
                 return generic<T>(z.vmin(v64i(x), v64i(y)));
            else
