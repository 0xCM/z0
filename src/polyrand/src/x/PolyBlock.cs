...
namespace Z0
{
    ...
    partial class XSource
    {
        ...
        public static ref readonly SpanBlock16<T> SpanBlock<T>(this IRangeSource src, T min, T max, in SpanBlock16<T> dst, int block)
            where T : unmanaged
        {
        ...
        /// <param name="block">The target block index</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static ref readonly SpanBlock32<T> SpanBlock<T>(this IRangeSource src, T min, T max, in SpanBlock32<T> dst, int block)
            where T : unmanaged
        {
            src.Fill(min,max,dst.CellBlock(block));
            return ref dst;
        ...
        /// <param name="block">The target block index</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static ref readonly SpanBlock64<T> SpanBlock<T>(this IRangeSource random, T min, T max, in SpanBlock64<T> dst, int block)
            where T : unmanaged
        {
        ...
        /// <param name="block">The target block index</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static ref readonly SpanBlock128<T> SpanBlock<T>(this IRangeSource random, T min, T max, in SpanBlock128<T> dst, int block)
            where T : unmanaged
        {
            random.Fill(min,max,dst.CellBlock(block));
            return ref dst;
        ...
        /// <param name="block">The target block index</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static ref readonly SpanBlock256<T> SpanBlock<T>(this IRangeSource random, T min, T max, in SpanBlock256<T> dst, int block)
            where T : unmanaged
        {
            random.Fill(min,max,dst.CellBlock(block));
            return ref dst;
        ...
        /// <param name="block">The target block index</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static ref readonly SpanBlock512<T> SpanBlock<T>(this IRangeSource random, T min, T max, in SpanBlock512<T> dst, int block)
            where T : unmanaged
        {
            random.Fill(min,max,dst.CellBlock(block));
            return ref dst;
        ...
        /// <typeparam name="T">The block cell type</typeparam>
        public static SpanBlock8<T> SpanBlock<T>(this IRangeSource source, W8 w)
            where T : unmanaged
        ...
        /// <param name="t">The cell type representative</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static SpanBlock16<T> SpanBlock<T>(this IRangeSource source, W16 w)
            where T : unmanaged
                => source.Stream<T>().ToSpan(B.cellblocks<T>(w,1)).Blocked(w);
        ...
        /// <param name="t">The cell type representative</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static SpanBlock16<T> SpanBlock<T>(this IRangeSource source, W16 w, T min, T max)
            where T : unmanaged
        ...
        /// <param name="max">The inclusive cell value upper bound</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static SpanBlock32<T> SpanBlock<T>(this IRangeSource source, W32 w, T min, T max)
            where T : unmanaged
        ...
        /// <param name="max">The inclusive cell value upper bound</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static SpanBlock64<T> SpanBlock<T>(this IRangeSource source, W64 w, T min, T max)
            where T : unmanaged
                => source.SpanBlocks<T>(w,min,max,1);
        ...
        /// <param name="max">The inclusive cell value upper bound</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static SpanBlock128<T> SpanBlock<T>(this IRangeSource source, W128 w, T min, T max)
            where T : unmanaged
                => source.SpanBlocks<T>(w,min,max,1);
        ...
        /// <param name="max">The inclusive cell value upper bound</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static SpanBlock256<T> SpanBlock<T>(this IRangeSource source, W256 w, T min, T max)
            where T : unmanaged
                => source.SpanBlocks<T>(w,min,max,1);
        ...
        /// <param name="max">The inclusive cell value upper bound</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static SpanBlock512<T> SpanBlock<T>(this IRangeSource source, W512 w, T min, T max)
            where T : unmanaged
                => source.SpanBlocks<T>(w,min,max,1);
        ...
        public static SpanBlock16<T> SpanBlock<T>(this IRangeSource random, W16 w, Interval<T> domain, Func<T,bool> filter)
            where T : unmanaged
        ...
        /// <param name="filter">An domain refinement filter</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock32<T> SpanBlock<T>(this IRangeSource random, W32 w, Interval<T> domain, Func<T,bool> filter)
            where T : unmanaged
                => random.Stream(domain,filter).ToSpan(B.cellblocks<T>(w,1)).Blocked(w);
        ...
        /// <param name="filter">An domain refinement filter</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock64<T> SpanBlock<T>(this IRangeSource random, W64 w, Interval<T> domain, Func<T,bool> filter)
            where T : unmanaged
                => random.Stream(domain,filter).ToSpan(B.cellblocks<T>(w,1)).Blocked(w);
        ...
        /// <param name="filter">An domain refinement filter</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock128<T> SpanBlock<T>(this IRangeSource random, W128 w, Interval<T> domain, Func<T,bool> filter)
            where T : unmanaged
                => random.Stream(domain,filter).ToSpan(B.cellblocks<T>(w,1)).Blocked(w);
        ...
        /// <param name="filter">An domain refinement filter</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock256<T> SpanBlock<T>(this IRangeSource random, W256 w, Interval<T> domain, Func<T,bool> filter)
            where T : unmanaged
                => random.Stream(domain,filter).ToSpan(B.cellblocks<T>(w,1)).Blocked(w);
        ...
        /// <param name="filter">An domain refinement filter</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock512<T> SpanBlock<T>(this IRangeSource source, W512 w, Interval<T> domain, Func<T,bool> filter)
            where T : unmanaged
        ...
        /// <param name="domain">A domain to which values are constrained</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock16<T> SpanBlock<T>(this IRangeSource source, W16 w, Interval<T> domain)
            where T : unmanaged
        ...
        /// <param name="domain">A domain to which values are constrained</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock32<T> SpanBlock<T>(this IRangeSource random, W32 w, Interval<T> domain)
            where T : unmanaged
        ...
        /// <param name="domain">A domain to which values are constrained</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock64<T> SpanBlock<T>(this IRangeSource random, W64 w, Interval<T> domain)
            where T : unmanaged
                => random.Stream(domain).ToSpan(B.cellblocks<T>(w,1)).Blocked(w);
        ...
        /// <param name="domain">A domain to which values are constrained</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock128<T> SpanBlock<T>(this IRangeSource random, W128 w, Interval<T> domain)
            where T : unmanaged
                => random.Stream(domain).ToSpan(B.cellblocks<T>(w,1)).Blocked(w);
        ...
        /// <param name="domain">A domain to which values are constrained</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock256<T> SpanBlock<T>(this IRangeSource random, W256 w, Interval<T> domain)
            where T : unmanaged
                => random.Stream(domain).ToSpan(B.cellblocks<T>(w,1)).Blocked(w);
        ...
        /// <param name="domain">A domain to which values are constrained</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock512<T> SpanBlock<T>(this IRangeSource random, W512 w, Interval<T> domain)
            where T : unmanaged
                => random.Stream(domain).ToSpan(B.cellblocks<T>(w,1)).Blocked(w);
    }
}
