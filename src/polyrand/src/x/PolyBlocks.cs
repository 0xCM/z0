...
namespace Z0
{
    ...
    partial class XSource
    {
        ...
        public static SpanBlock8<T> SpanBlocks<T>(this IRangeSource src, W8 w, int count, Interval<T> domain, Func<T,bool> filter)
            where T : unmanaged
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock8<T> SpanBlocks<T>(this IRangeSource src, W8 w, int count, T min, T max)
            where T : unmanaged
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock16<T> SpanBlocks<T>(this IRangeSource src, W16 w, int count, Interval<T> domain, Func<T,bool> filter)
            where T : unmanaged
                => src.Stream(domain,filter).ToSpan(B.cellblocks<T>(w,count)).Blocked(w);
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock16<T> SpanBlocks<T>(this IRangeSource src, W16 w, int count, T min, T max)
            where T : unmanaged
                => src.Stream<T>((min,max)).ToSpan(B.cellblocks<T>(w,count)).Blocked(w);
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock32<T> SpanBlocks<T>(this IRangeSource src, W32 w, Interval<T> domain, int count = 1, Func<T,bool> filter = null)
            where T : unmanaged
                => src.Stream(domain,filter).ToSpan(B.cellblocks<T>(w,count)).Blocked(w);
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock32<T> SpanBlocks<T>(this IRangeSource src, W32 w, T min, T max, int count = 1, Func<T,bool> filter = null)
            where T : unmanaged
        ...
        /// <param name="t">The cell type representative</param>
        /// <typeparam name="T">The block cell type</typeparam>
        public static SpanBlock32<T> SpanBlocks<T>(this IRangeSource src, W32 w, int count, T t)
            where T : unmanaged
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock64<T> SpanBlocks<T>(this IRangeSource src, W64 w, Interval<T> domain, int count = 1, Func<T,bool> filter = null)
            where T : unmanaged
                => src.Stream(domain,filter).ToSpan(B.cellblocks<T>(w,count)).Blocked(w);
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock64<T> SpanBlocks<T>(this IRangeSource src, W64 w, T min, T max, int count = 1, Func<T,bool> filter = null)
            where T : unmanaged
                => src.SpanBlocks(w, (min,max), count, filter);
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock128<T> SpanBlocks<T>(this IRangeSource src, W128 w, Interval<T> domain, int count = 1, Func<T,bool> filter = null)
            where T : unmanaged
                => src.Stream(domain,filter).ToSpan(B.cellblocks<T>(w,count)).Blocked(w);
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock128<T> SpanBlocks<T>(this IRangeSource src, W128 w, T min, T max, int count = 1, Func<T,bool> filter = null)
            where T : unmanaged
                => src.SpanBlocks(w, (min,max), count, filter);
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock256<T> SpanBlocks<T>(this IRangeSource src, W256 w, Interval<T> domain, int count = 1, Func<T,bool> filter = null)
            where T : unmanaged
                => src.Stream(domain,filter).ToSpan(B.cellblocks<T>(w,count)).Blocked(w);
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock256<T> SpanBlocks<T>(this IRangeSource src, W256 w, T min, T max, int count = 1, Func<T,bool> filter = null)
            where T : unmanaged
                => src.SpanBlocks(w, (min,max), count, filter);
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock512<T> SpanBlocks<T>(this IRangeSource src, W512 w, Interval<T> domain, int count = 1, Func<T,bool> filter = null)
            where T : unmanaged
                => src.Stream(domain,filter).ToSpan(B.cellblocks<T>(w,count)).Blocked(w);
        ...
        /// <param name="filter">An optional filter that refines the domain</param>
        /// <typeparam name="T">The primal random value type</typeparam>
        public static SpanBlock512<T> SpanBlocks<T>(this IRangeSource src, W512 w, T min, T max, int count = 1, Func<T,bool> filter = null)
            where T : unmanaged
                => src.SpanBlocks(w, (min,max), count, filter);
