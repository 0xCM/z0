...
namespace Z0
{
    ...
    partial class XTend
    {
        ...
        [MethodImpl(Inline)]
        public static NatSpan<N,T> NatSpan<N,T>(this IPolyStream random, Interval<T> domain, N n = default, Func<T,bool> filter = null)
            where T : unmanaged
        ...
        /// <typeparam name="T">The primal random value type</typeparam>
        [MethodImpl(Inline)]
        public static TableSpan<M,N,T> TableSpan<M,N,T>(this IPolyStream random, M rows = default, N cols = default)
            where T : unmanaged
        ...
        /// <typeparam name="T">The primal random value type</typeparam>
        [MethodImpl(Inline)]
        public static TableSpan<M,N,T> TableSpan<M,N,T>(this IPolyStream random, M rows, N cols, Interval<T> domain)
            where T : unmanaged
            where M : unmanaged, ITypeNat
            where N : unmanaged, ITypeNat
