...
namespace Z0
{
    ...
    partial class PolyFill
    {
        ...
        /// <typeparam name="T">The cell type</typeparam>
        public static void Fill<T>(this IPolySourced random, T min, T max, in SpanBlock16<T> dst)
            where T : unmanaged
        ...
        /// <param name="max">The exclusive upper bound</param>
        /// <typeparam name="T">The cell type</typeparam>
        public static void Fill<T>(this IPolySourced random, T min, T max, in SpanBlock32<T> dst)
            where T : unmanaged
                => random.Fill(min,max,dst.Data);
        ...
        /// <typeparam name="T">The cell type</typeparam>
        [MethodImpl(Inline)]
        public static void Fill<T>(this IPolySourced random, T min, T max, in SpanBlock64<T> dst)
            where T : unmanaged
                => random.Fill(min,max,dst.Data);
        ...
        /// <param name="max">The exclusive upper bound</param>
        /// <typeparam name="T">The cell type</typeparam>
        public static void Fill<T>(this IPolySourced random, T min, T max, in SpanBlock128<T> dst)
            where T : unmanaged
                => random.Fill(min,max,dst.Data);
        ...
        /// <param name="max">The exclusive upper bound</param>
        /// <typeparam name="T">The cell type</typeparam>
        public static void Fill<T>(this IPolySourced random, T min, T max, in SpanBlock256<T> dst)
            where T : unmanaged
                => random.Fill(min,max,dst.Data);
        ...
        /// <param name="max">The exclusive upper bound</param>
        /// <typeparam name="T">The cell type</typeparam>
        public static void Fill<T>(this IPolySourced random,T min, T max, in SpanBlock512<T> dst)
            where T : unmanaged
                => random.Fill(min,max,dst.Data);
    }
}