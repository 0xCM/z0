...
namespace Z0
{
    ...
    public static class PolyZero
    {
        ...
        public static IValueStream<T> NonZStream<T>(this IPolyStream random, Interval<T> domain)
            where T : unmanaged
        ...
        /// <typeparam name="T">The element type</typeparam>
        public static T NonZ<T>(this IPolyStream src, T min, T max)
            where T : unmanaged
        ...
        /// <typeparam name="T">The element type</typeparam>
        public static T NonZ<T>(this IPolyStream src, Interval<T> domain)
            where T : unmanaged
        ...
        [MethodImpl(Inline)]
        public static T NonZ<T>(this IPolyStream src, T max)
            where T : unmanaged
        ...
        /// <typeparam name="T">The element type</typeparam>
        [MethodImpl(Inline)]
        public static T NonZ<T>(this IPolyStream src)
            where T : unmanaged
