...
namespace Z0
{
    ...
    public static partial class RngStats
    {
        ...
        public static Ratio<double> SamplesWithin<T>(IPolySourced rng, Interval<T> domain, int count)
            where T : unmanaged
        {
        ...
        public static double SignRatio(IPolySourced rng, long samples, long radius)
        {
