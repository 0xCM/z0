...
namespace Z0
{
    ...
    partial struct CodeSolutions
    {
        public static class Log
        {
            ...
            static string errorLogFilePath = Path.GetFullPath(ErrorLogFile);

            static string messageLogFilePath = Path.GetFullPath(MessageLogFile);

            static TaskCompletionSource<object> completedTask = new TaskCompletionSource<object>();

            static readonly Subject<IMessage> Messages = new Subject<IMessage>();
            ...
            public static string ErrorLogFilePath
            {
                ...
                set { errorLogFilePath = MustBeAbsolute(value); }
            }

            public static string MessageLogFilePath
            {
                get { return messageLogFilePath; }
                set { messageLogFilePath = MustBeAbsolute(value); }
            }
