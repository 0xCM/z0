# JA rel8
------------------------------------------------------------------------------------------------------------------------
; uint clamp(uint src, uint max), located://math/api?clamp#clamp_(32u,32u)
...
# JAE rel8
------------------------------------------------------------------------------------------------------------------------
; ulong dist(uint a, uint b), located://math/api?dist#dist_(32u,32u)
...
# JG rel8
------------------------------------------------------------------------------------------------------------------------
; long clamp(long src, long max), located://math/api?clamp#clamp_(64i,64i)
...
# JGE rel8
------------------------------------------------------------------------------------------------------------------------
; ulong dist(long a, long b), located://math/api?dist#dist_(64i,64i)
