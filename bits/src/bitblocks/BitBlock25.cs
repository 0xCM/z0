...
namespace Z0
{
    ...
    /// <summary>
    /// Represents 25 bits with 25 bytes
    /// </summary>
    [StructLayout(LayoutKind.Explicit, Size=25)]
    public struct BitBlock25 : IBitBlock
    {
        /// <summary>
        ///  Bit 0
        /// </summary>
        ...
        public Span<T> AsSpan<T>()
            where T : unmanaged
            => Spans.AsSpan<BitBlock25, T>(ref this);
                
        [MethodImpl(Inline)]
        public byte GetPart(int i)
            => Unsafe.Add(ref Unsafe.As<BitBlock25, byte>(ref this), i);
