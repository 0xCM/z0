...
namespace Z0
{
    ...
    {         
        ...
        public static Vec128<byte> sll(in Vec128<byte> src, byte offset)
        {
            ...
            vstore(dinx.sll(dst, offset), ref data[0]);
            var i = 0;
        ...
        public static Vec128<byte> srl(in Vec128<byte> src, byte offset)
        {
            convert(in src, out Vec256<ushort> dst);
            Span<ushort> data = stackalloc ushort[Vec256<ushort>.Length];
            vstore(dinx.srl(dst, offset), ref data[0]);
            var i = 0;
            return Vec128.FromBytes(
                (byte)data[i++], (byte)data[i++], (byte)data[i++], (byte)data[i++], 
                (byte)data[i++], (byte)data[i++], (byte)data[i++], (byte)data[i++],
        ...
        public static Vec256<byte> sll(in Vec256<byte> src, byte offset)
        {
            ...
            var dstA = dinx.sll(srcX, offset).As<byte>();
            var dstB = dinx.sll(srcY, offset).As<byte>();
        ...
        public static Vec256<byte> srl(in Vec256<byte> src, byte offset)
        {
            ...
            //Shift each part with a concrete intrinsic anc convert back to bytes
            var dstA = dinx.srl(srcX, offset).As<byte>();
            var dstB = dinx.srl(srcY, offset).As<byte>();
