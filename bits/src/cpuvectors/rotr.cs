...
namespace Z0
{
    ...
    {                
        ...
        public static Vec128<ushort> rotr(in Vec128<ushort> src, byte offset)
        {
            ...
            var x = dinx.srl(in src, offset);
            var y = dinx.sll(in src, (byte)(bitsize - offset));   
            return dinx.vor(x,y);             
        }
        ...
        public static Vec128<uint> rotr(in Vec128<uint> src, Vec128<uint> offsets)
        {
            ...
            var y = dinx.vsllv(in src, dinx.sub(Vec128u32, offsets));
            return dinx.vor(x,y);             
        }
        ...
        {
            var x = dinx.srlv(in src, offsets);
            var y = dinx.vsllv(in src, dinx.sub(Vec128u64, offsets));
            return dinx.vor(x,y);             
        }
        ...
        {
            var x = dinx.srlv(in src, offsets);
            var y = dinx.vsllv(in src, dinx.sub(Vec256u32, offsets));
            return dinx.vor(x,y);             
        }
        ...
        {
            var x = dinx.srlv(in src, offsets);
            var y = dinx.vsllv(in src, dinx.sub(Vec256u64, offsets));
            return dinx.vor(x,y);             
        }
    }
