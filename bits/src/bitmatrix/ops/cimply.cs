...
namespace Z0
{
    ...
    partial class BitMatrix
    {
            ...
            where T : unmanaged
        {
            ...
            BitSquare.cimply(in A.Head, in B.Head, ref Z.Head);
            return Z;
        }
        ...
        /// <param name="B">The right matrix</param>
        [MethodImpl(Inline)]
        public static BitMatrix8 cimply(in BitMatrix8 A, in BitMatrix8 B)
        {
        ...
        /// <param name="B">The right matrix</param>
        [MethodImpl(Inline)]
        public static BitMatrix16 cimply(in BitMatrix16 A, in BitMatrix16 B)
        {
        ...
        /// <param name="B">The right matrix</param>
        [MethodImpl(Inline)]
        public static BitMatrix32 cimply(in BitMatrix32 A, in BitMatrix32 B)
        {
