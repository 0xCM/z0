...
namespace Z0
{
    ...
    partial class BitMatrix
    {
            ...
            where T : unmanaged
        {
            ...
            BitBlocks.nor(in A.Head, in B.Head, ref Z.Head);
            return Z;
        }
        ...
        /// <typeparam name="T">The primal type over which the matrix is constructed</typeparam>        
        [MethodImpl(Inline)]
        public static unsafe ref BitMatrix<T> nor<T>(in BitMatrix<T> A, in BitMatrix<T> B, ref BitMatrix<T> Z)
            where T : unmanaged
        {
            BitBlocks.nor(in A.Head, in B.Head, ref Z.Head);
            return ref Z;
        ...
        /// <param name="B">The target matrix</param>
        [MethodImpl(Inline)]
        public static unsafe ref BitMatrix8 nor(in BitMatrix8 A, in BitMatrix8 B, ref BitMatrix8 Z)
        {
             BitBlocks.nor(in A.Head, in B.Head, ref Z.Head);
             return ref Z;
        }
        ...
        /// <param name="B">The target matrix</param>
        [MethodImpl(Inline)]
        public static unsafe ref BitMatrix16 nor(in BitMatrix16 A, in BitMatrix16 B, ref BitMatrix16 Z)
        {
            BitBlocks.nor(in A.Head, in B.Head, ref Z.Head);
            return ref Z;
        }
        ...
        /// <param name="B">The target matrix</param>
        [MethodImpl(Inline)]
        public static unsafe ref BitMatrix32 nor(in BitMatrix32 A, in BitMatrix32 B, ref BitMatrix32 Z)
        {
            BitBlocks.nor(in A.Head, in B.Head, ref Z.Head);
            return ref Z;
        }
        ...
        /// <param name="B">The target matrix</param>
        [MethodImpl(Inline)]
        public static unsafe ref BitMatrix64 nor(in BitMatrix64 A, in BitMatrix64 B, ref BitMatrix64 Z)
        {
            BitBlocks.nor(in A.Head, in B.Head, ref Z.Head);
            return ref Z;
        }
