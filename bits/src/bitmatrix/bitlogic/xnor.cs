...
namespace Z0
{
    ...
    {
        /// <summary>
        /// Computes the logical Xnor between two generic bitmatrices, returning the allocated result
        /// </summary>
        ...
        /// <summary>
        /// Computes the logical Xnor between two primal bitmatrices, returning the allocated result
        /// </summary>
        /// <param name="A">The left matrix</param>
        /// <param name="B">The right matrix</param>
        [MethodImpl(Inline)]
