...
namespace Z0
{
    ...
    {
        /// <summary>
        /// Computes the converse nonimplication for generic bitmatrices, returning the allocated result
        /// </summary>
        ...
        /// <summary>
        /// Computes the converse nonimplication for generic bitmatrices, depositing the result to a caller-supplied target
        /// </summary>
        /// <param name="A">The left matrix</param>
        /// <param name="B">The right matrix</param>
        ...
        /// <summary>
        /// Computes the converse nonimplication for primal bitmatrices, depositing the result to a caller-supplied target
        /// </summary>
        /// <param name="A">The left matrix</param>
        /// <param name="B">The right matrix</param>
        /// <param name="B">The target matrix</param>
        ...
        /// <summary>
        /// Computes the converse nonimplication for primal bitmatrices, returning the allocated result
        /// </summary>
        /// <param name="A">The left matrix</param>
        /// <param name="B">The right matrix</param>
        [MethodImpl(Inline)]
        ...
        /// <param name="B">The right matrix</param>
        [MethodImpl(Inline)]
        public static unsafe BitMatrix32 cnotimply(in BitMatrix32 A, in BitMatrix32 B)
        {
