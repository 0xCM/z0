...
namespace Z0
{
    ...
    {
        /// <summary>
        /// Returns true if all bits in the source matrix are disabled, false otherwise
        /// </summary>
        ...
        /// <summary>
        /// Returns true if all mask-identified bits in the source matrix are disabled, false otherwise
        /// </summary>
        /// <param name="A">The source matrix</param>
