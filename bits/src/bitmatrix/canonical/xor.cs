...
namespace Z0
{
    ...
    partial class BitMatrix
    {
        ...
        /// <summary>
        /// Computes the logical Xor btween two generic bitmatrices and deposits the result to a caller-supplied target
        /// </summary>
        /// <param name="A">The left matrix</param>
        /// <param name="B">The right matrix</param>
        ...
        /// <summary>
        /// Computes the logical Xor btween two primal bitmatrices and deposits the result to a caller-supplied target
        /// </summary>
        /// <param name="A">The left matrix</param>
        /// <param name="B">The right matrix</param>
        /// <param name="Z">The target matrix</param>
