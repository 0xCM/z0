...
namespace Z0
{
    ...
    {   
        ...
        public static BitGrid<uint> ToBitGrid(this BitMatrix32 src)
            => BitGrid.load(DataBlocks.checkedload(n256,src.Data),32,32);

        [MethodImpl(Inline)]
        public static BitGrid<N64,N64,ulong> ToBitGrid(this BitMatrix64 src, N64 n)
            => BitGrid.load(DataBlocks.checkedload(n256,src.Data),n,n);
        ...
        public static BitGrid<ulong> ToBitGrid(this BitMatrix64 src)
            => BitGrid.load(DataBlocks.checkedload(n256,src.Data),64,64);
        ...
        [MethodImpl(Inline)]
        public static BitGrid64<T> ToBitGrid<T>(this BitString bs, N64 w, T t = default)
            where T : unmanaged
                => BitGrid.parse(bs,w,t);
