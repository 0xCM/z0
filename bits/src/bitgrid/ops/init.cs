...
namespace Z0
{
    ...
    partial class BitGrid
    {
        ...
        {            
            var w = n256;
            var blocks = DataBlocks.alloc<T>(w, BitCalcs.blockcount<T>(w,m,n)); 
        ...
        {
            var blocksize = n256;
            var blocks = DataBlocks.alloc<T>(blocksize, BitCalcs.blockcount<T>(blocksize, natval(m), natval(n))); 
            DataBlocks.broadcast(d,blocks);
        ...
        static BitGrid128<M,N,T> init128<M,N,T>(M m = default, N n = default, T d = default)
            ...
            where N : unmanaged, ITypeNat
            where T : unmanaged            
                => new BitGrid128<M, N, T>(ginx.vbroadcast(n128, d));
        ...
        static BitGrid256<M,N,T> init256<M,N,T>(M m = default, N n = default, T d = default)
            ...
            where N : unmanaged, ITypeNat
            where T : unmanaged            
                => new BitGrid256<M, N, T>(ginx.vbroadcast(n256, d)); 
