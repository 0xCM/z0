...
namespace Z0
{
        ...
        where X : t_bg<X>, new()
    {
            ...
            where T : unmanaged
        {
            ...
            ReportBenchmark($"gbg_read_{Identify.NumericType<T>()}", CycleCount*M*N, counter);
        }
            ...
            where T : unmanaged
        {
            ...
            ReportBenchmark($"gbm_bitread_{Identify.NumericType<T>()}", CycleCount*M*N, counter);
        }
            ...
            where T : unmanaged
        {
            ...
            ReportBenchmark($"gbg_bitwrite_{Identify.NumericType<T>()}", CycleCount*M*N, counter);
        }
