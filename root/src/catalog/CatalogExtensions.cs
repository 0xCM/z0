...
namespace Z0
{
    ...
    {    
        ...
        public static Option<IOperationCatalog> FindCatalog(this IAssemblyComposition src, AssemblyId id)
            => from a in src.FindAssembly(id)
                where !a.Catalog.IsEmpty
                select a.Catalog;
        
        public static IEnumerable<IOperationCatalog> Catalogs(this IAssemblyComposition src)
