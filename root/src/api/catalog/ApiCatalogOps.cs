...
namespace Z0
{
    ...
    {    
        ...
        public static Option<IApiCatalogProvider> CatalogProvider(this IAssemblyComposition src, AssemblyId id)
        ...
        public static Option<IApiCatalog> FindCatalog(this IAssemblyComposition src, AssemblyId id)
            => from r in src.FindAssembly(id)
                where r.Catalog.IsIdentified
                select r.Catalog;
        
        public static IEnumerable<IApiCatalog> Catalogs(this IAssemblyComposition src)
        ...
        /// </summary>
        /// <param name="src">The source composition</param>
        public static IEnumerable<IApiCatalogProvider> CatalogProviders(this IAssemblyComposition src)
            =>  from r in src.Resolved                
                where r.Catalog.IsIdentified
                select OP.Define(r.Id, r.Resolved, r.Catalog);
        ...
        public static IEnumerable<IApiCatalogProvider> CatalogProviders(this IAssemblyComposition src, IEnumerable<AssemblyId> filter)
            =>  from r in src.Resolved                
