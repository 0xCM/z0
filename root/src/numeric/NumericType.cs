...
namespace Z0
{
    ...
    {        
        ...
        {
            var k = Numeric.kind(src);
            return k.IsNone() ? Empty : new NumericType(src,k);
        }
        ...
        public static NumericType From(NumericKind src)
        {
            var t = src switch {
                NK.U8 => typeof(byte),
                NK.I8 => typeof(sbyte),
            ...
            return t.IsSome() ? new NumericType(t,src) : Empty;
        }
