...
namespace Z0
{
    ...
    [SuppressUnmanagedCodeSecurity]
    public interface ISVFApi<W1,W2,V1,V2,T1,T2> : ISVFuncApi, ISFApi<V1,V2>
    ...
    [SuppressUnmanagedCodeSecurity]
    public interface ISVFApi<W1,W2,W3,V1,V2,V3,T1,T2,T3> : ISVFuncApi, ISFApi<V1,V2,V3>
        where W1 : unmanaged, ITypeWidth
        where W2 : unmanaged, ITypeWidth
    ...
    [SuppressUnmanagedCodeSecurity]
    public interface ISVFApi<W1,W2,W3,W4,V1,V2,V3,V4,T1,T2,T3,T4> : ISVFuncApi, ISFApi<V1,V2,V3,V4>
        where W1 : unmanaged, ITypeWidth
        where W2 : unmanaged, ITypeWidth
        where W3 : unmanaged, ITypeWidth
