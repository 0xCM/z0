...
namespace Z0
{
    ...
    [SuppressUnmanagedCodeSecurity]
    public interface ISVScalarApi<W,V,T,K> : ISVFuncApi, ISFApi<V,K>
    ...
    /// <typeparam name="K">The scalar result type</typeparam>
    [SuppressUnmanagedCodeSecurity]
    public interface ISVScalarApi<W1,W2,V1,V2,T1,T2,K> : ISVFuncApi, ISFApi<V1,V2,K>
    ...
    /// <typeparam name="K">The scalar result type</typeparam>
    [SuppressUnmanagedCodeSecurity]
    public interface ISVScalarApi<W1,W2,W3,V1,V2,V3,T1,T2,T3,K> : ISVFuncApi, ISFApi<V1,V2,V3,K>
        where W1 : unmanaged, ITypeWidth
        where W2 : unmanaged, ITypeWidth
