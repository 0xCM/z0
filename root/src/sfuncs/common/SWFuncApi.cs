...
namespace Z0
{
    ...
    /// <typeparam name="W">The width type</typeparam>
    [SuppressUnmanagedCodeSecurity]
    public interface ISWFuncApi<W,A> : ISFApi<A>, ISWFuncApi<W>, ISWFunc<W,A>
        where W : unmanaged, ITypeWidth
    {
    ...
    [SuppressUnmanagedCodeSecurity]
    public interface ISWFuncApi<W,A,B> : ISFApi<A,B>, ISWFuncApi<W>, ISWFunc<W,A,B>
        where W : unmanaged, ITypeWidth
    {
    ...
    [SuppressUnmanagedCodeSecurity]
    public interface ISWFuncApi<W,A,B,C> : ISFApi<A,B,C>, ISWFuncApi<W>, ISWFunc<W,A,B,C>
        where W : unmanaged, ITypeWidth
    {
    ...
    [SuppressUnmanagedCodeSecurity]
    public interface ISWFuncApi<W,A,B,C,D> : ISFApi<A,B,C,D>, ISWFuncApi<W>, ISWFunc<W,A,B,C,D>
        where W : unmanaged, ITypeWidth
    {
