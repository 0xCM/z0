...
namespace Z0
{
    ...
    partial class Surrogates
    {
        ...
        public static Func<T> ToFunc<T>(this Emitter<T> src)
            => new Func<T>(src.Subject.ToFunc(), src.Id);

        [MethodImpl(Inline)]
        public static Emitter<T> ToEmitter<T>(this Func<T> src)
            => emitter(src.Subject.ToEmitter(), src.Id);
