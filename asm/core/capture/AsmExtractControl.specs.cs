...
namespace Z0
{
    ...
    public interface IAsmCaptureJunction
    {
        ...
        void OnCaptureStep(in AsmCaptureExchange src, in AsmCaptureState state);   
        ...
        void OnCaptureComplete(in AsmCaptureExchange src, in AsmCaptureState state, in AsmOpExtract captured);        
    }

    public interface IAsmExtractControl : IAsmOpExtractor, IAsmCaptureJunction
    {
