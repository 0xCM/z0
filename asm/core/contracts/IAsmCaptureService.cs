...
namespace Z0
{
    ...
    public interface IAsmCaptureService : IAsmService
    {
        ...
        AsmMemberCapture Capture(in AsmCaptureExchange exchange, OpIdentity id, MethodInfo src);
        ...
        AsmMemberCapture Capture(in AsmCaptureExchange exchange, MethodInfo src, params Type[] args);
        ...
        AsmMemberCapture Capture(in AsmCaptureExchange exchange, OpIdentity id, Delegate src);
        ...
        AsmMemberCapture Capture(in AsmCaptureExchange exchange, OpIdentity id, DynamicDelegate src);        
    }
}