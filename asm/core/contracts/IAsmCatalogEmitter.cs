...
{        
        ...
        where T : IUri
    {
        ...
        void EmitPrimary(in AsmCaptureExchange exchange, AsmEmissionObserver<T> observer);          

        /// <summary>
        /// Emits immediate captures
        /// </summary>
        /// <param name="exchange">The selected exchange</param>
        void EmitImm(in AsmCaptureExchange exchange, AsmEmissionObserver<T> observer);  
    ...
    public interface IAsmCatalogEmitter : IAsmService, ISink<AsmEmissionTokens<OpUri>>
    {
        ...
        /// </summary>
        /// <param name="exchange">The selected exchange</param>
        void EmitPrimary(in AsmCaptureExchange exchange, AsmEmissionObserver observer);          

        /// <summary>
        /// Emits immediate captures
        /// </summary>
        /// <param name="exchange">The selected exchange</param>
        void EmitImm(in AsmCaptureExchange exchange, AsmEmissionObserver observer);  
    }
}