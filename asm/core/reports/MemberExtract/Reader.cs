...
{        
    ...
    {
        ExtractedMember[] ReadExtracts(FilePath src);       
    }
    ...
    readonly struct MemberExtractReader : IMemberExtractReader
    {
        ...
        public ExtractedMember[] ReadExtracts(FilePath src)
        {
        ...
        ExtractedMember[] MemberExtracts(IApiHost host, MemberExtractRecord[] records)
        {
            ...
            for(var i = 0; i<records.Length; i++)
            {
                ...
                seek(extracts,i) = member ? ExtractedMember.Define(member.Value, encoded) : ExtractedMember.Empty;
            }
            return data;
        }
    }
