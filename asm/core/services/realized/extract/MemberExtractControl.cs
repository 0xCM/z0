...
namespace Z0.Asm
{
    ...
    readonly struct MemberExtractControl : IMemberExtractControl
    {                    
        ...
        [MethodImpl(Inline)]
        public static IMemberExtractControl New(IContext context)
            => new MemberExtractControl(context);
                    
        [MethodImpl(Inline)]
        MemberExtractControl(IContext context)
        {
        ...
        [MethodImpl(Inline)]
        void IExtractJunction.OnCaptureStep(in CaptureExchange exchange, in ApiExtractState state)
        {

        }

        [MethodImpl(Inline)]
        void IExtractJunction.OnCaptureComplete(in CaptureExchange exchange, in ApiExtractState state, in ApiMemberCapture captured)
        {}
