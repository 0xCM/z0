...
namespace Z0
{
    ...
    public readonly ref struct OpExtractExchange
    {
        /// <summary>
        ...
        OpExtractExchange(IExtractControl control, Span<byte> capture, Span<byte> state)            
        {
            ...
            this.Junction = control as IExtractJunction;
        ...
        [MethodImpl(Inline)]
        public ref readonly CapturedOp CaptureComplete(in OpExtractionState state, in CapturedOp captured)
        {
        ...
        [MethodImpl(Inline)]
        public ref readonly OpExtractionState CaptureStep(in OpExtractionState state)
        {
