...
namespace Z0
{
    ...
    public interface INativeCapture : IAsmService
    {
        ...
        void CaptureBits(in CaptureExchange exchange, MethodInfo src, IAsmHexWriter dst);
        ...
        /// <param name="args">The types over which to close the generic method</param>
        /// <param name="dst">The target buffer</param>
        void CaptureBits(in CaptureExchange exchange, MethodInfo src, Type[] args, IAsmHexWriter dst);
        ...
        void CaptureBits(in CaptureExchange exchange, Delegate src, IAsmHexWriter dst);
    }
