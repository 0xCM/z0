...
namespace Z0
{
    ...
    partial class soc
    {
        public static sbyte sar_8i(sbyte lhs, int offset)
            => math.sar(lhs,offset);

        public static sbyte sar_g8i(sbyte lhs, int offset)
            => gmath.sar(lhs,offset);

        public static byte sar_8u(byte lhs, int offset)
            => math.sar(lhs,offset);

        public static byte sar_g8u(byte lhs, int offset)
            => gmath.sar(lhs,offset);

        public static short sar_16i(short lhs, int offset)
            => math.sar(lhs,offset);

        public static short sar_g16i(short lhs, int offset)
            => gmath.sar(lhs,offset);

        public static ushort sar_16u(ushort lhs, int offset)
            => math.sar(lhs,offset);

        public static ushort sar_g16u(ushort lhs, int offset)
            => gmath.sar(lhs,offset);

        public static int sar_32i(int lhs, int offset)
            => math.sar(lhs,offset);

        public static int sar_g32i(int lhs, int offset)
            => gmath.sar(lhs,offset);

        public static uint sar_32u(uint lhs, int offset)
            => math.sar(lhs,offset);

        public static uint sar_g32u(uint lhs, int offset)
            => gmath.sar(lhs,offset);

        public static long sar_64i(long lhs, int offset)
            => math.sar(lhs,offset);

        public static long sar_g64i(long lhs, int offset)
            => gmath.sar(lhs,offset);

        public static ulong sar_64u(ulong lhs, int offset)
            => math.sar(lhs,offset);
