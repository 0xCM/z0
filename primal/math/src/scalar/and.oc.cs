...
namespace Z0
{
    ...
    partial class soc
    {
        public static sbyte and_8i(sbyte lhs, sbyte rhs)
            => math.and(lhs,rhs);

        public static sbyte and_g8i(sbyte lhs, sbyte rhs)
            => gmath.and(lhs,rhs);

        public static byte and_8u(byte lhs, byte rhs)
            => math.and(lhs,rhs);

        public static byte and_g8u(byte lhs, byte rhs)
            => gmath.and(lhs,rhs);

        public static short and_16i(short lhs, short rhs)
            => math.and(lhs,rhs);

        public static short and_g16i(short lhs, short rhs)
            => gmath.and(lhs,rhs);

        public static ushort and_16u(ushort lhs, ushort rhs)
            => math.and(lhs,rhs);

        public static ushort and_g16u(ushort lhs, ushort rhs)
            => gmath.and(lhs,rhs);

        public static int and_32i(int lhs, int rhs)
            => math.and(lhs,rhs);

        public static int and_g32i(int lhs, int rhs)
            => gmath.and(lhs,rhs);

        public static uint and_32u(uint lhs, uint rhs)
            => math.and(lhs,rhs);

        public static uint and_g32u(uint lhs, uint rhs)
            => gmath.and(lhs,rhs);

        public static long and_64i(long lhs, long rhs)
            => math.and(lhs,rhs);

        public static long and_g64i(long lhs, long rhs)
            => gmath.and(lhs,rhs);

        public static ulong and_64u(ulong lhs, ulong rhs)
            => math.and(lhs,rhs);

        public static ulong and_g64u(ulong lhs, ulong rhs)
            => gmath.and(lhs,rhs);

        public static float and_32f(float lhs, float rhs)
            => fmath.and(lhs,rhs);

        public static float and_g32f(float lhs, float rhs)
            => gfp.and(lhs,rhs);

        public static double and_64f(double lhs, double rhs)
            => fmath.and(lhs,rhs);
