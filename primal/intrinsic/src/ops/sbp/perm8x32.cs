...
namespace Z0
{
    ...
    {        
        ...
        /// Applies a cross-lane permutation over 8 32-bit signed integers in the source vector as indicated by the perm spec
        /// </summary>
        /// <param name="src">The source vector</param>
        /// <param name="spec">The perm spec</param>
        [MethodImpl(Inline)]
        public static Vector256<int> vperm8x32i(Vector256<int> src, Vector256<uint> spec)
