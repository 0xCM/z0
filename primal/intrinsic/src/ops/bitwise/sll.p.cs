...
namespace Z0
{
    ...
    partial class ginx
    {
        ...
        /// <summary>
        /// Loads a vector from a pointer and applies a left shift, returning the result to the caller
        /// </summary>
        ...
        /// <summary>
        /// Loads a vector from a pointer and applies a left shift, storing the result to a target pointer
        /// </summary>
        /// <param name="n">The bitness selector</param>
        /// <param name="pX">A pointer from which the source vector will be read</param>
