...
namespace Z0
{
    ...
    partial class ginx
    {
        ...
        [MethodImpl(Inline)]
        public static Vec128<T> vnor<T>(in Vec128<T> x, in Vec128<T> y)
            where T : unmanaged
        {
        ...
        [MethodImpl(Inline)]
        public static Vec256<T> vnor<T>(in Vec256<T> x, in Vec256<T> y)
            where T : unmanaged
        {
            if(typeof(T) == typeof(byte) 
            || typeof(T) == typeof(ushort) 
        ...
        [MethodImpl(Inline)]
        static Vec128<T> vnor_128u<T>(in Vec128<T> x, in Vec128<T> y)
            where T : unmanaged
        {
            if(typeof(T) == typeof(byte))
        ...
        [MethodImpl(Inline)]
        static Vec128<T> vnor_128i<T>(in Vec128<T> x, in Vec128<T> y)
            where T : unmanaged
        {
        ...
        [MethodImpl(Inline)]
        static Vec128<T> vnor_128f<T>(in Vec128<T> x, in Vec128<T> y)
            where T : unmanaged
        {
        ...
        [MethodImpl(Inline)]
        static Vec256<T> vnor_256u<T>(in Vec256<T> x, in Vec256<T> y)
            where T : unmanaged
        {
            if(typeof(T) == typeof(byte))
                return generic<T>(dinx.vnor(uint8(x), uint8(y)));
        ...
        [MethodImpl(Inline)]
        static Vec256<T> vnor_256i<T>(in Vec256<T> x, in Vec256<T> y)
            where T : unmanaged
        {
            if(typeof(T) == typeof(sbyte))
                return generic<T>(dinx.vnor(int8(x), int8(y)));
        ...
        [MethodImpl(Inline)]
        static Vec256<T> vnor_256f<T>(in Vec256<T> x, in Vec256<T> y)
            where T : unmanaged
        {
            if(typeof(T) == typeof(float))
                return generic<T>(dinx.vnor(float32(x), float32(y)));
