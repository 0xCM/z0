...
namespace Z0
{
    ...
    partial class dinx
    {
        ...
        ///</summary>
        [MethodImpl(Inline)]
        public static Vec128<short> vshufflehi(in Vec128<short> src, Perm4 control)
        ...
        [MethodImpl(Inline)]
        public static Vec128<ushort> vshufflehi(in Vec128<ushort> src, Perm4 spec)
        ...
        /// <param name="spec">The permutation spec</param>
        [MethodImpl(Inline)]
        public static Vec128<short> vshufflelo(in Vec128<short> src, Perm4 control)
        ...
        /// <param name="spec">The permutation spec</param>
        [MethodImpl(Inline)]
        public static Vec128<ushort> vshufflelo(in Vec128<ushort> src, Perm4 control)
            => ShuffleLow(src.xmm, (byte)control);        
        ...
        [MethodImpl(Inline)]
        public static Vec128<short> vshuffle(in Vec128<short> src, Perm4 lo, Perm4 hi)        
        ...
        /// <param name="hi">The hi mask</param>
        [MethodImpl(Inline)]
        public static Vec128<ushort> vshuffle(in Vec128<ushort> src, Perm4 lo, Perm4 hi)        
            => vshufflehi(vshufflelo(src,lo),hi);                   
        ...
        [MethodImpl(Inline)]
        public static Vec128<int> vshuffle(in Vec128<int> src, Perm4 spec)
        ...
        [MethodImpl(Inline)]
        public static Vec128<uint> vshuffle(in Vec128<uint> src, Perm4 spec)
            => Shuffle(src.xmm, (byte)spec);
        ...
        /// <param name="spec">The shuffle spec</param>
        [MethodImpl(Inline)]
        public static Vec256<int> vshuffle(in Vec256<int> src, Perm4 spec)
            => Shuffle(src.ymm, (byte)spec);
        ...
        /// <param name="spec">The shuffle spec</param>
        [MethodImpl(Inline)]
        public static Vec256<uint> vshuffle(in Vec256<uint> src, Perm4 spec)
            => Shuffle(src.ymm, (byte)spec);
        ...
        [MethodImpl(Inline)]
        public static Vec128<ushort> vshufflehi(in Vec128<ushort> src, byte control)
        ...
        /// </summary>
        [MethodImpl(Inline)]
        public static Vec128<ushort> vshufflelo(in Vec128<ushort> src, byte control)
        ...
        /// <param name="spec">The permutation spec</param>
        [MethodImpl(Inline)]
        public static Vec128<sbyte> vshuffle(in Vec128<sbyte> src, in Vec128<sbyte> spec)
            => Shuffle(src.xmm, spec);
        ...
        [MethodImpl(Inline)]
        public static Vec256<sbyte> vshuffle(in Vec256<sbyte> src, in Vec256<sbyte> spec)
            => Shuffle(src.ymm, spec);
    }
}