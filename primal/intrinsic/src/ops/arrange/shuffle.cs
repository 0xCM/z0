...
namespace Z0
{
    ...
    partial class dinx
    {
        ...
        /// <param name="spec">The shuffle spec</param>
        [MethodImpl(Inline)]
        public static Vector256<int> vshuffle(Vector256<int> src, Arrange4 spec)
            => Shuffle(src, (byte)spec);
        ...
        /// <param name="spec">The shuffle spec</param>
        [MethodImpl(Inline)]
        public static Vector256<uint> vshuffle(Vector256<uint> src, Arrange4 spec)
            => Shuffle(src, (byte)spec);
        ...
        /// <param name="spec">The shuffle spec</param>
        [MethodImpl(Inline)]
        public static Vector128<short> vshufflehi(Vector128<short> src, Perm4 spec)
            => ShuffleHigh(src, (byte)spec);
        ...
        /// <param name="spec">The permutation spec</param>
        [MethodImpl(Inline)]
        public static Vector128<short> vshufflelo(Vector128<short> src, Perm4 spec)
            => ShuffleLow(src, (byte)spec);
        ...
        /// <param name="spec">The permutation spec</param>
        [MethodImpl(Inline)]
        public static Vector128<ushort> vshufflelo(Vector128<ushort> src, Perm4 spec)
            => ShuffleLow(src, (byte)spec);        
        ...
        /// <param name="spec">The shuffle spec</param>
        [MethodImpl(Inline)]
        public static Vector128<ushort> vshufflehi(Vector128<ushort> src, byte spec)
        ...
        /// </summary>
        [MethodImpl(Inline)]
        public static Vector128<ushort> vshufflelo(Vector128<ushort> src, byte spec)
            => ShuffleLow(src, spec);
        ...
        /// as specified by the corresponding element in the shuffle spec
        ///</summary>
        /// <param name="src">The content vector</param>
        /// <param name="spec">The shuffle spec</param>
        [MethodImpl(Inline)]
