...
namespace Z0
{
    ...
    public readonly struct ParsedFunctions : IBinaryResourceIndex, IAsmFunctionCases
    {
        ...
        internal ParsedFunctions(int _)
        {
            ...
            var index = 0;
            Register(index++, ApiIdentityParser.parse(nameof(or_ᐤ8uㆍ8uᐤ)), or_ᐤ8uㆍ8uᐤ);
            Register(index++, ApiIdentityParser.parse(nameof(or_ᐤ16uㆍ16uᐤ)), or_ᐤ16uㆍ16uᐤ);
            Register(index++, ApiIdentityParser.parse(nameof(or_ᐤ32uㆍ32uᐤ)), or_ᐤ32uㆍ32uᐤ);
            Register(index++, ApiIdentityParser.parse(nameof(or_ᐤ64uㆍ64uᐤ)), or_ᐤ64uㆍ64uᐤ);
            Register(index++, ApiIdentityParser.parse(nameof(within_ᐤ8uㆍ8uㆍ8uᐤ)), within_ᐤ8uㆍ8uㆍ8uᐤ);
        }
