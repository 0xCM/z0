...
namespace Z0
{
    ...
    public struct BinaryComparisonResult<T,R>
    {
        public ComparisonKind Operator;
    ...
    {
        public static BinaryComparisonResult<T,R> eq<T,R>(T lhs, T rhs, R outcome)
        {
            var dst = new BinaryComparisonResult<T,R>();
        ...
        public void t_uint3_reduce()
        {
            ...
            var result = span<BinaryComparisonResult<uint3,bool>>(PointCount);
        ...
        void Analyze(ReadOnlySpan<BinaryComparisonResult<uint3,bool>> src )
        {
