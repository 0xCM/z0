...
namespace Z0
{
    ...
    public class t_vinflate : t_inx<t_vinflate>
    {
        public void vinflate_128x8u()
        {
            ...
            var v128x8u_output = cpu.vcompact8u(v128x16u_a, v128x16u_b, w128);
        ...
        public void vinflate_256x8_1024x32()
        {
            ...
            var c8 = cpu.vcompact8u(a0, b0, c0, d0, w256);
            var c16 = cpu.vcompact16u(a0, b0, w256);
            var v1024x32u = cpu.vinflate32u(c8, w1024);
