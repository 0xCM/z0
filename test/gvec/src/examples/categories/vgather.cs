...
namespace Z0
{
    ...
    partial class VexExamples
    {
        ...
        public void vgather_128()
        {
            ...
            var v256Expect = vparts(n128,0, 63, 127, 255);
            ...
            var i2x64 = vparts(n128, 64, 128);
            var v2x64 = cpu.vgather(n128, in src64, i2x64);
            Claim.veq(i2x64, v2x64);

            var i2x250 = vparts(n128, 250, 500);
            var v2x250 = cpu.vgather(n128, in src64, i2x250);
            Claim.veq(i2x250, v2x250);

            var i2x2 = vparts(n256, 2, 4, 8, 16);
            var v2x2 = cpu.vgather(n128, in src32, i2x2);
            Claim.veq(vcompact32u(i2x2, n128, z32i), v2x2);

            var i3x3 = vparts(n256, 3, 6, 12, 24);
            var v3x3 = cpu.vgather(n128, in src32, i3x3);
            Claim.veq(vcompact32u(i3x3, n128, z32i), v3x3);

            var i3_3 = vparts(n256, 3, 6, 9, 12);
            var v3_3 = cpu.vgather(n128, in src32, i3_3);
            Claim.veq(vcompact32u(i3_3, n128, z32i), v3_3);

            var i4x2 = vparts(n256, 4, 8, 16, 32);
            var v4x2 = cpu.vgather(n128, in src32, i4x2);
            Claim.veq(vcompact32u(i4x2, n128, z32i), v4x2);

            var i5_5 =vparts(n256, 5, 10, 15, 20);
            var v5_5 = cpu.vgather(n128, in src32, i5_5);
            Claim.veq(vcompact32u(i5_5, n128, z32i), v5_5);

            var i9_9 = vparts(n256, 9, 18, 27, 36);
            var v9_9 = cpu.vgather(n128, in src32, i9_9);
            Claim.veq(vcompact32u(i9_9, n128, z32i), v9_9);

            var i10_10 = vparts(n256, 10, 20, 30, 40);
            var v10_10 = cpu.vgather(n128, in src32, i10_10);
            Claim.veq(vcompact32u(i10_10, n128, z32i), v10_10);

            var i16x2 = vparts(n256, 16, 32, 64, 128);
            var v16x2 = cpu.vgather(n128, in src32, i16x2);
            Claim.veq(vcompact32u(i16x2, n128, z32i), v16x2);

            var i20_5 = vparts(n256, 20, 25, 30, 35);
            var v20_5 = cpu.vgather(n128, in src32, i20_5);
            Claim.veq(vcompact32u(i20_5, n128, z32i), v20_5);

            var i40_3 = vparts(n256, 40, 43, 46, 49);
            var v40_3 = cpu.vgather(n128, in src32, i40_3);
            Claim.veq(vcompact32u(i40_3, n128, z32i), v40_3);

            var i4x128 = vparts(w256i, 0, 128 - 1, 128*2 - 1, 128*4 - 1);
            var v4x128 = cpu.vgather(n128, in src32, v512idx);
            Claim.veq(z.vcompact32i(i4x128, n128, z32i), v32i(v4x128));
        }
        ...
        public void vgather_256()
        {
            ...
            var v256idx = vparts(n256,Pow2.T00 - 1, Pow2.T02 - 1, Pow2.T03 - 1, Pow2.T04 - 1, Pow2.T05 - 1, Pow2.T06 - 1, Pow2.T07 - 1, Pow2.T08 - 1);
            var v256Expect = vparts(n256, 0, Pow2.T02 - 1, Pow2.T03 - 1, Pow2.T04 - 1, Pow2.T05 - 1, Pow2.T06 - 1, Pow2.T07 - 1, Pow2.T08 - 1);
            var v256Actual = cpu.vgather(n256, in src, v256idx);
            Claim.veq(v256Expect,v256Actual);

            var v512Expect = vparts(n256, 0, Pow2.T03 - 1, Pow2.T04 - 1, Pow2.T05 - 1, Pow2.T06 - 1, Pow2.T07 - 1, Pow2.T08 - 1, Pow2.T09 - 1);
        ...
        public void vgather_blocks()
        {
            ...
            var a0 = cpu.vgather(w, in A.First, vparts(w,4*12, 4*24, 4*48, 4*64));
        ...
        {
            [MethodImpl(Inline)]
            get => z.vload(n256, in z.first64(VGather256x64x256IndexData));
        }
        ...
        {
            [MethodImpl(Inline)]
            get => z.vload(n256, in z.first64i(VGather256x64x256IndexData));
        }
