...
namespace Z0
{
    ...
    public interface ISVFImm8ScalarApi<W,V,T,K> : ISVFuncApi, ISFuncApi<V,byte,K>
    ...
    /// <typeparam name="K">The scalar result type</typeparam>
    [SuppressUnmanagedCodeSecurity]
    public interface ISVFImm8ScalarApi<W1,W2,V1,V2,T1,T2,K> : ISVFuncApi, ISFuncApi<V1,V2,byte,K>
