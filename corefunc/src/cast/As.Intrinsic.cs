...
namespace Z0
{
    ...
    partial class As
    {
        ...
        public static ref Vector512<T> vgeneric<T>(in Vector512<sbyte> src)
            where T : unmanaged        
                => ref Unsafe.As<Vector512<sbyte>,Vector512<T>>(ref mutable(in src));
        ...
        public static ref Vector512<T> vgeneric<T>(in Vector512<byte> src)
            where T : unmanaged        
                => ref Unsafe.As<Vector512<byte>,Vector512<T>>(ref mutable(in src));
        ...
        public static ref Vector512<T> vgeneric<T>(in Vector512<short> src)
            where T : unmanaged        
                => ref Unsafe.As<Vector512<short>,Vector512<T>>(ref mutable(in src));
        ...
        public static ref Vector512<T> vgeneric<T>(in Vector512<ushort> src)
            where T : unmanaged        
                => ref Unsafe.As<Vector512<ushort>,Vector512<T>>(ref mutable(in src));
        ...
        public static ref Vector512<T> vgeneric<T>(in Vector512<int> src)
            where T : unmanaged        
                => ref Unsafe.As<Vector512<int>,Vector512<T>>(ref mutable(in src));
        ...
        public static ref Vector512<T> vgeneric<T>(in Vector512<uint> src)
            where T : unmanaged        
                => ref Unsafe.As<Vector512<uint>,Vector512<T>>(ref mutable(in src));
        ...
        public static ref Vector512<T> vgeneric<T>(in Vector512<long> src)
            where T : unmanaged        
                => ref Unsafe.As<Vector512<long>,Vector512<T>>(ref mutable(in src));
        ...
        public static ref Vector512<T> vgeneric<T>(in Vector512<ulong> src)
            where T : unmanaged        
                => ref Unsafe.As<Vector512<ulong>,Vector512<T>>(ref mutable(in src));
        ...
        public static ref Vector512<T> vgeneric<T>(in Vector512<float> src)
            where T : unmanaged        
                => ref Unsafe.As<Vector512<float>,Vector512<T>>(ref mutable(in src));
