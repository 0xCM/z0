...
namespace Z0
{
    ...
    public static class XPressive
    {
        ...
        public static Func<X1, X2, X3, Y> func<X1, X2, X3, Y>(MethodInfo m, object instance = null)
            ...
            {
                var args = seq(paramX<X1>("x1"), paramX<X2>("x2"), paramX<X3>("x3"));
                var f = call(instance, m, args.ToArray());
        ...
        public static Expression<Func<X, Y, Z>> lambda<X, Y, Z>(Func<XPR, XPR, BinaryExpression> f)
        {
            ...
            var p2 = paramX<Y>("p2");
            var eval = f(p1, p2);
            return lambda<Func<X, Y, Z>>(seq(p1, p2), eval);
        }
        ...
        public static Option<Func<X, Y>> factory<X, Y>()
            => from c in Reflective.ctor<Y>(typeof(X))
        ...
        public static Option<Func<object, object>> factory(Type targetType, Type arg1Type)
            => from c in Reflective.ctor(targetType, arg1Type)
        ...
        public static Option<Func<X1, X2, Y>> factory<X1, X2, Y>()
            => from c in Reflective.ctor<Y>(typeof(X1), typeof(X2))
        ...
        public static Option<Func<object, object, object>> factory(Type targetType, Type arg1Type, Type arg2Type)
            => from c in Reflective.ctor(targetType, arg1Type, arg2Type)
        ...
        public static XFunc<X> fmake<X>(Func<X> f)
            => f;
        ...
        /// <typeparam name="Y">The return type</typeparam>
        /// <param name="f">The source function</param>
        public static XFunc<X,Y> fmake<X,Y>(Func<X,Y> f)
            => f;
        ...
        /// <typeparam name="Y">The return type</typeparam>
        /// <param name="f">The source function</param>
        public static XFunc<X1, X2, Y> fmake<X1, X2, Y>(Func<X1, X2, Y> f)
            => f;
        ...
        /// <typeparam name="X">The operand type</typeparam>
        /// <param name="f">The source function</param>
        public static XFunc<X, X, X> fmake<X>(Func<X, X, X> f)
            => f;
        ...
        /// <typeparam name="Y">The return type</typeparam>
        /// <param name="f">The source function</param>
        public static XFunc<X1, X2, X3, Y> fmake<X1, X2, X3, Y>(Func<X1, X2, X3, Y> f)
            => f;
        ...
        /// <typeparam name="X">The operand type</typeparam>
        /// <param name="f">The source function</param>
        public static XFunc<X, X, X,X> fmake<X>(Func<X, X, X,X> f)
            => f;
