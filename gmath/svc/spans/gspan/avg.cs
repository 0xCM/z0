    ...
    partial class gspan
    {
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(byte))
                return generic<T>(math.avg(Spans.span8u(src), @checked));
            else if(typeof(T) == typeof(ushort))
                return generic<T>(math.avg(Spans.span16u(src)));
            else if(typeof(T) == typeof(uint))
                return generic<T>(math.avg(Spans.span32u(src)));
            else if(typeof(T) == typeof(ulong))
                return generic<T>(math.avg(Spans.span64u(src)));
            else
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(sbyte))
                return generic<T>(math.avg(Spans.span8i(src), @checked));
            else if(typeof(T) == typeof(short))
                return generic<T>(math.avg(Spans.span16i(src), @checked));
            else if(typeof(T) == typeof(int))
                return generic<T>(math.avg(Spans.span32i(src), @checked));
            else if(typeof(T) == typeof(long))
                return generic<T>(math.avg(Spans.span64i(src), @checked));
            else
