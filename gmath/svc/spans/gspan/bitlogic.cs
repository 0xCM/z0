...
namespace Z0
{
    ...
    partial class gspan
    {
        ...
        public static Span<T> and<T>(ReadOnlySpan<T> l, ReadOnlySpan<T> r, Span<T> dst)
            where T : unmanaged
                => Spans.apply(MathSvcFactory.and<T>(), l,r,dst);
        ...
        public static Span<T> or<T>(ReadOnlySpan<T> l, ReadOnlySpan<T> r, Span<T> dst)
            where T : unmanaged
                => Spans.apply(MathSvcFactory.or<T>(), l, r, dst);
