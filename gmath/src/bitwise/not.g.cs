...
namespace Z0
{
    ...
    partial class gmath
    {
        ...
        {
            if(typeof(T) == typeof(sbyte))
                 math.not(ref int8(ref src));
            else if(typeof(T) == typeof(short))
                 math.not(ref int16(ref src));
            else if(typeof(T) == typeof(int))
                 math.not(ref int32(ref src));
            else
                 math.not(ref int64(ref src));
            return ref src;
        }
        ...
        {
            if(typeof(T) == typeof(byte))
                 math.not(ref uint8(ref src));
            else if(typeof(T) == typeof(ushort))
                 math.not(ref uint16(ref src));
            else if(typeof(T) == typeof(uint))
                 math.not(ref uint32(ref src));
            else
                 math.not(ref uint64(ref src));
            return ref src;
        }
    }
}