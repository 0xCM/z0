...
namespace Z0.Logix
{
    ...
    {
        [MethodImpl(Inline), VectorOp, PrimalClosures(NumericKind.Integers)]
        ...
        [MethodImpl(Inline), BinaryBitLogicOp(Xor), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> xor<T>(Vector256<T> a, Vector256<T> b)
            where T : unmanaged
                => ginx.vxor(a,b);

        [MethodImpl(Inline), BinaryBitLogicOp(Xnor), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> xnor<T>(Vector256<T> a, Vector256<T> b)
            where T : unmanaged
                => ginx.vxnor(a,b);

        [MethodImpl(Inline), BinaryBitLogicOp(LProject), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> left<T>(Vector256<T> a, Vector256<T> b)
            where T : unmanaged
                => a;

        [MethodImpl(Inline), BinaryBitLogicOp(LNot), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> lnot<T>(Vector256<T> a, Vector256<T> b)
            where T : unmanaged
                => not(a);

        [MethodImpl(Inline), BinaryBitLogicOp(RProject), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> right<T>(Vector256<T> a, Vector256<T> b)
            where T : unmanaged
                => b;

        [MethodImpl(Inline), BinaryBitLogicOp(RNot), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> rnot<T>(Vector256<T> a, Vector256<T> b)
            where T : unmanaged
                => not(b);

        [MethodImpl(Inline), BinaryBitLogicOp(Impl), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> impl<T>(Vector256<T> a, Vector256<T> b)
            where T : unmanaged
                => ginx.vimpl(a,b);

        [MethodImpl(Inline), BinaryBitLogicOp(NonImpl), PrimalClosures(NumericKind.Integers)]
        ...
        [MethodImpl(Inline), VectorOp, PrimalClosures(NumericKind.UnsignedInts)]
        ...
        [MethodImpl(Inline), VectorOp, PrimalClosures(NumericKind.Integers& (~NumericKind.U64))]
        ...
        [MethodImpl(Inline),TernaryBitLogicOp(X00), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f00<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => default;

        [MethodImpl(Inline),TernaryBitLogicOp(X01), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f01<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
            => nor(a, or(b,c));

        [MethodImpl(Inline),TernaryBitLogicOp(X02), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f02<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => and(c, nor(b,a));
 
         // b nor a
        [MethodImpl(Inline), TernaryBitLogicOp(X03), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f03<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => nor(b,a);

       // b and (a nor c)
        [MethodImpl(Inline),TernaryBitLogicOp(X04), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f04<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => and(b, nor(a,c));

        // c nor a
        [MethodImpl(Inline),TernaryBitLogicOp(X05), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f05<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => nor(c,a);

        [MethodImpl(Inline),TernaryBitLogicOp(X06), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f06<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => and(not(a), xor(b,c));

        [MethodImpl(Inline),TernaryBitLogicOp(X07), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f07<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => nor(a, and(b,c));
        
        [MethodImpl(Inline),TernaryBitLogicOp(X08), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f08<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => and(and(not(a),b), c);

        [MethodImpl(Inline), TernaryBitLogicOp(X09), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f09<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => nor(a, xor(b,c));

        [MethodImpl(Inline), TernaryBitLogicOp(X0A), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f0a<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => and(c, not(a));

        // not a and ((b xor 1) or c)
        [MethodImpl(Inline), TernaryBitLogicOp(X0B), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f0b<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => and(not(a), or(not(b),  c));   

        // b and (not a)
        [MethodImpl(Inline), TernaryBitLogicOp(X0C), PrimalClosures(NumericKind.Integers)]
        ...
        // not a and (b or c)
        [MethodImpl(Inline), TernaryBitLogicOp(X0E), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f0e<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => and(not(a),or(b,c));

        // not a
        [MethodImpl(Inline), TernaryBitLogicOp(X0F), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f0f<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => not(a);

        // a and (b nor c)
        [MethodImpl(Inline), TernaryBitLogicOp(X10), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f10<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => and(a, nor(b, c));
        
        // c nor b
        [MethodImpl(Inline), TernaryBitLogicOp(X11), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f11<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => nor(c,b);
        
        // not b and (a xor c) 
        [MethodImpl(Inline), TernaryBitLogicOp(X12), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f12<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => and(not(b), xor(a,c));

        // b nor (a and c)
        [MethodImpl(Inline), TernaryBitLogicOp(X13), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f13<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => nor(b, and(a,c));

        // not c and (a xor b)
        [MethodImpl(Inline), TernaryBitLogicOp(X14), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f14<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => and(not(c), xor(a,b));

        // c nor (b and a)
        [MethodImpl(Inline), TernaryBitLogicOp(X15), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f15<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => nor(c, and(a,b));

        // a ? (b nor c) : (b xor c)
        [MethodImpl(Inline), TernaryBitLogicOp(X16), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f16<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => select(a, nor(b,c), xor(b,c));

        // not(a ? (b or c) : (b and c))
        [MethodImpl(Inline), TernaryBitLogicOp(X17), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f17<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => not(select(a, or(b,c), and(b,c)));

        // (a xor b) and (a xor c)
        [MethodImpl(Inline), TernaryBitLogicOp(X18), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f18<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => and(xor(a,b), xor(a,c));

        // ((b xor c) xor (a and (b and c))
        [MethodImpl(Inline), TernaryBitLogicOp(X19), PrimalClosures(NumericKind.Integers)]
        ...
        [MethodImpl(Inline), TernaryBitLogicOp(X1A), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f1a<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => not(and(and(a,b), xor(a, c)));

        // c ? not a : not b
        [MethodImpl(Inline), TernaryBitLogicOp(X1B), PrimalClosures(NumericKind.Integers)]
        public static Vector256<T> f1b<T>(Vector256<T> a, Vector256<T> b, Vector256<T> c)
            where T : unmanaged
                => select(c, not(a), not(b));

        // a ? (b xnor c) : (b nand c)
        [MethodImpl(Inline), TernaryBitLogicOp(X97), PrimalClosures(NumericKind.Integers)]
