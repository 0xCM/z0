...
namespace Z0.Logix
{
    ...
    public static partial class TypedLogicSpec
    {
        ...
        [MethodImpl(Inline)]
        public static VariableExpr<T> variable<T>(string name, ITypedExpr<T> value)
            where T : unmanaged
        ...
        /// <typeparam name="T">The variable type</typeparam>
        [MethodImpl(Inline)]
        public static VariableExpr<T> variable<T>(char name, ITypedExpr<T> value)
            where T : unmanaged
        ...
        [MethodImpl(Inline)]
        public static VariableExpr<T> variable<T>(uint name, ITypedExpr<T> init)
            where T : unmanaged
        ...
        [MethodImpl(Inline)]
        public static VariedExpr<T> varied<T>(ITypedExpr<T> baseExpr, params VariableExpr<T>[] variables)
            where T : unmanaged             
        ...
        /// <param name="variables">The variable sequence</param>
        [MethodImpl(Inline)]
        public static VariedExpr<N,T> varied<N,T>(N n, ITypedExpr<T> baseExpr, params VariableExpr<T>[] variables)
            where T : unmanaged             
            where N : unmanaged, ITypeNat
        {
            Nat.require<N>(variables.Length);
        ...
        [MethodImpl(Inline)]
        public static VariedExpr<N1,T> varied<T>(N1 n, ITypedExpr<T> baseExpr, VariableExpr<T> v0)
            where T : unmanaged             
        ...
        /// <typeparam name="T">The type over which the expression is defined</typeparam>
        [MethodImpl(Inline)]
        public static VariedExpr<N2,T> varied<T>(N2 n, ITypedExpr<T> baseExpr, VariableExpr<T> v0, VariableExpr<T> v1)
            where T : unmanaged             
        ...
        /// <typeparam name="T">The type over which the expression is defined</typeparam>
        [MethodImpl(Inline)]
        public static VariedExpr<N3,T> varied<T>(N3 n, ITypedExpr<T> baseExpr, VariableExpr<T> v0, VariableExpr<T> v1, VariableExpr<T> v2)
            where T : unmanaged             
