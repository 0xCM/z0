...
namespace Z0.Logix
{
    ...
    partial class BitLogicSpec
    {
       /// <summary>
        ...
        [MethodImpl(Inline)]
        public static ComparisonExpr compare(ComparisonOpKindId kind, ILogicExpr lhs, ILogicExpr rhs, params ILogicVarExpr[] variables)
        ...
        /// <typeparam name="T">The operand type</typeparam>
        [MethodImpl(Inline)]
        public static ComparisonExpr<T> compare<T>(ComparisonOpKindId kind, ILogicExpr<T> lhs, ILogicExpr<T> rhs, params IVarExpr<T>[] variables)
            where T : unmanaged
                => ComparisonExpr.Define(kind, lhs,rhs, variables);
        ...
        public static ComparisonExpr equals(ILogicExpr lhs, ILogicExpr rhs, params ILogicVarExpr[] variables)
            => ComparisonExpr.Define(ComparisonOpKindId.Eq, lhs,rhs,variables);
