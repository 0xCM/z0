...
namespace Z0.Logix
{
    ...
    public static class PredicateSpec
    {
        ...
        [MethodImpl(Inline)]
        public static ComparisonPredExpr<T> compare<T>(ComparisonOpKindId kind, IExpr<T> a, IExpr<T> b)
            where T : unmanaged
        ...
        /// <typeparam name="T">The operand type</typeparam>
        [MethodImpl(Inline)]
        public static ComparisonPredExpr<T> compare<T>(ComparisonOpKindId kind, T a, T b)
            where T : unmanaged
