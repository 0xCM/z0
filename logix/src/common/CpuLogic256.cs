...
namespace Z0
{
    ...
    public static class CpuLogic256
    {
       ...
       // b and (a nor c)
        ...
        public static UnaryOp<Vector256<T>> unaryop<T>(UnaryLogicOpKind id)
            where T : unmanaged            
        {
            switch(id)
            {
       ...
       public static BinaryOp<Vector256<T>> binop<T>(BinaryLogicOpKind id)
            where T : unmanaged
        {
            switch(id)
            {
        ...
        public static TernaryOp<Vector256<T>> ternop<T>(TernaryLogicOpKind id)
            where T : unmanaged
        {
            switch(id)
            {
