...
namespace Z0
{
    ...
    {        
        ...
        public static UnaryOp<bit> unaryop(UnaryLogicKind id)
        {
            switch(id)
            {
        ...
        public static BinaryOp<bit> binop(BinaryLogicKind id)
        {
            switch(id)
            {
                ...
                case BinaryLogicKind.AndNot: return andnot;
                default:
                    throw unsupported<Bit>();
            }
        }
        ...
        public static IEnumerable<TernaryLogicKind> ternops
            => range((byte)1,0xf1b).Cast<TernaryLogicKind>();

        public static TernaryOp<bit> ternop(TernaryLogicKind id)
        {
            switch(id)
            {
                case X01: return f01;
        ...
        public static BitMatrix<N4,N3,byte> table(BinaryLogicKind op)
        {
        ...
        public static BitMatrix<N8,N4, byte> table(TernaryLogicKind op)
        {
