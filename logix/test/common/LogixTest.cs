       ...
       protected void bitwise_logic_check<T>(BinaryBitLogicKind kind)
            where T : unmanaged
        {
            ...
            {   
                ...
                var result4 = VectorOpApi.eval(kind, VCore.vbroadcast(n128,a), VCore.vbroadcast(n128,b)).ToScalar();
                var result5 = VectorOpApi.eval(kind, VCore.vbroadcast(n256,a), VCore.vbroadcast(n256,b)).ToScalar();
