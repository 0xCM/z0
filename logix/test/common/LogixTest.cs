       ...
       protected void bitwise_logic_check<T>(BinaryBitLogicKind kind)
            where T : unmanaged
        {
            ...
            {   
                ...
                var result4 = VectorOpApi.eval(kind, vgeneric.vbroadcast(n128,a), vgeneric.vbroadcast(n128,b)).ToScalar();
                var result5 = VectorOpApi.eval(kind, vgeneric.vbroadcast(n256,a), vgeneric.vbroadcast(n256,b)).ToScalar();
