...
namespace Z0.Logix
{
    ...
    public class t_variables : UnitTest<t_variables>
    {
        ...
        void check_4x2(BinaryBitLogicOpKind k0, BinaryBitLogicOpKind k1)
        {
        ...
        void check_4x2<T>(BinaryBitLogicOpKind k0, BinaryBitLogicOpKind k1)
            where T : unmanaged
        {
            var v0 = variable<T>(0);
            var v1 = variable<T>(1);
        ...
        void check_binop_vars(BinaryBitLogicOpKind kind)
        {
        ...
        void check_binop_vars<T>(BinaryBitLogicOpKind kind)
            where T : unmanaged
        {
            var v0 = variable<T>(0);
            var v1 = variable<T>(1);
