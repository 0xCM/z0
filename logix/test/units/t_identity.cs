...
namespace Z0
{
    ...
    //     public void check_equality(ILogicVarExpr v1, ILogicVarExpr v2, IExpr expr1, IExpr expr2)
    //     {
    ...
    //     void check_equality<T>(IVarExpr<T> v1, IVarExpr<T> v2, IExpr<T> expr1, IExpr<T> expr2)
    //         where T : unmanaged
    //     {
    ...
    //     void check_equality<T>(IVarExpr<Vec128<T>> v1, IVarExpr<Vec128<T>> v2, IExpr<Vec128<T>> expr1, IExpr<Vec128<T>> expr2)
    //         where T : unmanaged
    //     {
    //         for(var i=0; i< SampleSize; i++)
    //         {
    ...
    //     void check_equality<T>(IVarExpr<Vec256<T>> v1, IVarExpr<Vec256<T>> v2, IExpr<Vec256<T>> expr1, IExpr<Vec256<T>> expr2)
    //         where T : unmanaged
    //     {
    //         for(var i=0; i< SampleSize; i++)
    //         {
