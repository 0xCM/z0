...
namespace Z0.Mkl
{
    ...
    partial class mkl
    {
        ...
        [MethodImpl(Inline)]
        public static int iamin(VBlock256<float> X)        
        ...
        /// <param name="X">The source vector</param>
        [MethodImpl(Inline)]
        public static float amin(VBlock256<float> X)        
            => X[iamin(X)];
        ...
        /// <param name="X">The source vector</param>
        [MethodImpl(Inline)]
        public static int iamin(VBlock256<double> X)        
        ...
        /// <param name="X">The source vector</param>
        [MethodImpl(Inline)]
        public static double amin(VBlock256<double> X)        
            => X[iamin(X)];
