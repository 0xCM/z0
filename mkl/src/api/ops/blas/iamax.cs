...
namespace Z0.Mkl
{
    ...
    partial class mkl
    {
        ...
        [MethodImpl(Inline)]
        public static int iamax(VBlock256<float> X)        
        ...
        /// <param name="X">The source vector</param>
        [MethodImpl(Inline)]
        public static float amax(VBlock256<float> X)        
            => X[iamax(X)];
        ...
        /// <param name="X">The source vector</param>
        [MethodImpl(Inline)]
        public static int iamax(VBlock256<double> X)        
        ...
        /// <param name="X">The source vector</param>
        [MethodImpl(Inline)]
        public static double amax(VBlock256<double> X)        
            => X[iamax(X)];
