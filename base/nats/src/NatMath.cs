...
{        
    ...
    public static class NatMath2
    {
        [MethodImpl(Inline)]
        public static ulong natval<K>(K k = default)
        ...
        [MethodImpl(Inline)]
        public static ulong sll<K1,K2>(K1 k1 = default, K2 k2 = default)
            where K1 : unmanaged, ITypeNat
            where K2 : unmanaged, ITypeNat
                => natval(k1) << (int)natval(k2);

        [MethodImpl(Inline)]
        public static ulong srl<K1,K2>(K1 k1 = default, K2 k2 = default)
            where K1 : unmanaged, ITypeNat
            where K2 : unmanaged, ITypeNat
                => natval(k1) >> (int)natval(k2);
