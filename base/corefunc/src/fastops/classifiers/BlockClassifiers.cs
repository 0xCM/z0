...
namespace Z0
{
    ...
    {
        public readonly struct BlockClass<W,T> : IBlockClass<W,T>
            where W : unmanaged, ITypeNat
            where T : unmanaged            
        {
            [MethodImpl(Inline)]
            public static implicit operator BlockKind(BlockClass<W,T> b)
                => b.Classifier;
        ...
        [MethodImpl(Inline)]
        public static BlockClass<N16,T> block<T>(N16 w, T t = default)
            where T : unmanaged
                => default;

        [MethodImpl(Inline)]
        public static BlockClass<N32,T> block<T>(N32 w, T t = default)
            where T : unmanaged
                => default;

        [MethodImpl(Inline)]
        public static BlockClass<N64,T> block<T>(N64 w, T t = default)
            where T : unmanaged
                => default;

        [MethodImpl(Inline)]
        public static BlockClass<N128,T> block<T>(N128 w, T t = default)
            where T : unmanaged
                => default;

        [MethodImpl(Inline)]
        public static BlockClass<N256,T> block<T>(N256 w, T t = default)
            where T : unmanaged
                => default;

        [MethodImpl(Inline)]
        public static BlockClass<N512,T> block<T>(N512 w, T t = default)
            where T : unmanaged
                => default;

        [MethodImpl(Inline)]
        public static BlockClass<W,T> block<W,T>(W w = default, T t = default)
            where W : unmanaged, ITypeNat
            where T : unmanaged
                => default;

        public readonly struct Block16x8u : IBlockClass { public const BlockKind Kind = BlockKind.Block16x8u; public BlockKind Classifier => Kind;}
        
        public readonly struct Block16x8i : IBlockClass { public const BlockKind Kind = BlockKind.Block16x8i; public BlockKind Classifier => Kind;}
        
        public readonly struct Block16x16u : IBlockClass { public const BlockKind Kind = BlockKind.Block16x16u; public BlockKind Classifier => Kind;}

        public readonly struct Block16x16i : IBlockClass { public const BlockKind Kind = BlockKind.Block16x16i; public BlockKind Classifier => Kind;}

        public readonly struct Block32x8u : IBlockClass { public const BlockKind Kind = BlockKind.Block32x8u; public BlockKind Classifier => Kind;}
        
        public readonly struct Block32x8i : IBlockClass { public const BlockKind Kind = BlockKind.Block32x8i; public BlockKind Classifier => Kind;}
        
        public readonly struct Block32x16u : IBlockClass { public const BlockKind Kind = BlockKind.Block32x16u; public BlockKind Classifier => Kind;}

        public readonly struct Block32x16i : IBlockClass { public const BlockKind Kind = BlockKind.Block32x16i; public BlockKind Classifier => Kind;}

        public readonly struct Block32x32u : IBlockClass { public const BlockKind Kind = BlockKind.Block32x32u; public BlockKind Classifier => Kind;}

        public readonly struct Block32x32i : IBlockClass { public const BlockKind Kind = BlockKind.Block32x32i; public BlockKind Classifier => Kind;}

        public readonly struct Block64x8u : IBlockClass { public const BlockKind Kind = BlockKind.Block64x8u; public BlockKind Classifier => Kind;}
        
        public readonly struct Block64x8i : IBlockClass { public const BlockKind Kind = BlockKind.Block64x8i; public BlockKind Classifier => Kind;}
        
        public readonly struct Block64x16u : IBlockClass { public const BlockKind Kind = BlockKind.Block64x16u; public BlockKind Classifier => Kind;}

        public readonly struct Block64x16i : IBlockClass { public const BlockKind Kind = BlockKind.Block64x16i; public BlockKind Classifier => Kind;}

        public readonly struct Block64x32u : IBlockClass { public const BlockKind Kind = BlockKind.Block64x32u; public BlockKind Classifier => Kind;}

        public readonly struct Block64x32i : IBlockClass { public const BlockKind Kind = BlockKind.Block64x32i; public BlockKind Classifier => Kind;}

        public readonly struct Block64x64u : IBlockClass { public const BlockKind Kind = BlockKind.Block64x64u; public BlockKind Classifier => Kind;}

        public readonly struct Block64x64i : IBlockClass { public const BlockKind Kind = BlockKind.Block128x64i; public BlockKind Classifier => Kind;}
