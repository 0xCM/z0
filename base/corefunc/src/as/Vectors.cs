...
namespace Z0
{
    ...
    partial class As
    {
        ...
        [MethodImpl(Inline)]
        public static Vector256<T> vgeneric<T>(Vector256<byte> src)
            where T : unmanaged        
                => Unsafe.As<Vector256<byte>,Vector256<T>>(ref src);

        [MethodImpl(Inline)]
        public static Vector256<T> vgeneric<T>(Vector256<sbyte> src)
            where T : unmanaged        
                => Unsafe.As<Vector256<sbyte>,Vector256<T>>(ref src);

        [MethodImpl(Inline)]
        public static Vector256<T> vgeneric<T>(Vector256<short> src)
            where T : unmanaged        
                => Unsafe.As<Vector256<short>,Vector256<T>>(ref src);

        [MethodImpl(Inline)]
        public static Vector256<T> vgeneric<T>(Vector256<ushort> src)
            where T : unmanaged        
                => Unsafe.As<Vector256<ushort>,Vector256<T>>(ref src);

        [MethodImpl(Inline)]
        public static Vector256<T> vgeneric<T>(Vector256<int> src)
            where T : unmanaged        
                => Unsafe.As<Vector256<int>,Vector256<T>>(ref src);


        [MethodImpl(Inline)]
        public static Vector256<T> vgeneric<T>(Vector256<uint> src)
            where T : unmanaged        
