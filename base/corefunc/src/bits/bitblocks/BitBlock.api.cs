...
namespace Z0
{
    ...
    public static class BitBlock
    {
        ...
        [MethodImpl(Inline)]
        public static BitBlock<N,T> load<N,T>(params T[] src)
            where T : unmanaged        
            where N : unmanaged, ITypeNat<N>
                =>  new BitBlock<N, T>(MemoryMarshal.CreateSpan(ref src[0], cells<N,T>()));                
        ...
        /// <typeparam name="T">The cell type</typeparam>
        [MethodImpl(Inline)]
        public static BitBlock<N,T> load<N,T>(N n, params T[] src)
            where T : unmanaged        
            where N : unmanaged, ITypeNat<N>
                =>  new BitBlock<N, T>(MemoryMarshal.CreateSpan(ref src[0], cells<N,T>()));                

        [MethodImpl(Inline)]
        public static BitBlock<N,T> load<N,T>(ref T src, N n = default)        
            where T : unmanaged
            where N : unmanaged, ITypeNat<N>
                =>  new BitBlock<N, T>(MemoryMarshal.CreateSpan(ref src, cells<N,T>()));
        ...
        public static BitBlock<N,T> alloc<N,T>(N n = default, T fill = default)
            where N : unmanaged, ITypeNat<N>
            where T : unmanaged
        {
        ...
        [MethodImpl(Inline)]
        public static int bitcount<N>(N n = default) 
            where N : unmanaged, ITypeNat<N>
                => NatMath.pow2<N>();
        ...
        public static int cells<N,T>(N n = default, T zero = default)
            ...
            where N : unmanaged, ITypeNat<N>        
        {
            var bytecount = NatMath.pow2<N>(n) >> 3;
