...
namespace Z0
{
        ...
        where T : unmanaged
    {
        ...
        [MethodImpl(Inline)]
        public static implicit operator Span<T>(in BitBlock<T> src)
            => src.data;

        [MethodImpl(Inline)]
        public static implicit operator ReadOnlySpan<T> (in BitBlock<T> src)
            => src.data;

        [MethodImpl(Inline)]
        public static bool operator == (in BitBlock<T> lhs, in BitBlock<T> rhs)
            => lhs.data == rhs.data;
        ...
        [MethodImpl(Inline)]
        internal BitBlock(T fill, int len)
        {                    
