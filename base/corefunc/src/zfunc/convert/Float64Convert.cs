...
namespace Z0
{
    ...
    public static class Float64Convert
    {
        [MethodImpl(Inline)]
        public static double to64f(sbyte src)        
            => ConvertScalarToVector128Double(default, src).GetElement(0);

        [MethodImpl(Inline)]
        public static double to64f(byte src)        
            => ConvertScalarToVector128Double(default, (int)src).GetElement(0);
        [MethodImpl(Inline)]
        ...
        [MethodImpl(Inline)]
        public static unsafe uint to32u(double src)
            => (uint)((uint)to64i(src) >> 32);
