...
namespace Z0
{
    ...
    partial class BlockExtend    
    {
        ...
        public static Block32<T> LoBlock<T>(this Block64<T> src, int block)
            where T : unmanaged
                => new Block32<T>(src.Slice(block * blocklen<T>(n64), blocklen<T>(n32)));
        ...
        public static Block64<T> LoBlock<T>(this Block128<T> src, int block)
            where T : unmanaged
                => new Block64<T>(src.Slice(block * blocklen<T>(n128), blocklen<T>(n64)));
        ...
        public static Block128<T> LoBlock<T>(this Block256<T> src, int block)
            where T : unmanaged
                => new Block128<T>(src.Slice(block * blocklen<T>(n256), blocklen<T>(n128)));
        ...
        public static ConstBlock32<T> LoBlock<T>(this ConstBlock64<T> src, int block)
            where T : unmanaged
                => new ConstBlock32<T>(src.Slice(block * blocklen<T>(n64), blocklen<T>(n32)));
        ...
        public static ConstBlock64<T> LoBlock<T>(this ConstBlock128<T> src, int block)
            where T : unmanaged
                => new ConstBlock64<T>(src.Slice(block * blocklen<T>(n128), blocklen<T>(n64)));
        ...
        public static ConstBlock128<T> LoBlock<T>(this ConstBlock256<T> src, int block)
            where T : unmanaged
                => new ConstBlock128<T>(src.Slice(block * blocklen<T>(n256), blocklen<T>(n128)));
        ...
        public static ConstBlock128<T> HiBlock<T>(this ConstBlock256<T> src, int block)
            where T : unmanaged
                => new ConstBlock128<T>(src.Slice(block * blocklen<T>(n256) + blocklen<T>(n128), blocklen<T>(n128)));
