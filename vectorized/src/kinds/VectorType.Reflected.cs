...
namespace Z0
{
    ...
    public static class VectorType
    {
        ...
        public static IEnumerable<Type> Types
            => Types128.Union(Types256).Union(UserTypes);
        ...
        [MethodImpl(Inline)]
        public static Type definition(W512 w)
            => typeof(Vector512<>);

        public static IEnumerable<Type> types(W128 w)
            => from nt in NumericTypes.Defined select definition(w).MakeGenericType(nt);
