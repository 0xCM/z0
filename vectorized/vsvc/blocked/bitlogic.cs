...
namespace Z0
{
    ...
    partial class gblocks
    {
        ...
        public static ref readonly Block128<T> nor<T>(in Block128<T> a, in Block128<T> b, in Block128<T> c)
            where T : unmanaged
                => ref vzip(a,b,c,VSvc.vnor<T>(n128));
