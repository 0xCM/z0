...
namespace Z0
{
    ...
    partial class VSvcHosts
    {
        ...
        public readonly struct Negate128<T> : ISVUnaryOp128DApi<T>, IUnaryBlockedOp128<T>
            where T : unmanaged
        {
            ...
            public ref readonly Block128<T> Invoke(in Block128<T> a, in Block128<T> c)            
                => ref gblocks.vnegate(a,c);
        }

        [NumericClosures(NumericKind.All)]
        public readonly struct Negate256<T> : ISVUnaryOp256DApi<T>, IUnaryBlockedOp256<T>
            where T : unmanaged
        {
            public const string Name = "vnegate";
