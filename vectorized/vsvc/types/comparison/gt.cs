...
namespace Z0
{
    ...
    partial class VSvcHosts
    {
        ...
        public readonly struct Gt128<T> : ISVBinaryOp128DApi<T>, IBinaryBlockedOp128<T>
            where T : unmanaged
        {
            ...
            public ref readonly Block128<T> Invoke(in Block128<T> a, in Block128<T> b, in Block128<T> c)            
                => ref gblocks.vgt(a,b,c);


        }

        [NumericClosures(NumericKind.All)]
        public readonly struct Gt256<T> : ISVBinaryOp256DApi<T>, IBinaryBlockedOp256<T>
            where T : unmanaged
        {
            public const string Name = "vgt";
