...
namespace Z0
{
    ...
    {
        public readonly struct Rotr128<T> : ISVShiftOp128DApi<T>, ISVImm8UnaryResolver128Api<T>
            where T : unmanaged
        {
        ...
        public readonly struct Rotr256<T> : ISVShiftOp256DApi<T>, ISVImm8UnaryResolver256Api<T>
            where T : unmanaged
        {
            public const string Name = "vrotr";
