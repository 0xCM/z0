...
namespace Z0
{
    ...
    partial class VSvcHosts
    {
        ...
        public readonly struct CNonImpl128<T> : IVBinaryOp128D<T>, IBinaryBlockedOp128<T>
            where T : unmanaged
        {
        ...
        [NumericClosures(NumericKind.Integers)]
        public readonly struct CNonImpl256<T> : IVBinaryOp256D<T>, IBinaryBlockedOp256<T>
            where T : unmanaged
        {
            public const string Name = "vcnonimpl";
