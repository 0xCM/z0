...
//         /// <typeparam name="V">The vector type</typeparam>
//         /// <typeparam name="T">The vector component type</typeparam>
//         public abstract class VBinOp<W, V, T> : VOp<W, V, T>, IVBinaryOp<W, V, T>
//             where W : unmanaged, ITypeNat
//             where V : struct
//             where T : unmanaged
//         {
...
//         /// </summary>
//         /// <typeparam name="T">The vector component type</typeparam>
//         public abstract class VBinOp128D<T> : VBinOpD<N128, Vector128<T>, T>, IVBinaryOp128D<T>
//             where T : unmanaged
//         {
...
//         /// </summary>
//         /// <typeparam name="T">The vector component type</typeparam>
//         public abstract class VBinOp256D<T> : VBinOpD<N256, Vector256<T>, T>, IVBinaryOp256D<T>
//             where T : unmanaged
//         {
