...
namespace Z0
{
    ...
    partial class VSvcHosts
    {
        ...
        public readonly struct Nand128<T> : ISVBinaryOp128DApi<T>, IBinaryBlockedOp128<T>
            where T : unmanaged
        {
        ...
        [NumericClosures(NumericKind.Integers)]
        public readonly struct Nand256<T> : ISVBinaryOp256DApi<T>, IBinaryBlockedOp256<T>
            where T : unmanaged
        {
            public const string Name = "vnand";
