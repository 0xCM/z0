...
namespace Z0
{
    ...
    {        
        ...
        /// <typeparam name="T">The vector component type</typeparam>
        [MethodImpl(Inline)]
        public static Vector512<T> CpuVector<T>(this IPolyrand random, N512 n, Interval<T>? domain = null, Func<T,bool> filter = null)        
            where T : unmanaged
                => CpuVecX.LoadVector(random.Blocks(n, 1, domain, filter));
        ...
        /// <typeparam name="T">The vector component type</typeparam>
        [MethodImpl(Inline)]
        public static Vector512<T> CpuVector<T>(this IPolyrand random, N512 n, Interval<T> domain, Func<T,bool> filter = null)        
            where T : unmanaged
                => CpuVecX.LoadVector(random.Blocks(n,1, domain, filter));
