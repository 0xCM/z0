    ...
    partial class RngX
    {
        ...
        /// <typeparam name="T">The element type</typeparam>
         public static BlockMatrix<M,N,T> BlockMatrix<M,N,T>(this IPolyrand random)
            ...
            where T : unmanaged    
                => Z0.BlockMatrix.Load<M,N,T>(random.BlockedSpan<T>(n256,Z0.Block256.minblocks<M,N,T>()));                    
        ...
        public static BlockMatrix<M,N,T> BlockMatrix<M,N,T>(this IPolyrand random, Interval<T> domain, M m = default, N n = default)
            ...
            where N : unmanaged, ITypeNat
            where T : unmanaged    
                => Z0.BlockMatrix.Load<M,N,T>(random.BlockedSpan<T>(n256, Z0.Block256.minblocks<M,N,T>(), domain));                    
        ...
        /// <typeparam name="T">The element type</typeparam>
         public static BlockMatrix<N,T> BlockMatrix<N,T>(this IPolyrand random, Interval<T>? domain = null)
            where N : unmanaged, ITypeNat
            where T : unmanaged    
                => Z0.BlockMatrix.Load<N,T>(random.BlockedSpan<T>(n256, Z0.Block256.minblocks<N,N,T>(), domain));                    
