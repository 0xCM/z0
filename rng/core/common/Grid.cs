...
namespace Z0
{
    ...
    partial class RngX
    {
        ...
        /// <typeparam name="T">The primal random value type</typeparam>
        [MethodImpl(Inline)]
        public static NatGrid<M,N,T> Grid<M,N,T>(this IPolyrand random, M rows = default, N cols = default)
            where T : unmanaged  
        ...
        /// <typeparam name="T">The primal random value type</typeparam>
        [MethodImpl(Inline)]
        public static NatGrid<M,N,T> Grid<M,N,T>(this IPolyrand random, M rows, N cols, Interval<T> domain)
            where T : unmanaged  
            where M : unmanaged, ITypeNat
            where N : unmanaged, ITypeNat
