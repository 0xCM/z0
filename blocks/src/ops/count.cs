...
namespace Z0
{
    ...
    partial class Blocks
    {
        ...
        public static int cellcover<T>(N8 n, int cellcount)
            where T : unmanaged        
        {
        ...
        /// resolve the computation to a constant an no runtime computations will occur</remarks>
        [MethodImpl(Inline), Op, NumericClosures(NumericKind.All)]
        public static int cellcover<T>(N16 n, int cellcount)
            where T : unmanaged        
        {
            var blockcount = cellcount / length<T>(n);
            return cellcount % length<T>(n) == 0 ? blockcount : blockcount + 1;
        ...
        /// resolve the computation to a constant an no runtime computations will occur</remarks>
        [MethodImpl(Inline), Op, NumericClosures(NumericKind.All)]
        public static int cellcover<T>(N32 n, int cellcount)
            where T : unmanaged        
        {
            var blockcount = cellcount / length<T>(n);
            return cellcount % length<T>(n) == 0 ? blockcount : blockcount + 1;
        ...
        /// resolve the computation to a constant an no runtime computations will occur</remarks>
        [MethodImpl(Inline), Op, NumericClosures(NumericKind.All)]
        public static int cellcover<T>(N64 n, int cellcount)
            where T : unmanaged        
        {
            var blockcount = cellcount / length<T>(n);
            return cellcount % length<T>(n) == 0 ? blockcount : blockcount + 1;
        ...
        /// resolve the computation to a constant an no runtime computations will occur</remarks>
        [MethodImpl(Inline), Op, NumericClosures(NumericKind.All)]
        public static int cellcover<T>(N128 n, int cellcount)
            where T : unmanaged        
        {
            var blockcount = cellcount / length<T>(n);
            return cellcount % length<T>(n) == 0 ? blockcount : blockcount + 1;
        ...
        /// resolve the computation to a constant an no runtime computations will occur</remarks>
        [MethodImpl(Inline), Op, NumericClosures(NumericKind.All)]
        public static int cellcover<T>(N256 n, int cellcount)
            where T : unmanaged        
        {
            var blockcount = cellcount / length<T>(n);
            return cellcount % length<T>(n) == 0 ? blockcount : blockcount + 1;
        ...
        /// resolve the computation to a constant an no runtime computations will occur</remarks>
        [MethodImpl(Inline), Op, NumericClosures(NumericKind.All)]
        public static int cellcover<T>(N512 n, int cellcount)
            where T : unmanaged        
        {
            var blockcount = cellcount / length<T>(n);
            return cellcount % length<T>(n) == 0 ? blockcount : blockcount + 1;
