...
namespace Z0.Mkl
{
    ...
    public static class sample
    {
        ...
        public static void uniform(MklRng stream, Interval<int> range, Span<int> dst)
            => VSL.viRngUniform(0,stream.Source, dst.Length, ref first(dst), range.Left, range.Right).ThrowOnError();
        ...
        public static void uniform(MklRng stream, int min, int max, Span<int> dst)
            => VSL.viRngUniform(0,stream.Source, dst.Length, ref first(dst), min, max).ThrowOnError();
        ...
        public static void uniform(MklRng stream, Interval<float> range, Span<float> dst)
            => VSL.vsRngUniform(0,stream.Source, dst.Length, ref first(dst), range.Left, range.Right).ThrowOnError();
        ...
        public static void bits(MklRng stream, Span<uint> dst)
            => VSL.viRngUniformBits32(0,stream.Source, dst.Length, ref first(dst)).ThrowOnError();
        ...
        public static void cauchy(MklRng stream, float a, float b, Span<float> dst)
            => VSL.vsRngCauchy(0, stream.Source, dst.Length, ref first(dst), a, b).ThrowOnError();
        ...
        public static void chi2(MklRng stream, int dof, Span<float> dst)
            => VSL.vsRngChiSquare(0, stream.Source, dst.Length, ref first(dst), dof).ThrowOnError();
