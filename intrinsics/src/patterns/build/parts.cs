...
namespace Z0
{
    ...
    partial class vbuild
    {
        ...
        /// </summary>
        [MethodImpl(Inline)]
        public static Vector128<byte> parts(N128 n,
        ...
        /// </summary>
        [MethodImpl(Inline)]
        public static Vector128<ushort> parts(N128 n, ushort x0, ushort x1, ushort x2, ushort x3, ushort x4, ushort x5, ushort x6, ushort x7)
        ...
        /// </summary>
        [MethodImpl(Inline)]
        public static Vector128<uint> parts(N128 n,uint x0, uint x1, uint x2, uint x3)
        ...
        /// </summary>
        [MethodImpl(Inline)]
        public static Vector128<int> partsi(N128 n, int x0, int x1, int x2, int x3)
            => Vector128.Create(x0,x1, x2, x3);
        ...
        /// </summary>
        [MethodImpl(Inline)]
        public static Vector128<long> partsi(N128 n, long x0, long x1)
        ...
        /// </summary>
        [MethodImpl(Inline)]
        public static Vector128<ulong> parts(N128 n, ulong x0, ulong x1)
            => Vector128.Create(x0,x1);
        ...
        /// </summary>
        [MethodImpl(Inline)]
        public static Vector256<byte> parts(N256 n,
            byte x0, byte x1, byte x2, byte x3, byte x4, byte x5, byte x6, byte x7,
            byte x8, byte x9, byte xa, byte xb, byte xc, byte xd, byte xe, byte xf,
        ...
        /// </summary>
        [MethodImpl(Inline)]
        public static Vector256<ushort> parts(N256 n, 
        ...
        /// </summary>
        [MethodImpl(Inline)]
        public static Vector256<short> partsi(N256 n, 
        ...
        /// </summary>
        [MethodImpl(Inline)]
        public static Vector256<uint> parts(N256 n,
