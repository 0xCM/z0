...
namespace Z0
{
    ...
    {
        public static Block256<T> sll<T>(ConstBlock256<T> lhs, byte offset, Block256<T> dst)
            where T : unmanaged
        {
        ...
        public static Block256<T> srl<T>(ConstBlock256<T> lhs, byte offset, Block256<T> dst)
            where T : unmanaged
        {
            for(var i=0; i< lhs.BlockCount; i++)
        ...
        public static Block256<T> or<T>(ConstBlock256<T> lhs, ConstBlock256<T> rhs, Block256<T> dst)
            where T : unmanaged
        {
        ...
        public static Block256<T> xor<T>(ConstBlock256<T> lhs, ConstBlock256<T> rhs, Block256<T> dst)
            where T : unmanaged
        {
            for(var i=0; i< blocks(lhs,rhs); i++)
        ...
        public static Block256<T> sub<T>(ConstBlock256<T> lhs, ConstBlock256<T> rhs, Block256<T> dst)
            where T : unmanaged
        {            
        ...
        public static Block256<T> add<T>(ConstBlock256<T> lhs, ConstBlock256<T> rhs, Block256<T> dst)
            where T : unmanaged
        {
            var blocks = dst.BlockCount;
            for(var block = 0; block < blocks; block++)
