...
namespace Z0
{
    ...
    partial class dinx
    {
        ...
        [MethodImpl(Inline)]
        internal static byte gather(byte src, byte mask)        
        ...
        /// <param name="mask">The mask that defines the bits to select</param>
        [MethodImpl(Inline)]
        internal static ushort gather(ushort src, ushort mask)        
        ...
        /// <param name="mask">The mask that defines the bits to select</param>
        [MethodImpl(Inline)]
        internal static uint gather(uint src, uint mask)        
        ...
        /// <param name="mask">The mask that defines the bits to select</param>
        [MethodImpl(Inline)]
        internal static ulong gather(ulong src, ulong mask)        
            => ParallelBitExtract(src,mask);
    }
