    ...
    partial class ginx
    {
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(byte))
                ...
                return generic<T>(dinx.vcimpl(vcast16u(x),vcast16u(y)));
            else if(typeof(T) == typeof(uint))
                return generic<T>(dinx.vcimpl(vcast32u(x), vcast32u(y)));
            else if(typeof(T) == typeof(ulong))
                return generic<T>(dinx.vcimpl(vcast64u(x), vcast64u(y)));
            else 
                throw unsupported<T>();
        }
        ...
        {
            if(typeof(T) == typeof(byte))
                return generic<T>(dinx.vcimpl(vcast8u(x), vcast8u(y)));
            else if(typeof(T) == typeof(ushort))
                return generic<T>(dinx.vcimpl(vcast16u(x),vcast16u(y)));
            else if(typeof(T) == typeof(uint))
                return generic<T>(dinx.vcimpl(vcast32u(x), vcast32u(y)));
