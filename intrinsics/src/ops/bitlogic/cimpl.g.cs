    ...
    partial class ginx
    {
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(sbyte))
                return vgeneric<T>(dinx.vcimpl(v8i(x), v8i(y)));
            else if(typeof(T) == typeof(short))
                return vgeneric<T>(dinx.vcimpl(v16i(x),v16i(y)));
            else if(typeof(T) == typeof(int))
                return vgeneric<T>(dinx.vcimpl(v32i(x), v32i(y)));
            else if(typeof(T) == typeof(long))
                return vgeneric<T>(dinx.vcimpl(v64i(x), v64i(y)));
            else 
                throw unsupported<T>();
        }
