...
namespace Z0
{
    ...
    partial class dinx
    {
        ...
        [MethodImpl(Inline)]
        public static Vector128<int> vshuf4x32(Vector128<int> src, Arrange4 spec)
        ...
        /// <param name="spec">The shuffle spec</param>
        [MethodImpl(Inline)]
        public static Vector128<uint> vshuf4x32(Vector128<uint> src, Arrange4 spec)
            => Shuffle(src, (byte)spec);
        ...
        /// <param name="spec">The shuffle spec</param>
        [MethodImpl(Inline)]
        public static Vector256<int> vshuf4x32(Vector256<int> src, Arrange4 spec)
            => Shuffle(src, (byte)spec);
