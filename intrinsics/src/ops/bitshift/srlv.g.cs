    ...
    {        
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(byte))
                return vgeneric<T>(dinx.vsrlv(v8u(x), v8u(counts)));
            else if(typeof(T) == typeof(ushort))
                return vgeneric<T>(dinx.vsrlv(v16u(x), v16u(counts)));
            else if(typeof(T) == typeof(uint))
                return vgeneric<T>(dinx.vsrlv(v32u(x), v32u(counts)));
            else if(typeof(T) == typeof(ulong))
                return vgeneric<T>(dinx.vsrlv(v64u(x), v64u(counts)));            
            else
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(sbyte))
                return vgeneric<T>(dinx.vsrlv(v8i(x), v8i(counts)));
            else if(typeof(T) == typeof(short))
                return vgeneric<T>(dinx.vsrlv(v16i(x), v16i(counts)));
            else if(typeof(T) == typeof(int))
                return vgeneric<T>(dinx.vsrlv(v32i(x), v32i(counts)));
            else if(typeof(T) == typeof(long))
                return vgeneric<T>(dinx.vsrlv(v64i(x), v64i(counts)));            
            else
                throw unsupported<T>();
        }
