...
namespace Z0
{
    ...
    partial class dinx
    {
        ...
        [MethodImpl(Inline)]
        public static Vector128<short> vpermhi4x16(Vector128<short> src, Perm4L spec)
        ...
        /// <param name="spec">The permutation spec</param>
        [MethodImpl(Inline)]
        public static Vector128<ushort> vpermhi4x16(Vector128<ushort> src, Perm4L spec)
            => ShuffleHigh(src, (byte)spec);
        ...
        /// <param name="spec">The permutation spec</param>
        [MethodImpl(Inline)]
        public static Vector128<short> vpermlo4x16(Vector128<short> src, Perm4L spec)
        ...
        /// <param name="spec">The permutation spec</param>
        [MethodImpl(Inline)]
        public static Vector128<ushort> vpermlo4x16(Vector128<ushort> src, Perm4L spec)
            => ShuffleLow(src, (byte)spec);        
        ...
        /// <param name="spec">The permutation spec</param>
        [MethodImpl(Inline)]
        public static Vector256<short> vpermhi4x16(Vector256<short> src, Perm4L spec)
            => ShuffleHigh(src, (byte)spec);
        ...
        /// <param name="spec">The permutation spec</param>
        [MethodImpl(Inline)]
        public static Vector256<ushort> vpermhi4x16(Vector256<ushort> src, Perm4L spec)
            => ShuffleHigh(src, (byte)spec);
        ...
        /// <param name="spec">The permutation spec</param>
        [MethodImpl(Inline)]
        public static Vector256<short> vpermlo4x16(Vector256<short> src, Perm4L spec)
            => ShuffleLow(src, (byte)spec);
