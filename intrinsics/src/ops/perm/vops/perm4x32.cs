...
namespace Z0
{
    ...
    partial class dinx 
    {
        ...
        [MethodImpl(Inline)]
        public static Vector128<uint> vperm4x32(Vector128<uint> src, Perm4L spec)
        ...
        /// <param name="spec">The shuffle spec</param>
        [MethodImpl(Inline)]
        public static Vector128<int> vperm4x32(Vector128<int> src, Perm4L spec)
            => Shuffle(src,(byte)spec);
        ...
        /// <param name="spec">The shuffle spec</param>
        [MethodImpl(Inline)]
        public static Vector256<int> vperm4x32(Vector256<int> src, Perm4L spec)
            => Shuffle(src, (byte)spec);
        ...
        /// <param name="spec">The shuffle spec</param>
        [MethodImpl(Inline)]
        public static Vector256<uint> vperm4x32(Vector256<uint> src, Perm4L spec)
            => Shuffle(src, (byte)spec);
