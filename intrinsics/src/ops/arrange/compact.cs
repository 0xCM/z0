...
namespace Z0
{
    ...
    {   
        ...
        /// <param name="dst">The target vector</param>
        [MethodImpl(Inline)]
        public static Vector128<byte> vcompact(Vector128<short> x, Vector128<short> y, out Vector128<byte> dst)
            => dst = vpackus(x,y);
        ...
        /// <param name="hi">The target for the upper source elements</param>
        [MethodImpl(Inline)]
        public static void vinflate(Vector128<byte> x, out Vector128<short> lo, out Vector128<short> hi)
            => vconvert(x, out lo, out hi);
        ...
        /// <param name="hi">The target for the upper source elements</param>
        [MethodImpl(Inline)]
        public static ConstPair<Vector128<short>> vinflate(Vector128<sbyte> src, N128 w, short t = default)
            => (vmaplo(src,n128,t), vmaphi(src,n128,t));
        ...
        [MethodImpl(Inline)]
        public static void vinflate(Vector256<byte> src, out Vector256<ushort> lo, out Vector256<ushort> hi)
        ...
        {
            vconvert(src, out var lo, out var hi);
            return (lo,hi);
        }
        ...
        public static Vector128<uint> vcompact(Vector128<ulong> x0, Vector128<ulong> x1, out Vector128<uint> dst)
            => dst = CpuVector.parts(n128, (uint)vcell(x0, 0),(uint)vcell(x0, 1),(uint)vcell(x1, 0),(uint)vcell(x1, 1));
        ...
        /// <param name="x1">The second target vector</param>
        [MethodImpl(Inline)]
        public static void vinflate(Vector128<uint> src, out Vector128<ulong> lo, out Vector128<ulong> hi)
            => vconvert(src, out lo, out hi);
        ...
        /// <param name="hi">The second target vector</param>
        [MethodImpl(Inline)]
        public static void vinflate(Vector128<int> src, out Vector128<long> lo, out Vector128<long> hi)
            => vconvert(src, out lo, out hi);
        ...
        public static Vector128<uint> vcompact(Vector256<ulong> src, out Vector128<uint> dst)
            => dst = CpuVector.parts(n128, (uint)vcell(src, 0),(uint)vcell(src, 1),(uint)vcell(src, 2),(uint)vcell(src, 3));
        ...
        public static Vector128<int> vcompact(Vector256<long> src, out Vector128<int> dst)            
            => dst = CpuVector.partsi(n128, (int)vcell(src, 0),(int)vcell(src, 1),(int)vcell(src, 2),(int)vcell(src, 3));
