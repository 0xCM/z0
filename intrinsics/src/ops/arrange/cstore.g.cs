...
namespace Z0
{
    ...
    partial class ginx
    {
        ...
        [MethodImpl(Inline)]
        public static void vcstore<T>(Vector128<T> src, Vector128<byte> mask, ref byte dst)
            where T : unmanaged
        {
            ...
            || typeof(T) == typeof(ulong))
                vcstore_u(src,mask,ref dst);
            else if(typeof(T) == typeof(sbyte) 
            || typeof(T) == typeof(short) 
            || typeof(T) == typeof(int) 
            || typeof(T) == typeof(long))
                vcstore_i(src,mask,ref dst);
            else
                throw unsupported<T>();
        }
        ...
        /// <typeparam name="T">The primal component type</typeparam>
        [MethodImpl(Inline)]
        public static void vcstore<T>(Vector256<T> src, Vector256<byte> mask, ref byte dst)
            where T : unmanaged
        {
            if(typeof(T) == typeof(byte) 
            || typeof(T) == typeof(ushort) 
