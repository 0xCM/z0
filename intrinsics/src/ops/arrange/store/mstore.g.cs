...
namespace Z0
{
    ...
    partial class ginx
    {
        ...
        [MethodImpl(Inline)]
        public static void vmstore<T>(Vector128<T> src, Vector128<byte> mask, in Block128<byte> dst)
            where T : unmanaged
                => dinx.vmstore(v8u(src),mask, dst);
        ...
        /// <typeparam name="T">The primal component type</typeparam>
        [MethodImpl(Inline)]
        public static void vmstore<T>(Vector128<T> src, Vector128<uint> mask, in Block128<uint> dst)
            where T : unmanaged
                => dinx.vmstore(v32u(src),mask,dst);
        ...
        /// <typeparam name="T">The primal component type</typeparam>
        [MethodImpl(Inline)]
        public static void vmstore<T>(Vector256<T> src, Vector256<byte> mask, in Block256<byte> dst)
            where T : unmanaged
                => dinx.vmstore(v8u(src),mask, dst);
        ...
        /// <typeparam name="T">The primal component type</typeparam>
        [MethodImpl(Inline)]
        public static void vmstore<T>(Vector256<T> src, Vector256<uint> mask, in Block256<uint> dst)
            where T : unmanaged
                => dinx.vmstore(v32u(src),mask, dst);
        ...
        /// <typeparam name="T">The primal component type</typeparam>
        [MethodImpl(Inline)]
        public static void vmstore<T>(Vector256<T> src, Vector256<ulong> mask, in Block256<ulong> dst)
            where T : unmanaged
                => dinx.vmstore(v64u(src),mask, dst);
    }
}