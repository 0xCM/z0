    ...
    public static class gfpv
    {
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(float))
                return generic<T>(dfp.vhadd(vcast32f(x), vcast32f(y)));
            else if(typeof(T) == typeof(double))
                return generic<T>(dfp.vhadd(vcast64f(x), vcast64f(y)));
            else 
                throw unsupported<T>();
        }
        ...
        {
            if(typeof(T) == typeof(float))
                return generic<T>(dfp.vdiv(vcast32f(x), vcast32f(y)));
            else if(typeof(T) == typeof(double))
                return generic<T>(dfp.vdiv(vcast64f(x), vcast64f(y)));
            else 
                throw unsupported<T>();
        }
        ...
        {
            if(typeof(T) == typeof(float))
                return generic<T>(dfp.vand(vcast32f(x), vcast32f(y)));
            else if(typeof(T) == typeof(double))
                return generic<T>(dfp.vand(vcast64f(x), vcast64f(y)));
            else 
                throw unsupported<T>();
        ...
        {
            if(typeof(T) == typeof(float))
                return generic<T>(dfp.vxornot(vcast32f(x), vcast32f(y)));
            else if(typeof(T) == typeof(double))
                return generic<T>(dfp.vxornot(vcast64f(x), vcast64f(y)));
            else 
                throw unsupported<T>();                    
        }
        ...
        {
            if(typeof(T) == typeof(float))
                return generic<T>(dfp.vmin(vcast32f(x), vcast32f(y)));
            else if(typeof(T) == typeof(double))
                return generic<T>(dfp.vmin(vcast64f(x), vcast64f(y)));
            else 
                throw unsupported<T>();
       ...
       public static Vector128<T> vmax<T>(Vector128<T> x, Vector128<T> y)
        ...
        {
            if(typeof(T) == typeof(float))
                return generic<T>(dfp.vmax(vcast32f(x), vcast32f(y)));
            else if(typeof(T) == typeof(double))
                return generic<T>(dfp.vmax(vcast64f(x), vcast64f(y)));
            else 
                throw unsupported<T>();
        }        
       ...
       public static Vector128<T> vadd<T>(Vector128<T> x, Vector128<T> y)
        ...
        {
            if(typeof(T) == typeof(float))
                return generic<T>(dfp.vadd(vcast32f(x), vcast32f(y)));
            else if(typeof(T) == typeof(double))
                return generic<T>(dfp.vadd(vcast64f(x), vcast64f(y)));
            else 
                throw unsupported<T>();
        }        
       ...
       public static Vector256<T> vadd<T>(Vector256<T> x, Vector256<T> y)
        ...
        {
            if(typeof(T) == typeof(float))
                return generic<T>(dfp.vnegate(vcast32f(src)));
            else if(typeof(T) == typeof(double))
                return generic<T>(dfp.vnegate(vcast64f(src)));
            else 
                throw unsupported<T>();
        }
