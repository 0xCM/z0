...
namespace Z0
{
    ...
    {     
        ...
        [MethodImpl(Inline)]
        public static void rotlx<T>(N128 n, int vcount, int blocklen, in T a, int shift, ref T z)
            where T : unmanaged
        {
        ...
        [MethodImpl(Inline)]
        public static void rotlx<T>(N256 n, int vcount, int blocklen, in T a, int shift, ref T z)
            where T : unmanaged
        {
            for(int i=0, offset = 0; i < vcount; i++, offset += blocklen)
                rotlx(n, in skip(in a, offset), shift, ref seek(ref z, offset));
