    ...
    {     
            ...
            where T : unmanaged
        {
            ...
            for(var i=0; i< count; i++)
                vstore(ginx.vperm8x32(xb.LoadVector(i), yb.LoadVector(i)), ref zb.SeekBlock(i));                             
        } 
            ...
            where T : unmanaged
        {
            var count = zb.BlockCount;
            for(var i=0; i< count; i++)
                vstore(ginx.vperm2x128(xb.LoadVector(i), yb.LoadVector(i), spec), ref zb.SeekBlock(i));                             
        } 
