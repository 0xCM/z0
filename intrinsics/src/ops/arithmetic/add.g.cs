    ...
    partial class ginx
    {
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(sbyte))
                 ...
                 return generic<T>(dinx.vadd(vcast32i(x), vcast32i(y)));
            else
                 return generic<T>(dinx.vadd(vcast64i(x), vcast64i(y)));
        }
            ...
            where T : unmanaged
        {
            if(typeof(T) == typeof(byte))
                ...
                return generic<T>(dinx.vadd(vcast16u(x), vcast16u(y)));
            else if(typeof(T) == typeof(uint))
                return generic<T>(dinx.vadd(vcast32u(x), vcast32u(y)));
            else 
                return generic<T>(dinx.vadd(vcast64u(x), vcast64u(y)));
        }
        ...
        {
            if(typeof(T) == typeof(sbyte))
                 return generic<T>(dinx.vadd(vcast8i(x), vcast8i(y)));
            else if(typeof(T) == typeof(short))
                 return generic<T>(dinx.vadd(vcast16i(x), vcast16i(y)));
            else if(typeof(T) == typeof(int))
                 return generic<T>(dinx.vadd(vcast32i(x), vcast32i(y)));
            else
                 return generic<T>(dinx.vadd(vcast64i(x), vcast64i(y)));
        ...
        {
            if(typeof(T) == typeof(byte))
                return generic<T>(dinx.vadd(vcast8u(x), vcast8u(y)));
            else if(typeof(T) == typeof(ushort))
                return generic<T>(dinx.vadd(vcast16u(x), vcast16u(y)));
            else if(typeof(T) == typeof(uint))
                return generic<T>(dinx.vadd(vcast32u(x), vcast32u(y)));
