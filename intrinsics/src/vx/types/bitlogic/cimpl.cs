...
namespace Z0
{
    ...
    partial class VXTypes
    {
        ...
        public readonly struct CImpl128<T> : IVBinOp128D<T>, IBinaryBlockedOp128<T>
            where T : unmanaged
        {
            ...
            [MethodImpl(Inline)]
            public Vector128<T> Invoke(Vector128<T> x, Vector128<T> y) => ginx.vcimpl(x,y);
        ...
        [NumericClosures(NumericKind.Integers)]
        public readonly struct CImpl256<T> : IVBinOp256D<T>, IBinaryBlockedOp256<T>
            where T : unmanaged
        {
            public const string Name = "vcimpl";
            ...
            [MethodImpl(Inline)]
            public Vector256<T> Invoke(Vector256<T> x, Vector256<T> y) => ginx.vcimpl(x,y);
