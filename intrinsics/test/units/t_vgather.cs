...
namespace Z0
{
    ...
    public class t_vgather : IntrinsicTest<t_vgather>
    {
        ...
        public void vgather_128_basecase()
        {
            ...
            var v256Actual = dinx.vgather256(n128, ref src);
            var v256Expect = dinx.vparts(n128,0, 63, 127, 255);
            Claim.eq(v256Expect,v256Actual);

            var v512Actual = dinx.vgather512(n128, ref src);
        ...
        public void vgather_128x32x512_idx128()
        {
            var n = n128;
            var w = n512;
            var ix = n128;
