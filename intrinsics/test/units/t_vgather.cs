...
namespace Z0
{
    ...
    public class t_vgather : t_vinx<t_vgather>
    {
        ...
        public void vgather_128_basecase()
        {
            ...
            var v256Actual = CpuVector.gather256(n128, ref src32);
            var v256Expect = CpuVector.parts(n128,0, 63, 127, 255);
            Claim.eq(v256Expect,v256Actual);

            var v512Actual = CpuVector.gather512(n128, ref src32);
            var v512Expect = CpuVector.parts(n128,0, 127, 255, 511);
            ...
            var i2x8 = CpuVector.partsi(n128, 8, 16);
            var v2x8 = CpuVector.gather(n128, ref src64, i2x8);
            Claim.eq(i2x8, v64i(v2x8));            

            var i2x64 = CpuVector.partsi(n128, 64, 128);
            var v2x64 = CpuVector.gather(n128, ref src64, i2x64);
            Claim.eq(i2x64, v64i(v2x64));            

            var i2x250 = CpuVector.partsi(n128, 250, 500);
            var v2x250 = CpuVector.gather(n128, ref src64, i2x250);
            Claim.eq(i2x250, v64i(v2x250));            

            var i2x2 = CpuVector.partsi(n256, 2, 4, 8, 16);
            var v2x2 = CpuVector.gather(n128, ref src32, i2x2);
            Claim.eq(dinx.vcompact(i2x2, n128, z32i), v32i(v2x2));            

            var i3x3 = CpuVector.partsi(n256, 3, 6, 12, 24);
            var v3x3 = CpuVector.gather(n128, ref src32, i3x3); 
            Claim.eq(dinx.vcompact(i3x3, n128, z32i), v32i(v3x3));

            var i3_3 = CpuVector.partsi(n256, 3, 6, 9, 12);
            var v3_3 = CpuVector.gather(n128, ref src32, i3_3); 
            Claim.eq(dinx.vcompact(i3_3, n128, z32i), v32i(v3_3));

            var i4x2 = CpuVector.partsi(n256, 4, 8, 16, 32);
            var v4x2 = CpuVector.gather(n128, ref src32, i4x2);
            Claim.eq(dinx.vcompact(i4x2, n128, z32i), v32i(v4x2));

            var i5_5 = CpuVector.partsi(n256, 5, 10, 15, 20);
            var v5_5 = CpuVector.gather(n128, ref src32, i5_5);
            Claim.eq(dinx.vcompact(i5_5, n128, z32i), v32i(v5_5));

            var i9_9 = CpuVector.partsi(n256, 9, 18, 27, 36);
            var v9_9 = CpuVector.gather(n128, ref src32, i9_9);
            Claim.eq(dinx.vcompact(i9_9, n128, z32i), v32i(v9_9));

            var i10_10 = CpuVector.partsi(n256, 10, 20, 30, 40);
            var v10_10 = CpuVector.gather(n128, ref src32, i10_10);
            Claim.eq(dinx.vcompact(i10_10, n128, z32i), v32i(v10_10));

            var i16x2 = CpuVector.partsi(n256, 16, 32, 64, 128);
            var v16x2 = CpuVector.gather(n128, ref src32, i16x2);
            Claim.eq(dinx.vcompact(i16x2, n128, z32i), v32i(v16x2));

            var i20_5 = CpuVector.partsi(n256, 20, 25, 30, 35);
            var v20_5 = CpuVector.gather(n128, ref src32, i20_5);
            Claim.eq(dinx.vcompact(i20_5, n128, z32i), v32i(v20_5));

            var i40_3 = CpuVector.partsi(n256, 40, 43, 46, 49);
            var v40_3 = CpuVector.gather(n128, ref src32, i40_3);
            Claim.eq(dinx.vcompact(i40_3, n128, z32i), v32i(v40_3));

            var i4x128 = CpuVector.partsi(n256, 0, 128 - 1, 128*2 - 1, 128*4 - 1);
            var v4x128 = CpuVector.gather512(n128, ref src32);
        ...
        public void vgather_256_basecase()
        {
            ...
            var v256Expect = CpuVector.parts(n256, 0, Pow2.T02 - 1, Pow2.T03 - 1, Pow2.T04 - 1, Pow2.T05 - 1, Pow2.T06 - 1, Pow2.T07 - 1, Pow2.T08 - 1);
            var v256Actual = CpuVector.gather256(n256, ref src);
            Claim.eq(v256Expect,v256Actual);

            var v512Expect = CpuVector.parts(n256, 0, Pow2.T03 - 1, Pow2.T04 - 1, Pow2.T05 - 1, Pow2.T06 - 1, Pow2.T07 - 1, Pow2.T08 - 1, Pow2.T09 - 1);
            var v512Actual = CpuVector.gather512(n256, ref src);
            Claim.eq(v512Expect,v512Actual);
        ...
        public void vgather_128x322_512x128x32i()
        {
            ...
            for(var i=0; i<SampleSize; i++)
            {
                ...
                var vActual = CpuVector.gather(n, ref src, vIdx);                                
        ...
        {                
            ...
            var a0 = CpuVector.gather(w, ref A.Head, CpuVector.partsi(w,4*12, 4*24, 4*48, 4*64));
            ...
            for(var block = 0; block < blocks; block++)
            {
                ...
                var result = CpuVector.gather(w, ref A.Head, indices);
