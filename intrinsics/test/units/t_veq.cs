...
namespace Z0
{
    ...
    {     
        ...
        void check(N128 w)
        {
            v_check(VOps.veq(w,z8), w, z8);                
            v_check(VOps.veq(w,z8i), w, z8i);
            v_check(VOps.veq(w,z16),  w, z16);
            v_check(VOps.veq(w,z16i), w, z16i);
            v_check(VOps.veq(w,z32), w, z32);
            v_check(VOps.veq(w,z32i), w, z32i);
            v_check(VOps.veq(w,z64), w, z64);
            v_check(VOps.veq(w,z64i), w, z64i);
