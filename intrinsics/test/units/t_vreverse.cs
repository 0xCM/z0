...
namespace Z0
{
    ...
    public class t_vreverse : t_vinx<t_vreverse>
    {
        ...
        void check(N128 w)
        {
            check(VX.vreverse(w,z8), w, z8);
            check(VX.vreverse(w,z8i), w, z8i);
            check(VX.vreverse(w,z16), w, z16);
            check(VX.vreverse(w,z16i), w, z16i);
            check(VX.vreverse(w,z32), w, z32);
            check(VX.vreverse(w,z32i), w, z32i);
            check(VX.vreverse(w,z64), w, z64);
            check(VX.vreverse(w,z64i), w, z64i);
        }
