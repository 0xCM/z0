    ...
    public class t_sbroadcast : t_vinx<t_sbroadcast>
    {
        ...
        public void s_broadcast_basecase()
        {
            void case1()
            {
                ...
                var actual = gsinx.sbroadcast((byte)pattern, out ulong _);
            ...
            void case2()
            {
                ...
                var actual = gsinx.sbroadcast((ushort)pattern, out ulong _);
                Claim.eq(expect,actual);
            }
            ...
            void case3()
            {
                ...
                var actual = gsinx.sbroadcast((uint)pattern, out ulong _);
                Claim.eq(expect,actual);
            }
            ...
            void case4()
            {
                ...
                var actual = gsinx.sbroadcast(pattern, out byte _);
                Claim.eq(expect,actual);
            }
