...
namespace Z0
{
    ...
    public class t_intrinsic_bench : t_vinx<t_intrinsic_bench>
    {
        ...
        void vand_bench<T>(N128 w, T t)
            where T : unmanaged
                => vbinop_bench(w, VSvcFactories.vand(w,t),t);
        ...
        void vxor_bench<T>(N128 w, T t)
            where T : unmanaged
                => vbinop_bench(w, VSvcFactories.vxor(w,t),t);
        ...
        {
            vshift_bench(w, VSvcFactories.vrotl(w, z8), z8);
            vshift_bench(w, VSvcFactories.vrotl(w, z16),z16);
            vshift_bench(w, VSvcFactories.vrotl(w, z32), z32);
            vshift_bench(w, VSvcFactories.vrotl(w, z64), z64);
        }
        ...
        {
            vshift_bench(w, VSvcFactories.vrotr(w, z8), z8);
            vshift_bench(w, VSvcFactories.vrotr(w, z16),z16);
            vshift_bench(w, VSvcFactories.vrotr(w, z32), z32);
            vshift_bench(w, VSvcFactories.vrotr(w, z64), z64);
        }
        ...
        {
            vshift_bench(w,VSvcFactories.vsll(w, z8), z8);
            vshift_bench(w,VSvcFactories.vsll(w, z16), z16);
            vshift_bench(w,VSvcFactories.vsll(w, z32), z32);
            vshift_bench(w,VSvcFactories.vsll(w, z64), z64);            
        }
        ...
        {
            vshift_bench(w,VSvcFactories.vsrl(w, z8), z8);
            vshift_bench(w,VSvcFactories.vsrl(w, z16), z16);
            vshift_bench(w,VSvcFactories.vsrl(w, z32), z32);
            vshift_bench(w,VSvcFactories.vsrl(w, z64), z64);            
        }
