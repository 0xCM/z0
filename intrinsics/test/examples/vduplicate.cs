...
namespace Z0
{
    ...
    {     
        public void vduplicate_example()
        {
            ...
            Claim.eq(y0, vgeneric.vparts(n, 0,0,2,2,4,4,6,(uint)6));
            Claim.eq(z0, vgeneric.vparts(n, 1,1,3,3,5,5,7,(uint)7));            
            ...
            Claim.eq(y1, vgeneric.vparts(n,0,1, 0,1, 4,5, 4,5, 8,9, 8,9, C,D, C,D));
            Claim.eq(z1, vgeneric.vparts(n,2,3, 2,3, 6,7, 6,7, A,B, A,B, E,F, E,F));
