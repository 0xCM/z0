...
namespace Z0
{
    ...
    partial class vexamples
    {
        public void vgather_128()
        {
            ...
            var v256Expect = VCore.vparts(n128,0, 63, 127, 255);
            ...
            var v512Expect = VCore.vparts(n128,0, 127, 255, 511);
        ...
        public void vgather_256()
        {
            ...
            var v256idx = VCore.vparts(n256,Pow2.T00 - 1, Pow2.T02 - 1, Pow2.T03 - 1, Pow2.T04 - 1, Pow2.T05 - 1, Pow2.T06 - 1, Pow2.T07 - 1, Pow2.T08 - 1);
            var v256Expect = VCore.vparts(n256, 0, Pow2.T02 - 1, Pow2.T03 - 1, Pow2.T04 - 1, Pow2.T05 - 1, Pow2.T06 - 1, Pow2.T07 - 1, Pow2.T08 - 1);
            var v256Actual = vgather(n256, in src, v256idx);
            Claim.veq(v256Expect,v256Actual);

            var v512Expect = VCore.vparts(n256, 0, Pow2.T03 - 1, Pow2.T04 - 1, Pow2.T05 - 1, Pow2.T06 - 1, Pow2.T07 - 1, Pow2.T08 - 1, Pow2.T09 - 1);
        ...
        {                
            ...
            var a0 = vgather(w, in A.Head, VCore.vparts(w,4*12, 4*24, 4*48, 4*64));
            ...
            for(var block = 0; block < BlockCount; block++)
            {
                ...
                var indices = VCore.vparts(w,i0,i1,i2,i3);
        ...
        {
            [MethodImpl(Inline)]
            get => Vectors.vload(n256, in refs.head64(VGather256x64x256IndexData));
        }
        ...
        {
            [MethodImpl(Inline)]
            get => Vectors.vload(n256, in refs.head64i(VGather256x64x256IndexData));
        }
        ...
        {
            [MethodImpl(Inline)]
            get => Vectors.vload<uint>(n256, in refs.head32(VGather256x32x512IndexData));
        }
