...
namespace Z0
{
    ...
    partial class vexamples
    {
        ...
        public void vgather_256()
        {
            ...
            var v256idx = CpuVector.vparts(n256,Pow2.T00 - 1, Pow2.T02 - 1, Pow2.T03 - 1, Pow2.T04 - 1, Pow2.T05 - 1, Pow2.T06 - 1, Pow2.T07 - 1, Pow2.T08 - 1);
        ...
        {                
            ...
            var w = n128;
            var t = z32;
            var A = DataBlocks.alloc(w,BlockCount, t);                
            var B = DataBlocks.alloc(w,BlockCount, t);
            ...
            var a0 = vgather(w, in A.Head, CpuVector.vparts(w,4*12, 4*24, 4*48, 4*64));
        ...
        {
            [MethodImpl(Inline)]
            get => CpuVector.vload(n256, in SpanOps.head64(VGather256x64x256IndexData));
        }
        ...
        {
            [MethodImpl(Inline)]
            get => CpuVector.vload(n256, in SpanOps.head64i(VGather256x64x256IndexData));
        }
        ...
        {
            [MethodImpl(Inline)]
            get => CpuVector.vload<uint>(n256, in SpanOps.head32(VGather256x32x512IndexData));
        }
