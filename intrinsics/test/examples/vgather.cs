...
namespace Z0
{
    ...
    partial class vexamples
    {
        public void vgather_128()
        {
            ...
            var v256Expect = gvec.vparts(n128,0, 63, 127, 255);
            ...
            var v512Expect = gvec.vparts(n128,0, 127, 255, 511);
            ...
            var i2x8 = gvec.vparts(n128, 8, 16);
            var v2x8 = vgather(n128, in src64, i2x8);
            Claim.eq(i2x8, v2x8);            

            var i2x64 = gvec.vparts(n128, 64, 128);
            var v2x64 = vgather(n128, in src64, i2x64);
            Claim.eq(i2x64, v2x64);            

            var i2x250 = gvec.vparts(n128, 250, 500);
            var v2x250 = vgather(n128, in src64, i2x250);
            Claim.eq(i2x250, v2x250);            

            var i2x2 = gvec.vparts(n256, 2, 4, 8, 16);
            var v2x2 = vgather(n128, in src32, i2x2);
            Claim.eq(dinx.vcompact(i2x2, n128, z32i), v2x2);            

            var i3x3 = gvec.vparts(n256, 3, 6, 12, 24);
            var v3x3 = vgather(n128, in src32, i3x3); 
            Claim.eq(dinx.vcompact(i3x3, n128, z32i), v3x3);

            var i3_3 = gvec.vparts(n256, 3, 6, 9, 12);
            var v3_3 = vgather(n128, in src32, i3_3); 
            Claim.eq(dinx.vcompact(i3_3, n128, z32i), v3_3);

            var i4x2 = gvec.vparts(n256, 4, 8, 16, 32);
            var v4x2 = vgather(n128, in src32, i4x2);
            Claim.eq(dinx.vcompact(i4x2, n128, z32i), v4x2);

            var i5_5 = gvec.vparts(n256, 5, 10, 15, 20);
            var v5_5 = vgather(n128, in src32, i5_5);
            Claim.eq(dinx.vcompact(i5_5, n128, z32i), v5_5);

            var i9_9 = gvec.vparts(n256, 9, 18, 27, 36);
            var v9_9 = vgather(n128, in src32, i9_9);
            Claim.eq(dinx.vcompact(i9_9, n128, z32i), v9_9);

            var i10_10 = gvec.vparts(n256, 10, 20, 30, 40);
            var v10_10 = vgather(n128, in src32, i10_10);
            Claim.eq(dinx.vcompact(i10_10, n128, z32i), v10_10);

            var i16x2 = gvec.vparts(n256, 16, 32, 64, 128);
            var v16x2 = vgather(n128, in src32, i16x2);
            Claim.eq(dinx.vcompact(i16x2, n128, z32i), v16x2);

            var i20_5 = gvec.vparts(n256, 20, 25, 30, 35);
            var v20_5 = vgather(n128, in src32, i20_5);
            Claim.eq(dinx.vcompact(i20_5, n128, z32i), v20_5);

            var i40_3 = gvec.vparts(n256, 40, 43, 46, 49);
            var v40_3 = vgather(n128, in src32, i40_3);
            Claim.eq(dinx.vcompact(i40_3, n128, z32i), v40_3);

            var i4x128 = gvec.vpartsi(n256, 0, 128 - 1, 128*2 - 1, 128*4 - 1);
        ...
        public void vgather_256()
        {
            ...
            var v256idx = gvec.vparts(n256,Pow2.T00 - 1, Pow2.T02 - 1, Pow2.T03 - 1, Pow2.T04 - 1, Pow2.T05 - 1, Pow2.T06 - 1, Pow2.T07 - 1, Pow2.T08 - 1);
            var v256Expect = gvec.vparts(n256, 0, Pow2.T02 - 1, Pow2.T03 - 1, Pow2.T04 - 1, Pow2.T05 - 1, Pow2.T06 - 1, Pow2.T07 - 1, Pow2.T08 - 1);
            var v256Actual = vgather(n256, in src, v256idx);
            Claim.eq(v256Expect,v256Actual);

            var v512Expect = gvec.vparts(n256, 0, Pow2.T03 - 1, Pow2.T04 - 1, Pow2.T05 - 1, Pow2.T06 - 1, Pow2.T07 - 1, Pow2.T08 - 1, Pow2.T09 - 1);
        ...
        {                
            ...
            var a0 = vgather(w, in A.Head, gvec.vparts(w,4*12, 4*24, 4*48, 4*64));
            ...
            for(var block = 0; block < BlockCount; block++)
            {
                ...
                var indices = gvec.vparts(w,i0,i1,i2,i3);
        ...
        {
            [MethodImpl(Inline)]
            get => gvec.vload(n256, in refs.head64(VGather256x64x256IndexData));
        }
        ...
        {
            [MethodImpl(Inline)]
            get => gvec.vload(n256, in refs.head64i(VGather256x64x256IndexData));
        }
        ...
        {
            [MethodImpl(Inline)]
            get => gvec.vload<uint>(n256, in refs.head32(VGather256x32x512IndexData));
        }
