...
namespace Z0
{
    ...
    partial class vexamples
    {
        ...
        {
            [MethodImpl(Inline)]
            get => VCore.vload(n256, in refs.head64(VGather256x64x256IndexData));
        }
        ...
        {
            [MethodImpl(Inline)]
            get => VCore.vload(n256, in refs.head64i(VGather256x64x256IndexData));
        }
        ...
        {
            [MethodImpl(Inline)]
            get => VCore.vload<uint>(n256, in refs.head32(VGather256x32x512IndexData));
        }
