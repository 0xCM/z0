...
namespace Z0
{
    ...
    partial class vexamples
    {
        public void vgather_128()
        {
            ...
            var v512Expect = Vectors.vparts(n128,0, 127, 255, 511);
        ...
        public void vgather_256()
        {
            ...
            var v256Expect = Vectors.vparts(n256, 0, Pow2.T02 - 1, Pow2.T03 - 1, Pow2.T04 - 1, Pow2.T05 - 1, Pow2.T06 - 1, Pow2.T07 - 1, Pow2.T08 - 1);
            var v256Actual = vgather(n256, in src, v256idx);
            Claim.eq(v256Expect,v256Actual);

            var v512Expect = Vectors.vparts(n256, 0, Pow2.T03 - 1, Pow2.T04 - 1, Pow2.T05 - 1, Pow2.T06 - 1, Pow2.T07 - 1, Pow2.T08 - 1, Pow2.T09 - 1);
        ...
        {                
            ...
            var a0 = vgather(w, in A.Head, Vectors.vparts(w,4*12, 4*24, 4*48, 4*64));
